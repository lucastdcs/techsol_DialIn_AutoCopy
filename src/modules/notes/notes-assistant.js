...
export function initCaseNotesAssistant() {
  ...
  setCaseType("bau");
    ...
    // --- NOVO: Container para Label + Link de Ajuda ---
    ...
    // Removemos margens do label pois o container cuida disso
    Object.assign(subStatusLabel.style, styleLabel, { marginTop: "0", marginBottom: "0" });

    // O Link de Ajuda
    const subStatusHelpLink = document.createElement("a");
    subStatusHelpLink.target = "_blank"; // Abre em nova aba
    subStatusHelpLink.innerHTML = `
        ...
        Guia de Substatus
    `;
    Object.assign(subStatusHelpLink.style, styleHelpLink);
    ...
    step1Div.appendChild(subStatusHeader); // Adiciona o header (Label + Link)

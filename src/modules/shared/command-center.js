...
export function initCommandCenter(actions) {
  ...
  if (!document.getElementById(styleId)) {
    ...
    style.innerHTML = `
        ...
        .cw-pill {
            ...
            padding: 8px 0 16px 0; /* Espaço para o Grip e para baixo */
            gap: 8px;
        ...
        .cw-pill.collapsed {
            /* Força altura igual a largura */
            max-height: 56px !important; 
            
            /* CRUCIAL: Remove padding para não deformar o círculo */
            padding: 0 !important; 
            gap: 0 !important;
        ...
        .cw-brand-btn svg {
            ...
            fill: currentColor; /* Usa a cor definida no botão (Branco) */
            filter: drop-shadow(0 0 4px rgba(255,255,255,0.3)); /* Brilho sutil */
        }

        /* Ajuste de rotação suave */
        ...
        .cw-btn {
            ...
            border-radius: 50%; border: none; background: transparent;
            display: flex; align-items: center; justify-content: center; 
            cursor: pointer; color: ${COLORS.iconIdle};
  ...
  // 2. DOM STRUCTURE
  const ICONS = {
    // Nexus (Principal) agora com fill="currentColor" explícito
  ...
  function onMouseUp() {
      ...
      pill.style.transition = `max-height 0.4s cubic-bezier(0.2, 0, 0, 1), padding 0.3s ease, background 0.3s ease, top 0.1s linear, left 0.1s linear`;
      isDragging = false;
  }

...
const ICONS = {
    ...
    // Ícone de Barra Simples (Handle)
    grip: `<svg viewBox="0 0 24 24" fill="currentColor"><rect x="8" y="11" width="8" height="2" rx="1"/></svg>`
};
...
export function initCommandCenter(actions) {
    ...
    if (!document.getElementById('cw-command-center-style')) {
        ...
        style.innerHTML = `
            ...
            .cw-pill.dragging .cw-grip-area { color: ${COLORS.gripActive}; }
            ...
            /* Ícone do Grip (Sem rotação) */
            .cw-grip-area svg { 
                width: 24px; height: 24px; 
                fill: currentColor; 
                /* transform: rotate(90deg); <--- REMOVIDO */
            }
    ...
    // Drag só inicia se clicar na área do Grip ou espaços vazios
    // Se for um botão, o evento de clique do botão tem prioridade
    pill.onmousedown = (e) => {

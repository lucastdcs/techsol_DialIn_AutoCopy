...
style.innerHTML = `
    ...
    .cw-focus-backdrop {
        ...
        transition: opacity 0.4s ease; /* Ajustado para acompanhar a nova física */
    }
    ...
    .cw-pill {
        ...
        /* ABRIR: Efeito "Elástico" (Overshoot) - Vai um pouco além e volta */
        transition: 
    ...
    .cw-main-logo {
        ...
        transform: scale(2) rotate(180deg); /* Começa gigante */
        color: #fff;
    ...
    .cw-pill.collapsed > *:not(.cw-main-logo) {
        ...
        transform: scale(0); 
        /* Transição rápida com efeito "sugador" */
        transition: 
    ...
    /* Na opção "Jelly", tudo ser sugado junto reforça a física de gelatina/vácuo. */

...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ct={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ut={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Wt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var be={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var St=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Ht=-1;function Je(){let e=Math.floor(Math.random()*St.length);return e===Ht&&(e=(e+1)%St.length),Ht=e,St[e]}var Ie=e=>new Promise(t=>setTimeout(t,e));async function Eo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let o=e.querySelector(".cursor");await Ie(200);for(let n=0;n<t.length;n++){let r=t.charAt(n),a=document.createElement("span");a.textContent=r,o&&o.parentNode===e?o.before(a):e.appendChild(a);let i=Math.floor(Math.random()*60)+30;n===0&&(i=150),n>t.length-3&&(i=30),await Ie(i)}await Ie(600),o&&(o.style.display="none")}async function Et(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await Ie(200);let t=await zt(),o=Bt(t),n=e.querySelector("#w-icon"),r=e.querySelector("#p1"),a=e.querySelector("#p2"),i=e.querySelector("#p3"),l=e.querySelector("#p-sextou");n&&(n.innerHTML=o.icon),r&&(r.textContent=o.prefix),i&&(i.textContent=o.suffix),await Ie(300);let g=n?n.querySelector("svg"):null;if(g&&(g.style.opacity="1",g.style.transform="scale(1)"),await Ie(400),r&&(r.style.opacity="1"),Z.playStartup(),a&&await Eo(a,o.name),i&&(i.style.opacity="1",i.style.transform="translateY(0)"),o.isFriday&&l){await Ie(400),l.style.display="block",l.offsetWidth;let u=l.querySelector(".sextou-badge");u&&(u.style.opacity="1",u.style.transform="scale(1)")}await Ie(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await Ie(900),e.parentNode&&e.parentNode.removeChild(e)}}var Ye={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Xe(e,t){t.onmousedown=o;function o(n){n.stopPropagation(),n.preventDefault();let r=e.style.transition;e.style.transition="none";let a=n.clientX,i=n.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),g=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),u=a,x=i,p=!1;function b(v){u=v.clientX,x=v.clientY,p||(window.requestAnimationFrame(()=>{A(),p=!1}),p=!0)}function A(){let v=l+(u-a),T=g+(x-i);v>360&&(e.style.width=v+"px"),T>300&&(e.style.height=T+"px")}function m(){document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",m),setTimeout(()=>{e.style.transition=r},50)}document.addEventListener("mousemove",b),document.addEventListener("mouseup",m)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function Yt(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,o=>t[o]?t[o]:"")}var et=e=>new Promise(t=>setTimeout(t,e));function it(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}var Xt="cw-automation-styles";if(!document.getElementById(Xt)){let e=document.createElement("style");e.id=Xt,e.innerHTML=`
...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var pe=e=>new Promise(t=>setTimeout(t,e));function fe(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function st(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let r=e.getBoundingClientRect(),a=document.createElement("div");a.id=o,a.style.cssText=`
    ...
    `,a.innerHTML=`
        ...
        ">\xD7</div>
    `;let i=a.querySelector(".cw-close-btn");i.onclick=()=>{a.style.opacity="0",a.style.transform="translateY(-5px)",setTimeout(()=>a.remove(),300)},document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(a)&&i.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await pe(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await pe(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let n=o.offsetParent!==null,r=o.closest("case-message-view")!==null,a=o.closest(".editor")!==null||o.closest("write-card")!==null;return n&&!r&&a});return t&&fe("Editor visualmente detectado.","success"),t}async function Zt(){fe("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");if(o&&o.offsetParent!==null){fe("Bot\xE3o de email direto encontrado.");let p=o.closest("material-button")||o.closest("material-fab")||o;Ce(p),e=!0}else{fe("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let p=document.querySelector("material-fab-speed-dial");if(p){let b=p.querySelector(".trigger");if(b){Ce(b),await pe(800);let m=Array.from(document.querySelectorAll("i.material-icons-extended")).find(v=>v.innerText.trim()==="email");m&&(Ce(m),e=!0)}}}if(!e)return oe("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;fe("\u{1F680} FASE 2: Verificando rascunhos...");let n=null,r=0,a=20;for(;r<a;){await pe(250);let p=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(n=Array.from(p).find(b=>b.offsetParent!==null),n){fe("\u26A0\uFE0F Rascunho detectado!","warn");break}r++}if(n){fe("\u{1F5D1}\uFE0F Descartando..."),Ce(n),n.click();let p=null,b=0;for(;b<15;){await pe(300);let A=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(p=Array.from(A).find(m=>m.offsetParent!==null),p)break;b++}p&&(Ce(p),oe("Limpando rascunho antigo...",{duration:2e3}),await pe(2500))}fe("\u{1F680} FASE 3: Buscando editor final...");let i=0,l=null;for(;i<20&&(l=kt(),!l);)await pe(250),i++;if(!l)return oe("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let g=l.closest('[id="email-body-content-top"]'),x=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(g){if(x){let b=x.closest('[aria-hidden="true"]');b&&b.removeAttribute("aria-hidden"),x.focus(),Ce(x)}await pe(300),g.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let p=g.querySelector("#cases-body-field");if(p){let b=document.createRange();b.selectNodeContents(p),b.collapse(!0);let A=window.getSelection();A.removeAllRanges(),A.addRange(b)}return!0}return!1}async function lt(e){if(!e||!await Zt())return;let o=await At();fe("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await pe(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let a=document.querySelector('input[aria-label="Enter To email address"]');a&&(await rt(a,o.clientEmail),st(a,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let a=document.querySelector('input[aria-label="Enter Bcc email address"]');a&&(await rt(a,o.internalEmail),st(a,`
            ...
            `))}await pe(500);let r=document.querySelector('material-button[debug-id="canned_response_button"]');if(r){Ce(r),await pe(1e3);let a=document.querySelector("material-auto-suggest-input input");if(a){Ce(a),document.execCommand("insertText",!1,e),a.dispatchEvent(new Event("input",{bubbles:!0})),fe("\u23F3 Buscando resultado da Canned Response...","info");let i=null,l=0,g=15e3,u=500;for(;l<g&&(i=document.querySelector("material-select-dropdown-item"),!i);)await pe(u),l+=u;if(i){Ce(i),await pe(1500);let x=kt();if(x&&o.advertiserName){let p=x.innerHTML;p.includes("{%ADVERTISER_NAME%}")&&(x.innerHTML=p.replace(/{%ADVERTISER_NAME%}/g,o.advertiserName))}oe("Canned Response aplicada!")}else fe(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),oe(`Timeout: Template '${e}' n\xE3o carregou.`,{error:!0})}}else oe("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function Jt(e){if(fe(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Zt())return;let o=await At(),n=vt();await pe(600),fe("\u{1F4E7} Processando destinat\xE1rios...");let r=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(r&&(r.click(),await pe(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await rt(l,o.clientEmail),st(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await rt(l,o.internalEmail),st(l,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
...
@keyframes googleBounce {
    ...
    `;let r=document.createElement("div");if(r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(n),n.querySelector(".notes").onclick=A=>{A.stopPropagation(),e.toggleNotes()},n.querySelector(".email").onclick=A=>{A.stopPropagation(),e.toggleEmail()},n.querySelector(".script").onclick=A=>{A.stopPropagation(),e.toggleScript()},n.querySelector(".links").onclick=A=>{A.stopPropagation(),e.toggleLinks()},n.querySelector(".broadcast").onclick=A=>{A.stopPropagation();let m=A.currentTarget.querySelector(".cw-badge");m&&(m.style.transform="scale(0)",setTimeout(()=>m.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let A=document.createElement("div");A.className="cw-badge",n.querySelector(".broadcast").appendChild(A)}(async function(){await ct(2800),n.classList.add("docked"),await ct(300);let m=n.querySelectorAll(".cw-btn");n.querySelectorAll(".cw-sep").forEach(T=>T.classList.add("visible"));for(let T=0;T<m.length;T++)m[T].classList.add("popped"),await ct(90);await ct(200),n.classList.add("system-check")})();let a=!1,i,l,g,u,x=3;n.onmousedown=A=>{if(A.target.closest("button"))return;A.preventDefault(),i=A.clientX,l=A.clientY;let m=n.getBoundingClientRect();g=m.left,u=m.top,document.addEventListener("mousemove",p),document.addEventListener("mouseup",b)};function p(A){let m=A.clientX-i,v=A.clientY-l;!a&&Math.sqrt(m*m+v*v)>x&&(a=!0,n.style.transition="none"),a&&(n.style.left=`${g+m}px`,n.style.top=`${u+v}px`,n.style.right="auto",n.style.bottom="auto",n.style.transform="none")}function b(A){if(document.removeEventListener("mousemove",p),document.removeEventListener("mouseup",b),a){a=!1,n.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let m=window.innerWidth,v=window.innerHeight,T=n.getBoundingClientRect(),I=T.left+T.width/2,R;I<m/2?(R=24,n.classList.remove("side-right"),n.classList.add("side-left")):(R=m-T.width-24,n.classList.remove("side-left"),n.classList.add("side-right"));let G=T.top;G<24&&(G=24),G>v-T.height-24&&(G=v-T.height-24),n.style.left=`${R}px`,n.style.top=`${G}px`}else{let m=A.target.closest("button");m&&(m.style.transform="scale(0.9)",setTimeout(()=>m.style.transform="",150))}}}function dt(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(y)}let l=document.createElement("div");l.className="cw-zen-container";let g=document.createElement("div");Object.assign(g.style,{display:"none"});let u=document.createElement("div");u.className="cw-screens-container",g.appendChild(u),l.innerHTML=`
    ...
    `;let x=l.querySelector(".cw-hero-grid"),p=l.querySelector(".cw-acc-container"),b=l.querySelector(".cw-results-container"),A=l.querySelector(".cw-search-input"),m=l.querySelector(".cw-status-bar"),v=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");r.forEach(([y,f])=>{let s=n(f.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${y}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`

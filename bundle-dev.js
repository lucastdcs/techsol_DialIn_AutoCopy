...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var de=e=>new Promise(t=>setTimeout(t,e));function be(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function st(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let r=e.getBoundingClientRect(),a=document.createElement("div");a.id=o,a.style.cssText=`
    ...
    `,document.head.appendChild(e)}function Te(e,t,o){let n=document.getElementById(o);if(!t)return;let r=t.getAttribute("data-moved")==="true",a={x:0,y:0};if(n){let h=n.getBoundingClientRect();a.x=h.left+h.width/2,a.y=h.top+h.height/2}let i,l;if(!r)i=window.innerWidth/2,l=window.innerHeight/2;else{let h=t.getBoundingClientRect();i=h.left+h.width/2,l=h.top+h.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let m=a.x-i,u=a.y-l;e?(Z.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",r?t.style.transform=`translate(${m}px, ${u}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${m}px), calc(-50% + ${u}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),n&&n.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",r?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof eo=="function"&&eo(t,o)):(Z.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",r?t.style.transform=`translate(${m}px, ${u}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${m}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),n&&n.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof kt=="function"&&kt(t))}function eo(e,t){kt(e);let o=n=>{if(!e.classList.contains("open"))return;let r=e.contains(n.target),a=document.querySelector(".cw-pill"),i=a&&a.contains(n.target);r?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=o,document.addEventListener("mousedown",o)}function kt(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var no="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",Ot="cw_data_broadcast",to="cw_data_tips",ko=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function oo(e){return new Promise((t,o)=>{let n="cw_cb_"+Math.round(1e4*Math.random()),r=document.createElement("script");window[n]=a=>{document.body.removeChild(r),delete window[n],t(a)},r.src=`${no}?op=${e}&callback=${n}&t=${Date.now()}`,r.onerror=()=>{document.body.removeChild(r),delete window[n],o(new Error("JSONP Load Error"))},document.body.appendChild(r)})}var He={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await oo("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(to,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await oo("broadcast");if(e&&e.broadcast)return localStorage.setItem(Ot,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(Ot)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Ot)||"[]"),getRandomTip:()=>{let e=ko,t=localStorage.getItem(to);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let n={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(no,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(n)}).catch(r=>console.log("Log fail",r))}};var fe={glassBg:"rgba(61, 61, 61, 0.90)",glassBorder:"rgba(255, 255, 255, 0.12)",glassHighlight:"rgba(255, 255, 255, 0.1)",iconIdle:"#c2c5c8",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},Oo=e=>new Promise(t=>setTimeout(t,e));function ao(e){let t="cw-command-center-style";if(!document.getElementById(t)){let y=document.createElement("style");y.id=t,y.innerHTML=`
        ...
        .cw-pill {
            ...
            /* CRUCIAL: Esconde qualquer coisa que tente "sambar" fora da borda durante anima\xE7\xE3o */
            overflow: hidden; 

            /* Transi\xE7\xF5es Separadas para X e Y */
            transition: 
                width 0.5s var(--cw-smooth-x),       /* Largura sem el\xE1stico */
                height 0.6s var(--cw-spring-y),      /* Altura com el\xE1stico */
                padding 0.3s ease,                   /* Padding r\xE1pido */
                gap 0.3s ease,
        ...
        .cw-pill.collapsed {
            ...
            cursor: default; /* O cursor \xE9 controlado pelos bot\xF5es internos */
        }
        ...
        /* --- ITENS QUE DESAPARECEM (Anima\xE7\xE3o de Sa\xEDda R\xE1pida) --- */
        ...
        .cw-pill.collapsed .cw-status-container {
            opacity: 0; 
            pointer-events: none;
            /* Zera dimens\xF5es instantaneamente ap\xF3s a opacidade */
            height: 0; margin: 0; width: 0; padding: 0; 
            
            /* Transi\xE7\xE3o muito r\xE1pida para sumir antes da caixa encolher */
            transition: 
  ...
  `;let r=document.createElement("div");if(r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(n),n.querySelector(".notes").onclick=y=>{y.stopPropagation(),e.toggleNotes()},n.querySelector(".email").onclick=y=>{y.stopPropagation(),e.toggleEmail()},n.querySelector(".script").onclick=y=>{y.stopPropagation(),e.toggleScript()},n.querySelector(".links").onclick=y=>{y.stopPropagation(),e.toggleLinks()},n.querySelector(".broadcast").onclick=y=>{y.stopPropagation();let k=y.currentTarget.querySelector(".cw-badge");k&&(k.style.transform="scale(0)",setTimeout(()=>k.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let y=document.createElement("div");y.className="cw-badge",n.querySelector(".broadcast").appendChild(y)}let a=n.querySelector("#cw-brand-toggle"),i=!1,l=!1,m,u,h,p,g=3,q=!1;a.onclick=y=>{q||(y.stopPropagation(),i=!i,i?(n.classList.add("collapsed"),a.setAttribute("data-label","Expandir")):(n.classList.remove("collapsed"),a.setAttribute("data-label","Minimizar")))},n.onmousedown=y=>{if(y.target.closest("button")&&!y.target.closest("#cw-brand-toggle")&&!i)return;y.preventDefault(),m=y.clientX,u=y.clientY;let k=n.getBoundingClientRect();h=k.left,p=k.top,q=!1,l=!1,n.style.transition="none",document.addEventListener("mousemove",v),document.addEventListener("mouseup",S)};function v(y){let k=y.clientX-m,N=y.clientY-u;!l&&Math.sqrt(k*k+N*N)>g&&(l=!0,q=!0),l&&(n.style.left=`${h+k}px`,n.style.top=`${p+N}px`,n.style.right="auto",n.style.bottom="auto",n.style.transform="none")}function S(y){if(document.removeEventListener("mousemove",v),document.removeEventListener("mouseup",S),n.style.transition=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let h=l.querySelector(".cw-hero-grid"),p=l.querySelector(".cw-acc-container"),g=l.querySelector(".cw-results-container"),q=l.querySelector(".cw-search-input"),v=l.querySelector(".cw-status-bar"),S=l.querySelector(".cw-status-text"),y=l.querySelector(".cw-footer-icons");r.forEach(([f,b])=>{let s=n(b.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${f}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=A=>{if(A.target.closest(".cw-step-btn"))return;let d=t[f]?t[f].count:0;N(f,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>N(f,-1,b),c.querySelector(".plus").onclick=()=>N(f,1,b),c.dataset.color=s.color,h.appendChild(c)});function k(f,b){let s=n(b.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=f,c.innerHTML=`
...
`).filter(B=>B.trim()!=="").map(B=>`<p style="margin: 0 0 8px 0;">${B}</p>`).join(""):K.tagName==="TEXTAREA"&&(Y=Y.replace(/\n/g,"<br>"));let se=Y.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let B=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${D}\\}(?:<br>\\s*)?`,"gi");B.test(E)?E=E.replace(B,""):E=E.replace(I,"")}else E=E.replace(I,Y.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(E+=i.getOutput()),E}Ke.onclick=()=>{let C=_t();C?(qt(C),oe(V("copiado_sucesso"))):oe(V("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=w.value,L=_t();if(!L){oe(V("selecione_substatus"),{error:!0});return}qt(L),xt();let E=ct(),$=await co();if($)try{if($.focus(),$.innerHTML.trim()==="<p><br></p>"||$.innerHTML.trim()==="<br>"||$.innerText.trim()===""){let ce=document.createRange();ce.selectNodeContents($);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ce),document.execCommand("delete",!1,null)}else if(!$.innerHTML.endsWith("<br><br>")){let ce=document.createRange();ce.selectNodeContents($),ce.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ce),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,L),lo($),setTimeout(()=>{oe(V("inserido_copiado"))},600);let le=typeof ze<"u"&&ze?ze.checked:!0;if(C&&Pe[C]&&le){let ce=Pe[C];await lt(ce),await new Promise(Q=>setTimeout(Q,500))}E(),ht(1.5),A.value="",w.innerHTML=`<option value="">${V("select_substatus")}</option>`,w.disabled=!0}catch(ae){console.error(ae),oe("Erro ao inserir.",{error:!0}),E()}};function ht(C=1.5){C<=1.5&&(Le.style.display="none",Ae.innerHTML=""),C<=2&&(l.reset(),pe.style.display="none"),C<=3&&(xe.style.display="none",Re.innerHTML="",i.reset(),We.style.display="none",Fe.style.display="none")}function xt(){if(r=!r,r){let C=m.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Te(r,m,"cw-btn-notes")}return mt("bau"),gt("pt"),xt}var $e={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
        ...
        `,x.querySelector("#csa-back-btn").onclick=T;let H=x.querySelector("#csa-insert-btn");H.onclick=()=>{H.style.transform="scale(0.96)",O(_,"email"),setTimeout(()=>{H.style.transform="scale(1)",T()},300)}}function T(){r="list",F.style.transform="translateX(0)"}function ne(_,P,X=null){let H=document.createElement("button");return H.innerHTML=X?`<span style="margin-right:4px">${X}</span>${_}`:_,Object.assign(H.style,p),o===P&&n===""&&Object.assign(H.style,g),H.onclick=()=>{o=P,n="",s.value="",z(),M()},H}function z(){c.innerHTML="",c.appendChild(ne("Smart CRs",t,"\u26A1")),Object.keys($e).forEach(_=>{c.appendChild(ne($e[_].title,_))})}function M(){A.innerHTML="";let _=[];if(n.trim()!==""){let W=n.toLowerCase();Object.values($e).forEach(R=>{R.emails.forEach(J=>{(J.name.toLowerCase().includes(W)||J.subject.toLowerCase().includes(W))&&_.push({type:"email",data:J})})}),Object.entries(Pe).forEach(([R,J])=>{if(!J)return;(R.replace(/_/g," ").toLowerCase().includes(W)||J.toLowerCase().includes(W))&&_.push({type:"cr",key:R,code:J})})}else o===t?Object.entries(Pe).forEach(([W,R])=>{R&&_.push({type:"cr",key:W,code:R})}):$e[o]&&$e[o].emails.forEach(W=>{_.push({type:"email",data:W})});if(_.length===0){A.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px;">\u{1F50D}</div><div style="font-size:14px; margin-top:8px;">Nada encontrado.</div></div>';return}let X='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a73e8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',H='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fbbc04" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',he='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dadce0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';_.forEach(W=>{let R=document.createElement("div");if(Object.assign(R.style,q),W.type==="email"){let J=W.data,re=J.subject.length>40?J.subject.substring(0,40)+"...":J.subject;R.innerHTML=`

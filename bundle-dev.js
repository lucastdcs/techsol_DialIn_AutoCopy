...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var pe=e=>new Promise(t=>setTimeout(t,e));function fe(e,t="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,n[t]||n.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function st(e,t){if(!e)return;let n=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let r=e.getBoundingClientRect(),a=document.createElement("div");a.id=n,a.style.cssText=`
    ...
    `,a.innerHTML=`
        ...
        ">\xD7</div>
    `;let i=a.querySelector(".cw-close-btn");i.onclick=()=>{a.style.opacity="0",a.style.transform="translateY(-5px)",setTimeout(()=>a.remove(),300)},document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(a)&&i.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await pe(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await pe(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(n=>{let o=n.offsetParent!==null,r=n.closest("case-message-view")!==null,a=n.closest(".editor")!==null||n.closest("write-card")!==null;return o&&!r&&a});return t&&fe("Editor visualmente detectado.","success"),t}async function Zt(){fe("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");if(n&&n.offsetParent!==null){fe("Bot\xE3o de email direto encontrado.");let p=n.closest("material-button")||n.closest("material-fab")||n;Ce(p),e=!0}else{fe("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let p=document.querySelector("material-fab-speed-dial");if(p){let b=p.querySelector(".trigger");if(b){Ce(b),await pe(800);let v=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");v&&(Ce(v),e=!0)}}}if(!e)return oe("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;fe("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,r=0,a=20;for(;r<a;){await pe(250);let p=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(p).find(b=>b.offsetParent!==null),o){fe("\u26A0\uFE0F Rascunho detectado!","warn");break}r++}if(o){fe("\u{1F5D1}\uFE0F Descartando..."),Ce(o),o.click();let p=null,b=0;for(;b<15;){await pe(300);let N=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(p=Array.from(N).find(v=>v.offsetParent!==null),p)break;b++}p&&(Ce(p),oe("Limpando rascunho antigo...",{duration:2e3}),await pe(2500))}fe("\u{1F680} FASE 3: Buscando editor final...");let i=0,l=null;for(;i<20&&(l=kt(),!l);)await pe(250),i++;if(!l)return oe("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let g=l.closest('[id="email-body-content-top"]'),h=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(g){if(h){let b=h.closest('[aria-hidden="true"]');b&&b.removeAttribute("aria-hidden"),h.focus(),Ce(h)}await pe(300),g.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let p=g.querySelector("#cases-body-field");if(p){let b=document.createRange();b.selectNodeContents(p),b.collapse(!0);let N=window.getSelection();N.removeAllRanges(),N.addRange(b)}return!0}return!1}async function lt(e){if(!e||!await Zt())return;let n=await At();fe("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await pe(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let a=document.querySelector('input[aria-label="Enter To email address"]');a&&(await rt(a,n.clientEmail),st(a,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let a=document.querySelector('input[aria-label="Enter Bcc email address"]');a&&(await rt(a,n.internalEmail),st(a,`
            ...
            `))}await pe(500);let r=document.querySelector('material-button[debug-id="canned_response_button"]');if(r){Ce(r),await pe(1e3);let a=document.querySelector("material-auto-suggest-input input");if(a){Ce(a),document.execCommand("insertText",!1,e),a.dispatchEvent(new Event("input",{bubbles:!0})),fe("\u23F3 Buscando resultado da Canned Response...","info");let i=null,l=0,g=15e3,m=500;for(;l<g&&(i=document.querySelector("material-select-dropdown-item"),!i);)await pe(m),l+=m;if(i){Ce(i),await pe(1500);let h=kt();if(h&&n.advertiserName){let p=h.innerHTML;p.includes("{%ADVERTISER_NAME%}")&&(h.innerHTML=p.replace(/{%ADVERTISER_NAME%}/g,n.advertiserName))}oe("Canned Response aplicada!")}else fe(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),oe(`Timeout: Template '${e}' n\xE3o carregou.`,{error:!0})}}else oe("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function Jt(e){if(fe(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Zt())return;let n=await At(),o=vt();await pe(600),fe("\u{1F4E7} Processando destinat\xE1rios...");let r=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(r&&(r.click(),await pe(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await rt(l,n.clientEmail),st(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await rt(l,n.internalEmail),st(l,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
...
.cw-pill {
    ...
    gap: 8px; /* Espa\xE7o entre itens quando aberto */
    
    /* Tamanho e Forma (Estado Aberto Padr\xE3o) */
    width: 56px; /* Largura fixa para evitar balan\xE7o lateral */
    padding: 8px 0 16px 0; /* Padding assim\xE9trico para acomodar Grip e conte\xFAdo */
    max-height: 500px; /* Altura suficiente para todo conte\xFAdo */
    ...
    overflow: hidden; /* Corta conte\xFAdo no colapso */
    z-index: 2147483647;

    /* TRANSI\xC7\xD5ES CR\xCDTICAS UNIFICADAS */
    transition: 
        max-height 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), /* Colapso Vertical El\xE1stico */
        width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1),      /* Largura (importante p/ Ilha Din\xE2mica) */
        padding 0.4s ease,                               /* Ajuste de padding */
        gap 0.4s ease,
        background 0.3s ease,
        border-radius 0.5s ease,                         /* De 28px para 50% ou outro valor */
        opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1), /* Entrada */
        top 0.1s linear, left 0.1s linear;               /* Drag sem lag */
...
/* 1. O BOT\xC3O DA MARCA (PRINCIPAL) */
.cw-brand-btn {
    width: 44px; height: 44px; flex-shrink: 0;
    border-radius: 50%; border: none; background: transparent;
    display: flex; align-items: center; justify-content: center;
    cursor: pointer; position: relative; z-index: 20;
    color: #fff; /* \xCDcone Branco */
    transition: transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1);
}

/* Gradiente Sutil no Bot\xE3o */
.cw-brand-btn::before {
...
/* 2. A P\xCDLULA (CONTAINER) */


/* 3. ESTADO COLAPSADO (A BOLA) */
.cw-pill.collapsed {
    max-height: 56px !important; /* Altura exata do bot\xE3o */
...
/* Isso faz os \xEDcones sumirem r\xE1pido antes da p\xEDlula fechar */
...
/* Gira o \xEDcone principal ao fechar (Opcional, mas fica legal) */
.cw-pill.collapsed .cw-brand-btn { transform: rotate(-180deg); }
...
@keyframes googleBounce {
    ...
    `;let r=document.createElement("div");if(r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=u=>{u.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=u=>{u.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=u=>{u.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=u=>{u.stopPropagation(),e.toggleLinks()},o.querySelector(".broadcast").onclick=u=>{u.stopPropagation();let A=u.currentTarget.querySelector(".cw-badge");A&&(A.style.transform="scale(0)",setTimeout(()=>A.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let u=document.createElement("div");u.className="cw-badge",o.querySelector(".broadcast").appendChild(u)}let a=o.querySelector("#cw-brand-toggle"),i=!1;a.onclick=u=>{typeof l<"u"&&l||(u.stopPropagation(),i=!i,i?(o.classList.add("collapsed"),a.title="Expandir"):(o.classList.remove("collapsed"),a.title="Minimizar"))},(async function(){await ct(2800),o.classList.add("docked"),await ct(300);let A=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(q=>q.classList.add("visible"));for(let q=0;q<A.length;q++)A[q].classList.add("popped"),await ct(90);await ct(200),o.classList.add("system-check")})();let l=!1,g,m,h,p,b=3;o.onmousedown=u=>{if(u.target.closest("button"))return;u.preventDefault(),g=u.clientX,m=u.clientY;let A=o.getBoundingClientRect();h=A.left,p=A.top,document.addEventListener("mousemove",N),document.addEventListener("mouseup",v)};function N(u){let A=u.clientX-g,O=u.clientY-m;!l&&Math.sqrt(A*A+O*O)>b&&(l=!0,o.style.transition="none"),l&&(o.style.left=`${h+A}px`,o.style.top=`${p+O}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function v(u){if(document.removeEventListener("mousemove",N),document.removeEventListener("mouseup",v),l){l=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let A=window.innerWidth,O=window.innerHeight,q=o.getBoundingClientRect(),Y=q.left+q.width/2,G;Y<A/2?(G=24,o.classList.remove("side-right"),o.classList.add("side-left")):(G=A-q.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let f=q.top;f<24&&(f=24),f>O-q.height-24&&(f=O-q.height-24),o.style.left=`${G}px`,o.style.top=`${f}px`}else{let A=u.target.closest("button");A&&(A.style.transform="scale(0.9)",setTimeout(()=>A.style.transform="",150))}}}function dt(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let n=document.createElement("div");n.className="cw-center-stage",n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(f)}let l=document.createElement("div");l.className="cw-zen-container";let g=document.createElement("div");Object.assign(g.style,{display:"none"});let m=document.createElement("div");m.className="cw-screens-container",g.appendChild(m),l.innerHTML=`
    ...
    `;let h=l.querySelector(".cw-hero-grid"),p=l.querySelector(".cw-acc-container"),b=l.querySelector(".cw-results-container"),N=l.querySelector(".cw-search-input"),v=l.querySelector(".cw-status-bar"),u=l.querySelector(".cw-status-text"),A=l.querySelector(".cw-footer-icons");r.forEach(([f,x])=>{let s=o(x.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${f}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let d=t[f]?t[f].count:0;q(f,d>0?-d:1,x)},c.querySelector(".minus").onclick=()=>q(f,-1,x),c.querySelector(".plus").onclick=()=>q(f,1,x),c.dataset.color=s.color,h.appendChild(c)});function O(f,x){let s=o(x.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=f,c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let d=t[f]?t[f].count:0;q(f,d>0?-d:1,x)},c.querySelector(".minus").onclick=()=>q(f,-1,x),c.querySelector(".plus").onclick=()=>q(f,1,x),c}Object.entries(a).forEach(([f,x])=>{let s=document.createElement("div");s.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${x.brand.color}"></div>
                ${f}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{p.querySelectorAll(".cw-acc-group.open").forEach(d=>{d!==s&&d.classList.remove("open")}),s.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",x.tasks.forEach(d=>{let y=O(d.key,d);w.appendChild(y)}),s.appendChild(c),s.appendChild(w),p.appendChild(s)});function q(f,x,s){t[f]||(t[f]={count:0,data:s,brand:o(s.name)}),t[f].count+=x,t[f].count<=0&&delete t[f],Y(),G(),e&&e()}function Y(){r.forEach(([w])=>{let d=h.querySelector(`#hero-${w}`);if(!d)return;let y=t[w];y?(d.classList.add("active"),d.querySelector(".cw-step-val").textContent=y.count,d.querySelector(".cw-step-val").style.color=d.dataset.color):d.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(w=>{let d=w.dataset.id,y=t[d];y?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=y.count):w.classList.remove("selected")});let x=Object.keys(t),s=0,c=[];if(x.forEach(w=>{let d=t[w];s+=d.count;for(let y=0;y<d.count;y++)c.length<6&&c.push(d.brand)}),s>0){v.classList.add("visible");let w=s>1?"A\xE7\xF5es":"A\xE7\xE3o",d=s>1?"definidas":"definida";u.textContent=`${s} ${w} ${d}`,A.innerHTML="",c.forEach(y=>{let k=document.createElement("div");k.className="cw-mini-icon",k.innerHTML=He[y.icon]||He.default;let S=k.querySelector("svg");S&&(S.style.width="14px",S.style.height="14px"),A.appendChild(k)})}else v.classList.remove("visible")}N.addEventListener("input",f=>{let x=f.target.value.toLowerCase();if(x.length>0){p.style.display="none",b.style.display="block",b.innerHTML="";let s=!1;Object.entries(Re).forEach(([c,w])=>{if(w.name.toLowerCase().includes(x)){s=!0;let d=O(c,w);t[c]&&(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=t[c].count),b.appendChild(d)}}),s||(b.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else p.style.display="block",b.style.display="none"});function G(){m.innerHTML="";let f=Object.keys(t),x=!1,s=document.getElementById("sub-status"),c="implementation";if(s&&s.value.toLowerCase().includes("education")&&(c="education"),f.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(f.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`
        ...
        `,m.appendChild(w),f.forEach(d=>{let y=t[d].data,k=t[d].count,S=t[d].brand,T=y.screenshots?y.screenshots[c]||[]:["Link da Evid\xEAncia"];if(T.length>0){x=!0;for(let ne=1;ne<=k;ne++){let z=document.createElement("div");z.className="cw-screen-card",z.style.setProperty("--brand-color",S.color),z.style.setProperty("--brand-bg",S.bg),z.style.setProperty("--brand-shadow",S.color+"40");let L=document.createElement("div");L.className="cw-card-header";let R=document.createElement("div");R.className="cw-card-icon",R.innerHTML=He[S.icon]||He.default;let j=document.createElement("div");j.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let X=document.createElement("input");X.className="cw-card-title-input",X.id=`name-${d}-${ne}`,X.value=`${y.name}${k>1?" #"+ne:""}`,X.title="Clique para renomear esta task";let P=document.createElement("span");P.className="cw-edit-hint",P.innerHTML="\u270E Renomear",j.appendChild(X),j.appendChild(P),L.appendChild(R),L.appendChild(j),z.appendChild(L),T.forEach((he,U)=>{let _=document.createElement("div");_.className="cw-input-group";let J=document.createElement("label");J.className="cw-input-label",J.textContent=he.replace(/📷|:|•/g,"").trim();let re=document.createElement("input");re.className="cw-input-field",re.id=`screen-${d}-${ne}-${U}`,re.placeholder="Cole o link aqui...",re.setAttribute("autocomplete","off"),re.addEventListener("input",()=>{re.value.trim().length>5?re.classList.add("filled"):re.classList.remove("filled")});let ge=document.createElement("div");ge.className="cw-input-check",ge.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',_.appendChild(J),_.appendChild(re),_.appendChild(ge),z.appendChild(_)}),m.appendChild(z)}}}),g.style.display=x?"block":"none"}return{selectionElement:l,screenshotsElement:g,updateSubStatus:()=>G(),getCheckedElements:()=>Object.keys(t).map(f=>({value:f,closest:()=>({querySelector:()=>({textContent:t[f].count})})})),toggleTask:(f,x=!0)=>{let s=t[f];x&&!s?q(f,1,Re[f]):!x&&s&&q(f,-s.count,Re[f])},setMode:f=>{n=f,G()},reset:()=>{for(let f in t)delete t[f];N.value="",p.style.display="block",b.style.display="none",Y(),G()}}}function go(){let e="v3.6.0",t="bau",n="pt",o=!1,r=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},i=uo(),l=mo(()=>{let M=l.getCheckedElements().map(E=>E.value);S&&S.value&&i.updateVisibility(S.value,M)}),g=document.createElement("div");g.id="autofill-popup",g.classList.add("cw-module-window"),Object.assign(g.style,we,{right:"100px",width:"400px",transition:"width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)"});let h=Ee(g,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:g,googleLine:null},()=>yt());g.appendChild(h);let p=document.createElement("div");Object.assign(p.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),g.appendChild(p);let b=document.createElement("div");b.textContent="created by lucaste@",Object.assign(b.style,Wt),g.appendChild(b);let N=document.createElement("div");N.id="step-lang-type";let v=document.createElement("label");Object.assign(v.style,a.label),N.appendChild(v);let u=document.createElement("div");Object.assign(u.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let A=document.createElement("div");A.textContent="Portugu\xEAs",A.classList.add("no-drag"),Object.assign(A.style,be);let O=document.createElement("div");O.textContent="Espa\xF1ol",O.classList.add("no-drag"),Object.assign(O.style,be),A.onclick=()=>bt("pt"),O.onclick=()=>bt("es"),u.appendChild(A),u.appendChild(O),N.appendChild(u),p.appendChild(N);let q=document.createElement("div");q.id="step-0-case-type";let Y=document.createElement("label");Object.assign(Y.style,a.label),q.appendChild(Y);let G=document.createElement("div");Object.assign(G.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let f=document.createElement("div");f.textContent="BAU",f.classList.add("no-drag"),Object.assign(f.style,be);let x=document.createElement("div");x.textContent="LM",x.classList.add("no-drag"),Object.assign(x.style,be),f.onclick=()=>gt("bau"),x.onclick=()=>gt("lm"),G.appendChild(f),G.appendChild(x),q.appendChild(G),p.appendChild(q);let s=document.createElement("div");s.id="step-1-selection";let c=document.createElement("label");c.className="cw-input-label",c.textContent="Status Principal";let w=document.createElement("select");w.id="main-status",w.className="cw-select",w.innerHTML=`
  ...
  `;let d=document.createElement("div");d.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let y=document.createElement("label");y.className="cw-input-label",y.textContent="Sub-status",y.style.marginBottom="0";let k=document.createElement("a");k.href="https://seu-link-do-guia-aqui.com",k.target="_blank",k.className="cw-info-link",k.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(k.style,a.helpLink),d.appendChild(y),d.appendChild(k);let S=document.createElement("select");S.id="sub-status",S.className="cw-select",S.disabled=!0,S.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',s.appendChild(c),s.appendChild(w),s.appendChild(d),s.appendChild(S),p.appendChild(s);let T=document.createElement("div");T.id="step-1-1-portugal",Object.assign(T.style,a.stepBlock,{display:"none"});let ne=document.createElement("label");Object.assign(ne.style,a.label),T.appendChild(ne);let z=document.createElement("div");Object.assign(z.style,a.radioContainer);let L=document.createElement("div");Object.assign(L.style,{display:"flex",alignItems:"center"});let R=document.createElement("input");R.type="radio",R.name="portugal-group",R.value="sim",Object.assign(R.style,a.checkboxInput);let j=document.createElement("label");j.htmlFor="portugal-sim",Object.assign(j.style,{cursor:"pointer"}),L.appendChild(R),L.appendChild(j);let X=document.createElement("div");Object.assign(X.style,{display:"flex",alignItems:"center"});let P=document.createElement("input");P.type="radio",P.name="portugal-group",P.value="nao",P.checked=!0,Object.assign(P.style,a.checkboxInput);let he=document.createElement("label");he.htmlFor="portugal-nao",Object.assign(he.style,{cursor:"pointer"}),X.appendChild(P),X.appendChild(he),z.appendChild(L),z.appendChild(X),T.appendChild(z),p.appendChild(T);function U(C){o=C,C?_.style.display="block":_.style.display="none"}R.onchange=()=>U(!0),P.onchange=()=>U(!1);let _=document.createElement("div");_.id="step-1-2-consent",Object.assign(_.style,a.stepBlock,{display:"none"});let J=document.createElement("label");Object.assign(J.style,a.label),_.appendChild(J);let re=document.createElement("div");Object.assign(re.style,a.radioContainer);let ge=document.createElement("div");Object.assign(ge.style,{display:"flex",alignItems:"center"});let ve=document.createElement("input");ve.type="radio",ve.name="consent-group",ve.value="Sim",ve.checked=!0,Object.assign(ve.style,a.checkboxInput);let ie=document.createElement("label");ie.htmlFor="consent-sim",Object.assign(ie.style,{cursor:"pointer"}),ge.appendChild(ve),ge.appendChild(ie);let ee=document.createElement("div");Object.assign(ee.style,{display:"flex",alignItems:"center"});let Oe=document.createElement("input");Oe.type="radio",Oe.name="consent-group",Oe.value="N\xE3o",Object.assign(Oe.style,a.checkboxInput);let Le=document.createElement("label");Le.htmlFor="consent-nao",Object.assign(Le.style,{cursor:"pointer"}),ee.appendChild(Oe),ee.appendChild(Le),re.appendChild(ge),re.appendChild(ee),_.appendChild(re),p.appendChild(_);let Me=document.createElement("div");Me.id="step-1-5-snippets",Object.assign(Me.style,a.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,a.h3),nt.textContent="Cen\xE1rios Comuns";let Ae=so(C=>{let M=document.querySelector("textarea");M&&(M.value=C,M.dispatchEvent(new Event("input")),M.style.transition="background-color 0.2s",M.style.backgroundColor="#e8f0fe",setTimeout(()=>M.style.backgroundColor="#fff",300))});Ae.id="snippet-container",Me.appendChild(nt),Me.appendChild(Ae),p.appendChild(Me);let xe=document.createElement("div");xe.id="step-3-form",Object.assign(xe.style,a.stepBlock,{display:"none"});let mt=document.createElement("h3");Object.assign(mt.style,a.h3),xe.appendChild(mt);let _e=document.createElement("div");_e.id="dynamic-form-fields-container",xe.appendChild(_e);let ue=document.createElement("button");ue.textContent="+ Gostaria de selecionar uma task?",Object.assign(ue.style,a.optionalBtn),ue.onmouseover=()=>ue.style.background="#e8f0fe",ue.onmouseout=()=>ue.style.background="white",ue.onclick=()=>{ue.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};let De=document.createElement("h3");Object.assign(De.style,a.h3,{marginTop:"20px"});let Rt=l.selectionElement;Object.assign(Rt.style,{marginBottom:"20px"}),xe.appendChild(ue),xe.appendChild(De),xe.appendChild(Rt),xe.appendChild(i.element),xe.appendChild(l.screenshotsElement),p.appendChild(xe);let Fe=document.createElement("div");Fe.id="step-4-email",Object.assign(Fe.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let ze=document.createElement("input");ze.type="checkbox",ze.checked=!0,Object.assign(ze.style,a.checkboxInput),Ge.appendChild(ze),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),Fe.appendChild(Ge),p.appendChild(Fe);let We=document.createElement("div");Object.assign(We.style,{display:"none",gap:"8px",padding:"0"}),p.appendChild(We);let Ke=document.createElement("button");Object.assign(Ke.style,a.buttonBase,{backgroundColor:"#5f6368"}),Ke.textContent="Copiar";let Qe=document.createElement("button");Object.assign(Qe.style,a.buttonBase,{backgroundColor:"#1a73e8"}),Qe.textContent="Preencher",We.appendChild(Ke),We.appendChild(Qe);let Ze=document.createElement("div");Object.assign(Ze.style,Ye),Ze.className="no-drag",Ze.title="Redimensionar",g.appendChild(Ze),Xe(g,Ze),document.body.appendChild(g);function gt(C){t=C;let M=Je();Object.assign(f.style,be),Object.assign(x.style,be),C==="bau"?(Object.assign(f.style,M),k.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(x.style,M),k.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),S.value&&S.dispatchEvent(new Event("change"))}function V(C){try{if(Ne&&Ne[n]&&Ne[n][C])return Ne[n][C];if(Ne&&Ne.pt&&Ne.pt[C])return Ne.pt[C]}catch{}return C}function vo(){v.textContent=V("idioma"),Y.textContent=V("fluxo"),c.textContent=V("status_principal"),y.textContent=V("substatus"),nt.textContent=V("cenarios_comuns"),De.textContent=V("selecione_tasks"),mt.textContent=V("preencha_detalhes"),Ke.textContent=V("copiar"),Qe.textContent=V("preencher"),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=V("select_status")),S.querySelector('option[value=""]')&&(S.querySelector('option[value=""]').textContent=V("select_substatus")),ne.textContent=V("caso_portugal"),j.textContent=V("sim"),he.textContent=V("nao"),J.textContent=V("consentiu_gravacao"),ie.textContent=V("sim"),Le.textContent=V("nao"),_e.querySelectorAll("label").forEach(C=>{let M=C.nextElementSibling.id.replace("field-",""),E=V(M.toLowerCase());E!==M.toLowerCase()?C.textContent=E:C.textContent=M.replace(/_/g," ").replace(/\b\w/g,H=>H.toUpperCase())+":"}),ue.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function bt(C){n=C;let M=Je();Object.assign(A.style,be),Object.assign(O.style,be),C==="pt"?(Object.assign(A.style,M),T.style.display="block",U(o)):(Object.assign(O.style,M),T.style.display="none",_.style.display="none"),vo(),S.value&&S.dispatchEvent(new Event("change"))}function ft(C){(C.value.trim()===""||C.value.trim()==="\u2022")&&(C.value="\u2022 "),C.onkeydown=function(M){if(M.key==="Enter"){M.preventDefault();let E=this.selectionStart,H=this.selectionEnd,ae=this.value,ce=ae.lastIndexOf(`
`,E-1)+1,ye=ae.substring(ce,E),de=ye.trim()==="\u2022"||ye.trim()===""?`
`:`
\u2022 `;this.value=ae.substring(0,E)+de+ae.substring(H),this.selectionStart=this.selectionEnd=E+de.length}else if(M.key==="Backspace"){let E=this.selectionStart;if(E===this.selectionEnd&&E>0){let H=this.value.substring(0,E);H.endsWith(`
\u2022 `)?(M.preventDefault(),this.value=H.substring(0,E-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=E-3):H==="\u2022 "&&(M.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function ht(){let C=typeof Ae<"u"?Ae:document.getElementById("snippet-container");if(!C)return;let M=C.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),E={},H=new Set;M.forEach(Q=>{let K=Q.id,D=Se[K];if(D)for(let I in D)I==="linkedTask"?H.add(D.linkedTask):I!=="type"&&(E[I]||(E[I]=[]),E[I].includes(D[I])||E[I].push(D[I]))});let ae=new Set;Object.values(Se).forEach(Q=>{Object.keys(Q).forEach(K=>{K!=="linkedTask"&&K!=="type"&&ae.add(K)})}),ae.forEach(Q=>{let K=document.getElementById(Q);if(K){let D=E[Q]||[],I="";ot.includes(Q.replace("field-",""))?(I=D.map(W=>W.startsWith("\u2022 ")?W:"\u2022 "+W).join(`
`),I===""?I="\u2022 ":I.endsWith(`
\u2022 `)||(I+=`
\u2022 `)):I=D.join(`

`),I.trim()!=="\u2022"&&I.trim()!==""?K.value=I:ot.includes(Q.replace("field-",""))?K.value="\u2022 ":K.value="",K.tagName==="TEXTAREA"&&typeof ft=="function"&&ft(K)}});let ce=new Set,ye=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(Q=>{let K=Se[Q.id];K&&K.linkedTask&&(Q.checked?ce.add(K.linkedTask):ye.add(K.linkedTask))}),ye.forEach(Q=>{ce.has(Q)||l.toggleTask(Q,!1)}),ce.forEach(Q=>{l.toggleTask(Q,!0)})}w.onchange=()=>{let C=w.value;if(xt(1.5),S.innerHTML=`<option value="">${V("select_substatus")}</option>`,!C){S.disabled=!0;return}for(let M in tt){let E=tt[M];if(E.status===C){let H=document.createElement("option");H.value=M,H.textContent=E.name,S.appendChild(H)}}S.disabled=!1},S.onchange=()=>{let C=S.value;if(xt(1.5),!C)return;l.updateSubStatus(C);let M=tt[C];Ae.innerHTML="";let E=(D,I,W)=>{let se=document.createElement("label");Object.assign(se.style,a.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let te=document.createElement("input");return te.type=I,te.id=D.id,Object.assign(te.style,a.checkboxInput),se.appendChild(te),se.appendChild(document.createTextNode(` ${D.text}`)),W.appendChild(se),te},H=[],ae="radio";if(C==="NI_Awaiting_Inputs")H=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))ae="checkbox",H=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(C.startsWith("AS_")){ae="checkbox";let D=document.createElement("label");D.textContent=V("cenarios_comuns"),Object.assign(D.style,a.label),Ae.appendChild(D),H=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")?H=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:C.startsWith("DC_")&&(ae="radio",H=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let ce=H.filter(D=>{let I=Se[D.id];return!I.type||I.type==="all"||I.type===t});ce.forEach((D,I)=>{let W=E(D,ae,Ae);ae==="radio"&&(W.name="scenario-radio-group",I===0&&(W.checked=!0))}),ce.length>0&&(Me.style.display="block"),M.requiresTasks?(ue.style.display="none",De.style.display="block",l.selectionElement.style.display="block"):(ue.style.display="block",De.style.display="none",l.selectionElement.style.display="none"),_e.innerHTML="";let ye=M.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(ye)].forEach(D=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(D))return;let I=D.slice(1,-1),W=document.createElement("label"),se=V(I.toLowerCase());if(W.textContent=se!==I.toLowerCase()?se:I.replace(/_/g," ").replace(/\b\w/g,B=>B.toUpperCase())+":",Object.assign(W.style,a.label),I==="SPEAKEASY_ID"){let B=document.createElement("button");B.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',B.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,B.title="Localizar Speakeasy ID no hist\xF3rico",B.onmouseover=()=>{B.style.backgroundColor="#c2e7ff",B.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},B.onmouseout=()=>{B.style.backgroundColor="#d3e3fd",B.style.boxShadow="none"},B.onmousedown=()=>{B.style.backgroundColor="#a8c7fa",B.style.transform="scale(0.96)"},B.onmouseup=()=>B.style.transform="scale(1)",B.onclick=me=>{me.preventDefault(),Qt(`field-${I}`)},W.appendChild(B)}let te;ot.includes(I)?(te=document.createElement("textarea"),Object.assign(te.style,a.textarea),te.classList.add("bullet-textarea"),ft(te)):Tt.includes(I)?(te=document.createElement("textarea"),Object.assign(te.style,a.textarea)):(te=document.createElement("input"),te.type="text",Object.assign(te.style,a.input),I==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign(W.style,{display:"none"}),Object.assign(te.style,{display:"none"}))),I==="ON_CALL"&&t==="lm"&&(Object.assign(W.style,{display:"none"}),Object.assign(te.style,{display:"none"}),te.value="N/A"),te.id=`field-${I}`,_e.appendChild(W),_e.appendChild(te)});let Q=Ae.querySelectorAll('input[type="checkbox"], input[type="radio"]');Q.length>0&&(Q.forEach(D=>{D.removeEventListener("change",ht),D.addEventListener("change",ht)}),ht()),xe.style.display="block",Pe[C]?Fe.style.display="block":Fe.style.display="none",We.style.display="flex";let K=l.getCheckedElements().map(D=>D.value);i.updateVisibility(C,K)},ue.onclick=()=>{ue.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};function Lt(){let C=S.value;if(!C)return null;let E=tt[C].template.replace(/\n/g,"<br>"),H='style="margin-bottom: 12px; padding-left: 30px;"',ae=[],ce="",ye=l.getCheckedElements();ye.length>0&&ye.forEach(K=>{let D=K.value,I=Re[D],W=K.closest().querySelector(".stepper-count"),se=W?parseInt(W.textContent):1;se>1?ae.push(`${I.name} (x${se})`):ae.push(I.name)});let de=l.screenshotsElement;if(de){let K=Array.from(de.querySelectorAll('input[id^="name-"]'));K.length>0&&K.forEach(D=>{let I=D.value,W=D.closest(".cw-screen-card");if(W){let se=W.querySelectorAll('input[id^="screen-"]'),te=!1,B="";se.forEach(me=>{let Mt=me.closest(".cw-input-group"),Dt=Mt?Mt.querySelector(".cw-input-label"):null,Ao=Dt?Dt.textContent:"Evid\xEAncia",Ft=me.value.trim(),wo=Ft?` ${Ft}`:"";B+=`<li>${Ao} -${wo}</li>`,te=!0}),te&&(ce+=`<b>${I}</b>`,ce+=`<ul ${H}>${B}</ul>`)}})}if(E.includes("{TAGS_IMPLEMENTED}")?E=E.replace(/{TAGS_IMPLEMENTED}/g,ae.join(", ")||"N/A"):ae.length>0&&(E+=`<br><b>Tags:</b> ${ae.join(", ")}<br>`),E.includes("{SCREENSHOTS_LIST}")?E=E.replace(/{SCREENSHOTS_LIST}/g,ce?`${ce}`:"N/A"):ce!==""&&(E+=`<br>${ce}`),n==="pt"&&o){let K=ve.checked?V("sim"):V("nao");E=E.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${V("consentiu_gravacao")}</b> ${K}<br><br>`),E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${V("caso_portugal")}</b> ${V("sim")}<br>`)}else n==="pt"&&!o?(E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${V("caso_portugal")}</b> ${V("nao")}<br>`),E=E.replace(/{CONSENTIU_GRAVACAO}/g,"")):(E=E.replace(/{CASO_PORTUGAL}/g,""),E=E.replace(/{CONSENTIU_GRAVACAO}/g,""));return _e.querySelectorAll("input, textarea").forEach(K=>{let D=K.id.replace("field-",""),I=new RegExp(`{${D}}`,"g"),W=K.value;if(D==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let B=Ae.querySelector('input[type="radio"]:checked');B&&Se[B.id]&&(W=Se[B.id]["field-REASON_COMMENTS"])}if(ot.includes(D)&&W.trim()!==""){let B=W.split(`
`).map(me=>me.trim()).filter(me=>me!==""&&me!=="\u2022").map(me=>me.startsWith("\u2022 ")?me.substring(2):me).map(me=>`<li>${me}</li>`).join("");W=B?`<ul ${H}>${B}</ul>`:""}else Tt.includes(D)?W=W.split(`
`).filter(B=>B.trim()!=="").map(B=>`<p style="margin: 0 0 8px 0;">${B}</p>`).join(""):K.tagName==="TEXTAREA"&&(W=W.replace(/\n/g,"<br>"));let se=W.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let B=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${D}\\}(?:<br>\\s*)?`,"gi");B.test(E)?E=E.replace(B,""):E=E.replace(I,"")}else E=E.replace(I,W.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(E+=i.getOutput()),E}Ke.onclick=()=>{let C=Lt();C?(It(C),oe(V("copiado_sucesso"))):oe(V("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=S.value,M=Lt();if(!M){oe(V("selecione_substatus"),{error:!0});return}It(M),yt();let E=dt(),H=await po();if(H)try{if(H.focus(),H.innerHTML.trim()==="<p><br></p>"||H.innerHTML.trim()==="<br>"||H.innerText.trim()===""){let de=document.createRange();de.selectNodeContents(H);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(de),document.execCommand("delete",!1,null)}else if(!H.innerHTML.endsWith("<br><br>")){let de=document.createRange();de.selectNodeContents(H),de.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(de),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,M),co(H),setTimeout(()=>{oe(V("inserido_copiado"))},600);let ce=typeof ze<"u"&&ze?ze.checked:!0;if(C&&Pe[C]&&ce){let de=Pe[C];await lt(de),await new Promise(Q=>setTimeout(Q,500))}E(),xt(1.5),w.value="",S.innerHTML=`<option value="">${V("select_substatus")}</option>`,S.disabled=!0}catch(ae){console.error(ae),oe("Erro ao inserir.",{error:!0}),E()}};function xt(C=1.5){C<=1.5&&(Me.style.display="none",Ae.innerHTML=""),C<=2&&(l.reset(),ue.style.display="none"),C<=3&&(xe.style.display="none",_e.innerHTML="",i.reset(),We.style.display="none",Fe.style.display="none")}function yt(){if(r=!r,r){let C=g.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Te(r,g,"cw-btn-notes")}return gt("bau"),bt("pt"),yt}var $e={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
        ...
        `,y.querySelector("#csa-back-btn").onclick=T;let P=y.querySelector("#csa-insert-btn");P.onclick=()=>{P.style.transform="scale(0.96)",k(R,"email"),setTimeout(()=>{P.style.transform="scale(1)",T()},300)}}function T(){r="list",Y.style.transform="translateX(0)"}function ne(R,j,X=null){let P=document.createElement("button");return P.innerHTML=X?`<span style="margin-right:4px">${X}</span>${R}`:R,Object.assign(P.style,p),n===j&&o===""&&Object.assign(P.style,b),P.onclick=()=>{n=j,o="",s.value="",z(),L()},P}function z(){c.innerHTML="",c.appendChild(ne("Smart CRs",t,"\u26A1")),Object.keys($e).forEach(R=>{c.appendChild(ne($e[R].title,R))})}function L(){w.innerHTML="";let R=[];if(o.trim()!==""){let U=o.toLowerCase();Object.values($e).forEach(_=>{_.emails.forEach(J=>{(J.name.toLowerCase().includes(U)||J.subject.toLowerCase().includes(U))&&R.push({type:"email",data:J})})}),Object.entries(Pe).forEach(([_,J])=>{if(!J)return;(_.replace(/_/g," ").toLowerCase().includes(U)||J.toLowerCase().includes(U))&&R.push({type:"cr",key:_,code:J})})}else n===t?Object.entries(Pe).forEach(([U,_])=>{_&&R.push({type:"cr",key:U,code:_})}):$e[n]&&$e[n].emails.forEach(U=>{R.push({type:"email",data:U})});if(R.length===0){w.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px;">\u{1F50D}</div><div style="font-size:14px; margin-top:8px;">Nada encontrado.</div></div>';return}let X='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a73e8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',P='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fbbc04" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',he='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dadce0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';R.forEach(U=>{let _=document.createElement("div");if(Object.assign(_.style,N),U.type==="email"){let J=U.data,re=J.subject.length>40?J.subject.substring(0,40)+"...":J.subject;_.innerHTML=`
                ...
                `,_.onclick=()=>S(J)}else{let J=U.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");_.innerHTML=`
  ...
  `,Object.assign(u.style,t.resetBtn),u.onmouseenter=()=>u.style.background="#fce8e6",u.onmouseleave=()=>u.style.background="transparent",u.onclick=()=>{u.style.transform="scale(0.9)",setTimeout(()=>u.style.transform="scale(1)",150);for(let k in n)delete n[k];c()},N.appendChild(v),N.appendChild(u),i.appendChild(N);let A=document.createElement("div");Object.assign(A.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let O=document.createElement("div");Object.assign(O.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let q=document.createElement("div");q.textContent="BAU";let Y=document.createElement("div");Y.textContent="LT",Object.assign(q.style,be),Object.assign(Y.style,be),O.appendChild(q),O.appendChild(Y);let G=document.createElement("select");Object.assign(G.style,Ut,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),G.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',G.value=o,A.appendChild(O),A.appendChild(G),b.appendChild(A);let f=document.createElement("div");f.id="csa-checklist-area",b.appendChild(f);let x=document.createElement("div");Object.assign(x.style,Ye),x.className="no-drag",x.title="Redimensionar",i.appendChild(x),Xe(i,x),document.body.appendChild(i);function s(k){return k}function c(){f.innerHTML="";let k=`${o} ${r}`,S=fo[k];if(!S){f.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,Object.assign(c.style,a),c.style.display="inline-flex",c.style.alignItems="center",t===x&&n===""&&Object.assign(c.style,i),c.onmousedown=()=>c.style.transform="scale(0.95)",c.onmouseup=()=>c.style.transform="scale(1)",c.onmouseleave=()=>c.style.transform="scale(1)",c.onclick=()=>{t=x,n="",u.value="",Y(),G()},A.appendChild(c)})}function G(){O.innerHTML="";let x=[],s=n.trim()!=="";if(s?Object.entries(ut).forEach(([c,w])=>{let d=w.links.filter(y=>y.name.toLowerCase().includes(n.toLowerCase())||y.desc.toLowerCase().includes(n.toLowerCase()));d.forEach(y=>{y._catIcon=h[c],y._categoryName=w.label}),x=[...x,...d]}):(x=ut[t].links,x.forEach(c=>c._catIcon=h[t])),x.length===0){O.innerHTML=`
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
           ...
           `,v.appendChild(y)}let w=c.filter(y=>!s.includes(y.id)),d=c.filter(y=>s.includes(y.id));if(w.forEach(y=>v.appendChild(Y(y,!1))),d.length>0){let y=document.createElement("div");Object.assign(y.style,i.historyDivider),y.innerHTML=`<span>Visualizar ${d.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let k=document.createElement("div");Object.assign(k.style,i.historyContainer),d.forEach(T=>k.appendChild(Y(T,!0)));let S=!1;y.onclick=()=>{Z.playClick(),S=!S,k.style.display=S?"flex":"none",y.querySelector("svg").style.transform=S?"rotate(180deg)":"rotate(0deg)",y.querySelector("span").textContent=S?"Ocultar hist\xF3rico":`Visualizar ${d.length} avisos anteriores`},v.appendChild(y),v.appendChild(k)}}function Y(s,c){let w=document.createElement("div");Object.assign(w.style,c?i.cardHistory:i.card);let d=a[s.type]||a.info,y=document.createElement("div");Object.assign(y.style,i.cardHeader,{background:d.bg,color:d.text,borderBottom:`1px solid ${d.border}`});let k=document.createElement("div");if(Object.assign(k.style,{display:"flex",alignItems:"center",gap:"6px"}),k.innerHTML=`${d.icon} <span>${s.type.toUpperCase()}</span>`,y.appendChild(k),c){let T=document.createElement("span");T.textContent=r(s.date),T.style.opacity="0.7",y.appendChild(T)}else{let T=document.createElement("button");T.title="Marcar como lido",Object.assign(T.style,i.dismissBtn),T.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',T.onmouseenter=()=>{T.style.color="#1e8e3e",T.style.background="#e6f4ea",T.style.borderColor="#1e8e3e"},T.onmouseleave=()=>{T.style.color="#5f6368",T.style.background="#fff",T.style.borderColor="rgba(0,0,0,0.1)"},T.onclick=ne=>{ne.stopPropagation(),Z.playClick(),w.style.transform="translateX(20px)",w.style.opacity="0",setTimeout(()=>{let z=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");z.push(s.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(z)),q(),A()},250)},y.appendChild(T)}if(w.appendChild(y),s.title){let T=document.createElement("div");Object.assign(T.style,i.msgTitle),T.textContent=s.title,w.appendChild(T)}if(!c){let T=document.createElement("div");Object.assign(T.style,i.metaContainer),T.innerHTML=`<span style="font-weight:600">${s.author}</span> \u2022 <span>${r(s.date)}</span>`,w.appendChild(T)}let S=document.createElement("div");return Object.assign(S.style,i.cardBody),S.innerHTML=g(s.text),w.appendChild(S),w}q();let G=document.createElement("div");Object.assign(G.style,Ye),G.className="no-drag",m.appendChild(G),Xe(m,G),document.body.appendChild(m);let f=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),x=Ue.some(s=>!f.includes(s.id));return{toggle:p,hasUnread:x}}function Lo(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Ht();try{Z.initGlobalListeners(),Z.playStartup()}catch(a){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",a)}Ve.fetchTips(),Et();let e=go(),t=bo(),n=ho(),o=xo(),r=yo();io({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:r})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),oe("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Lo();})();

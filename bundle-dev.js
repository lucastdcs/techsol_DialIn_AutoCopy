(()=>{var at="",bo=e=>new Promise(t=>setTimeout(t,e));async function Lt(){if(at)return at;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await bo(100);let t="Consultor",n=document.querySelector("profile-details .name");if(n)t=n.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let a=o.src.match(/\/photos\/([^\?]+)/)[1];t=a.charAt(0).toUpperCase()+a.slice(1)}}return e.click(),document.body.click(),at=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function ft(){return at||"Consultor"}function Mt(e){let t=new Date,n=t.getHours(),o=t.getDay(),a="Ol\xE1",s="";n>=5&&n<12?(a="Bom dia",s='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):n>=12&&n<18?(a="Boa tarde",s='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(a="Boa noite",s='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let i=[];n>=0&&n<5?i=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:n<12?o===1?i=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?i=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:i=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:n<18?i=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:i=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(i=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let l=i[Math.floor(Math.random()*i.length)];return{prefix:`${a},`,name:e,suffix:l,icon:s,isFriday:o===5}}function ht(){let e="Cliente",t="[INSERIR URL]";try{let o=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let a=o.nextElementSibling.innerText.trim();a&&(e=a)}}catch(n){console.warn("Falha ao capturar Nome:",n)}try{let o=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let a=o.nextElementSibling.innerText.trim();a&&(t=a)}}catch(n){console.warn("Falha ao capturar Website:",n)}return{advertiserName:e,websiteUrl:t,agentName:ft()}}var Be=null,xt=null,Oe=.3;function ze(){if(!Be){let e=window.AudioContext||window.webkitAudioContext;e&&(Be=new e)}return Be&&Be.state==="suspended"&&Be.resume(),Be}function Dt(e){if(xt)return xt;let t=e.sampleRate*2,n=e.createBuffer(1,t,e.sampleRate),o=n.getChannelData(0);for(let a=0;a<t;a++)o[a]=Math.random()*2-1;return xt=n,n}var J={playClick:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Dt(e);let o=e.createBiquadFilter();o.type="highpass",o.frequency.value=4e3;let a=e.createGain();a.gain.setValueAtTime(Oe*.8,t),a.gain.exponentialRampToValueAtTime(.001,t+.015),n.connect(o),o.connect(a),a.connect(e.destination),n.start(t),n.stop(t+.02)},playHover:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createOscillator();n.type="sine",n.frequency.setValueAtTime(400,t);let o=e.createGain();o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(Oe*.1,t+.005),o.gain.linearRampToValueAtTime(0,t+.02),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.03)},playSuccess:()=>{let e=ze();if(!e)return;let t=e.currentTime;[1046.5,1567.9].forEach((o,a)=>{let s=e.createOscillator(),i=e.createGain();s.type="sine",s.frequency.value=o,i.gain.setValueAtTime(0,t),i.gain.linearRampToValueAtTime(Oe*.6,t+.05),i.gain.exponentialRampToValueAtTime(.001,t+.6),s.connect(i),i.connect(e.destination),s.start(t),s.stop(t+.7)})},playGenieOpen:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Dt(e);let o=e.createBiquadFilter();o.type="lowpass",o.frequency.setValueAtTime(100,t),o.frequency.exponentialRampToValueAtTime(800,t+.2);let a=e.createGain();a.gain.setValueAtTime(0,t),a.gain.linearRampToValueAtTime(Oe*.5,t+.05),a.gain.linearRampToValueAtTime(0,t+.25),n.connect(o),o.connect(a),a.connect(e.destination),n.start(t),n.stop(t+.3)},playError:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="triangle",n.frequency.setValueAtTime(120,t),n.frequency.exponentialRampToValueAtTime(80,t+.1),o.gain.setValueAtTime(Oe,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.2)},playStartup:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain(),a=e.createBiquadFilter();n.type="square",n.frequency.setValueAtTime(150,t),n.frequency.exponentialRampToValueAtTime(10,t+.1),a.type="lowpass",a.frequency.value=300,o.gain.setValueAtTime(Oe*3,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),n.connect(a),a.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.2);let s=e.createOscillator(),i=e.createGain();s.type="sine",s.frequency.setValueAtTime(100,t),s.frequency.exponentialRampToValueAtTime(30,t+.5),i.gain.setValueAtTime(Oe*2.5,t),i.gain.exponentialRampToValueAtTime(.001,t+.5),s.connect(i),i.connect(e.destination),s.start(t),s.stop(t+.5),[55,55.4,110].forEach((u,m)=>{let x=e.createOscillator(),p=e.createGain(),S=e.createBiquadFilter();x.type="sawtooth",x.frequency.value=u,S.type="lowpass",S.frequency.setValueAtTime(20,t),S.frequency.linearRampToValueAtTime(800,t+.2),S.frequency.exponentialRampToValueAtTime(50,t+2.5),p.gain.setValueAtTime(0,t),p.gain.linearRampToValueAtTime(Oe*.5,t+.1),p.gain.exponentialRampToValueAtTime(.001,t+3),x.connect(S),S.connect(p),p.connect(e.destination),x.start(t),x.stop(t+3.1)})},playNotification:()=>{let e=ze();if(!e)return;let t=e.currentTime;[{freq:880,dur:1.2,vol:.6},{freq:1760,dur:.6,vol:.3}].forEach(o=>{let a=e.createOscillator(),s=e.createGain();a.type="sine",a.frequency.setValueAtTime(o.freq,t),s.gain.setValueAtTime(0,t),s.gain.linearRampToValueAtTime(Oe*o.vol,t+.004),s.gain.exponentialRampToValueAtTime(.001,t+o.dur),a.connect(s),s.connect(e.destination),a.start(t),a.stop(t+o.dur+.1)})},playSwoosh:()=>{J.playGenieOpen()},playReset:()=>{J.playError()},initGlobalListeners:()=>{if(window._cwSoundListenersActive)return;window._cwSoundListenersActive=!0;let e=0,t=50;document.addEventListener("mouseover",n=>{if(!Be)return;let o=n.target.closest('button, a, input[type="checkbox"], .cw-btn, .cw-hero-card, .cw-task-item, [data-sound="hover"]');if(!o||o.contains(n.relatedTarget))return;let a=Date.now();a-e<t||(J.playHover(),e=a)},{passive:!0})}};var Ft=1e4;function zt(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
        :root {
            --cw-primary: #1a73e8;
...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var ce=e=>new Promise(t=>setTimeout(t,e));function Ne(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Xe(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,a=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&a})}async function Ht(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(l=>l.innerText.trim()==="email");if(n&&n.offsetParent!==null){let l=n.closest("material-button")||n.closest("material-fab")||n;l.style&&(l.style.display="block",l.style.visibility="visible"),Ne(l),e=!0}else{let l=document.querySelector("material-fab-speed-dial");if(l){let u=l.querySelector(".trigger");if(u){u.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Ne(u),await ce(1e3);let x=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");x&&(Ne(x),e=!0)}else l.click()}}let o=0,a=Xe();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!a&&o<30;)await ce(500),a=Xe(),o++;if(!a)return ee("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;console.log("\u{1F575}\uFE0F Verificando exist\xEAncia de rascunhos (Ghost Drafts)...");let s=null,i=0;for(;!s&&i<10;)s=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"], material-button[debug-id="discard-draft-button"]')).find(u=>u.offsetParent!==null),s||(await ce(200),i++);if(s){console.log("\u26A0\uFE0F Rascunho detectado! Clicando em Discard..."),Ne(s);let l=s.querySelector("i")||s.querySelector(".content");l&&Ne(l);let u=null,m=0;for(console.log("\u23F3 Aguardando modal de confirma\xE7\xE3o...");!u&&m<15;)await ce(200),u=Array.from(document.querySelectorAll('material-dialog material-button[debug-id="confirm-button"], material-button[debug-id="discard-button"]')).find(p=>p.offsetParent!==null),m++;u?(console.log("\u2705 Confirmando descarte..."),Ne(u),ee("Rascunho descartado. Recarregando...",{duration:2e3}),await ce(3e3),a=Xe(),a||(await ce(1e3),a=Xe())):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu a tempo.")}else console.log("\u2705 Nenhum rascunho detectado ap\xF3s verifica\xE7\xE3o.");if(a){let l=a.closest('[id="email-body-content-top"]'),m=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(l){if(m){let p=m.closest('[aria-hidden="true"]');p&&p.removeAttribute("aria-hidden"),m.focus()}await ce(300),l.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let x=l.querySelector("#cases-body-field");if(x){let p=document.createRange();p.selectNodeContents(x),p.collapse(!0);let S=window.getSelection();S.removeAllRanges(),S.addRange(p)}return!0}}return ee("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function $t(e){if(!e)return;ee("Preparando email...",{duration:3e3});let t=ht();if(!await Ht())return;await ce(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await ce(200),Ne(o),await ce(1500);let a=document.querySelector("material-auto-suggest-input input");if(a){Ne(a),await ce(200),document.execCommand("insertText",!1,e),a.dispatchEvent(new Event("input",{bubbles:!0}));let s=null,i=0;for(;i<20;){await ce(500),i++;let l=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(l.length>0&&(s=l.find(u=>u.innerText.toLowerCase().includes(e.toLowerCase())),!s&&l.length===1&&(s=l[0]),s))break}if(s){let l=function(p,S){if(p.nodeType===3&&p.nodeValue.includes(S))return p;if(!p.childNodes)return null;for(let h of p.childNodes){let f=l(h,S);if(f)return f}return null};Ne(s),await ce(2e3);let u=Xe(),m=u?u.closest('[id="email-body-content-top"]'):document.body,x=l(m,"{%ADVERTISER_NAME%}");if(x){let p=document.createRange(),S=x.nodeValue.indexOf("{%ADVERTISER_NAME%}");p.setStart(x,S),p.setEnd(x,S+19);let h=window.getSelection();h.removeAllRanges(),h.addRange(p),document.execCommand("insertText",!1,t.advertiserName),ee("Email preenchido!")}else ee("Email inserido (Nome n\xE3o substitu\xEDdo).")}else ee(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else ee("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function Ct(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),ee("Preparando email...",{duration:3e3});let t=ht(),n=ft();if(!await Ht())return;await ce(600);let a=document.querySelector('input[aria-label="Subject"]');a&&e.subject&&(a.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(a,e.subject),a.dispatchEvent(new Event("input",{bubbles:!0})),await ce(300));let s=Xe();if(s){let l=(s.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');l&&(l.focus(),l.click(),l.dispatchEvent(new Event("input",{bubbles:!0}))),await ce(400);let u=new Date;u.setDate(u.getDate()+3);let m=u.getDay();m===6?u.setDate(u.getDate()+2):m===0&&u.setDate(u.getDate()+1);let x=u.toLocaleDateString("pt-BR"),p=e.body;p=p.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),p=p.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),p=p.replace(/\[URL\]/g,t.websiteUrl||"seu site"),p=p.replace(/\[Seu Nome\]/g,n),p=p.replace(/\[MM\/DD\/YYYY\]/g,x),document.execCommand("insertHTML",!1,p),l&&(l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))),ee("Email preenchido com sucesso!",{duration:2e3}),await ce(800)}else ee("Erro ao focar no editor.",{error:!0})}var ho={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Ut={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Ce(e,t,n,o,a,s){let i=document.createElement("div");Object.assign(i.style,ho),Bt(e,i);let l=document.createElement("div");Object.assign(l.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),i.appendChild(l),a&&(a.googleLine=l);let u=document.createElement("div");Object.assign(u.style,{display:"flex",alignItems:"center",gap:"12px"});let m=document.createElement("img");m.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(m.style,{width:"20px",height:"20px",pointerEvents:"none"});let x=document.createElement("span");x.textContent=t,u.appendChild(m),u.appendChild(x);let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center",gap:"4px"});let S='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',h='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',f=document.createElement("div");f.innerHTML=S,Object.assign(f.style,Ut),f.title="Sobre",f.classList.add("no-drag"),f.onmouseenter=()=>{f.style.background="rgba(255,255,255,0.1)",f.style.color="#FFF"},f.onmouseleave=()=>{f.style.color!=="rgb(138, 180, 248)"&&(f.style.background="transparent",f.style.color="#9AA0A6")};let y=document.createElement("div");y.innerHTML=h,Object.assign(y.style,Ut),y.title="Fechar",y.classList.add("no-drag"),y.onmouseenter=()=>{y.style.background="rgba(242, 139, 130, 0.2)",y.style.color="#F28B82"},y.onmouseleave=()=>{y.style.background="transparent",y.style.color="#9AA0A6"},y.onmousedown=q=>q.stopPropagation(),f.onmousedown=q=>q.stopPropagation(),y.onclick=s;let T=xo(e,t,n,o);return f.onclick=q=>{q.stopPropagation(),T.style.opacity==="1"?(T.style.opacity="0",T.style.pointerEvents="none",f.style.color="#9AA0A6",f.style.background="transparent"):(T.style.opacity="1",T.style.pointerEvents="auto",f.style.color="#8AB4F8",f.style.background="rgba(138, 180, 248, 0.1)")},p.appendChild(f),p.appendChild(y),i.appendChild(u),i.appendChild(p),i}function xo(e,t,n,o){let a=document.createElement("div");return Object.assign(a.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),a.innerHTML=`
    ...
    `,setTimeout(()=>{let s=a.querySelector("#close-help-internal");s&&(s.onmouseover=()=>s.style.backgroundColor="#f8f9fa",s.onmouseout=()=>s.style.backgroundColor="white",s.onclick=()=>{a.style.opacity="0",a.style.pointerEvents="none"})},0),e.appendChild(a),a}if(!document.getElementById("cw-module-styles")){let e=document.createElement("style");e.id="cw-module-styles",e.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let x=l.querySelector(".cw-hero-grid"),p=l.querySelector(".cw-acc-container"),S=l.querySelector(".cw-results-container"),h=l.querySelector(".cw-search-input"),f=l.querySelector(".cw-status-bar"),y=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");a.forEach(([g,b])=>{let r=o(b.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${g}`,c.style.setProperty("--hero-color",r.color),c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let d=t[g]?t[g].count:0;_(g,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>_(g,-1,b),c.querySelector(".plus").onclick=()=>_(g,1,b),c.dataset.color=r.color,x.appendChild(c)});function q(g,b){let r=o(b.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=g,c.innerHTML=`
        ...
        `,c.onclick=()=>{p.querySelectorAll(".cw-acc-group.open").forEach(d=>{d!==r&&d.classList.remove("open")}),r.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",b.tasks.forEach(d=>{let v=q(d.key,d);w.appendChild(v)}),r.appendChild(c),r.appendChild(w),p.appendChild(r)});function _(g,b,r){t[g]||(t[g]={count:0,data:r,brand:o(r.name)}),t[g].count+=b,t[g].count<=0&&delete t[g],B(),H(),e&&e()}function B(){a.forEach(([w])=>{let d=x.querySelector(`#hero-${w}`);if(!d)return;let v=t[w];v?(d.classList.add("active"),d.querySelector(".cw-step-val").textContent=v.count,d.querySelector(".cw-step-val").style.color=d.dataset.color):d.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(w=>{let d=w.dataset.id,v=t[d];v?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=v.count):w.classList.remove("selected")});let b=Object.keys(t),r=0,c=[];if(b.forEach(w=>{let d=t[w];r+=d.count;for(let v=0;v<d.count;v++)c.length<6&&c.push(d.brand)}),r>0){f.classList.add("visible");let w=r>1?"A\xE7\xF5es":"A\xE7\xE3o",d=r>1?"definidas":"definida";y.textContent=`${r} ${w} ${d}`,T.innerHTML="",c.forEach(v=>{let O=document.createElement("div");O.className="cw-mini-icon",O.innerHTML=Pe[v.icon]||Pe.default;let A=O.querySelector("svg");A&&(A.style.width="14px",A.style.height="14px"),T.appendChild(O)})}else f.classList.remove("visible")}h.addEventListener("input",g=>{let b=g.target.value.toLowerCase();if(b.length>0){p.style.display="none",S.style.display="block",S.innerHTML="";let r=!1;Object.entries(Re).forEach(([c,w])=>{if(w.name.toLowerCase().includes(b)){r=!0;let d=q(c,w);t[c]&&(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=t[c].count),S.appendChild(d)}}),r||(S.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else p.style.display="block",S.style.display="none"});function H(){m.innerHTML="";let g=Object.keys(t),b=!1,r=document.getElementById("sub-status"),c="implementation";if(r&&r.value.toLowerCase().includes("education")&&(c="education"),g.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(g.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`
        ...
        `,m.appendChild(w),g.forEach(d=>{let v=t[d].data,O=t[d].count,A=t[d].brand,k=v.screenshots?v.screenshots[c]||[]:["Link da Evid\xEAncia"];if(k.length>0){b=!0;for(let F=1;F<=O;F++){let L=document.createElement("div");L.className="cw-screen-card",L.style.setProperty("--brand-color",A.color),L.style.setProperty("--brand-bg",A.bg),L.style.setProperty("--brand-shadow",A.color+"40");let I=document.createElement("div");I.className="cw-card-header";let z=document.createElement("div");z.className="cw-card-icon",z.innerHTML=Pe[A.icon]||Pe.default;let N=document.createElement("div");N.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let W=document.createElement("input");W.className="cw-card-title-input",W.id=`name-${d}-${F}`,W.value=`${v.name}${O>1?" #"+F:""}`,W.title="Clique para renomear esta task";let Y=document.createElement("span");Y.className="cw-edit-hint",Y.innerHTML="\u270E Renomear",N.appendChild(W),N.appendChild(Y),I.appendChild(z),I.appendChild(N),L.appendChild(I),k.forEach((Z,ae)=>{let te=document.createElement("div");te.className="cw-input-group";let ge=document.createElement("label");ge.className="cw-input-label",ge.textContent=Z.replace(/📷|:|•/g,"").trim();let de=document.createElement("input");de.className="cw-input-field",de.id=`screen-${d}-${F}-${ae}`,de.placeholder="Cole o link aqui...",de.setAttribute("autocomplete","off"),de.addEventListener("input",()=>{de.value.trim().length>5?de.classList.add("filled"):de.classList.remove("filled")});let ue=document.createElement("div");ue.className="cw-input-check",ue.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',te.appendChild(ge),te.appendChild(de),te.appendChild(ue),L.appendChild(te)}),m.appendChild(L)}}}),u.style.display=b?"block":"none"}return{selectionElement:l,screenshotsElement:u,updateSubStatus:()=>H(),getCheckedElements:()=>Object.keys(t).map(g=>({value:g,closest:()=>({querySelector:()=>({textContent:t[g].count})})})),toggleTask:(g,b=!0)=>{let r=t[g];b&&!r?_(g,1,Re[g]):!b&&r&&_(g,-r.count,Re[g])},setMode:g=>{n=g,H()},reset:()=>{for(let g in t)delete t[g];h.value="",p.style.display="block",S.style.display="none",B(),H()}}}function io(){let e="v3.6.0",t="bau",n="pt",o=!1,a=!1,s={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},i=no(),l=ao(()=>{let M=l.getCheckedElements().map(E=>E.value);A&&A.value&&i.updateVisibility(A.value,M)}),u=document.createElement("div");u.id="autofill-popup",Object.assign(u.style,Ae,{right:"100px",width:"400px",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),u.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let x=Ce(u,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:u,googleLine:null},()=>bt());u.appendChild(x);let p=document.createElement("div");Object.assign(p.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),u.appendChild(p);let S=document.createElement("div");S.textContent="created by lucaste@",Object.assign(S.style,Pt),u.appendChild(S);let h=document.createElement("div");h.id="step-lang-type";let f=document.createElement("label");Object.assign(f.style,s.label),h.appendChild(f);let y=document.createElement("div");Object.assign(y.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let T=document.createElement("div");T.textContent="Portugu\xEAs",T.classList.add("no-drag"),Object.assign(T.style,me);let q=document.createElement("div");q.textContent="Espa\xF1ol",q.classList.add("no-drag"),Object.assign(q.style,me),T.onclick=()=>pt("pt"),q.onclick=()=>pt("es"),y.appendChild(T),y.appendChild(q),h.appendChild(y),p.appendChild(h);let _=document.createElement("div");_.id="step-0-case-type";let B=document.createElement("label");Object.assign(B.style,s.label),_.appendChild(B);let H=document.createElement("div");Object.assign(H.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let g=document.createElement("div");g.textContent="BAU",g.classList.add("no-drag"),Object.assign(g.style,me);let b=document.createElement("div");b.textContent="LM",b.classList.add("no-drag"),Object.assign(b.style,me),g.onclick=()=>dt("bau"),b.onclick=()=>dt("lm"),H.appendChild(g),H.appendChild(b),_.appendChild(H),p.appendChild(_);let r=document.createElement("div");r.id="step-1-selection";let c=document.createElement("label");c.className="cw-input-label",c.textContent="Status Principal";let w=document.createElement("select");w.id="main-status",w.className="cw-select",w.innerHTML=`
      <option value="" disabled selected hidden>Selecione uma op\xE7\xE3o...</option>
      <option value="NI">NI - Need Info</option>
      <option value="SO">SO - Solution Offered</option>
      <option value="IN">IN - Inactive</option>
      <option value="AS">AS - Assigned</option>
  `;let d=document.createElement("div");d.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let v=document.createElement("label");v.className="cw-input-label",v.textContent="Sub-status",v.style.marginBottom="0";let O=document.createElement("a");O.href="https://seu-link-do-guia-aqui.com",O.target="_blank",O.className="cw-info-link",O.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(O.style,s.helpLink),d.appendChild(v),d.appendChild(O);let A=document.createElement("select");A.id="sub-status",A.className="cw-select",A.disabled=!0,A.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',r.appendChild(c),r.appendChild(w),r.appendChild(d),r.appendChild(A),p.appendChild(r);let k=document.createElement("div");k.id="step-1-1-portugal",Object.assign(k.style,s.stepBlock,{display:"none"});let F=document.createElement("label");Object.assign(F.style,s.label),k.appendChild(F);let L=document.createElement("div");Object.assign(L.style,s.radioContainer);let I=document.createElement("div");Object.assign(I.style,{display:"flex",alignItems:"center"});let z=document.createElement("input");z.type="radio",z.name="portugal-group",z.value="sim",Object.assign(z.style,s.checkboxInput);let N=document.createElement("label");N.htmlFor="portugal-sim",Object.assign(N.style,{cursor:"pointer"}),I.appendChild(z),I.appendChild(N);let W=document.createElement("div");Object.assign(W.style,{display:"flex",alignItems:"center"});let Y=document.createElement("input");Y.type="radio",Y.name="portugal-group",Y.value="nao",Y.checked=!0,Object.assign(Y.style,s.checkboxInput);let Z=document.createElement("label");Z.htmlFor="portugal-nao",Object.assign(Z.style,{cursor:"pointer"}),W.appendChild(Y),W.appendChild(Z),L.appendChild(I),L.appendChild(W),k.appendChild(L),p.appendChild(k);function ae(C){o=C,C?te.style.display="block":te.style.display="none"}z.onchange=()=>ae(!0),Y.onchange=()=>ae(!1);let te=document.createElement("div");te.id="step-1-2-consent",Object.assign(te.style,s.stepBlock,{display:"none"});let ge=document.createElement("label");Object.assign(ge.style,s.label),te.appendChild(ge);let de=document.createElement("div");Object.assign(de.style,s.radioContainer);let ue=document.createElement("div");Object.assign(ue.style,{display:"flex",alignItems:"center"});let xe=document.createElement("input");xe.type="radio",xe.name="consent-group",xe.value="Sim",xe.checked=!0,Object.assign(xe.style,s.checkboxInput);let ie=document.createElement("label");ie.htmlFor="consent-sim",Object.assign(ie.style,{cursor:"pointer"}),ue.appendChild(xe),ue.appendChild(ie);let K=document.createElement("div");Object.assign(K.style,{display:"flex",alignItems:"center"});let Te=document.createElement("input");Te.type="radio",Te.name="consent-group",Te.value="N\xE3o",Object.assign(Te.style,s.checkboxInput);let Le=document.createElement("label");Le.htmlFor="consent-nao",Object.assign(Le.style,{cursor:"pointer"}),K.appendChild(Te),K.appendChild(Le),de.appendChild(ue),de.appendChild(K),te.appendChild(de),p.appendChild(te);let Me=document.createElement("div");Me.id="step-1-5-snippets",Object.assign(Me.style,s.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,s.h3),nt.textContent="Cen\xE1rios Comuns";let ye=Jt(C=>{let M=document.querySelector("textarea");M&&(M.value=C,M.dispatchEvent(new Event("input")),M.style.transition="background-color 0.2s",M.style.backgroundColor="#e8f0fe",setTimeout(()=>M.style.backgroundColor="#fff",300))});ye.id="snippet-container",Me.appendChild(nt),Me.appendChild(ye),p.appendChild(Me);let ve=document.createElement("div");ve.id="step-2-tasks",Object.assign(ve.style,s.stepBlock,{display:"none"});let be=document.createElement("button");be.textContent="+ Gostaria de selecionar uma task?",Object.assign(be.style,s.optionalBtn),be.onmouseover=()=>{be.style.background="#e8f0fe"},be.onmouseout=()=>{be.style.background="white"};let $e=document.createElement("h3");Object.assign($e.style,s.h3);let qt=document.createElement("div");qt.id="task-checkboxes-container",ve.appendChild(be),ve.appendChild(qt),ve.appendChild($e),ve.appendChild(l.selectionElement),p.appendChild(ve);let ke=document.createElement("div");ke.id="step-3-form",Object.assign(ke.style,s.stepBlock,{display:"none"});let ct=document.createElement("h3");Object.assign(ct.style,s.h3),ke.appendChild(ct);let _e=document.createElement("div");_e.id="dynamic-form-fields-container",ke.appendChild(_e),ke.appendChild(i.element),ke.appendChild(l.screenshotsElement),p.appendChild(ke);let De=document.createElement("div");De.id="step-4-email",Object.assign(De.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Fe=document.createElement("label");Fe.style.display="flex",Fe.style.alignItems="center",Fe.style.cursor="pointer",Fe.style.fontSize="14px";let Ge=document.createElement("input");Ge.type="checkbox",Ge.checked=!0,Object.assign(Ge.style,s.checkboxInput),Fe.appendChild(Ge),Fe.appendChild(document.createTextNode("Preencher email automaticamente?")),De.appendChild(Fe),p.appendChild(De);let Ue=document.createElement("div");Object.assign(Ue.style,{display:"none",gap:"8px",padding:"0"}),p.appendChild(Ue);let Qe=document.createElement("button");Object.assign(Qe.style,s.buttonBase,{backgroundColor:"#5f6368"}),Qe.textContent="Copiar";let Je=document.createElement("button");Object.assign(Je.style,s.buttonBase,{backgroundColor:"#1a73e8"}),Je.textContent="Preencher",Ue.appendChild(Qe),Ue.appendChild(Je);let Ze=document.createElement("div");Object.assign(Ze.style,We),Ze.className="no-drag",Ze.title="Redimensionar",u.appendChild(Ze),Ye(u,Ze),document.body.appendChild(u);function dt(C){t=C;let M=et();Object.assign(g.style,me),Object.assign(b.style,me),C==="bau"?(Object.assign(g.style,M),O.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(b.style,M),O.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),A.value&&A.dispatchEvent(new Event("change"))}function j(C){try{if(Ie&&Ie[n]&&Ie[n][C])return Ie[n][C];if(Ie&&Ie.pt&&Ie.pt[C])return Ie.pt[C]}catch{}return C}function uo(){f.textContent=j("idioma"),B.textContent=j("fluxo"),c.textContent=j("status_principal"),v.textContent=j("substatus"),nt.textContent=j("cenarios_comuns"),$e.textContent=j("selecione_tasks"),ct.textContent=j("preencha_detalhes"),Qe.textContent=j("copiar"),Je.textContent=j("preencher"),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=j("select_status")),A.querySelector('option[value=""]')&&(A.querySelector('option[value=""]').textContent=j("select_substatus")),F.textContent=j("caso_portugal"),N.textContent=j("sim"),Z.textContent=j("nao"),ge.textContent=j("consentiu_gravacao"),ie.textContent=j("sim"),Le.textContent=j("nao"),_e.querySelectorAll("label").forEach(C=>{let M=C.nextElementSibling.id.replace("field-",""),E=j(M.toLowerCase());E!==M.toLowerCase()?C.textContent=E:C.textContent=M.replace(/_/g," ").replace(/\b\w/g,V=>V.toUpperCase())+":"}),be.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function pt(C){n=C;let M=et();Object.assign(T.style,me),Object.assign(q.style,me),C==="pt"?(Object.assign(T.style,M),k.style.display="block",ae(o)):(Object.assign(q.style,M),k.style.display="none",te.style.display="none"),uo(),A.value&&A.dispatchEvent(new Event("change"))}function ut(C){(C.value.trim()===""||C.value.trim()==="\u2022")&&(C.value="\u2022 "),C.onkeydown=function(M){if(M.key==="Enter"){M.preventDefault();let E=this.selectionStart,V=this.selectionEnd,oe=this.value,le=oe.lastIndexOf(`
`,E-1)+1,he=oe.substring(le,E),pe=he.trim()==="\u2022"||he.trim()===""?`
`:`
\u2022 `;this.value=oe.substring(0,E)+pe+oe.substring(V),this.selectionStart=this.selectionEnd=E+pe.length}else if(M.key==="Backspace"){let E=this.selectionStart;if(E===this.selectionEnd&&E>0){let V=this.value.substring(0,E);V.endsWith(`
\u2022 `)?(M.preventDefault(),this.value=V.substring(0,E-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=E-3):V==="\u2022 "&&(M.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function mt(){let C=typeof ye<"u"?ye:document.getElementById("snippet-container");if(!C)return;let M=C.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),E={},V=new Set;M.forEach(X=>{let $=X.id,D=we[$];if(D)for(let R in D)R==="linkedTask"?V.add(D.linkedTask):R!=="type"&&(E[R]||(E[R]=[]),E[R].includes(D[R])||E[R].push(D[R]))});let oe=new Set;Object.values(we).forEach(X=>{Object.keys(X).forEach($=>{$!=="linkedTask"&&$!=="type"&&oe.add($)})}),oe.forEach(X=>{let $=document.getElementById(X);if($){let D=E[X]||[],R="";ot.includes(X.replace("field-",""))?(R=D.map(U=>U.startsWith("\u2022 ")?U:"\u2022 "+U).join(`
`),R===""?R="\u2022 ":R.endsWith(`
\u2022 `)||(R+=`
\u2022 `)):R=D.join(`

`),R.trim()!=="\u2022"&&R.trim()!==""?$.value=R:ot.includes(X.replace("field-",""))?$.value="\u2022 ":$.value="",$.tagName==="TEXTAREA"&&typeof ut=="function"&&ut($)}});let le=new Set,he=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(X=>{let $=we[X.id];$&&$.linkedTask&&(X.checked?le.add($.linkedTask):he.add($.linkedTask))}),he.forEach(X=>{le.has(X)||l.toggleTask(X,!1)}),le.forEach(X=>{l.toggleTask(X,!0)})}w.onchange=()=>{let C=w.value;if(gt(1.5),A.innerHTML=`<option value="">${j("select_substatus")}</option>`,!C){A.disabled=!0;return}for(let M in tt){let E=tt[M];if(E.status===C){let V=document.createElement("option");V.value=M,V.textContent=E.name,A.appendChild(V)}}A.disabled=!1},A.onchange=()=>{let C=A.value;if(gt(1.5),!C)return;l.updateSubStatus(C);let M=tt[C];ye.innerHTML="";let E=(D,R,U)=>{let se=document.createElement("label");Object.assign(se.style,s.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let Q=document.createElement("input");return Q.type=R,Q.id=D.id,Object.assign(Q.style,s.checkboxInput),se.appendChild(Q),se.appendChild(document.createTextNode(` ${D.text}`)),U.appendChild(se),Q},V=[],oe="radio";if(C==="NI_Awaiting_Inputs")V=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))oe="checkbox",V=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(C.startsWith("AS_")){oe="checkbox";let D=document.createElement("label");D.textContent=j("cenarios_comuns"),Object.assign(D.style,s.label),ye.appendChild(D),V=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")&&(V=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let le=V.filter(D=>{let R=we[D.id];return!R.type||R.type==="all"||R.type===t});le.forEach((D,R)=>{let U=E(D,oe,ye);oe==="radio"&&(U.name="scenario-radio-group",R===0&&(U.checked=!0))}),le.length>0&&(Me.style.display="block"),M.requiresTasks?(be.style.display="none",$e.style.display="block",l.selectionElement.style.display="block",ve.style.display="block"):(be.style.display="block",$e.style.display="none",l.selectionElement.style.display="none",ve.style.display="block"),_e.innerHTML="";let he=M.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(he)].forEach(D=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(D))return;let R=D.slice(1,-1),U=document.createElement("label"),se=j(R.toLowerCase());U.textContent=se!==R.toLowerCase()?se:R.replace(/_/g," ").replace(/\b\w/g,re=>re.toUpperCase())+":",Object.assign(U.style,s.label);let Q;ot.includes(R)?(Q=document.createElement("textarea"),Object.assign(Q.style,s.textarea),Q.classList.add("bullet-textarea"),ut(Q)):wt.includes(R)?(Q=document.createElement("textarea"),Object.assign(Q.style,s.textarea)):(Q=document.createElement("input"),Q.type="text",Object.assign(Q.style,s.input),R==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign(U.style,{display:"none"}),Object.assign(Q.style,{display:"none"}))),R==="ON_CALL"&&t==="lm"&&(Object.assign(U.style,{display:"none"}),Object.assign(Q.style,{display:"none"}),Q.value="N/A"),Q.id=`field-${R}`,_e.appendChild(U),_e.appendChild(Q)});let X=ye.querySelectorAll('input[type="checkbox"], input[type="radio"]');X.length>0&&(X.forEach(D=>{D.removeEventListener("change",mt),D.addEventListener("change",mt)}),mt()),ke.style.display="block",it[C]?De.style.display="block":De.style.display="none",Ue.style.display="flex";let $=l.getCheckedElements().map(D=>D.value);i.updateVisibility(C,$)},be.onclick=()=>{be.style.display="none",$e.style.display="block",l.selectionElement.style.display="block"};function It(){let C=A.value;if(!C)return null;let E=tt[C].template.replace(/\n/g,"<br>"),V='style="margin-bottom: 12px; padding-left: 30px;"',oe=[],le="",he=l.getCheckedElements();he.length>0&&he.forEach($=>{let D=$.value,R=Re[D],U=$.closest().querySelector(".stepper-count"),se=U?parseInt(U.textContent):1;se>1?oe.push(`${R.name} (x${se})`):oe.push(R.name)});let pe=l.screenshotsElement;if(pe){let $=Array.from(pe.querySelectorAll('input[id^="name-"]'));$.length>0&&$.forEach(D=>{let R=D.value,U=D.closest(".cw-screen-card");if(U){let se=U.querySelectorAll('input[id^="screen-"]'),Q=!1,re="";se.forEach(fe=>{let Nt=fe.closest(".cw-input-group"),_t=Nt?Nt.querySelector(".cw-input-label"):null,mo=_t?_t.textContent:"Evid\xEAncia",Rt=fe.value.trim(),go=Rt?` ${Rt}`:"";re+=`<li>${mo} -${go}</li>`,Q=!0}),Q&&(le+=`<b>${R}</b>`,le+=`<ul ${V}>${re}</ul>`)}})}if(E.includes("{TAGS_IMPLEMENTED}")?E=E.replace(/{TAGS_IMPLEMENTED}/g,oe.join(", ")||"N/A"):oe.length>0&&(E+=`<br><b>Tags:</b> ${oe.join(", ")}<br>`),E.includes("{SCREENSHOTS_LIST}")?E=E.replace(/{SCREENSHOTS_LIST}/g,le?`${le}`:"N/A"):le!==""&&(E+=`<br>${le}`),n==="pt"&&o){let $=xe.checked?j("sim"):j("nao");E=E.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${j("consentiu_gravacao")}</b> ${$}<br><br>`),E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("sim")}<br>`)}else n==="pt"&&!o?(E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("nao")}<br>`),E=E.replace(/{CONSENTIU_GRAVACAO}/g,"")):(E=E.replace(/{CASO_PORTUGAL}/g,""),E=E.replace(/{CONSENTIU_GRAVACAO}/g,""));return _e.querySelectorAll("input, textarea").forEach($=>{let D=$.id.replace("field-",""),R=new RegExp(`{${D}}`,"g"),U=$.value;if(D==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let re=ye.querySelector('input[type="radio"]:checked');re&&we[re.id]&&(U=we[re.id]["field-REASON_COMMENTS"])}if(ot.includes(D)&&U.trim()!==""){let re=U.split(`
...
`).filter(re=>re.trim()!=="").map(re=>`<p style="margin: 0 0 8px 0;">${re}</p>`).join(""):$.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let se=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let re=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${D}\\}(?:<br>\\s*)?`,"gi");re.test(E)?E=E.replace(re,""):E=E.replace(R,"")}else E=E.replace(R,U.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(E+=i.getOutput()),E}Qe.onclick=()=>{let C=It();C?(Tt(C),ee(j("copiado_sucesso"))):ee(j("selecione_substatus"),{error:!0})},Je.onclick=async()=>{let C=A.value,M=It();if(!M){ee(j("selecione_substatus"),{error:!0});return}Tt(M),bt();let E=Ke(),V=await oo();if(V)try{if(V.focus(),V.innerHTML.trim()==="<p><br></p>"||V.innerHTML.trim()==="<br>"||V.innerText.trim()===""){let pe=document.createRange();pe.selectNodeContents(V);let X=window.getSelection();X.removeAllRanges(),X.addRange(pe),document.execCommand("delete",!1,null)}else if(!V.innerHTML.endsWith("<br><br>")){let pe=document.createRange();pe.selectNodeContents(V),pe.collapse(!1);let X=window.getSelection();X.removeAllRanges(),X.addRange(pe),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,M),to(V),setTimeout(()=>{ee(j("inserido_copiado"))},600);let le=typeof Ge<"u"&&Ge?Ge.checked:!0;if(C&&it[C]&&le){let pe=it[C];await $t(pe),await new Promise(X=>setTimeout(X,500))}E(),gt(1.5),w.value="",A.innerHTML=`<option value="">${j("select_substatus")}</option>`,A.disabled=!0}catch(oe){console.error(oe),ee("Erro ao inserir.",{error:!0}),E()}};function gt(C=1.5){C<=1.5&&(Me.style.display="none",ye.innerHTML=""),C<=2&&(ve.style.display="none",l.reset(),be.style.display="none"),C<=3&&(ke.style.display="none",_e.innerHTML="",i.reset(),Ue.style.display="none",De.style.display="none")}function bt(){if(a=!a,a){let C=u.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Se(a,u,"cw-btn-notes")}return dt("bau"),pt("pt"),bt}var Ve={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function lo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",a="BAU",s=!1,i=document.createElement("div");i.id="call-script-popup",Object.assign(i.style,Ae,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",opacity:"0",pointerEvents:"none"});let l={popup:i,googleLine:null};function u(){s=!s,Se(s,i,"cw-btn-script")}let m=Ce(i,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{u()});i.appendChild(m);let x=document.createElement("div");Object.assign(x.style,t.progressBarContainer);let p=document.createElement("div");Object.assign(p.style,t.progressBarFill),x.appendChild(p),i.appendChild(x);let S=document.createElement("div");S.id="csa-content",Object.assign(S.style,t.contentArea),i.appendChild(S);let h=document.createElement("div");Object.assign(h.style,t.footer);let f=document.createElement("span");f.textContent="by lucaste@",Object.assign(f.style,{fontSize:"10px",color:"#bdc1c6"});let y=document.createElement("button");y.innerHTML=`
  ...
  `,Object.assign(y.style,t.resetBtn),y.onmouseenter=()=>y.style.background="#fce8e6",y.onmouseleave=()=>y.style.background="transparent",y.onclick=()=>{y.style.transform="scale(0.9)",setTimeout(()=>y.style.transform="scale(1)",150);for(let O in n)delete n[O];c()},h.appendChild(f),h.appendChild(y),i.appendChild(h);let T=document.createElement("div");Object.assign(T.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let q=document.createElement("div");Object.assign(q.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let _=document.createElement("div");_.textContent="BAU";let B=document.createElement("div");B.textContent="LT",Object.assign(_.style,me),Object.assign(B.style,me),q.appendChild(_),q.appendChild(B);let H=document.createElement("select");Object.assign(H.style,jt,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),H.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',H.value=o,T.appendChild(q),T.appendChild(H),S.appendChild(T);let g=document.createElement("div");g.id="csa-checklist-area",S.appendChild(g);let b=document.createElement("div");Object.assign(b.style,We),b.className="no-drag",b.title="Redimensionar",i.appendChild(b),Ye(i,b),document.body.appendChild(i);function r(O){return O}function c(){g.innerHTML="";let O=`${o} ${a}`,A=ro[O];if(!A){g.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
           ...
           `,f.appendChild(v)}let w=c.filter(v=>!r.includes(v.id)),d=c.filter(v=>r.includes(v.id));if(w.forEach(v=>f.appendChild(B(v,!1))),d.length>0){let v=document.createElement("div");Object.assign(v.style,i.historyDivider),v.innerHTML=`<span>Visualizar ${d.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let O=document.createElement("div");Object.assign(O.style,i.historyContainer),d.forEach(k=>O.appendChild(B(k,!0)));let A=!1;v.onclick=()=>{J.playClick(),A=!A,O.style.display=A?"flex":"none",v.querySelector("svg").style.transform=A?"rotate(180deg)":"rotate(0deg)",v.querySelector("span").textContent=A?"Ocultar hist\xF3rico":`Visualizar ${d.length} avisos anteriores`},f.appendChild(v),f.appendChild(O)}}function B(r,c){let w=document.createElement("div");Object.assign(w.style,c?i.cardHistory:i.card);let d=s[r.type]||s.info,v=document.createElement("div");Object.assign(v.style,i.cardHeader,{background:d.bg,color:d.text,borderBottom:`1px solid ${d.border}`});let O=document.createElement("div");if(Object.assign(O.style,{display:"flex",alignItems:"center",gap:"6px"}),O.innerHTML=`${d.icon} <span>${r.type.toUpperCase()}</span>`,v.appendChild(O),c){let k=document.createElement("span");k.textContent=a(r.date),k.style.opacity="0.7",v.appendChild(k)}else{let k=document.createElement("button");k.title="Marcar como lido",Object.assign(k.style,i.dismissBtn),k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',k.onmouseenter=()=>{k.style.color="#1e8e3e",k.style.background="#e6f4ea",k.style.borderColor="#1e8e3e"},k.onmouseleave=()=>{k.style.color="#5f6368",k.style.background="#fff",k.style.borderColor="rgba(0,0,0,0.1)"},k.onclick=F=>{F.stopPropagation(),J.playClick(),w.style.transform="translateX(20px)",w.style.opacity="0",setTimeout(()=>{let L=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");L.push(r.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(L)),_(),T()},250)},v.appendChild(k)}if(w.appendChild(v),r.title){let k=document.createElement("div");Object.assign(k.style,i.msgTitle),k.textContent=r.title,w.appendChild(k)}if(!c){let k=document.createElement("div");Object.assign(k.style,i.metaContainer),k.innerHTML=`<span style="font-weight:600">${r.author}</span> \u2022 <span>${a(r.date)}</span>`,w.appendChild(k)}let A=document.createElement("div");return Object.assign(A.style,i.cardBody),A.innerHTML=u(r.text),w.appendChild(A),w}_();let H=document.createElement("div");Object.assign(H.style,We),H.className="no-drag",m.appendChild(H),Ye(m,H),document.body.appendChild(m);let g=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),b=He.some(r=>!g.includes(r.id));return{toggle:p,hasUnread:b}}function Eo(){if(window.techSolInitialized){At();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{zt();try{J.initGlobalListeners(),J.playStartup()}catch(s){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",s)}je.fetchTips(),At();let e=io(),t=so(),n=lo(),o=co(),a=po();Qt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:a})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),ee("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Eo();})();

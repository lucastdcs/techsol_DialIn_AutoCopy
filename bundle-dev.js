...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=b=>{b.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=b=>{b.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=b=>{b.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=b=>{b.stopPropagation(),e.toggleLinks()},(async function(){await Ke(2800),o.classList.add("docked"),await Ke(300);let x=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(E=>E.classList.add("visible"));for(let E=0;E<x.length;E++)x[E].classList.add("popped"),await Ke(90);await Ke(200),o.classList.add("system-check")})();let a=!1,s,i,p,S,y=3;o.onmousedown=b=>{if(b.target.closest("button"))return;b.preventDefault(),s=b.clientX,i=b.clientY;let x=o.getBoundingClientRect();p=x.left,S=x.top,document.addEventListener("mousemove",m),document.addEventListener("mouseup",C)};function m(b){let x=b.clientX-s,A=b.clientY-i;!a&&Math.sqrt(x*x+A*A)>y&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${p+x}px`,o.style.top=`${S+A}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function C(b){if(document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",C),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let x=window.innerWidth,A=window.innerHeight,E=o.getBoundingClientRect(),N=E.left+E.width/2,F;N<x/2?(F=24,o.classList.remove("side-right"),o.classList.add("side-left")):(F=x-E.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let q=E.top;q<24&&(q=24),q>A-E.height-24&&(q=A-E.height-24),o.style.left=`${F}px`,o.style.top=`${q}px`,setTimeout(()=>{},600)}else{let x=b.target.closest("button");x&&(x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="",150))}}}function Qe(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let s=Date.now()-r,i=Math.max(0,1500-s);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},i)}}var Mt=e=>new Promise(t=>setTimeout(t,e));function Ze(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function gt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{K("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Gt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Dt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Ft(){console.log("Iniciando processo de Nova Nota...");let e=Dt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(s=>s.innerText.trim()==="description");if(o){let s=o.closest("material-fab")||o.closest("material-button");s?(s.style&&(s.style.display="block",s.style.visibility="visible"),Ze(s)):Ze(o)}else{let s=document.querySelector("material-fab-speed-dial");if(s){let i=s.querySelector(".trigger");i?(i.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Ze(i)):s.click(),await Mt(800);let S=Array.from(document.querySelectorAll("i.material-icons-extended")).find(y=>y.innerText.trim()==="description");S&&Ze(S)}}let r=null,a=0;for(;!r&&a<20;){await Mt(300);let s=Dt();if(s.length>t)r=s.find(i=>!e.includes(i)),r||(r=s[s.length-1]);else if(a>10){let i=s.filter(p=>p.offsetParent!==null);i.length>0&&(r=i[i.length-1])}a++}return r}var Zt={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto'",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},yo={...Zt,height:"100px",resize:"vertical"};var ft={width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"};var Jt={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},eo={fontSize:"12px",color:"#e37400",marginTop:"4px"},to={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},oo={display:"flex",gap:"15px",marginBottom:"10px"};function Pt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Jt);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,Ge,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,oo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,ft);let r=document.createElement("label");r.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(r);let s=document.createElement("input");s.type="radio",s.name="ts_usage_mod",s.value="N\xE3o",s.checked=!0,Object.assign(s.style,ft);let i=document.createElement("label");i.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(s),p.appendChild(i),n.appendChild(a),n.appendChild(p);let S=document.createElement("div");S.style.display="block";let y=document.createElement("label");y.textContent="Qual foi o Motivo?",Object.assign(y.style,Ge,{fontSize:"12px"});let m=document.createElement("input");m.type="text",Object.assign(m.style,to);let C=document.createElement("div");C.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(C.style,eo),S.appendChild(y),S.appendChild(m),S.appendChild(C),e.appendChild(t),e.appendChild(n),e.appendChild(S),o.onchange=()=>{S.style.display="none"},s.onchange=()=>{S.style.display="block"};function b(E,N){if(e.style.display="none",!E||E.includes("Education")||!N||N.length===0)return;let F=N.some(c=>c.includes("enhanced")||c==="ec_google_ads"),q=N.some(c=>(c.includes("conversion")||c.includes("ads"))&&!c.includes("enhanced")),g=N.some(c=>c.includes("ga4")||c.includes("analytics")||c.includes("ua")),d=N.some(c=>c.includes("merchant")||c.includes("gmc")||c.includes("shopping"));(F||q&&!g&&!d)&&(e.style.display="block")}function x(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return s.checked&&m.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${m.value}`),E+="<br>",E}function A(){e.style.display="none",s.checked=!0,o.checked=!1,S.style.display="block",m.value=""}return{element:e,updateVisibility:b,getOutput:x,reset:A}}var T={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Oe={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function jt(e){let t={};function n(g){let d=g.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?T.brands.ads:d.includes("ga4")||d.includes("analytics")?T.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?T.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?T.brands.gmc:T.brands.default}let o=Object.entries(_e).filter(([g,d])=>d.popular),r={};Object.entries(_e).forEach(([g,d])=>{if(d.popular)return;let l=n(d.name);r[l.label]||(r[l.label]={brand:l,tasks:[]}),r[l.label].tasks.push({key:g,...d})});let a="cw-zen-tasks";if(!document.getElementById(a)){let g=document.createElement("style");g.id=a,g.innerHTML=`
            ...
            .cw-helper-text { font-size: 12px; color: ${T.textSub}; margin-top: 12px; line-height: 1.4; }

            /* HERO CARD */
            .cw-hero-card {
                background: ${T.white}; border-radius: 12px; padding: 10px 12px;
                box-shadow: ${T.shadowCard}; border: 1px solid transparent;
            ...
            .cw-hero-icon { 
                width: 32px; height: 32px; border-radius: 8px; background: #F3F4F6; color: ${T.textSub};
                display: flex; align-items: center; justify-content: center; flex-shrink: 0; transition: all 0.2s;
            }
            .cw-hero-icon svg { width: 18px; height: 18px; fill: currentColor; }
            .cw-hero-label { font-size: 12px; font-weight: 500; color: ${T.textMain}; line-height: 1.2; }

            /* Hero Active */
            .cw-hero-card.active { background: ${T.white}; border-color: ${T.blue}; }
            .cw-hero-card.active .cw-hero-icon { background: ${T.blue}; color: white; }
            .cw-hero-card.active .cw-hero-label { color: ${T.blue}; font-weight: 600; }

            /* Hero Stepper */
            .cw-hero-stepper {
                position: absolute; right: 4px; top: 4px; bottom: 4px;
                background: ${T.white}; border-radius: 8px; padding: 0 4px;
            ...
            .cw-search-input {
                ...
                border: 1px solid ${T.border}; border-radius: 10px; background: ${T.white};
                font-size: 13px; outline: none;
                background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%239CA3AF" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>');
                background-repeat: no-repeat; background-position: 10px center;
                transition: border-color 0.2s, box-shadow 0.2s; margin-bottom: 16px;
            }
            .cw-search-input:focus { border-color: ${T.blue}; box-shadow: 0 0 0 3px ${T.blueLight}; }

            /* ACCORDION */
            .cw-acc-group { margin-bottom: 8px; border: 1px solid ${T.border}; border-radius: 10px; background: ${T.white}; overflow: hidden; }
            .cw-acc-header {
                padding: 12px 16px; display: flex; align-items: center; justify-content: space-between;
                cursor: pointer; background: ${T.white}; transition: background 0.1s;
            }
            .cw-acc-header:hover { background: #F9FAFB; }
            .cw-acc-title { font-size: 13px; font-weight: 600; color: ${T.textMain}; display: flex; align-items: center; gap: 8px; }
            .cw-acc-dot { width: 8px; height: 8px; border-radius: 50%; }
            .cw-acc-icon { width: 12px; height: 12px; transition: transform 0.3s; color: ${T.textSub}; font-size: 10px; }
            .cw-acc-group.open .cw-acc-icon { transform: rotate(180deg); }
            .cw-acc-body { display: none; border-top: 1px solid ${T.border}; background: #FAFAFA; }
            ...
            .cw-task-item.selected { background: ${T.blueLight}; }
            ...
            .cw-task-label { font-size: 13px; color: ${T.textSub}; transition: color 0.1s; font-weight: 400; line-height: 1.3; }
            .cw-task-item.selected .cw-task-label { color: ${T.blue}; font-weight: 500; }
            ...
            .cw-step-btn {
                ...
                color: ${T.textMain}; display: flex; align-items: center; justify-content: center;
                font-size: 14px; font-weight: bold; transition: background 0.1s; cursor: pointer;
            }
            .cw-step-btn:hover { background: #E5E7EB; }
            .cw-step-val { font-size: 13px; font-weight: 600; min-width: 14px; text-align: center; color: ${T.blue}; }
            ...
            .cw-status-bar {
                ...
                box-shadow: ${T.shadowFloat}; z-index: 10;
            }
            .cw-status-bar.visible { transform: translateY(0); }
            .cw-status-text { font-size: 13px; font-weight: 500; color: ${T.textMain}; }
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
            ...
            .cw-card-title-input {
                font-family: ${T.font}; font-size: 15px; font-weight: 600; color: ${T.textMain};
            ...
            .cw-card-title-input:focus {
                background: #FFFFFF;
                border-color: ${T.brands.ads.color};
                box-shadow: 0 0 0 2px rgba(26, 115, 232, 0.1);
            }

            /* Dica Visual "\u270E Renomear" */
            .cw-edit-hint {
                font-size: 12px; color: ${T.textSub}; opacity: 0; 
            ...
            .cw-info-banner {
                ...
                border-radius: 8px;
                font-size: 11px; color: ${T.textSub};
                display: flex; align-items: center; gap: 8px;
            }
            .cw-info-link { color: ${T.brands.ads.color}; text-decoration: none; font-weight: 600; }
            ...
            .cw-input-label {
                display: block; font-size: 10px; font-weight: 700; color: ${T.textSub};
    ...
    `;let S=s.querySelector(".cw-hero-grid"),y=s.querySelector(".cw-acc-container"),m=s.querySelector(".cw-results-container"),C=s.querySelector(".cw-search-input"),b=s.querySelector(".cw-status-bar"),x=s.querySelector(".cw-status-text"),A=s.querySelector(".cw-footer-icons");o.forEach(([g,d])=>{let l=n(d.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${g}`,c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;N(g,h>0?-h:1,d)},c.querySelector(".minus").onclick=()=>N(g,-1,d),c.querySelector(".plus").onclick=()=>N(g,1,d),c.dataset.color=l.color,S.appendChild(c)});function E(g,d){let l=n(d.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=g,c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;N(g,h>0?-h:1,d)},c.querySelector(".minus").onclick=()=>N(g,-1,d),c.querySelector(".plus").onclick=()=>N(g,1,d),c}Object.entries(r).forEach(([g,d])=>{let l=document.createElement("div");l.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${d.brand.color}"></div>
                ${g}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{y.querySelectorAll(".cw-acc-group.open").forEach(h=>{h!==l&&h.classList.remove("open")}),l.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",d.tasks.forEach(h=>{let w=E(h.key,h);v.appendChild(w)}),l.appendChild(c),l.appendChild(v),y.appendChild(l)});function N(g,d,l){t[g]||(t[g]={count:0,data:l,brand:n(l.name)}),t[g].count+=d,t[g].count<=0&&delete t[g],F(),q(),e&&e()}function F(){o.forEach(([v])=>{let h=S.querySelector(`#hero-${v}`);if(!h)return;let w=t[v];if(w){h.classList.add("active"),h.style.borderColor=h.dataset.color;let O=h.querySelector(".cw-hero-icon");O.style.backgroundColor=h.dataset.color,O.style.color="white",h.querySelector(".cw-step-val").textContent=w.count}else{h.classList.remove("active"),h.style.borderColor="transparent";let O=h.querySelector(".cw-hero-icon");O.style.backgroundColor="#F3F4F6",O.style.color=T.textSub}}),s.querySelectorAll(".cw-task-item").forEach(v=>{let h=v.dataset.id,w=t[h];w?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=w.count):v.classList.remove("selected")});let d=Object.keys(t),l=0,c=[];if(d.forEach(v=>{let h=t[v];l+=h.count;for(let w=0;w<h.count;w++)c.length<6&&c.push(h.brand)}),l>0){b.classList.add("visible");let v=l>1?"A\xE7\xF5es":"A\xE7\xE3o",h=l>1?"definidas":"definida";x.textContent=`${l} ${v} ${h}`,A.innerHTML="",c.forEach(w=>{let O=document.createElement("div");O.className="cw-mini-icon",O.innerHTML=Oe[w.icon]||Oe.default;let I=O.querySelector("svg");I&&(I.style.width="14px",I.style.height="14px"),A.appendChild(O)})}else b.classList.remove("visible")}C.addEventListener("input",g=>{let d=g.target.value.toLowerCase();if(d.length>0){y.style.display="none",m.style.display="block",m.innerHTML="";let l=!1;Object.entries(_e).forEach(([c,v])=>{if(v.name.toLowerCase().includes(d)){l=!0;let h=E(c,v);t[c]&&(h.classList.add("selected"),h.querySelector(".cw-step-val").textContent=t[c].count),m.appendChild(h)}}),l||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else y.style.display="block",m.style.display="none"});function q(){p.innerHTML="";let g=Object.keys(t),d=!1,l="implementation";if(g.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let c=document.createElement("div");c.className="cw-info-banner",c.innerHTML=`
...
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):z.tagName==="TEXTAREA"&&(H=H.replace(/\n/g,"<br>"));let J=H.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(J===""||J==="\u2022"||J.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${G}\\}(?:<br>\\s*)?`,"gi");ee.test(f)?f=f.replace(ee,""):f=f.replace(V,"")}else f=f.replace(V,H.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof s<"u"&&s.getOutput&&(f+=s.getOutput()),f}Me.onclick=()=>{let u=yt();u?(gt(u),K(M("copiado_sucesso"))):K(M("selecione_substatus"),{error:!0})},De.onclick=async()=>{let u=k.value,L=yt();if(!L){K(M("selecione_substatus"),{error:!0});return}gt(L),lt();let f=Qe(),D=await Ft();if(D)try{if(D.focus(),D.innerHTML.trim()==="<p><br></p>"||D.innerHTML.trim()==="<br>"||D.innerText.trim()===""){let B=document.createRange();B.selectNodeContents(D);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(B),document.execCommand("delete",!1,null)}else if(!D.innerHTML.endsWith("<br><br>")){let B=document.createRange();B.selectNodeContents(D),B.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(B),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,L),Gt(D),setTimeout(()=>{K(M("inserido_copiado"))},600);let se=typeof Te<"u"&&Te?Te.checked:!0;if(u&&Ye[u]&&se){let B=Ye[u];await Nt(B),await new Promise(Q=>setTimeout(Q,500))}f(),rt(1.5),w.value="",k.innerHTML=`<option value="">${M("select_substatus")}</option>`,k.disabled=!0}catch(X){console.error(X),K("Erro ao inserir.",{error:!0}),f()}};function rt(u=1.5){u<=1.5&&(Ae.style.display="none",ue.innerHTML=""),u<=2&&(me.style.display="none",i.reset(),le.style.display="none"),u<=3&&(be.style.display="none",he.innerHTML="",s.reset(),Ne.style.display="none",Ee.style.display="none")}function lt(){r=!r,Se(r,p,"cw-btn-notes")}return nt("bau"),at("pt"),lt}var ke={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let j=h.querySelector("#csa-back-btn");j.onmouseover=()=>j.style.backgroundColor="#f1f3f4",j.onmouseout=()=>j.style.backgroundColor="transparent",j.onclick=I;let R=h.querySelector("#csa-insert-btn");R.onmouseover=()=>R.style.backgroundColor="#174ea6",R.onmouseout=()=>R.style.backgroundColor="#1a73e8",R.onclick=async()=>{R.style.transform="scale(0.96)",A();let oe=Qe();try{await bt(_),oe()}catch(ne){console.error(ne),oe()}setTimeout(()=>{R.style.transform="scale(1)",I()},300)}}function I(){o="list",F.style.transform="translateX(0)"}function U(){l.innerHTML="",Object.keys(ke).forEach(_=>{let Z=ke[_],P=document.createElement("button");P.textContent=Z.title,Object.assign(P.style,S),t===_&&n===""&&Object.assign(P.style,y),P.onclick=()=>{t=_,n="",d.value="",U(),k()},l.appendChild(P)})}function k(){c.innerHTML="";let _=[];if(n.trim()!==""?Object.values(ke).forEach(j=>{let R=j.emails.filter(oe=>oe.name.toLowerCase().includes(n.toLowerCase()));_=[..._,...R]}):ke[t]&&(_=ke[t].emails),_.length===0){c.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let Z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',P='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';_.forEach(j=>{let R=document.createElement("div");Object.assign(R.style,m);let oe=j.subject.length>50?j.subject.substring(0,50)+"...":j.subject;R.innerHTML=`

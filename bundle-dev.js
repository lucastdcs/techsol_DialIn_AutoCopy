...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var ce=e=>new Promise(t=>setTimeout(t,e));function Oe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function tt(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,r=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&r})}async function Gt(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(i=>i.innerText.trim()==="email");if(n&&n.offsetParent!==null){let i=n.closest("material-button")||n.closest("material-fab")||n;i.style&&(i.style.display="block",i.style.visibility="visible"),Oe(i),e=!0}else{let i=document.querySelector("material-fab-speed-dial");if(i){let l=i.querySelector(".trigger");if(l){l.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Oe(l),await ce(1e3);let m=Array.from(document.querySelectorAll("i.material-icons-extended")).find(c=>c.innerText.trim()==="email");m&&(Oe(m),e=!0)}else i.click()}}let o=0,r=tt();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!r&&o<30;)await ce(500),r=tt(),o++;if(!r)return oe("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let a=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(i=>i.offsetParent!==null);if(a){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),Oe(a);let i=null,l=0;for(;!i&&l<10;)await ce(200),i=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(m=>m.offsetParent!==null),l++;i?(console.log("\u2705 Confirmando descarte..."),Oe(i),await ce(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(r){let i=r.closest('[id="email-body-content-top"]'),f=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(i){if(f){let c=f.closest('[aria-hidden="true"]');c&&c.removeAttribute("aria-hidden"),f.focus()}await ce(300),i.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let m=i.querySelector("#cases-body-field");if(m){let c=document.createRange();c.selectNodeContents(m),c.collapse(!0);let T=window.getSelection();T.removeAllRanges(),T.addRange(c)}return!0}}return oe("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function Ft(e){if(!e)return;oe("Preparando email...",{duration:3e3});let t=gt();if(!await Gt())return;await ce(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await ce(200),Oe(o),await ce(1500);let r=document.querySelector("material-auto-suggest-input input");if(r){Oe(r),await ce(200),document.execCommand("insertText",!1,e),r.dispatchEvent(new Event("input",{bubbles:!0}));let s=null,a=0;for(;a<20;){await ce(500),a++;let i=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(i.length>0&&(s=i.find(l=>l.innerText.toLowerCase().includes(e.toLowerCase())),!s&&i.length===1&&(s=i[0]),s))break}if(s){let i=function(c,T){if(c.nodeType===3&&c.nodeValue.includes(T))return c;if(!c.childNodes)return null;for(let h of c.childNodes){let y=i(h,T);if(y)return y}return null};Oe(s),await ce(2e3);let l=tt(),f=l?l.closest('[id="email-body-content-top"]'):document.body,m=i(f,"{%ADVERTISER_NAME%}");if(m){let c=document.createRange(),T=m.nodeValue.indexOf("{%ADVERTISER_NAME%}");c.setStart(m,T),c.setEnd(m,T+19);let h=window.getSelection();h.removeAllRanges(),h.addRange(c),document.execCommand("insertText",!1,t.advertiserName),oe("Email preenchido!")}else oe("Email inserido (Nome n\xE3o substitu\xEDdo).")}else oe(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else oe("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function vt(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),oe("Preparando email...",{duration:3e3});let t=gt(),n=bt();if(!await Gt())return;await ce(600);let r=document.querySelector('input[aria-label="Subject"]');r&&e.subject&&(r.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(r,e.subject),r.dispatchEvent(new Event("input",{bubbles:!0})),await ce(300));let s=tt();if(s){let i=(s.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');i&&(i.focus(),i.click(),i.dispatchEvent(new Event("input",{bubbles:!0}))),await ce(400);let l=new Date;l.setDate(l.getDate()+3);let f=l.getDay();f===6?l.setDate(l.getDate()+2):f===0&&l.setDate(l.getDate()+1);let m=l.toLocaleDateString("pt-BR"),c=e.body;c=c.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),c=c.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),c=c.replace(/\[URL\]/g,t.websiteUrl||"seu site"),c=c.replace(/\[Seu Nome\]/g,n),c=c.replace(/\[MM\/DD\/YYYY\]/g,m),document.execCommand("insertHTML",!1,c),i&&(i.dispatchEvent(new Event("input",{bubbles:!0})),i.dispatchEvent(new Event("change",{bubbles:!0}))),oe("Email preenchido com sucesso!",{duration:2e3}),await ce(800)}else oe("Erro ao focar no editor.",{error:!0})}var ao={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},zt={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Ie(e,t,n,o,r,s){let a=document.createElement("div");Object.assign(a.style,ao),Mt(e,a);let i=document.createElement("div");Object.assign(i.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),a.appendChild(i),r&&(r.googleLine=i);let l=document.createElement("div");Object.assign(l.style,{display:"flex",alignItems:"center",gap:"12px"});let f=document.createElement("img");f.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(f.style,{width:"20px",height:"20px",pointerEvents:"none"});let m=document.createElement("span");m.textContent=t,l.appendChild(f),l.appendChild(m);let c=document.createElement("div");Object.assign(c.style,{display:"flex",alignItems:"center",gap:"4px"});let T='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',h='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',y=document.createElement("div");y.innerHTML=T,Object.assign(y.style,zt),y.title="Sobre",y.classList.add("no-drag"),y.onmouseenter=()=>{y.style.background="rgba(255,255,255,0.1)",y.style.color="#FFF"},y.onmouseleave=()=>{y.style.color!=="rgb(138, 180, 248)"&&(y.style.background="transparent",y.style.color="#9AA0A6")};let b=document.createElement("div");b.innerHTML=h,Object.assign(b.style,zt),b.title="Fechar",b.classList.add("no-drag"),b.onmouseenter=()=>{b.style.background="rgba(242, 139, 130, 0.2)",b.style.color="#F28B82"},b.onmouseleave=()=>{b.style.background="transparent",b.style.color="#9AA0A6"},b.onmousedown=E=>E.stopPropagation(),y.onmousedown=E=>E.stopPropagation(),b.onclick=s;let A=io(e,t,n,o);return y.onclick=E=>{E.stopPropagation(),A.style.opacity==="1"?(A.style.opacity="0",A.style.pointerEvents="none",y.style.color="#9AA0A6",y.style.background="transparent"):(A.style.opacity="1",A.style.pointerEvents="auto",y.style.color="#8AB4F8",y.style.background="rgba(138, 180, 248, 0.1)")},c.appendChild(y),c.appendChild(b),a.appendChild(l),a.appendChild(c),a}function io(e,t,n,o){let r=document.createElement("div");return Object.assign(r.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),r.innerHTML=`
    ...
    `,setTimeout(()=>{let s=r.querySelector("#close-help-internal");s&&(s.onmouseover=()=>s.style.backgroundColor="#f8f9fa",s.onmouseout=()=>s.style.backgroundColor="white",s.onclick=()=>{r.style.opacity="0",r.style.pointerEvents="none"})},0),e.appendChild(r),r}var qe=null;function ot(){if(!qe){let e=window.AudioContext||window.webkitAudioContext;e&&(qe=new e)}return qe&&qe.state==="suspended"&&qe.resume(),qe}var Ne={playClick:()=>{let e=ot();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.connect(o),o.connect(e.destination),n.type="sine",n.frequency.setValueAtTime(800,t),n.frequency.exponentialRampToValueAtTime(100,t+.05),o.gain.setValueAtTime(.1,t),o.gain.exponentialRampToValueAtTime(.01,t+.05),n.start(t),n.stop(t+.05)},playSwoosh:()=>{let e=ot();if(!e)return;let t=e.currentTime,n=.25,o=e.sampleRate*n,r=e.createBuffer(1,o,e.sampleRate),s=r.getChannelData(0);for(let f=0;f<o;f++)s[f]=Math.random()*2-1;let a=e.createBufferSource();a.buffer=r;let i=e.createBiquadFilter();i.type="lowpass",i.frequency.setValueAtTime(200,t),i.frequency.linearRampToValueAtTime(800,t+n/2),i.frequency.linearRampToValueAtTime(200,t+n);let l=e.createGain();l.gain.setValueAtTime(.05,t),l.gain.linearRampToValueAtTime(0,t+n),a.connect(i),i.connect(l),l.connect(e.destination),a.start(t)},playSuccess:()=>{let e=ot();if(!e)return;let t=e.currentTime;[523.25,659.25,783.99].forEach((o,r)=>{let s=e.createOscillator(),a=e.createGain();s.connect(a),a.connect(e.destination),s.type="sine",s.frequency.value=o;let i=t+r*.03;a.gain.setValueAtTime(0,i),a.gain.linearRampToValueAtTime(.05,i+.05),a.gain.exponentialRampToValueAtTime(.001,i+.6),s.start(i),s.stop(i+.6)})},playReset:()=>{let e=ot();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.connect(o),o.connect(e.destination),n.type="triangle",n.frequency.setValueAtTime(150,t),n.frequency.exponentialRampToValueAtTime(40,t+.2),o.gain.setValueAtTime(.1,t),o.gain.exponentialRampToValueAtTime(.01,t+.2),n.start(t),n.stop(t+.2)}};if(!document.getElementById("cw-module-styles")){let e=document.createElement("style");e.id="cw-module-styles",e.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=h=>{h.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=h=>{h.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=h=>{h.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=h=>{h.stopPropagation(),e.toggleLinks()},(async function(){await nt(2800),o.classList.add("docked"),await nt(300);let y=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(A=>A.classList.add("visible"));for(let A=0;A<y.length;A++)y[A].classList.add("popped"),await nt(90);await nt(200),o.classList.add("system-check")})();let s=!1,a,i,l,f,m=3;o.onmousedown=h=>{if(h.target.closest("button"))return;h.preventDefault(),a=h.clientX,i=h.clientY;let y=o.getBoundingClientRect();l=y.left,f=y.top,document.addEventListener("mousemove",c),document.addEventListener("mouseup",T)};function c(h){let y=h.clientX-a,b=h.clientY-i;!s&&Math.sqrt(y*y+b*b)>m&&(s=!0,o.style.transition="none"),s&&(o.style.left=`${l+y}px`,o.style.top=`${f+b}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function T(h){if(document.removeEventListener("mousemove",c),document.removeEventListener("mouseup",T),s){s=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let y=window.innerWidth,b=window.innerHeight,A=o.getBoundingClientRect(),E=A.left+A.width/2,j;E<y/2?(j=24,o.classList.remove("side-right"),o.classList.add("side-left")):(j=y-A.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let V=A.top;V<24&&(V=24),V>b-A.height-24&&(V=b-A.height-24),o.style.left=`${j}px`,o.style.top=`${V}px`,setTimeout(()=>{},600)}else{let y=h.target.closest("button");y&&(y.style.transform="scale(0.9)",setTimeout(()=>y.style.transform="",150))}}}function at(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let a=Date.now()-r,i=Math.max(0,1500-a);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},i)}}function Bt(e){let t=document.createElement("div");t.className="cw-step-scenarios";let n=document.createElement("div");Object.assign(n.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let o=document.createElement("div");Object.assign(o.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"40px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s ease"}),o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>";let r=null;Object.entries(xe).forEach(([a,i])=>{let l=document.createElement("div");l.textContent=a,Object.assign(l.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",display:"flex",alignItems:"center",gap:"6px"}),l.onmouseenter=()=>{r!==i&&(o.style.background="#fff",o.style.borderColor="#1a73e8",o.style.color="#202124",o.textContent=`"${i.substring(0,120)}${i.length>120?"...":""}"`),r!==i&&(l.style.background="#f1f3f4")},l.onmouseleave=()=>{r!==i&&(r||(o.style.background="#f8f9fa",o.style.borderColor="#dadce0",o.style.color="#5f6368",o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>"),l.style.background="#ffffff")},l.onclick=()=>{Ne.playClick(),r===i?(r=null,s(),e("")):(r=i,s(),l.style.transform="scale(0.95)",setTimeout(()=>l.style.transform="scale(1)",150),e(i))},n.appendChild(l)});function s(){Array.from(n.children).forEach(a=>{xe[a.textContent]===r?(a.style.background="#e8f0fe",a.style.borderColor="#1a73e8",a.style.color="#1967d2",a.style.fontWeight="500"):(a.style.background="#ffffff",a.style.borderColor="#dadce0",a.style.color="#3c4043",a.style.fontWeight="400")})}return t.appendChild(n),t.appendChild(o),t}var qt=e=>new Promise(t=>setTimeout(t,e));function it(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Ct(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{oe("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Ht(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Vt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function $t(){console.log("Iniciando processo de Nova Nota...");let e=Vt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(a=>a.innerText.trim()==="description");if(o){let a=o.closest("material-fab")||o.closest("material-button");a?(a.style&&(a.style.display="block",a.style.visibility="visible"),it(a)):it(o)}else{let a=document.querySelector("material-fab-speed-dial");if(a){let i=a.querySelector(".trigger");i?(i.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),it(i)):a.click(),await qt(800);let f=Array.from(document.querySelectorAll("i.material-icons-extended")).find(m=>m.innerText.trim()==="description");f&&it(f)}}let r=null,s=0;for(;!r&&s<20;){await qt(300);let a=Vt();if(a.length>t)r=a.find(i=>!e.includes(i)),r||(r=a[a.length-1]);else if(s>10){let i=a.filter(l=>l.offsetParent!==null);i.length>0&&(r=i[i.length-1])}s++}return r}var P={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},ye="cubic-bezier(0.25, 0.8, 0.25, 1)",so={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.bgInput,fontSize:"14px",color:P.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${ye}, box-shadow 0.2s ${ye}, background-color 0.2s`,outline:"none"},Ro={...so,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},Lo={fontSize:"13px",fontWeight:"700",color:P.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},Mo={display:"block",fontSize:"13px",fontWeight:"600",color:P.text,marginBottom:"8px",marginTop:"16px"},Do={fontSize:"12px",color:P.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},Go={fontSize:"12px",color:P.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},Fo={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:P.text,cursor:"pointer",padding:"12px 14px",backgroundColor:P.surface,border:`1px solid ${P.border}`,borderRadius:"12px",transition:`all 0.2s ${ye}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},At={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:P.primary},zo={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:P.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${ye}, box-shadow 0.2s ${ye}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},Po={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${P.primary}`,color:P.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${ye}`},jo={background:"transparent",border:`1px solid ${P.border}`,borderRadius:"20px",color:P.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${ye}`,fontFamily:"'Google Sans', 'Roboto'"};var Bo={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:P.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},qo={fontSize:"13px",fontWeight:"700",color:P.primary,minWidth:"20px",textAlign:"center"},Vo={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${P.border}`,backgroundColor:P.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${ye}, box-shadow 0.2s ${ye}`},Ho={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${P.bgInput}`},$o={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.surface,color:P.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${ye}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Uo={backgroundColor:P.primaryBg,color:P.primary,borderColor:P.primary,fontWeight:"600"},Wo={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:P.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Yo={borderTop:`1px solid ${P.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Xo={maxHeight:"240px",overflowY:"auto",border:`1px solid ${P.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:P.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},Ko={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${P.bgInput}`,cursor:"pointer",fontSize:"13px",color:P.text,transition:"background 0.1s",userSelect:"none"};var ro={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},lo={fontSize:"12px",color:"#e37400",marginTop:"4px"},co={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},po={display:"flex",gap:"15px",marginBottom:"10px"};function Ut(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,ro);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,ht,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,po);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,At);let r=document.createElement("label");r.textContent="Sim";let s=document.createElement("div");Object.assign(s.style,{display:"flex",alignItems:"center"}),s.appendChild(o),s.appendChild(r);let a=document.createElement("input");a.type="radio",a.name="ts_usage_mod",a.value="N\xE3o",a.checked=!0,Object.assign(a.style,At);let i=document.createElement("label");i.textContent="N\xE3o";let l=document.createElement("div");Object.assign(l.style,{display:"flex",alignItems:"center"}),l.appendChild(a),l.appendChild(i),n.appendChild(s),n.appendChild(l);let f=document.createElement("div");f.style.display="block";let m=document.createElement("label");m.textContent="Qual foi o Motivo?",Object.assign(m.style,ht,{fontSize:"12px"});let c=document.createElement("input");c.type="text",Object.assign(c.style,co);let T=document.createElement("div");T.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(T.style,lo),f.appendChild(m),f.appendChild(c),f.appendChild(T),e.appendChild(t),e.appendChild(n),e.appendChild(f),o.onchange=()=>{f.style.display="none"},a.onchange=()=>{f.style.display="block"};function h(A,E){if(e.style.display="none",!A||A.includes("Education")||!E||E.length===0)return;let j=E.some(u=>u.includes("enhanced")||u==="ec_google_ads"),V=E.some(u=>(u.includes("conversion")||u.includes("ads"))&&!u.includes("enhanced")),g=E.some(u=>u.includes("ga4")||u.includes("analytics")||u.includes("ua")),d=E.some(u=>u.includes("merchant")||u.includes("gmc")||u.includes("shopping"));(j||V&&!g&&!d)&&(e.style.display="block")}function y(){if(e.style.display==="none")return"";let A=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return a.checked&&c.value.trim()!==""&&(A+=`<br><b>Motivo:</b> ${c.value}`),A+="<br>",A}function b(){e.style.display="none",a.checked=!0,o.checked=!1,f.style.display="block",c.value=""}return{element:e,updateVisibility:h,getOutput:y,reset:b}}var D={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Fe={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function Wt(e){let t={};function n(g){let d=g.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?D.brands.ads:d.includes("ga4")||d.includes("analytics")?D.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?D.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?D.brands.gmc:D.brands.default}let o=Object.entries(ke).filter(([g,d])=>d.popular),r={};Object.entries(ke).forEach(([g,d])=>{if(d.popular)return;let p=n(d.name);r[p.label]||(r[p.label]={brand:p,tasks:[]}),r[p.label].tasks.push({key:g,...d})});let s="cw-zen-tasks";if(!document.getElementById(s)){let g=document.createElement("style");g.id=s,g.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(g)}let a=document.createElement("div");a.className="cw-zen-container";let i=document.createElement("div");Object.assign(i.style,{display:"none"});let l=document.createElement("div");l.className="cw-screens-container",i.appendChild(l),a.innerHTML=`
    ...
    `;let f=a.querySelector(".cw-hero-grid"),m=a.querySelector(".cw-acc-container"),c=a.querySelector(".cw-results-container"),T=a.querySelector(".cw-search-input"),h=a.querySelector(".cw-status-bar"),y=a.querySelector(".cw-status-text"),b=a.querySelector(".cw-footer-icons");o.forEach(([g,d])=>{let p=n(d.name),u=document.createElement("div");u.className="cw-hero-card",u.id=`hero-${g}`,u.style.setProperty("--hero-color",p.color),u.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${Fe[p.icon]}</div>
        ...
        `,u.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let C=t[g]?t[g].count:0;E(g,C>0?-C:1,d)},u.querySelector(".minus").onclick=()=>E(g,-1,d),u.querySelector(".plus").onclick=()=>E(g,1,d),u.dataset.color=p.color,f.appendChild(u)});function A(g,d){let p=n(d.name),u=document.createElement("div");return u.className="cw-task-item",u.dataset.id=g,u.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${p.bg}; color:${p.color}">
                    ${Fe[p.icon]||Fe.default}
                </div>
        ...
        `,u.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let C=t[g]?t[g].count:0;E(g,C>0?-C:1,d)},u.querySelector(".minus").onclick=()=>E(g,-1,d),u.querySelector(".plus").onclick=()=>E(g,1,d),u}Object.entries(r).forEach(([g,d])=>{let p=document.createElement("div");p.className="cw-acc-group";let u=document.createElement("div");u.className="cw-acc-header",u.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${d.brand.color}"></div>
                ${g}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,u.onclick=()=>{m.querySelectorAll(".cw-acc-group.open").forEach(C=>{C!==p&&C.classList.remove("open")}),p.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",d.tasks.forEach(C=>{let k=A(C.key,C);v.appendChild(k)}),p.appendChild(u),p.appendChild(v),m.appendChild(p)});function E(g,d,p){t[g]||(t[g]={count:0,data:p,brand:n(p.name)}),t[g].count+=d,t[g].count<=0&&delete t[g],j(),V(),e&&e()}function j(){o.forEach(([v])=>{let C=f.querySelector(`#hero-${v}`);if(!C)return;let k=t[v];k?(C.classList.add("active"),C.querySelector(".cw-step-val").textContent=k.count,C.querySelector(".cw-step-val").style.color=C.dataset.color):C.classList.remove("active")}),a.querySelectorAll(".cw-task-item").forEach(v=>{let C=v.dataset.id,k=t[C];k?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=k.count):v.classList.remove("selected")});let d=Object.keys(t),p=0,u=[];if(d.forEach(v=>{let C=t[v];p+=C.count;for(let k=0;k<C.count;k++)u.length<6&&u.push(C.brand)}),p>0){h.classList.add("visible");let v=p>1?"A\xE7\xF5es":"A\xE7\xE3o",C=p>1?"definidas":"definida";y.textContent=`${p} ${v} ${C}`,b.innerHTML="",u.forEach(k=>{let U=document.createElement("div");U.className="cw-mini-icon",U.innerHTML=Fe[k.icon]||Fe.default;let _=U.querySelector("svg");_&&(_.style.width="14px",_.style.height="14px"),b.appendChild(U)})}else h.classList.remove("visible")}T.addEventListener("input",g=>{let d=g.target.value.toLowerCase();if(d.length>0){m.style.display="none",c.style.display="block",c.innerHTML="";let p=!1;Object.entries(ke).forEach(([u,v])=>{if(v.name.toLowerCase().includes(d)){p=!0;let C=A(u,v);t[u]&&(C.classList.add("selected"),C.querySelector(".cw-step-val").textContent=t[u].count),c.appendChild(C)}}),p||(c.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else m.style.display="block",c.style.display="none"});function V(){l.innerHTML="";let g=Object.keys(t),d=!1,p="implementation";if(g.length===0){l.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let u=document.createElement("div");u.className="cw-info-banner",u.innerHTML=`
        ...
        `,l.appendChild(u),g.forEach(v=>{let C=t[v].data,k=t[v].count,U=t[v].brand,_=C.screenshots?C.screenshots[p]||[]:["Link da Evid\xEAncia"];if(_.length>0){d=!0;for(let w=1;w<=k;w++){let G=document.createElement("div");G.className="cw-screen-card",G.style.setProperty("--brand-color",U.color),G.style.setProperty("--brand-bg",U.bg),G.style.setProperty("--brand-shadow",U.color+"40");let F=document.createElement("div");F.className="cw-card-header";let B=document.createElement("div");B.className="cw-card-icon",B.innerHTML=Fe[U.icon]||Fe.default;let O=document.createElement("div");O.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let M=document.createElement("input");M.className="cw-card-title-input",M.id=`name-${v}-${w}`,M.value=`${C.name}${k>1?" #"+w:""}`,M.title="Clique para renomear esta task";let I=document.createElement("span");I.className="cw-edit-hint",I.innerHTML="\u270E Renomear",O.appendChild(M),O.appendChild(I),F.appendChild(B),F.appendChild(O),G.appendChild(F),_.forEach((Z,K)=>{let Y=document.createElement("div");Y.className="cw-input-group";let J=document.createElement("label");J.className="cw-input-label",J.textContent=Z.replace(/📷|:|•/g,"").trim();let ee=document.createElement("input");ee.className="cw-input-field",ee.id=`screen-${v}-${w}-${K}`,ee.placeholder="Cole o link aqui...",ee.setAttribute("autocomplete","off"),ee.addEventListener("input",()=>{ee.value.trim().length>5?ee.classList.add("filled"):ee.classList.remove("filled")});let ve=document.createElement("div");ve.className="cw-input-check",ve.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',Y.appendChild(J),Y.appendChild(ee),Y.appendChild(ve),G.appendChild(Y)}),l.appendChild(G)}}}),i.style.display=d?"block":"none"}return{selectionElement:a,screenshotsElement:i,updateSubStatus:()=>V(),getCheckedElements:()=>Object.keys(t).map(g=>({value:g,closest:()=>({querySelector:()=>({textContent:t[g].count})})})),toggleTask:(g,d=!0)=>{let p=t[g];d&&!p?E(g,1,ke[g]):!d&&p&&E(g,-p.count,ke[g])},reset:()=>{for(let g in t)delete t[g];T.value="",m.style.display="block",c.style.display="none",j(),V()}}}function Yt(){let e="v3.6.0",t="bau",n="pt",o=!1,r=!1,s={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},a=Ut(),i=Wt(()=>{let R=i.getCheckedElements().map(S=>S.value);w&&w.value&&a.updateVisibility(w.value,R)}),l=document.createElement("div");l.id="autofill-popup",Object.assign(l.style,Te,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),l.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let m=Ie(l,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:l,googleLine:null},()=>mt());l.appendChild(m);let c=document.createElement("div");Object.assign(c.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),l.appendChild(c);let T=document.createElement("div");T.textContent="created by lucaste@",Object.assign(T.style,Dt),l.appendChild(T);let h=document.createElement("div");h.id="step-lang-type";let y=document.createElement("label");Object.assign(y.style,s.label),h.appendChild(y);let b=document.createElement("div");Object.assign(b.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let A=document.createElement("div");A.textContent="Portugu\xEAs",A.classList.add("no-drag"),Object.assign(A.style,de);let E=document.createElement("div");E.textContent="Espa\xF1ol",E.classList.add("no-drag"),Object.assign(E.style,de),A.onclick=()=>ct("pt"),E.onclick=()=>ct("es"),b.appendChild(A),b.appendChild(E),h.appendChild(b),c.appendChild(h);let j=document.createElement("div");j.id="step-0-case-type";let V=document.createElement("label");Object.assign(V.style,s.label),j.appendChild(V);let g=document.createElement("div");Object.assign(g.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let d=document.createElement("div");d.textContent="BAU",d.classList.add("no-drag"),Object.assign(d.style,de);let p=document.createElement("div");p.textContent="LM",p.classList.add("no-drag"),Object.assign(p.style,de),d.onclick=()=>lt("bau"),p.onclick=()=>lt("lm"),g.appendChild(d),g.appendChild(p),j.appendChild(g),c.appendChild(j);let u=document.createElement("div");u.id="step-1-selection";let v=document.createElement("label");Object.assign(v.style,s.label);let C=document.createElement("select");C.id="main-status",Object.assign(C.style,Ue),C.innerHTML='<option value="">-- Selecione --</option><option value="NI">NI - Need Info</option><option value="SO">SO - Solution Offered</option><option value="IN">IN - Inactive</option><option value="AS">AS - Assigned</option>';let k=document.createElement("div");Object.assign(k.style,{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginTop:"16px",marginBottom:"8px"});let U=document.createElement("label");Object.assign(U.style,s.label,{marginTop:"0",marginBottom:"0"});let _=document.createElement("a");_.target="_blank",_.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg> Guia de Substatus',Object.assign(_.style,s.helpLink),k.appendChild(U),k.appendChild(_);let w=document.createElement("select");w.id="sub-status",Object.assign(w.style,Ue),w.disabled=!0,u.appendChild(v),u.appendChild(C),u.appendChild(k),u.appendChild(w),c.appendChild(u);let G=document.createElement("div");G.id="step-1-1-portugal",Object.assign(G.style,s.stepBlock,{display:"none"});let F=document.createElement("label");Object.assign(F.style,s.label),G.appendChild(F);let B=document.createElement("div");Object.assign(B.style,s.radioContainer);let O=document.createElement("div");Object.assign(O.style,{display:"flex",alignItems:"center"});let M=document.createElement("input");M.type="radio",M.name="portugal-group",M.value="sim",Object.assign(M.style,s.checkboxInput);let I=document.createElement("label");I.htmlFor="portugal-sim",Object.assign(I.style,{cursor:"pointer"}),O.appendChild(M),O.appendChild(I);let Z=document.createElement("div");Object.assign(Z.style,{display:"flex",alignItems:"center"});let K=document.createElement("input");K.type="radio",K.name="portugal-group",K.value="nao",K.checked=!0,Object.assign(K.style,s.checkboxInput);let Y=document.createElement("label");Y.htmlFor="portugal-nao",Object.assign(Y.style,{cursor:"pointer"}),Z.appendChild(K),Z.appendChild(Y),B.appendChild(O),B.appendChild(Z),G.appendChild(B),c.appendChild(G);function J(x){o=x,x?ee.style.display="block":ee.style.display="none"}M.onchange=()=>J(!0),K.onchange=()=>J(!1);let ee=document.createElement("div");ee.id="step-1-2-consent",Object.assign(ee.style,s.stepBlock,{display:"none"});let ve=document.createElement("label");Object.assign(ve.style,s.label),ee.appendChild(ve);let Pe=document.createElement("div");Object.assign(Pe.style,s.radioContainer);let be=document.createElement("div");Object.assign(be.style,{display:"flex",alignItems:"center"});let ge=document.createElement("input");ge.type="radio",ge.name="consent-group",ge.value="Sim",ge.checked=!0,Object.assign(ge.style,s.checkboxInput);let ne=document.createElement("label");ne.htmlFor="consent-sim",Object.assign(ne.style,{cursor:"pointer"}),be.appendChild(ge),be.appendChild(ne);let X=document.createElement("div");Object.assign(X.style,{display:"flex",alignItems:"center"});let Se=document.createElement("input");Se.type="radio",Se.name="consent-group",Se.value="N\xE3o",Object.assign(Se.style,s.checkboxInput);let Re=document.createElement("label");Re.htmlFor="consent-nao",Object.assign(Re.style,{cursor:"pointer"}),X.appendChild(Se),X.appendChild(Re),Pe.appendChild(be),Pe.appendChild(X),ee.appendChild(Pe),c.appendChild(ee);let Le=document.createElement("div");Le.id="step-1-5-snippets",Object.assign(Le.style,s.stepBlock,{display:"none"});let Ke=document.createElement("h3");Object.assign(Ke.style,s.h3),Ke.textContent="Cen\xE1rios Comuns";let fe=Bt(x=>{let R=document.querySelector("textarea");R&&(R.value=x,R.dispatchEvent(new Event("input")),R.style.transition="background-color 0.2s",R.style.backgroundColor="#e8f0fe",setTimeout(()=>R.style.backgroundColor="#fff",300))});fe.id="snippet-container",Le.appendChild(Ke),Le.appendChild(fe),c.appendChild(Le);let he=document.createElement("div");he.id="step-2-tasks",Object.assign(he.style,s.stepBlock,{display:"none"});let pe=document.createElement("button");pe.textContent="+ Gostaria de selecionar uma task?",Object.assign(pe.style,s.optionalBtn),pe.onmouseover=()=>{pe.style.background="#e8f0fe"},pe.onmouseout=()=>{pe.style.background="white"};let je=document.createElement("h3");Object.assign(je.style,s.h3);let wt=document.createElement("div");wt.id="task-checkboxes-container",he.appendChild(pe),he.appendChild(wt),he.appendChild(je),he.appendChild(i.selectionElement),c.appendChild(he);let Ce=document.createElement("div");Ce.id="step-3-form",Object.assign(Ce.style,s.stepBlock,{display:"none"});let rt=document.createElement("h3");Object.assign(rt.style,s.h3),Ce.appendChild(rt);let Ee=document.createElement("div");Ee.id="dynamic-form-fields-container",Ce.appendChild(Ee),Ce.appendChild(a.element),Ce.appendChild(i.screenshotsElement),c.appendChild(Ce);let Me=document.createElement("div");Me.id="step-4-email",Object.assign(Me.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let De=document.createElement("label");De.style.display="flex",De.style.alignItems="center",De.style.cursor="pointer",De.style.fontSize="14px";let Ge=document.createElement("input");Ge.type="checkbox",Ge.checked=!0,Object.assign(Ge.style,s.checkboxInput),De.appendChild(Ge),De.appendChild(document.createTextNode("Preencher email automaticamente?")),Me.appendChild(De),c.appendChild(Me);let Be=document.createElement("div");Object.assign(Be.style,{display:"none",gap:"8px",padding:"0"}),c.appendChild(Be);let Ve=document.createElement("button");Object.assign(Ve.style,s.buttonBase,{backgroundColor:"#5f6368"}),Ve.textContent="Copiar";let He=document.createElement("button");Object.assign(He.style,s.buttonBase,{backgroundColor:"#1a73e8"}),He.textContent="Preencher",Be.appendChild(Ve),Be.appendChild(He);let $e=document.createElement("div");Object.assign($e.style,Ze),$e.className="no-drag",$e.title="Redimensionar",l.appendChild($e),Je(l,$e),document.body.appendChild(l);function lt(x){t=x;let R=We();Object.assign(d.style,de),Object.assign(p.style,de),x==="bau"?(Object.assign(d.style,R),_.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(p.style,R),_.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),w.value&&w.dispatchEvent(new Event("change"))}function z(x){try{if(we&&we[n]&&we[n][x])return we[n][x];if(we&&we.pt&&we.pt[x])return we.pt[x]}catch{}return x}function Jt(){y.textContent=z("idioma"),V.textContent=z("fluxo"),v.textContent=z("status_principal"),U.textContent=z("substatus"),Ke.textContent=z("cenarios_comuns"),je.textContent=z("selecione_tasks"),rt.textContent=z("preencha_detalhes"),Ve.textContent=z("copiar"),He.textContent=z("preencher"),C.querySelector('option[value=""]')&&(C.querySelector('option[value=""]').textContent=z("select_status")),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=z("select_substatus")),F.textContent=z("caso_portugal"),I.textContent=z("sim"),Y.textContent=z("nao"),ve.textContent=z("consentiu_gravacao"),ne.textContent=z("sim"),Re.textContent=z("nao"),Ee.querySelectorAll("label").forEach(x=>{let R=x.nextElementSibling.id.replace("field-",""),S=z(R.toLowerCase());S!==R.toLowerCase()?x.textContent=S:x.textContent=R.replace(/_/g," ").replace(/\b\w/g,q=>q.toUpperCase())+":"}),pe.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function ct(x){n=x;let R=We();Object.assign(A.style,de),Object.assign(E.style,de),x==="pt"?(Object.assign(A.style,R),G.style.display="block",J(o)):(Object.assign(E.style,R),G.style.display="none",ee.style.display="none"),Jt(),w.value&&w.dispatchEvent(new Event("change"))}function dt(x){(x.value.trim()===""||x.value.trim()==="\u2022")&&(x.value="\u2022 "),x.onkeydown=function(R){if(R.key==="Enter"){R.preventDefault();let S=this.selectionStart,q=this.selectionEnd,te=this.value,re=te.lastIndexOf(`
`,S-1)+1,me=te.substring(re,S),le=me.trim()==="\u2022"||me.trim()===""?`
`:`
\u2022 `;this.value=te.substring(0,S)+le+te.substring(q),this.selectionStart=this.selectionEnd=S+le.length}else if(R.key==="Backspace"){let S=this.selectionStart;if(S===this.selectionEnd&&S>0){let q=this.value.substring(0,S);q.endsWith(`
\u2022 `)?(R.preventDefault(),this.value=q.substring(0,S-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=S-3):q==="\u2022 "&&(R.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function pt(){let x=typeof fe<"u"?fe:document.getElementById("snippet-container");if(!x)return;let R=x.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),S={},q=new Set;R.forEach(W=>{let H=W.id,L=xe[H];if(L)for(let N in L)N==="linkedTask"?q.add(L.linkedTask):N!=="type"&&(S[N]||(S[N]=[]),S[N].includes(L[N])||S[N].push(L[N]))});let te=new Set;Object.values(xe).forEach(W=>{Object.keys(W).forEach(H=>{H!=="linkedTask"&&H!=="type"&&te.add(H)})}),te.forEach(W=>{let H=document.getElementById(W);if(H){let L=S[W]||[],N="";Xe.includes(W.replace("field-",""))?(N=L.map($=>$.startsWith("\u2022 ")?$:"\u2022 "+$).join(`
`),N===""?N="\u2022 ":N.endsWith(`
\u2022 `)||(N+=`
\u2022 `)):N=L.join(`

`),N.trim()!=="\u2022"&&N.trim()!==""?H.value=N:Xe.includes(W.replace("field-",""))?H.value="\u2022 ":H.value="",H.tagName==="TEXTAREA"&&typeof dt=="function"&&dt(H)}});let re=new Set,me=new Set;x.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(W=>{let H=xe[W.id];H&&H.linkedTask&&(W.checked?re.add(H.linkedTask):me.add(H.linkedTask))}),me.forEach(W=>{re.has(W)||i.toggleTask(W,!1)}),re.forEach(W=>{i.toggleTask(W,!0)})}C.onchange=()=>{let x=C.value;if(ut(1.5),w.innerHTML=`<option value="">${z("select_substatus")}</option>`,!x){w.disabled=!0;return}for(let R in Ye){let S=Ye[R];if(S.status===x){let q=document.createElement("option");q.value=R,q.textContent=S.name,w.appendChild(q)}}w.disabled=!1},w.onchange=()=>{let x=w.value;if(ut(1.5),!x)return;i.updateSubStatus(x);let R=Ye[x];fe.innerHTML="";let S=(L,N,$)=>{let ae=document.createElement("label");Object.assign(ae.style,s.checkboxLabel),ae.onmouseover=()=>ae.style.backgroundColor="#e8eaed",ae.onmouseout=()=>ae.style.backgroundColor="#f8f9fa";let Q=document.createElement("input");return Q.type=N,Q.id=L.id,Object.assign(Q.style,s.checkboxInput),ae.appendChild(Q),ae.appendChild(document.createTextNode(` ${L.text}`)),$.appendChild(ae),Q},q=[],te="radio";if(x==="NI_Awaiting_Inputs")q=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(x.startsWith("SO_"))te="checkbox",q=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(x.startsWith("AS_")){te="checkbox";let L=document.createElement("label");L.textContent=z("cenarios_comuns"),Object.assign(L.style,s.label),fe.appendChild(L),q=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else x.startsWith("IN_")&&(q=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let re=q.filter(L=>{let N=xe[L.id];return!N.type||N.type==="all"||N.type===t});re.forEach((L,N)=>{let $=S(L,te,fe);te==="radio"&&($.name="scenario-radio-group",N===0&&($.checked=!0))}),re.length>0&&(Le.style.display="block"),R.requiresTasks?(pe.style.display="none",je.style.display="block",i.selectionElement.style.display="block",he.style.display="block"):(pe.style.display="block",je.style.display="none",i.selectionElement.style.display="none",he.style.display="block"),Ee.innerHTML="";let me=R.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(me)].forEach(L=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(L))return;let N=L.slice(1,-1),$=document.createElement("label"),ae=z(N.toLowerCase());$.textContent=ae!==N.toLowerCase()?ae:N.replace(/_/g," ").replace(/\b\w/g,ie=>ie.toUpperCase())+":",Object.assign($.style,s.label);let Q;Xe.includes(N)?(Q=document.createElement("textarea"),Object.assign(Q.style,s.textarea),Q.classList.add("bullet-textarea"),dt(Q)):yt.includes(N)?(Q=document.createElement("textarea"),Object.assign(Q.style,s.textarea)):(Q=document.createElement("input"),Q.type="text",Object.assign(Q.style,s.input),N==="REASON_COMMENTS"&&(x.startsWith("NI_")||x.startsWith("IN_"))&&(Object.assign($.style,{display:"none"}),Object.assign(Q.style,{display:"none"}))),N==="ON_CALL"&&t==="lm"&&(Object.assign($.style,{display:"none"}),Object.assign(Q.style,{display:"none"}),Q.value="N/A"),Q.id=`field-${N}`,Ee.appendChild($),Ee.appendChild(Q)});let W=fe.querySelectorAll('input[type="checkbox"], input[type="radio"]');W.length>0&&(W.forEach(L=>{L.removeEventListener("change",pt),L.addEventListener("change",pt)}),pt()),Ce.style.display="block",et[x]?Me.style.display="block":Me.style.display="none",Be.style.display="flex";let H=i.getCheckedElements().map(L=>L.value);a.updateVisibility(x,H)},pe.onclick=()=>{pe.style.display="none",je.style.display="block",i.selectionElement.style.display="block"};function Et(){let x=w.value;if(!x)return null;let S=Ye[x].template.replace(/\n/g,"<br>"),q='style="margin-bottom: 12px; padding-left: 30px;"',te=[],re="",me=i.getCheckedElements();me.length>0&&me.forEach(H=>{let L=H.value,N=ke[L],$=H.closest().querySelector(".stepper-count"),ae=$?parseInt($.textContent):1;ae>1?te.push(`${N.name} (x${ae})`):te.push(N.name)});let le=i.screenshotsElement;if(le){let H=Array.from(le.querySelectorAll('input[id^="name-"]'));H.length>0&&H.forEach(L=>{let N=L.value,$=L.closest(".cw-screen-card");if($){let ae=$.querySelectorAll('input[id^="screen-"]'),Q=!1,ie="";ae.forEach(ue=>{let Tt=ue.closest(".cw-input-group"),kt=Tt?Tt.querySelector(".cw-input-label"):null,eo=kt?kt.textContent:"Evid\xEAncia",Ot=ue.value.trim(),to=Ot?` ${Ot}`:"";ie+=`<li>${eo} -${to}</li>`,Q=!0}),Q&&(re+=`<b>${N}</b>`,re+=`<ul ${q}>${ie}</ul>`)}})}if(S.includes("{TAGS_IMPLEMENTED}")?S=S.replace(/{TAGS_IMPLEMENTED}/g,te.join(", ")||"N/A"):te.length>0&&(S+=`<br><b>Tags:</b> ${te.join(", ")}<br>`),S.includes("{SCREENSHOTS_LIST}")?S=S.replace(/{SCREENSHOTS_LIST}/g,re?`${re}`:"N/A"):re!==""&&(S+=`<br>${re}`),n==="pt"&&o){let H=ge.checked?z("sim"):z("nao");S=S.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${z("consentiu_gravacao")}</b> ${H}<br><br>`),S=S.replace(/{CASO_PORTUGAL}/g,`<br><b>${z("caso_portugal")}</b> ${z("sim")}<br>`)}else n==="pt"&&!o?(S=S.replace(/{CASO_PORTUGAL}/g,`<br><b>${z("caso_portugal")}</b> ${z("nao")}<br>`),S=S.replace(/{CONSENTIU_GRAVACAO}/g,"")):(S=S.replace(/{CASO_PORTUGAL}/g,""),S=S.replace(/{CONSENTIU_GRAVACAO}/g,""));return Ee.querySelectorAll("input, textarea").forEach(H=>{let L=H.id.replace("field-",""),N=new RegExp(`{${L}}`,"g"),$=H.value;if(L==="REASON_COMMENTS"&&(x.startsWith("NI_")||x.startsWith("IN_"))){let ie=fe.querySelector('input[type="radio"]:checked');ie&&xe[ie.id]&&($=xe[ie.id]["field-REASON_COMMENTS"])}if(Xe.includes(L)&&$.trim()!==""){let ie=$.split(`
...
`).filter(ie=>ie.trim()!=="").map(ie=>`<p style="margin: 0 0 8px 0;">${ie}</p>`).join(""):H.tagName==="TEXTAREA"&&($=$.replace(/\n/g,"<br>"));let ae=$.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ae===""||ae==="\u2022"||ae.toLowerCase()==="n/a"){let ie=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${L}\\}(?:<br>\\s*)?`,"gi");ie.test(S)?S=S.replace(ie,""):S=S.replace(N,"")}else S=S.replace(N,$.replace(/\$/g,"$$$$"))}),S=S.replace(/{([A-Z0-9_]+)}/g,""),S=S.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(S+=a.getOutput()),S}Ve.onclick=()=>{let x=Et();x?(Ct(x),oe(z("copiado_sucesso"))):oe(z("selecione_substatus"),{error:!0})},He.onclick=async()=>{let x=w.value,R=Et();if(!R){oe(z("selecione_substatus"),{error:!0});return}Ct(R),mt();let S=at(),q=await $t();if(q)try{if(q.focus(),q.innerHTML.trim()==="<p><br></p>"||q.innerHTML.trim()==="<br>"||q.innerText.trim()===""){let le=document.createRange();le.selectNodeContents(q);let W=window.getSelection();W.removeAllRanges(),W.addRange(le),document.execCommand("delete",!1,null)}else if(!q.innerHTML.endsWith("<br><br>")){let le=document.createRange();le.selectNodeContents(q),le.collapse(!1);let W=window.getSelection();W.removeAllRanges(),W.addRange(le),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,R),Ht(q),setTimeout(()=>{oe(z("inserido_copiado"))},600);let re=typeof Ge<"u"&&Ge?Ge.checked:!0;if(x&&et[x]&&re){let le=et[x];await Ft(le),await new Promise(W=>setTimeout(W,500))}S(),ut(1.5),C.value="",w.innerHTML=`<option value="">${z("select_substatus")}</option>`,w.disabled=!0}catch(te){console.error(te),oe("Erro ao inserir.",{error:!0}),S()}};function ut(x=1.5){x<=1.5&&(Le.style.display="none",fe.innerHTML=""),x<=2&&(he.style.display="none",i.reset(),pe.style.display="none"),x<=3&&(Ce.style.display="none",Ee.innerHTML="",a.reset(),Be.style.display="none",Me.style.display="none")}function mt(){if(r=!r,r){let x=l.querySelector(".cw-expand-btn");x&&typeof x.resetState=="function"&&x.resetState()}_e(r,l,"cw-btn-notes")}return lt("bau"),ct("pt"),mt}var ze={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let M=C.querySelector("#csa-back-btn");M.onmouseover=()=>M.style.backgroundColor="#f1f3f4",M.onmouseout=()=>M.style.backgroundColor="transparent",M.onclick=_;let I=C.querySelector("#csa-insert-btn");I.onmouseover=()=>I.style.backgroundColor="#174ea6",I.onmouseout=()=>I.style.backgroundColor="#1a73e8",I.onclick=async()=>{I.style.transform="scale(0.96)",b();let Z=at();try{await vt(F),Z()}catch(K){console.error(K),Z()}setTimeout(()=>{I.style.transform="scale(1)",_()},300)}}function _(){o="list",j.style.transform="translateX(0)"}function w(){p.innerHTML="",Object.keys(ze).forEach(F=>{let B=ze[F],O=document.createElement("button");O.textContent=B.title,Object.assign(O.style,f),t===F&&n===""&&Object.assign(O.style,m),O.onclick=()=>{t=F,n="",d.value="",w(),G()},p.appendChild(O)})}function G(){u.innerHTML="";let F=[];if(n.trim()!==""?Object.values(ze).forEach(M=>{let I=M.emails.filter(Z=>Z.name.toLowerCase().includes(n.toLowerCase()));F=[...F,...I]}):ze[t]&&(F=ze[t].emails),F.length===0){u.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let B='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',O='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';F.forEach(M=>{let I=document.createElement("div");Object.assign(I.style,c);let Z=M.subject.length>50?M.subject.substring(0,50)+"...":M.subject;I.innerHTML=`

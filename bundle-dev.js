...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var ie=e=>new Promise(t=>setTimeout(t,e));function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Qe(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,r=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&r})}async function Lt(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(s=>s.innerText.trim()==="email");if(n&&n.offsetParent!==null){let s=n.closest("material-button")||n.closest("material-fab")||n;s.style&&(s.style.display="block",s.style.visibility="visible"),Ce(s),e=!0}else{let s=document.querySelector("material-fab-speed-dial");if(s){let u=s.querySelector(".trigger");if(u){u.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Ce(u),await ie(1e3);let v=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");v&&(Ce(v),e=!0)}else s.click()}}let o=0,r=Qe();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!r&&o<30;)await ie(500),r=Qe(),o++;if(!r)return Q("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let i=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(s=>s.offsetParent!==null);if(i){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),Ce(i);let s=null,u=0;for(;!s&&u<10;)await ie(200),s=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(v=>v.offsetParent!==null),u++;s?(console.log("\u2705 Confirmando descarte..."),Ce(s),await ie(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(r){let s=r.closest('[id="email-body-content-top"]'),y=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(s){if(y){let p=y.closest('[aria-hidden="true"]');p&&p.removeAttribute("aria-hidden"),y.focus()}await ie(300),s.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let v=s.querySelector("#cases-body-field");if(v){let p=document.createRange();p.selectNodeContents(v),p.collapse(!0);let w=window.getSelection();w.removeAllRanges(),w.addRange(p)}return!0}}return Q("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function Mt(e){if(!e)return;Q("Preparando email...",{duration:3e3});let t=ut();if(!await Lt())return;await ie(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await ie(200),Ce(o),await ie(1500);let r=document.querySelector("material-auto-suggest-input input");if(r){Ce(r),await ie(200),document.execCommand("insertText",!1,e),r.dispatchEvent(new Event("input",{bubbles:!0}));let a=null,i=0;for(;i<20;){await ie(500),i++;let s=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(s.length>0&&(a=s.find(u=>u.innerText.toLowerCase().includes(e.toLowerCase())),!a&&s.length===1&&(a=s[0]),a))break}if(a){let s=function(p,w){if(p.nodeType===3&&p.nodeValue.includes(w))return p;if(!p.childNodes)return null;for(let g of p.childNodes){let f=s(g,w);if(f)return f}return null};Ce(a),await ie(2e3);let u=Qe(),y=u?u.closest('[id="email-body-content-top"]'):document.body,v=s(y,"{%ADVERTISER_NAME%}");if(v){let p=document.createRange(),w=v.nodeValue.indexOf("{%ADVERTISER_NAME%}");p.setStart(v,w),p.setEnd(v,w+19);let g=window.getSelection();g.removeAllRanges(),g.addRange(p),document.execCommand("insertText",!1,t.advertiserName),Q("Email preenchido!")}else Q("Email inserido (Nome n\xE3o substitu\xEDdo).")}else Q(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else Q("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function ft(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),Q("Preparando email...",{duration:3e3});let t=ut(),n=pt();if(!await Lt())return;await ie(600);let r=document.querySelector('input[aria-label="Subject"]');r&&e.subject&&(r.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(r,e.subject),r.dispatchEvent(new Event("input",{bubbles:!0})),await ie(300));let a=Qe();if(a){let s=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');s&&(s.focus(),s.click(),s.dispatchEvent(new Event("input",{bubbles:!0}))),await ie(400);let u=new Date;u.setDate(u.getDate()+3);let y=u.getDay();y===6?u.setDate(u.getDate()+2):y===0&&u.setDate(u.getDate()+1);let v=u.toLocaleDateString("pt-BR"),p=e.body;p=p.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),p=p.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),p=p.replace(/\[URL\]/g,t.websiteUrl||"seu site"),p=p.replace(/\[Seu Nome\]/g,n),p=p.replace(/\[MM\/DD\/YYYY\]/g,v),document.execCommand("insertHTML",!1,p),s&&(s.dispatchEvent(new Event("input",{bubbles:!0})),s.dispatchEvent(new Event("change",{bubbles:!0}))),Q("Email preenchido com sucesso!",{duration:2e3}),await ie(800)}else Q("Erro ao focar no editor.",{error:!0})}var Jt={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Dt={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Ae(e,t,n,o,r,a){let i=document.createElement("div");Object.assign(i.style,Jt),_t(e,i);let s=document.createElement("div");Object.assign(s.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),i.appendChild(s),r&&(r.googleLine=s);let u=document.createElement("div");Object.assign(u.style,{display:"flex",alignItems:"center",gap:"12px"});let y=document.createElement("img");y.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(y.style,{width:"20px",height:"20px",pointerEvents:"none"});let v=document.createElement("span");v.textContent=t,u.appendChild(y),u.appendChild(v);let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center",gap:"4px"});let w='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',g='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',f=document.createElement("div");f.innerHTML=w,Object.assign(f.style,Dt),f.title="Sobre",f.classList.add("no-drag"),f.onmouseenter=()=>{f.style.background="rgba(255,255,255,0.1)",f.style.color="#FFF"},f.onmouseleave=()=>{f.style.color!=="rgb(138, 180, 248)"&&(f.style.background="transparent",f.style.color="#9AA0A6")};let C=document.createElement("div");C.innerHTML=g,Object.assign(C.style,Dt),C.title="Fechar",C.classList.add("no-drag"),C.onmouseenter=()=>{C.style.background="rgba(242, 139, 130, 0.2)",C.style.color="#F28B82"},C.onmouseleave=()=>{C.style.background="transparent",C.style.color="#9AA0A6"},C.onmousedown=T=>T.stopPropagation(),f.onmousedown=T=>T.stopPropagation(),C.onclick=a;let E=eo(e,t,n,o);return f.onclick=T=>{T.stopPropagation(),E.style.opacity==="1"?(E.style.opacity="0",E.style.pointerEvents="none",f.style.color="#9AA0A6",f.style.background="transparent"):(E.style.opacity="1",E.style.pointerEvents="auto",f.style.color="#8AB4F8",f.style.background="rgba(138, 180, 248, 0.1)")},p.appendChild(f),p.appendChild(C),i.appendChild(u),i.appendChild(p),i}function eo(e,t,n,o){let r=document.createElement("div");return Object.assign(r.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),r.innerHTML=`
...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=g=>{g.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=g=>{g.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=g=>{g.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=g=>{g.stopPropagation(),e.toggleLinks()},(async function(){await Ze(2800),o.classList.add("docked"),await Ze(300);let f=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(E=>E.classList.add("visible"));for(let E=0;E<f.length;E++)f[E].classList.add("popped"),await Ze(90);await Ze(200),o.classList.add("system-check")})();let a=!1,i,s,u,y,v=3;o.onmousedown=g=>{if(g.target.closest("button"))return;g.preventDefault(),i=g.clientX,s=g.clientY;let f=o.getBoundingClientRect();u=f.left,y=f.top,document.addEventListener("mousemove",p),document.addEventListener("mouseup",w)};function p(g){let f=g.clientX-i,C=g.clientY-s;!a&&Math.sqrt(f*f+C*C)>v&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${u+f}px`,o.style.top=`${y+C}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function w(g){if(document.removeEventListener("mousemove",p),document.removeEventListener("mouseup",w),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let f=window.innerWidth,C=window.innerHeight,E=o.getBoundingClientRect(),T=E.left+E.width/2,j;T<f/2?(j=24,o.classList.remove("side-right"),o.classList.add("side-left")):(j=f-E.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let V=E.top;V<24&&(V=24),V>C-E.height-24&&(V=C-E.height-24),o.style.left=`${j}px`,o.style.top=`${V}px`,setTimeout(()=>{},600)}else{let f=g.target.closest("button");f&&(f.style.transform="scale(0.9)",setTimeout(()=>f.style.transform="",150))}}}function Je(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let i=Date.now()-r,s=Math.max(0,1500-i);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},s)}}var zt=e=>new Promise(t=>setTimeout(t,e));function et(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function xt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{Q("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function jt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Pt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Bt(){console.log("Iniciando processo de Nova Nota...");let e=Pt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(i=>i.innerText.trim()==="description");if(o){let i=o.closest("material-fab")||o.closest("material-button");i?(i.style&&(i.style.display="block",i.style.visibility="visible"),et(i)):et(o)}else{let i=document.querySelector("material-fab-speed-dial");if(i){let s=i.querySelector(".trigger");s?(s.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),et(s)):i.click(),await zt(800);let y=Array.from(document.querySelectorAll("i.material-icons-extended")).find(v=>v.innerText.trim()==="description");y&&et(y)}}let r=null,a=0;for(;!r&&a<20;){await zt(300);let i=Pt();if(i.length>t)r=i.find(s=>!e.includes(s)),r||(r=i[i.length-1]);else if(a>10){let s=i.filter(u=>u.offsetParent!==null);s.length>0&&(r=s[s.length-1])}a++}return r}var P={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},ge="cubic-bezier(0.25, 0.8, 0.25, 1)",to={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.bgInput,fontSize:"14px",color:P.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${ge}, box-shadow 0.2s ${ge}, background-color 0.2s`,outline:"none"},Co={...to,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},Ao={fontSize:"13px",fontWeight:"700",color:P.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},wo={display:"block",fontSize:"13px",fontWeight:"600",color:P.text,marginBottom:"8px",marginTop:"16px"},Eo={fontSize:"12px",color:P.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},To={fontSize:"12px",color:P.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},ko={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:P.text,cursor:"pointer",padding:"12px 14px",backgroundColor:P.surface,border:`1px solid ${P.border}`,borderRadius:"12px",transition:`all 0.2s ${ge}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},yt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:P.primary},Oo={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:P.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${ge}, box-shadow 0.2s ${ge}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},Io={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${P.primary}`,color:P.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${ge}`},No={background:"transparent",border:`1px solid ${P.border}`,borderRadius:"20px",color:P.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${ge}`,fontFamily:"'Google Sans', 'Roboto'"};var _o={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:P.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},Ro={fontSize:"13px",fontWeight:"700",color:P.primary,minWidth:"20px",textAlign:"center"},Lo={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${P.border}`,backgroundColor:P.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${ge}, box-shadow 0.2s ${ge}`},Mo={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${P.bgInput}`},Do={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.surface,color:P.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${ge}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Go={backgroundColor:P.primaryBg,color:P.primary,borderColor:P.primary,fontWeight:"600"},Fo={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:P.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},zo={borderTop:`1px solid ${P.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Po={maxHeight:"240px",overflowY:"auto",border:`1px solid ${P.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:P.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},jo={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${P.bgInput}`,cursor:"pointer",fontSize:"13px",color:P.text,transition:"background 0.1s",userSelect:"none"};var oo={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},no={fontSize:"12px",color:"#e37400",marginTop:"4px"},ao={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},io={display:"flex",gap:"15px",marginBottom:"10px"};function qt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,oo);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,ze,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,io);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,yt);let r=document.createElement("label");r.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(r);let i=document.createElement("input");i.type="radio",i.name="ts_usage_mod",i.value="N\xE3o",i.checked=!0,Object.assign(i.style,yt);let s=document.createElement("label");s.textContent="N\xE3o";let u=document.createElement("div");Object.assign(u.style,{display:"flex",alignItems:"center"}),u.appendChild(i),u.appendChild(s),n.appendChild(a),n.appendChild(u);let y=document.createElement("div");y.style.display="block";let v=document.createElement("label");v.textContent="Qual foi o Motivo?",Object.assign(v.style,ze,{fontSize:"12px"});let p=document.createElement("input");p.type="text",Object.assign(p.style,ao);let w=document.createElement("div");w.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(w.style,no),y.appendChild(v),y.appendChild(p),y.appendChild(w),e.appendChild(t),e.appendChild(n),e.appendChild(y),o.onchange=()=>{y.style.display="none"},i.onchange=()=>{y.style.display="block"};function g(E,T){if(e.style.display="none",!E||E.includes("Education")||!T||T.length===0)return;let j=T.some(c=>c.includes("enhanced")||c==="ec_google_ads"),V=T.some(c=>(c.includes("conversion")||c.includes("ads"))&&!c.includes("enhanced")),h=T.some(c=>c.includes("ga4")||c.includes("analytics")||c.includes("ua")),b=T.some(c=>c.includes("merchant")||c.includes("gmc")||c.includes("shopping"));(j||V&&!h&&!b)&&(e.style.display="block")}function f(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return i.checked&&p.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${p.value}`),E+="<br>",E}function C(){e.style.display="none",i.checked=!0,o.checked=!1,y.style.display="block",p.value=""}return{element:e,updateVisibility:g,getOutput:f,reset:C}}var D={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},_e={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function Vt(e){let t={};function n(h){let b=h.toLowerCase();return b.includes("ads")||b.includes("conversion")||b.includes("remarketing")?D.brands.ads:b.includes("ga4")||b.includes("analytics")?D.brands.ga4:b.includes("gtm")||b.includes("tag manager")||b.includes("container")?D.brands.gtm:b.includes("merchant")||b.includes("shopping")||b.includes("feed")?D.brands.gmc:D.brands.default}let o=Object.entries(Se).filter(([h,b])=>b.popular),r={};Object.entries(Se).forEach(([h,b])=>{if(b.popular)return;let l=n(b.name);r[l.label]||(r[l.label]={brand:l,tasks:[]}),r[l.label].tasks.push({key:h,...b})});let a="cw-zen-tasks";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(h)}let i=document.createElement("div");i.className="cw-zen-container";let s=document.createElement("div");Object.assign(s.style,{display:"none"});let u=document.createElement("div");u.className="cw-screens-container",s.appendChild(u),i.innerHTML=`
    ...
    `;let y=i.querySelector(".cw-hero-grid"),v=i.querySelector(".cw-acc-container"),p=i.querySelector(".cw-results-container"),w=i.querySelector(".cw-search-input"),g=i.querySelector(".cw-status-bar"),f=i.querySelector(".cw-status-text"),C=i.querySelector(".cw-footer-icons");o.forEach(([h,b])=>{let l=n(b.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${h}`,c.style.setProperty("--hero-color",l.color),c.innerHTML=`
        ...
        `,c.onclick=m=>{if(m.target.closest(".cw-step-btn"))return;let S=t[h]?t[h].count:0;T(h,S>0?-S:1,b)},c.querySelector(".minus").onclick=()=>T(h,-1,b),c.querySelector(".plus").onclick=()=>T(h,1,b),c.dataset.color=l.color,y.appendChild(c)});function E(h,b){let l=n(b.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=h,c.innerHTML=`
        ...
        `,c.onclick=m=>{if(m.target.closest(".cw-step-btn"))return;let S=t[h]?t[h].count:0;T(h,S>0?-S:1,b)},c.querySelector(".minus").onclick=()=>T(h,-1,b),c.querySelector(".plus").onclick=()=>T(h,1,b),c}Object.entries(r).forEach(([h,b])=>{let l=document.createElement("div");l.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${b.brand.color}"></div>
                ${h}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{v.querySelectorAll(".cw-acc-group.open").forEach(S=>{S!==l&&S.classList.remove("open")}),l.classList.toggle("open")};let m=document.createElement("div");m.className="cw-acc-body",b.tasks.forEach(S=>{let A=E(S.key,S);m.appendChild(A)}),l.appendChild(c),l.appendChild(m),v.appendChild(l)});function T(h,b,l){t[h]||(t[h]={count:0,data:l,brand:n(l.name)}),t[h].count+=b,t[h].count<=0&&delete t[h],j(),V(),e&&e()}function j(){o.forEach(([m])=>{let S=y.querySelector(`#hero-${m}`);if(!S)return;let A=t[m];A?(S.classList.add("active"),S.querySelector(".cw-step-val").textContent=A.count,S.querySelector(".cw-step-val").style.color=S.dataset.color):S.classList.remove("active")}),i.querySelectorAll(".cw-task-item").forEach(m=>{let S=m.dataset.id,A=t[S];A?(m.classList.add("selected"),m.querySelector(".cw-step-val").textContent=A.count):m.classList.remove("selected")});let b=Object.keys(t),l=0,c=[];if(b.forEach(m=>{let S=t[m];l+=S.count;for(let A=0;A<S.count;A++)c.length<6&&c.push(S.brand)}),l>0){g.classList.add("visible");let m=l>1?"A\xE7\xF5es":"A\xE7\xE3o",S=l>1?"definidas":"definida";f.textContent=`${l} ${m} ${S}`,C.innerHTML="",c.forEach(A=>{let N=document.createElement("div");N.className="cw-mini-icon",N.innerHTML=_e[A.icon]||_e.default;let $=N.querySelector("svg");$&&($.style.width="14px",$.style.height="14px"),C.appendChild(N)})}else g.classList.remove("visible")}w.addEventListener("input",h=>{let b=h.target.value.toLowerCase();if(b.length>0){v.style.display="none",p.style.display="block",p.innerHTML="";let l=!1;Object.entries(Se).forEach(([c,m])=>{if(m.name.toLowerCase().includes(b)){l=!0;let S=E(c,m);t[c]&&(S.classList.add("selected"),S.querySelector(".cw-step-val").textContent=t[c].count),p.appendChild(S)}}),l||(p.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else v.style.display="block",p.style.display="none"});function V(){u.innerHTML="";let h=Object.keys(t),b=!1,l="implementation";if(h.length===0){u.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let c=document.createElement("div");c.className="cw-info-banner",c.innerHTML=`
...
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):B.tagName==="TEXTAREA"&&(q=q.replace(/\n/g,"<br>"));let Z=q.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(Z===""||Z==="\u2022"||Z.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${L}\\}(?:<br>\\s*)?`,"gi");ee.test(x)?x=x.replace(ee,""):x=x.replace(k,"")}else x=x.replace(k,q.replace(/\$/g,"$$$$"))}),x=x.replace(/{([A-Z0-9_]+)}/g,""),x=x.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(x+=i.getOutput()),x}Ge.onclick=()=>{let d=Ct();d?(xt(d),Q(z("copiado_sucesso"))):Q(z("selecione_substatus"),{error:!0})},Fe.onclick=async()=>{let d=O.value,G=Ct();if(!G){Q(z("selecione_substatus"),{error:!0});return}xt(G),dt();let x=Je(),R=await Bt();if(R)try{if(R.focus(),R.innerHTML.trim()==="<p><br></p>"||R.innerHTML.trim()==="<br>"||R.innerText.trim()===""){let ae=document.createRange();ae.selectNodeContents(R);let H=window.getSelection();H.removeAllRanges(),H.addRange(ae),document.execCommand("delete",!1,null)}else if(!R.innerHTML.endsWith("<br><br>")){let ae=document.createRange();ae.selectNodeContents(R),ae.collapse(!1);let H=window.getSelection();H.removeAllRanges(),H.addRange(ae),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,G),jt(R),setTimeout(()=>{Q(z("inserido_copiado"))},600);let oe=typeof Ie<"u"&&Ie?Ie.checked:!0;if(d&&Ke[d]&&oe){let ae=Ke[d];await Mt(ae),await new Promise(H=>setTimeout(H,500))}x(),ct(1.5),A.value="",O.innerHTML=`<option value="">${z("select_substatus")}</option>`,O.disabled=!0}catch(X){console.error(X),Q("Erro ao inserir.",{error:!0}),x()}};function ct(d=1.5){d<=1.5&&(Te.style.display="none",me.innerHTML=""),d<=2&&(be.style.display="none",s.reset(),le.style.display="none"),d<=3&&(fe.style.display="none",ye.innerHTML="",i.reset(),Me.style.display="none",ke.style.display="none")}function dt(){if(r=!r,r){let d=u.querySelector(".cw-expand-btn");d&&typeof d.resetState=="function"&&d.resetState()}we(r,u,"cw-btn-notes")}return it("bau"),st("pt"),dt}var Re={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
      ...
      `;let M=S.querySelector("#csa-back-btn");M.onmouseover=()=>M.style.backgroundColor="#f1f3f4",M.onmouseout=()=>M.style.backgroundColor="transparent",M.onclick=$;let _=S.querySelector("#csa-insert-btn");_.onmouseover=()=>_.style.backgroundColor="#174ea6",_.onmouseout=()=>_.style.backgroundColor="#1a73e8",_.onclick=async()=>{_.style.transform="scale(0.96)",C();let J=Je();try{await ft(F),J()}catch(ne){console.error(ne),J()}setTimeout(()=>{_.style.transform="scale(1)",$()},300)}}function $(){o="list",j.style.transform="translateX(0)"}function W(){l.innerHTML="",Object.keys(Re).forEach(F=>{let U=Re[F],I=document.createElement("button");I.textContent=U.title,Object.assign(I.style,y),t===F&&n===""&&Object.assign(I.style,v),I.onclick=()=>{t=F,n="",b.value="",W(),O()},l.appendChild(I)})}function O(){c.innerHTML="";let F=[];if(n.trim()!==""?Object.values(Re).forEach(M=>{let _=M.emails.filter(J=>J.name.toLowerCase().includes(n.toLowerCase()));F=[...F,..._]}):Re[t]&&(F=Re[t].emails),F.length===0){c.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let U='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',I='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';F.forEach(M=>{let _=document.createElement("div");Object.assign(_.style,p);let J=M.subject.length>50?M.subject.substring(0,50)+"...":M.subject;_.innerHTML=`

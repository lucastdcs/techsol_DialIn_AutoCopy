...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var ie=e=>new Promise(t=>setTimeout(t,e));function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Qe(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,l=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&l})}async function Lt(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(r=>r.innerText.trim()==="email");if(n&&n.offsetParent!==null){let r=n.closest("material-button")||n.closest("material-fab")||n;r.style&&(r.style.display="block",r.style.visibility="visible"),Ce(r),e=!0}else{let r=document.querySelector("material-fab-speed-dial");if(r){let b=r.querySelector(".trigger");if(b){b.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Ce(b),await ie(1e3);let v=Array.from(document.querySelectorAll("i.material-icons-extended")).find(m=>m.innerText.trim()==="email");v&&(Ce(v),e=!0)}else r.click()}}let o=0,l=Qe();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!l&&o<30;)await ie(500),l=Qe(),o++;if(!l)return Q("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let i=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(r=>r.offsetParent!==null);if(i){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),Ce(i);let r=null,b=0;for(;!r&&b<10;)await ie(200),r=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(v=>v.offsetParent!==null),b++;r?(console.log("\u2705 Confirmando descarte..."),Ce(r),await ie(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(l){let r=l.closest('[id="email-body-content-top"]'),y=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(r){if(y){let m=y.closest('[aria-hidden="true"]');m&&m.removeAttribute("aria-hidden"),y.focus()}await ie(300),r.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let v=r.querySelector("#cases-body-field");if(v){let m=document.createRange();m.selectNodeContents(v),m.collapse(!0);let w=window.getSelection();w.removeAllRanges(),w.addRange(m)}return!0}}return Q("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function Rt(e){if(!e)return;Q("Preparando email...",{duration:3e3});let t=ut();if(!await Lt())return;await ie(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await ie(200),Ce(o),await ie(1500);let l=document.querySelector("material-auto-suggest-input input");if(l){Ce(l),await ie(200),document.execCommand("insertText",!1,e),l.dispatchEvent(new Event("input",{bubbles:!0}));let a=null,i=0;for(;i<20;){await ie(500),i++;let r=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(r.length>0&&(a=r.find(b=>b.innerText.toLowerCase().includes(e.toLowerCase())),!a&&r.length===1&&(a=r[0]),a))break}if(a){let r=function(m,w){if(m.nodeType===3&&m.nodeValue.includes(w))return m;if(!m.childNodes)return null;for(let S of m.childNodes){let x=r(S,w);if(x)return x}return null};Ce(a),await ie(2e3);let b=Qe(),y=b?b.closest('[id="email-body-content-top"]'):document.body,v=r(y,"{%ADVERTISER_NAME%}");if(v){let m=document.createRange(),w=v.nodeValue.indexOf("{%ADVERTISER_NAME%}");m.setStart(v,w),m.setEnd(v,w+19);let S=window.getSelection();S.removeAllRanges(),S.addRange(m),document.execCommand("insertText",!1,t.advertiserName),Q("Email preenchido!")}else Q("Email inserido (Nome n\xE3o substitu\xEDdo).")}else Q(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else Q("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function ft(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),Q("Preparando email...",{duration:3e3});let t=ut(),n=pt();if(!await Lt())return;await ie(600);let l=document.querySelector('input[aria-label="Subject"]');l&&e.subject&&(l.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(l,e.subject),l.dispatchEvent(new Event("input",{bubbles:!0})),await ie(300));let a=Qe();if(a){let r=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');r&&(r.focus(),r.click(),r.dispatchEvent(new Event("input",{bubbles:!0}))),await ie(400);let b=new Date;b.setDate(b.getDate()+3);let y=b.getDay();y===6?b.setDate(b.getDate()+2):y===0&&b.setDate(b.getDate()+1);let v=b.toLocaleDateString("pt-BR"),m=e.body;m=m.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),m=m.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),m=m.replace(/\[URL\]/g,t.websiteUrl||"seu site"),m=m.replace(/\[Seu Nome\]/g,n),m=m.replace(/\[MM\/DD\/YYYY\]/g,v),document.execCommand("insertHTML",!1,m),r&&(r.dispatchEvent(new Event("input",{bubbles:!0})),r.dispatchEvent(new Event("change",{bubbles:!0}))),Q("Email preenchido com sucesso!",{duration:2e3}),await ie(800)}else Q("Erro ao focar no editor.",{error:!0})}var Zt={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Mt={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Ae(e,t,n,o,l,a){let i=document.createElement("div");Object.assign(i.style,Zt),_t(e,i);let r=document.createElement("div");Object.assign(r.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),i.appendChild(r),l&&(l.googleLine=r);let b=document.createElement("div");Object.assign(b.style,{display:"flex",alignItems:"center",gap:"12px"});let y=document.createElement("img");y.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(y.style,{width:"20px",height:"20px",pointerEvents:"none"});let v=document.createElement("span");v.textContent=t,b.appendChild(y),b.appendChild(v);let m=document.createElement("div");Object.assign(m.style,{display:"flex",alignItems:"center",gap:"4px"});let w='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',S='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',x=document.createElement("div");x.innerHTML=w,Object.assign(x.style,Mt),x.title="Sobre",x.classList.add("no-drag"),x.onmouseenter=()=>{x.style.background="rgba(255,255,255,0.1)",x.style.color="#FFF"},x.onmouseleave=()=>{x.style.color!=="rgb(138, 180, 248)"&&(x.style.background="transparent",x.style.color="#9AA0A6")};let C=document.createElement("div");C.innerHTML=S,Object.assign(C.style,Mt),C.title="Fechar",C.classList.add("no-drag"),C.onmouseenter=()=>{C.style.background="rgba(242, 139, 130, 0.2)",C.style.color="#F28B82"},C.onmouseleave=()=>{C.style.background="transparent",C.style.color="#9AA0A6"},C.onmousedown=T=>T.stopPropagation(),x.onmousedown=T=>T.stopPropagation(),C.onclick=a;let E=Jt(e,t,n,o);return x.onclick=T=>{T.stopPropagation(),E.style.opacity==="1"?(E.style.opacity="0",E.style.pointerEvents="none",x.style.color="#9AA0A6",x.style.background="transparent"):(E.style.opacity="1",E.style.pointerEvents="auto",x.style.color="#8AB4F8",x.style.background="rgba(138, 180, 248, 0.1)")},m.appendChild(x),m.appendChild(C),i.appendChild(b),i.appendChild(m),i}function Jt(e,t,n,o){let l=document.createElement("div");return Object.assign(l.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),l.innerHTML=`
...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let l=document.createElement("div");l.className="cw-focus-backdrop",document.body.appendChild(l),document.body.appendChild(o),o.querySelector(".notes").onclick=S=>{S.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=S=>{S.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=S=>{S.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=S=>{S.stopPropagation(),e.toggleLinks()},(async function(){await Ze(2800),o.classList.add("docked"),await Ze(300);let x=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(E=>E.classList.add("visible"));for(let E=0;E<x.length;E++)x[E].classList.add("popped"),await Ze(90);await Ze(200),o.classList.add("system-check")})();let a=!1,i,r,b,y,v=3;o.onmousedown=S=>{if(S.target.closest("button"))return;S.preventDefault(),i=S.clientX,r=S.clientY;let x=o.getBoundingClientRect();b=x.left,y=x.top,document.addEventListener("mousemove",m),document.addEventListener("mouseup",w)};function m(S){let x=S.clientX-i,C=S.clientY-r;!a&&Math.sqrt(x*x+C*C)>v&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${b+x}px`,o.style.top=`${y+C}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function w(S){if(document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",w),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let x=window.innerWidth,C=window.innerHeight,E=o.getBoundingClientRect(),T=E.left+E.width/2,q;T<x/2?(q=24,o.classList.remove("side-right"),o.classList.add("side-left")):(q=x-E.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let U=E.top;U<24&&(U=24),U>C-E.height-24&&(U=C-E.height-24),o.style.left=`${q}px`,o.style.top=`${U}px`,setTimeout(()=>{},600)}else{let x=S.target.closest("button");x&&(x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="",150))}}}function Je(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let l=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let i=Date.now()-l,r=Math.max(0,1500-i);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},r)}}var Ft=e=>new Promise(t=>setTimeout(t,e));function et(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function xt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{Q("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function jt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function zt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Pt(){console.log("Iniciando processo de Nova Nota...");let e=zt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(i=>i.innerText.trim()==="description");if(o){let i=o.closest("material-fab")||o.closest("material-button");i?(i.style&&(i.style.display="block",i.style.visibility="visible"),et(i)):et(o)}else{let i=document.querySelector("material-fab-speed-dial");if(i){let r=i.querySelector(".trigger");r?(r.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),et(r)):i.click(),await Ft(800);let y=Array.from(document.querySelectorAll("i.material-icons-extended")).find(v=>v.innerText.trim()==="description");y&&et(y)}}let l=null,a=0;for(;!l&&a<20;){await Ft(300);let i=zt();if(i.length>t)l=i.find(r=>!e.includes(r)),l||(l=i[i.length-1]);else if(a>10){let r=i.filter(b=>b.offsetParent!==null);r.length>0&&(l=r[r.length-1])}a++}return l}var P={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},ge="cubic-bezier(0.25, 0.8, 0.25, 1)",eo={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.bgInput,fontSize:"14px",color:P.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${ge}, box-shadow 0.2s ${ge}, background-color 0.2s`,outline:"none"},So={...eo,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},Co={fontSize:"13px",fontWeight:"700",color:P.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},Ao={display:"block",fontSize:"13px",fontWeight:"600",color:P.text,marginBottom:"8px",marginTop:"16px"},wo={fontSize:"12px",color:P.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},Eo={fontSize:"12px",color:P.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},To={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:P.text,cursor:"pointer",padding:"12px 14px",backgroundColor:P.surface,border:`1px solid ${P.border}`,borderRadius:"12px",transition:`all 0.2s ${ge}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},yt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:P.primary},ko={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:P.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${ge}, box-shadow 0.2s ${ge}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},Oo={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${P.primary}`,color:P.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${ge}`},Io={background:"transparent",border:`1px solid ${P.border}`,borderRadius:"20px",color:P.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${ge}`,fontFamily:"'Google Sans', 'Roboto'"};var No={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:P.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},_o={fontSize:"13px",fontWeight:"700",color:P.primary,minWidth:"20px",textAlign:"center"},Lo={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${P.border}`,backgroundColor:P.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${ge}, box-shadow 0.2s ${ge}`},Ro={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${P.bgInput}`},Mo={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.surface,color:P.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${ge}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Do={backgroundColor:P.primaryBg,color:P.primary,borderColor:P.primary,fontWeight:"600"},Go={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:P.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Fo={borderTop:`1px solid ${P.bgInput}`,paddingTop:"20px",marginTop:"16px"};var zo={maxHeight:"240px",overflowY:"auto",border:`1px solid ${P.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:P.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},jo={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${P.bgInput}`,cursor:"pointer",fontSize:"13px",color:P.text,transition:"background 0.1s",userSelect:"none"};var to={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},oo={fontSize:"12px",color:"#e37400",marginTop:"4px"},no={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},ao={display:"flex",gap:"15px",marginBottom:"10px"};function Bt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,to);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,ze,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,ao);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,yt);let l=document.createElement("label");l.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(l);let i=document.createElement("input");i.type="radio",i.name="ts_usage_mod",i.value="N\xE3o",i.checked=!0,Object.assign(i.style,yt);let r=document.createElement("label");r.textContent="N\xE3o";let b=document.createElement("div");Object.assign(b.style,{display:"flex",alignItems:"center"}),b.appendChild(i),b.appendChild(r),n.appendChild(a),n.appendChild(b);let y=document.createElement("div");y.style.display="block";let v=document.createElement("label");v.textContent="Qual foi o Motivo?",Object.assign(v.style,ze,{fontSize:"12px"});let m=document.createElement("input");m.type="text",Object.assign(m.style,no);let w=document.createElement("div");w.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(w.style,oo),y.appendChild(v),y.appendChild(m),y.appendChild(w),e.appendChild(t),e.appendChild(n),e.appendChild(y),o.onchange=()=>{y.style.display="none"},i.onchange=()=>{y.style.display="block"};function S(E,T){if(e.style.display="none",!E||E.includes("Education")||!T||T.length===0)return;let q=T.some(s=>s.includes("enhanced")||s==="ec_google_ads"),U=T.some(s=>(s.includes("conversion")||s.includes("ads"))&&!s.includes("enhanced")),h=T.some(s=>s.includes("ga4")||s.includes("analytics")||s.includes("ua")),d=T.some(s=>s.includes("merchant")||s.includes("gmc")||s.includes("shopping"));(q||U&&!h&&!d)&&(e.style.display="block")}function x(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return i.checked&&m.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${m.value}`),E+="<br>",E}function C(){e.style.display="none",i.checked=!0,o.checked=!1,y.style.display="block",m.value=""}return{element:e,updateVisibility:S,getOutput:x,reset:C}}var F={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},_e={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function qt(e){let t={};function n(h){let d=h.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?F.brands.ads:d.includes("ga4")||d.includes("analytics")?F.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?F.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?F.brands.gmc:F.brands.default}let o=Object.entries(Se).filter(([h,d])=>d.popular),l={};Object.entries(Se).forEach(([h,d])=>{if(d.popular)return;let c=n(d.name);l[c.label]||(l[c.label]={brand:c,tasks:[]}),l[c.label].tasks.push({key:h,...d})});let a="cw-zen-tasks";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(h)}let i=document.createElement("div");i.className="cw-zen-container";let r=document.createElement("div");Object.assign(r.style,{display:"none"});let b=document.createElement("div");b.className="cw-screens-container",r.appendChild(b),i.innerHTML=`
    ...
    `;let y=i.querySelector(".cw-hero-grid"),v=i.querySelector(".cw-acc-container"),m=i.querySelector(".cw-results-container"),w=i.querySelector(".cw-search-input"),S=i.querySelector(".cw-status-bar"),x=i.querySelector(".cw-status-text"),C=i.querySelector(".cw-footer-icons");o.forEach(([h,d])=>{let c=n(d.name),s=document.createElement("div");s.className="cw-hero-card",s.id=`hero-${h}`,s.style.setProperty("--hero-color",c.color),s.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${_e[c.icon]}</div>
        ...
        `,s.onclick=g=>{if(g.target.closest(".cw-step-btn"))return;let p=t[h]?t[h].count:0;T(h,p>0?-p:1,d)},s.querySelector(".minus").onclick=()=>T(h,-1,d),s.querySelector(".plus").onclick=()=>T(h,1,d),s.dataset.color=c.color,y.appendChild(s)});function E(h,d){let c=n(d.name),s=document.createElement("div");return s.className="cw-task-item",s.dataset.id=h,s.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${c.bg}; color:${c.color}">
                    ${_e[c.icon]||_e.default}
                </div>
        ...
        `,s.onclick=g=>{if(g.target.closest(".cw-step-btn"))return;let p=t[h]?t[h].count:0;T(h,p>0?-p:1,d)},s.querySelector(".minus").onclick=()=>T(h,-1,d),s.querySelector(".plus").onclick=()=>T(h,1,d),s}Object.entries(l).forEach(([h,d])=>{let c=document.createElement("div");c.className="cw-acc-group";let s=document.createElement("div");s.className="cw-acc-header",s.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${d.brand.color}"></div>
                ${h}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,s.onclick=()=>{v.querySelectorAll(".cw-acc-group.open").forEach(p=>{p!==c&&p.classList.remove("open")}),c.classList.toggle("open")};let g=document.createElement("div");g.className="cw-acc-body",d.tasks.forEach(p=>{let A=E(p.key,p);g.appendChild(A)}),c.appendChild(s),c.appendChild(g),v.appendChild(c)});function T(h,d,c){t[h]||(t[h]={count:0,data:c,brand:n(c.name)}),t[h].count+=d,t[h].count<=0&&delete t[h],q(),U(),e&&e()}function q(){o.forEach(([g])=>{let p=y.querySelector(`#hero-${g}`);if(!p)return;let A=t[g];A?(p.classList.add("active"),p.querySelector(".cw-step-val").textContent=A.count,p.querySelector(".cw-step-val").style.color=p.dataset.color):p.classList.remove("active")}),i.querySelectorAll(".cw-task-item").forEach(g=>{let p=g.dataset.id,A=t[p];A?(g.classList.add("selected"),g.querySelector(".cw-step-val").textContent=A.count):g.classList.remove("selected")});let d=Object.keys(t),c=0,s=[];if(d.forEach(g=>{let p=t[g];c+=p.count;for(let A=0;A<p.count;A++)s.length<6&&s.push(p.brand)}),c>0){S.classList.add("visible");let g=c>1?"A\xE7\xF5es":"A\xE7\xE3o",p=c>1?"definidas":"definida";x.textContent=`${c} ${g} ${p}`,C.innerHTML="",s.forEach(A=>{let L=document.createElement("div");L.className="cw-mini-icon",L.innerHTML=_e[A.icon]||_e.default;let V=L.querySelector("svg");V&&(V.style.width="14px",V.style.height="14px"),C.appendChild(L)})}else S.classList.remove("visible")}w.addEventListener("input",h=>{let d=h.target.value.toLowerCase();if(d.length>0){v.style.display="none",m.style.display="block",m.innerHTML="";let c=!1;Object.entries(Se).forEach(([s,g])=>{if(g.name.toLowerCase().includes(d)){c=!0;let p=E(s,g);t[s]&&(p.classList.add("selected"),p.querySelector(".cw-step-val").textContent=t[s].count),m.appendChild(p)}}),c||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else v.style.display="block",m.style.display="none"});function U(){b.innerHTML="";let h=Object.keys(t),d=!1,c="implementation";if(h.length===0){b.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let s=document.createElement("div");s.className="cw-info-banner",s.innerHTML=`
        ...
        `,b.appendChild(s),h.forEach(g=>{let p=t[g].data,A=t[g].count,L=t[g].brand,V=p.screenshots?p.screenshots[c]||[]:["Link da Evid\xEAncia"];if(V.length>0){d=!0;for(let N=1;N<=A;N++){let k=document.createElement("div");k.className="cw-screen-card",k.style.setProperty("--brand-color",L.color),k.style.setProperty("--brand-bg",L.bg),k.style.setProperty("--brand-shadow",L.color+"40");let O=document.createElement("div");O.className="cw-card-header";let R=document.createElement("div");R.className="cw-card-icon",R.innerHTML=_e[L.icon]||_e.default;let z=document.createElement("div");z.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let _=document.createElement("input");_.className="cw-card-title-input",_.id=`name-${g}-${N}`,_.value=`${p.name}${A>1?" #"+N:""}`,_.title="Clique para renomear esta task";let D=document.createElement("span");D.className="cw-edit-hint",D.innerHTML="\u270E Renomear",z.appendChild(_),z.appendChild(D),O.appendChild(R),O.appendChild(z),k.appendChild(O),V.forEach((oe,ne)=>{let Y=document.createElement("div");Y.className="cw-input-group";let de=document.createElement("label");de.className="cw-input-label",de.textContent=oe.replace(/📷|:|•/g,"").trim();let re=document.createElement("input");re.className="cw-input-field",re.id=`screen-${g}-${N}-${ne}`,re.placeholder="Cole o link aqui...",re.setAttribute("autocomplete","off"),re.addEventListener("input",()=>{re.value.trim().length>5?re.classList.add("filled"):re.classList.remove("filled")});let pe=document.createElement("div");pe.className="cw-input-check",pe.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',Y.appendChild(de),Y.appendChild(re),Y.appendChild(pe),k.appendChild(Y)}),b.appendChild(k)}}}),r.style.display=d?"block":"none"}return{selectionElement:i,screenshotsElement:r,updateSubStatus:()=>U(),getCheckedElements:()=>Object.keys(t).map(h=>({value:h,closest:()=>({querySelector:()=>({textContent:t[h].count})})})),toggleTask:(h,d=!0)=>{let c=t[h];d&&!c?T(h,1,Se[h]):!d&&c&&T(h,-c.count,Se[h])},reset:()=>{for(let h in t)delete t[h];w.value="",v.style.display="block",m.style.display="none",q(),U()}}}function Vt(){let e="v3.6.0",t="bau",n="pt",o=!1,l=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},i=Bt(),r=qt(()=>{let G=r.getCheckedElements().map(f=>f.value);k&&k.value&&i.updateVisibility(k.value,G)}),b=document.createElement("div");b.id="autofill-popup",Object.assign(b.style,ve,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),b.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let v=Ae(b,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:b,googleLine:null},()=>dt()),m=v.lastElementChild;if(m){let u=document.createElement("div");u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',u.classList.add("no-drag"),Object.assign(u.style,{fontSize:"20px",color:"#9AA0A6",cursor:"pointer",padding:"8px",display:"flex",alignItems:"center",justifyContent:"center",marginRight:"4px",marginLeft:"auto",borderRadius:"50%",transition:"background 0.2s, transform 0.3s ease"}),u.title="Expandir/Contrair Janela",u.onmouseover=()=>u.style.backgroundColor="#e8eaed",u.onmouseout=()=>u.style.backgroundColor="transparent";let G=!1;u.onclick=()=>{G=!G,u.style.transform=G?"rotate(180deg)":"rotate(0deg)",b.style.width=G?"700px":"380px",G?u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>':u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>'};let f=m.lastElementChild;f?m.insertBefore(u,f):m.appendChild(u)}b.appendChild(v);let w=document.createElement("div");Object.assign(w.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),b.appendChild(w);let S=document.createElement("div");S.textContent="created by lucaste@",Object.assign(S.style,Xe),b.appendChild(S);let x=document.createElement("div");x.id="step-lang-type";let C=document.createElement("label");Object.assign(C.style,a.label),x.appendChild(C);let E=document.createElement("div");Object.assign(E.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let T=document.createElement("div");T.textContent="Portugu\xEAs",T.classList.add("no-drag"),Object.assign(T.style,se);let q=document.createElement("div");q.textContent="Espa\xF1ol",q.classList.add("no-drag"),Object.assign(q.style,se),T.onclick=()=>st("pt"),q.onclick=()=>st("es"),E.appendChild(T),E.appendChild(q),x.appendChild(E),w.appendChild(x);let U=document.createElement("div");U.id="step-0-case-type";let h=document.createElement("label");Object.assign(h.style,a.label),U.appendChild(h);let d=document.createElement("div");Object.assign(d.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let c=document.createElement("div");c.textContent="BAU",c.classList.add("no-drag"),Object.assign(c.style,se);let s=document.createElement("div");s.textContent="LM",s.classList.add("no-drag"),Object.assign(s.style,se),c.onclick=()=>it("bau"),s.onclick=()=>it("lm"),d.appendChild(c),d.appendChild(s),U.appendChild(d),w.appendChild(U);let g=document.createElement("div");g.id="step-1-selection";let p=document.createElement("label");Object.assign(p.style,a.label);let A=document.createElement("select");A.id="main-status",Object.assign(A.style,je),A.innerHTML='<option value="">-- Selecione --</option><option value="NI">NI - Need Info</option><option value="SO">SO - Solution Offered</option><option value="IN">IN - Inactive</option><option value="AS">AS - Assigned</option>';let L=document.createElement("div");Object.assign(L.style,{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginTop:"16px",marginBottom:"8px"});let V=document.createElement("label");Object.assign(V.style,a.label,{marginTop:"0",marginBottom:"0"});let N=document.createElement("a");N.target="_blank",N.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg> Guia de Substatus',Object.assign(N.style,a.helpLink),L.appendChild(V),L.appendChild(N);let k=document.createElement("select");k.id="sub-status",Object.assign(k.style,je),k.disabled=!0,g.appendChild(p),g.appendChild(A),g.appendChild(L),g.appendChild(k),w.appendChild(g);let O=document.createElement("div");O.id="step-1-1-portugal",Object.assign(O.style,a.stepBlock,{display:"none"});let R=document.createElement("label");Object.assign(R.style,a.label),O.appendChild(R);let z=document.createElement("div");Object.assign(z.style,a.radioContainer);let _=document.createElement("div");Object.assign(_.style,{display:"flex",alignItems:"center"});let D=document.createElement("input");D.type="radio",D.name="portugal-group",D.value="sim",Object.assign(D.style,a.checkboxInput);let oe=document.createElement("label");oe.htmlFor="portugal-sim",Object.assign(oe.style,{cursor:"pointer"}),_.appendChild(D),_.appendChild(oe);let ne=document.createElement("div");Object.assign(ne.style,{display:"flex",alignItems:"center"});let Y=document.createElement("input");Y.type="radio",Y.name="portugal-group",Y.value="nao",Y.checked=!0,Object.assign(Y.style,a.checkboxInput);let de=document.createElement("label");de.htmlFor="portugal-nao",Object.assign(de.style,{cursor:"pointer"}),ne.appendChild(Y),ne.appendChild(de),z.appendChild(_),z.appendChild(ne),O.appendChild(z),w.appendChild(O);function re(u){o=u,u?pe.style.display="block":pe.style.display="none"}D.onchange=()=>re(!0),Y.onchange=()=>re(!1);let pe=document.createElement("div");pe.id="step-1-2-consent",Object.assign(pe.style,a.stepBlock,{display:"none"});let ot=document.createElement("label");Object.assign(ot.style,a.label),pe.appendChild(ot);let Ve=document.createElement("div");Object.assign(Ve.style,a.radioContainer);let He=document.createElement("div");Object.assign(He.style,{display:"flex",alignItems:"center"});let Ee=document.createElement("input");Ee.type="radio",Ee.name="consent-group",Ee.value="Sim",Ee.checked=!0,Object.assign(Ee.style,a.checkboxInput);let $e=document.createElement("label");$e.htmlFor="consent-sim",Object.assign($e.style,{cursor:"pointer"}),He.appendChild(Ee),He.appendChild($e);let Ue=document.createElement("div");Object.assign(Ue.style,{display:"flex",alignItems:"center"});let De=document.createElement("input");De.type="radio",De.name="consent-group",De.value="N\xE3o",Object.assign(De.style,a.checkboxInput);let We=document.createElement("label");We.htmlFor="consent-nao",Object.assign(We.style,{cursor:"pointer"}),Ue.appendChild(De),Ue.appendChild(We),Ve.appendChild(He),Ve.appendChild(Ue),pe.appendChild(Ve),w.appendChild(pe);let Te=document.createElement("div");Te.id="step-1-5-snippets",Object.assign(Te.style,a.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,a.h3);let me=document.createElement("div");me.id="snippet-container",Te.appendChild(nt),Te.appendChild(me),w.appendChild(Te);let be=document.createElement("div");be.id="step-2-tasks",Object.assign(be.style,a.stepBlock,{display:"none"});let le=document.createElement("button");le.textContent="+ Gostaria de selecionar uma task?",Object.assign(le.style,a.optionalBtn),le.onmouseover=()=>{le.style.background="#e8f0fe"},le.onmouseout=()=>{le.style.background="white"};let Re=document.createElement("h3");Object.assign(Re.style,a.h3);let St=document.createElement("div");St.id="task-checkboxes-container",be.appendChild(le),be.appendChild(St),be.appendChild(Re),be.appendChild(r.selectionElement),w.appendChild(be);let fe=document.createElement("div");fe.id="step-3-form",Object.assign(fe.style,a.stepBlock,{display:"none"});let at=document.createElement("h3");Object.assign(at.style,a.h3),fe.appendChild(at);let ye=document.createElement("div");ye.id="dynamic-form-fields-container",fe.appendChild(ye),fe.appendChild(i.element),fe.appendChild(r.screenshotsElement),w.appendChild(fe);let ke=document.createElement("div");ke.id="step-4-email",Object.assign(ke.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Oe=document.createElement("label");Oe.style.display="flex",Oe.style.alignItems="center",Oe.style.cursor="pointer",Oe.style.fontSize="14px";let Ie=document.createElement("input");Ie.type="checkbox",Ie.checked=!0,Object.assign(Ie.style,a.checkboxInput),Oe.appendChild(Ie),Oe.appendChild(document.createTextNode("Preencher email automaticamente?")),ke.appendChild(Oe),w.appendChild(ke);let Me=document.createElement("div");Object.assign(Me.style,{display:"none",gap:"8px",padding:"0"}),w.appendChild(Me);let Ge=document.createElement("button");Object.assign(Ge.style,a.buttonBase,{backgroundColor:"#5f6368"}),Ge.textContent="Copiar";let Fe=document.createElement("button");Object.assign(Fe.style,a.buttonBase,{backgroundColor:"#1a73e8"}),Fe.textContent="Preencher",Me.appendChild(Ge),Me.appendChild(Fe),document.body.appendChild(b);function it(u){t=u;let G=Pe();Object.assign(c.style,se),Object.assign(s.style,se),u==="bau"?(Object.assign(c.style,G),N.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(s.style,G),N.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),k.value&&k.dispatchEvent(new Event("change"))}function j(u){try{if(xe&&xe[n]&&xe[n][u])return xe[n][u];if(xe&&xe.pt&&xe.pt[u])return xe.pt[u]}catch{}return u}function Wt(){C.textContent=j("idioma"),h.textContent=j("fluxo"),p.textContent=j("status_principal"),V.textContent=j("substatus"),nt.textContent=j("cenarios_comuns"),Re.textContent=j("selecione_tasks"),at.textContent=j("preencha_detalhes"),Ge.textContent=j("copiar"),Fe.textContent=j("preencher"),A.querySelector('option[value=""]')&&(A.querySelector('option[value=""]').textContent=j("select_status")),k.querySelector('option[value=""]')&&(k.querySelector('option[value=""]').textContent=j("select_substatus")),R.textContent=j("caso_portugal"),oe.textContent=j("sim"),de.textContent=j("nao"),ot.textContent=j("consentiu_gravacao"),$e.textContent=j("sim"),We.textContent=j("nao"),ye.querySelectorAll("label").forEach(u=>{let G=u.nextElementSibling.id.replace("field-",""),f=j(G.toLowerCase());f!==G.toLowerCase()?u.textContent=f:u.textContent=G.replace(/_/g," ").replace(/\b\w/g,B=>B.toUpperCase())+":"}),le.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function st(u){n=u;let G=Pe();Object.assign(T.style,se),Object.assign(q.style,se),u==="pt"?(Object.assign(T.style,G),O.style.display="block",re(o)):(Object.assign(q.style,G),O.style.display="none",pe.style.display="none"),Wt(),k.value&&k.dispatchEvent(new Event("change"))}function rt(u){(u.value.trim()===""||u.value.trim()==="\u2022")&&(u.value="\u2022 "),u.onkeydown=function(G){if(G.key==="Enter"){G.preventDefault();let f=this.selectionStart,B=this.selectionEnd,K=this.value,te=K.lastIndexOf(`
`,f-1)+1,ue=K.substring(te,f),ae=ue.trim()==="\u2022"||ue.trim()===""?`
`:`
\u2022 `;this.value=K.substring(0,f)+ae+K.substring(B),this.selectionStart=this.selectionEnd=f+ae.length}else if(G.key==="Backspace"){let f=this.selectionStart;if(f===this.selectionEnd&&f>0){let B=this.value.substring(0,f);B.endsWith(`
\u2022 `)?(G.preventDefault(),this.value=B.substring(0,f-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=f-3):B==="\u2022 "&&(G.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function lt(){let u=typeof me<"u"?me:document.getElementById("snippet-container");if(!u)return;let G=u.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),f={},B=new Set;G.forEach(W=>{let H=W.id,M=Ne[H];if(M)for(let I in M)I==="linkedTask"?B.add(M.linkedTask):I!=="type"&&(f[I]||(f[I]=[]),f[I].includes(M[I])||f[I].push(M[I]))});let K=new Set;Object.values(Ne).forEach(W=>{Object.keys(W).forEach(H=>{H!=="linkedTask"&&H!=="type"&&K.add(H)})}),K.forEach(W=>{let H=document.getElementById(W);if(H){let M=f[W]||[],I="";qe.includes(W.replace("field-",""))?(I=M.map($=>$.startsWith("\u2022 ")?$:"\u2022 "+$).join(`
`),I===""?I="\u2022 ":I.endsWith(`
\u2022 `)||(I+=`
\u2022 `)):I=M.join(`

`),I.trim()!=="\u2022"&&I.trim()!==""?H.value=I:qe.includes(W.replace("field-",""))?H.value="\u2022 ":H.value="",H.tagName==="TEXTAREA"&&typeof rt=="function"&&rt(H)}});let te=new Set,ue=new Set;u.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(W=>{let H=Ne[W.id];H&&H.linkedTask&&(W.checked?te.add(H.linkedTask):ue.add(H.linkedTask))}),ue.forEach(W=>{te.has(W)||r.toggleTask(W,!1)}),te.forEach(W=>{r.toggleTask(W,!0)})}A.onchange=()=>{let u=A.value;if(ct(1.5),k.innerHTML=`<option value="">${j("select_substatus")}</option>`,!u){k.disabled=!0;return}for(let G in Be){let f=Be[G];if(f.status===u){let B=document.createElement("option");B.value=G,B.textContent=f.name,k.appendChild(B)}}k.disabled=!1},k.onchange=()=>{let u=k.value;if(ct(1.5),!u)return;r.updateSubStatus(u);let G=Be[u];me.innerHTML="";let f=(M,I,$)=>{let Z=document.createElement("label");Object.assign(Z.style,a.checkboxLabel),Z.onmouseover=()=>Z.style.backgroundColor="#e8eaed",Z.onmouseout=()=>Z.style.backgroundColor="#f8f9fa";let X=document.createElement("input");return X.type=I,X.id=M.id,Object.assign(X.style,a.checkboxInput),Z.appendChild(X),Z.appendChild(document.createTextNode(` ${M.text}`)),$.appendChild(Z),X},B=[],K="radio";if(u==="NI_Awaiting_Inputs")B=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(u.startsWith("SO_"))K="checkbox",B=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(u.startsWith("AS_")){K="checkbox";let M=document.createElement("label");M.textContent=j("cenarios_comuns"),Object.assign(M.style,a.label),me.appendChild(M),B=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else u.startsWith("IN_")&&(B=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let te=B.filter(M=>{let I=Ne[M.id];return!I.type||I.type==="all"||I.type===t});te.forEach((M,I)=>{let $=f(M,K,me);K==="radio"&&($.name="scenario-radio-group",I===0&&($.checked=!0))}),te.length>0&&(Te.style.display="block"),G.requiresTasks?(le.style.display="none",Re.style.display="block",r.selectionElement.style.display="block",be.style.display="block"):(le.style.display="block",Re.style.display="none",r.selectionElement.style.display="none",be.style.display="block"),ye.innerHTML="";let ue=G.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(ue)].forEach(M=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(M))return;let I=M.slice(1,-1),$=document.createElement("label"),Z=j(I.toLowerCase());$.textContent=Z!==I.toLowerCase()?Z:I.replace(/_/g," ").replace(/\b\w/g,J=>J.toUpperCase())+":",Object.assign($.style,a.label);let X;qe.includes(I)?(X=document.createElement("textarea"),Object.assign(X.style,a.textarea),X.classList.add("bullet-textarea"),rt(X)):gt.includes(I)?(X=document.createElement("textarea"),Object.assign(X.style,a.textarea)):(X=document.createElement("input"),X.type="text",Object.assign(X.style,a.input),I==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))&&(Object.assign($.style,{display:"none"}),Object.assign(X.style,{display:"none"}))),I==="ON_CALL"&&t==="lm"&&(Object.assign($.style,{display:"none"}),Object.assign(X.style,{display:"none"}),X.value="N/A"),X.id=`field-${I}`,ye.appendChild($),ye.appendChild(X)});let W=me.querySelectorAll('input[type="checkbox"], input[type="radio"]');W.length>0&&(W.forEach(M=>{M.removeEventListener("change",lt),M.addEventListener("change",lt)}),lt()),fe.style.display="block",Ke[u]?ke.style.display="block":ke.style.display="none",Me.style.display="flex";let H=r.getCheckedElements().map(M=>M.value);i.updateVisibility(u,H)},le.onclick=()=>{le.style.display="none",Re.style.display="block",r.selectionElement.style.display="block"};function Ct(){let u=k.value;if(!u)return null;let f=Be[u].template.replace(/\n/g,"<br>"),B='style="margin-bottom: 12px; padding-left: 30px;"',K=[],te="",ue=r.getCheckedElements();ue.length>0&&ue.forEach(H=>{let M=H.value,I=Se[M],$=H.closest().querySelector(".stepper-count"),Z=$?parseInt($.textContent):1;Z>1?K.push(`${I.name} (x${Z})`):K.push(I.name)});let ae=r.screenshotsElement;if(ae){let H=Array.from(ae.querySelectorAll('input[id^="name-"]'));H.length>0&&H.forEach(M=>{let I=M.value,$=M.closest(".cw-screen-card");if($){let Z=$.querySelectorAll('input[id^="screen-"]'),X=!1,J="";Z.forEach(ce=>{let At=ce.closest(".cw-input-group"),wt=At?At.querySelector(".cw-input-label"):null,Yt=wt?wt.textContent:"Evid\xEAncia",Et=ce.value.trim(),Xt=Et?` ${Et}`:"";J+=`<li>${Yt} -${Xt}</li>`,X=!0}),X&&(te+=`<b>${I}</b>`,te+=`<ul ${B}>${J}</ul>`)}})}if(f.includes("{TAGS_IMPLEMENTED}")?f=f.replace(/{TAGS_IMPLEMENTED}/g,K.join(", ")||"N/A"):K.length>0&&(f+=`<br><b>Tags:</b> ${K.join(", ")}<br>`),f.includes("{SCREENSHOTS_LIST}")?f=f.replace(/{SCREENSHOTS_LIST}/g,te?`${te}`:"N/A"):te!==""&&(f+=`<br>${te}`),n==="pt"&&o){let H=Ee.checked?j("sim"):j("nao");f=f.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${j("consentiu_gravacao")}</b> ${H}<br><br>`),f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("sim")}<br>`)}else n==="pt"&&!o?(f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("nao")}<br>`),f=f.replace(/{CONSENTIU_GRAVACAO}/g,"")):(f=f.replace(/{CASO_PORTUGAL}/g,""),f=f.replace(/{CONSENTIU_GRAVACAO}/g,""));return ye.querySelectorAll("input, textarea").forEach(H=>{let M=H.id.replace("field-",""),I=new RegExp(`{${M}}`,"g"),$=H.value;if(M==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))){let J=me.querySelector('input[type="radio"]:checked');J&&Ne[J.id]&&($=Ne[J.id]["field-REASON_COMMENTS"])}if(qe.includes(M)&&$.trim()!==""){let J=$.split(`
`).map(ce=>ce.trim()).filter(ce=>ce!==""&&ce!=="\u2022").map(ce=>ce.startsWith("\u2022 ")?ce.substring(2):ce).map(ce=>`<li>${ce}</li>`).join("");$=J?`<ul ${B}>${J}</ul>`:""}else gt.includes(M)?$=$.split(`
`).filter(J=>J.trim()!=="").map(J=>`<p style="margin: 0 0 8px 0;">${J}</p>`).join(""):H.tagName==="TEXTAREA"&&($=$.replace(/\n/g,"<br>"));let Z=$.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(Z===""||Z==="\u2022"||Z.toLowerCase()==="n/a"){let J=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${M}\\}(?:<br>\\s*)?`,"gi");J.test(f)?f=f.replace(J,""):f=f.replace(I,"")}else f=f.replace(I,$.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(f+=i.getOutput()),f}Ge.onclick=()=>{let u=Ct();u?(xt(u),Q(j("copiado_sucesso"))):Q(j("selecione_substatus"),{error:!0})},Fe.onclick=async()=>{let u=k.value,G=Ct();if(!G){Q(j("selecione_substatus"),{error:!0});return}xt(G),dt();let f=Je(),B=await Pt();if(B)try{if(B.focus(),B.innerHTML.trim()==="<p><br></p>"||B.innerHTML.trim()==="<br>"||B.innerText.trim()===""){let ae=document.createRange();ae.selectNodeContents(B);let W=window.getSelection();W.removeAllRanges(),W.addRange(ae),document.execCommand("delete",!1,null)}else if(!B.innerHTML.endsWith("<br><br>")){let ae=document.createRange();ae.selectNodeContents(B),ae.collapse(!1);let W=window.getSelection();W.removeAllRanges(),W.addRange(ae),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,G),jt(B),setTimeout(()=>{Q(j("inserido_copiado"))},600);let te=typeof Ie<"u"&&Ie?Ie.checked:!0;if(u&&Ke[u]&&te){let ae=Ke[u];await Rt(ae),await new Promise(W=>setTimeout(W,500))}f(),ct(1.5),A.value="",k.innerHTML=`<option value="">${j("select_substatus")}</option>`,k.disabled=!0}catch(K){console.error(K),Q("Erro ao inserir.",{error:!0}),f()}};function ct(u=1.5){u<=1.5&&(Te.style.display="none",me.innerHTML=""),u<=2&&(be.style.display="none",r.reset(),le.style.display="none"),u<=3&&(fe.style.display="none",ye.innerHTML="",i.reset(),Me.style.display="none",ke.style.display="none")}function dt(){l=!l,we(l,b,"cw-btn-notes")}return it("bau"),st("pt"),dt}var Le={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
                ...
                `},{id:"nrp_dfa",name:"NRP - DFA",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Encerramento",body:`
                    ...
                    <br>
                    <p><strong>[Seu Nome]</strong><br>Time de Solu\xE7\xF5es T\xE9cnicas Cognizant, em nome do Google</p>
                `}]}};function Ht(){let e="v4.0.0",t=Object.keys(Le)[0],n="",o="list",l={display:"flex",flexDirection:"column",height:"100%",position:"relative",overflow:"hidden",background:"#FAFAFA"},a={display:"flex",width:"200%",height:"100%",transition:"transform 0.4s cubic-bezier(0.25, 1, 0.5, 1)",transform:"translateX(0)"},i={width:"50%",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"},r={width:"100%",padding:"10px 12px 10px 36px",borderRadius:"8px",border:"none",background:"#F0F2F5",fontSize:"14px",color:"#202124",boxSizing:"border-box",outline:"none",transition:"all 0.2s ease",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"10px center"},b={display:"flex",gap:"6px",padding:"4px 4px 8px 4px",overflowX:"auto",scrollbarWidth:"none"},y={padding:"6px 12px",borderRadius:"16px",border:"1px solid transparent",background:"transparent",color:"#5f6368",fontSize:"12px",fontWeight:"500",cursor:"pointer",transition:"all 0.2s ease",flexShrink:"0"},v={background:"#E8F0FE",color:"#1967D2",fontWeight:"600"},m={display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px",marginBottom:"6px",borderRadius:"8px",background:"#fff",border:"1px solid #dadce0",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.4, 0.0, 0.2, 1)",position:"relative",overflow:"hidden"},w=!1,S=document.createElement("div");S.id="quick-email-popup",Object.assign(S.style,ve,{right:"100px",width:"480px",height:"600px",boxShadow:"none",opacity:"0",pointerEvents:"none"});let x={popup:S,googleLine:null,focusElement:null};function C(){w=!w,we(w,S,"cw-btn-email"),w||setTimeout(()=>V(),300)}let E=Ae(S,"Emails R\xE1pidos",e,"Selecione, visualize e insira com um clique.",x,()=>C()),T=document.createElement("div");Object.assign(T.style,l);let q=document.createElement("div");Object.assign(q.style,a);let U=document.createElement("div");Object.assign(U.style,i);let h=document.createElement("div");Object.assign(h.style,{padding:"16px 16px 4px 16px",flexShrink:"0",background:"#fff",zIndex:"10",display:"flex",flexDirection:"column",gap:"8px",borderBottom:"1px solid #f1f3f4"});let d=document.createElement("input");d.placeholder="Buscar template...",Object.assign(d.style,r),d.onfocus=()=>{d.style.background="#fff",d.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},d.onblur=()=>{d.style.background="#F0F2F5",d.style.boxShadow="none"},x.focusElement=d;let c=document.createElement("div");Object.assign(c.style,b);let s=document.createElement("div");Object.assign(s.style,{padding:"12px 16px",overflowY:"auto",flexGrow:"1"}),h.appendChild(d),h.appendChild(c),U.appendChild(h),U.appendChild(s);let g=document.createElement("div");Object.assign(g.style,i);let p=document.createElement("div");Object.assign(p.style,{padding:"0",overflowY:"auto",flexGrow:"1",background:"#fff"}),g.appendChild(p),q.appendChild(U),q.appendChild(g),T.appendChild(q),S.appendChild(E),S.appendChild(T);let A=document.createElement("div");Object.assign(A.style,{padding:"8px 16px",borderTop:"1px solid #eee",textAlign:"center",fontSize:"10px",color:"#9aa0a6",background:"#fff",flexShrink:"0"}),A.textContent="created by lucaste@",S.appendChild(A),document.body.appendChild(S);function L(O){o="detail",q.style.transform="translateX(-50%)";let R='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg>',z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>';p.innerHTML=`
        <div style="
      ...
      `;let _=p.querySelector("#csa-back-btn");_.onmouseover=()=>_.style.backgroundColor="#f1f3f4",_.onmouseout=()=>_.style.backgroundColor="transparent",_.onclick=V;let D=p.querySelector("#csa-insert-btn");D.onmouseover=()=>D.style.backgroundColor="#174ea6",D.onmouseout=()=>D.style.backgroundColor="#1a73e8",D.onclick=async()=>{D.style.transform="scale(0.96)",C();let oe=Je();try{await ft(O),oe()}catch(ne){console.error(ne),oe()}setTimeout(()=>{D.style.transform="scale(1)",V()},300)}}function V(){o="list",q.style.transform="translateX(0)"}function N(){c.innerHTML="",Object.keys(Le).forEach(O=>{let R=Le[O],z=document.createElement("button");z.textContent=R.title,Object.assign(z.style,y),t===O&&n===""&&Object.assign(z.style,v),z.onclick=()=>{t=O,n="",d.value="",N(),k()},c.appendChild(z)})}function k(){s.innerHTML="";let O=[];if(n.trim()!==""?Object.values(Le).forEach(_=>{let D=_.emails.filter(oe=>oe.name.toLowerCase().includes(n.toLowerCase()));O=[...O,...D]}):Le[t]&&(O=Le[t].emails),O.length===0){s.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let R='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';O.forEach(_=>{let D=document.createElement("div");Object.assign(D.style,m);let oe=_.subject.length>50?_.subject.substring(0,50)+"...":_.subject;D.innerHTML=`
        ...
        <div style="display:flex; gap:6px;">
            ...
            <button class="action-btn send" title="Inserir Agora" style="width:32px; height:32px; border-radius:50%; border:none; background:#e8f0fe; color:#1a73e8; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all 0.2s;">${R}</button>
        </div>
      `,D.onmouseenter=()=>{D.style.background="#F8F9FA",D.style.borderColor="#1a73e8"},D.onmouseleave=()=>{D.style.background="#fff",D.style.borderColor="#dadce0"};let ne=D.querySelector(".view");ne.onclick=de=>{de.stopPropagation(),L(_)},ne.onmouseenter=()=>{ne.style.background="#d2e3fc",ne.style.color="#174ea6"},ne.onmouseleave=()=>{ne.style.background="#f1f3f4",ne.style.color="#5f6368"};let Y=D.querySelector(".send");Y.onclick=de=>{de.stopPropagation(),Y.style.transform="scale(0.9)",setTimeout(()=>Y.style.transform="scale(1)",150),ft(_),C()},Y.onmouseenter=()=>{Y.style.background="#1a73e8",Y.style.color="#fff",Y.style.boxShadow="0 2px 6px rgba(26,115,232,0.3)"},Y.onmouseleave=()=>{Y.style.background="#e8f0fe",Y.style.color="#1a73e8",Y.style.boxShadow="none"},D.onclick=()=>L(_),s.appendChild(D)})}return d.addEventListener("input",O=>{n=O.target.value,n!==""?Array.from(c.children).forEach(R=>Object.assign(R.style,y)):N(),k()}),N(),k(),C}var vt={"PT BAU":{color:"#6c1199",inicio:["Apresenta\xE7\xE3o (Nome e Time)","Aviso de Grava\xE7\xE3o e Pol\xEDtica de Privacidade","Confirma\xE7\xE3o de CID e Email","(Opcional) Validar autentica\xE7\xE3o da conta via link","Confirma\xE7\xE3o da Task e do AM","Informar tempo da liga\xE7\xE3o (30-45 min)","Pedir para fechar conte\xFAdo sens\xEDvel (antes de compartilhar)","Validar Backup e Acessos Admin"],fim:["Resumo da chamada (o que foi feito e como funciona)","Oferecer ajuda adicional / Abrir para d\xFAvidas","Pedir para fechar compartilhamento de tela","Pr\xF3ximos passos (Acompanhamento por XX dias)","Pedir consentimento para teste de QA","Alinhar escopo (T\xE9cnico vs. Gerente de Contas)","Pesquisa de Satisfa\xE7\xE3o (e confirmar email para envio)","Despedida"]},"PT LT":{color:"#004f67",inicio:["Ol\xE1 [...], eu sou o [...], e fa\xE7o parte da Equipe de Solu\xE7\xF5es T\xE9cnicas do Google. Tudo bem?","Nossa liga\xE7\xE3o poder\xE1 ser gravada para fins de treinamento, qualidade e melhorias dos servi\xE7os do Google, de acordo com a nossa Pol\xEDtica de Privacidade.","Por quest\xE3o de seguran\xE7a preciso que voc\xEA me informe o seu email e CID (ou n\xFAmero) da conta do Ads, por favor","Confirma\xE7\xE3o da Task e do AM","A consultoria tem uma dura\xE7\xE3o m\xE9dia de 30 a 45 minutos.","Pe\xE7o para que compartilhe a tela usando a op\xE7\xE3o \u201CTela Inteira\u201D","Por favor, feche todo e qualquer conte\xFAdo confidencial e sens\xEDvel (conversas, dados pessoais importantes, etc).","Possui o backup do seu site e todos os acessos \xE0s ferramentas do Google?"],fim:["Resumo da chamada (o que foi feito e como funciona)","Oferecer ajuda adicional / Abrir para d\xFAvidas","Pedir para fechar compartilhamento de tela","Pr\xF3ximos passos (Acompanhamento por XX dias)","Durante esse tempo, nossa equipe de qualidade poder\xE1 realizar um teste de convers\xE3o para validar a implementa\xE7\xE3o. Voc\xEA concorda com esse teste para garantirmos a efetividade da implementa\xE7\xE3o?","Alinhar escopo (T\xE9cnico vs. Gerente de Contas)","Pesquisa de Satisfa\xE7\xE3o (e confirmar email para envio)","Despedida"]},"ES BAU":{color:"#00bbff",inicio:["Introducci\xF3n (Nombre y  Equipo).","La llamada pode ser grabada con fines de entrenamiento y calidad de acuerdo com nuestra pol\xEDtica de privacidad.","Informar sitio web registrado en el caso.","Confirmaci\xF3n: Solicitar al Anunciante que confirme los 10 d\xEDgitos del CID el email del anunciante.","Confirmaciones: Tarea, AM","Informar el tiempo que va a durar la reuni\xE3o.","Confirmaci\xF3n: Copia de seguridad y acceso de ADM","Cerrar conte\xFAdo sens\xEDvel antes de compartir la pantalla."],fim:["Resumen de la llamada.","Ayuda adicional.","Cerrar la pantalla compartida.","Pr\xF3ximos passos (\xBFCu\xE1nto tempo seguir\xE1 el caso?)","Encuesta de Satisfa\xE7\xE3o.","Estar\xE9 monitoreando su caso durante XX dias para asegurarme de que todo est\xE9 funcionando corretamente. Durante este tiempo, nuestro equipo de qualidade podr\xEDa realizar una prueba de conversi\xF3n para validar la implementaci\xF3n. \xBFEst\xE1s de acuerdo con esta prueba para garantizar la efectividad de la implementaci\xF3n? Perfecto, \xA1gracias!"]},"ES LT":{color:"#f269ff",inicio:["Presentaci\xF3n (Nombre y equipo).","Informar al cliente sobre la llamada grabada.","Tiempo de duraci\xF3n de la llamada.",`Solicitar al anunciante que confirme lo siguiente: 
 A) 10 d\xEDgitos de la conta 
 B) Correo electr\xF3nico 
 C) N\xFAmero de tel\xE9fono y 
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function $t(){let e="v1.2.7",t={},n="PT",o="BAU",l=!1,a=document.createElement("div");a.id="call-script-popup",Object.assign(a.style,ve,{right:"100px",width:"340px",display:"flex",flexDirection:"column",boxShadow:"none",opacity:"0",pointerEvents:"none"});let i={popup:a,googleLine:null};function r(){l=!l,we(l,a,"cw-btn-script")}let b=Ae(a,"Call Script Assistant",e,"Checklists guiados para in\xEDcio e fim de chamada.",i,()=>{r()});a.appendChild(b);let y=document.createElement("div");y.id="csa-content",Object.assign(y.style,{padding:"16px",overflowY:"auto",flexGrow:"1"}),a.appendChild(y);let v=document.createElement("div");v.textContent="created by lucaste@",Object.assign(v.style,Xe),a.appendChild(v);let m=document.createElement("div");Object.assign(m.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px",gap:"8px"});let w=document.createElement("div");Object.assign(w.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden"});let S=document.createElement("div");S.textContent="BAU";let x=document.createElement("div");x.textContent="LT",Object.assign(S.style,se),Object.assign(x.style,se),w.appendChild(S),w.appendChild(x);let C=document.createElement("select");Object.assign(C.style,je,{marginBottom:"0",width:"auto",minWidth:"85px",paddingTop:"6px",paddingBottom:"6px"}),C.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',C.value=n,m.appendChild(w),m.appendChild(C),y.appendChild(m);let E=document.createElement("div");E.id="csa-checklist-area",Object.assign(E.style,{maxHeight:"60vh",overflowY:"auto",paddingRight:"5px"}),y.appendChild(E),document.body.appendChild(a);function T(c,s){let g=c.replace("#",""),p=parseInt(g.substring(0,2),16),A=parseInt(g.substring(2,4),16),L=parseInt(g.substring(4,6),16);return`rgba(${p}, ${A}, ${L}, ${s})`}function q(c,s,g){c.classList.toggle("csa-completed",s),s?(c.style.borderColor=g,c.style.backgroundColor=T(g,.15),c.style.textDecorationLine="line-through"):(c.style.borderColor="transparent",c.style.backgroundColor="#f8f9fa",c.style.textDecorationLine="none")}function U(c,s,g){let p=vt[c];if(!p)return;let A=p[s];if(!A||A.length===0)return;let L=!0;for(let V=0;V<A.length;V++){let N=`${c}-${s}-${V}`;if(!t[N]){L=!1;break}}g.classList.toggle("csa-group-completed",L)}function h(){E.innerHTML="";let c=`${n} ${o}`,s=vt[c];if(!s){E.innerHTML='<div style="padding: 10px; color: #5f6368;">Script n\xE3o dispon\xEDvel.</div>';return}let g=s.color;["inicio","fim"].forEach(p=>{let A=s[p];if(!A||A.length===0)return;let L=document.createElement("div");L.className="csa-group-container",Object.assign(L.style,{marginBottom:"16px"});let V=document.createElement("div");V.className="csa-group-title";let N=p==="inicio"?"In\xEDcio":"Fim";n.includes("ES")&&(N=p==="inicio"?"Inicio":"Fin"),n.includes("EN")&&(N=p==="inicio"?"Start":"End"),V.textContent=N,Object.assign(V.style,ze,{fontWeight:"600",fontSize:"14px",textDecoration:"underline",marginBottom:"8px"}),L.appendChild(V);let k=document.createElement("ul");Object.assign(k.style,{listStyle:"none",paddingLeft:"0",margin:"0"}),A.forEach((O,R)=>{let z=document.createElement("li");z.className="csa-li",z.textContent=O;let _=`${c}-${p}-${R}`,D=!!t[_];q(z,D,g),z.addEventListener("click",()=>{let oe=!t[_];t[_]=oe,q(z,oe,g),U(c,p,L)}),k.appendChild(z)}),L.appendChild(k),E.appendChild(L),U(c,p,L)})}function d(c){o=c;let s=Pe();Object.assign(S.style,se),Object.assign(x.style,se),Object.assign(c==="BAU"?S.style:x.style,s),h()}return S.onclick=()=>d("BAU"),x.onclick=()=>d("LT"),C.addEventListener("change",c=>{n=c.target.value,h()}),d(o),r}var tt={lm:{label:"LM Forms",links:[{name:"Relat\xF3rio de Ocorr\xEAncias",url:"https://docs.google.com/forms/d/e/1FAIpQLSc6CamPehrREeVr7yCWMyqFETrFYYezNcLb_13W4yZDQkfY6Q/viewform",desc:"Reportar problemas operacionais | Aviso de pausas"},{name:"Chamadas Excedidas (>50min)",url:"https://docs.google.com/forms/d/e/1FAIpQLSfE8EMHNJMTKYeA6XM2RZjZ9AQ4LhGk1Dwm_WLu3kcMdKMikA/viewform",desc:"Registro de chamadas longas"},{name:"Relat\xF3rio de Bugs",url:"https://docs.google.com/forms/d/e/1FAIpQLSfkqRqT2Kbf08IStz31fQPE84MDOtGxk7cetJmc3xzShXIXRA/viewform",desc:"Erros de sistema/ferramenta"},{name:"Suporte LM",url:"https://script.google.com/a/macros/google.com/s/AKfycbxYMlFCMZvqgHMIImeS_u-lNZPiertXmem-5m9Fox3jvZaq0ZOQDoc5ma96ltSvWHY/exec",desc:"Enviar casos para BAU/Solicitar Descarte/Abrir Monitoria para AMs"}]},qa:{label:"QA",links:[{name:"Elogios",url:"https://docs.google.com/forms/d/e/1FAIpQLSezY5K-trQDv0LkL5IoTlV0Tl0oOqGTEszylmgcbMRXcC9Weg/viewform",desc:"Feedback positivo dos Anunciantes"},{name:"Casos Complexos",url:"https://docs.google.com/forms/d/e/1FAIpQLSe26q1LEloFNRfOAVZtA7DCOQTqdu1BAEeWuxtK6oPwZhLp-A/viewform?resourcekey=0-c1N4h8gntza2gQowqYAqMw",desc:"Casos complicados de atender"}]},suporte:{label:"Central de Ajuda",links:[{name:"Suporte Google Ads",url:"https://support.google.com/google-ads/",desc:"Oficial"},{name:"Suporte GA4",url:"https://support.google.com/analytics/",desc:"Oficial"},{name:"Suporte Merchant Center",url:"https://support.google.com/merchants/gethelp",desc:"Oficial"},{name:"Doc. CSP",url:"https://developers.google.com/tag-platform/tag-manager/web/csp?hl=pt-br.",desc:"Doc. oficial sobre CSP"},{name:"Doc. Enhanced Conversion",url:"https://support.google.com/google-ads/answer/9888656?hl=en",desc:"Como funcionam as convers\xF5es otimizadas?"},{name:"Doc. CoMo",url:"https://developers.google.com/tag-platform/security/concepts/consent-mode?hl=pt-br",desc:"Doc. oficial sobre Consent Mode"}]},outros:{label:"Diversos",links:[{name:"Solicitar Grava\xE7\xE3o",url:"https://support.google.com/policies/contact/sar",desc:"Form para solicitar grava\xE7\xE3o da chamada."}]}};function Ut(){let e="v2.4.5",t="lm",n="",o={width:"100%",padding:"10px 12px 10px 36px",borderRadius:"8px",border:"1px solid #dadce0",background:"#f8f9fa",fontSize:"14px",boxSizing:"border-box",outline:"none",color:"#3c4043",transition:"background 0.2s, border-color 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"10px center"},l={display:"flex",flexWrap:"wrap",gap:"8px",paddingBottom:"8px"},a={padding:"6px 16px",borderRadius:"16px",border:"1px solid #dadce0",background:"transparent",color:"#5f6368",fontSize:"13px",fontWeight:"500",cursor:"pointer",whiteSpace:"nowrap",transition:"all 0.2s ease",marginBottom:"4px"},i={background:"#e8f0fe",color:"#1967d2",borderColor:"#e8f0fe",fontWeight:"600"},r={display:"flex",alignItems:"center",padding:"10px 14px",borderRadius:"12px",cursor:"pointer",border:"1px solid transparent",marginBottom:"6px",background:"#ffffff",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), background 0.2s",boxShadow:"0 1px 2px rgba(0,0,0,0.02)",opacity:"0",transform:"translateY(10px)"},b={width:"36px",height:"36px",borderRadius:"10px",background:"#f1f3f4",color:"#5f6368",display:"flex",alignItems:"center",justifyContent:"center",marginRight:"14px",fontSize:"18px",flexShrink:"0"},y=document.createElement("div");y.id="feedback-popup",Object.assign(y.style,ve,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none"});let v={lm:"\u{1F4DD}",qa:"\u{1F6E1}\uFE0F",suporte:"\u{1F4DA}",outros:"\u26A1"},m={popup:y,googleLine:null,focusElement:null},w=!1,S=Ae(y,"Links \xDAteis",e,"Acesso r\xE1pido a formul\xE1rios internos (Ocorr\xEAncias, Bugs) e documenta\xE7\xF5es oficiais de suporte.",m,()=>h());y.appendChild(S);let x=document.createElement("div");Object.assign(x.style,{padding:"0 16px 16px 16px",display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid #f1f3f4",flexShrink:"0",backgroundColor:"#fff"});let C=document.createElement("input");C.type="text",C.placeholder="Buscar link, form ou ajuda...",Object.assign(C.style,o),m.focusElement=C,C.onfocus=()=>{C.style.borderColor="#1a73e8",C.style.backgroundColor="#fff"},C.onblur=()=>{C.style.borderColor="#dadce0",C.style.backgroundColor="#f8f9fa"};let E=document.createElement("div");Object.assign(E.style,l),x.appendChild(C),x.appendChild(E),y.appendChild(x);let T=document.createElement("div");Object.assign(T.style,{padding:"0 8px 8px 8px",overflowY:"auto",flexGrow:"1"}),y.appendChild(T);let q=document.createElement("div");Object.assign(q.style,{padding:"8px 16px",borderTop:"1px solid #eee",display:"flex",justifyContent:"space-between",alignItems:"center",fontSize:"10px",color:"#9aa0a6"}),q.innerHTML="<span>by lucaste@</span>",y.appendChild(q),document.body.appendChild(y);function U(){T.innerHTML="";let d=[];if(n.trim()!==""?Object.values(tt).forEach(c=>{let s=c.links.filter(g=>g.name.toLowerCase().includes(n.toLowerCase())||g.desc.toLowerCase().includes(n.toLowerCase()));s.forEach(g=>g._categoryName=c.label),d=[...d,...s]}):d=tt[t].links,d.length===0){T.innerHTML='<div style="text-align:center; padding:20px; color:#9aa0a6; fontSize:13px;">Nenhum link encontrado.</div>';return}d.forEach(c=>{let s=document.createElement("div");Object.assign(s.style,r);let g=document.createElement("div");Object.assign(g.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"2px"});let p=document.createElement("div");Object.assign(p.style,{display:"flex",flexDirection:"column",flexGrow:"1"});let A=document.createElement("span");A.textContent=c.name,Object.assign(A.style,{fontSize:"14px",color:"#202124",fontWeight:"500"});let L=document.createElement("span");L.textContent=c.desc+(c._categoryName?` \u2022 ${c._categoryName}`:""),Object.assign(L.style,{fontSize:"11px",color:"#5f6368",marginTop:"2px"}),p.appendChild(A),p.appendChild(L);let V=document.createElement("div");Object.assign(V.style,{display:"flex",alignItems:"center",gap:"8px"});let N=document.createElement("div"),k='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',O='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1e8e3e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>';N.innerHTML=k,Object.assign(N.style,{width:"28px",height:"28px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#5f6368",cursor:"pointer",transition:"all 0.2s",opacity:"0"}),N.onclick=z=>{z.stopPropagation();let _=document.createElement("input");_.value=c.url,document.body.appendChild(_),_.select(),document.execCommand("copy"),document.body.removeChild(_),N.innerHTML=O,N.style.backgroundColor="#e6f4ea",setTimeout(()=>{N.innerHTML=k,N.style.backgroundColor="transparent"},1500)},N.onmouseenter=()=>{N.style.backgroundColor="#e8eaed",N.style.color="#202124"},N.onmouseleave=()=>{N.style.backgroundColor="transparent",N.style.color="#5f6368"};let R=document.createElement("span");R.innerHTML="&#8599;",Object.assign(R.style,{fontSize:"18px",color:"#dadce0",marginLeft:"4px"}),V.appendChild(N),V.appendChild(R),g.appendChild(p),g.appendChild(V),s.appendChild(g),s.onmouseenter=()=>{s.style.backgroundColor="#f1f3f4",R.style.color="#1a73e8",N.style.opacity="1"},s.onmouseleave=()=>{s.style.backgroundColor="transparent",R.style.color="#dadce0",N.style.opacity="0"},s.onclick=()=>window.open(c.url,"_blank"),T.appendChild(s)})}C.addEventListener("input",d=>{n=d.target.value,n!==""?Array.from(E.children).forEach(c=>{c.style.backgroundColor="transparent",c.style.color="#5f6368",c.style.borderColor="#dadce0"}):renderTabs(),U()});function h(){w=!w,we(w,y,"cw-btn-links")}return renderTabs(),U(),h}function io(){if(window.techSolInitialized){bt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Nt(),bt();let e=Vt(),t=Ht(),n=$t(),o=Ut();Gt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),Q("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}io();})();

...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Lt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},ao={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var io={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var xe={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var Mt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],to=-1;function st(){let e=Math.floor(Math.random()*Mt.length);return e===to&&(e=(e+1)%Mt.length),to=e,Mt[e]}var Me=e=>new Promise(t=>setTimeout(t,e));async function Go(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let n=e.querySelector(".cursor");await Me(200);for(let o=0;o<t.length;o++){let s=t.charAt(o),i=document.createElement("span");i.textContent=s,n&&n.parentNode===e?n.before(i):e.appendChild(i);let a=Math.floor(Math.random()*60)+30;o===0&&(a=150),o>t.length-3&&(a=30),await Me(a)}await Me(600),n&&(n.style.display="none")}async function Rt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await Me(200);let t=await Qt(),n=Zt(t),o=e.querySelector("#w-icon"),s=e.querySelector("#p1"),i=e.querySelector("#p2"),a=e.querySelector("#p3"),r=e.querySelector("#p-sextou");o&&(o.innerHTML=n.icon),s&&(s.textContent=n.prefix),a&&(a.textContent=n.suffix),await Me(300);let p=o?o.querySelector("svg"):null;if(p&&(p.style.opacity="1",p.style.transform="scale(1)"),await Me(400),s&&(s.style.opacity="1"),Y.playStartup(),i&&await Go(i,n.name),a&&(a.style.opacity="1",a.style.transform="translateY(0)"),n.isFriday&&r){await Me(400),r.style.display="block",r.offsetWidth;let d=r.querySelector(".sextou-badge");d&&(d.style.opacity="1",d.style.transform="scale(1)")}await Me(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await Me(900),e.parentNode&&e.parentNode.removeChild(e)}}var Ze={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Je(e,t){t.onmousedown=n;function n(o){o.stopPropagation(),o.preventDefault();let s=e.style.transition;e.style.transition="none";let i=o.clientX,a=o.clientY,r=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),p=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),d=i,u=a,c=!1;function m(h){d=h.clientX,u=h.clientY,c||(window.requestAnimationFrame(()=>{T(),c=!1}),c=!0)}function T(){let h=r+(d-i),E=p+(u-a);h>360&&(e.style.width=h+"px"),E>300&&(e.style.height=E+"px")}function f(){document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",f),setTimeout(()=>{e.style.transition=s},50)}document.addEventListener("mousemove",m),document.addEventListener("mouseup",f)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function so(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,n=>t[n]?t[n]:"")}var et=e=>new Promise(t=>setTimeout(t,e));function rt(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}var ro="cw-automation-styles";if(!document.getElementById(ro)){let e=document.createElement("style");e.id=ro,e.innerHTML=`
...
\u2022 Tentativa 2 -`}};var ge=e=>new Promise(t=>setTimeout(t,e));function ye(e,t="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,n[t]||n.info)}function Oe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function ft(e,t){if(!e)return;let n=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=e.getBoundingClientRect(),i=document.createElement("div");i.id=n,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let a=i.querySelector(".cw-close-btn");a.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&a.click()},25e3)}async function ht(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await ge(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await ge(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function Gt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(n=>{let o=n.offsetParent!==null,s=n.closest("case-message-view")!==null,i=n.closest(".editor")!==null||n.closest("write-card")!==null;return o&&!s&&i});return t&&ye("Editor visualmente detectado.","success"),t}async function po(){ye("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(c=>c.innerText.trim()==="email");if(n&&n.offsetParent!==null){ye("Bot\xE3o de email direto encontrado.");let c=n.closest("material-button")||n.closest("material-fab")||n;Oe(c),e=!0}else{ye("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let c=document.querySelector("material-fab-speed-dial");if(c){let m=c.querySelector(".trigger");if(m){Oe(m),await ge(800);let f=Array.from(document.querySelectorAll("i.material-icons-extended")).find(h=>h.innerText.trim()==="email");f&&(Oe(f),e=!0)}}}if(!e)return V("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;ye("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,s=0,i=20;for(;s<i;){await ge(250);let c=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(c).find(m=>m.offsetParent!==null),o){ye("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(o){ye("\u{1F5D1}\uFE0F Descartando..."),Oe(o),o.click();let c=null,m=0;for(;m<15;){await ge(300);let T=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(c=Array.from(T).find(f=>f.offsetParent!==null),c)break;m++}c&&(Oe(c),V("Limpando rascunho antigo...",{duration:2e3}),await ge(2500))}ye("\u{1F680} FASE 3: Buscando editor final...");let a=0,r=null;for(;a<20&&(r=Gt(),!r);)await ge(250),a++;if(!r)return V("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let p=r.closest('[id="email-body-content-top"]'),u=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(p){if(u){let m=u.closest('[aria-hidden="true"]');m&&m.removeAttribute("aria-hidden"),u.focus(),Oe(u)}await ge(300),p.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let c=p.querySelector("#cases-body-field");if(c){let m=document.createRange();m.selectNodeContents(c),m.collapse(!0);let T=window.getSelection();T.removeAllRanges(),T.addRange(m)}return!0}return!1}async function xt(e){if(!e||!await po())return;let n=await it();ye("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await ge(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await ht(i,n.clientEmail),ft(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await ht(i,n.internalEmail),ft(i,`
            ...
            `))}await ge(500);let s=document.querySelector('material-button[debug-id="canned_response_button"]');if(s){Oe(s),await ge(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){Oe(i),document.execCommand("insertText",!1,e),i.dispatchEvent(new Event("input",{bubbles:!0})),ye("\u23F3 Buscando resultado da Canned Response...","info");let a=null,r=0,p=15e3,d=500;for(;r<p&&(a=document.querySelector("material-select-dropdown-item"),!a);)await ge(d),r+=d;if(a){Oe(a),await ge(1500);let u=Gt();if(u&&n.advertiserName){let c=u.innerHTML;c.includes("{%ADVERTISER_NAME%}")&&(u.innerHTML=c.replace(/{%ADVERTISER_NAME%}/g,n.advertiserName))}V("Canned Response aplicada!")}else ye(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),V(`Timeout: Template '${e}' n\xE3o carregou.`,{error:!0})}}else V("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function uo(e){if(ye(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await po())return;let n=await it(),o=Nt();await ge(600),ye("\u{1F4E7} Processando destinat\xE1rios...");let s=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(s&&(s.click(),await ge(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let r=document.querySelector('input[aria-label="Enter To email address"]');r&&(await ht(r,n.clientEmail),ft(r,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let r=document.querySelector('input[aria-label="Enter Bcc email address"]');r&&(await ht(r,n.internalEmail),ft(r,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
    ...
    `,document.head.appendChild(e)}function Ie(e,t,n){let o=document.getElementById(n);if(!t)return;let s=t.getAttribute("data-moved")==="true",i={x:0,y:0};if(o){let u=o.getBoundingClientRect();i.x=u.left+u.width/2,i.y=u.top+u.height/2}let a,r;if(!s)a=window.innerWidth/2,r=window.innerHeight/2;else{let u=t.getBoundingClientRect();a=u.left+u.width/2,r=u.top+u.height/2,a===0&&r===0&&(a=window.innerWidth/2,r=window.innerHeight/2)}let p=i.x-a,d=i.y-r;e?(Y.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",s?t.style.transform=`translate(${p}px, ${d}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${d}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",s?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(t,n)):(Y.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",s?t.style.transform=`translate(${p}px, ${d}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${d}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof zt=="function"&&zt(t))}function go(e,t){zt(e);let n=o=>{if(!e.classList.contains("open"))return;let s=e.contains(o.target),i=document.querySelector(".cw-pill"),a=i&&i.contains(o.target);s?(e.classList.remove("idle"),e.style.zIndex="2147483648"):a||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function zt(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var Po="https://script.google.com/a/macros/google.com/s/AKfycbxFxh1cVk6r0t_JTA2TBfHBLJe_mOBQFsidwL1jwsUDcBtQYk3afu25SN-FR3vafJChHw/exec",Bt="cw_data_broadcast",bo="cw_data_tips",jo=["Processando...","Mantenha o foco!","Aguarde..."];function yt(e,t={}){return new Promise((n,o)=>{let s="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script");window[s]=p=>{document.body.contains(i)&&document.body.removeChild(i),delete window[s],n(p)};let a=Object.keys(t).map(p=>encodeURIComponent(p)+"="+encodeURIComponent(t[p])).join("&"),r=`${Po}?op=${e}&callback=${s}&t=${Date.now()}&${a}`;i.src=r,i.onerror=()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[s],o(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(i)})}var ve={fetchTips:async()=>{try{let e=await yt("tips");e?.tips&&localStorage.setItem(bo,JSON.stringify(e.tips))}catch(e){console.warn("Tips offline",e)}},fetchData:async()=>{try{let e=await yt("broadcast");if(e?.broadcast)return localStorage.setItem(Bt,JSON.stringify(e.broadcast)),e}catch(e){console.warn("Broadcast offline",e)}return{broadcast:JSON.parse(localStorage.getItem(Bt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Bt)||"[]"),getRandomTip:()=>{let e=jo,t=localStorage.getItem(bo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},sendBroadcast:async e=>{let t={...e,date:new Date().toISOString(),id:Date.now().toString()};return await ve._performOp("new_broadcast",t)},updateBroadcast:async(e,t)=>{let n={id:e,...t};return await ve._performOp("update_broadcast",n)},deleteBroadcast:async e=>await ve._performOp("delete_broadcast",{id:e}),_performOp:async(e,t)=>{try{console.log(`\u{1F4E4} Executando ${e}...`,t);let n=await yt(e,t);return n&&n.status==="success"?(console.log("\u2705 Sucesso:",e),!0):(console.warn("\u26A0\uFE0F Falha:",n),!1)}catch(n){return console.error("\u274C Erro JSONP:",n),!1}},logEvent:(e,t,n="",o=null)=>{try{let s="anon";try{let a=bt();a&&(s=a.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:s,version:"v4.5.1",category:e,action:t,label:n,value:o||""};yt("log",i).catch(a=>{})}catch(s){console.warn("Analytics error",s)}},logUsage:()=>{}};var we={glassBg:"rgba(32, 33, 36, 0.85)",glassBorder:"rgba(255, 255, 255, 0.1)",iconIdle:"#9AA0A6",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},Pt=e=>new Promise(t=>setTimeout(t,e));function fo(e){let t="cw-command-center-style";if(!document.getElementById(t)){let h=document.createElement("style");h.id=t,h.innerHTML=`
            ...
            .cw-pill {
                ...
                padding: 16px 6px; /* Padding padr\xE3o aberto */
                ...
                /* Transi\xE7\xF5es complexas para o efeito "Morph" */
                transition: 
                ...
                min-width: 52px; /* Tamanho base */
                overflow: hidden; /* Importante para cortar o conte\xFAdo ao fechar */
            }
            .cw-pill.docked { opacity: 1; transform: translateX(0) scale(1); }

            /* --- ESTADO COLAPSADO (A Bolinha Perfeita) --- */
            .cw-pill.collapsed {
                width: 52px !important; 
                height: 52px !important;
                padding: 0 !important; /* Remove padding para centralizar */
                gap: 0;
                border-radius: 50% !important; /* C\xEDrculo perfeito */
                cursor: pointer;
            }
            
            /* Efeito Hover na Bolinha Fechada */
            .cw-pill.collapsed:hover {
                background: rgba(45, 46, 50, 0.95);
                border-color: rgba(255,255,255,0.3);
                transform: scale(1.05); /* Leve respiro */
            }

            /* \xCDcone Principal (Logo) */
            .cw-main-logo {
            ...
            /* Conte\xFAdo Interno (Bot\xF5es) */
            /* Quando fechado, eles somem r\xE1pido e perdem intera\xE7\xE3o */
            ...
            .cw-pill.collapsed .cw-status-container {
                ...
                pointer-events: none; 
                transform: scale(0.8);
                transition: opacity 0.2s ease, transform 0.2s ease; /* Some r\xE1pido */
            }
            
            /* Quando aberto, eles aparecem com leve delay */
            .cw-btn, .cw-grip, .cw-sep {
                transition: opacity 0.4s ease 0.1s, transform 0.4s ease 0.1s; /* Delay para esperar abrir */
            }
            ...
            .cw-btn:hover { background: rgba(255,255,255,0.1); color: ${we.iconActive}; transform: scale(1.1); }
            ...
            .cw-grip-bar { 
                width: 24px; height: 4px; background-color: ${we.iconIdle}; border-radius: 4px; 
                opacity: 0.3; transition: all 0.3s; 
            }
            .cw-grip:hover .cw-grip-bar { opacity: 0.8; background-color: #FFF; }
            .cw-grip:active { cursor: grabbing; }

            /* Tooltips (S\xF3 aparecem se aberto) */
            .cw-btn::after { 
            ...
            .cw-pill:not(.collapsed) .cw-btn:hover::after { opacity: 1; transform: translateY(-50%) scale(1); }
            .cw-pill.side-right .cw-btn::after { right: 50px; transform-origin: right center; }
            .cw-pill.side-left .cw-btn::after { left: 50px; transform-origin: left center; }

            /* --- DRAGGING STATE --- */
            .cw-pill.dragging {
                transition: none !important; /* Remove transi\xE7\xE3o para seguir o mouse r\xE1pido */
                cursor: grabbing;
                transform: scale(1.02);
                border-color: rgba(255,255,255,0.3);
            }

            /* --- ESTILOS DA ILHA DIN\xC2MICA (Processing) --- */
            ...
            .cw-pill.processing-center.collapsed {
                 background: #202124 !important; overflow: visible !important;
            }
            ...
            .cw-center-dots span:nth-child(1) { background-color: ${we.blue}; animation-delay: -0.32s; }
            .cw-center-dots span:nth-child(2) { background-color: ${we.red}; animation-delay: -0.16s; }
            ...
            .cw-center-text {
                ...
                animation: textSlideUp 0.5s forwards; animation-delay: 0.2s;
            }
            .cw-center-success { display: none; color: ${we.green}; }
    ...
    `;let s=document.createElement("div");s.className="cw-focus-backdrop",document.body.appendChild(s),document.body.appendChild(o);let i=h=>E=>{E.stopPropagation(),h()};if(o.querySelector(".notes").onclick=i(e.toggleNotes),o.querySelector(".email").onclick=i(e.toggleEmail),o.querySelector(".script").onclick=i(e.toggleScript),o.querySelector(".links").onclick=i(e.toggleLinks),o.querySelector(".broadcast").onclick=h=>{h.stopPropagation();let E=h.currentTarget.querySelector(".cw-badge");E&&E.remove(),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let h=document.createElement("div");h.className="cw-badge",o.querySelector(".broadcast").appendChild(h)}let a=null;o.onmouseenter=()=>{a&&clearTimeout(a),r||o.classList.remove("collapsed")},o.onmouseleave=()=>{o.classList.contains("processing-center")||r||(a=setTimeout(()=>{o.classList.add("collapsed")},500))},(async function(){await Pt(2800),o.classList.add("docked"),await Pt(300);let E=o.querySelectorAll(".cw-btn");for(let D=0;D<E.length;D++)E[D].classList.add("popped"),await Pt(80)})();let r=!1,p,d,u,c,m=5;o.onmousedown=h=>{if(!o.classList.contains("collapsed")&&h.target.closest("button"))return;h.preventDefault(),p=h.clientX,d=h.clientY;let E=o.getBoundingClientRect();u=E.left,c=E.top,document.addEventListener("mousemove",T),document.addEventListener("mouseup",f)};function T(h){let E=h.clientX-p,D=h.clientY-d;!r&&Math.sqrt(E*E+D*D)>m&&(r=!0,o.classList.add("dragging"),a&&clearTimeout(a)),r&&(o.style.left=`${u+E}px`,o.style.top=`${c+D}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function f(h){if(document.removeEventListener("mousemove",T),document.removeEventListener("mouseup",f),r){r=!1,o.classList.remove("dragging");let E=window.innerWidth,D=window.innerHeight,B=o.getBoundingClientRect(),oe=B.left+B.width/2,ne;oe<E/2?(ne=24,o.classList.remove("side-right"),o.classList.add("side-left")):(ne=E-B.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let S=Math.max(24,Math.min(B.top,D-B.height-24));o.style.transition="left 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.5s cubic-bezier(0.2, 0.8, 0.2, 1)",o.style.left=`${ne}px`,o.style.top=`${S}px`,setTimeout(()=>o.style.transition="",500)}else o.classList.contains("collapsed")&&o.classList.remove("collapsed")}}function vt(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};e.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let n=document.createElement("div");n.className="cw-center-stage",n.innerHTML=`
        <div class="cw-center-dots"><span></span><span></span><span></span></div>
        <div class="cw-center-text">${ve.getRandomTip()}</div>
        <div class="cw-center-success"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
    `;let o=document.createElement("div");o.className="cw-abort-btn",o.textContent="Cancelar",o.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,V("Cancelado!",{duration:3e3}),n.remove(),e.classList.remove("processing-center"),e.classList.remove("success"),e.classList.add("collapsed"),t&&t.classList.remove("active")},n.appendChild(o),e.appendChild(n);let s=Date.now();return e.classList.add("processing-center"),t&&t.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!e.contains(n))return;let a=Date.now()-s,r=Math.max(0,2e3-a);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!e.contains(n))return;let p=n.querySelector(".cw-center-dots"),d=n.querySelector(".cw-center-text"),u=n.querySelector(".cw-center-success"),c=n.querySelector(".cw-abort-btn");p&&(p.style.display="none"),d&&(d.style.display="none"),c&&(c.style.display="none"),u&&u.classList.add("show"),e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing-center"),setTimeout(()=>{n.remove(),e.classList.remove("success"),e.classList.add("collapsed"),t&&t.classList.remove("active")},400)},1e3)},r)}}function ho(e){let t=document.createElement("div");t.className="cw-step-scenarios";let n=document.createElement("div");Object.assign(n.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let o=document.createElement("div");Object.assign(o.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"40px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s ease"}),o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>";let s=null;Object.entries(ke).forEach(([a,r])=>{let p=document.createElement("div");p.textContent=a,Object.assign(p.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",display:"flex",alignItems:"center",gap:"6px"}),p.onmouseenter=()=>{s!==r&&(o.style.background="#fff",o.style.borderColor="#1a73e8",o.style.color="#202124",o.textContent=`"${r.substring(0,120)}${r.length>120?"...":""}"`),s!==r&&(p.style.background="#f1f3f4")},p.onmouseleave=()=>{s!==r&&(s||(o.style.background="#f8f9fa",o.style.borderColor="#dadce0",o.style.color="#5f6368",o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>"),p.style.background="#ffffff")},p.onclick=()=>{Y.playClick(),s===r?(s=null,i(),e("")):(s=r,i(),p.style.transform="scale(0.95)",setTimeout(()=>p.style.transform="scale(1)",150),e(r))},n.appendChild(p)});function i(){Array.from(n.children).forEach(a=>{ke[a.textContent]===s?(a.style.background="#e8f0fe",a.style.borderColor="#1a73e8",a.style.color="#1967d2",a.style.fontWeight="500"):(a.style.background="#ffffff",a.style.borderColor="#dadce0",a.style.color="#3c4043",a.style.fontWeight="400")})}return t.appendChild(n),t.appendChild(o),t}var xo=e=>new Promise(t=>setTimeout(t,e));function wt(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function dt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{V("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function At(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function yo(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Ct(){console.log("Iniciando processo de Nova Nota...");let e=yo(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(a=>a.innerText.trim()==="description");if(o){let a=o.closest("material-fab")||o.closest("material-button");a?(a.style&&(a.style.display="block",a.style.visibility="visible"),wt(a)):wt(o)}else{let a=document.querySelector("material-fab-speed-dial");if(a){let r=a.querySelector(".trigger");r?(r.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),wt(r)):a.click(),await xo(800);let d=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="description");d&&wt(d)}}let s=null,i=0;for(;!s&&i<20;){await xo(300);let a=yo();if(a.length>t)s=a.find(r=>!e.includes(r)),s||(s=a[a.length-1]);else if(i>10){let r=a.filter(p=>p.offsetParent!==null);r.length>0&&(s=r[r.length-1])}i++}return s}var J={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},_e="cubic-bezier(0.25, 0.8, 0.25, 1)",Ho={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${J.border}`,backgroundColor:J.bgInput,fontSize:"14px",color:J.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${_e}, box-shadow 0.2s ${_e}, background-color 0.2s`,outline:"none"},kn={...Ho,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},On={fontSize:"13px",fontWeight:"700",color:J.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},qn={display:"block",fontSize:"13px",fontWeight:"600",color:J.text,marginBottom:"8px",marginTop:"16px"},In={fontSize:"12px",color:J.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},_n={fontSize:"12px",color:J.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},Nn={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:J.text,cursor:"pointer",padding:"12px 14px",backgroundColor:J.surface,border:`1px solid ${J.border}`,borderRadius:"12px",transition:`all 0.2s ${_e}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},jt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:J.primary},Fn={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:J.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${_e}, box-shadow 0.2s ${_e}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},Mn={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${J.primary}`,color:J.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${_e}`},Ln={background:"transparent",border:`1px solid ${J.border}`,borderRadius:"20px",color:J.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${_e}`,fontFamily:"'Google Sans', 'Roboto'"};var Rn={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:J.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},Dn={fontSize:"13px",fontWeight:"700",color:J.primary,minWidth:"20px",textAlign:"center"},Gn={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${J.border}`,backgroundColor:J.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${_e}, box-shadow 0.2s ${_e}`},zn={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${J.bgInput}`},Bn={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${J.border}`,backgroundColor:J.surface,color:J.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${_e}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Pn={backgroundColor:J.primaryBg,color:J.primary,borderColor:J.primary,fontWeight:"600"},jn={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:J.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Hn={borderTop:`1px solid ${J.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Vn={maxHeight:"240px",overflowY:"auto",border:`1px solid ${J.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:J.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},$n={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${J.bgInput}`,cursor:"pointer",fontSize:"13px",color:J.text,transition:"background 0.1s",userSelect:"none"};var Vo={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},$o={fontSize:"12px",color:"#e37400",marginTop:"4px"},Uo={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},Wo={display:"flex",gap:"15px",marginBottom:"10px"};function vo(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Vo);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,Lt,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,Wo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,jt);let s=document.createElement("label");s.textContent="Sim";let i=document.createElement("div");Object.assign(i.style,{display:"flex",alignItems:"center"}),i.appendChild(o),i.appendChild(s);let a=document.createElement("input");a.type="radio",a.name="ts_usage_mod",a.value="N\xE3o",a.checked=!0,Object.assign(a.style,jt);let r=document.createElement("label");r.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(a),p.appendChild(r),n.appendChild(i),n.appendChild(p);let d=document.createElement("div");d.style.display="block";let u=document.createElement("label");u.textContent="Qual foi o Motivo?",Object.assign(u.style,Lt,{fontSize:"12px"});let c=document.createElement("input");c.type="text",Object.assign(c.style,Uo);let m=document.createElement("div");m.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(m.style,$o),d.appendChild(u),d.appendChild(c),d.appendChild(m),e.appendChild(t),e.appendChild(n),e.appendChild(d),o.onchange=()=>{d.style.display="none"},a.onchange=()=>{d.style.display="block"};function T(E,D){if(e.style.display="none",!E||E.includes("Education")||!D||D.length===0)return;let B=D.some(q=>q.includes("enhanced")||q==="ec_google_ads"),oe=D.some(q=>(q.includes("conversion")||q.includes("ads"))&&!q.includes("enhanced")),ne=D.some(q=>q.includes("ga4")||q.includes("analytics")||q.includes("ua")),S=D.some(q=>q.includes("merchant")||q.includes("gmc")||q.includes("shopping"));(B||oe&&!ne&&!S)&&(e.style.display="block")}function f(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return a.checked&&c.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${c.value}`),E+="<br>",E}function h(){e.style.display="none",a.checked=!0,o.checked=!1,d.style.display="block",c.value=""}return{element:e,updateVisibility:T,getOutput:f,reset:h}}var X={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Xe={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function wo(e){let t={},n="implementation";function o(S){let C=S.toLowerCase();return C.includes("ads")||C.includes("conversion")||C.includes("remarketing")?X.brands.ads:C.includes("ga4")||C.includes("analytics")?X.brands.ga4:C.includes("gtm")||C.includes("tag manager")||C.includes("container")?X.brands.gtm:C.includes("merchant")||C.includes("shopping")||C.includes("feed")?X.brands.gmc:X.brands.default}let s=Object.entries(Ge).filter(([S,C])=>C.popular),i={};Object.entries(Ge).forEach(([S,C])=>{if(C.popular)return;let q=o(C.name);i[q.label]||(i[q.label]={brand:q,tasks:[]}),i[q.label].tasks.push({key:S,...C})});let a="cw-zen-tasks";if(!document.getElementById(a)){let S=document.createElement("style");S.id=a,S.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(S)}let r=document.createElement("div");r.className="cw-zen-container";let p=document.createElement("div");Object.assign(p.style,{display:"none"});let d=document.createElement("div");d.className="cw-screens-container",p.appendChild(d),r.innerHTML=`
    ...
    `;let u=r.querySelector(".cw-hero-grid"),c=r.querySelector(".cw-acc-container"),m=r.querySelector(".cw-results-container"),T=r.querySelector(".cw-search-input"),f=r.querySelector(".cw-status-bar"),h=r.querySelector(".cw-status-text"),E=r.querySelector(".cw-footer-icons");s.forEach(([S,C])=>{let q=o(C.name),G=document.createElement("div");G.className="cw-hero-card",G.id=`hero-${S}`,G.style.setProperty("--hero-color",q.color),G.innerHTML=`
        ...
        `,G.onclick=M=>{if(M.target.closest(".cw-step-btn"))return;let L=t[S]?t[S].count:0;B(S,L>0?-L:1,C)},G.querySelector(".minus").onclick=()=>B(S,-1,C),G.querySelector(".plus").onclick=()=>B(S,1,C),G.dataset.color=q.color,u.appendChild(G)});function D(S,C){let q=o(C.name),G=document.createElement("div");return G.className="cw-task-item",G.dataset.id=S,G.innerHTML=`
        ...
        `,G.onclick=M=>{if(M.target.closest(".cw-step-btn"))return;let L=t[S]?t[S].count:0;B(S,L>0?-L:1,C)},G.querySelector(".minus").onclick=()=>B(S,-1,C),G.querySelector(".plus").onclick=()=>B(S,1,C),G}Object.entries(i).forEach(([S,C])=>{let q=document.createElement("div");q.className="cw-acc-group";let G=document.createElement("div");G.className="cw-acc-header",G.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${C.brand.color}"></div>
                ${S}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,G.onclick=()=>{c.querySelectorAll(".cw-acc-group.open").forEach(L=>{L!==q&&L.classList.remove("open")}),q.classList.toggle("open")};let M=document.createElement("div");M.className="cw-acc-body",C.tasks.forEach(L=>{let O=D(L.key,L);M.appendChild(O)}),q.appendChild(G),q.appendChild(M),c.appendChild(q)});function B(S,C,q){t[S]||(t[S]={count:0,data:q,brand:o(q.name)}),t[S].count+=C,t[S].count<=0&&delete t[S],oe(),ne(),e&&e()}function oe(){s.forEach(([M])=>{let L=u.querySelector(`#hero-${M}`);if(!L)return;let O=t[M];O?(L.classList.add("active"),L.querySelector(".cw-step-val").textContent=O.count,L.querySelector(".cw-step-val").style.color=L.dataset.color):L.classList.remove("active")}),r.querySelectorAll(".cw-task-item").forEach(M=>{let L=M.dataset.id,O=t[L];O?(M.classList.add("selected"),M.querySelector(".cw-step-val").textContent=O.count):M.classList.remove("selected")});let C=Object.keys(t),q=0,G=[];if(C.forEach(M=>{let L=t[M];q+=L.count;for(let O=0;O<L.count;O++)G.length<6&&G.push(L.brand)}),q>0){f.classList.add("visible");let M=q>1?"A\xE7\xF5es":"A\xE7\xE3o",L=q>1?"definidas":"definida";h.textContent=`${q} ${M} ${L}`,E.innerHTML="",G.forEach(O=>{let x=document.createElement("div");x.className="cw-mini-icon",x.innerHTML=Xe[O.icon]||Xe.default;let b=x.querySelector("svg");b&&(b.style.width="14px",b.style.height="14px"),E.appendChild(x)})}else f.classList.remove("visible")}T.addEventListener("input",S=>{let C=S.target.value.toLowerCase();if(C.length>0){c.style.display="none",m.style.display="block",m.innerHTML="";let q=!1;Object.entries(Ge).forEach(([G,M])=>{if(M.name.toLowerCase().includes(C)){q=!0;let L=D(G,M);t[G]&&(L.classList.add("selected"),L.querySelector(".cw-step-val").textContent=t[G].count),m.appendChild(L)}}),q||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else c.style.display="block",m.style.display="none"});function ne(){d.innerHTML="";let S=Object.keys(t),C=!1,q=document.getElementById("sub-status"),G="implementation";if(q&&q.value.toLowerCase().includes("education")&&(G="education"),S.length===0){d.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(S.length===0){d.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let M=document.createElement("div");M.className="cw-info-banner",M.innerHTML=`
        ...
        `,d.appendChild(M),S.forEach(L=>{let O=t[L].data,x=t[L].count,b=t[L].brand,N=O.screenshots?O.screenshots[G]||[]:["Link da Evid\xEAncia"];if(N.length>0){C=!0;for(let l=1;l<=x;l++){let v=document.createElement("div");v.className="cw-screen-card",v.style.setProperty("--brand-color",b.color),v.style.setProperty("--brand-bg",b.bg),v.style.setProperty("--brand-shadow",b.color+"40");let w=document.createElement("div");w.className="cw-card-header";let g=document.createElement("div");g.className="cw-card-icon",g.innerHTML=Xe[b.icon]||Xe.default;let A=document.createElement("div");A.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let I=document.createElement("input");I.className="cw-card-title-input",I.id=`name-${L}-${l}`,I.value=`${O.name}${x>1?" #"+l:""}`,I.title="Clique para renomear esta task";let j=document.createElement("span");j.className="cw-edit-hint",j.innerHTML="\u270E Renomear",A.appendChild(I),A.appendChild(j),w.appendChild(g),w.appendChild(A),v.appendChild(w),N.forEach((R,k)=>{let z=document.createElement("div");z.className="cw-input-group";let U=document.createElement("label");U.className="cw-input-label",U.textContent=R.replace(/📷|:|•/g,"").trim();let _=document.createElement("input");_.className="cw-input-field",_.id=`screen-${L}-${l}-${k}`,_.placeholder="Cole o link aqui...",_.setAttribute("autocomplete","off"),_.addEventListener("input",()=>{_.value.trim().length>5?_.classList.add("filled"):_.classList.remove("filled")});let H=document.createElement("div");H.className="cw-input-check",H.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',z.appendChild(U),z.appendChild(_),z.appendChild(H),v.appendChild(z)}),d.appendChild(v)}}}),p.style.display=C?"block":"none"}return{selectionElement:r,screenshotsElement:p,updateSubStatus:()=>ne(),getCheckedElements:()=>Object.keys(t).map(S=>({value:S,closest:()=>({querySelector:()=>({textContent:t[S].count})})})),toggleTask:(S,C=!0)=>{let q=t[S];C&&!q?B(S,1,Ge[S]):!C&&q&&B(S,-q.count,Ge[S])},setMode:S=>{n=S,ne()},reset:()=>{for(let S in t)delete t[S];T.value="",c.style.display="block",m.style.display="none",oe(),ne()}}}function Ao(e){let t=document.createElement("div");t.style.cssText="display: flex; flex-direction: column; height: 100%; width: 100%; background: #F8F9FA; overflow: hidden; position: relative;";let n=document.createElement("div");n.style.cssText="flex: 1; overflow-y: auto; padding: 20px 24px 80px 24px; min-height: 0;";let o={sectionTitle:`
            font-family: 'Google Sans', Roboto, sans-serif;
            font-size: 11px; 
            font-weight: 700; 
            color: #5F6368; 
        ...
        `};function s(b,N,l="text",v=""){let w=document.createElement("div");w.style.cssText=o.inputWrapper;let g=document.createElement("label");g.style.cssText=o.label,g.textContent=N;let A;l==="textarea"?(A=document.createElement("textarea"),A.style.cssText=o.input+o.textarea):(A=document.createElement("input"),A.type=l,A.style.cssText=o.input);let I=A.style.cssText;return A.onfocus=()=>A.style.cssText=I+o.inputFocus,A.onblur=()=>A.style.cssText=I,A.id=`st-${b}`,A.placeholder=v,w.appendChild(g),w.appendChild(A),{wrapper:w,input:A}}function i(b,N){let l=document.createElement("div"),v=document.createElement("label");v.style.cssText=o.label,v.textContent=N,l.appendChild(v);let w=document.createElement("div");return w.style.cssText=o.radioGroup,["Yes","No"].forEach(g=>{let A=document.createElement("label");A.style.cssText=o.radioLabel;let I=document.createElement("input");I.type="radio",I.name=`st-${b}`,I.value=g==="Yes"?"Y":"N",I.style.display="none",g==="No"&&(I.checked=!0),A.onmousedown=()=>A.style.transform="scale(0.96)",A.onmouseup=()=>A.style.transform="scale(1)",A.onmouseleave=()=>A.style.transform="scale(1)",A.appendChild(I),A.appendChild(document.createTextNode(g)),I.addEventListener("change",()=>{w.querySelectorAll("label").forEach(j=>j.style.cssText=o.radioLabel),I.checked&&(A.style.cssText=o.radioLabel+o.radioActive)}),g==="No"&&(A.style.cssText=o.radioLabel+o.radioActive),w.appendChild(A)}),l.appendChild(w),{wrapper:l}}let a=document.createElement("div");a.style.cssText=o.banner,a.innerHTML=`
    ...
    `,n.appendChild(a);let r=document.createElement("button");r.style.cssText=o.magicBtn,r.innerHTML='<span style="font-size:16px">\u2728</span> Preencher Automaticamente',r.onmouseover=()=>r.style.backgroundColor="#F8F9FA",r.onmouseout=()=>r.style.backgroundColor="#FFFFFF",r.onmousedown=()=>r.style.transform="scale(0.98)",r.onmouseup=()=>r.style.transform="scale(1)",n.appendChild(r);let p=document.createElement("div");p.style.cssText=o.sectionTitle,p.style.marginTop="24px",p.innerHTML="<span>\u{1F6E0}\uFE0F</span> Dados T\xE9cnicos",n.appendChild(p);let d=s("cid","Ads CID","text","000-000-0000"),u=s("ga4","GA4 ID"),c=s("gtm","GTM ID"),m=i("access","Advertiser has access to GA4/GTM?"),T=s("access-email","If Yes, User Email"),f=i("ghost","Ghosting Access Available?");n.append(d.wrapper,u.wrapper,c.wrapper,m.wrapper,T.wrapper,f.wrapper);let h=document.createElement("div");h.style.cssText=o.sectionTitle,h.innerHTML="<span>\u{1F4DE}</span> Contato & Problema",n.appendChild(h);let E=s("name","Name of Advertiser"),D=s("url","Website Address"),B=s("phone","Phone Number"),oe=s("email","Email Address"),ne=s("callback","Preferred Call Back Time (w/ Timezone)"),S=s("desc","Detailed Issue Description","textarea","Descreva o problema t\xE9cnico em detalhes..."),C=s("checks","Checks Performed by Tech Team","textarea","Liste o troubleshooting j\xE1 realizado..."),q=s("screens","Uncropped Screenshots (Links)","textarea","https://...");n.append(E.wrapper,D.wrapper,B.wrapper,oe.wrapper,ne.wrapper,S.wrapper,C.wrapper,q.wrapper);let G=document.createElement("div");G.style.cssText=o.sectionTitle,G.innerHTML="<span>\u{1F4E7}</span> Contatos para C\xF3pia (CC)",n.appendChild(G);let M=s("c-adv","Advertiser Contact"),L=s("c-am","Account Manager");n.append(M.wrapper,L.wrapper);let O=document.createElement("div");O.style.cssText="padding: 16px 24px; background: rgba(255,255,255,0.9); backdrop-filter: blur(8px); border-top: 1px solid #E0E0E0; display: flex; justify-content: flex-end; position: absolute; bottom: 0; left: 0; width: 100%; box-sizing: border-box; z-index: 100;";let x=document.createElement("button");return x.textContent="Gerar Nota S&T",x.style.cssText="padding: 10px 24px; background: #1a73e8; color: #fff; border: none; border-radius: 24px; font-size: 14px; font-weight: 600; cursor: pointer; box-shadow: 0 2px 6px rgba(26, 115, 232, 0.3); transition: transform 0.1s, box-shadow 0.2s;",x.onmousedown=()=>{x.style.transform="scale(0.96)",x.style.boxShadow="0 1px 3px rgba(26, 115, 232, 0.2)"},x.onmouseup=()=>{x.style.transform="scale(1)",x.style.boxShadow="0 2px 6px rgba(26, 115, 232, 0.3)"},O.appendChild(x),t.appendChild(n),t.appendChild(O),r.onclick=async()=>{r.innerHTML='<span style="font-size:16px">\u23F3</span> Buscando...';let b=await it();b.advertiserName&&(E.input.value=b.advertiserName),b.websiteUrl&&(D.input.value=b.websiteUrl),b.clientEmail&&(oe.input.value=b.clientEmail,M.input.value=b.clientEmail);let l=document.body.innerText.match(/\d{3}-\d{3}-\d{4}/);l&&(d.input.value=l[0]),r.innerHTML='<span style="font-size:16px; color:#188038">\u2705</span> Dados Preenchidos!',r.style.background="#E6F4EA",r.style.borderColor="#188038",setTimeout(()=>{r.innerHTML='<span style="font-size:16px">\u2728</span> Preencher Automaticamente',r.style.background="#FFFFFF",r.style.borderColor="#DADCE0"},2e3),V("Dados capturados com sucesso!")},x.onclick=async()=>{let b=g=>{let A=t.querySelector(`#st-${g}`);return A?A.value:""},N=g=>{let A=t.querySelector(`input[name="st-${g}"]:checked`);return A?A.value:"N"},v=`Split & Transfer : Phone Note Format [Mandatory]

<b>Advertiser\u2019s info:</b>
<b>Ads CID:</b> ${b("cid")}
<b>GA4 ID:</b> ${b("ga4")}
<b>GTM ID:</b> ${b("gtm")}
<b>Advertiser has access to either GA4 or GTM (Y/N):</b> ${N("access")}
<b>If Yes, user access email to GA4/GTM:</b> ${b("access-email")}
<b>Ghosting Access Available (Y/N):</b> ${N("ghost")}
...
<b>Additional Comments:</b> (Optional)`.replace(/\n/g,"<br>");dt(v);let w=await Ct();w?(w.innerText.trim()===""&&(w.innerHTML=""),document.execCommand("insertHTML",!1,v),At(w),V("Nota S&T inserida!")):V("Copiado! Abra uma nota para colar.")},t}function Co(){let e="v3.7.0 (S&T Mode)",t="bau",n="pt",o=!1,s=!1,i=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},r=vo(),p=wo(()=>{let $=p.getCheckedElements().map(F=>F.value);g&&g.value&&r.updateVisibility(g.value,$)}),d=document.createElement("div");d.id="autofill-popup",d.classList.add("cw-module-window"),Object.assign(d.style,Te,{right:"100px",width:"450px",transition:"width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)"});let u={popup:d,googleLine:null},c=qe(d,"Case Notes",e,"Gera notas padronizadas.",u,()=>_t());d.appendChild(c);let m=c.lastElementChild;if(m){let y=document.createElement("div");y.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',Object.assign(y.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease",marginLeft:"4px"}),y.title="Alternar para Split & Transfer",y.onmouseenter=()=>{y.style.background="rgba(255,255,255,0.1)",y.style.color="#FFF"},y.onmouseleave=()=>{i||(y.style.background="transparent",y.style.color="#9AA0A6")},y.onclick=$=>{$.stopPropagation(),E(y)},m.insertBefore(y,m.firstChild)}let T=document.createElement("div");Object.assign(T.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),d.appendChild(T);let f=document.createElement("div");Object.assign(f.style,{flexGrow:"1",display:"none",overflow:"hidden"});let h=Ao(()=>E());f.appendChild(h),d.appendChild(f);function E(y){i=!i,i?(T.style.display="none",f.style.display="flex",u.googleLine&&(u.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)"),y&&(y.style.color="#C58AF9",y.style.background="rgba(197, 138, 249, 0.15)")):(T.style.display="block",f.style.display="none",u.googleLine&&(u.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"),y&&(y.style.color="#9AA0A6",y.style.background="transparent"))}let D=document.createElement("div");D.textContent="created by lucaste@",Object.assign(D.style,io),d.appendChild(D);let B=document.createElement("div");B.id="step-lang-type";let oe=document.createElement("label");Object.assign(oe.style,a.label),B.appendChild(oe);let ne=document.createElement("div");Object.assign(ne.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let S=document.createElement("div");S.textContent="Portugu\xEAs",S.classList.add("no-drag"),Object.assign(S.style,xe);let C=document.createElement("div");C.textContent="Espa\xF1ol",C.classList.add("no-drag"),Object.assign(C.style,xe),S.onclick=()=>kt("pt"),C.onclick=()=>kt("es"),ne.appendChild(S),ne.appendChild(C),B.appendChild(ne),T.appendChild(B);let q=document.createElement("div");q.id="step-0-case-type";let G=document.createElement("label");Object.assign(G.style,a.label),q.appendChild(G);let M=document.createElement("div");Object.assign(M.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let L=document.createElement("div");L.textContent="BAU",L.classList.add("no-drag"),Object.assign(L.style,xe);let O=document.createElement("div");O.textContent="LM",O.classList.add("no-drag"),Object.assign(O.style,xe),L.onclick=()=>Tt("bau"),O.onclick=()=>Tt("lm"),M.appendChild(L),M.appendChild(O),q.appendChild(M),T.appendChild(q);let x=document.createElement("div");x.id="step-1-selection";let b=document.createElement("label");b.className="cw-input-label",b.textContent="Status Principal";let N=document.createElement("select");N.id="main-status",N.className="cw-select",N.innerHTML=`
  ...
  `;let l=document.createElement("div");l.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let v=document.createElement("label");v.className="cw-input-label",v.textContent="Sub-status",v.style.marginBottom="0";let w=document.createElement("a");w.href="https://seu-link-do-guia-aqui.com",w.target="_blank",w.className="cw-info-link",w.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(w.style,a.helpLink),l.appendChild(v),l.appendChild(w);let g=document.createElement("select");g.id="sub-status",g.className="cw-select",g.disabled=!0,g.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',x.appendChild(b),x.appendChild(N),x.appendChild(l),x.appendChild(g),T.appendChild(x);let A=document.createElement("div");A.id="step-1-1-portugal",Object.assign(A.style,a.stepBlock,{display:"none"});let I=document.createElement("label");Object.assign(I.style,a.label),A.appendChild(I);let j=document.createElement("div");Object.assign(j.style,a.radioContainer);let R=document.createElement("div");Object.assign(R.style,{display:"flex",alignItems:"center"});let k=document.createElement("input");k.type="radio",k.name="portugal-group",k.value="sim",Object.assign(k.style,a.checkboxInput);let z=document.createElement("label");z.htmlFor="portugal-sim",Object.assign(z.style,{cursor:"pointer"}),R.appendChild(k),R.appendChild(z);let U=document.createElement("div");Object.assign(U.style,{display:"flex",alignItems:"center"});let _=document.createElement("input");_.type="radio",_.name="portugal-group",_.value="nao",_.checked=!0,Object.assign(_.style,a.checkboxInput);let H=document.createElement("label");H.htmlFor="portugal-nao",Object.assign(H.style,{cursor:"pointer"}),U.appendChild(_),U.appendChild(H),j.appendChild(R),j.appendChild(U),A.appendChild(j),T.appendChild(A);function de(y){o=y,y?ae.style.display="block":ae.style.display="none"}k.onchange=()=>de(!0),_.onchange=()=>de(!1);let ae=document.createElement("div");ae.id="step-1-2-consent",Object.assign(ae.style,a.stepBlock,{display:"none"});let ie=document.createElement("label");Object.assign(ie.style,a.label),ae.appendChild(ie);let ce=document.createElement("div");Object.assign(ce.style,a.radioContainer);let be=document.createElement("div");Object.assign(be.style,{display:"flex",alignItems:"center"});let Se=document.createElement("input");Se.type="radio",Se.name="consent-group",Se.value="Sim",Se.checked=!0,Object.assign(Se.style,a.checkboxInput);let Ne=document.createElement("label");Ne.htmlFor="consent-sim",Object.assign(Ne.style,{cursor:"pointer"}),be.appendChild(Se),be.appendChild(Ne);let tt=document.createElement("div");Object.assign(tt.style,{display:"flex",alignItems:"center"});let Re=document.createElement("input");Re.type="radio",Re.name="consent-group",Re.value="N\xE3o",Object.assign(Re.style,a.checkboxInput);let pt=document.createElement("label");pt.htmlFor="consent-nao",Object.assign(pt.style,{cursor:"pointer"}),tt.appendChild(Re),tt.appendChild(pt),ce.appendChild(be),ce.appendChild(tt),ae.appendChild(ce),T.appendChild(ae);let Pe=document.createElement("div");Pe.id="step-1-5-snippets",Object.assign(Pe.style,a.stepBlock,{display:"none"});let ut=document.createElement("h3");Object.assign(ut.style,a.h3),ut.textContent="Cen\xE1rios Comuns";let Ee=ho(y=>{let $=document.querySelector("textarea");$&&($.value=y,$.dispatchEvent(new Event("input")),$.style.transition="background-color 0.2s",$.style.backgroundColor="#e8f0fe",setTimeout(()=>$.style.backgroundColor="#fff",300))});Ee.id="snippet-container",Pe.appendChild(ut),Pe.appendChild(Ee),T.appendChild(Pe);let Ae=document.createElement("div");Ae.id="step-3-form",Object.assign(Ae.style,a.stepBlock,{display:"none"});let Et=document.createElement("h3");Object.assign(Et.style,a.h3),Ae.appendChild(Et);let De=document.createElement("div");De.id="dynamic-form-fields-container",Ae.appendChild(De);let fe=document.createElement("button");fe.textContent="+ Gostaria de selecionar uma task?",Object.assign(fe.style,a.optionalBtn),fe.onmouseover=()=>fe.style.background="#e8f0fe",fe.onmouseout=()=>fe.style.background="white",fe.onclick=()=>{fe.style.display="none",je.style.display="block",p.selectionElement.style.display="block"};let je=document.createElement("h3");Object.assign(je.style,a.h3,{marginTop:"20px"});let $t=p.selectionElement;Object.assign($t.style,{marginBottom:"20px"}),Ae.appendChild(fe),Ae.appendChild(je),Ae.appendChild($t),Ae.appendChild(r.element),Ae.appendChild(p.screenshotsElement),T.appendChild(Ae);let He=document.createElement("div");He.id="step-4-email",Object.assign(He.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ve=document.createElement("label");Ve.style.display="flex",Ve.style.alignItems="center",Ve.style.cursor="pointer",Ve.style.fontSize="14px";let $e=document.createElement("input");$e.type="checkbox",$e.checked=!0,Object.assign($e.style,a.checkboxInput),Ve.appendChild($e),Ve.appendChild(document.createTextNode("Preencher email automaticamente?")),He.appendChild(Ve),T.appendChild(He);let Qe=document.createElement("div");Object.assign(Qe.style,{display:"none",gap:"8px",padding:"0"}),T.appendChild(Qe);let ot=document.createElement("button");Object.assign(ot.style,a.buttonBase,{backgroundColor:"#5f6368"}),ot.textContent="Copiar";let nt=document.createElement("button");Object.assign(nt.style,a.buttonBase,{backgroundColor:"#1a73e8"}),nt.textContent="Preencher",Qe.appendChild(ot),Qe.appendChild(nt);let at=document.createElement("div");Object.assign(at.style,Ze),at.className="no-drag",at.title="Redimensionar",d.appendChild(at),Je(d,at),document.body.appendChild(d);function Tt(y){t=y;let $=st();Object.assign(L.style,xe),Object.assign(O.style,xe),y==="bau"?(Object.assign(L.style,$),w.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(O.style,$),w.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),g.value&&g.dispatchEvent(new Event("change"))}function Z(y){try{if(Le&&Le[n]&&Le[n][y])return Le[n][y];if(Le&&Le.pt&&Le.pt[y])return Le.pt[y]}catch{}return y}function Fo(){oe.textContent=Z("idioma"),G.textContent=Z("fluxo"),b.textContent=Z("status_principal"),v.textContent=Z("substatus"),ut.textContent=Z("cenarios_comuns"),je.textContent=Z("selecione_tasks"),Et.textContent=Z("preencha_detalhes"),ot.textContent=Z("copiar"),nt.textContent=Z("preencher"),N.querySelector('option[value=""]')&&(N.querySelector('option[value=""]').textContent=Z("select_status")),g.querySelector('option[value=""]')&&(g.querySelector('option[value=""]').textContent=Z("select_substatus")),I.textContent=Z("caso_portugal"),z.textContent=Z("sim"),H.textContent=Z("nao"),ie.textContent=Z("consentiu_gravacao"),Ne.textContent=Z("sim"),pt.textContent=Z("nao"),De.querySelectorAll("label").forEach(y=>{let $=y.nextElementSibling.id.replace("field-",""),F=Z($.toLowerCase());F!==$.toLowerCase()?y.textContent=F:y.textContent=$.replace(/_/g," ").replace(/\b\w/g,K=>K.toUpperCase())+":"}),fe.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function kt(y){n=y;let $=st();Object.assign(S.style,xe),Object.assign(C.style,xe),y==="pt"?(Object.assign(S.style,$),A.style.display="block",de(o)):(Object.assign(C.style,$),A.style.display="none",ae.style.display="none"),Fo(),g.value&&g.dispatchEvent(new Event("change"))}function Ot(y){(y.value.trim()===""||y.value.trim()==="\u2022")&&(y.value="\u2022 "),y.onkeydown=function($){if($.key==="Enter"){$.preventDefault();let F=this.selectionStart,K=this.selectionEnd,re=this.value,ue=re.lastIndexOf(`
`,F-1)+1,Ce=re.substring(ue,F),me=Ce.trim()==="\u2022"||Ce.trim()===""?`
`:`
\u2022 `;this.value=re.substring(0,F)+me+re.substring(K),this.selectionStart=this.selectionEnd=F+me.length}else if($.key==="Backspace"){let F=this.selectionStart;if(F===this.selectionEnd&&F>0){let K=this.value.substring(0,F);K.endsWith(`
\u2022 `)?($.preventDefault(),this.value=K.substring(0,F-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=F-3):K==="\u2022 "&&($.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function qt(){let y=typeof Ee<"u"?Ee:document.getElementById("snippet-container");if(!y)return;let $=y.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),F={},K=new Set;$.forEach(se=>{let te=se.id,W=ke[te];if(W)for(let P in W)P==="linkedTask"?K.add(W.linkedTask):P!=="type"&&(F[P]||(F[P]=[]),F[P].includes(W[P])||F[P].push(W[P]))});let re=new Set;Object.values(ke).forEach(se=>{Object.keys(se).forEach(te=>{te!=="linkedTask"&&te!=="type"&&re.add(te)})}),re.forEach(se=>{let te=document.getElementById(se);if(te){let W=F[se]||[],P="";ct.includes(se.replace("field-",""))?(P=W.map(ee=>ee.startsWith("\u2022 ")?ee:"\u2022 "+ee).join(`
`),P===""?P="\u2022 ":P.endsWith(`
\u2022 `)||(P+=`
\u2022 `)):P=W.join(`

`),P.trim()!=="\u2022"&&P.trim()!==""?te.value=P:ct.includes(se.replace("field-",""))?te.value="\u2022 ":te.value="",te.tagName==="TEXTAREA"&&typeof Ot=="function"&&Ot(te)}});let ue=new Set,Ce=new Set;y.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(se=>{let te=ke[se.id];te&&te.linkedTask&&(se.checked?ue.add(te.linkedTask):Ce.add(te.linkedTask))}),Ce.forEach(se=>{ue.has(se)||p.toggleTask(se,!1)}),ue.forEach(se=>{p.toggleTask(se,!0)})}N.onchange=()=>{let y=N.value;if(It(1.5),g.innerHTML=`<option value="">${Z("select_substatus")}</option>`,!y){g.disabled=!0;return}for(let $ in lt){let F=lt[$];if(F.status===y){let K=document.createElement("option");K.value=$,K.textContent=F.name,g.appendChild(K)}}g.disabled=!1},g.onchange=()=>{let y=g.value;if(It(1.5),!y)return;p.updateSubStatus(y);let $=lt[y];Ee.innerHTML="";let F=(W,P,ee)=>{let pe=document.createElement("label");Object.assign(pe.style,a.checkboxLabel),pe.onmouseover=()=>pe.style.backgroundColor="#e8eaed",pe.onmouseout=()=>pe.style.backgroundColor="#f8f9fa";let le=document.createElement("input");return le.type=P,le.id=W.id,Object.assign(le.style,a.checkboxInput),pe.appendChild(le),pe.appendChild(document.createTextNode(` ${W.text}`)),ee.appendChild(pe),le},K=[],re="radio";if(y==="NI_Awaiting_Inputs")K=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(y.startsWith("SO_"))re="checkbox",K=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"},{id:"quickfill-ga4-event-close",text:"Fechamento GA4 (P\xF3s 2 dias)"}];else if(y.startsWith("AS_")){re="checkbox";let W=document.createElement("label");W.textContent=Z("cenarios_comuns"),Object.assign(W.style,a.label),Ee.appendChild(W),K=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else y.startsWith("IN_")?K=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:y.startsWith("DC_")?(re="radio",K=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]):y==="NI_Attempted_Contact"?(re="radio",K=[{id:"quickfill-ni-attempted-2day",text:"2 Day Rule (2 Liga\xE7\xF5es + Chat AM)"}]):y==="NI_Awaiting_Validation"&&(re="checkbox",K=[{id:"quickfill-ni-awaiting-ecw4",text:"ECW4 (Acompanhar)"},{id:"quickfill-ni-awaiting-ga4",text:"GA4 Event Tracking (Acompanhar)"}]);let ue=K.filter(W=>{let P=ke[W.id];return!P.type||P.type==="all"||P.type===t});ue.forEach((W,P)=>{let ee=F(W,re,Ee);re==="radio"&&(ee.name="scenario-radio-group",P===0&&(ee.checked=!0))}),ue.length>0&&(Pe.style.display="block"),$.requiresTasks?(fe.style.display="none",je.style.display="block",p.selectionElement.style.display="block"):(fe.style.display="block",je.style.display="none",p.selectionElement.style.display="none"),De.innerHTML="";let Ce=$.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(Ce)].forEach(W=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(W))return;let P=W.slice(1,-1),ee=document.createElement("label"),pe=Z(P.toLowerCase());if(ee.textContent=pe!==P.toLowerCase()?pe:P.replace(/_/g," ").replace(/\b\w/g,Q=>Q.toUpperCase())+":",Object.assign(ee.style,a.label),P==="SPEAKEASY_ID"){let Q=document.createElement("button");Q.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',Q.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,Q.title="Localizar Speakeasy ID no hist\xF3rico",Q.onmouseover=()=>{Q.style.backgroundColor="#c2e7ff",Q.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},Q.onmouseout=()=>{Q.style.backgroundColor="#d3e3fd",Q.style.boxShadow="none"},Q.onmousedown=()=>{Q.style.backgroundColor="#a8c7fa",Q.style.transform="scale(0.96)"},Q.onmouseup=()=>Q.style.transform="scale(1)",Q.onclick=he=>{he.preventDefault(),co(`field-${P}`)},ee.appendChild(Q)}let le;ct.includes(P)?(le=document.createElement("textarea"),Object.assign(le.style,a.textarea),le.classList.add("bullet-textarea"),Ot(le)):Dt.includes(P)?(le=document.createElement("textarea"),Object.assign(le.style,a.textarea)):(le=document.createElement("input"),le.type="text",Object.assign(le.style,a.input),P==="REASON_COMMENTS"&&(y.startsWith("NI_")||y.startsWith("IN_"))&&(Object.assign(ee.style,{display:"none"}),Object.assign(le.style,{display:"none"}))),P==="ON_CALL"&&t==="lm"&&(Object.assign(ee.style,{display:"none"}),Object.assign(le.style,{display:"none"}),le.value="N/A"),le.id=`field-${P}`,De.appendChild(ee),De.appendChild(le)});let se=Ee.querySelectorAll('input[type="checkbox"], input[type="radio"]');se.length>0&&(se.forEach(W=>{W.removeEventListener("change",qt),W.addEventListener("change",qt)}),qt()),Ae.style.display="block",Ye[y]?He.style.display="block":He.style.display="none",Qe.style.display="flex";let te=p.getCheckedElements().map(W=>W.value);r.updateVisibility(y,te)},fe.onclick=()=>{fe.style.display="none",je.style.display="block",p.selectionElement.style.display="block"};function Ut(){let y=g.value;if(!y)return null;let F=lt[y].template.replace(/\n/g,"<br>"),K='style="margin-bottom: 12px; padding-left: 30px;"',re=[],ue="",Ce=p.getCheckedElements();Ce.length>0&&Ce.forEach(te=>{let W=te.value,P=Ge[W],ee=te.closest().querySelector(".stepper-count"),pe=ee?parseInt(ee.textContent):1;pe>1?re.push(`${P.name} (x${pe})`):re.push(P.name)});let me=p.screenshotsElement;if(me){let te=Array.from(me.querySelectorAll('input[id^="name-"]'));te.length>0&&te.forEach(W=>{let P=W.value,ee=W.closest(".cw-screen-card");if(ee){let pe=ee.querySelectorAll('input[id^="screen-"]'),le=!1,Q="";pe.forEach(he=>{let Wt=he.closest(".cw-input-group"),Yt=Wt?Wt.querySelector(".cw-input-label"):null,Mo=Yt?Yt.textContent:"Evid\xEAncia",Xt=he.value.trim(),Lo=Xt?` ${Xt}`:"";Q+=`<li>${Mo} -${Lo}</li>`,le=!0}),le&&(ue+=`<b>${P}</b>`,ue+=`<ul ${K}>${Q}</ul>`)}})}if(F.includes("{TAGS_IMPLEMENTED}")?F=F.replace(/{TAGS_IMPLEMENTED}/g,re.join(", ")||"N/A"):re.length>0&&(F+=`<br><b>Tags:</b> ${re.join(", ")}<br>`),F.includes("{SCREENSHOTS_LIST}")?F=F.replace(/{SCREENSHOTS_LIST}/g,ue?`${ue}`:"N/A"):ue!==""&&(F+=`<br>${ue}`),n==="pt"&&o){let te=Se.checked?Z("sim"):Z("nao");F=F.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${Z("consentiu_gravacao")}</b> ${te}<br><br>`),F=F.replace(/{CASO_PORTUGAL}/g,`<br><b>${Z("caso_portugal")}</b> ${Z("sim")}<br>`)}else n==="pt"&&!o?(F=F.replace(/{CASO_PORTUGAL}/g,`<br><b>${Z("caso_portugal")}</b> ${Z("nao")}<br>`),F=F.replace(/{CONSENTIU_GRAVACAO}/g,"")):(F=F.replace(/{CASO_PORTUGAL}/g,""),F=F.replace(/{CONSENTIU_GRAVACAO}/g,""));return De.querySelectorAll("input, textarea").forEach(te=>{let W=te.id.replace("field-",""),P=new RegExp(`{${W}}`,"g"),ee=te.value;if(W==="REASON_COMMENTS"&&(y.startsWith("NI_")||y.startsWith("IN_"))){let Q=Ee.querySelector('input[type="radio"]:checked');Q&&ke[Q.id]&&(ee=ke[Q.id]["field-REASON_COMMENTS"])}if(ct.includes(W)&&ee.trim()!==""){let Q=ee.split(`
`).map(he=>he.trim()).filter(he=>he!==""&&he!=="\u2022").map(he=>he.startsWith("\u2022 ")?he.substring(2):he).map(he=>`<li>${he}</li>`).join("");ee=Q?`<ul ${K}>${Q}</ul>`:""}else Dt.includes(W)?ee=ee.split(`
`).filter(Q=>Q.trim()!=="").map(Q=>`<p style="margin: 0 0 8px 0;">${Q}</p>`).join(""):te.tagName==="TEXTAREA"&&(ee=ee.replace(/\n/g,"<br>"));let pe=ee.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(pe===""||pe==="\u2022"||pe.toLowerCase()==="n/a"){let Q=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${W}\\}(?:<br>\\s*)?`,"gi");Q.test(F)?F=F.replace(Q,""):F=F.replace(P,"")}else F=F.replace(P,ee.replace(/\$/g,"$$$$"))}),F=F.replace(/{([A-Z0-9_]+)}/g,""),F=F.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(F+=r.getOutput()),F}ot.onclick=()=>{let y=Ut();y?(dt(y),V(Z("copiado_sucesso"))):V(Z("selecione_substatus"),{error:!0})},nt.onclick=async()=>{let y=g.value,$=Ut();if(!$){V(Z("selecione_substatus"),{error:!0});return}dt($),_t();let F=vt(),K=await Ct();if(K)try{if(K.focus(),K.innerHTML.trim()==="<p><br></p>"||K.innerHTML.trim()==="<br>"||K.innerText.trim()===""){let me=document.createRange();me.selectNodeContents(K);let se=window.getSelection();se.removeAllRanges(),se.addRange(me),document.execCommand("delete",!1,null)}else if(!K.innerHTML.endsWith("<br><br>")){let me=document.createRange();me.selectNodeContents(K),me.collapse(!1);let se=window.getSelection();se.removeAllRanges(),se.addRange(me),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,$),At(K),setTimeout(()=>{V(Z("inserido_copiado"))},600);let ue=typeof $e<"u"&&$e?$e.checked:!0;if(y&&Ye[y]&&ue){let me=Ye[y];await xt(me),await new Promise(se=>setTimeout(se,500))}F(),It(1.5),N.value="",g.innerHTML=`<option value="">${Z("select_substatus")}</option>`,g.disabled=!0}catch(re){console.error(re),V("Erro ao inserir.",{error:!0}),F()}};function It(y=1.5){y<=1.5&&(Pe.style.display="none",Ee.innerHTML=""),y<=2&&(p.reset(),fe.style.display="none"),y<=3&&(Ae.style.display="none",De.innerHTML="",r.reset(),Qe.style.display="none",He.style.display="none")}function _t(){if(s=!s,s){let y=d.querySelector(".cw-expand-btn");y&&typeof y.resetState=="function"&&y.resetState()}Ie(s,d,"cw-btn-notes")}return Tt("bau"),kt("pt"),_t}var Ke={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
        ...
        `;let k=b.querySelector("#csa-back-btn");k.onmouseenter=()=>k.style.background="#f1f3f4",k.onmouseleave=()=>k.style.background="none",k.onclick=v;let z=b.querySelector("#csa-insert-btn");z.onmouseenter=()=>{z.style.transform="translateY(-1px)",z.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},z.onmouseleave=()=>{z.style.transform="translateY(0)",z.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},z.onclick=()=>{z.style.transform="scale(0.96)",N(I,"email"),setTimeout(()=>{z.style.transform="scale(1)",v()},300)}}function v(){s="list",C.style.transform="translateX(0)"}function w(I,j,R=null){let k=document.createElement("button"),z=R?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${R}</span>`:"";return k.innerHTML=`${z}${I}`,Object.assign(k.style,T),n===j&&o===""?Object.assign(k.style,f):(k.onmouseenter=()=>{k.style.background="#F1F3F4",k.style.borderColor="#DADCE0"},k.onmouseleave=()=>{k.style.background="#FFFFFF",k.style.borderColor="#DADCE0"}),k.onclick=()=>{n=j,o="",M.value="",g(),A()},k}function g(){L.innerHTML="",L.appendChild(w("Smart CRs",t,"\u26A1")),Object.keys(Ke).forEach(I=>{L.appendChild(w(Ke[I].title,I))})}function A(){O.innerHTML="";let I=[];if(o.trim()!==""){let U=o.toLowerCase();Object.values(Ke).forEach(_=>{_.emails.forEach(H=>{(H.name.toLowerCase().includes(U)||H.subject.toLowerCase().includes(U))&&I.push({type:"email",data:H})})}),Object.entries(Ye).forEach(([_,H])=>{if(!H)return;(_.replace(/_/g," ").toLowerCase().includes(U)||H.toLowerCase().includes(U))&&I.push({type:"cr",key:_,code:H})})}else n===t?Object.entries(Ye).forEach(([U,_])=>{_&&I.push({type:"cr",key:U,code:_})}):Ke[n]&&Ke[n].emails.forEach(U=>{I.push({type:"email",data:U})});if(I.length===0){O.innerHTML=`
                ...
                </div>`;return}let R='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1967D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',k='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA8600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BDC1C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';I.forEach(U=>{let _=document.createElement("div");if(Object.assign(_.style,E),U.type==="email"){let H=U.data,de=H.subject.length>45?H.subject.substring(0,45)+"...":H.subject;_.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function To(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Te,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function p(){i=!i,Ie(i,a,"cw-btn-script")}let d=qe(a,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{p()});a.appendChild(d);let u=document.createElement("div");Object.assign(u.style,t.progressBarContainer);let c=document.createElement("div");Object.assign(c.style,t.progressBarFill),u.appendChild(c),a.appendChild(u);let m=document.createElement("div");m.id="csa-content",Object.assign(m.style,t.contentArea),a.appendChild(m);let T=document.createElement("div");Object.assign(T.style,t.footer);let f=document.createElement("span");f.textContent="by lucaste@",Object.assign(f.style,{fontSize:"10px",color:"#bdc1c6"});let h=document.createElement("button");h.innerHTML=`
  ...
  `;let T=document.createElement("div");T.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#5F6368" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',T.style.cssText="margin-left: 12px; display: flex; align-items: center; justify-content: center; pointer-events: none;";let f=document.createElement("input");f.type="text",f.placeholder="Buscar link, SOP ou ferramenta...",f.style.cssText=`
      flex: 1; height: 100%; border: none; background: transparent;
      padding: 0 12px; font-size: 14px; color: ${s.textPrimary};
      outline: none; box-sizing: border-box; font-family: 'Google Sans', Roboto, sans-serif;
  `,f.onfocus=()=>{m.style.background="#FFF",m.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)",m.style.borderColor=s.primary},f.onblur=()=>{m.style.background="#F1F3F4",m.style.boxShadow="none",m.style.borderColor=s.borderSubtle},m.appendChild(T),m.appendChild(f),c.appendChild(m),u.appendChild(c);let h=document.createElement("div");h.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",u.appendChild(h);let E=null;function D(){if(E)return;E=document.createElement("div"),E.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let O=document.createElement("div");O.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",O.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Hist\xF3rico Recente</span>';let x=document.createElement("button");x.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',x.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",x.onclick=oe,O.appendChild(x),E.appendChild(O);let b=document.createElement("div");b.id="cw-history-list",b.style.cssText="flex: 1; overflow-y: auto; padding: 20px;",E.appendChild(b),u.appendChild(E)}function B(){E||D();let O=E.querySelector("#cw-history-list");O.innerHTML="";let x=Yo();x.length===0?O.innerHTML='<div style="text-align: center; color: #999; margin-top: 40px;">Nenhum link acessado recentemente.</div>':x.forEach(b=>{let N=M(b,ze[b._originalCat],!0);O.appendChild(N)}),requestAnimationFrame(()=>{E.style.transform="translateY(0)"})}function oe(){E&&(E.style.transform="translateY(100%)")}function ne(){d.innerHTML="";let O=S("history","Recentes",ze.history);O.onclick=()=>{Y.playClick(),B()};let x=document.createElement("div");x.style.cssText="width: 40px; height: 1px; background: rgba(0,0,0,0.06); margin: 8px 0;",d.appendChild(O),d.appendChild(x),Object.keys(St).forEach(b=>{let N=St[b],l=S(b,N.label,ze[b]);l.onclick=()=>{Y.playClick(),C(b)},d.appendChild(l)})}function S(O,x,b){let N=document.createElement("div");N.style.cssText=`
          width: 64px; height: 56px; border-radius: 12px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${s.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          margin-bottom: 4px; position: relative;
      `,N.title=x,N.dataset.key=O;let l=document.createElement("div");l.style.cssText="width: 24px; height: 24px; margin-bottom: 4px; transition: transform 0.2s;",l.innerHTML=b||ze.tasks;let v=document.createElement("div");return v.style.cssText="font-size: 10px; font-weight: 500; opacity: 0.8;",v.textContent=x,N.appendChild(l),N.appendChild(v),N.onmouseenter=()=>{o!==O&&(N.style.background="rgba(0,0,0,0.04)",l.style.transform="scale(1.1)")},N.onmouseleave=()=>{o!==O&&(N.style.background="transparent",l.style.transform="scale(1)")},N}function C(O){let x=document.getElementById(`cat-anchor-${O}`);x&&(x.scrollIntoView({behavior:"smooth",block:"start"}),q(O))}function q(O){o=O,Array.from(d.children).forEach(x=>{if(!x.dataset.key)return;let b=x.querySelector("div:first-child");x.dataset.key===O?(x.style.background="#E8F0FE",x.style.color="#1967D2",x.style.fontWeight="600",b&&(b.style.transform="scale(1.1)")):(x.style.background="transparent",x.style.color=s.textSecondary,x.style.fontWeight="500",b&&(b.style.transform="scale(1)"))})}function G(){if(h.innerHTML="",t.trim()!==""){let x=[];if(Object.entries(St).forEach(([N,l])=>{let v=l.links.filter(w=>w.name.toLowerCase().includes(t.toLowerCase())||w.desc.toLowerCase().includes(t.toLowerCase()));x.push(...v.map(w=>({...w,_cat:N})))}),x.length===0){h.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nenhum link encontrado.</div>';return}let b=document.createElement("div");b.innerHTML="Resultados da busca",b.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase;",h.appendChild(b),x.forEach(N=>{let l=M(N,ze[N._cat],!1);h.appendChild(l)});return}Object.entries(St).forEach(([x,b])=>{let N=document.createElement("div"),l=document.createElement("div");l.id=`cat-anchor-${x}`,l.innerHTML=`<span style="opacity:0.6; margin-right:8px;">${ze[x]}</span> ${b.label}`,l.style.cssText=`
              display: flex; align-items: center;
              font-size: 12px; font-weight: 700; color: #1a73e8; 
              text-transform: uppercase; margin: 32px 0 12px 0;
              padding-top: 10px;
          `,N.appendChild(l),b.links.forEach(v=>{let w=M(v,ze[x],!1,x);N.appendChild(w)}),h.appendChild(N)});let O=document.createElement("div");O.style.height="60px",h.appendChild(O)}function M(O,x,b,N){let l=document.createElement("div"),v=b?"#FFF8E1":"#FFFFFF",w=b?"1px solid #FFE082":"1px solid rgba(0,0,0,0.08)";l.style.cssText=`
      ...
      `;let g=document.createElement("div");g.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,b&&(g.style.background="#FFFFFF"),g.innerHTML=x||ze.tasks;let A=g.querySelector("svg");A&&(A.style.width="20px",A.style.height="20px");let I=document.createElement("div");I.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let j=document.createElement("div");j.style.cssText=`font-size: 13px; font-weight: 600; color: ${s.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,j.textContent=O.name;let R=document.createElement("div");R.style.cssText=`font-size: 11px; color: ${s.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,R.textContent=O.desc,I.appendChild(j),I.appendChild(R);let k=document.createElement("div");return k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',k.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0.6;
      `,k.title="Copiar URL",l.onmouseenter=()=>{l.style.transform="translateY(-2px)",l.style.boxShadow="0 4px 12px rgba(0,0,0,0.08)",g.style.background=s.primaryBg,g.style.color=s.primary,k.style.opacity="1",k.style.color=s.primary,k.style.background="#F1F3F4"},l.onmouseleave=()=>{l.style.transform="translateY(0)",l.style.boxShadow="0 1px 2px rgba(0,0,0,0.04)",g.style.background=b?"#FFFFFF":"#F1F3F4",g.style.color=s.textSecondary,k.style.opacity="0.6",k.style.color="#9AA0A6",k.style.background="transparent"},l.onclick=()=>{!b&&N&&ko(O,N),window.open(O.url,"_blank")},k.onclick=z=>{z.stopPropagation(),Y.playClick(),navigator.clipboard.writeText(O.url),!b&&N&&ko(O,N),V("Link copiado!")},l.appendChild(g),l.appendChild(I),l.appendChild(k),l}f.addEventListener("input",O=>{t=O.target.value,G()});function L(){n=!n,Ie(n,i,"cw-btn-links")}return document.body.appendChild(i),ne(),G(),L}var Be=[];function Vt(e){Be=e}var Xo=["lucaste"],Ko=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function qo(){let e="v4.9 (High Contrast UI)",t=!1,n=null,o=null;function s(l){if(!l)return"";try{let v=new Date(l);return isNaN(v.getTime())?String(l):v.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(l)}}if(!document.getElementById("cw-broadcast-hd-css")){let l=document.createElement("style");l.id="cw-broadcast-hd-css",l.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,f.querySelectorAll('input[name="cw-bc-type"]').forEach(g=>{g.addEventListener("change",()=>{f.querySelectorAll(".cw-radio-option").forEach(A=>A.classList.remove("checked")),g.parentElement.classList.add("checked")})}),setTimeout(()=>{let g=f.querySelector(".cw-radio-option.info");g&&g.classList.add("checked")},100);let l=f.querySelector("#cw-bc-cancel"),v=f.querySelector("#cw-bc-close-x"),w=f.querySelector("#cw-bc-send");l.onclick=oe,v.onclick=oe,w.onclick=ne,d.appendChild(f)}function B(l=null){if(!f)return;let v=f.querySelector("#cw-editor-title-label"),w=f.querySelector("#cw-bc-title"),g=f.querySelector("#cw-bc-text"),A=f.querySelector("#cw-bc-send");if(l){o=l.id,v.textContent="Editar Aviso",w.value=l.title||"",g.value=l.text||"",A.textContent="Salvar Altera\xE7\xF5es";let I=l.type||"info",j=f.querySelector(`input[name="cw-bc-type"][value="${I}"]`);j&&j.click()}else{o=null,v.textContent="Novo Aviso",w.value="",g.value="",A.textContent="Publicar";let I=f.querySelector('input[name="cw-bc-type"][value="info"]');I&&I.click()}f.classList.add("active"),setTimeout(()=>w.focus(),300)}function oe(){f&&f.classList.remove("active"),o=null}async function ne(){let l=f.querySelector("#cw-bc-send"),v=f.querySelector("#cw-bc-title"),w=f.querySelector("#cw-bc-text"),g=f.querySelector('input[name="cw-bc-type"]:checked'),A=g?g.value:"info";if(!v.value.trim()||!w.value.trim()){V("Preencha todos os campos!",{error:!0});return}l.textContent="Salvando...",l.style.opacity="0.7";let I=!1;o?I=await ve.updateBroadcast(o,{title:v.value,text:w.value,type:A}):I=await ve.sendBroadcast({title:v.value,text:w.value,type:A,author:window._cwCurrentUser||"admin"}),I?(V(o?"Atualizado!":"Publicado!"),Y.playSuccess(),oe(),setTimeout(()=>q(),1500)):(V("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),l.textContent=o?"Salvar Altera\xE7\xF5es":"Publicar",l.style.opacity="1")}async function S(l){if(confirm("Confirma a exclus\xE3o deste aviso?"))if(await ve.deleteBroadcast(l)){V("Aviso removido."),Y.playClick();let w=Be.findIndex(g=>g.id===l);w>-1&&Be.splice(w,1),M(),setTimeout(()=>q(),1500)}else V("Erro ao excluir.",{error:!0})}let C=document.createElement("div");C.className="cw-nice-scroll",Object.assign(C.style,i.feedContainer),d.appendChild(C);async function q(){t&&(E.style.display="block",E.innerHTML="\u{1F504} Sincronizando...");try{let l=await ve.fetchData();l&&l.broadcast&&(Vt(l.broadcast),G(),t&&(M(),E.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{E.style.display="none"},1500)))}catch{t&&(E.innerHTML="\u26A0\uFE0F Offline")}}function G(){let l=document.getElementById("cw-btn-broadcast");if(!l)return;let v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Be.some(g=>!v.includes(g.id))){if(l.classList.add("has-new"),!l.querySelector(".cw-badge")){let g=document.createElement("div");g.className="cw-badge",Object.assign(g.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),l.appendChild(g)}}else{l.classList.remove("has-new");let g=l.querySelector(".cw-badge");g&&g.remove()}}function M(){C.innerHTML="";let l=d.querySelector("#cw-bau-widget");l&&l.remove();let v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),w=[...Be].sort((R,k)=>{let z=new Date(R.date).getTime()||0;return(new Date(k.date).getTime()||0)-z}),g=w.findIndex(R=>R.title&&R.title.toLowerCase().includes("disponibilidade bau"));if(g!==-1){let R=w[g];w.splice(g,1);let k=document.createElement("div");k.id="cw-bau-widget",Object.assign(k.style,i.bauContainer);let z=[],U=(R.text||"").split(`
`),_=/\d{1,2}\/\d{1,2}/;if(U.forEach(ce=>{let be=ce.match(_);if(be){let Se=be[0],Ne="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(ce)?Ne="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(ce)&&(Ne="\u{1F1EA}\u{1F1F8}"),z.some(Re=>Re.flag===Ne&&Re.date===Se)||z.push({flag:Ne,date:Se})}}),z.length===0){let ce=(R.text||"").match(/\d{1,2}\/\d{1,2}/g);ce&&[...new Set(ce)].forEach(be=>z.push({flag:"\u{1F4C5}",date:be}))}let H="",de='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(de=`
              ...
              `),z.length>0?H=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${z.map(be=>`
                  <div style="${r(i.bauSlotRow)}; margin-bottom:0; flex:1; justify-content:center;">
                      <span style="${r(i.bauFlag)}">${be.flag}</span>
                      <span style="${r(i.bauDate)}">${be.date}</span>
                  </div>
              `).join("")}</div>

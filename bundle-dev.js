(()=>{var nt="",Gt=e=>new Promise(t=>setTimeout(t,e));async function zt(){if(nt)return nt;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await Gt(100);let t="Consultor",a=document.querySelector("profile-details .name");if(a)t=a.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let r=o.src.match(/\/photos\/([^\?]+)/)[1];t=r.charAt(0).toUpperCase()+r.slice(1)}}return e.click(),document.body.click(),nt=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function vt(){return nt||"Consultor"}function Bt(e){let t=new Date,a=t.getHours(),o=t.getDay(),r="Ol\xE1",n="";a>=5&&a<12?(r="Bom dia",n='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):a>=12&&a<18?(r="Boa tarde",n='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(r="Boa noite",n='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let i=[];a>=0&&a<5?i=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:a<12?o===1?i=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?i=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:i=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:a<18?i=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:i=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(i=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let l=i[Math.floor(Math.random()*i.length)];return{prefix:`${r},`,name:e,suffix:l,icon:n,isFriday:o===5}}async function So(){try{let t=document.evaluate("//div[contains(@class, 'form-label') and contains(text(), 'Contact email')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(!t)return null;let a=t.parentElement,o=a.querySelector(".unmask-button")||a.querySelector('[aria-label="Click to view"]');o&&(o.click(),await Gt(500));let n=Array.from(a.querySelectorAll("a, span, div, pii-value")).find(i=>{let l=i.innerText.trim();return l.includes("@")&&!l.includes("Is this:")&&l.toLowerCase()!=="email"});return n?n.innerText.trim():null}catch(e){return console.warn("Erro ao capturar email do cliente:",e),null}}function Co(){try{let e=document.querySelector('material-input[debug-id="account-id-input"]');if(e){let t=e.querySelector("input");if(t){let a=t.value.trim();if(a)return a.includes("@")?a:`${a}@google.com`}}}catch(e){console.warn("Erro ao capturar email interno:",e)}return null}async function At(){let e="Cliente",t="[INSERIR URL]";try{let n=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(n&&n.nextElementSibling){let i=n.nextElementSibling.innerText.trim();i&&(e=i)}}catch(r){console.warn("Falha Nome:",r)}try{let n=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(n&&n.nextElementSibling){let i=n.nextElementSibling.innerText.trim();i&&(t=i)}}catch(r){console.warn("Falha URL:",r)}let a=await So(),o=Co();return{advertiserName:e,websiteUrl:t,clientEmail:a,internalEmail:o,agentName:vt()}}var je=null,wt=null,qe=.3;function Be(){if(!je){let e=window.AudioContext||window.webkitAudioContext;e&&(je=new e)}return je&&je.state==="suspended"&&je.resume(),je}function jt(e){if(wt)return wt;let t=e.sampleRate*2,a=e.createBuffer(1,t,e.sampleRate),o=a.getChannelData(0);for(let r=0;r<t;r++)o[r]=Math.random()*2-1;return wt=a,a}var Z={playClick:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createBufferSource();a.buffer=jt(e);let o=e.createBiquadFilter();o.type="highpass",o.frequency.value=4e3;let r=e.createGain();r.gain.setValueAtTime(qe*.8,t),r.gain.exponentialRampToValueAtTime(.001,t+.015),a.connect(o),o.connect(r),r.connect(e.destination),a.start(t),a.stop(t+.02)},playHover:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createOscillator();a.type="sine",a.frequency.setValueAtTime(400,t);let o=e.createGain();o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(qe*.1,t+.005),o.gain.linearRampToValueAtTime(0,t+.02),a.connect(o),o.connect(e.destination),a.start(t),a.stop(t+.03)},playSuccess:()=>{let e=Be();if(!e)return;let t=e.currentTime;[1046.5,1567.9].forEach((o,r)=>{let n=e.createOscillator(),i=e.createGain();n.type="sine",n.frequency.value=o,i.gain.setValueAtTime(0,t),i.gain.linearRampToValueAtTime(qe*.6,t+.05),i.gain.exponentialRampToValueAtTime(.001,t+.6),n.connect(i),i.connect(e.destination),n.start(t),n.stop(t+.7)})},playGenieOpen:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createBufferSource();a.buffer=jt(e);let o=e.createBiquadFilter();o.type="lowpass",o.frequency.setValueAtTime(100,t),o.frequency.exponentialRampToValueAtTime(800,t+.2);let r=e.createGain();r.gain.setValueAtTime(0,t),r.gain.linearRampToValueAtTime(qe*.5,t+.05),r.gain.linearRampToValueAtTime(0,t+.25),a.connect(o),o.connect(r),r.connect(e.destination),a.start(t),a.stop(t+.3)},playError:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createOscillator(),o=e.createGain();a.type="triangle",a.frequency.setValueAtTime(120,t),a.frequency.exponentialRampToValueAtTime(80,t+.1),o.gain.setValueAtTime(qe,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),a.connect(o),o.connect(e.destination),a.start(t),a.stop(t+.2)},playStartup:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=.12,o=e.createOscillator(),r=e.createGain(),n=e.createBiquadFilter();o.type="square",o.frequency.setValueAtTime(400,t),o.frequency.exponentialRampToValueAtTime(50,t+.1),n.type="lowpass",n.frequency.setValueAtTime(800,t),n.frequency.exponentialRampToValueAtTime(100,t+.1),r.gain.setValueAtTime(qe*4,t),r.gain.exponentialRampToValueAtTime(.001,t+.1),o.connect(n),n.connect(r),r.connect(e.destination),o.start(t),o.stop(t+.12);let i=e.createOscillator(),l=e.createGain();i.type="sine",i.frequency.setValueAtTime(150,t),i.frequency.exponentialRampToValueAtTime(50,t+.15),l.gain.setValueAtTime(qe*1.5,t),l.gain.exponentialRampToValueAtTime(.001,t+.15),i.connect(l),l.connect(e.destination),i.start(t),i.stop(t+.15),[55,55.4,110.5].forEach(p=>{let h=e.createOscillator(),u=e.createGain(),f=e.createBiquadFilter();h.type="sawtooth",h.frequency.value=p,f.type="lowpass",f.frequency.setValueAtTime(30,t),f.frequency.linearRampToValueAtTime(900,t+a+.2),f.frequency.exponentialRampToValueAtTime(40,t+3),u.gain.setValueAtTime(0,t),u.gain.linearRampToValueAtTime(qe*.6,t+a+.1),u.gain.exponentialRampToValueAtTime(.001,t+3.5),h.connect(f),f.connect(u),u.connect(e.destination),h.start(t),h.stop(t+3.6)})},playNotification:()=>{let e=Be();if(!e)return;let t=e.currentTime;[{freq:880,dur:1.2,vol:.6},{freq:1760,dur:.6,vol:.3}].forEach(o=>{let r=e.createOscillator(),n=e.createGain();r.type="sine",r.frequency.setValueAtTime(o.freq,t),n.gain.setValueAtTime(0,t),n.gain.linearRampToValueAtTime(qe*o.vol,t+.004),n.gain.exponentialRampToValueAtTime(.001,t+o.dur),r.connect(n),n.connect(e.destination),r.start(t),r.stop(t+o.dur+.1)})},playSwoosh:()=>{Z.playGenieOpen()},playReset:()=>{Z.playError()},initGlobalListeners:()=>{if(window._cwSoundListenersActive)return;window._cwSoundListenersActive=!0;let e=0,t=50;document.addEventListener("mouseover",a=>{if(!je)return;let o=a.target.closest('button, a, input[type="checkbox"], .cw-btn, .cw-hero-card, .cw-task-item, [data-sound="hover"]');if(!o||o.contains(a.relatedTarget))return;let r=Date.now();r-e<t||(Z.playHover(),e=r)},{passive:!0})}};var Pt=1e4;function Vt(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
        :root {
            --cw-primary: #1a73e8;
...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ct={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ut={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Wt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var ge={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var St=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Ht=-1;function Je(){let e=Math.floor(Math.random()*St.length);return e===Ht&&(e=(e+1)%St.length),Ht=e,St[e]}var Ie=e=>new Promise(t=>setTimeout(t,e));async function Eo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let a=e.querySelector(".cursor");await Ie(200);for(let o=0;o<t.length;o++){let r=t.charAt(o),n=document.createElement("span");n.textContent=r,a&&a.parentNode===e?a.before(n):e.appendChild(n);let i=Math.floor(Math.random()*60)+30;o===0&&(i=150),o>t.length-3&&(i=30),await Ie(i)}await Ie(600),a&&(a.style.display="none")}async function Et(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await Ie(200);let t=await zt(),a=Bt(t),o=e.querySelector("#w-icon"),r=e.querySelector("#p1"),n=e.querySelector("#p2"),i=e.querySelector("#p3"),l=e.querySelector("#p-sextou");o&&(o.innerHTML=a.icon),r&&(r.textContent=a.prefix),i&&(i.textContent=a.suffix),await Ie(300);let b=o?o.querySelector("svg"):null;if(b&&(b.style.opacity="1",b.style.transform="scale(1)"),await Ie(400),r&&(r.style.opacity="1"),Z.playStartup(),n&&await Eo(n,a.name),i&&(i.style.opacity="1",i.style.transform="translateY(0)"),a.isFriday&&l){await Ie(400),l.style.display="block",l.offsetWidth;let p=l.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await Ie(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await Ie(900),e.parentNode&&e.parentNode.removeChild(e)}}var Ye={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Xe(e,t){t.onmousedown=a;function a(o){o.stopPropagation(),o.preventDefault();let r=e.style.transition;e.style.transition="none";let n=o.clientX,i=o.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),b=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),p=n,h=i,u=!1;function f(A){p=A.clientX,h=A.clientY,u||(window.requestAnimationFrame(()=>{_(),u=!1}),u=!0)}function _(){let A=l+(p-n),O=b+(h-i);A>360&&(e.style.width=A+"px"),O>300&&(e.style.height=O+"px")}function v(){document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",v),setTimeout(()=>{e.style.transition=r},50)}document.addEventListener("mousemove",f),document.addEventListener("mouseup",v)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function Yt(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,a=>t[a]?t[a]:"")}var et=e=>new Promise(t=>setTimeout(t,e));function it(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}var Xt="cw-automation-styles";if(!document.getElementById(Xt)){let e=document.createElement("style");e.id=Xt,e.innerHTML=`
...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var de=e=>new Promise(t=>setTimeout(t,e));function be(e,t="info"){let a={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,a[t]||a.info)}function Se(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(a=>e.dispatchEvent(new MouseEvent(a,t)))}function st(e,t){if(!e)return;let a=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(a);o&&o.remove();let r=e.getBoundingClientRect(),n=document.createElement("div");n.id=a,n.style.cssText=`
        position: fixed;
        top: ${r.bottom+8}px;
        left: ${r.left}px;
        min-width: 300px;
    ...
    `,n.innerHTML=`
        ...
        ">\xD7</div>
    `;let i=n.querySelector(".cw-close-btn");i.onclick=()=>{n.style.opacity="0",n.style.transform="translateY(-5px)",setTimeout(()=>n.remove(),300)},document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(n)&&i.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await de(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await de(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(a=>{let o=a.offsetParent!==null,r=a.closest("case-message-view")!==null,n=a.closest(".editor")!==null||a.closest("write-card")!==null;return o&&!r&&n});return t&&be("Editor visualmente detectado.","success"),t}async function Zt(){be("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,a=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");if(a&&a.offsetParent!==null){be("Bot\xE3o de email direto encontrado.");let u=a.closest("material-button")||a.closest("material-fab")||a;Se(u),e=!0}else{be("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let u=document.querySelector("material-fab-speed-dial");if(u){let f=u.querySelector(".trigger");if(f){Se(f),await de(800);let v=Array.from(document.querySelectorAll("i.material-icons-extended")).find(A=>A.innerText.trim()==="email");v&&(Se(v),e=!0)}}}if(!e)return oe("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;be("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,r=0,n=20;for(;r<n;){await de(250);let u=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(u).find(f=>f.offsetParent!==null),o){be("\u26A0\uFE0F Rascunho detectado!","warn");break}r++}if(o){be("\u{1F5D1}\uFE0F Descartando..."),Se(o),o.click();let u=null,f=0;for(;f<15;){await de(300);let _=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(u=Array.from(_).find(v=>v.offsetParent!==null),u)break;f++}u&&(Se(u),oe("Limpando rascunho antigo...",{duration:2e3}),await de(2500))}be("\u{1F680} FASE 3: Buscando editor final...");let i=0,l=null;for(;i<20&&(l=kt(),!l);)await de(250),i++;if(!l)return oe("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let b=l.closest('[id="email-body-content-top"]'),h=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(b){if(h){let f=h.closest('[aria-hidden="true"]');f&&f.removeAttribute("aria-hidden"),h.focus(),Se(h)}await de(300),b.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let u=b.querySelector("#cases-body-field");if(u){let f=document.createRange();f.selectNodeContents(u),f.collapse(!0);let _=window.getSelection();_.removeAllRanges(),_.addRange(f)}return!0}return!1}async function lt(e){if(!e||!await Zt())return;let a=await At();be("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await de(600)),a.clientEmail&&a.clientEmail!=="N/A"&&a.clientEmail!=="N/A (Bloqueado)"){let n=document.querySelector('input[aria-label="Enter To email address"]');n&&(await rt(n,a.clientEmail),st(n,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(a.internalEmail){let n=document.querySelector('input[aria-label="Enter Bcc email address"]');n&&(await rt(n,a.internalEmail),st(n,`
            ...
            `))}await de(500);let r=document.querySelector('material-button[debug-id="canned_response_button"]');if(r){Se(r),await de(1e3);let n=document.querySelector("material-auto-suggest-input input");if(n){Se(n),document.execCommand("insertText",!1,e),n.dispatchEvent(new Event("input",{bubbles:!0})),be("\u23F3 Buscando resultado da Canned Response...","info");let i=null,l=0,b=15e3,p=500;for(;l<b&&(i=document.querySelector("material-select-dropdown-item"),!i);)await de(p),l+=p;if(i){Se(i),await de(1500);let h=kt();if(h&&a.advertiserName){let u=h.innerHTML;u.includes("{%ADVERTISER_NAME%}")&&(h.innerHTML=u.replace(/{%ADVERTISER_NAME%}/g,a.advertiserName))}oe("Canned Response aplicada!")}else be(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),oe(`Timeout: Template '${e}' n\xE3o carregou.`,{error:!0})}}else oe("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function Jt(e){if(be(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Zt())return;let a=await At(),o=vt();await de(600),be("\u{1F4E7} Processando destinat\xE1rios...");let r=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(r&&(r.click(),await de(600)),a.clientEmail&&a.clientEmail!=="N/A"&&a.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await rt(l,a.clientEmail),st(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(a.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await rt(l,a.internalEmail),st(l,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
    ...
    `,setTimeout(()=>{let n=r.querySelector("#close-help-internal");n&&(n.onmouseover=()=>n.style.backgroundColor="#f8f9fa",n.onmouseout=()=>n.style.backgroundColor="white",n.onclick=()=>{r.style.opacity="0",r.style.pointerEvents="none"})},0),e.appendChild(r),r}if(!document.getElementById("cw-module-styles")){let e=document.createElement("style");e.id="cw-module-styles",e.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
    ...
    `,document.head.appendChild(e)}function Ee(e,t,a){let o=document.getElementById(a);if(!t)return;let r=t.getAttribute("data-moved")==="true",n={x:0,y:0};if(o){let h=o.getBoundingClientRect();n.x=h.left+h.width/2,n.y=h.top+h.height/2}let i,l;if(!r)i=window.innerWidth/2,l=window.innerHeight/2;else{let h=t.getBoundingClientRect();i=h.left+h.width/2,l=h.top+h.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let b=n.x-i,p=n.y-l;e?(Z.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",r?t.style.transform=`translate(${b}px, ${p}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${b}px), calc(-50% + ${p}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",r?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof to=="function"&&to(t,a)):(Z.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",r?t.style.transform=`translate(${b}px, ${p}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${b}px), calc(-50% + ${p}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Ot=="function"&&Ot(t))}function to(e,t){Ot(e);let a=o=>{if(!e.classList.contains("open"))return;let r=e.contains(o.target),n=document.querySelector(".cw-pill"),i=n&&n.contains(o.target);r?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=a,document.addEventListener("mousedown",a)}function Ot(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var no="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",qt="cw_data_broadcast",oo="cw_data_tips",Oo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function ao(e){return new Promise((t,a)=>{let o="cw_cb_"+Math.round(1e4*Math.random()),r=document.createElement("script");window[o]=n=>{document.body.removeChild(r),delete window[o],t(n)},r.src=`${no}?op=${e}&callback=${o}&t=${Date.now()}`,r.onerror=()=>{document.body.removeChild(r),delete window[o],a(new Error("JSONP Load Error"))},document.body.appendChild(r)})}var He={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await ao("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(oo,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await ao("broadcast");if(e&&e.broadcast)return localStorage.setItem(qt,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(qt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(qt)||"[]"),getRandomTip:()=>{let e=Oo,t=localStorage.getItem(oo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let o={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(no,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(o)}).catch(r=>console.log("Log fail",r))}};var Te={glassBg:"rgba(61, 61, 61, 0.95)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},ct=e=>new Promise(t=>setTimeout(t,e));function io(e){let t="cw-command-center-style";if(!document.getElementById(t)){let C=document.createElement("style");C.id=t,C.innerHTML=`
        ...
        :root {
            ...
            /* Curva R\xE1pida e Precisa para Fechamento (Apple Snap) */
        ...
        /* --- A P\xCDLULA (Container Principal) --- */
        .cw-pill {
            ...
            /* Bordas Redondas Cont\xEDnuas */
            border-radius: 28px; 
            
            /* Sombras em camadas (Padr\xE3o Google Material 3 / iOS) */
            box-shadow: 
            ...
            transition: 
                max-height 0.7s var(--cw-spring-open), /* Mais lento e el\xE1stico ao abrir */
                opacity 0.4s ease-out, 
                transform 0.5s var(--cw-spring-open),
                border-radius 0.4s ease; /* Transi\xE7\xE3o suave da forma */

            /* Estado Aberto (Altura M\xE1xima Calculada para caber tudo) */
            max-height: 600px;
        ...
        .cw-pill.collapsed {
            /* Altura exata = Largura (56px) para ser um c\xEDrculo perfeito */
            max-height: 64px !important; /* 64px para acomodar o header com respiro */
            
            /* Ajuste da curva para fechar mais r\xE1pido (Snap) */
        ...
        .cw-brand-header:hover .cw-brand-icon {
            transform: scale(1.15) rotate(5deg); /* Vida org\xE2nica no hover */
        ...
        /* Ao Fechar: Some r\xE1pido e sobe um pouco */
        ...
        .cw-badge { 
            ...
            border: 2px solid #2d2d2d; /* Borda escura para contraste no \xEDcone */
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
  ...
  `;let d=document.createElement("div");d.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let x=document.createElement("label");x.className="cw-input-label",x.textContent="Sub-status",x.style.marginBottom="0";let k=document.createElement("a");k.href="https://seu-link-do-guia-aqui.com",k.target="_blank",k.className="cw-info-link",k.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(k.style,n.helpLink),d.appendChild(x),d.appendChild(k);let w=document.createElement("select");w.id="sub-status",w.className="cw-select",w.disabled=!0,w.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',s.appendChild(c),s.appendChild(y),s.appendChild(d),s.appendChild(w),u.appendChild(s);let T=document.createElement("div");T.id="step-1-1-portugal",Object.assign(T.style,n.stepBlock,{display:"none"});let ae=document.createElement("label");Object.assign(ae.style,n.label),T.appendChild(ae);let B=document.createElement("div");Object.assign(B.style,n.radioContainer);let L=document.createElement("div");Object.assign(L.style,{display:"flex",alignItems:"center"});let M=document.createElement("input");M.type="radio",M.name="portugal-group",M.value="sim",Object.assign(M.style,n.checkboxInput);let P=document.createElement("label");P.htmlFor="portugal-sim",Object.assign(P.style,{cursor:"pointer"}),L.appendChild(M),L.appendChild(P);let X=document.createElement("div");Object.assign(X.style,{display:"flex",alignItems:"center"});let H=document.createElement("input");H.type="radio",H.name="portugal-group",H.value="nao",H.checked=!0,Object.assign(H.style,n.checkboxInput);let fe=document.createElement("label");fe.htmlFor="portugal-nao",Object.assign(fe.style,{cursor:"pointer"}),X.appendChild(H),X.appendChild(fe),B.appendChild(L),B.appendChild(X),T.appendChild(B),u.appendChild(T);function W(S){o=S,S?R.style.display="block":R.style.display="none"}M.onchange=()=>W(!0),H.onchange=()=>W(!1);let R=document.createElement("div");R.id="step-1-2-consent",Object.assign(R.style,n.stepBlock,{display:"none"});let J=document.createElement("label");Object.assign(J.style,n.label),R.appendChild(J);let re=document.createElement("div");Object.assign(re.style,n.radioContainer);let me=document.createElement("div");Object.assign(me.style,{display:"flex",alignItems:"center"});let ye=document.createElement("input");ye.type="radio",ye.name="consent-group",ye.value="Sim",ye.checked=!0,Object.assign(ye.style,n.checkboxInput);let ie=document.createElement("label");ie.htmlFor="consent-sim",Object.assign(ie.style,{cursor:"pointer"}),me.appendChild(ye),me.appendChild(ie);let ee=document.createElement("div");Object.assign(ee.style,{display:"flex",alignItems:"center"});let Oe=document.createElement("input");Oe.type="radio",Oe.name="consent-group",Oe.value="N\xE3o",Object.assign(Oe.style,n.checkboxInput);let Me=document.createElement("label");Me.htmlFor="consent-nao",Object.assign(Me.style,{cursor:"pointer"}),ee.appendChild(Oe),ee.appendChild(Me),re.appendChild(me),re.appendChild(ee),R.appendChild(re),u.appendChild(R);let Le=document.createElement("div");Le.id="step-1-5-snippets",Object.assign(Le.style,n.stepBlock,{display:"none"});let at=document.createElement("h3");Object.assign(at.style,n.h3),at.textContent="Cen\xE1rios Comuns";let ve=so(S=>{let F=document.querySelector("textarea");F&&(F.value=S,F.dispatchEvent(new Event("input")),F.style.transition="background-color 0.2s",F.style.backgroundColor="#e8f0fe",setTimeout(()=>F.style.backgroundColor="#fff",300))});ve.id="snippet-container",Le.appendChild(at),Le.appendChild(ve),u.appendChild(Le);let he=document.createElement("div");he.id="step-3-form",Object.assign(he.style,n.stepBlock,{display:"none"});let mt=document.createElement("h3");Object.assign(mt.style,n.h3),he.appendChild(mt);let _e=document.createElement("div");_e.id="dynamic-form-fields-container",he.appendChild(_e);let pe=document.createElement("button");pe.textContent="+ Gostaria de selecionar uma task?",Object.assign(pe.style,n.optionalBtn),pe.onmouseover=()=>pe.style.background="#e8f0fe",pe.onmouseout=()=>pe.style.background="white",pe.onclick=()=>{pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};let De=document.createElement("h3");Object.assign(De.style,n.h3,{marginTop:"20px"});let Rt=l.selectionElement;Object.assign(Rt.style,{marginBottom:"20px"}),he.appendChild(pe),he.appendChild(De),he.appendChild(Rt),he.appendChild(i.element),he.appendChild(l.screenshotsElement),u.appendChild(he);let Fe=document.createElement("div");Fe.id="step-4-email",Object.assign(Fe.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let ze=document.createElement("input");ze.type="checkbox",ze.checked=!0,Object.assign(ze.style,n.checkboxInput),Ge.appendChild(ze),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),Fe.appendChild(Ge),u.appendChild(Fe);let We=document.createElement("div");Object.assign(We.style,{display:"none",gap:"8px",padding:"0"}),u.appendChild(We);let Ke=document.createElement("button");Object.assign(Ke.style,n.buttonBase,{backgroundColor:"#5f6368"}),Ke.textContent="Copiar";let Qe=document.createElement("button");Object.assign(Qe.style,n.buttonBase,{backgroundColor:"#1a73e8"}),Qe.textContent="Preencher",We.appendChild(Ke),We.appendChild(Qe);let Ze=document.createElement("div");Object.assign(Ze.style,Ye),Ze.className="no-drag",Ze.title="Redimensionar",b.appendChild(Ze),Xe(b,Ze),document.body.appendChild(b);function gt(S){t=S;let F=Je();Object.assign(m.style,ge),Object.assign(g.style,ge),S==="bau"?(Object.assign(m.style,F),k.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(g.style,F),k.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),w.value&&w.dispatchEvent(new Event("change"))}function V(S){try{if(Ne&&Ne[a]&&Ne[a][S])return Ne[a][S];if(Ne&&Ne.pt&&Ne.pt[S])return Ne.pt[S]}catch{}return S}function vo(){v.textContent=V("idioma"),C.textContent=V("fluxo"),c.textContent=V("status_principal"),x.textContent=V("substatus"),at.textContent=V("cenarios_comuns"),De.textContent=V("selecione_tasks"),mt.textContent=V("preencha_detalhes"),Ke.textContent=V("copiar"),Qe.textContent=V("preencher"),y.querySelector('option[value=""]')&&(y.querySelector('option[value=""]').textContent=V("select_status")),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=V("select_substatus")),ae.textContent=V("caso_portugal"),P.textContent=V("sim"),fe.textContent=V("nao"),J.textContent=V("consentiu_gravacao"),ie.textContent=V("sim"),Me.textContent=V("nao"),_e.querySelectorAll("label").forEach(S=>{let F=S.nextElementSibling.id.replace("field-",""),E=V(F.toLowerCase());E!==F.toLowerCase()?S.textContent=E:S.textContent=F.replace(/_/g," ").replace(/\b\w/g,$=>$.toUpperCase())+":"}),pe.textContent="+ "+(a==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function bt(S){a=S;let F=Je();Object.assign(O.style,ge),Object.assign(I.style,ge),S==="pt"?(Object.assign(O.style,F),T.style.display="block",W(o)):(Object.assign(I.style,F),T.style.display="none",R.style.display="none"),vo(),w.value&&w.dispatchEvent(new Event("change"))}function ft(S){(S.value.trim()===""||S.value.trim()==="\u2022")&&(S.value="\u2022 "),S.onkeydown=function(F){if(F.key==="Enter"){F.preventDefault();let E=this.selectionStart,$=this.selectionEnd,ne=this.value,le=ne.lastIndexOf(`
`,E-1)+1,xe=ne.substring(le,E),ce=xe.trim()==="\u2022"||xe.trim()===""?`
`:`
\u2022 `;this.value=ne.substring(0,E)+ce+ne.substring($),this.selectionStart=this.selectionEnd=E+ce.length}else if(F.key==="Backspace"){let E=this.selectionStart;if(E===this.selectionEnd&&E>0){let $=this.value.substring(0,E);$.endsWith(`
\u2022 `)?(F.preventDefault(),this.value=$.substring(0,E-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=E-3):$==="\u2022 "&&(F.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function ht(){let S=typeof ve<"u"?ve:document.getElementById("snippet-container");if(!S)return;let F=S.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),E={},$=new Set;F.forEach(Q=>{let K=Q.id,G=we[K];if(G)for(let N in G)N==="linkedTask"?$.add(G.linkedTask):N!=="type"&&(E[N]||(E[N]=[]),E[N].includes(G[N])||E[N].push(G[N]))});let ne=new Set;Object.values(we).forEach(Q=>{Object.keys(Q).forEach(K=>{K!=="linkedTask"&&K!=="type"&&ne.add(K)})}),ne.forEach(Q=>{let K=document.getElementById(Q);if(K){let G=E[Q]||[],N="";ot.includes(Q.replace("field-",""))?(N=G.map(Y=>Y.startsWith("\u2022 ")?Y:"\u2022 "+Y).join(`
`),N===""?N="\u2022 ":N.endsWith(`
\u2022 `)||(N+=`
\u2022 `)):N=G.join(`

`),N.trim()!=="\u2022"&&N.trim()!==""?K.value=N:ot.includes(Q.replace("field-",""))?K.value="\u2022 ":K.value="",K.tagName==="TEXTAREA"&&typeof ft=="function"&&ft(K)}});let le=new Set,xe=new Set;S.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(Q=>{let K=we[Q.id];K&&K.linkedTask&&(Q.checked?le.add(K.linkedTask):xe.add(K.linkedTask))}),xe.forEach(Q=>{le.has(Q)||l.toggleTask(Q,!1)}),le.forEach(Q=>{l.toggleTask(Q,!0)})}y.onchange=()=>{let S=y.value;if(xt(1.5),w.innerHTML=`<option value="">${V("select_substatus")}</option>`,!S){w.disabled=!0;return}for(let F in tt){let E=tt[F];if(E.status===S){let $=document.createElement("option");$.value=F,$.textContent=E.name,w.appendChild($)}}w.disabled=!1},w.onchange=()=>{let S=w.value;if(xt(1.5),!S)return;l.updateSubStatus(S);let F=tt[S];ve.innerHTML="";let E=(G,N,Y)=>{let se=document.createElement("label");Object.assign(se.style,n.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let te=document.createElement("input");return te.type=N,te.id=G.id,Object.assign(te.style,n.checkboxInput),se.appendChild(te),se.appendChild(document.createTextNode(` ${G.text}`)),Y.appendChild(se),te},$=[],ne="radio";if(S==="NI_Awaiting_Inputs")$=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(S.startsWith("SO_"))ne="checkbox",$=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(S.startsWith("AS_")){ne="checkbox";let G=document.createElement("label");G.textContent=V("cenarios_comuns"),Object.assign(G.style,n.label),ve.appendChild(G),$=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else S.startsWith("IN_")?$=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:S.startsWith("DC_")&&(ne="radio",$=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let le=$.filter(G=>{let N=we[G.id];return!N.type||N.type==="all"||N.type===t});le.forEach((G,N)=>{let Y=E(G,ne,ve);ne==="radio"&&(Y.name="scenario-radio-group",N===0&&(Y.checked=!0))}),le.length>0&&(Le.style.display="block"),F.requiresTasks?(pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"):(pe.style.display="block",De.style.display="none",l.selectionElement.style.display="none"),_e.innerHTML="";let xe=F.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(xe)].forEach(G=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(G))return;let N=G.slice(1,-1),Y=document.createElement("label"),se=V(N.toLowerCase());if(Y.textContent=se!==N.toLowerCase()?se:N.replace(/_/g," ").replace(/\b\w/g,j=>j.toUpperCase())+":",Object.assign(Y.style,n.label),N==="SPEAKEASY_ID"){let j=document.createElement("button");j.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',j.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;

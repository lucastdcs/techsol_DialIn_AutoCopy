...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=f=>{f.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=f=>{f.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=f=>{f.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=f=>{f.stopPropagation(),e.toggleLinks()},(async function(){await nt(2800),o.classList.add("docked"),await nt(300);let x=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(C=>C.classList.add("visible"));for(let C=0;C<x.length;C++)x[C].classList.add("popped"),await nt(90);await nt(200),o.classList.add("system-check")})();let i=!1,a,s,l,h,m=3;o.onmousedown=f=>{if(f.target.closest("button"))return;f.preventDefault(),a=f.clientX,s=f.clientY;let x=o.getBoundingClientRect();l=x.left,h=x.top,document.addEventListener("mousemove",c),document.addEventListener("mouseup",E)};function c(f){let x=f.clientX-a,p=f.clientY-s;!i&&Math.sqrt(x*x+p*p)>m&&(i=!0,o.style.transition="none"),i&&(o.style.left=`${l+x}px`,o.style.top=`${h+p}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function E(f){if(document.removeEventListener("mousemove",c),document.removeEventListener("mouseup",E),i){i=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let x=window.innerWidth,p=window.innerHeight,C=o.getBoundingClientRect(),w=C.left+C.width/2,M;w<x/2?(M=24,o.classList.remove("side-right"),o.classList.add("side-left")):(M=x-C.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let G=C.top;G<24&&(G=24),G>p-C.height-24&&(G=p-C.height-24),o.style.left=`${M}px`,o.style.top=`${G}px`,setTimeout(()=>{},600)}else{let x=f.target.closest("button");x&&(x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="",150))}}}function at(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let a=Date.now()-r,s=Math.max(0,1500-a);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},s)}}function Bt(e){let t=document.createElement("div");t.className="cw-step-scenarios";let n=document.createElement("div");Object.assign(n.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let o=document.createElement("div");Object.assign(o.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"40px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s ease"}),o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>";let r=null;Object.entries(ye).forEach(([a,s])=>{let l=document.createElement("div");l.textContent=a,Object.assign(l.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",display:"flex",alignItems:"center",gap:"6px"}),l.onmouseenter=()=>{r!==s&&(o.style.background="#fff",o.style.borderColor="#1a73e8",o.style.color="#202124",o.textContent=`"${s.substring(0,120)}${s.length>120?"...":""}"`),r!==s&&(l.style.background="#f1f3f4")},l.onmouseleave=()=>{r!==s&&(r||(o.style.background="#f8f9fa",o.style.borderColor="#dadce0",o.style.color="#5f6368",o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>"),l.style.background="#ffffff")},l.onclick=()=>{me.playClick(),r===s?(r=null,i(),e("")):(r=s,i(),l.style.transform="scale(0.95)",setTimeout(()=>l.style.transform="scale(1)",150),e(s))},n.appendChild(l)});function i(){Array.from(n.children).forEach(a=>{ye[a.textContent]===r?(a.style.background="#e8f0fe",a.style.borderColor="#1a73e8",a.style.color="#1967d2",a.style.fontWeight="500"):(a.style.background="#ffffff",a.style.borderColor="#dadce0",a.style.color="#3c4043",a.style.fontWeight="400")})}return t.appendChild(n),t.appendChild(o),t}var qt=e=>new Promise(t=>setTimeout(t,e));function it(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Ct(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{oe("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Ht(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Vt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function $t(){console.log("Iniciando processo de Nova Nota...");let e=Vt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(a=>a.innerText.trim()==="description");if(o){let a=o.closest("material-fab")||o.closest("material-button");a?(a.style&&(a.style.display="block",a.style.visibility="visible"),it(a)):it(o)}else{let a=document.querySelector("material-fab-speed-dial");if(a){let s=a.querySelector(".trigger");s?(s.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),it(s)):a.click(),await qt(800);let h=Array.from(document.querySelectorAll("i.material-icons-extended")).find(m=>m.innerText.trim()==="description");h&&it(h)}}let r=null,i=0;for(;!r&&i<20;){await qt(300);let a=Vt();if(a.length>t)r=a.find(s=>!e.includes(s)),r||(r=a[a.length-1]);else if(i>10){let s=a.filter(l=>l.offsetParent!==null);s.length>0&&(r=s[s.length-1])}i++}return r}var B={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},ve="cubic-bezier(0.25, 0.8, 0.25, 1)",so={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${B.border}`,backgroundColor:B.bgInput,fontSize:"14px",color:B.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${ve}, box-shadow 0.2s ${ve}, background-color 0.2s`,outline:"none"},Lo={...so,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},Mo={fontSize:"13px",fontWeight:"700",color:B.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},Do={display:"block",fontSize:"13px",fontWeight:"600",color:B.text,marginBottom:"8px",marginTop:"16px"},Go={fontSize:"12px",color:B.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},Fo={fontSize:"12px",color:B.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},zo={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:B.text,cursor:"pointer",padding:"12px 14px",backgroundColor:B.surface,border:`1px solid ${B.border}`,borderRadius:"12px",transition:`all 0.2s ${ve}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},At={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:B.primary},Po={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:B.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${ve}, box-shadow 0.2s ${ve}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},jo={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${B.primary}`,color:B.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${ve}`},Bo={background:"transparent",border:`1px solid ${B.border}`,borderRadius:"20px",color:B.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${ve}`,fontFamily:"'Google Sans', 'Roboto'"};var qo={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:B.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},Vo={fontSize:"13px",fontWeight:"700",color:B.primary,minWidth:"20px",textAlign:"center"},Ho={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${B.border}`,backgroundColor:B.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${ve}, box-shadow 0.2s ${ve}`},$o={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${B.bgInput}`},Uo={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${B.border}`,backgroundColor:B.surface,color:B.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${ve}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Wo={backgroundColor:B.primaryBg,color:B.primary,borderColor:B.primary,fontWeight:"600"},Yo={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:B.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Xo={borderTop:`1px solid ${B.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Ko={maxHeight:"240px",overflowY:"auto",border:`1px solid ${B.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:B.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},Qo={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${B.bgInput}`,cursor:"pointer",fontSize:"13px",color:B.text,transition:"background 0.1s",userSelect:"none"};var ro={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},lo={fontSize:"12px",color:"#e37400",marginTop:"4px"},co={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},po={display:"flex",gap:"15px",marginBottom:"10px"};function Ut(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,ro);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,ht,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,po);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,At);let r=document.createElement("label");r.textContent="Sim";let i=document.createElement("div");Object.assign(i.style,{display:"flex",alignItems:"center"}),i.appendChild(o),i.appendChild(r);let a=document.createElement("input");a.type="radio",a.name="ts_usage_mod",a.value="N\xE3o",a.checked=!0,Object.assign(a.style,At);let s=document.createElement("label");s.textContent="N\xE3o";let l=document.createElement("div");Object.assign(l.style,{display:"flex",alignItems:"center"}),l.appendChild(a),l.appendChild(s),n.appendChild(i),n.appendChild(l);let h=document.createElement("div");h.style.display="block";let m=document.createElement("label");m.textContent="Qual foi o Motivo?",Object.assign(m.style,ht,{fontSize:"12px"});let c=document.createElement("input");c.type="text",Object.assign(c.style,co);let E=document.createElement("div");E.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(E.style,lo),h.appendChild(m),h.appendChild(c),h.appendChild(E),e.appendChild(t),e.appendChild(n),e.appendChild(h),o.onchange=()=>{h.style.display="none"},a.onchange=()=>{h.style.display="block"};function f(C,w){if(e.style.display="none",!C||C.includes("Education")||!w||w.length===0)return;let M=w.some(g=>g.includes("enhanced")||g==="ec_google_ads"),G=w.some(g=>(g.includes("conversion")||g.includes("ads"))&&!g.includes("enhanced")),d=w.some(g=>g.includes("ga4")||g.includes("analytics")||g.includes("ua")),u=w.some(g=>g.includes("merchant")||g.includes("gmc")||g.includes("shopping"));(M||G&&!d&&!u)&&(e.style.display="block")}function x(){if(e.style.display==="none")return"";let C=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return a.checked&&c.value.trim()!==""&&(C+=`<br><b>Motivo:</b> ${c.value}`),C+="<br>",C}function p(){e.style.display="none",a.checked=!0,o.checked=!1,h.style.display="block",c.value=""}return{element:e,updateVisibility:f,getOutput:x,reset:p}}var F={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},ze={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function Wt(e){let t={};function n(d){let u=d.toLowerCase();return u.includes("ads")||u.includes("conversion")||u.includes("remarketing")?F.brands.ads:u.includes("ga4")||u.includes("analytics")?F.brands.ga4:u.includes("gtm")||u.includes("tag manager")||u.includes("container")?F.brands.gtm:u.includes("merchant")||u.includes("shopping")||u.includes("feed")?F.brands.gmc:F.brands.default}let o=Object.entries(Ie).filter(([d,u])=>u.popular),r={};Object.entries(Ie).forEach(([d,u])=>{if(u.popular)return;let b=n(u.name);r[b.label]||(r[b.label]={brand:b,tasks:[]}),r[b.label].tasks.push({key:d,...u})});let i="cw-zen-tasks";if(!document.getElementById(i)){let d=document.createElement("style");d.id=i,d.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(d)}let a=document.createElement("div");a.className="cw-zen-container";let s=document.createElement("div");Object.assign(s.style,{display:"none"});let l=document.createElement("div");l.className="cw-screens-container",s.appendChild(l),a.innerHTML=`
    ...
    `;let h=a.querySelector(".cw-hero-grid"),m=a.querySelector(".cw-acc-container"),c=a.querySelector(".cw-results-container"),E=a.querySelector(".cw-search-input"),f=a.querySelector(".cw-status-bar"),x=a.querySelector(".cw-status-text"),p=a.querySelector(".cw-footer-icons");o.forEach(([d,u])=>{let b=n(u.name),g=document.createElement("div");g.className="cw-hero-card",g.id=`hero-${d}`,g.style.setProperty("--hero-color",b.color),g.innerHTML=`
        ...
        `,g.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let A=t[d]?t[d].count:0;w(d,A>0?-A:1,u)},g.querySelector(".minus").onclick=()=>w(d,-1,u),g.querySelector(".plus").onclick=()=>w(d,1,u),g.dataset.color=b.color,h.appendChild(g)});function C(d,u){let b=n(u.name),g=document.createElement("div");return g.className="cw-task-item",g.dataset.id=d,g.innerHTML=`
        ...
        `,g.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let A=t[d]?t[d].count:0;w(d,A>0?-A:1,u)},g.querySelector(".minus").onclick=()=>w(d,-1,u),g.querySelector(".plus").onclick=()=>w(d,1,u),g}Object.entries(r).forEach(([d,u])=>{let b=document.createElement("div");b.className="cw-acc-group";let g=document.createElement("div");g.className="cw-acc-header",g.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${u.brand.color}"></div>
                ${d}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,g.onclick=()=>{m.querySelectorAll(".cw-acc-group.open").forEach(A=>{A!==b&&A.classList.remove("open")}),b.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",u.tasks.forEach(A=>{let k=C(A.key,A);v.appendChild(k)}),b.appendChild(g),b.appendChild(v),m.appendChild(b)});function w(d,u,b){t[d]||(t[d]={count:0,data:b,brand:n(b.name)}),t[d].count+=u,t[d].count<=0&&delete t[d],M(),G(),e&&e()}function M(){o.forEach(([v])=>{let A=h.querySelector(`#hero-${v}`);if(!A)return;let k=t[v];k?(A.classList.add("active"),A.querySelector(".cw-step-val").textContent=k.count,A.querySelector(".cw-step-val").style.color=A.dataset.color):A.classList.remove("active")}),a.querySelectorAll(".cw-task-item").forEach(v=>{let A=v.dataset.id,k=t[A];k?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=k.count):v.classList.remove("selected")});let u=Object.keys(t),b=0,g=[];if(u.forEach(v=>{let A=t[v];b+=A.count;for(let k=0;k<A.count;k++)g.length<6&&g.push(A.brand)}),b>0){f.classList.add("visible");let v=b>1?"A\xE7\xF5es":"A\xE7\xE3o",A=b>1?"definidas":"definida";x.textContent=`${b} ${v} ${A}`,p.innerHTML="",g.forEach(k=>{let U=document.createElement("div");U.className="cw-mini-icon",U.innerHTML=ze[k.icon]||ze.default;let R=U.querySelector("svg");R&&(R.style.width="14px",R.style.height="14px"),p.appendChild(U)})}else f.classList.remove("visible")}E.addEventListener("input",d=>{let u=d.target.value.toLowerCase();if(u.length>0){m.style.display="none",c.style.display="block",c.innerHTML="";let b=!1;Object.entries(Ie).forEach(([g,v])=>{if(v.name.toLowerCase().includes(u)){b=!0;let A=C(g,v);t[g]&&(A.classList.add("selected"),A.querySelector(".cw-step-val").textContent=t[g].count),c.appendChild(A)}}),b||(c.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else m.style.display="block",c.style.display="none"});function G(){l.innerHTML="";let d=Object.keys(t),u=!1,b="implementation";if(d.length===0){l.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let g=document.createElement("div");g.className="cw-info-banner",g.innerHTML=`
        ...
        `,l.appendChild(g),d.forEach(v=>{let A=t[v].data,k=t[v].count,U=t[v].brand,R=A.screenshots?A.screenshots[b]||[]:["Link da Evid\xEAncia"];if(R.length>0){u=!0;for(let T=1;T<=k;T++){let z=document.createElement("div");z.className="cw-screen-card",z.style.setProperty("--brand-color",U.color),z.style.setProperty("--brand-bg",U.bg),z.style.setProperty("--brand-shadow",U.color+"40");let P=document.createElement("div");P.className="cw-card-header";let q=document.createElement("div");q.className="cw-card-icon",q.innerHTML=ze[U.icon]||ze.default;let O=document.createElement("div");O.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let D=document.createElement("input");D.className="cw-card-title-input",D.id=`name-${v}-${T}`,D.value=`${A.name}${k>1?" #"+T:""}`,D.title="Clique para renomear esta task";let I=document.createElement("span");I.className="cw-edit-hint",I.innerHTML="\u270E Renomear",O.appendChild(D),O.appendChild(I),P.appendChild(q),P.appendChild(O),z.appendChild(P),R.forEach((Z,K)=>{let Y=document.createElement("div");Y.className="cw-input-group";let J=document.createElement("label");J.className="cw-input-label",J.textContent=Z.replace(/📷|:|•/g,"").trim();let ee=document.createElement("input");ee.className="cw-input-field",ee.id=`screen-${v}-${T}-${K}`,ee.placeholder="Cole o link aqui...",ee.setAttribute("autocomplete","off"),ee.addEventListener("input",()=>{ee.value.trim().length>5?ee.classList.add("filled"):ee.classList.remove("filled")});let Se=document.createElement("div");Se.className="cw-input-check",Se.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',Y.appendChild(J),Y.appendChild(ee),Y.appendChild(Se),z.appendChild(Y)}),l.appendChild(z)}}}),s.style.display=u?"block":"none"}return{selectionElement:a,screenshotsElement:s,updateSubStatus:()=>G(),getCheckedElements:()=>Object.keys(t).map(d=>({value:d,closest:()=>({querySelector:()=>({textContent:t[d].count})})})),toggleTask:(d,u=!0)=>{let b=t[d];u&&!b?w(d,1,Ie[d]):!u&&b&&w(d,-b.count,Ie[d])},reset:()=>{for(let d in t)delete t[d];E.value="",m.style.display="block",c.style.display="none",M(),G()}}}function Yt(){let e="v3.6.0",t="bau",n="pt",o=!1,r=!1,i={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},a=Ut(),s=Wt(()=>{let _=s.getCheckedElements().map(S=>S.value);T&&T.value&&a.updateVisibility(T.value,_)}),l=document.createElement("div");l.id="autofill-popup",Object.assign(l.style,Oe,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),l.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let m=Re(l,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:l,googleLine:null},()=>mt());l.appendChild(m);let c=document.createElement("div");Object.assign(c.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),l.appendChild(c);let E=document.createElement("div");E.textContent="created by lucaste@",Object.assign(E.style,Dt),l.appendChild(E);let f=document.createElement("div");f.id="step-lang-type";let x=document.createElement("label");Object.assign(x.style,i.label),f.appendChild(x);let p=document.createElement("div");Object.assign(p.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let C=document.createElement("div");C.textContent="Portugu\xEAs",C.classList.add("no-drag"),Object.assign(C.style,de);let w=document.createElement("div");w.textContent="Espa\xF1ol",w.classList.add("no-drag"),Object.assign(w.style,de),C.onclick=()=>ct("pt"),w.onclick=()=>ct("es"),p.appendChild(C),p.appendChild(w),f.appendChild(p),c.appendChild(f);let M=document.createElement("div");M.id="step-0-case-type";let G=document.createElement("label");Object.assign(G.style,i.label),M.appendChild(G);let d=document.createElement("div");Object.assign(d.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let u=document.createElement("div");u.textContent="BAU",u.classList.add("no-drag"),Object.assign(u.style,de);let b=document.createElement("div");b.textContent="LM",b.classList.add("no-drag"),Object.assign(b.style,de),u.onclick=()=>lt("bau"),b.onclick=()=>lt("lm"),d.appendChild(u),d.appendChild(b),M.appendChild(d),c.appendChild(M);let g=document.createElement("div");g.id="step-1-selection";let v=document.createElement("label");Object.assign(v.style,i.label);let A=document.createElement("select");A.id="main-status",Object.assign(A.style,We),A.innerHTML='<option value="">-- Selecione --</option><option value="NI">NI - Need Info</option><option value="SO">SO - Solution Offered</option><option value="IN">IN - Inactive</option><option value="AS">AS - Assigned</option>';let k=document.createElement("div");Object.assign(k.style,{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginTop:"16px",marginBottom:"8px"});let U=document.createElement("label");Object.assign(U.style,i.label,{marginTop:"0",marginBottom:"0"});let R=document.createElement("a");R.target="_blank",R.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg> Guia de Substatus',Object.assign(R.style,i.helpLink),k.appendChild(U),k.appendChild(R);let T=document.createElement("select");T.id="sub-status",Object.assign(T.style,We),T.disabled=!0,g.appendChild(v),g.appendChild(A),g.appendChild(k),g.appendChild(T),c.appendChild(g);let z=document.createElement("div");z.id="step-1-1-portugal",Object.assign(z.style,i.stepBlock,{display:"none"});let P=document.createElement("label");Object.assign(P.style,i.label),z.appendChild(P);let q=document.createElement("div");Object.assign(q.style,i.radioContainer);let O=document.createElement("div");Object.assign(O.style,{display:"flex",alignItems:"center"});let D=document.createElement("input");D.type="radio",D.name="portugal-group",D.value="sim",Object.assign(D.style,i.checkboxInput);let I=document.createElement("label");I.htmlFor="portugal-sim",Object.assign(I.style,{cursor:"pointer"}),O.appendChild(D),O.appendChild(I);let Z=document.createElement("div");Object.assign(Z.style,{display:"flex",alignItems:"center"});let K=document.createElement("input");K.type="radio",K.name="portugal-group",K.value="nao",K.checked=!0,Object.assign(K.style,i.checkboxInput);let Y=document.createElement("label");Y.htmlFor="portugal-nao",Object.assign(Y.style,{cursor:"pointer"}),Z.appendChild(K),Z.appendChild(Y),q.appendChild(O),q.appendChild(Z),z.appendChild(q),c.appendChild(z);function J(y){o=y,y?ee.style.display="block":ee.style.display="none"}D.onchange=()=>J(!0),K.onchange=()=>J(!1);let ee=document.createElement("div");ee.id="step-1-2-consent",Object.assign(ee.style,i.stepBlock,{display:"none"});let Se=document.createElement("label");Object.assign(Se.style,i.label),ee.appendChild(Se);let je=document.createElement("div");Object.assign(je.style,i.radioContainer);let ge=document.createElement("div");Object.assign(ge.style,{display:"flex",alignItems:"center"});let fe=document.createElement("input");fe.type="radio",fe.name="consent-group",fe.value="Sim",fe.checked=!0,Object.assign(fe.style,i.checkboxInput);let ne=document.createElement("label");ne.htmlFor="consent-sim",Object.assign(ne.style,{cursor:"pointer"}),ge.appendChild(fe),ge.appendChild(ne);let X=document.createElement("div");Object.assign(X.style,{display:"flex",alignItems:"center"});let Ce=document.createElement("input");Ce.type="radio",Ce.name="consent-group",Ce.value="N\xE3o",Object.assign(Ce.style,i.checkboxInput);let Le=document.createElement("label");Le.htmlFor="consent-nao",Object.assign(Le.style,{cursor:"pointer"}),X.appendChild(Ce),X.appendChild(Le),je.appendChild(ge),je.appendChild(X),ee.appendChild(je),c.appendChild(ee);let Me=document.createElement("div");Me.id="step-1-5-snippets",Object.assign(Me.style,i.stepBlock,{display:"none"});let Qe=document.createElement("h3");Object.assign(Qe.style,i.h3),Qe.textContent="Cen\xE1rios Comuns";let he=Bt(y=>{let _=document.querySelector("textarea");_&&(_.value=y,_.dispatchEvent(new Event("input")),_.style.transition="background-color 0.2s",_.style.backgroundColor="#e8f0fe",setTimeout(()=>_.style.backgroundColor="#fff",300))});he.id="snippet-container",Me.appendChild(Qe),Me.appendChild(he),c.appendChild(Me);let xe=document.createElement("div");xe.id="step-2-tasks",Object.assign(xe.style,i.stepBlock,{display:"none"});let pe=document.createElement("button");pe.textContent="+ Gostaria de selecionar uma task?",Object.assign(pe.style,i.optionalBtn),pe.onmouseover=()=>{pe.style.background="#e8f0fe"},pe.onmouseout=()=>{pe.style.background="white"};let Be=document.createElement("h3");Object.assign(Be.style,i.h3);let wt=document.createElement("div");wt.id="task-checkboxes-container",xe.appendChild(pe),xe.appendChild(wt),xe.appendChild(Be),xe.appendChild(s.selectionElement),c.appendChild(xe);let Ae=document.createElement("div");Ae.id="step-3-form",Object.assign(Ae.style,i.stepBlock,{display:"none"});let rt=document.createElement("h3");Object.assign(rt.style,i.h3),Ae.appendChild(rt);let ke=document.createElement("div");ke.id="dynamic-form-fields-container",Ae.appendChild(ke),Ae.appendChild(a.element),Ae.appendChild(s.screenshotsElement),c.appendChild(Ae);let De=document.createElement("div");De.id="step-4-email",Object.assign(De.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let Fe=document.createElement("input");Fe.type="checkbox",Fe.checked=!0,Object.assign(Fe.style,i.checkboxInput),Ge.appendChild(Fe),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),De.appendChild(Ge),c.appendChild(De);let qe=document.createElement("div");Object.assign(qe.style,{display:"none",gap:"8px",padding:"0"}),c.appendChild(qe);let He=document.createElement("button");Object.assign(He.style,i.buttonBase,{backgroundColor:"#5f6368"}),He.textContent="Copiar";let $e=document.createElement("button");Object.assign($e.style,i.buttonBase,{backgroundColor:"#1a73e8"}),$e.textContent="Preencher",qe.appendChild(He),qe.appendChild($e);let Ue=document.createElement("div");Object.assign(Ue.style,Je),Ue.className="no-drag",Ue.title="Redimensionar",l.appendChild(Ue),et(l,Ue),document.body.appendChild(l);function lt(y){t=y;let _=Ye();Object.assign(u.style,de),Object.assign(b.style,de),y==="bau"?(Object.assign(u.style,_),R.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(b.style,_),R.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),T.value&&T.dispatchEvent(new Event("change"))}function j(y){try{if(Te&&Te[n]&&Te[n][y])return Te[n][y];if(Te&&Te.pt&&Te.pt[y])return Te.pt[y]}catch{}return y}function Jt(){x.textContent=j("idioma"),G.textContent=j("fluxo"),v.textContent=j("status_principal"),U.textContent=j("substatus"),Qe.textContent=j("cenarios_comuns"),Be.textContent=j("selecione_tasks"),rt.textContent=j("preencha_detalhes"),He.textContent=j("copiar"),$e.textContent=j("preencher"),A.querySelector('option[value=""]')&&(A.querySelector('option[value=""]').textContent=j("select_status")),T.querySelector('option[value=""]')&&(T.querySelector('option[value=""]').textContent=j("select_substatus")),P.textContent=j("caso_portugal"),I.textContent=j("sim"),Y.textContent=j("nao"),Se.textContent=j("consentiu_gravacao"),ne.textContent=j("sim"),Le.textContent=j("nao"),ke.querySelectorAll("label").forEach(y=>{let _=y.nextElementSibling.id.replace("field-",""),S=j(_.toLowerCase());S!==_.toLowerCase()?y.textContent=S:y.textContent=_.replace(/_/g," ").replace(/\b\w/g,V=>V.toUpperCase())+":"}),pe.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function ct(y){n=y;let _=Ye();Object.assign(C.style,de),Object.assign(w.style,de),y==="pt"?(Object.assign(C.style,_),z.style.display="block",J(o)):(Object.assign(w.style,_),z.style.display="none",ee.style.display="none"),Jt(),T.value&&T.dispatchEvent(new Event("change"))}function dt(y){(y.value.trim()===""||y.value.trim()==="\u2022")&&(y.value="\u2022 "),y.onkeydown=function(_){if(_.key==="Enter"){_.preventDefault();let S=this.selectionStart,V=this.selectionEnd,te=this.value,re=te.lastIndexOf(`
`,S-1)+1,be=te.substring(re,S),le=be.trim()==="\u2022"||be.trim()===""?`
`:`
\u2022 `;this.value=te.substring(0,S)+le+te.substring(V),this.selectionStart=this.selectionEnd=S+le.length}else if(_.key==="Backspace"){let S=this.selectionStart;if(S===this.selectionEnd&&S>0){let V=this.value.substring(0,S);V.endsWith(`
\u2022 `)?(_.preventDefault(),this.value=V.substring(0,S-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=S-3):V==="\u2022 "&&(_.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function pt(){let y=typeof he<"u"?he:document.getElementById("snippet-container");if(!y)return;let _=y.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),S={},V=new Set;_.forEach(W=>{let H=W.id,L=ye[H];if(L)for(let N in L)N==="linkedTask"?V.add(L.linkedTask):N!=="type"&&(S[N]||(S[N]=[]),S[N].includes(L[N])||S[N].push(L[N]))});let te=new Set;Object.values(ye).forEach(W=>{Object.keys(W).forEach(H=>{H!=="linkedTask"&&H!=="type"&&te.add(H)})}),te.forEach(W=>{let H=document.getElementById(W);if(H){let L=S[W]||[],N="";Ke.includes(W.replace("field-",""))?(N=L.map($=>$.startsWith("\u2022 ")?$:"\u2022 "+$).join(`
`),N===""?N="\u2022 ":N.endsWith(`
\u2022 `)||(N+=`
\u2022 `)):N=L.join(`

`),N.trim()!=="\u2022"&&N.trim()!==""?H.value=N:Ke.includes(W.replace("field-",""))?H.value="\u2022 ":H.value="",H.tagName==="TEXTAREA"&&typeof dt=="function"&&dt(H)}});let re=new Set,be=new Set;y.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(W=>{let H=ye[W.id];H&&H.linkedTask&&(W.checked?re.add(H.linkedTask):be.add(H.linkedTask))}),be.forEach(W=>{re.has(W)||s.toggleTask(W,!1)}),re.forEach(W=>{s.toggleTask(W,!0)})}A.onchange=()=>{let y=A.value;if(ut(1.5),T.innerHTML=`<option value="">${j("select_substatus")}</option>`,!y){T.disabled=!0;return}for(let _ in Xe){let S=Xe[_];if(S.status===y){let V=document.createElement("option");V.value=_,V.textContent=S.name,T.appendChild(V)}}T.disabled=!1},T.onchange=()=>{let y=T.value;if(ut(1.5),!y)return;s.updateSubStatus(y);let _=Xe[y];he.innerHTML="";let S=(L,N,$)=>{let ae=document.createElement("label");Object.assign(ae.style,i.checkboxLabel),ae.onmouseover=()=>ae.style.backgroundColor="#e8eaed",ae.onmouseout=()=>ae.style.backgroundColor="#f8f9fa";let Q=document.createElement("input");return Q.type=N,Q.id=L.id,Object.assign(Q.style,i.checkboxInput),ae.appendChild(Q),ae.appendChild(document.createTextNode(` ${L.text}`)),$.appendChild(ae),Q},V=[],te="radio";if(y==="NI_Awaiting_Inputs")V=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(y.startsWith("SO_"))te="checkbox",V=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(y.startsWith("AS_")){te="checkbox";let L=document.createElement("label");L.textContent=j("cenarios_comuns"),Object.assign(L.style,i.label),he.appendChild(L),V=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else y.startsWith("IN_")&&(V=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let re=V.filter(L=>{let N=ye[L.id];return!N.type||N.type==="all"||N.type===t});re.forEach((L,N)=>{let $=S(L,te,he);te==="radio"&&($.name="scenario-radio-group",N===0&&($.checked=!0))}),re.length>0&&(Me.style.display="block"),_.requiresTasks?(pe.style.display="none",Be.style.display="block",s.selectionElement.style.display="block",xe.style.display="block"):(pe.style.display="block",Be.style.display="none",s.selectionElement.style.display="none",xe.style.display="block"),ke.innerHTML="";let be=_.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(be)].forEach(L=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(L))return;let N=L.slice(1,-1),$=document.createElement("label"),ae=j(N.toLowerCase());$.textContent=ae!==N.toLowerCase()?ae:N.replace(/_/g," ").replace(/\b\w/g,ie=>ie.toUpperCase())+":",Object.assign($.style,i.label);let Q;Ke.includes(N)?(Q=document.createElement("textarea"),Object.assign(Q.style,i.textarea),Q.classList.add("bullet-textarea"),dt(Q)):yt.includes(N)?(Q=document.createElement("textarea"),Object.assign(Q.style,i.textarea)):(Q=document.createElement("input"),Q.type="text",Object.assign(Q.style,i.input),N==="REASON_COMMENTS"&&(y.startsWith("NI_")||y.startsWith("IN_"))&&(Object.assign($.style,{display:"none"}),Object.assign(Q.style,{display:"none"}))),N==="ON_CALL"&&t==="lm"&&(Object.assign($.style,{display:"none"}),Object.assign(Q.style,{display:"none"}),Q.value="N/A"),Q.id=`field-${N}`,ke.appendChild($),ke.appendChild(Q)});let W=he.querySelectorAll('input[type="checkbox"], input[type="radio"]');W.length>0&&(W.forEach(L=>{L.removeEventListener("change",pt),L.addEventListener("change",pt)}),pt()),Ae.style.display="block",tt[y]?De.style.display="block":De.style.display="none",qe.style.display="flex";let H=s.getCheckedElements().map(L=>L.value);a.updateVisibility(y,H)},pe.onclick=()=>{pe.style.display="none",Be.style.display="block",s.selectionElement.style.display="block"};function Et(){let y=T.value;if(!y)return null;let S=Xe[y].template.replace(/\n/g,"<br>"),V='style="margin-bottom: 12px; padding-left: 30px;"',te=[],re="",be=s.getCheckedElements();be.length>0&&be.forEach(H=>{let L=H.value,N=Ie[L],$=H.closest().querySelector(".stepper-count"),ae=$?parseInt($.textContent):1;ae>1?te.push(`${N.name} (x${ae})`):te.push(N.name)});let le=s.screenshotsElement;if(le){let H=Array.from(le.querySelectorAll('input[id^="name-"]'));H.length>0&&H.forEach(L=>{let N=L.value,$=L.closest(".cw-screen-card");if($){let ae=$.querySelectorAll('input[id^="screen-"]'),Q=!1,ie="";ae.forEach(ue=>{let Tt=ue.closest(".cw-input-group"),kt=Tt?Tt.querySelector(".cw-input-label"):null,eo=kt?kt.textContent:"Evid\xEAncia",Ot=ue.value.trim(),to=Ot?` ${Ot}`:"";ie+=`<li>${eo} -${to}</li>`,Q=!0}),Q&&(re+=`<b>${N}</b>`,re+=`<ul ${V}>${ie}</ul>`)}})}if(S.includes("{TAGS_IMPLEMENTED}")?S=S.replace(/{TAGS_IMPLEMENTED}/g,te.join(", ")||"N/A"):te.length>0&&(S+=`<br><b>Tags:</b> ${te.join(", ")}<br>`),S.includes("{SCREENSHOTS_LIST}")?S=S.replace(/{SCREENSHOTS_LIST}/g,re?`${re}`:"N/A"):re!==""&&(S+=`<br>${re}`),n==="pt"&&o){let H=fe.checked?j("sim"):j("nao");S=S.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${j("consentiu_gravacao")}</b> ${H}<br><br>`),S=S.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("sim")}<br>`)}else n==="pt"&&!o?(S=S.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("nao")}<br>`),S=S.replace(/{CONSENTIU_GRAVACAO}/g,"")):(S=S.replace(/{CASO_PORTUGAL}/g,""),S=S.replace(/{CONSENTIU_GRAVACAO}/g,""));return ke.querySelectorAll("input, textarea").forEach(H=>{let L=H.id.replace("field-",""),N=new RegExp(`{${L}}`,"g"),$=H.value;if(L==="REASON_COMMENTS"&&(y.startsWith("NI_")||y.startsWith("IN_"))){let ie=he.querySelector('input[type="radio"]:checked');ie&&ye[ie.id]&&($=ye[ie.id]["field-REASON_COMMENTS"])}if(Ke.includes(L)&&$.trim()!==""){let ie=$.split(`
`).map(ue=>ue.trim()).filter(ue=>ue!==""&&ue!=="\u2022").map(ue=>ue.startsWith("\u2022 ")?ue.substring(2):ue).map(ue=>`<li>${ue}</li>`).join("");$=ie?`<ul ${V}>${ie}</ul>`:""}else yt.includes(L)?$=$.split(`
`).filter(ie=>ie.trim()!=="").map(ie=>`<p style="margin: 0 0 8px 0;">${ie}</p>`).join(""):H.tagName==="TEXTAREA"&&($=$.replace(/\n/g,"<br>"));let ae=$.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ae===""||ae==="\u2022"||ae.toLowerCase()==="n/a"){let ie=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${L}\\}(?:<br>\\s*)?`,"gi");ie.test(S)?S=S.replace(ie,""):S=S.replace(N,"")}else S=S.replace(N,$.replace(/\$/g,"$$$$"))}),S=S.replace(/{([A-Z0-9_]+)}/g,""),S=S.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(S+=a.getOutput()),S}He.onclick=()=>{let y=Et();y?(Ct(y),oe(j("copiado_sucesso"))):oe(j("selecione_substatus"),{error:!0})},$e.onclick=async()=>{let y=T.value,_=Et();if(!_){oe(j("selecione_substatus"),{error:!0});return}Ct(_),mt();let S=at(),V=await $t();if(V)try{if(V.focus(),V.innerHTML.trim()==="<p><br></p>"||V.innerHTML.trim()==="<br>"||V.innerText.trim()===""){let le=document.createRange();le.selectNodeContents(V);let W=window.getSelection();W.removeAllRanges(),W.addRange(le),document.execCommand("delete",!1,null)}else if(!V.innerHTML.endsWith("<br><br>")){let le=document.createRange();le.selectNodeContents(V),le.collapse(!1);let W=window.getSelection();W.removeAllRanges(),W.addRange(le),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,_),Ht(V),setTimeout(()=>{oe(j("inserido_copiado"))},600);let re=typeof Fe<"u"&&Fe?Fe.checked:!0;if(y&&tt[y]&&re){let le=tt[y];await Ft(le),await new Promise(W=>setTimeout(W,500))}S(),ut(1.5),A.value="",T.innerHTML=`<option value="">${j("select_substatus")}</option>`,T.disabled=!0}catch(te){console.error(te),oe("Erro ao inserir.",{error:!0}),S()}};function ut(y=1.5){y<=1.5&&(Me.style.display="none",he.innerHTML=""),y<=2&&(xe.style.display="none",s.reset(),pe.style.display="none"),y<=3&&(Ae.style.display="none",ke.innerHTML="",a.reset(),qe.style.display="none",De.style.display="none")}function mt(){if(r=!r,r){let y=l.querySelector(".cw-expand-btn");y&&typeof y.resetState=="function"&&y.resetState()}_e(r,l,"cw-btn-notes")}return lt("bau"),ct("pt"),mt}var Pe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let D=A.querySelector("#csa-back-btn");D.onmouseover=()=>D.style.backgroundColor="#f1f3f4",D.onmouseout=()=>D.style.backgroundColor="transparent",D.onclick=R;let I=A.querySelector("#csa-insert-btn");I.onmouseover=()=>I.style.backgroundColor="#174ea6",I.onmouseout=()=>I.style.backgroundColor="#1a73e8",I.onclick=async()=>{I.style.transform="scale(0.96)",p();let Z=at();try{await vt(P),Z()}catch(K){console.error(K),Z()}setTimeout(()=>{I.style.transform="scale(1)",R()},300)}}function R(){o="list",M.style.transform="translateX(0)"}function T(){b.innerHTML="",Object.keys(Pe).forEach(P=>{let q=Pe[P],O=document.createElement("button");O.textContent=q.title,Object.assign(O.style,h),t===P&&n===""&&Object.assign(O.style,m),O.onclick=()=>{t=P,n="",u.value="",T(),z()},b.appendChild(O)})}function z(){g.innerHTML="";let P=[];if(n.trim()!==""?Object.values(Pe).forEach(D=>{let I=D.emails.filter(Z=>Z.name.toLowerCase().includes(n.toLowerCase()));P=[...P,...I]}):Pe[t]&&(P=Pe[t].emails),P.length===0){g.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let q='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',O='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';P.forEach(D=>{let I=document.createElement("div");Object.assign(I.style,c);let Z=D.subject.length>50?D.subject.substring(0,50)+"...":D.subject;I.innerHTML=`
        <div style="flex-grow: 1; margin-right: 12px; min-width: 0;">
            <div style="font-size:13px; font-weight:600; color:#202124; margin-bottom:2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${D.name}</div>
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function Qt(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",r="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",Object.assign(a.style,Oe,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",boxShadow:"none",opacity:"0",pointerEvents:"none"});let s={popup:a,googleLine:null};function l(){i=!i,_e(i,a,"cw-btn-script")}let h=Re(a,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",s,()=>{l()});a.appendChild(h);let m=document.createElement("div");Object.assign(m.style,t.progressBarContainer);let c=document.createElement("div");Object.assign(c.style,t.progressBarFill),m.appendChild(c),a.appendChild(m);let E=document.createElement("div");E.id="csa-content",Object.assign(E.style,t.contentArea),a.appendChild(E);let f=document.createElement("div");Object.assign(f.style,t.footer);let x=document.createElement("span");x.textContent="by lucaste@",Object.assign(x.style,{fontSize:"10px",color:"#bdc1c6"});let p=document.createElement("button");p.innerHTML=`
  ...
  `,Object.assign(p.style,t.resetBtn),p.onmouseenter=()=>p.style.background="#fce8e6",p.onmouseleave=()=>p.style.background="transparent",p.onclick=()=>{p.style.transform="scale(0.9)",setTimeout(()=>p.style.transform="scale(1)",150);for(let R in n)delete n[R];v()},f.appendChild(x),f.appendChild(p),a.appendChild(f);let C=document.createElement("div");Object.assign(C.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let w=document.createElement("div");Object.assign(w.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let M=document.createElement("div");M.textContent="BAU";let G=document.createElement("div");G.textContent="LT",Object.assign(M.style,de),Object.assign(G.style,de),w.appendChild(M),w.appendChild(G);let d=document.createElement("select");Object.assign(d.style,We,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),d.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',d.value=o,C.appendChild(w),C.appendChild(d),E.appendChild(C);let u=document.createElement("div");u.id="csa-checklist-area",E.appendChild(u);let b=document.createElement("div");Object.assign(b.style,Je),b.className="no-drag",b.title="Redimensionar",a.appendChild(b),et(a,b),document.body.appendChild(a);function g(R){return R}function v(){u.innerHTML="";let R=`${o} ${r}`,T=Kt[R];if(!T){u.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        </div>`;return}b.forEach((v,A)=>{let k=document.createElement("div");Object.assign(k.style,s);let U=document.createElement("div");Object.assign(U.style,l),U.textContent=v._catIcon||"\u{1F517}",k.appendChild(U);let R=document.createElement("div");R.style.flexGrow="1";let T=I=>{if(!g)return I;let Z=new RegExp(`(${n})`,"gi");return I.replace(Z,'<span style="color:#1a73e8; font-weight:700;">$1</span>')},z=`<div style="font-size:14px; font-weight:500; color:#202124;">${T(v.name)}</div>`,P=`<div style="font-size:11px; color:#5f6368; margin-top:2px;">${T(v.desc)}</div>`;R.innerHTML=z+P,k.appendChild(R);let q=document.createElement("div");q.style.display="flex",q.style.gap="4px",q.style.opacity="0",q.style.transition="opacity 0.2s";let O=document.createElement("div");O.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',Object.assign(O.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#5f6368",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"}),O.onclick=I=>{me.playClick(),I.stopPropagation(),navigator.clipboard.writeText(v.url),O.style.transform="scale(1.2)",O.style.color="#1e8e3e",O.style.backgroundColor="#e6f4ea",setTimeout(()=>{O.style.transform="scale(1)",O.style.color="#5f6368",O.style.backgroundColor="transparent"},800)},O.onmouseenter=()=>O.style.backgroundColor="#f1f3f4",O.onmouseleave=()=>O.style.backgroundColor="transparent",q.appendChild(O);let D=document.createElement("div");D.innerHTML="\u2197",Object.assign(D.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",color:"#dadce0",fontSize:"16px"}),q.appendChild(D),k.appendChild(q),k.onclick=()=>window.open(v.url,"_blank"),k.onmouseenter=()=>{k.style.backgroundColor="#f8f9fa",k.style.transform="scale(1.01)",q.style.opacity="1",D.style.color="#1a73e8"},k.onmouseleave=()=>{k.style.backgroundColor="#ffffff",k.style.transform="scale(1)",q.style.opacity="0",D.style.color="#dadce0"},w.appendChild(k),requestAnimationFrame(()=>{k.style.transition="opacity 0.3s ease, transform 0.3s cubic-bezier(0.2, 0.9, 0.3, 1.2)",setTimeout(()=>{k.style.opacity="1",k.style.transform="translateY(0)"},A*40)})})}p.addEventListener("input",b=>{n=b.target.value,n!==""?Array.from(C.children).forEach(g=>{g.style.backgroundColor="transparent",g.style.color="#5f6368",g.style.borderColor="#dadce0"}):G(),d()});function u(){E=!E,_e(E,h,"cw-btn-links")}return G(),d(),u}function uo(){if(window.techSolInitialized){xt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Lt(),xt();let e=Yt(),t=Xt(),n=Qt(),o=Zt();jt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),oe("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}uo();})();

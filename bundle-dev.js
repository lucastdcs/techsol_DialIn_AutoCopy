(()=>{var nt="",bo=e=>new Promise(t=>setTimeout(t,e));async function Mt(){if(nt)return nt;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await bo(100);let t="Consultor",n=document.querySelector("profile-details .name");if(n)t=n.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let a=o.src.match(/\/photos\/([^\?]+)/)[1];t=a.charAt(0).toUpperCase()+a.slice(1)}}return e.click(),document.body.click(),nt=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function ft(){return nt||"Consultor"}function Dt(e){let t=new Date,n=t.getHours(),o=t.getDay(),a="Ol\xE1",r="";n>=5&&n<12?(a="Bom dia",r='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):n>=12&&n<18?(a="Boa tarde",r='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(a="Boa noite",r='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let i=[];n>=0&&n<5?i=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:n<12?o===1?i=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?i=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:i=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:n<18?i=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:i=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(i=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let l=i[Math.floor(Math.random()*i.length)];return{prefix:`${a},`,name:e,suffix:l,icon:r,isFriday:o===5}}function ht(){let e="Cliente",t="[INSERIR URL]";try{let o=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let a=o.nextElementSibling.innerText.trim();a&&(e=a)}}catch(n){console.warn("Falha ao capturar Nome:",n)}try{let o=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let a=o.nextElementSibling.innerText.trim();a&&(t=a)}}catch(n){console.warn("Falha ao capturar Website:",n)}return{advertiserName:e,websiteUrl:t,agentName:ft()}}var je=null,xt=null,Oe=.3;function Re(){if(!je){let e=window.AudioContext||window.webkitAudioContext;e&&(je=new e)}return je&&je.state==="suspended"&&je.resume(),je}function Ft(e){if(xt)return xt;let t=e.sampleRate*2,n=e.createBuffer(1,t,e.sampleRate),o=n.getChannelData(0);for(let a=0;a<t;a++)o[a]=Math.random()*2-1;return xt=n,n}var J={playClick:()=>{let e=Re();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Ft(e);let o=e.createBiquadFilter();o.type="highpass",o.frequency.value=4e3;let a=e.createGain();a.gain.setValueAtTime(Oe*.8,t),a.gain.exponentialRampToValueAtTime(.001,t+.015),n.connect(o),o.connect(a),a.connect(e.destination),n.start(t),n.stop(t+.02)},playHover:()=>{let e=Re();if(!e)return;let t=e.currentTime,n=e.createOscillator();n.type="sine",n.frequency.setValueAtTime(400,t);let o=e.createGain();o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(Oe*.1,t+.005),o.gain.linearRampToValueAtTime(0,t+.02),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.03)},playSuccess:()=>{let e=Re();if(!e)return;let t=e.currentTime;[1046.5,1567.9].forEach((o,a)=>{let r=e.createOscillator(),i=e.createGain();r.type="sine",r.frequency.value=o,i.gain.setValueAtTime(0,t),i.gain.linearRampToValueAtTime(Oe*.6,t+.05),i.gain.exponentialRampToValueAtTime(.001,t+.6),r.connect(i),i.connect(e.destination),r.start(t),r.stop(t+.7)})},playGenieOpen:()=>{let e=Re();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Ft(e);let o=e.createBiquadFilter();o.type="lowpass",o.frequency.setValueAtTime(100,t),o.frequency.exponentialRampToValueAtTime(800,t+.2);let a=e.createGain();a.gain.setValueAtTime(0,t),a.gain.linearRampToValueAtTime(Oe*.5,t+.05),a.gain.linearRampToValueAtTime(0,t+.25),n.connect(o),o.connect(a),a.connect(e.destination),n.start(t),n.stop(t+.3)},playError:()=>{let e=Re();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="triangle",n.frequency.setValueAtTime(120,t),n.frequency.exponentialRampToValueAtTime(80,t+.1),o.gain.setValueAtTime(Oe,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.2)},playStartup:()=>{let e=Re();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="sine",n.frequency.value=440;let a=e.createBiquadFilter();a.type="lowpass",a.frequency.value=200,o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(Oe*.4,t+.8),o.gain.linearRampToValueAtTime(0,t+1.6),n.connect(a),a.connect(o),o.connect(e.destination),n.start(t),n.stop(t+2)},playStartup:()=>{let e=Re();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.connect(o),o.connect(e.destination),n.type="sine",n.frequency.setValueAtTime(120,t),n.frequency.exponentialRampToValueAtTime(40,t+.15),o.gain.setValueAtTime(Oe*1.5,t),o.gain.exponentialRampToValueAtTime(.001,t+.3),n.start(t),n.stop(t+.3),[55,55.4,110].forEach((r,i)=>{let l=e.createOscillator(),p=e.createGain(),m=e.createBiquadFilter();l.type="sawtooth",l.frequency.value=r,m.type="lowpass",m.frequency.setValueAtTime(100,t),m.frequency.linearRampToValueAtTime(600,t+.3),m.frequency.exponentialRampToValueAtTime(100,t+2.5),l.connect(m),m.connect(p),p.connect(e.destination),p.gain.setValueAtTime(0,t),p.gain.linearRampToValueAtTime(Oe*.4,t+.1),p.gain.exponentialRampToValueAtTime(.001,t+3.5),l.start(t),l.stop(t+3.6)})},playNotification:()=>{let e=Re();if(!e)return;let t=e.currentTime;[{freq:880,dur:1.2,vol:.6},{freq:1760,dur:.6,vol:.3}].forEach(o=>{let a=e.createOscillator(),r=e.createGain();a.type="sine",a.frequency.setValueAtTime(o.freq,t),r.gain.setValueAtTime(0,t),r.gain.linearRampToValueAtTime(Oe*o.vol,t+.004),r.gain.exponentialRampToValueAtTime(.001,t+o.dur),a.connect(r),r.connect(e.destination),a.start(t),a.stop(t+o.dur+.1)})},playSwoosh:()=>{J.playGenieOpen()},playReset:()=>{J.playError()},initGlobalListeners:()=>{if(window._cwSoundListenersActive)return;window._cwSoundListenersActive=!0;let e=0,t=50;document.addEventListener("mouseover",n=>{if(!je)return;let o=n.target.closest('button, a, input[type="checkbox"], .cw-btn, .cw-hero-card, .cw-task-item, [data-sound="hover"]');if(!o||o.contains(n.relatedTarget))return;let a=Date.now();a-e<t||(J.playHover(),e=a)},{passive:!0})}};var Gt=1e4;function Bt(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
        :root {
            --cw-primary: #1a73e8;
...
.cw-dropdown-option.selected { 
    ...
    `,document.head.appendChild(t)}function oe(e,t={}){let n=document.createElement("div"),o=t.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(n.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:o,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",pointerEvents:"none"}),n.textContent=e,document.body.appendChild(n),t.error?J.playError():J.playSuccess(),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>n.remove(),400)},t.duration||4e3)}function jt(e,t=null){let n=0,o=0,a=0,r=0,i=t||e;i.style.cursor="grab",i.onmousedown=l;function l(w){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(w.target.tagName)||w.target.closest(".no-drag"))return;w=w||window.event,i.style.cursor="grabbing",e.style.transition="none";let u=e.getBoundingClientRect();e.style.transform="none",e.style.left=u.left+"px",e.style.top=u.top+"px",e.style.margin="0",e.style.bottom="auto",e.style.right="auto",Gt++,e.style.zIndex=Gt,a=w.clientX,r=w.clientY,e.setAttribute("data-dragging","true"),document.onmouseup=m,document.onmousemove=p}function p(w){w=w||window.event,w.preventDefault(),n=a-w.clientX,o=r-w.clientY,a=w.clientX,r=w.clientY;let u=e.offsetTop-o,O=e.offsetLeft-n,h=16,f=window.innerWidth,x=window.innerHeight,E=e.offsetWidth,I=e.offsetHeight;O<h?O=h:O+E>f-h&&(O=f-E-h),u<h?u=h:u+I>x-h&&(u=x-I-h),e.style.top=u+"px",e.style.left=O+"px"}function m(){document.onmouseup=null,document.onmousemove=null,i.style.cursor="grab",setTimeout(()=>{e.style.transition="all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease",e.setAttribute("data-dragging","false"),e.setAttribute("data-moved","true")},50)}}var we={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:"99999",overflow:"hidden",backgroundColor:"rgba(255, 255, 255, 0.98)",backdropFilter:"blur(20px)",webkitBackdropFilter:"blur(20px)",borderRadius:"16px",boxShadow:`
    0 0 1px rgba(0,0,0,0.08), 
    0 8px 24px rgba(0,0,0,0.12),
    0 20px 60px rgba(0,0,0,0.08)
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var vt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Pt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var qt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var me={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var yt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],zt=-1;function Ze(){let e=Math.floor(Math.random()*yt.length);return e===zt&&(e=(e+1)%yt.length),zt=e,yt[e]}var Ie=e=>new Promise(t=>setTimeout(t,e));async function fo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let n=e.querySelector(".cursor");await Ie(200);for(let o=0;o<t.length;o++){let a=t.charAt(o),r=document.createElement("span");r.textContent=a,n&&n.parentNode===e?n.before(r):e.appendChild(r);let i=Math.floor(Math.random()*60)+30;o===0&&(i=150),o>t.length-3&&(i=30),await Ie(i)}await Ie(600),n&&(n.style.display="none")}async function wt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var pe=e=>new Promise(t=>setTimeout(t,e));function Me(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function it(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,a=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&a})}async function Vt(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(l=>l.innerText.trim()==="email");if(n&&n.offsetParent!==null){let l=n.closest("material-button")||n.closest("material-fab")||n;l.style&&(l.style.display="block",l.style.visibility="visible"),Me(l),e=!0}else{let l=document.querySelector("material-fab-speed-dial");if(l){let p=l.querySelector(".trigger");if(p){p.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Me(p),await pe(1e3);let w=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");w&&(Me(w),e=!0)}else l.click()}}let o=0,a=it();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!a&&o<30;)await pe(500),a=it(),o++;if(!a)return oe("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let i=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(l=>l.offsetParent!==null);if(i){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),Me(i);let l=null,p=0;for(;!l&&p<10;)await pe(200),l=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(w=>w.offsetParent!==null),p++;l?(console.log("\u2705 Confirmando descarte..."),Me(l),await pe(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(a){let l=a.closest('[id="email-body-content-top"]'),m=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(l){if(m){let u=m.closest('[aria-hidden="true"]');u&&u.removeAttribute("aria-hidden"),m.focus()}await pe(300),l.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let w=l.querySelector("#cases-body-field");if(w){let u=document.createRange();u.selectNodeContents(w),u.collapse(!0);let O=window.getSelection();O.removeAllRanges(),O.addRange(u)}return!0}}return oe("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function $t(e){if(!e)return;oe("Preparando email...",{duration:3e3});let t=ht();if(!await Vt())return;await pe(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await pe(200),Me(o),await pe(1500);let a=document.querySelector("material-auto-suggest-input input");if(a){Me(a),await pe(200),document.execCommand("insertText",!1,e),a.dispatchEvent(new Event("input",{bubbles:!0}));let r=null,i=0;for(;i<20;){await pe(500),i++;let l=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(l.length>0&&(r=l.find(p=>p.innerText.toLowerCase().includes(e.toLowerCase())),!r&&l.length===1&&(r=l[0]),r))break}if(r){let l=function(u,O){if(u.nodeType===3&&u.nodeValue.includes(O))return u;if(!u.childNodes)return null;for(let h of u.childNodes){let f=l(h,O);if(f)return f}return null};Me(r),await pe(2e3);let p=it(),m=p?p.closest('[id="email-body-content-top"]'):document.body,w=l(m,"{%ADVERTISER_NAME%}");if(w){let u=document.createRange(),O=w.nodeValue.indexOf("{%ADVERTISER_NAME%}");u.setStart(w,O),u.setEnd(w,O+19);let h=window.getSelection();h.removeAllRanges(),h.addRange(u),document.execCommand("insertText",!1,t.advertiserName),oe("Email preenchido!")}else oe("Email inserido (Nome n\xE3o substitu\xEDdo).")}else oe(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else oe("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function Ct(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),oe("Preparando email...",{duration:3e3});let t=ht(),n=ft();if(!await Vt())return;await pe(600);let a=document.querySelector('input[aria-label="Subject"]');a&&e.subject&&(a.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(a,e.subject),a.dispatchEvent(new Event("input",{bubbles:!0})),await pe(300));let r=it();if(r){let l=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');l&&(l.focus(),l.click(),l.dispatchEvent(new Event("input",{bubbles:!0}))),await pe(400);let p=new Date;p.setDate(p.getDate()+3);let m=p.getDay();m===6?p.setDate(p.getDate()+2):m===0&&p.setDate(p.getDate()+1);let w=p.toLocaleDateString("pt-BR"),u=e.body;u=u.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),u=u.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),u=u.replace(/\[URL\]/g,t.websiteUrl||"seu site"),u=u.replace(/\[Seu Nome\]/g,n),u=u.replace(/\[MM\/DD\/YYYY\]/g,w),document.execCommand("insertHTML",!1,u),l&&(l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))),oe("Email preenchido com sucesso!",{duration:2e3}),await pe(800)}else oe("Erro ao focar no editor.",{error:!0})}var ho={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Ut={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Ce(e,t,n,o,a,r){let i=document.createElement("div");Object.assign(i.style,ho),jt(e,i);let l=document.createElement("div");Object.assign(l.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),i.appendChild(l),a&&(a.googleLine=l);let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center",gap:"12px"});let m=document.createElement("img");m.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(m.style,{width:"20px",height:"20px",pointerEvents:"none"});let w=document.createElement("span");w.textContent=t,p.appendChild(m),p.appendChild(w);let u=document.createElement("div");Object.assign(u.style,{display:"flex",alignItems:"center",gap:"4px"});let O='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',h='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',f=document.createElement("div");f.innerHTML=O,Object.assign(f.style,Ut),f.title="Sobre",f.classList.add("no-drag"),f.onmouseenter=()=>{f.style.background="rgba(255,255,255,0.1)",f.style.color="#FFF"},f.onmouseleave=()=>{f.style.color!=="rgb(138, 180, 248)"&&(f.style.background="transparent",f.style.color="#9AA0A6")};let x=document.createElement("div");x.innerHTML=h,Object.assign(x.style,Ut),x.title="Fechar",x.classList.add("no-drag"),x.onmouseenter=()=>{x.style.background="rgba(242, 139, 130, 0.2)",x.style.color="#F28B82"},x.onmouseleave=()=>{x.style.background="transparent",x.style.color="#9AA0A6"},x.onmousedown=I=>I.stopPropagation(),f.onmousedown=I=>I.stopPropagation(),x.onclick=r;let E=xo(e,t,n,o);return f.onclick=I=>{I.stopPropagation(),E.style.opacity==="1"?(E.style.opacity="0",E.style.pointerEvents="none",f.style.color="#9AA0A6",f.style.background="transparent"):(E.style.opacity="1",E.style.pointerEvents="auto",f.style.color="#8AB4F8",f.style.background="rgba(138, 180, 248, 0.1)")},u.appendChild(f),u.appendChild(x),i.appendChild(p),i.appendChild(u),i}function xo(e,t,n,o){let a=document.createElement("div");return Object.assign(a.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),a.innerHTML=`
    ...
    `,setTimeout(()=>{let r=a.querySelector("#close-help-internal");r&&(r.onmouseover=()=>r.style.backgroundColor="#f8f9fa",r.onmouseout=()=>r.style.backgroundColor="white",r.onclick=()=>{a.style.opacity="0",a.style.pointerEvents="none"})},0),e.appendChild(a),a}if(!document.getElementById("cw-module-styles")){let e=document.createElement("style");e.id="cw-module-styles",e.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
    ...
    `,document.head.appendChild(e)}function Ae(e,t,n){let o=document.getElementById(n);if(!t)return;let a=t.getAttribute("data-moved")==="true",r={x:0,y:0};if(o){let w=o.getBoundingClientRect();r.x=w.left+w.width/2,r.y=w.top+w.height/2}let i,l;if(!a)i=window.innerWidth/2,l=window.innerHeight/2;else{let w=t.getBoundingClientRect();i=w.left+w.width/2,l=w.top+w.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let p=r.x-i,m=r.y-l;e?(J.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",a?t.style.transform=`translate(${p}px, ${m}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${m}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",a?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof Wt=="function"&&Wt(t,n)):(J.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",a?t.style.transform=`translate(${p}px, ${m}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${m}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof At=="function"&&At(t))}function Wt(e,t){At(e);let n=o=>{if(!e.classList.contains("open"))return;let a=e.contains(o.target),r=document.querySelector(".cw-pill"),i=r&&r.contains(o.target);a?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function At(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var Kt="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",Et="cw_data_broadcast",Yt="cw_data_tips",yo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function Xt(e){return new Promise((t,n)=>{let o="cw_cb_"+Math.round(1e4*Math.random()),a=document.createElement("script");window[o]=r=>{document.body.removeChild(a),delete window[o],t(r)},a.src=`${Kt}?op=${e}&callback=${o}&t=${Date.now()}`,a.onerror=()=>{document.body.removeChild(a),delete window[o],n(new Error("JSONP Load Error"))},document.body.appendChild(a)})}var Pe={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await Xt("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(Yt,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await Xt("broadcast");if(e&&e.broadcast)return localStorage.setItem(Et,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(Et)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Et)||"[]"),getRandomTip:()=>{let e=yo,t=localStorage.getItem(Yt);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let o={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(Kt,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(o)}).catch(a=>console.log("Log fail",a))}};var ne={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},st=e=>new Promise(t=>setTimeout(t,e));function Qt(e){let t="cw-command-center-style";if(!document.getElementById(t)){let h=document.createElement("style");h.id=t,h.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let w=l.querySelector(".cw-hero-grid"),u=l.querySelector(".cw-acc-container"),O=l.querySelector(".cw-results-container"),h=l.querySelector(".cw-search-input"),f=l.querySelector(".cw-status-bar"),x=l.querySelector(".cw-status-text"),E=l.querySelector(".cw-footer-icons");a.forEach(([g,b])=>{let s=o(b.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${g}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=S=>{if(S.target.closest(".cw-step-btn"))return;let d=t[g]?t[g].count:0;R(g,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>R(g,-1,b),c.querySelector(".plus").onclick=()=>R(g,1,b),c.dataset.color=s.color,w.appendChild(c)});function I(g,b){let s=o(b.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=g,c.innerHTML=`
        ...
        `,c.onclick=S=>{if(S.target.closest(".cw-step-btn"))return;let d=t[g]?t[g].count:0;R(g,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>R(g,-1,b),c.querySelector(".plus").onclick=()=>R(g,1,b),c}Object.entries(r).forEach(([g,b])=>{let s=document.createElement("div");s.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${b.brand.color}"></div>
                ${g}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{u.querySelectorAll(".cw-acc-group.open").forEach(d=>{d!==s&&d.classList.remove("open")}),s.classList.toggle("open")};let S=document.createElement("div");S.className="cw-acc-body",b.tasks.forEach(d=>{let y=I(d.key,d);S.appendChild(y)}),s.appendChild(c),s.appendChild(S),u.appendChild(s)});function R(g,b,s){t[g]||(t[g]={count:0,data:s,brand:o(s.name)}),t[g].count+=b,t[g].count<=0&&delete t[g],j(),V(),e&&e()}function j(){a.forEach(([S])=>{let d=w.querySelector(`#hero-${S}`);if(!d)return;let y=t[S];y?(d.classList.add("active"),d.querySelector(".cw-step-val").textContent=y.count,d.querySelector(".cw-step-val").style.color=d.dataset.color):d.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(S=>{let d=S.dataset.id,y=t[d];y?(S.classList.add("selected"),S.querySelector(".cw-step-val").textContent=y.count):S.classList.remove("selected")});let b=Object.keys(t),s=0,c=[];if(b.forEach(S=>{let d=t[S];s+=d.count;for(let y=0;y<d.count;y++)c.length<6&&c.push(d.brand)}),s>0){f.classList.add("visible");let S=s>1?"A\xE7\xF5es":"A\xE7\xE3o",d=s>1?"definidas":"definida";x.textContent=`${s} ${S} ${d}`,E.innerHTML="",c.forEach(y=>{let k=document.createElement("div");k.className="cw-mini-icon",k.innerHTML=qe[y.icon]||qe.default;let v=k.querySelector("svg");v&&(v.style.width="14px",v.style.height="14px"),E.appendChild(k)})}else f.classList.remove("visible")}h.addEventListener("input",g=>{let b=g.target.value.toLowerCase();if(b.length>0){u.style.display="none",O.style.display="block",O.innerHTML="";let s=!1;Object.entries(Le).forEach(([c,S])=>{if(S.name.toLowerCase().includes(b)){s=!0;let d=I(c,S);t[c]&&(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=t[c].count),O.appendChild(d)}}),s||(O.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else u.style.display="block",O.style.display="none"});function V(){m.innerHTML="";let g=Object.keys(t),b=!1,s=document.getElementById("sub-status"),c="implementation";if(s&&s.value.toLowerCase().includes("education")&&(c="education"),g.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(g.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let S=document.createElement("div");S.className="cw-info-banner",S.innerHTML=`
...
\u2022 `)?(D.preventDefault(),this.value=H.substring(0,A-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=A-3):H==="\u2022 "&&(D.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function mt(){let C=typeof ye<"u"?ye:document.getElementById("snippet-container");if(!C)return;let D=C.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),A={},H=new Set;D.forEach(X=>{let $=X.id,F=Se[$];if(F)for(let L in F)L==="linkedTask"?H.add(F.linkedTask):L!=="type"&&(A[L]||(A[L]=[]),A[L].includes(F[L])||A[L].push(F[L]))});let te=new Set;Object.values(Se).forEach(X=>{Object.keys(X).forEach($=>{$!=="linkedTask"&&$!=="type"&&te.add($)})}),te.forEach(X=>{let $=document.getElementById(X);if($){let F=A[X]||[],L="";tt.includes(X.replace("field-",""))?(L=F.map(U=>U.startsWith("\u2022 ")?U:"\u2022 "+U).join(`
`),L===""?L="\u2022 ":L.endsWith(`
\u2022 `)||(L+=`
\u2022 `)):L=F.join(`

`),L.trim()!=="\u2022"&&L.trim()!==""?$.value=L:tt.includes(X.replace("field-",""))?$.value="\u2022 ":$.value="",$.tagName==="TEXTAREA"&&typeof ut=="function"&&ut($)}});let le=new Set,he=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(X=>{let $=Se[X.id];$&&$.linkedTask&&(X.checked?le.add($.linkedTask):he.add($.linkedTask))}),he.forEach(X=>{le.has(X)||l.toggleTask(X,!1)}),le.forEach(X=>{l.toggleTask(X,!0)})}S.onchange=()=>{let C=S.value;if(gt(1.5),v.innerHTML=`<option value="">${P("select_substatus")}</option>`,!C){v.disabled=!0;return}for(let D in et){let A=et[D];if(A.status===C){let H=document.createElement("option");H.value=D,H.textContent=A.name,v.appendChild(H)}}v.disabled=!1},v.onchange=()=>{let C=v.value;if(gt(1.5),!C)return;l.updateSubStatus(C);let D=et[C];ye.innerHTML="";let A=(F,L,U)=>{let se=document.createElement("label");Object.assign(se.style,r.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let Q=document.createElement("input");return Q.type=L,Q.id=F.id,Object.assign(Q.style,r.checkboxInput),se.appendChild(Q),se.appendChild(document.createTextNode(` ${F.text}`)),U.appendChild(se),Q},H=[],te="radio";if(C==="NI_Awaiting_Inputs")H=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))te="checkbox",H=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(C.startsWith("AS_")){te="checkbox";let F=document.createElement("label");F.textContent=P("cenarios_comuns"),Object.assign(F.style,r.label),ye.appendChild(F),H=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")&&(H=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let le=H.filter(F=>{let L=Se[F.id];return!L.type||L.type==="all"||L.type===t});le.forEach((F,L)=>{let U=A(F,te,ye);te==="radio"&&(U.name="scenario-radio-group",L===0&&(U.checked=!0))}),le.length>0&&(Fe.style.display="block"),D.requiresTasks?(be.style.display="none",$e.style.display="block",l.selectionElement.style.display="block",ve.style.display="block"):(be.style.display="block",$e.style.display="none",l.selectionElement.style.display="none",ve.style.display="block"),_e.innerHTML="";let he=D.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(he)].forEach(F=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(F))return;let L=F.slice(1,-1),U=document.createElement("label"),se=P(L.toLowerCase());U.textContent=se!==L.toLowerCase()?se:L.replace(/_/g," ").replace(/\b\w/g,re=>re.toUpperCase())+":",Object.assign(U.style,r.label);let Q;tt.includes(L)?(Q=document.createElement("textarea"),Object.assign(Q.style,r.textarea),Q.classList.add("bullet-textarea"),ut(Q)):St.includes(L)?(Q=document.createElement("textarea"),Object.assign(Q.style,r.textarea)):(Q=document.createElement("input"),Q.type="text",Object.assign(Q.style,r.input),L==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign(U.style,{display:"none"}),Object.assign(Q.style,{display:"none"}))),L==="ON_CALL"&&t==="lm"&&(Object.assign(U.style,{display:"none"}),Object.assign(Q.style,{display:"none"}),Q.value="N/A"),Q.id=`field-${L}`,_e.appendChild(U),_e.appendChild(Q)});let X=ye.querySelectorAll('input[type="checkbox"], input[type="radio"]');X.length>0&&(X.forEach(F=>{F.removeEventListener("change",mt),F.addEventListener("change",mt)}),mt()),ke.style.display="block",at[C]?Ge.style.display="block":Ge.style.display="none",Ue.style.display="flex";let $=l.getCheckedElements().map(F=>F.value);i.updateVisibility(C,$)},be.onclick=()=>{be.style.display="none",$e.style.display="block",l.selectionElement.style.display="block"};function Nt(){let C=v.value;if(!C)return null;let A=et[C].template.replace(/\n/g,"<br>"),H='style="margin-bottom: 12px; padding-left: 30px;"',te=[],le="",he=l.getCheckedElements();he.length>0&&he.forEach($=>{let F=$.value,L=Le[F],U=$.closest().querySelector(".stepper-count"),se=U?parseInt(U.textContent):1;se>1?te.push(`${L.name} (x${se})`):te.push(L.name)});let de=l.screenshotsElement;if(de){let $=Array.from(de.querySelectorAll('input[id^="name-"]'));$.length>0&&$.forEach(F=>{let L=F.value,U=F.closest(".cw-screen-card");if(U){let se=U.querySelectorAll('input[id^="screen-"]'),Q=!1,re="";se.forEach(fe=>{let _t=fe.closest(".cw-input-group"),Rt=_t?_t.querySelector(".cw-input-label"):null,mo=Rt?Rt.textContent:"Evid\xEAncia",Lt=fe.value.trim(),go=Lt?` ${Lt}`:"";re+=`<li>${mo} -${go}</li>`,Q=!0}),Q&&(le+=`<b>${L}</b>`,le+=`<ul ${H}>${re}</ul>`)}})}if(A.includes("{TAGS_IMPLEMENTED}")?A=A.replace(/{TAGS_IMPLEMENTED}/g,te.join(", ")||"N/A"):te.length>0&&(A+=`<br><b>Tags:</b> ${te.join(", ")}<br>`),A.includes("{SCREENSHOTS_LIST}")?A=A.replace(/{SCREENSHOTS_LIST}/g,le?`${le}`:"N/A"):le!==""&&(A+=`<br>${le}`),n==="pt"&&o){let $=xe.checked?P("sim"):P("nao");A=A.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${P("consentiu_gravacao")}</b> ${$}<br><br>`),A=A.replace(/{CASO_PORTUGAL}/g,`<br><b>${P("caso_portugal")}</b> ${P("sim")}<br>`)}else n==="pt"&&!o?(A=A.replace(/{CASO_PORTUGAL}/g,`<br><b>${P("caso_portugal")}</b> ${P("nao")}<br>`),A=A.replace(/{CONSENTIU_GRAVACAO}/g,"")):(A=A.replace(/{CASO_PORTUGAL}/g,""),A=A.replace(/{CONSENTIU_GRAVACAO}/g,""));return _e.querySelectorAll("input, textarea").forEach($=>{let F=$.id.replace("field-",""),L=new RegExp(`{${F}}`,"g"),U=$.value;if(F==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let re=ye.querySelector('input[type="radio"]:checked');re&&Se[re.id]&&(U=Se[re.id]["field-REASON_COMMENTS"])}if(tt.includes(F)&&U.trim()!==""){let re=U.split(`
`).map(fe=>fe.trim()).filter(fe=>fe!==""&&fe!=="\u2022").map(fe=>fe.startsWith("\u2022 ")?fe.substring(2):fe).map(fe=>`<li>${fe}</li>`).join("");U=re?`<ul ${H}>${re}</ul>`:""}else St.includes(F)?U=U.split(`
`).filter(re=>re.trim()!=="").map(re=>`<p style="margin: 0 0 8px 0;">${re}</p>`).join(""):$.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let se=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let re=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${F}\\}(?:<br>\\s*)?`,"gi");re.test(A)?A=A.replace(re,""):A=A.replace(L,"")}else A=A.replace(L,U.replace(/\$/g,"$$$$"))}),A=A.replace(/{([A-Z0-9_]+)}/g,""),A=A.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(A+=i.getOutput()),A}Ke.onclick=()=>{let C=Nt();C?(Tt(C),oe(P("copiado_sucesso"))):oe(P("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=v.value,D=Nt();if(!D){oe(P("selecione_substatus"),{error:!0});return}Tt(D),bt();let A=Xe(),H=await oo();if(H)try{if(H.focus(),H.innerHTML.trim()==="<p><br></p>"||H.innerHTML.trim()==="<br>"||H.innerText.trim()===""){let de=document.createRange();de.selectNodeContents(H);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("delete",!1,null)}else if(!H.innerHTML.endsWith("<br><br>")){let de=document.createRange();de.selectNodeContents(H),de.collapse(!1);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,D),to(H),setTimeout(()=>{oe(P("inserido_copiado"))},600);let le=typeof Be<"u"&&Be?Be.checked:!0;if(C&&at[C]&&le){let de=at[C];await $t(de),await new Promise(X=>setTimeout(X,500))}A(),gt(1.5),S.value="",v.innerHTML=`<option value="">${P("select_substatus")}</option>`,v.disabled=!0}catch(te){console.error(te),oe("Erro ao inserir.",{error:!0}),A()}};function gt(C=1.5){C<=1.5&&(Fe.style.display="none",ye.innerHTML=""),C<=2&&(ve.style.display="none",l.reset(),be.style.display="none"),C<=3&&(ke.style.display="none",_e.innerHTML="",i.reset(),Ue.style.display="none",Ge.style.display="none")}function bt(){if(a=!a,a){let C=p.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Ae(a,p,"cw-btn-notes")}return dt("bau"),pt("pt"),bt}var He={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let B=S.querySelector("#csa-back-btn");B.onmouseover=()=>B.style.backgroundColor="#f1f3f4",B.onmouseout=()=>B.style.backgroundColor="transparent",B.onclick=k;let _=S.querySelector("#csa-insert-btn");_.onmouseover=()=>_.style.backgroundColor="#174ea6",_.onmouseout=()=>_.style.backgroundColor="#1a73e8",_.onclick=async()=>{console.log("\u{1F50D} DEBUG: Clique detectado"),console.log("\u{1F50D} DEBUG: triggerProcessingAnimation \xE9:",typeof Xe),_.style.transform="scale(0.96)",x(),console.log("\u{1F50D} DEBUG: Janela fechada");try{console.log("\u{1F50D} DEBUG: Chamando anima\xE7\xE3o...");let W=Xe();console.log("\u{1F50D} DEBUG: finishLoading \xE9:",typeof W),console.log("\u{1F50D} DEBUG: Iniciando espera de 1s..."),await new Promise(Y=>setTimeout(Y,1e3)),console.log("\u{1F50D} DEBUG: Rodando l\xF3gica do email..."),await Ct(G),console.log("\u{1F50D} DEBUG: Finalizando anima\xE7\xE3o..."),typeof W=="function"?W():console.error("\u274C ERRO: finishLoading n\xE3o \xE9 uma fun\xE7\xE3o! A anima\xE7\xE3o falhou ao iniciar.")}catch(W){console.error("\u274C ERRO NO PROCESSO:",W);let Y=document.querySelector(".cw-focus-backdrop");Y&&Y.classList.remove("active")}setTimeout(()=>{_.style.transform="scale(1)",typeof k=="function"&&k()},300)}}function k(){o="list",R.style.transform="translateX(0)"}function v(){b.innerHTML="",Object.keys(He).forEach(G=>{let M=He[G],N=document.createElement("button");N.textContent=M.title,Object.assign(N.style,m),t===G&&n===""&&Object.assign(N.style,w),N.onclick=()=>{t=G,n="",g.value="",v(),T()},b.appendChild(N)})}function T(){s.innerHTML="";let G=[];if(n.trim()!==""?Object.values(He).forEach(B=>{let _=B.emails.filter(W=>W.name.toLowerCase().includes(n.toLowerCase()));G=[...G,..._]}):He[t]&&(G=He[t].emails),G.length===0){s.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let M='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',N='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';G.forEach(B=>{let _=document.createElement("div");Object.assign(_.style,u);let W=B.subject.length>50?B.subject.substring(0,50)+"...":B.subject;_.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function lo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",a="BAU",r=!1,i=document.createElement("div");i.id="call-script-popup",Object.assign(i.style,we,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",opacity:"0",pointerEvents:"none"});let l={popup:i,googleLine:null};function p(){r=!r,Ae(r,i,"cw-btn-script")}let m=Ce(i,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{p()});i.appendChild(m);let w=document.createElement("div");Object.assign(w.style,t.progressBarContainer);let u=document.createElement("div");Object.assign(u.style,t.progressBarFill),w.appendChild(u),i.appendChild(w);let O=document.createElement("div");O.id="csa-content",Object.assign(O.style,t.contentArea),i.appendChild(O);let h=document.createElement("div");Object.assign(h.style,t.footer);let f=document.createElement("span");f.textContent="by lucaste@",Object.assign(f.style,{fontSize:"10px",color:"#bdc1c6"});let x=document.createElement("button");x.innerHTML=`
  ...
  `,Object.assign(x.style,t.resetBtn),x.onmouseenter=()=>x.style.background="#fce8e6",x.onmouseleave=()=>x.style.background="transparent",x.onclick=()=>{x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="scale(1)",150);for(let k in n)delete n[k];c()},h.appendChild(f),h.appendChild(x),i.appendChild(h);let E=document.createElement("div");Object.assign(E.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let I=document.createElement("div");Object.assign(I.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let R=document.createElement("div");R.textContent="BAU";let j=document.createElement("div");j.textContent="LT",Object.assign(R.style,me),Object.assign(j.style,me),I.appendChild(R),I.appendChild(j);let V=document.createElement("select");Object.assign(V.style,Pt,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),V.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',V.value=o,E.appendChild(I),E.appendChild(V),O.appendChild(E);let g=document.createElement("div");g.id="csa-checklist-area",O.appendChild(g);let b=document.createElement("div");Object.assign(b.style,We),b.className="no-drag",b.title="Redimensionar",i.appendChild(b),Ye(i,b),document.body.appendChild(i);function s(k){return k}function c(){g.innerHTML="";let k=`${o} ${a}`,v=ro[k];if(!v){g.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
           ...
           `,f.appendChild(y)}let S=c.filter(y=>!s.includes(y.id)),d=c.filter(y=>s.includes(y.id));if(S.forEach(y=>f.appendChild(j(y,!1))),d.length>0){let y=document.createElement("div");Object.assign(y.style,i.historyDivider),y.innerHTML=`<span>Visualizar ${d.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let k=document.createElement("div");Object.assign(k.style,i.historyContainer),d.forEach(T=>k.appendChild(j(T,!0)));let v=!1;y.onclick=()=>{J.playClick(),v=!v,k.style.display=v?"flex":"none",y.querySelector("svg").style.transform=v?"rotate(180deg)":"rotate(0deg)",y.querySelector("span").textContent=v?"Ocultar hist\xF3rico":`Visualizar ${d.length} avisos anteriores`},f.appendChild(y),f.appendChild(k)}}function j(s,c){let S=document.createElement("div");Object.assign(S.style,c?i.cardHistory:i.card);let d=r[s.type]||r.info,y=document.createElement("div");Object.assign(y.style,i.cardHeader,{background:d.bg,color:d.text,borderBottom:`1px solid ${d.border}`});let k=document.createElement("div");if(Object.assign(k.style,{display:"flex",alignItems:"center",gap:"6px"}),k.innerHTML=`${d.icon} <span>${s.type.toUpperCase()}</span>`,y.appendChild(k),c){let T=document.createElement("span");T.textContent=a(s.date),T.style.opacity="0.7",y.appendChild(T)}else{let T=document.createElement("button");T.title="Marcar como lido",Object.assign(T.style,i.dismissBtn),T.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',T.onmouseenter=()=>{T.style.color="#1e8e3e",T.style.background="#e6f4ea",T.style.borderColor="#1e8e3e"},T.onmouseleave=()=>{T.style.color="#5f6368",T.style.background="#fff",T.style.borderColor="rgba(0,0,0,0.1)"},T.onclick=G=>{G.stopPropagation(),J.playClick(),S.style.transform="translateX(20px)",S.style.opacity="0",setTimeout(()=>{let M=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");M.push(s.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(M)),R(),E()},250)},y.appendChild(T)}if(S.appendChild(y),s.title){let T=document.createElement("div");Object.assign(T.style,i.msgTitle),T.textContent=s.title,S.appendChild(T)}if(!c){let T=document.createElement("div");Object.assign(T.style,i.metaContainer),T.innerHTML=`<span style="font-weight:600">${s.author}</span> \u2022 <span>${a(s.date)}</span>`,S.appendChild(T)}let v=document.createElement("div");return Object.assign(v.style,i.cardBody),v.innerHTML=p(s.text),S.appendChild(v),S}R();let V=document.createElement("div");Object.assign(V.style,We),V.className="no-drag",m.appendChild(V),Ye(m,V),document.body.appendChild(m);let g=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),b=Ve.some(s=>!g.includes(s.id));return{toggle:u,hasUnread:b}}function Eo(){if(window.techSolInitialized){wt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Bt();try{J.initGlobalListeners(),J.playStartup()}catch(r){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",r)}Pe.fetchTips(),wt();let e=io(),t=so(),n=lo(),o=co(),a=po();Qt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:a})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),oe("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Eo();})();

...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var _t={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},oo={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var no={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var ye={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var Nt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Jt=-1;function it(){let t=Math.floor(Math.random()*Nt.length);return t===Jt&&(t=(t+1)%Nt.length),Jt=t,Nt[t]}var Le=t=>new Promise(e=>setTimeout(e,t));async function No(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let n=t.querySelector(".cursor");await Le(200);for(let o=0;o<e.length;o++){let s=e.charAt(o),i=document.createElement("span");i.textContent=s,n&&n.parentNode===t?n.before(i):t.appendChild(i);let a=Math.floor(Math.random()*60)+30;o===0&&(a=150),o>e.length-3&&(a=30),await Le(a)}await Le(600),n&&(n.style.display="none")}async function Lt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await Yt(),n=Kt(e),o=t.querySelector("#w-icon"),s=t.querySelector("#p1"),i=t.querySelector("#p2"),a=t.querySelector("#p3"),r=t.querySelector("#p-sextou");o&&(o.innerHTML=n.icon),s&&(s.textContent=n.prefix),a&&(a.textContent=n.suffix),await Le(300);let d=o?o.querySelector("svg"):null;if(d&&(d.style.opacity="1",d.style.transform="scale(1)"),await Le(400),s&&(s.style.opacity="1"),ie.playStartup(),i&&await No(i,n.name),a&&(a.style.opacity="1",a.style.transform="translateY(0)"),n.isFriday&&r){await Le(400),r.style.display="block",r.offsetWidth;let p=r.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}var Qe={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Ze(t,e){e.onmousedown=n;function n(o){o.stopPropagation(),o.preventDefault();let s=t.style.transition;t.style.transition="none";let i=o.clientX,a=o.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),d=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),p=i,g=a,b=!1;function f(T){p=T.clientX,g=T.clientY,b||(window.requestAnimationFrame(()=>{m(),b=!1}),b=!0)}function m(){let T=r+(p-i),F=d+(g-a);T>360&&(t.style.width=T+"px"),F>300&&(t.style.height=F+"px")}function u(){document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",u),setTimeout(()=>{t.style.transition=s},50)}document.addEventListener("mousemove",f),document.addEventListener("mouseup",u)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function ao(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,n=>e[n]?e[n]:"")}var Je=t=>new Promise(e=>setTimeout(e,t));function st(t){t&&["mousedown","mouseup","click"].forEach(e=>t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window})))}var io="cw-automation-styles";if(!document.getElementById(io)){let t=document.createElement("style");t.id=io,t.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let g=r.querySelector(".cw-hero-grid"),b=r.querySelector(".cw-acc-container"),f=r.querySelector(".cw-results-container"),m=r.querySelector(".cw-search-input"),u=r.querySelector(".cw-status-bar"),T=r.querySelector(".cw-status-text"),F=r.querySelector(".cw-footer-icons");s.forEach(([C,v])=>{let y=o(v.name),M=document.createElement("div");M.className="cw-hero-card",M.id=`hero-${C}`,M.style.setProperty("--hero-color",y.color),M.innerHTML=`
        ...
        `,M.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let q=e[C]?e[C].count:0;B(C,q>0?-q:1,v)},M.querySelector(".minus").onclick=()=>B(C,-1,v),M.querySelector(".plus").onclick=()=>B(C,1,v),M.dataset.color=y.color,g.appendChild(M)});function _(C,v){let y=o(v.name),M=document.createElement("div");return M.className="cw-task-item",M.dataset.id=C,M.innerHTML=`
        ...
        `,M.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let q=e[C]?e[C].count:0;B(C,q>0?-q:1,v)},M.querySelector(".minus").onclick=()=>B(C,-1,v),M.querySelector(".plus").onclick=()=>B(C,1,v),M}Object.entries(i).forEach(([C,v])=>{let y=document.createElement("div");y.className="cw-acc-group";let M=document.createElement("div");M.className="cw-acc-header",M.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${v.brand.color}"></div>
                ${C}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,M.onclick=()=>{b.querySelectorAll(".cw-acc-group.open").forEach(q=>{q!==y&&q.classList.remove("open")}),y.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",v.tasks.forEach(q=>{let L=_(q.key,q);w.appendChild(L)}),y.appendChild(M),y.appendChild(w),b.appendChild(y)});function B(C,v,y){e[C]||(e[C]={count:0,data:y,brand:o(y.name)}),e[C].count+=v,e[C].count<=0&&delete e[C],$(),se(),t&&t()}function $(){s.forEach(([w])=>{let q=g.querySelector(`#hero-${w}`);if(!q)return;let L=e[w];L?(q.classList.add("active"),q.querySelector(".cw-step-val").textContent=L.count,q.querySelector(".cw-step-val").style.color=q.dataset.color):q.classList.remove("active")}),r.querySelectorAll(".cw-task-item").forEach(w=>{let q=w.dataset.id,L=e[q];L?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=L.count):w.classList.remove("selected")});let v=Object.keys(e),y=0,M=[];if(v.forEach(w=>{let q=e[w];y+=q.count;for(let L=0;L<q.count;L++)M.length<6&&M.push(q.brand)}),y>0){u.classList.add("visible");let w=y>1?"A\xE7\xF5es":"A\xE7\xE3o",q=y>1?"definidas":"definida";T.textContent=`${y} ${w} ${q}`,F.innerHTML="",M.forEach(L=>{let R=document.createElement("div");R.className="cw-mini-icon",R.innerHTML=Ye[L.icon]||Ye.default;let E=R.querySelector("svg");E&&(E.style.width="14px",E.style.height="14px"),F.appendChild(R)})}else u.classList.remove("visible")}m.addEventListener("input",C=>{let v=C.target.value.toLowerCase();if(v.length>0){b.style.display="none",f.style.display="block",f.innerHTML="";let y=!1;Object.entries(Ge).forEach(([M,w])=>{if(w.name.toLowerCase().includes(v)){y=!0;let q=_(M,w);e[M]&&(q.classList.add("selected"),q.querySelector(".cw-step-val").textContent=e[M].count),f.appendChild(q)}}),y||(f.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else b.style.display="block",f.style.display="none"});function se(){p.innerHTML="";let C=Object.keys(e),v=!1,y=document.getElementById("sub-status"),M="implementation";if(y&&y.value.toLowerCase().includes("education")&&(M="education"),C.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(C.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`
        ...
        `,p.appendChild(w),C.forEach(q=>{let L=e[q].data,R=e[q].count,E=e[q].brand,j=L.screenshots?L.screenshots[M]||[]:["Link da Evid\xEAncia"];if(j.length>0){v=!0;for(let c=1;c<=R;c++){let A=document.createElement("div");A.className="cw-screen-card",A.style.setProperty("--brand-color",E.color),A.style.setProperty("--brand-bg",E.bg),A.style.setProperty("--brand-shadow",E.color+"40");let h=document.createElement("div");h.className="cw-card-header";let l=document.createElement("div");l.className="cw-card-icon",l.innerHTML=Ye[E.icon]||Ye.default;let S=document.createElement("div");S.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let k=document.createElement("input");k.className="cw-card-title-input",k.id=`name-${q}-${c}`,k.value=`${L.name}${R>1?" #"+c:""}`,k.title="Clique para renomear esta task";let H=document.createElement("span");H.className="cw-edit-hint",H.innerHTML="\u270E Renomear",S.appendChild(k),S.appendChild(H),h.appendChild(l),h.appendChild(S),A.appendChild(h),j.forEach((D,I)=>{let G=document.createElement("div");G.className="cw-input-group";let U=document.createElement("label");U.className="cw-input-label",U.textContent=D.replace(/📷|:|•/g,"").trim();let O=document.createElement("input");O.className="cw-input-field",O.id=`screen-${q}-${c}-${I}`,O.placeholder="Cole o link aqui...",O.setAttribute("autocomplete","off"),O.addEventListener("input",()=>{O.value.trim().length>5?O.classList.add("filled"):O.classList.remove("filled")});let P=document.createElement("div");P.className="cw-input-check",P.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',G.appendChild(U),G.appendChild(O),G.appendChild(P),A.appendChild(G)}),p.appendChild(A)}}}),d.style.display=v?"block":"none"}return{selectionElement:r,screenshotsElement:d,updateSubStatus:()=>se(),getCheckedElements:()=>Object.keys(e).map(C=>({value:C,closest:()=>({querySelector:()=>({textContent:e[C].count})})})),toggleTask:(C,v=!0)=>{let y=e[C];v&&!y?B(C,1,Ge[C]):!v&&y&&B(C,-y.count,Ge[C])},setMode:C=>{n=C,se()},reset:()=>{for(let C in e)delete e[C];m.value="",b.style.display="block",f.style.display="none",$(),se()}}}function vo(t){let e=document.createElement("div");e.style.cssText="display: flex; flex-direction: column; height: 100%; width: 100%; background: #F8F9FA; position: relative; overflow: hidden;";let n=document.createElement("div");n.style.cssText="flex: 1; overflow-y: auto; padding: 20px 24px 80px 24px;";let o={sectionTitle:"font-size: 11px; font-weight: 700; color: #5F6368; text-transform: uppercase; letter-spacing: 0.5px; margin: 24px 0 12px 0; border-bottom: 1px solid #E0E0E0; padding-bottom: 6px;",label:"display: block; font-size: 13px; font-weight: 600; color: #202124; marginBottom: 6px;",input:"width: 100%; padding: 10px 12px; border-radius: 8px; border: 1px solid #DADCE0; background: #FFFFFF; font-size: 14px; color: #3C4043; transition: all 0.2s; outline: none; box-sizing: border-box;",inputFocus:"border-color: #1a73e8; box-shadow: 0 0 0 2px rgba(26,115,232,0.15);",textarea:"min-height: 80px; resize: vertical; line-height: 1.5; font-family: Roboto, sans-serif;",radioGroup:"display: flex; gap: 12px; margin-bottom: 16px;",radioLabel:"flex: 1; display: flex; align-items: center; justify-content: center; padding: 10px; border: 1px solid #DADCE0; border-radius: 8px; background: #FFF; cursor: pointer; transition: all 0.2s; font-size: 13px; font-weight: 500; color: #3C4043; user-select: none;",radioActive:"background: #E8F0FE; border-color: #1967D2; color: #1967D2; font-weight: 600;",banner:"background: #FEF7E0; border: 1px solid #FEEFC3; border-radius: 8px; padding: 12px 16px; margin-bottom: 20px; font-size: 12px; color: #B06000; line-height: 1.5; display: flex; gap: 10px; align-items: start;",magicBtn:"width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 10px; background: #E8F0FE; color: #1967D2; border: 1px dashed #1967D2; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.2s; margin-bottom: 20px;"};function s(E,j,c="text",A=""){let h=document.createElement("div");h.style.marginBottom="16px";let l=document.createElement("label");l.style.cssText=o.label,l.textContent=j;let S;return c==="textarea"?(S=document.createElement("textarea"),S.style.cssText=o.input+o.textarea):(S=document.createElement("input"),S.type=c,S.style.cssText=o.input),S.onfocus=()=>S.style.cssText+=o.inputFocus,S.onblur=()=>{c==="textarea"?S.style.cssText=o.input+o.textarea:S.style.cssText=o.input},S.id=`st-${E}`,S.placeholder=A,h.appendChild(l),h.appendChild(S),{wrapper:h,input:S}}function i(E,j){let c=document.createElement("div"),A=document.createElement("label");A.style.cssText=o.label,A.textContent=j,c.appendChild(A);let h=document.createElement("div");return h.style.cssText=o.radioGroup,["Yes","No"].forEach(l=>{let S=document.createElement("label");S.style.cssText=o.radioLabel;let k=document.createElement("input");k.type="radio",k.name=`st-${E}`,k.value=l==="Yes"?"Y":"N",k.style.display="none",l==="No"&&(k.checked=!0),S.appendChild(k),S.appendChild(document.createTextNode(l)),k.addEventListener("change",()=>{h.querySelectorAll("label").forEach(H=>H.style.cssText=o.radioLabel),k.checked&&(S.style.cssText=o.radioLabel+o.radioActive)}),l==="No"&&(S.style.cssText=o.radioLabel+o.radioActive),h.appendChild(S)}),c.appendChild(h),{wrapper:c}}let a=document.createElement("div");a.style.cssText=o.banner,a.innerHTML=`
    ...
    `,n.appendChild(a);let r=document.createElement("button");r.style.cssText=o.magicBtn,r.innerHTML="<span>\u2728</span> Preencher Automaticamente",r.onmouseover=()=>r.style.background="#D2E3FC",r.onmouseout=()=>r.style.background="#E8F0FE",n.appendChild(r);let d=document.createElement("div");d.style.cssText=o.sectionTitle,d.style.marginTop="0",d.textContent="1. Dados T\xE9cnicos",n.appendChild(d);let p=s("cid","Ads CID"),g=s("ga4","GA4 ID"),b=s("gtm","GTM ID"),f=i("access","Advertiser has access to GA4/GTM?"),m=s("access-email","If Yes, User Email"),u=i("ghost","Ghosting Access Available?");n.append(p.wrapper,g.wrapper,b.wrapper,f.wrapper,m.wrapper,u.wrapper);let T=document.createElement("div");T.style.cssText=o.sectionTitle,T.textContent="2. Contato & Problema",n.appendChild(T);let F=s("name","Name of Advertiser"),_=s("url","Website Address"),B=s("phone","Phone Number"),$=s("email","Email Address"),se=s("callback","Preferred Call Back Time (w/ Timezone)"),C=s("desc","Detailed Issue Description","textarea"),v=s("checks","Checks Performed by Tech Team","textarea"),y=s("screens","Uncropped Screenshots (Links)","textarea");n.append(F.wrapper,_.wrapper,B.wrapper,$.wrapper,se.wrapper,C.wrapper,v.wrapper,y.wrapper);let M=document.createElement("div");M.style.cssText=o.sectionTitle,M.textContent="3. Contatos para C\xF3pia (CC)",n.appendChild(M);let w=s("c-adv","Advertiser Contact"),q=s("c-am","Account Manager");n.append(w.wrapper,q.wrapper);let L=document.createElement("div");L.style.cssText="padding: 16px 24px; background: #fff; border-top: 1px solid #E0E0E0; display: flex; justify-content: flex-end; position: absolute; bottom: 0; width: 100%; box-sizing: border-box; z-index: 10;";let R=document.createElement("button");return R.textContent="Gerar Nota S&T",R.style.cssText="padding: 10px 24px; background: #1a73e8; color: #fff; border: none; border-radius: 24px; font-size: 14px; font-weight: 600; cursor: pointer; box-shadow: 0 2px 6px rgba(26, 115, 232, 0.3); transition: transform 0.1s;",R.onactive=()=>R.style.transform="scale(0.96)",L.appendChild(R),e.appendChild(n),e.appendChild(L),r.onclick=async()=>{r.innerHTML="<span>\u23F3</span> Buscando...";let E=await at();E.advertiserName&&(F.input.value=E.advertiserName),E.websiteUrl&&(_.input.value=E.websiteUrl),E.clientEmail&&($.input.value=E.clientEmail,w.input.value=E.clientEmail);let c=document.body.innerText.match(/\d{3}-\d{3}-\d{4}/);c&&(p.input.value=c[0]),r.innerHTML="<span>\u2705</span> Dados Preenchidos!",setTimeout(()=>{r.innerHTML="<span>\u2728</span> Preencher Automaticamente"},2e3),Q("Dados capturados com sucesso!")},R.onclick=async()=>{let E=l=>{let S=e.querySelector(`#st-${l}`);return S?S.value:""},j=l=>{let S=e.querySelector(`input[name="st-${l}"]:checked`);return S?S.value:"N"},A=`Split & Transfer : Phone Note Format [Mandatory]
...
<b>If Yes, user access email to GA4/GTM:</b> ${E("access-email")}
<b>Ghosting Access Available (Y/N):</b> ${j("ghost")}
<b>Name of the advertiser:</b> ${E("name")}
<b>Website Address:</b> ${E("url")}
<b>Advertiser\u2019s preferred mode of communication:</b> Phone
<b>Advertiser/Web Master\u2019s Phone Number:</b> ${E("phone")}
<b>Preferred Call Back time with time zone and contact number:</b> ${E("callback")}
<b>Advertiser/Web Master\u2019s Email Address:</b> ${E("email")}
...
\u2022 `)?(V.preventDefault(),this.value=X.substring(0,N-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=N-3):X==="\u2022 "&&(V.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function kt(){let x=typeof Ee<"u"?Ee:document.getElementById("snippet-container");if(!x)return;let V=x.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),N={},X=new Set;V.forEach(ae=>{let te=ae.id,W=ke[te];if(W)for(let z in W)z==="linkedTask"?X.add(W.linkedTask):z!=="type"&&(N[z]||(N[z]=[]),N[z].includes(W[z])||N[z].push(W[z]))});let re=new Set;Object.values(ke).forEach(ae=>{Object.keys(ae).forEach(te=>{te!=="linkedTask"&&te!=="type"&&re.add(te)})}),re.forEach(ae=>{let te=document.getElementById(ae);if(te){let W=N[ae]||[],z="";lt.includes(ae.replace("field-",""))?(z=W.map(ee=>ee.startsWith("\u2022 ")?ee:"\u2022 "+ee).join(`
`),z===""?z="\u2022 ":z.endsWith(`
\u2022 `)||(z+=`
\u2022 `)):z=W.join(`

`),z.trim()!=="\u2022"&&z.trim()!==""?te.value=z:lt.includes(ae.replace("field-",""))?te.value="\u2022 ":te.value="",te.tagName==="TEXTAREA"&&typeof Tt=="function"&&Tt(te)}});let me=new Set,Ce=new Set;x.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(ae=>{let te=ke[ae.id];te&&te.linkedTask&&(ae.checked?me.add(te.linkedTask):Ce.add(te.linkedTask))}),Ce.forEach(ae=>{me.has(ae)||d.toggleTask(ae,!1)}),me.forEach(ae=>{d.toggleTask(ae,!0)})}j.onchange=()=>{let x=j.value;if(Ot(1.5),l.innerHTML=`<option value="">${Z("select_substatus")}</option>`,!x){l.disabled=!0;return}for(let V in rt){let N=rt[V];if(N.status===x){let X=document.createElement("option");X.value=V,X.textContent=N.name,l.appendChild(X)}}l.disabled=!1},l.onchange=()=>{let x=l.value;if(Ot(1.5),!x)return;d.updateSubStatus(x);let V=rt[x];Ee.innerHTML="";let N=(W,z,ee)=>{let ue=document.createElement("label");Object.assign(ue.style,a.checkboxLabel),ue.onmouseover=()=>ue.style.backgroundColor="#e8eaed",ue.onmouseout=()=>ue.style.backgroundColor="#f8f9fa";let le=document.createElement("input");return le.type=z,le.id=W.id,Object.assign(le.style,a.checkboxInput),ue.appendChild(le),ue.appendChild(document.createTextNode(` ${W.text}`)),ee.appendChild(ue),le},X=[],re="radio";if(x==="NI_Awaiting_Inputs")X=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(x.startsWith("SO_"))re="checkbox",X=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"},{id:"quickfill-ga4-event-close",text:"Fechamento GA4 (P\xF3s 2 dias)"}];else if(x.startsWith("AS_")){re="checkbox";let W=document.createElement("label");W.textContent=Z("cenarios_comuns"),Object.assign(W.style,a.label),Ee.appendChild(W),X=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else x.startsWith("IN_")?X=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:x.startsWith("DC_")?(re="radio",X=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]):x==="NI_Attempted_Contact"?(re="radio",X=[{id:"quickfill-ni-attempted-2day",text:"2 Day Rule (2 Liga\xE7\xF5es + Chat AM)"}]):x==="NI_Awaiting_Validation"&&(re="checkbox",X=[{id:"quickfill-ni-awaiting-ecw4",text:"ECW4 (Acompanhar)"},{id:"quickfill-ni-awaiting-ga4",text:"GA4 Event Tracking (Acompanhar)"}]);let me=X.filter(W=>{let z=ke[W.id];return!z.type||z.type==="all"||z.type===e});me.forEach((W,z)=>{let ee=N(W,re,Ee);re==="radio"&&(ee.name="scenario-radio-group",z===0&&(ee.checked=!0))}),me.length>0&&(Be.style.display="block"),V.requiresTasks?(he.style.display="none",Pe.style.display="block",d.selectionElement.style.display="block"):(he.style.display="block",Pe.style.display="none",d.selectionElement.style.display="none"),De.innerHTML="";let Ce=V.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(Ce)].forEach(W=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(W))return;let z=W.slice(1,-1),ee=document.createElement("label"),ue=Z(z.toLowerCase());if(ee.textContent=ue!==z.toLowerCase()?ue:z.replace(/_/g," ").replace(/\b\w/g,K=>K.toUpperCase())+":",Object.assign(ee.style,a.label),z==="SPEAKEASY_ID"){let K=document.createElement("button");K.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',K.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,K.title="Localizar Speakeasy ID no hist\xF3rico",K.onmouseover=()=>{K.style.backgroundColor="#c2e7ff",K.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},K.onmouseout=()=>{K.style.backgroundColor="#d3e3fd",K.style.boxShadow="none"},K.onmousedown=()=>{K.style.backgroundColor="#a8c7fa",K.style.transform="scale(0.96)"},K.onmouseup=()=>K.style.transform="scale(1)",K.onclick=xe=>{xe.preventDefault(),ro(`field-${z}`)},ee.appendChild(K)}let le;lt.includes(z)?(le=document.createElement("textarea"),Object.assign(le.style,a.textarea),le.classList.add("bullet-textarea"),Tt(le)):Rt.includes(z)?(le=document.createElement("textarea"),Object.assign(le.style,a.textarea)):(le=document.createElement("input"),le.type="text",Object.assign(le.style,a.input),z==="REASON_COMMENTS"&&(x.startsWith("NI_")||x.startsWith("IN_"))&&(Object.assign(ee.style,{display:"none"}),Object.assign(le.style,{display:"none"}))),z==="ON_CALL"&&e==="lm"&&(Object.assign(ee.style,{display:"none"}),Object.assign(le.style,{display:"none"}),le.value="N/A"),le.id=`field-${z}`,De.appendChild(ee),De.appendChild(le)});let ae=Ee.querySelectorAll('input[type="checkbox"], input[type="radio"]');ae.length>0&&(ae.forEach(W=>{W.removeEventListener("change",kt),W.addEventListener("change",kt)}),kt()),Ae.style.display="block",We[x]?je.style.display="block":je.style.display="none",Ke.style.display="flex";let te=d.getCheckedElements().map(W=>W.value);r.updateVisibility(x,te)},he.onclick=()=>{he.style.display="none",Pe.style.display="block",d.selectionElement.style.display="block"};function Ht(){let x=l.value;if(!x)return null;let N=rt[x].template.replace(/\n/g,"<br>"),X='style="margin-bottom: 12px; padding-left: 30px;"',re=[],me="",Ce=d.getCheckedElements();Ce.length>0&&Ce.forEach(te=>{let W=te.value,z=Ge[W],ee=te.closest().querySelector(".stepper-count"),ue=ee?parseInt(ee.textContent):1;ue>1?re.push(`${z.name} (x${ue})`):re.push(z.name)});let ge=d.screenshotsElement;if(ge){let te=Array.from(ge.querySelectorAll('input[id^="name-"]'));te.length>0&&te.forEach(W=>{let z=W.value,ee=W.closest(".cw-screen-card");if(ee){let ue=ee.querySelectorAll('input[id^="screen-"]'),le=!1,K="";ue.forEach(xe=>{let Vt=xe.closest(".cw-input-group"),$t=Vt?Vt.querySelector(".cw-input-label"):null,Oo=$t?$t.textContent:"Evid\xEAncia",Ut=xe.value.trim(),qo=Ut?` ${Ut}`:"";K+=`<li>${Oo} -${qo}</li>`,le=!0}),le&&(me+=`<b>${z}</b>`,me+=`<ul ${X}>${K}</ul>`)}})}if(N.includes("{TAGS_IMPLEMENTED}")?N=N.replace(/{TAGS_IMPLEMENTED}/g,re.join(", ")||"N/A"):re.length>0&&(N+=`<br><b>Tags:</b> ${re.join(", ")}<br>`),N.includes("{SCREENSHOTS_LIST}")?N=N.replace(/{SCREENSHOTS_LIST}/g,me?`${me}`:"N/A"):me!==""&&(N+=`<br>${me}`),n==="pt"&&o){let te=Se.checked?Z("sim"):Z("nao");N=N.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${Z("consentiu_gravacao")}</b> ${te}<br><br>`),N=N.replace(/{CASO_PORTUGAL}/g,`<br><b>${Z("caso_portugal")}</b> ${Z("sim")}<br>`)}else n==="pt"&&!o?(N=N.replace(/{CASO_PORTUGAL}/g,`<br><b>${Z("caso_portugal")}</b> ${Z("nao")}<br>`),N=N.replace(/{CONSENTIU_GRAVACAO}/g,"")):(N=N.replace(/{CASO_PORTUGAL}/g,""),N=N.replace(/{CONSENTIU_GRAVACAO}/g,""));return De.querySelectorAll("input, textarea").forEach(te=>{let W=te.id.replace("field-",""),z=new RegExp(`{${W}}`,"g"),ee=te.value;if(W==="REASON_COMMENTS"&&(x.startsWith("NI_")||x.startsWith("IN_"))){let K=Ee.querySelector('input[type="radio"]:checked');K&&ke[K.id]&&(ee=ke[K.id]["field-REASON_COMMENTS"])}if(lt.includes(W)&&ee.trim()!==""){let K=ee.split(`
...
`).filter(K=>K.trim()!=="").map(K=>`<p style="margin: 0 0 8px 0;">${K}</p>`).join(""):te.tagName==="TEXTAREA"&&(ee=ee.replace(/\n/g,"<br>"));let ue=ee.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ue===""||ue==="\u2022"||ue.toLowerCase()==="n/a"){let K=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${W}\\}(?:<br>\\s*)?`,"gi");K.test(N)?N=N.replace(K,""):N=N.replace(z,"")}else N=N.replace(z,ee.replace(/\$/g,"$$$$"))}),N=N.replace(/{([A-Z0-9_]+)}/g,""),N=N.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(N+=r.getOutput()),N}tt.onclick=()=>{let x=Ht();x?(ct(x),Q(Z("copiado_sucesso"))):Q(Z("selecione_substatus"),{error:!0})},ot.onclick=async()=>{let x=l.value,V=Ht();if(!V){Q(Z("selecione_substatus"),{error:!0});return}ct(V),qt();let N=xt(),X=await wt();if(X)try{if(X.focus(),X.innerHTML.trim()==="<p><br></p>"||X.innerHTML.trim()==="<br>"||X.innerText.trim()===""){let ge=document.createRange();ge.selectNodeContents(X);let ae=window.getSelection();ae.removeAllRanges(),ae.addRange(ge),document.execCommand("delete",!1,null)}else if(!X.innerHTML.endsWith("<br><br>")){let ge=document.createRange();ge.selectNodeContents(X),ge.collapse(!1);let ae=window.getSelection();ae.removeAllRanges(),ae.addRange(ge),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,V),vt(X),setTimeout(()=>{Q(Z("inserido_copiado"))},600);let me=typeof Ve<"u"&&Ve?Ve.checked:!0;if(x&&We[x]&&me){let ge=We[x];await ft(ge),await new Promise(ae=>setTimeout(ae,500))}N(),Ot(1.5),j.value="",l.innerHTML=`<option value="">${Z("select_substatus")}</option>`,l.disabled=!0}catch(re){console.error(re),Q("Erro ao inserir.",{error:!0}),N()}};function Ot(x=1.5){x<=1.5&&(Be.style.display="none",Ee.innerHTML=""),x<=2&&(d.reset(),he.style.display="none"),x<=3&&(Ae.style.display="none",De.innerHTML="",r.reset(),Ke.style.display="none",je.style.display="none")}function qt(){if(s=!s,s){let x=p.querySelector(".cw-expand-btn");x&&typeof x.resetState=="function"&&x.resetState()}Ie(s,p,"cw-btn-notes")}return St("bau"),Et("pt"),qt}var Xe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
        ...
        `;let I=E.querySelector("#csa-back-btn");I.onmouseenter=()=>I.style.background="#f1f3f4",I.onmouseleave=()=>I.style.background="none",I.onclick=A;let G=E.querySelector("#csa-insert-btn");G.onmouseenter=()=>{G.style.transform="translateY(-1px)",G.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},G.onmouseleave=()=>{G.style.transform="translateY(0)",G.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},G.onclick=()=>{G.style.transform="scale(0.96)",j(k,"email"),setTimeout(()=>{G.style.transform="scale(1)",A()},300)}}function A(){s="list",v.style.transform="translateX(0)"}function h(k,H,D=null){let I=document.createElement("button"),G=D?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${D}</span>`:"";return I.innerHTML=`${G}${k}`,Object.assign(I.style,m),n===H&&o===""?Object.assign(I.style,u):(I.onmouseenter=()=>{I.style.background="#F1F3F4",I.style.borderColor="#DADCE0"},I.onmouseleave=()=>{I.style.background="#FFFFFF",I.style.borderColor="#DADCE0"}),I.onclick=()=>{n=H,o="",w.value="",l(),S()},I}function l(){q.innerHTML="",q.appendChild(h("Smart CRs",e,"\u26A1")),Object.keys(Xe).forEach(k=>{q.appendChild(h(Xe[k].title,k))})}function S(){L.innerHTML="";let k=[];if(o.trim()!==""){let U=o.toLowerCase();Object.values(Xe).forEach(O=>{O.emails.forEach(P=>{(P.name.toLowerCase().includes(U)||P.subject.toLowerCase().includes(U))&&k.push({type:"email",data:P})})}),Object.entries(We).forEach(([O,P])=>{if(!P)return;(O.replace(/_/g," ").toLowerCase().includes(U)||P.toLowerCase().includes(U))&&k.push({type:"cr",key:O,code:P})})}else n===e?Object.entries(We).forEach(([U,O])=>{O&&k.push({type:"cr",key:U,code:O})}):Xe[n]&&Xe[n].emails.forEach(U=>{k.push({type:"email",data:U})});if(k.length===0){L.innerHTML=`
                ...
                </div>`;return}let D='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1967D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',I='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA8600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',G='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BDC1C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';k.forEach(U=>{let O=document.createElement("div");if(Object.assign(O.style,F),U.type==="email"){let P=U.data,de=P.subject.length>45?P.subject.substring(0,45)+"...":P.subject;O.innerHTML=`
                ...
                `,O.onclick=()=>c(P)}else{let P=U.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");O.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function So(){let t="v2.1 (Apple Motion)",e={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Te,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function d(){i=!i,Ie(i,a,"cw-btn-script")}let p=qe(a,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{d()});a.appendChild(p);let g=document.createElement("div");Object.assign(g.style,e.progressBarContainer);let b=document.createElement("div");Object.assign(b.style,e.progressBarFill),g.appendChild(b),a.appendChild(g);let f=document.createElement("div");f.id="csa-content",Object.assign(f.style,e.contentArea),a.appendChild(f);let m=document.createElement("div");Object.assign(m.style,e.footer);let u=document.createElement("span");u.textContent="by lucaste@",Object.assign(u.style,{fontSize:"10px",color:"#bdc1c6"});let T=document.createElement("button");T.innerHTML=`
  ...
  `,Object.assign(T.style,e.resetBtn),T.onmouseenter=()=>T.style.background="#fce8e6",T.onmouseleave=()=>T.style.background="transparent",T.onclick=()=>{T.style.transform="scale(0.9)",setTimeout(()=>T.style.transform="scale(1)",150);for(let R in n)delete n[R];M()},m.appendChild(u),m.appendChild(T),a.appendChild(m);let F=document.createElement("div");Object.assign(F.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let _=document.createElement("div");Object.assign(_.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let B=document.createElement("div");B.textContent="BAU";let $=document.createElement("div");$.textContent="LT",Object.assign(B.style,ye),Object.assign($.style,ye),_.appendChild(B),_.appendChild($);let se=document.createElement("select");Object.assign(se.style,oo,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),se.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',se.value=o,F.appendChild(_),F.appendChild(se),f.appendChild(F);let C=document.createElement("div");C.id="csa-checklist-area",f.appendChild(C);let v=document.createElement("div");Object.assign(v.style,Qe),v.className="no-drag",v.title="Redimensionar",a.appendChild(v),Ze(a,v),document.body.appendChild(a);function y(R){return R}function M(){C.innerHTML="";let R=`${o} ${s}`,E=Co[R];if(!E){C.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,Object.assign(w.style,a),e===y&&n===""?Object.assign(w.style,r):(w.onmouseenter=()=>{w.style.background="#F1F3F4",w.style.borderColor="#DADCE0"},w.onmouseleave=()=>{w.style.background="#FFFFFF",w.style.borderColor="#DADCE0"}),w.onclick=()=>{e=y,n="",_.value="",se(),w.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}),C()},B.appendChild(w)})}function C(){$.innerHTML="";let y=[],M=n.trim()!=="";if(M?Object.entries(At).forEach(([w,q])=>{let L=q.links.filter(R=>R.name.toLowerCase().includes(n.toLowerCase())||R.desc.toLowerCase().includes(n.toLowerCase()));L.forEach(R=>{R._catIcon=b[w]}),y=[...y,...L]}):(y=At[e].links,y.forEach(w=>w._catIcon=b[e])),y.length===0){$.innerHTML=`
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:60px 20px; color:#9AA0A6;">
            <div style="font-size:32px; margin-bottom:12px; opacity:0.5;">\u{1F50D}</div>
            <div style="font-size:14px; font-weight:500;">Nenhum link encontrado</div>
        </div>`;return}y.forEach((w,q)=>{let L=document.createElement("div");Object.assign(L.style,d);let R=document.createElement("div");Object.assign(R.style,p),R.innerHTML=w._catIcon||'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>',L.appendChild(R);let E=document.createElement("div");E.style.flexGrow="1",E.style.minWidth="0",E.style.display="flex",E.style.flexDirection="column",E.style.gap="2px";let j=k=>{if(!M)return k;let H=new RegExp(`(${n})`,"gi");return k.replace(H,'<span style="color:#1a73e8; font-weight:700;">$1</span>')},c=`<div style="font-size:14px; font-weight:600; color:${o.textPrimary}; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${j(w.name)}</div>`,A=`<div style="font-size:12px; color:${o.textSecondary}; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${j(w.desc)}</div>`;E.innerHTML=c+A,L.appendChild(E);let h=document.createElement("div");h.style.display="flex",h.style.alignItems="center",h.style.gap="8px",h.style.flexShrink="0",h.style.opacity="0.4",h.style.transition="opacity 0.2s";let l=document.createElement("div");l.title="Copiar Link",l.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',Object.assign(l.style,{width:"32px",height:"32px",borderRadius:"8px",display:"flex",alignItems:"center",justifyContent:"center",color:o.textSecondary,cursor:"pointer",transition:"all 0.2s ease"}),l.onclick=k=>{ie.playClick(),k.stopPropagation(),navigator.clipboard.writeText(w.url),l.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',l.style.color="#188038",l.style.background="#E6F4EA",setTimeout(()=>{l.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',l.style.color=o.textSecondary,l.style.background="transparent"},1500)},l.onmouseenter=()=>{l.style.background="#F1F3F4"},l.onmouseleave=()=>{l.style.background="transparent"},h.appendChild(l);let S=document.createElement("div");S.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>',Object.assign(S.style,{display:"flex",alignItems:"center",justifyContent:"center",color:"#DADCE0",width:"24px",height:"24px"}),h.appendChild(S),L.appendChild(h),L.onclick=()=>window.open(w.url,"_blank"),L.onmouseenter=()=>{L.style.transform="translateY(-2px)",L.style.boxShadow=o.shadowHover,h.style.opacity="1",R.style.background="#E8F0FE",R.style.color="#1967D2",S.style.color="#1A73E8"},L.onmouseleave=()=>{L.style.transform="translateY(0)",L.style.boxShadow=o.shadowCard,h.style.opacity="0.4",R.style.background="#F1F3F4",R.style.color=o.textSecondary,S.style.color="#DADCE0"},$.appendChild(L),requestAnimationFrame(()=>{setTimeout(()=>{L.style.opacity="1",L.style.transform="translateY(0)"},q*30)})})}_.addEventListener("input",y=>{n=y.target.value,n!==""?Array.from(B.children).forEach(M=>{Object.assign(M.style,a),M.style.opacity="0.6"}):se(),C()});function v(){u=!u,Ie(u,g,"cw-btn-links")}return se(),C(),v}var ze=[];function Pt(t){ze=t}var jo=["lucaste"],Ho=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function To(){let t="v4.9 (High Contrast UI)",e=!1,n=null,o=null;function s(c){if(!c)return"";try{let A=new Date(c);return isNaN(A.getTime())?String(c):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(c)}}if(!document.getElementById("cw-broadcast-hd-css")){let c=document.createElement("style");c.id="cw-broadcast-hd-css",c.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,document.head.appendChild(c)}let i={feedContainer:{padding:"20px 24px 80px 24px",overflowY:"auto",flexGrow:"1",background:"#F8F9FA",display:"flex",flexDirection:"column",gap:"20px"},card:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.12)",boxShadow:"0 4px 12px rgba(60,64,67,0.08)",overflow:"hidden",transition:"all 0.3s ease",position:"relative",width:"100%",boxSizing:"border-box",flexShrink:"0"},cardHistory:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.05)",boxShadow:"none",opacity:"0.6",filter:"grayscale(0.8)",marginBottom:"16px",flexShrink:"0",width:"100%",boxSizing:"border-box",position:"relative"},cardHeader:{padding:"16px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid #F1F3F4"},typeTag:{display:"flex",alignItems:"center",gap:"6px",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",letterSpacing:"0.6px",padding:"4px 8px",borderRadius:"6px"},dateTag:{fontSize:"11px",color:"#5f6368",fontWeight:"500"},cardContent:{padding:"16px 20px 20px 20px"},msgTitle:{fontSize:"16px",fontWeight:"700",color:"#202124",marginBottom:"8px",lineHeight:"1.4"},msgBody:{fontSize:"14px",color:"#3c4043",lineHeight:"1.6",whiteSpace:"pre-wrap",wordBreak:"break-word"},msgMeta:{fontSize:"11px",color:"#9aa0a6",marginTop:"12px",display:"flex",alignItems:"center",gap:"6px"},dismissBtn:{width:"28px",height:"28px",borderRadius:"50%",border:"1px solid rgba(0,0,0,0.1)",background:"#fff",color:"#5f6368",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s ease",marginLeft:"12px"},bauContainer:{margin:"16px 24px 0 24px",padding:"16px",background:"#F3E8FD",border:"1px solid #D8B4FE",borderRadius:"16px",display:"flex",flexDirection:"column",gap:"12px",boxShadow:"0 4px 12px rgba(147, 51, 234, 0.1)"},bauHeader:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"2px"},bauLabel:{fontSize:"11px",fontWeight:"800",color:"#7E22CE",textTransform:"uppercase",letterSpacing:"0.8px"},liveIndicator:{display:"flex",alignItems:"center",gap:"8px"},pulseDot:{width:"8px",height:"8px",borderRadius:"50%",background:"#9333EA",boxShadow:"0 0 0 0 rgba(147, 51, 234, 0.7)",animation:"cw-pulse 2s infinite"},bauSlotRow:{display:"flex",alignItems:"center",gap:"10px",padding:"8px 12px",background:"rgba(255,255,255,0.5)",borderRadius:"8px",marginBottom:"4px"},bauFlag:{fontSize:"18px",lineHeight:"1"},bauDate:{fontSize:"16px",fontWeight:"700",color:"#581C87",letterSpacing:"-0.5px"},emptyState:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"60px 0",color:"#BDC1C6",gap:"16px",textAlign:"center"},historyDivider:{display:"flex",alignItems:"center",justifyContent:"center",margin:"20px 0",cursor:"pointer",color:"#1a73e8",fontSize:"13px",fontWeight:"500",gap:"8px",padding:"8px 16px",borderRadius:"20px",background:"#E8F0FE"},historyContainer:{display:"none",flexDirection:"column",gap:"16px",opacity:"0.8"}},a={critical:{color:"#991B1B",bg:"#FEF2F2",icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>'},info:{color:"#1E40AF",bg:"#EFF6FF",icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>'},success:{color:"#166534",bg:"#F0FDF4",icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>'}};function r(c){return c?Object.entries(c).map(([A,h])=>`${A.replace(/[A-Z]/g,l=>"-"+l.toLowerCase())}:${h}`).join(";"):""}function d(c){if(!c||typeof c!="string")return"";let A=c;return A=A.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" style="color:#1967d2; text-decoration:none; font-weight:500;">$1</a>'),A=A.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),A=A.replace(/_(.*?)_/g,"<i>$1</i>"),A=A.replace(/\n/g,"<br>"),A=ao(A),A}let p=document.createElement("div");p.id="broadcast-popup",p.classList.add("cw-module-window"),Object.assign(p.style,Te,{right:"auto",left:"50%",width:"420px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",backgroundColor:"#FAFAFA",overflow:"hidden"});let g={popup:p,googleLine:null};function b(){if(e=!e,Ie(e,p,"cw-btn-broadcast"),e){let c=document.getElementById("cw-btn-broadcast");c&&c.classList.remove("has-new"),y()}}let f=qe(p,"Central de Avisos",t,"Comunica\xE7\xE3o oficial da opera\xE7\xE3o.",g,()=>b()),m=f.querySelector(".cw-header-actions")||f.lastElementChild,u=null;function T(){let c=null;try{c=Xt()}catch{console.warn("TechSol: Auth Pending")}if(c){let A=c.split("@")[0].toLowerCase(),h=jo.includes(A);if(window._cwIsAdmin=h,window._cwCurrentUser=A,h&&m&&!m.querySelector("#cw-admin-btn")){let l=document.createElement("div");l.id="cw-admin-btn",l.className="cw-btn-interactive",l.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',Object.assign(l.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#1a73e8",background:"rgba(26, 115, 232, 0.1)",marginRight:"8px"}),l.title="Novo Aviso",l.onclick=S=>{S.stopPropagation(),B()},m.insertBefore(l,m.firstChild),u||_(),w()}}else window._cwAdminRetries||(window._cwAdminRetries=0),window._cwAdminRetries<5&&(window._cwAdminRetries++,setTimeout(T,2e3))}if(m){let c=document.createElement("button");c.textContent="Limpar",c.className="cw-btn-interactive",Object.assign(c.style,{fontSize:"12px",color:"#1a73e8",background:"transparent",border:"none",padding:"8px",fontWeight:"600"}),c.onclick=A=>{A.stopPropagation(),ie.playSuccess();let h=ze.map(l=>l.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(h)),w(),M()},m.insertBefore(c,m.firstChild)}p.appendChild(f);let F=document.createElement("div");F.id="cw-update-status",F.style.cssText="padding: 8px; text-align: center; font-size: 11px; color: #5f6368; background: #FAFAFA; border-bottom: 1px solid transparent; font-weight:500; display:none;",p.appendChild(F);function _(){u=document.createElement("div"),u.className="cw-editor-overlay",u.innerHTML=`
      ...
      `,u.querySelectorAll('input[name="cw-bc-type"]').forEach(l=>{l.addEventListener("change",()=>{u.querySelectorAll(".cw-radio-option").forEach(S=>S.classList.remove("checked")),l.parentElement.classList.add("checked")})}),setTimeout(()=>{let l=u.querySelector(".cw-radio-option.info");l&&l.classList.add("checked")},100);let c=u.querySelector("#cw-bc-cancel"),A=u.querySelector("#cw-bc-close-x"),h=u.querySelector("#cw-bc-send");c.onclick=$,A.onclick=$,h.onclick=se,p.appendChild(u)}function B(c=null){if(!u)return;let A=u.querySelector("#cw-editor-title-label"),h=u.querySelector("#cw-bc-title"),l=u.querySelector("#cw-bc-text"),S=u.querySelector("#cw-bc-send");if(c){o=c.id,A.textContent="Editar Aviso",h.value=c.title||"",l.value=c.text||"",S.textContent="Salvar Altera\xE7\xF5es";let k=c.type||"info",H=u.querySelector(`input[name="cw-bc-type"][value="${k}"]`);H&&H.click()}else{o=null,A.textContent="Novo Aviso",h.value="",l.value="",S.textContent="Publicar";let k=u.querySelector('input[name="cw-bc-type"][value="info"]');k&&k.click()}u.classList.add("active"),setTimeout(()=>h.focus(),300)}function $(){u&&u.classList.remove("active"),o=null}async function se(){let c=u.querySelector("#cw-bc-send"),A=u.querySelector("#cw-bc-title"),h=u.querySelector("#cw-bc-text"),l=u.querySelector('input[name="cw-bc-type"]:checked'),S=l?l.value:"info";if(!A.value.trim()||!h.value.trim()){Q("Preencha todos os campos!",{error:!0});return}c.textContent="Salvando...",c.style.opacity="0.7";let k=!1;o?k=await we.updateBroadcast(o,{title:A.value,text:h.value,type:S}):k=await we.sendBroadcast({title:A.value,text:h.value,type:S,author:window._cwCurrentUser||"admin"}),k?(Q(o?"Atualizado!":"Publicado!"),ie.playSuccess(),$(),setTimeout(()=>y(),1500)):(Q("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),c.textContent=o?"Salvar Altera\xE7\xF5es":"Publicar",c.style.opacity="1")}async function C(c){if(confirm("Confirma a exclus\xE3o deste aviso?"))if(await we.deleteBroadcast(c)){Q("Aviso removido."),ie.playClick();let h=ze.findIndex(l=>l.id===c);h>-1&&ze.splice(h,1),w(),setTimeout(()=>y(),1500)}else Q("Erro ao excluir.",{error:!0})}let v=document.createElement("div");v.className="cw-nice-scroll",Object.assign(v.style,i.feedContainer),p.appendChild(v);async function y(){e&&(F.style.display="block",F.innerHTML="\u{1F504} Sincronizando...");try{let c=await we.fetchData();c&&c.broadcast&&(Pt(c.broadcast),M(),e&&(w(),F.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{F.style.display="none"},1500)))}catch{e&&(F.innerHTML="\u26A0\uFE0F Offline")}}function M(){let c=document.getElementById("cw-btn-broadcast");if(!c)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(ze.some(l=>!A.includes(l.id))){if(c.classList.add("has-new"),!c.querySelector(".cw-badge")){let l=document.createElement("div");l.className="cw-badge",Object.assign(l.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),c.appendChild(l)}}else{c.classList.remove("has-new");let l=c.querySelector(".cw-badge");l&&l.remove()}}function w(){v.innerHTML="";let c=p.querySelector("#cw-bau-widget");c&&c.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),h=[...ze].sort((D,I)=>{let G=new Date(D.date).getTime()||0;return(new Date(I.date).getTime()||0)-G}),l=h.findIndex(D=>D.title&&D.title.toLowerCase().includes("disponibilidade bau"));if(l!==-1){let D=h[l];h.splice(l,1);let I=document.createElement("div");I.id="cw-bau-widget",Object.assign(I.style,i.bauContainer);let G=[],U=(D.text||"").split(`
`),O=/\d{1,2}\/\d{1,2}/;if(U.forEach(ce=>{let fe=ce.match(O);if(fe){let Se=fe[0],Ne="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(ce)?Ne="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(ce)&&(Ne="\u{1F1EA}\u{1F1F8}"),G.some(Fe=>Fe.flag===Ne&&Fe.date===Se)||G.push({flag:Ne,date:Se})}}),G.length===0){let ce=(D.text||"").match(/\d{1,2}\/\d{1,2}/g);ce&&[...new Set(ce)].forEach(fe=>G.push({flag:"\u{1F4C5}",date:fe}))}let P="",de='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(de=`
              ...
              ${P}
          `,F.after(I);let oe=I.querySelector("#cw-bau-toggle-btn"),ne=I.querySelector("#cw-bau-full");if(oe&&ne&&(oe.onclick=()=>{let ce=ne.style.display==="none";ne.style.display=ce?"block":"none",oe.textContent=ce?"Ocultar":"Detalhes"}),window._cwIsAdmin){let ce=I.querySelector(".cw-bau-edit");ce&&(ce.onclick=()=>B(D))}}let S=h.sort((D,I)=>{let G=A.includes(D.id),U=A.includes(I.id);return G===U?0:G?1:-1});if(S.length===0&&!l){let D=document.createElement("div");Object.assign(D.style,i.emptyState),D.innerHTML=`
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><path d="M9 12l2 2 4-4"></path></svg>
            <div style="font-weight:500;">Tudo lido!</div>
           `,v.appendChild(D)}let k=S.filter(D=>!A.includes(D.id)),H=S.filter(D=>A.includes(D.id));if(k.forEach(D=>v.appendChild(q(D,!1))),H.length>0){let D=document.createElement("div");Object.assign(D.style,i.historyDivider),D.innerHTML=`<span>Hist\xF3rico (${H.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let I=document.createElement("div");Object.assign(I.style,i.historyContainer),H.forEach(U=>I.appendChild(q(U,!0)));let G=!1;D.onclick=()=>{ie.playClick(),G=!G,I.style.display=G?"flex":"none",D.querySelector("svg").style.transform=G?"rotate(180deg)":"rotate(0deg)"},v.appendChild(D),v.appendChild(I)}}function q(c,A){let h=document.createElement("div");Object.assign(h.style,A?i.cardHistory:i.card);let l=a[c.type]||a.info,S=document.createElement("div");Object.assign(S.style,i.cardHeader);let k=document.createElement("div");Object.assign(k.style,i.typeTag,{color:l.color,background:l.bg}),k.innerHTML=`${l.icon} <span>${c.type}</span>`;let H=document.createElement("span");if(Object.assign(H.style,i.dateTag),H.textContent=s(c.date),S.appendChild(k),A)S.appendChild(H);else{let O=document.createElement("button");O.className="cw-btn-interactive",Object.assign(O.style,i.dismissBtn),O.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',O.onmouseenter=()=>{O.style.color="#1e8e3e",O.style.background="#e6f4ea",O.style.borderColor="#1e8e3e"},O.onmouseleave=()=>{O.style.color="#5f6368",O.style.background="#fff",O.style.borderColor="rgba(0,0,0,0.1)"},O.onclick=P=>{P.stopPropagation(),ie.playClick(),h.style.transform="translateX(20px)",h.style.opacity="0",setTimeout(()=>{let de=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");de.push(c.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(de)),w(),M()},200)},S.appendChild(O)}let D=document.createElement("div");Object.assign(D.style,i.cardContent);let I=document.createElement("div");Object.assign(I.style,i.msgTitle),I.textContent=c.title;let G=document.createElement("div");Object.assign(G.style,i.msgBody),G.innerHTML=d(c.text);let U=document.createElement("div");if(Object.assign(U.style,i.msgMeta),U.innerHTML=`Publicado por <b>${c.author||"Sistema"}</b>`,A||(U.innerHTML+=` \u2022 ${s(c.date)}`),D.appendChild(I),D.appendChild(G),D.appendChild(U),h.appendChild(S),h.appendChild(D),window._cwIsAdmin){let O=document.createElement("div");O.className="cw-card-actions";let P=document.createElement("button");P.className="cw-action-btn edit",P.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',P.onclick=()=>B(c);let de=document.createElement("button");de.className="cw-action-btn delete",de.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',de.onclick=()=>C(c.id),O.appendChild(P),O.appendChild(de),h.appendChild(O)}return h}let L=we.getCachedBroadcasts();L.length>0&&(Pt(L),w()),setTimeout(T,500),y(),n||(n=setInterval(y,Ho));let R=document.createElement("div");Object.assign(R.style,Qe),R.className="no-drag",p.appendChild(R),Ze(p,R),document.body.appendChild(p);let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),j=ze.some(c=>!E.includes(c.id));return{toggle:b,hasUnread:j}}function Vo(){if(window.techSolInitialized){Lt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{eo();try{ie.initGlobalListeners(),ie.playStartup()}catch(i){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",i)}we.fetchTips(),Lt();let t=wo(),e=Ao(),n=So(),o=Eo(),s=To();go({toggleNotes:t,toggleEmail:e,toggleScript:n,toggleLinks:o,broadcastControl:s})}catch(t){console.error("Erro fatal na inicializa\xE7\xE3o:",t),Q("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Vo();})();

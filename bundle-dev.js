(()=>{var Ye="",Jt=t=>new Promise(e=>setTimeout(e,t));async function Et(){if(Ye)return Ye;try{let t=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!t)return"Agente";t.click(),await Jt(100);let e="Consultor",n=document.querySelector("profile-details .name");if(n)e=n.textContent.trim().split(" ")[0],e=e.charAt(0).toUpperCase()+e.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let r=o.src.match(/\/photos\/([^\?]+)/)[1];e=r.charAt(0).toUpperCase()+r.slice(1)}}return t.click(),document.body.click(),Ye=e,e}catch(t){return console.warn("Sherlock falhou:",t),"Consultor"}}function dt(){return Ye||"Consultor"}function Tt(t){let e=new Date,n=e.getHours(),o=e.getDay(),r="Ol\xE1",s="";n>=5&&n<12?(r="Bom dia",s='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):n>=12&&n<18?(r="Boa tarde",s='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(r="Boa noite",s='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let a=[];n>=0&&n<5?a=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:n<12?o===1?a=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?a=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:a=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:n<18?a=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:a=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(a=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let i=a[Math.floor(Math.random()*a.length)];return{prefix:`${r},`,name:t,suffix:i,icon:s,isFriday:o===5}}function pt(){let t="Cliente",e="[INSERIR URL]";try{let o=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let r=o.nextElementSibling.innerText.trim();r&&(t=r)}}catch(n){console.warn("Falha ao capturar Nome:",n)}try{let o=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let r=o.nextElementSibling.innerText.trim();r&&(e=r)}}catch(n){console.warn("Falha ao capturar Website:",n)}return{advertiserName:t,websiteUrl:e,agentName:dt()}}var kt=1e4;function It(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let t=document.createElement("link");t.id="google-font-roboto",t.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",t.rel="stylesheet",document.head.appendChild(t);let e=document.createElement("style");e.id="techsol-global-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}function oe(t,e={}){let n=document.createElement("div"),o=e.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(n.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:o,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",pointerEvents:"none"}),n.textContent=t,document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>n.remove(),400)},e.duration||4e3)}function Nt(t,e=null){let n=0,o=0,r=0,s=0,a=e||t;a.style.cursor="grab",a.onmousedown=i;function i(m){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(m.target.tagName)||m.target.closest(".no-drag"))return;m=m||window.event,a.style.cursor="grabbing",t.style.transition="none";let l=t.getBoundingClientRect();t.style.transform="none",t.style.left=l.left+"px",t.style.top=l.top+"px",t.style.margin="0",t.style.bottom="auto",t.style.right="auto",kt++,t.style.zIndex=kt,r=m.clientX,s=m.clientY,t.setAttribute("data-dragging","true"),document.onmouseup=y,document.onmousemove=c}function c(m){m=m||window.event,m.preventDefault(),n=r-m.clientX,o=s-m.clientY,r=m.clientX,s=m.clientY;let l=t.offsetTop-o,T=t.offsetLeft-n,f=16,x=window.innerWidth,b=window.innerHeight,A=t.offsetWidth,E=t.offsetHeight;T<f?T=f:T+A>x-f&&(T=x-A-f),l<f?l=f:l+E>b-f&&(l=b-E-f),t.style.top=l+"px",t.style.left=T+"px"}function y(){document.onmouseup=null,document.onmousemove=null,a.style.cursor="grab",setTimeout(()=>{t.style.transition="all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease",t.setAttribute("data-dragging","false"),t.setAttribute("data-moved","true")},50)}}var Ee={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:"99999",overflow:"hidden",display:"flex",flexDirection:"column",backgroundColor:"rgba(248, 249, 250, 0.96)",backdropFilter:"blur(20px) saturate(180%)",borderRadius:"20px",boxShadow:"0 20px 50px -12px rgba(0,0,0,0.25), 0 0 0 1px rgba(0,0,0,0.05)",opacity:"0",pointerEvents:"none",fontFamily:"'Google Sans', 'Roboto'",transform:"translate(-50%, -50%)",transition:"all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease"};var mt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},He={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var _t={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var de={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var ut=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Ot=-1;function Ve(){let t=Math.floor(Math.random()*ut.length);return t===Ot&&(t=(t+1)%ut.length),Ot=t,ut[t]}var Se=t=>new Promise(e=>setTimeout(e,t));async function eo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let n=t.querySelector(".cursor");await Se(200);for(let o=0;o<e.length;o++){let r=e.charAt(o),s=document.createElement("span");s.textContent=r,n&&n.parentNode===t?n.before(s):t.appendChild(s);let a=Math.floor(Math.random()*60)+30;o===0&&(a=150),o>e.length-3&&(a=30),await Se(a)}await Se(600),n&&(n.style.display="none")}async function bt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let y=a.querySelector(".cw-hero-grid"),m=a.querySelector(".cw-acc-container"),l=a.querySelector(".cw-results-container"),T=a.querySelector(".cw-search-input"),f=a.querySelector(".cw-status-bar"),x=a.querySelector(".cw-status-text"),b=a.querySelector(".cw-footer-icons");o.forEach(([g,d])=>{let p=n(d.name),u=document.createElement("div");u.className="cw-hero-card",u.id=`hero-${g}`,u.style.setProperty("--hero-color",p.color),u.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${De[p.icon]}</div>
...
\u2022 `)?(R.preventDefault(),this.value=q.substring(0,C-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=C-3):q==="\u2022 "&&(R.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function rt(){let h=typeof snippetContainer<"u"?snippetContainer:document.getElementById("snippet-container");if(!h)return;let R=h.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),C={},q=new Set;R.forEach(W=>{let V=W.id,L=he[V];if(L)for(let N in L)N==="linkedTask"?q.add(L.linkedTask):N!=="type"&&(C[N]||(C[N]=[]),C[N].includes(L[N])||C[N].push(L[N]))});let te=new Set;Object.values(he).forEach(W=>{Object.keys(W).forEach(V=>{V!=="linkedTask"&&V!=="type"&&te.add(V)})}),te.forEach(W=>{let V=document.getElementById(W);if(V){let L=C[W]||[],N="";Ue.includes(W.replace("field-",""))?(N=L.map($=>$.startsWith("\u2022 ")?$:"\u2022 "+$).join(`
`),N===""?N="\u2022 ":N.endsWith(`
\u2022 `)||(N+=`
\u2022 `)):N=L.join(`

`),N.trim()!=="\u2022"&&N.trim()!==""?V.value=N:Ue.includes(W.replace("field-",""))?V.value="\u2022 ":V.value="",V.tagName==="TEXTAREA"&&typeof st=="function"&&st(V)}});let re=new Set,me=new Set;h.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(W=>{let V=he[W.id];V&&V.linkedTask&&(W.checked?re.add(V.linkedTask):me.add(V.linkedTask))}),me.forEach(W=>{re.has(W)||i.toggleTask(W,!1)}),re.forEach(W=>{i.toggleTask(W,!0)})}S.onchange=()=>{let h=S.value;if(lt(1.5),w.innerHTML=`<option value="">${z("select_substatus")}</option>`,!h){w.disabled=!0;return}for(let R in $e){let C=$e[R];if(C.status===h){let q=document.createElement("option");q.value=R,q.textContent=C.name,w.appendChild(q)}}w.disabled=!1},w.onchange=()=>{let h=w.value;if(lt(1.5),!h)return;i.updateSubStatus(h);let R=$e[h];snippetContainer.innerHTML="";let C=(L,N,$)=>{let ae=document.createElement("label");Object.assign(ae.style,s.checkboxLabel),ae.onmouseover=()=>ae.style.backgroundColor="#e8eaed",ae.onmouseout=()=>ae.style.backgroundColor="#f8f9fa";let Q=document.createElement("input");return Q.type=N,Q.id=L.id,Object.assign(Q.style,s.checkboxInput),ae.appendChild(Q),ae.appendChild(document.createTextNode(` ${L.text}`)),$.appendChild(ae),Q},q=[],te="radio";if(h==="NI_Awaiting_Inputs")q=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(h.startsWith("SO_"))te="checkbox",q=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(h.startsWith("AS_")){te="checkbox";let L=document.createElement("label");L.textContent=z("cenarios_comuns"),Object.assign(L.style,s.label),snippetContainer.appendChild(L),q=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else h.startsWith("IN_")&&(q=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let re=q.filter(L=>{let N=he[L.id];return!N.type||N.type==="all"||N.type===e});re.forEach((L,N)=>{let $=C(L,te,snippetContainer);te==="radio"&&($.name="scenario-radio-group",N===0&&($.checked=!0))}),re.length>0&&(_e.style.display="block"),R.requiresTasks?(pe.style.display="none",ze.style.display="block",i.selectionElement.style.display="block",fe.style.display="block"):(pe.style.display="block",ze.style.display="none",i.selectionElement.style.display="none",fe.style.display="block"),we.innerHTML="";let me=R.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(me)].forEach(L=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(L))return;let N=L.slice(1,-1),$=document.createElement("label"),ae=z(N.toLowerCase());$.textContent=ae!==N.toLowerCase()?ae:N.replace(/_/g," ").replace(/\b\w/g,ie=>ie.toUpperCase())+":",Object.assign($.style,s.label);let Q;Ue.includes(N)?(Q=document.createElement("textarea"),Object.assign(Q.style,s.textarea),Q.classList.add("bullet-textarea"),st(Q)):gt.includes(N)?(Q=document.createElement("textarea"),Object.assign(Q.style,s.textarea)):(Q=document.createElement("input"),Q.type="text",Object.assign(Q.style,s.input),N==="REASON_COMMENTS"&&(h.startsWith("NI_")||h.startsWith("IN_"))&&(Object.assign($.style,{display:"none"}),Object.assign(Q.style,{display:"none"}))),N==="ON_CALL"&&e==="lm"&&(Object.assign($.style,{display:"none"}),Object.assign(Q.style,{display:"none"}),Q.value="N/A"),Q.id=`field-${N}`,we.appendChild($),we.appendChild(Q)});let W=snippetContainer.querySelectorAll('input[type="checkbox"], input[type="radio"]');W.length>0&&(W.forEach(L=>{L.removeEventListener("change",rt),L.addEventListener("change",rt)}),rt()),Ce.style.display="block",Qe[h]?Re.style.display="block":Re.style.display="none",Pe.style.display="flex";let V=i.getCheckedElements().map(L=>L.value);a.updateVisibility(h,V)},pe.onclick=()=>{pe.style.display="none",ze.style.display="block",i.selectionElement.style.display="block"};function Ct(){let h=w.value;if(!h)return null;let C=$e[h].template.replace(/\n/g,"<br>"),q='style="margin-bottom: 12px; padding-left: 30px;"',te=[],re="",me=i.getCheckedElements();me.length>0&&me.forEach(V=>{let L=V.value,N=Te[L],$=V.closest().querySelector(".stepper-count"),ae=$?parseInt($.textContent):1;ae>1?te.push(`${N.name} (x${ae})`):te.push(N.name)});let le=i.screenshotsElement;if(le){let V=Array.from(le.querySelectorAll('input[id^="name-"]'));V.length>0&&V.forEach(L=>{let N=L.value,$=L.closest(".cw-screen-card");if($){let ae=$.querySelectorAll('input[id^="screen-"]'),Q=!1,ie="";ae.forEach(ue=>{let St=ue.closest(".cw-input-group"),At=St?St.querySelector(".cw-input-label"):null,Qt=At?At.textContent:"Evid\xEAncia",wt=ue.value.trim(),Zt=wt?` ${wt}`:"";ie+=`<li>${Qt} -${Zt}</li>`,Q=!0}),Q&&(re+=`<b>${N}</b>`,re+=`<ul ${q}>${ie}</ul>`)}})}if(C.includes("{TAGS_IMPLEMENTED}")?C=C.replace(/{TAGS_IMPLEMENTED}/g,te.join(", ")||"N/A"):te.length>0&&(C+=`<br><b>Tags:</b> ${te.join(", ")}<br>`),C.includes("{SCREENSHOTS_LIST}")?C=C.replace(/{SCREENSHOTS_LIST}/g,re?`${re}`:"N/A"):re!==""&&(C+=`<br>${re}`),n==="pt"&&o){let V=ge.checked?z("sim"):z("nao");C=C.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${z("consentiu_gravacao")}</b> ${V}<br><br>`),C=C.replace(/{CASO_PORTUGAL}/g,`<br><b>${z("caso_portugal")}</b> ${z("sim")}<br>`)}else n==="pt"&&!o?(C=C.replace(/{CASO_PORTUGAL}/g,`<br><b>${z("caso_portugal")}</b> ${z("nao")}<br>`),C=C.replace(/{CONSENTIU_GRAVACAO}/g,"")):(C=C.replace(/{CASO_PORTUGAL}/g,""),C=C.replace(/{CONSENTIU_GRAVACAO}/g,""));return we.querySelectorAll("input, textarea").forEach(V=>{let L=V.id.replace("field-",""),N=new RegExp(`{${L}}`,"g"),$=V.value;if(L==="REASON_COMMENTS"&&(h.startsWith("NI_")||h.startsWith("IN_"))){let ie=snippetContainer.querySelector('input[type="radio"]:checked');ie&&he[ie.id]&&($=he[ie.id]["field-REASON_COMMENTS"])}if(Ue.includes(L)&&$.trim()!==""){let ie=$.split(`
`).map(ue=>ue.trim()).filter(ue=>ue!==""&&ue!=="\u2022").map(ue=>ue.startsWith("\u2022 ")?ue.substring(2):ue).map(ue=>`<li>${ue}</li>`).join("");$=ie?`<ul ${q}>${ie}</ul>`:""}else gt.includes(L)?$=$.split(`
`).filter(ie=>ie.trim()!=="").map(ie=>`<p style="margin: 0 0 8px 0;">${ie}</p>`).join(""):V.tagName==="TEXTAREA"&&($=$.replace(/\n/g,"<br>"));let ae=$.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ae===""||ae==="\u2022"||ae.toLowerCase()==="n/a"){let ie=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${L}\\}(?:<br>\\s*)?`,"gi");ie.test(C)?C=C.replace(ie,""):C=C.replace(N,"")}else C=C.replace(N,$.replace(/\$/g,"$$$$"))}),C=C.replace(/{([A-Z0-9_]+)}/g,""),C=C.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(C+=a.getOutput()),C}je.onclick=()=>{let h=Ct();h?(xt(h),oe(z("copiado_sucesso"))):oe(z("selecione_substatus"),{error:!0})},Be.onclick=async()=>{let h=w.value,R=Ct();if(!R){oe(z("selecione_substatus"),{error:!0});return}xt(R),ct();let C=et(),q=await Bt();if(q)try{if(q.focus(),q.innerHTML.trim()==="<p><br></p>"||q.innerHTML.trim()==="<br>"||q.innerText.trim()===""){let le=document.createRange();le.selectNodeContents(q);let W=window.getSelection();W.removeAllRanges(),W.addRange(le),document.execCommand("delete",!1,null)}else if(!q.innerHTML.endsWith("<br><br>")){let le=document.createRange();le.selectNodeContents(q),le.collapse(!1);let W=window.getSelection();W.removeAllRanges(),W.addRange(le),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,R),jt(q),setTimeout(()=>{oe(z("inserido_copiado"))},600);let re=typeof Me<"u"&&Me?Me.checked:!0;if(h&&Qe[h]&&re){let le=Qe[h];await Lt(le),await new Promise(W=>setTimeout(W,500))}C(),lt(1.5),S.value="",w.innerHTML=`<option value="">${z("select_substatus")}</option>`,w.disabled=!0}catch(te){console.error(te),oe("Erro ao inserir.",{error:!0}),C()}};function lt(h=1.5){h<=1.5&&(_e.style.display="none",snippetContainer.innerHTML=""),h<=2&&(fe.style.display="none",i.reset(),pe.style.display="none"),h<=3&&(Ce.style.display="none",we.innerHTML="",a.reset(),Pe.style.display="none",Re.style.display="none")}function ct(){if(r=!r,r){let h=c.querySelector(".cw-expand-btn");h&&typeof h.resetState=="function"&&h.resetState()}Ie(r,c,"cw-btn-notes")}return at("bau"),it("pt"),ct}var Ge={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>

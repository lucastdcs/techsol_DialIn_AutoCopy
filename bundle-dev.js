...
\u2022 Tentativa 2 -`}};var fe=t=>new Promise(e=>setTimeout(e,t));function ve(t,e="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,n[e]||n.info)}function qe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>t.dispatchEvent(new MouseEvent(n,e)))}function xt(t,e){if(!t)return;let n=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=t.getBoundingClientRect(),i=document.createElement("div");i.id=n,i.style.cssText=`
    ...
    .cw-focus-backdrop {
        ...
        transition: opacity 0.4s ease; /* Ajustado para acompanhar a nova f\xEDsica */
    }
    ...
    .cw-pill {
        ...
        /* ABRIR: Efeito "El\xE1stico" (Overshoot) - Vai um pouco al\xE9m e volta */
        transition: 
    ...
    .cw-pill.collapsed {
        ...
        /* FECHAR: Efeito "Back-in" - Recua (encolhe demais) antes de estabilizar */
        transition: 
    ...
    .cw-main-logo {
        ...
        transform: scale(2) rotate(180deg); /* Come\xE7a gigante */
        color: #fff;
    ...
    .cw-pill.collapsed .cw-main-logo { 
        ...
        /* "Carimba" a bolinha com um bounce no final */
    ...
    .cw-pill > *:not(.cw-main-logo) {
        opacity: 1;
        transform: scale(1);
        /* ABRIR: Itens "pulam" para fora com delay */
        transition: 
    ...
    .cw-pill.collapsed > *:not(.cw-main-logo) {
        opacity: 0; 
        pointer-events: none; 
        /* FECHAR: Sugados para o centro (escala 0) */
        transform: scale(0); 
        /* Transi\xE7\xE3o r\xE1pida com efeito "sugador" */
        transition: 
            opacity 0.25s ease 0s, 
            transform 0.3s cubic-bezier(0.36, 0, 0.66, -0.56) 0s;
    }

    /* --- (Removida a cascata de delays para focar no efeito "sugador" unificado) --- */
    /* Na op\xE7\xE3o "Jelly", tudo ser sugado junto refor\xE7a a f\xEDsica de gelatina/v\xE1cuo. */

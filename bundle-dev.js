...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Nt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},oo={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var no={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var ye={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var _t=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Jt=-1;function it(){let t=Math.floor(Math.random()*_t.length);return t===Jt&&(t=(t+1)%_t.length),Jt=t,_t[t]}var Le=t=>new Promise(e=>setTimeout(e,t));async function No(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let n=t.querySelector(".cursor");await Le(200);for(let o=0;o<e.length;o++){let s=e.charAt(o),i=document.createElement("span");i.textContent=s,n&&n.parentNode===t?n.before(i):t.appendChild(i);let a=Math.floor(Math.random()*60)+30;o===0&&(a=150),o>e.length-3&&(a=30),await Le(a)}await Le(600),n&&(n.style.display="none")}async function Lt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await Yt(),n=Kt(e),o=t.querySelector("#w-icon"),s=t.querySelector("#p1"),i=t.querySelector("#p2"),a=t.querySelector("#p3"),r=t.querySelector("#p-sextou");o&&(o.innerHTML=n.icon),s&&(s.textContent=n.prefix),a&&(a.textContent=n.suffix),await Le(300);let d=o?o.querySelector("svg"):null;if(d&&(d.style.opacity="1",d.style.transform="scale(1)"),await Le(400),s&&(s.style.opacity="1"),oe.playStartup(),i&&await No(i,n.name),a&&(a.style.opacity="1",a.style.transform="translateY(0)"),n.isFriday&&r){await Le(400),r.style.display="block",r.offsetWidth;let p=r.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}var Qe={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Ze(t,e){e.onmousedown=n;function n(o){o.stopPropagation(),o.preventDefault();let s=t.style.transition;t.style.transition="none";let i=o.clientX,a=o.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),d=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),p=i,u=a,l=!1;function f(E){p=E.clientX,u=E.clientY,l||(window.requestAnimationFrame(()=>{b(),l=!1}),l=!0)}function b(){let E=r+(p-i),F=d+(u-a);E>360&&(t.style.width=E+"px"),F>300&&(t.style.height=F+"px")}function g(){document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=s},50)}document.addEventListener("mousemove",f),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function ao(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,n=>e[n]?e[n]:"")}var Je=t=>new Promise(e=>setTimeout(e,t));function st(t){t&&["mousedown","mouseup","click"].forEach(e=>t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window})))}var io="cw-automation-styles";if(!document.getElementById(io)){let t=document.createElement("style");t.id=io,t.innerHTML=`
...
\u2022 Tentativa 2 -`}};var be=t=>new Promise(e=>setTimeout(e,t));function ve(t,e="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,n[e]||n.info)}function Oe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>t.dispatchEvent(new MouseEvent(n,e)))}function gt(t,e){if(!t)return;let n=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=t.getBoundingClientRect(),i=document.createElement("div");i.id=n,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let a=i.querySelector(".cw-close-btn");a.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&a.click()},25e3)}async function bt(t,e){if(!t||!e)return;t.focus(),t.value="",t.dispatchEvent(new Event("input",{bubbles:!0})),await be(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(t,e),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})),await be(100),t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function Ft(){let e=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(n=>{let o=n.offsetParent!==null,s=n.closest("case-message-view")!==null,i=n.closest(".editor")!==null||n.closest("write-card")!==null;return o&&!s&&i});return e&&ve("Editor visualmente detectado.","success"),e}async function lo(){ve("\u{1F680} FASE 1: Tentando abrir a janela de email...");let t=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(l=>l.innerText.trim()==="email");if(n&&n.offsetParent!==null){ve("Bot\xE3o de email direto encontrado.");let l=n.closest("material-button")||n.closest("material-fab")||n;Oe(l),t=!0}else{ve("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let l=document.querySelector("material-fab-speed-dial");if(l){let f=l.querySelector(".trigger");if(f){Oe(f),await be(800);let g=Array.from(document.querySelectorAll("i.material-icons-extended")).find(E=>E.innerText.trim()==="email");g&&(Oe(g),t=!0)}}}if(!t)return Y("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;ve("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,s=0,i=20;for(;s<i;){await be(250);let l=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(l).find(f=>f.offsetParent!==null),o){ve("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(o){ve("\u{1F5D1}\uFE0F Descartando..."),Oe(o),o.click();let l=null,f=0;for(;f<15;){await be(300);let b=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(l=Array.from(b).find(g=>g.offsetParent!==null),l)break;f++}l&&(Oe(l),Y("Limpando rascunho antigo...",{duration:2e3}),await be(2500))}ve("\u{1F680} FASE 3: Buscando editor final...");let a=0,r=null;for(;a<20&&(r=Ft(),!r);)await be(250),a++;if(!r)return Y("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let d=r.closest('[id="email-body-content-top"]'),u=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(d){if(u){let f=u.closest('[aria-hidden="true"]');f&&f.removeAttribute("aria-hidden"),u.focus(),Oe(u)}await be(300),d.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let l=d.querySelector("#cases-body-field");if(l){let f=document.createRange();f.selectNodeContents(l),f.collapse(!0);let b=window.getSelection();b.removeAllRanges(),b.addRange(f)}return!0}return!1}async function ft(t){if(!t||!await lo())return;let n=await at();ve("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await be(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await bt(i,n.clientEmail),gt(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await bt(i,n.internalEmail),gt(i,`
    ...
    `;let s=document.createElement("div");if(s.className="cw-focus-backdrop",document.body.appendChild(s),document.body.appendChild(o),o.querySelector(".notes").onclick=b=>{b.stopPropagation(),t.toggleNotes()},o.querySelector(".email").onclick=b=>{b.stopPropagation(),t.toggleEmail()},o.querySelector(".script").onclick=b=>{b.stopPropagation(),t.toggleScript()},o.querySelector(".links").onclick=b=>{b.stopPropagation(),t.toggleLinks()},o.querySelector(".broadcast").onclick=b=>{b.stopPropagation();let g=b.currentTarget.querySelector(".cw-badge");g&&(g.style.transform="scale(0)",setTimeout(()=>g.remove(),200)),t.broadcastControl&&t.broadcastControl.toggle()},t.broadcastControl&&t.broadcastControl.hasUnread){let b=document.createElement("div");b.className="cw-badge",o.querySelector(".broadcast").appendChild(b)}(async function(){await ht(2800),o.classList.add("docked"),await ht(300);let g=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(E=>E.classList.add("visible"));for(let E=0;E<g.length;E++)g[E].classList.add("popped"),await ht(90);await ht(200),o.classList.add("system-check")})();let i=!1,a,r,d,p,u=3;o.onmousedown=b=>{if(b.target.closest("button"))return;b.preventDefault(),a=b.clientX,r=b.clientY;let g=o.getBoundingClientRect();d=g.left,p=g.top,document.addEventListener("mousemove",l),document.addEventListener("mouseup",f)};function l(b){let g=b.clientX-a,E=b.clientY-r;!i&&Math.sqrt(g*g+E*E)>u&&(i=!0,o.style.transition="none"),i&&(o.style.left=`${d+g}px`,o.style.top=`${p+E}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function f(b){if(document.removeEventListener("mousemove",l),document.removeEventListener("mouseup",f),i){i=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let g=window.innerWidth,E=window.innerHeight,F=o.getBoundingClientRect(),_=F.left+F.width/2,z;_<g/2?(z=24,o.classList.remove("side-right"),o.classList.add("side-left")):(z=g-F.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let $=F.top;$<24&&($=24),$>E-F.height-24&&($=E-F.height-24),o.style.left=`${z}px`,o.style.top=`${$}px`}else{let g=b.target.closest("button");g&&(g.style.transform="scale(0.9)",setTimeout(()=>g.style.transform="",150))}}}function xt(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};window._CW_ABORT_PROCESS=!1;let n=document.createElement("div");n.className="cw-center-stage",n.innerHTML=`
        <div class="cw-center-dots"><span></span><span></span><span></span></div>
        <div class="cw-center-text">${we.getRandomTip()}</div>
        <div class="cw-center-success">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
        </div>
    `;let o=document.createElement("div");o.className="cw-abort-btn",o.textContent="Cancelar",o.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,Y("Cancelado! Mas a nota foi copiada para a \xE1rea de transfer\xEAncia.",{duration:4e3}),n.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),e&&e.classList.remove("active")},n.appendChild(o),t.appendChild(n);let s=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(n))return;let a=Date.now()-s,r=Math.max(0,2e3-a);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(n))return;let d=n.querySelector(".cw-center-dots"),p=n.querySelector(".cw-center-text"),u=n.querySelector(".cw-center-success"),l=n.querySelector(".cw-abort-btn");d&&(d.style.display="none"),p&&(p.style.display="none"),l&&(l.style.display="none"),u&&u.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{n.remove(),t.classList.remove("success"),e&&e.classList.remove("active")},400)},1e3)},r)}}function bo(t){let e=document.createElement("div");e.className="cw-step-scenarios";let n=document.createElement("div");Object.assign(n.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let o=document.createElement("div");Object.assign(o.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"40px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s ease"}),o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>";let s=null;Object.entries(ke).forEach(([a,r])=>{let d=document.createElement("div");d.textContent=a,Object.assign(d.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",display:"flex",alignItems:"center",gap:"6px"}),d.onmouseenter=()=>{s!==r&&(o.style.background="#fff",o.style.borderColor="#1a73e8",o.style.color="#202124",o.textContent=`"${r.substring(0,120)}${r.length>120?"...":""}"`),s!==r&&(d.style.background="#f1f3f4")},d.onmouseleave=()=>{s!==r&&(s||(o.style.background="#f8f9fa",o.style.borderColor="#dadce0",o.style.color="#5f6368",o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>"),d.style.background="#ffffff")},d.onclick=()=>{oe.playClick(),s===r?(s=null,i(),t("")):(s=r,i(),d.style.transform="scale(0.95)",setTimeout(()=>d.style.transform="scale(1)",150),t(r))},n.appendChild(d)});function i(){Array.from(n.children).forEach(a=>{ke[a.textContent]===s?(a.style.background="#e8f0fe",a.style.borderColor="#1a73e8",a.style.color="#1967d2",a.style.fontWeight="500"):(a.style.background="#ffffff",a.style.borderColor="#dadce0",a.style.color="#3c4043",a.style.fontWeight="400")})}return e.appendChild(n),e.appendChild(o),e}var fo=t=>new Promise(e=>setTimeout(e,t));function yt(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>t.dispatchEvent(new MouseEvent(n,e)))}function ct(t){let e=document.createElement("div");e.style.position="fixed",e.style.left="-9999px",e.innerHTML=t,document.body.appendChild(e);let n=document.createRange();n.selectNodeContents(e);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{Y("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(e)}function vt(t){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});t.dispatchEvent(o)})}function ho(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function wt(){console.log("Iniciando processo de Nova Nota...");let t=ho(),e=t.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(a=>a.innerText.trim()==="description");if(o){let a=o.closest("material-fab")||o.closest("material-button");a?(a.style&&(a.style.display="block",a.style.visibility="visible"),yt(a)):yt(o)}else{let a=document.querySelector("material-fab-speed-dial");if(a){let r=a.querySelector(".trigger");r?(r.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),yt(r)):a.click(),await fo(800);let p=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="description");p&&yt(p)}}let s=null,i=0;for(;!s&&i<20;){await fo(300);let a=ho();if(a.length>e)s=a.find(r=>!t.includes(r)),s||(s=a[a.length-1]);else if(i>10){let r=a.filter(d=>d.offsetParent!==null);r.length>0&&(s=r[r.length-1])}i++}return s}var J={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},Me="cubic-bezier(0.25, 0.8, 0.25, 1)",Go={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${J.border}`,backgroundColor:J.bgInput,fontSize:"14px",color:J.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${Me}, box-shadow 0.2s ${Me}, background-color 0.2s`,outline:"none"},yn={...Go,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},vn={fontSize:"13px",fontWeight:"700",color:J.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},wn={display:"block",fontSize:"13px",fontWeight:"600",color:J.text,marginBottom:"8px",marginTop:"16px"},An={fontSize:"12px",color:J.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},Cn={fontSize:"12px",color:J.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},Sn={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:J.text,cursor:"pointer",padding:"12px 14px",backgroundColor:J.surface,border:`1px solid ${J.border}`,borderRadius:"12px",transition:`all 0.2s ${Me}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},Bt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:J.primary},En={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:J.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${Me}, box-shadow 0.2s ${Me}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},Tn={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${J.primary}`,color:J.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${Me}`},kn={background:"transparent",border:`1px solid ${J.border}`,borderRadius:"20px",color:J.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${Me}`,fontFamily:"'Google Sans', 'Roboto'"};var On={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:J.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},In={fontSize:"13px",fontWeight:"700",color:J.primary,minWidth:"20px",textAlign:"center"},qn={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${J.border}`,backgroundColor:J.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${Me}, box-shadow 0.2s ${Me}`},Mn={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${J.bgInput}`},_n={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${J.border}`,backgroundColor:J.surface,color:J.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${Me}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Nn={backgroundColor:J.primaryBg,color:J.primary,borderColor:J.primary,fontWeight:"600"},Ln={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:J.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Rn={borderTop:`1px solid ${J.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Fn={maxHeight:"240px",overflowY:"auto",border:`1px solid ${J.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:J.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},Dn={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${J.bgInput}`,cursor:"pointer",fontSize:"13px",color:J.text,transition:"background 0.1s",userSelect:"none"};var zo={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},Bo={fontSize:"12px",color:"#e37400",marginTop:"4px"},Po={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},jo={display:"flex",gap:"15px",marginBottom:"10px"};function xo(){let t=document.createElement("div");t.id="tag-support-container",Object.assign(t.style,zo);let e=document.createElement("label");e.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(e.style,Nt,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,jo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,Bt);let s=document.createElement("label");s.textContent="Sim";let i=document.createElement("div");Object.assign(i.style,{display:"flex",alignItems:"center"}),i.appendChild(o),i.appendChild(s);let a=document.createElement("input");a.type="radio",a.name="ts_usage_mod",a.value="N\xE3o",a.checked=!0,Object.assign(a.style,Bt);let r=document.createElement("label");r.textContent="N\xE3o";let d=document.createElement("div");Object.assign(d.style,{display:"flex",alignItems:"center"}),d.appendChild(a),d.appendChild(r),n.appendChild(i),n.appendChild(d);let p=document.createElement("div");p.style.display="block";let u=document.createElement("label");u.textContent="Qual foi o Motivo?",Object.assign(u.style,Nt,{fontSize:"12px"});let l=document.createElement("input");l.type="text",Object.assign(l.style,Po);let f=document.createElement("div");f.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(f.style,Bo),p.appendChild(u),p.appendChild(l),p.appendChild(f),t.appendChild(e),t.appendChild(n),t.appendChild(p),o.onchange=()=>{p.style.display="none"},a.onchange=()=>{p.style.display="block"};function b(F,_){if(t.style.display="none",!F||F.includes("Education")||!_||_.length===0)return;let z=_.some(y=>y.includes("enhanced")||y==="ec_google_ads"),$=_.some(y=>(y.includes("conversion")||y.includes("ads"))&&!y.includes("enhanced")),se=_.some(y=>y.includes("ga4")||y.includes("analytics")||y.includes("ua")),C=_.some(y=>y.includes("merchant")||y.includes("gmc")||y.includes("shopping"));(z||$&&!se&&!C)&&(t.style.display="block")}function g(){if(t.style.display==="none")return"";let F=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return a.checked&&l.value.trim()!==""&&(F+=`<br><b>Motivo:</b> ${l.value}`),F+="<br>",F}function E(){t.style.display="none",a.checked=!0,o.checked=!1,p.style.display="block",l.value=""}return{element:t,updateVisibility:b,getOutput:g,reset:E}}var X={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Ye={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function yo(t){let e={},n="implementation";function o(C){let v=C.toLowerCase();return v.includes("ads")||v.includes("conversion")||v.includes("remarketing")?X.brands.ads:v.includes("ga4")||v.includes("analytics")?X.brands.ga4:v.includes("gtm")||v.includes("tag manager")||v.includes("container")?X.brands.gtm:v.includes("merchant")||v.includes("shopping")||v.includes("feed")?X.brands.gmc:X.brands.default}let s=Object.entries(Ge).filter(([C,v])=>v.popular),i={};Object.entries(Ge).forEach(([C,v])=>{if(v.popular)return;let y=o(v.name);i[y.label]||(i[y.label]={brand:y,tasks:[]}),i[y.label].tasks.push({key:C,...v})});let a="cw-zen-tasks";if(!document.getElementById(a)){let C=document.createElement("style");C.id=a,C.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(C)}let r=document.createElement("div");r.className="cw-zen-container";let d=document.createElement("div");Object.assign(d.style,{display:"none"});let p=document.createElement("div");p.className="cw-screens-container",d.appendChild(p),r.innerHTML=`
    ...
    `;let u=r.querySelector(".cw-hero-grid"),l=r.querySelector(".cw-acc-container"),f=r.querySelector(".cw-results-container"),b=r.querySelector(".cw-search-input"),g=r.querySelector(".cw-status-bar"),E=r.querySelector(".cw-status-text"),F=r.querySelector(".cw-footer-icons");s.forEach(([C,v])=>{let y=o(v.name),M=document.createElement("div");M.className="cw-hero-card",M.id=`hero-${C}`,M.style.setProperty("--hero-color",y.color),M.innerHTML=`
        ...
        `,M.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let I=e[C]?e[C].count:0;z(C,I>0?-I:1,v)},M.querySelector(".minus").onclick=()=>z(C,-1,v),M.querySelector(".plus").onclick=()=>z(C,1,v),M.dataset.color=y.color,u.appendChild(M)});function _(C,v){let y=o(v.name),M=document.createElement("div");return M.className="cw-task-item",M.dataset.id=C,M.innerHTML=`
        ...
        `,M.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let I=e[C]?e[C].count:0;z(C,I>0?-I:1,v)},M.querySelector(".minus").onclick=()=>z(C,-1,v),M.querySelector(".plus").onclick=()=>z(C,1,v),M}Object.entries(i).forEach(([C,v])=>{let y=document.createElement("div");y.className="cw-acc-group";let M=document.createElement("div");M.className="cw-acc-header",M.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${v.brand.color}"></div>
                ${C}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,M.onclick=()=>{l.querySelectorAll(".cw-acc-group.open").forEach(I=>{I!==y&&I.classList.remove("open")}),y.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",v.tasks.forEach(I=>{let L=_(I.key,I);w.appendChild(L)}),y.appendChild(M),y.appendChild(w),l.appendChild(y)});function z(C,v,y){e[C]||(e[C]={count:0,data:y,brand:o(y.name)}),e[C].count+=v,e[C].count<=0&&delete e[C],$(),se(),t&&t()}function $(){s.forEach(([w])=>{let I=u.querySelector(`#hero-${w}`);if(!I)return;let L=e[w];L?(I.classList.add("active"),I.querySelector(".cw-step-val").textContent=L.count,I.querySelector(".cw-step-val").style.color=I.dataset.color):I.classList.remove("active")}),r.querySelectorAll(".cw-task-item").forEach(w=>{let I=w.dataset.id,L=e[I];L?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=L.count):w.classList.remove("selected")});let v=Object.keys(e),y=0,M=[];if(v.forEach(w=>{let I=e[w];y+=I.count;for(let L=0;L<I.count;L++)M.length<6&&M.push(I.brand)}),y>0){g.classList.add("visible");let w=y>1?"A\xE7\xF5es":"A\xE7\xE3o",I=y>1?"definidas":"definida";E.textContent=`${y} ${w} ${I}`,F.innerHTML="",M.forEach(L=>{let R=document.createElement("div");R.className="cw-mini-icon",R.innerHTML=Ye[L.icon]||Ye.default;let T=R.querySelector("svg");T&&(T.style.width="14px",T.style.height="14px"),F.appendChild(R)})}else g.classList.remove("visible")}b.addEventListener("input",C=>{let v=C.target.value.toLowerCase();if(v.length>0){l.style.display="none",f.style.display="block",f.innerHTML="";let y=!1;Object.entries(Ge).forEach(([M,w])=>{if(w.name.toLowerCase().includes(v)){y=!0;let I=_(M,w);e[M]&&(I.classList.add("selected"),I.querySelector(".cw-step-val").textContent=e[M].count),f.appendChild(I)}}),y||(f.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else l.style.display="block",f.style.display="none"});function se(){p.innerHTML="";let C=Object.keys(e),v=!1,y=document.getElementById("sub-status"),M="implementation";if(y&&y.value.toLowerCase().includes("education")&&(M="education"),C.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(C.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`
        ...
        `,p.appendChild(w),C.forEach(I=>{let L=e[I].data,R=e[I].count,T=e[I].brand,j=L.screenshots?L.screenshots[M]||[]:["Link da Evid\xEAncia"];if(j.length>0){v=!0;for(let m=1;m<=R;m++){let A=document.createElement("div");A.className="cw-screen-card",A.style.setProperty("--brand-color",T.color),A.style.setProperty("--brand-bg",T.bg),A.style.setProperty("--brand-shadow",T.color+"40");let h=document.createElement("div");h.className="cw-card-header";let c=document.createElement("div");c.className="cw-card-icon",c.innerHTML=Ye[T.icon]||Ye.default;let S=document.createElement("div");S.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let k=document.createElement("input");k.className="cw-card-title-input",k.id=`name-${I}-${m}`,k.value=`${L.name}${R>1?" #"+m:""}`,k.title="Clique para renomear esta task";let H=document.createElement("span");H.className="cw-edit-hint",H.innerHTML="\u270E Renomear",S.appendChild(k),S.appendChild(H),h.appendChild(c),h.appendChild(S),A.appendChild(h),j.forEach((D,q)=>{let G=document.createElement("div");G.className="cw-input-group";let U=document.createElement("label");U.className="cw-input-label",U.textContent=D.replace(/📷|:|•/g,"").trim();let O=document.createElement("input");O.className="cw-input-field",O.id=`screen-${I}-${m}-${q}`,O.placeholder="Cole o link aqui...",O.setAttribute("autocomplete","off"),O.addEventListener("input",()=>{O.value.trim().length>5?O.classList.add("filled"):O.classList.remove("filled")});let P=document.createElement("div");P.className="cw-input-check",P.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',G.appendChild(U),G.appendChild(O),G.appendChild(P),A.appendChild(G)}),p.appendChild(A)}}}),d.style.display=v?"block":"none"}return{selectionElement:r,screenshotsElement:d,updateSubStatus:()=>se(),getCheckedElements:()=>Object.keys(e).map(C=>({value:C,closest:()=>({querySelector:()=>({textContent:e[C].count})})})),toggleTask:(C,v=!0)=>{let y=e[C];v&&!y?z(C,1,Ge[C]):!v&&y&&z(C,-y.count,Ge[C])},setMode:C=>{n=C,se()},reset:()=>{for(let C in e)delete e[C];b.value="",l.style.display="block",f.style.display="none",$(),se()}}}function vo(t){let e=document.createElement("div");e.style.cssText="display: flex; flex-direction: column; height: 100%; width: 100%; background: #F8F9FA; position: relative; overflow: hidden;";let n=document.createElement("div");n.style.cssText="flex: 1; overflow-y: auto; padding: 20px 24px 80px 24px;";let o={sectionTitle:"font-size: 11px; font-weight: 700; color: #5F6368; text-transform: uppercase; letter-spacing: 0.5px; margin: 24px 0 12px 0; border-bottom: 1px solid #E0E0E0; padding-bottom: 6px;",label:"display: block; font-size: 13px; font-weight: 600; color: #202124; marginBottom: 6px;",input:"width: 100%; padding: 10px 12px; border-radius: 8px; border: 1px solid #DADCE0; background: #FFFFFF; font-size: 14px; color: #3C4043; transition: all 0.2s; outline: none; box-sizing: border-box;",inputFocus:"border-color: #1a73e8; box-shadow: 0 0 0 2px rgba(26,115,232,0.15);",textarea:"min-height: 80px; resize: vertical; line-height: 1.5; font-family: Roboto, sans-serif;",radioGroup:"display: flex; gap: 12px; margin-bottom: 16px;",radioLabel:"flex: 1; display: flex; align-items: center; justify-content: center; padding: 10px; border: 1px solid #DADCE0; border-radius: 8px; background: #FFF; cursor: pointer; transition: all 0.2s; font-size: 13px; font-weight: 500; color: #3C4043; user-select: none;",radioActive:"background: #E8F0FE; border-color: #1967D2; color: #1967D2; font-weight: 600;",banner:"background: #FEF7E0; border: 1px solid #FEEFC3; border-radius: 8px; padding: 12px 16px; margin-bottom: 20px; font-size: 12px; color: #B06000; line-height: 1.5; display: flex; gap: 10px; align-items: start;",magicBtn:"width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 10px; background: #E8F0FE; color: #1967D2; border: 1px dashed #1967D2; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.2s; margin-bottom: 20px;"};function s(T,j,m="text",A=""){let h=document.createElement("div");h.style.marginBottom="16px";let c=document.createElement("label");c.style.cssText=o.label,c.textContent=j;let S;return m==="textarea"?(S=document.createElement("textarea"),S.style.cssText=o.input+o.textarea):(S=document.createElement("input"),S.type=m,S.style.cssText=o.input),S.onfocus=()=>S.style.cssText+=o.inputFocus,S.onblur=()=>{m==="textarea"?S.style.cssText=o.input+o.textarea:S.style.cssText=o.input},S.id=`st-${T}`,S.placeholder=A,h.appendChild(c),h.appendChild(S),{wrapper:h,input:S}}function i(T,j){let m=document.createElement("div"),A=document.createElement("label");A.style.cssText=o.label,A.textContent=j,m.appendChild(A);let h=document.createElement("div");return h.style.cssText=o.radioGroup,["Yes","No"].forEach(c=>{let S=document.createElement("label");S.style.cssText=o.radioLabel;let k=document.createElement("input");k.type="radio",k.name=`st-${T}`,k.value=c==="Yes"?"Y":"N",k.style.display="none",c==="No"&&(k.checked=!0),S.appendChild(k),S.appendChild(document.createTextNode(c)),k.addEventListener("change",()=>{h.querySelectorAll("label").forEach(H=>H.style.cssText=o.radioLabel),k.checked&&(S.style.cssText=o.radioLabel+o.radioActive)}),c==="No"&&(S.style.cssText=o.radioLabel+o.radioActive),h.appendChild(S)}),m.appendChild(h),{wrapper:m}}let a=document.createElement("div");a.style.cssText=o.banner,a.innerHTML=`
    ...
    `,n.appendChild(a);let r=document.createElement("button");r.style.cssText=o.magicBtn,r.innerHTML="<span>\u2728</span> Preencher Automaticamente",r.onmouseover=()=>r.style.background="#D2E3FC",r.onmouseout=()=>r.style.background="#E8F0FE",n.appendChild(r);let d=document.createElement("div");d.style.cssText=o.sectionTitle,d.style.marginTop="0",d.textContent="1. Dados T\xE9cnicos",n.appendChild(d);let p=s("cid","Ads CID"),u=s("ga4","GA4 ID"),l=s("gtm","GTM ID"),f=i("access","Advertiser has access to GA4/GTM?"),b=s("access-email","If Yes, User Email"),g=i("ghost","Ghosting Access Available?");n.append(p.wrapper,u.wrapper,l.wrapper,f.wrapper,b.wrapper,g.wrapper);let E=document.createElement("div");E.style.cssText=o.sectionTitle,E.textContent="2. Contato & Problema",n.appendChild(E);let F=s("name","Name of Advertiser"),_=s("url","Website Address"),z=s("phone","Phone Number"),$=s("email","Email Address"),se=s("callback","Preferred Call Back Time (w/ Timezone)"),C=s("desc","Detailed Issue Description","textarea"),v=s("checks","Checks Performed by Tech Team","textarea"),y=s("screens","Uncropped Screenshots (Links)","textarea");n.append(F.wrapper,_.wrapper,z.wrapper,$.wrapper,se.wrapper,C.wrapper,v.wrapper,y.wrapper);let M=document.createElement("div");M.style.cssText=o.sectionTitle,M.textContent="3. Contatos para C\xF3pia (CC)",n.appendChild(M);let w=s("c-adv","Advertiser Contact"),I=s("c-am","Account Manager");n.append(w.wrapper,I.wrapper);let L=document.createElement("div");L.style.cssText="padding: 16px 24px; background: #fff; border-top: 1px solid #E0E0E0; display: flex; justify-content: flex-end; position: absolute; bottom: 0; width: 100%; box-sizing: border-box; z-index: 10;";let R=document.createElement("button");return R.textContent="Gerar Nota S&T",R.style.cssText="padding: 10px 24px; background: #1a73e8; color: #fff; border: none; border-radius: 24px; font-size: 14px; font-weight: 600; cursor: pointer; box-shadow: 0 2px 6px rgba(26, 115, 232, 0.3); transition: transform 0.1s;",R.onactive=()=>R.style.transform="scale(0.96)",L.appendChild(R),e.appendChild(n),e.appendChild(L),r.onclick=async()=>{r.innerHTML="<span>\u23F3</span> Buscando...";let T=await at();T.advertiserName&&(F.input.value=T.advertiserName),T.websiteUrl&&(_.input.value=T.websiteUrl),T.clientEmail&&($.input.value=T.clientEmail,w.input.value=T.clientEmail);let m=document.body.innerText.match(/\d{3}-\d{3}-\d{4}/);m&&(p.input.value=m[0]),r.innerHTML="<span>\u2705</span> Dados Preenchidos!",setTimeout(()=>{r.innerHTML="<span>\u2728</span> Preencher Automaticamente"},2e3),Y("Dados capturados com sucesso!")},R.onclick=async()=>{let T=c=>{let S=e.querySelector(`#st-${c}`);return S?S.value:""},j=c=>{let S=e.querySelector(`input[name="st-${c}"]:checked`);return S?S.value:"N"},A=`Split & Transfer : Phone Note Format [Mandatory]

<b>Advertiser\u2019s info:</b>
<b>Ads CID:</b> ${T("cid")}
<b>GA4 ID:</b> ${T("ga4")}
<b>GTM ID:</b> ${T("gtm")}
<b>Advertiser has access to either GA4 or GTM (Y/N):</b> ${j("access")}
<b>If Yes, user access email to GA4/GTM:</b> ${T("access-email")}
<b>Ghosting Access Available (Y/N):</b> ${j("ghost")}
<b>Name of the advertiser:</b> ${T("name")}
<b>Website Address:</b> ${T("url")}
<b>Advertiser\u2019s preferred mode of communication:</b> Phone
<b>Advertiser/Web Master\u2019s Phone Number:</b> ${T("phone")}
<b>Preferred Call Back time with time zone and contact number:</b> ${T("callback")}
<b>Advertiser/Web Master\u2019s Email Address:</b> ${T("email")}
...
<b>Advertiser contact -</b> ${T("c-adv")}
<b>Account Manager -</b> ${T("c-am")}
<b>Additional Contact -</b> N/A

<b>Additional Comments:</b> (Optional)`.replace(/\n/g,"<br>");ct(A);let h=await wt();h?(h.innerText.trim()===""&&(h.innerHTML=""),document.execCommand("insertHTML",!1,A),vt(h),Y("Nota S&T inserida!")):Y("Copiado! Abra uma nota para colar.")},e}function wo(){let t="v3.7.0 (S&T Mode)",e="bau",n="pt",o=!1,s=!1,i=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},r=xo(),d=yo(()=>{let V=d.getCheckedElements().map(N=>N.value);c&&c.value&&r.updateVisibility(c.value,V)}),p=document.createElement("div");p.id="autofill-popup",p.classList.add("cw-module-window"),Object.assign(p.style,Te,{right:"100px",width:"400px",transition:"width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)"});let u={popup:p,googleLine:null},l=Ie(p,"Case Notes",t,"Gera notas padronizadas.",u,()=>It());p.appendChild(l);let f=l.lastElementChild;if(f){let x=document.createElement("div");x.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',Object.assign(x.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease",marginLeft:"4px"}),x.title="Alternar para Split & Transfer",x.onmouseenter=()=>{x.style.background="rgba(255,255,255,0.1)",x.style.color="#FFF"},x.onmouseleave=()=>{i||(x.style.background="transparent",x.style.color="#9AA0A6")},x.onclick=V=>{V.stopPropagation(),F(x)},f.insertBefore(x,f.firstChild)}let b=document.createElement("div");Object.assign(b.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),p.appendChild(b);let g=document.createElement("div");Object.assign(g.style,{flexGrow:"1",display:"none",overflow:"hidden"});let E=vo(()=>F());g.appendChild(E),p.appendChild(g);function F(x){i=!i,i?(b.style.display="none",g.style.display="flex",u.googleLine&&(u.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)"),x&&(x.style.color="#C58AF9",x.style.background="rgba(197, 138, 249, 0.15)")):(b.style.display="block",g.style.display="none",u.googleLine&&(u.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"),x&&(x.style.color="#9AA0A6",x.style.background="transparent"))}let _=document.createElement("div");_.textContent="created by lucaste@",Object.assign(_.style,no),p.appendChild(_);let z=document.createElement("div");z.id="step-lang-type";let $=document.createElement("label");Object.assign($.style,a.label),z.appendChild($);let se=document.createElement("div");Object.assign(se.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let C=document.createElement("div");C.textContent="Portugu\xEAs",C.classList.add("no-drag"),Object.assign(C.style,ye);let v=document.createElement("div");v.textContent="Espa\xF1ol",v.classList.add("no-drag"),Object.assign(v.style,ye),C.onclick=()=>Et("pt"),v.onclick=()=>Et("es"),se.appendChild(C),se.appendChild(v),z.appendChild(se),b.appendChild(z);let y=document.createElement("div");y.id="step-0-case-type";let M=document.createElement("label");Object.assign(M.style,a.label),y.appendChild(M);let w=document.createElement("div");Object.assign(w.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let I=document.createElement("div");I.textContent="BAU",I.classList.add("no-drag"),Object.assign(I.style,ye);let L=document.createElement("div");L.textContent="LM",L.classList.add("no-drag"),Object.assign(L.style,ye),I.onclick=()=>St("bau"),L.onclick=()=>St("lm"),w.appendChild(I),w.appendChild(L),y.appendChild(w),b.appendChild(y);let R=document.createElement("div");R.id="step-1-selection";let T=document.createElement("label");T.className="cw-input-label",T.textContent="Status Principal";let j=document.createElement("select");j.id="main-status",j.className="cw-select",j.innerHTML=`
  ...
  `;let m=document.createElement("div");m.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let A=document.createElement("label");A.className="cw-input-label",A.textContent="Sub-status",A.style.marginBottom="0";let h=document.createElement("a");h.href="https://seu-link-do-guia-aqui.com",h.target="_blank",h.className="cw-info-link",h.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(h.style,a.helpLink),m.appendChild(A),m.appendChild(h);let c=document.createElement("select");c.id="sub-status",c.className="cw-select",c.disabled=!0,c.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',R.appendChild(T),R.appendChild(j),R.appendChild(m),R.appendChild(c),b.appendChild(R);let S=document.createElement("div");S.id="step-1-1-portugal",Object.assign(S.style,a.stepBlock,{display:"none"});let k=document.createElement("label");Object.assign(k.style,a.label),S.appendChild(k);let H=document.createElement("div");Object.assign(H.style,a.radioContainer);let D=document.createElement("div");Object.assign(D.style,{display:"flex",alignItems:"center"});let q=document.createElement("input");q.type="radio",q.name="portugal-group",q.value="sim",Object.assign(q.style,a.checkboxInput);let G=document.createElement("label");G.htmlFor="portugal-sim",Object.assign(G.style,{cursor:"pointer"}),D.appendChild(q),D.appendChild(G);let U=document.createElement("div");Object.assign(U.style,{display:"flex",alignItems:"center"});let O=document.createElement("input");O.type="radio",O.name="portugal-group",O.value="nao",O.checked=!0,Object.assign(O.style,a.checkboxInput);let P=document.createElement("label");P.htmlFor="portugal-nao",Object.assign(P.style,{cursor:"pointer"}),U.appendChild(O),U.appendChild(P),H.appendChild(D),H.appendChild(U),S.appendChild(H),b.appendChild(S);function de(x){o=x,x?ne.style.display="block":ne.style.display="none"}q.onchange=()=>de(!0),O.onchange=()=>de(!1);let ne=document.createElement("div");ne.id="step-1-2-consent",Object.assign(ne.style,a.stepBlock,{display:"none"});let ae=document.createElement("label");Object.assign(ae.style,a.label),ne.appendChild(ae);let ce=document.createElement("div");Object.assign(ce.style,a.radioContainer);let fe=document.createElement("div");Object.assign(fe.style,{display:"flex",alignItems:"center"});let Se=document.createElement("input");Se.type="radio",Se.name="consent-group",Se.value="Sim",Se.checked=!0,Object.assign(Se.style,a.checkboxInput);let _e=document.createElement("label");_e.htmlFor="consent-sim",Object.assign(_e.style,{cursor:"pointer"}),fe.appendChild(Se),fe.appendChild(_e);let et=document.createElement("div");Object.assign(et.style,{display:"flex",alignItems:"center"});let Fe=document.createElement("input");Fe.type="radio",Fe.name="consent-group",Fe.value="N\xE3o",Object.assign(Fe.style,a.checkboxInput);let dt=document.createElement("label");dt.htmlFor="consent-nao",Object.assign(dt.style,{cursor:"pointer"}),et.appendChild(Fe),et.appendChild(dt),ce.appendChild(fe),ce.appendChild(et),ne.appendChild(ce),b.appendChild(ne);let Be=document.createElement("div");Be.id="step-1-5-snippets",Object.assign(Be.style,a.stepBlock,{display:"none"});let pt=document.createElement("h3");Object.assign(pt.style,a.h3),pt.textContent="Cen\xE1rios Comuns";let Ee=bo(x=>{let V=document.querySelector("textarea");V&&(V.value=x,V.dispatchEvent(new Event("input")),V.style.transition="background-color 0.2s",V.style.backgroundColor="#e8f0fe",setTimeout(()=>V.style.backgroundColor="#fff",300))});Ee.id="snippet-container",Be.appendChild(pt),Be.appendChild(Ee),b.appendChild(Be);let Ae=document.createElement("div");Ae.id="step-3-form",Object.assign(Ae.style,a.stepBlock,{display:"none"});let Ct=document.createElement("h3");Object.assign(Ct.style,a.h3),Ae.appendChild(Ct);let De=document.createElement("div");De.id="dynamic-form-fields-container",Ae.appendChild(De);let he=document.createElement("button");he.textContent="+ Gostaria de selecionar uma task?",Object.assign(he.style,a.optionalBtn),he.onmouseover=()=>he.style.background="#e8f0fe",he.onmouseout=()=>he.style.background="white",he.onclick=()=>{he.style.display="none",Pe.style.display="block",d.selectionElement.style.display="block"};let Pe=document.createElement("h3");Object.assign(Pe.style,a.h3,{marginTop:"20px"});let jt=d.selectionElement;Object.assign(jt.style,{marginBottom:"20px"}),Ae.appendChild(he),Ae.appendChild(Pe),Ae.appendChild(jt),Ae.appendChild(r.element),Ae.appendChild(d.screenshotsElement),b.appendChild(Ae);let je=document.createElement("div");je.id="step-4-email",Object.assign(je.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let He=document.createElement("label");He.style.display="flex",He.style.alignItems="center",He.style.cursor="pointer",He.style.fontSize="14px";let Ve=document.createElement("input");Ve.type="checkbox",Ve.checked=!0,Object.assign(Ve.style,a.checkboxInput),He.appendChild(Ve),He.appendChild(document.createTextNode("Preencher email automaticamente?")),je.appendChild(He),b.appendChild(je);let Ke=document.createElement("div");Object.assign(Ke.style,{display:"none",gap:"8px",padding:"0"}),b.appendChild(Ke);let tt=document.createElement("button");Object.assign(tt.style,a.buttonBase,{backgroundColor:"#5f6368"}),tt.textContent="Copiar";let ot=document.createElement("button");Object.assign(ot.style,a.buttonBase,{backgroundColor:"#1a73e8"}),ot.textContent="Preencher",Ke.appendChild(tt),Ke.appendChild(ot);let nt=document.createElement("div");Object.assign(nt.style,Qe),nt.className="no-drag",nt.title="Redimensionar",p.appendChild(nt),Ze(p,nt),document.body.appendChild(p);function St(x){e=x;let V=it();Object.assign(I.style,ye),Object.assign(L.style,ye),x==="bau"?(Object.assign(I.style,V),h.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(L.style,V),h.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),c.value&&c.dispatchEvent(new Event("change"))}function Z(x){try{if(Re&&Re[n]&&Re[n][x])return Re[n][x];if(Re&&Re.pt&&Re.pt[x])return Re.pt[x]}catch{}return x}function Oo(){$.textContent=Z("idioma"),M.textContent=Z("fluxo"),T.textContent=Z("status_principal"),A.textContent=Z("substatus"),pt.textContent=Z("cenarios_comuns"),Pe.textContent=Z("selecione_tasks"),Ct.textContent=Z("preencha_detalhes"),tt.textContent=Z("copiar"),ot.textContent=Z("preencher"),j.querySelector('option[value=""]')&&(j.querySelector('option[value=""]').textContent=Z("select_status")),c.querySelector('option[value=""]')&&(c.querySelector('option[value=""]').textContent=Z("select_substatus")),k.textContent=Z("caso_portugal"),G.textContent=Z("sim"),P.textContent=Z("nao"),ae.textContent=Z("consentiu_gravacao"),_e.textContent=Z("sim"),dt.textContent=Z("nao"),De.querySelectorAll("label").forEach(x=>{let V=x.nextElementSibling.id.replace("field-",""),N=Z(V.toLowerCase());N!==V.toLowerCase()?x.textContent=N:x.textContent=V.replace(/_/g," ").replace(/\b\w/g,K=>K.toUpperCase())+":"}),he.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function Et(x){n=x;let V=it();Object.assign(C.style,ye),Object.assign(v.style,ye),x==="pt"?(Object.assign(C.style,V),S.style.display="block",de(o)):(Object.assign(v.style,V),S.style.display="none",ne.style.display="none"),Oo(),c.value&&c.dispatchEvent(new Event("change"))}function Tt(x){(x.value.trim()===""||x.value.trim()==="\u2022")&&(x.value="\u2022 "),x.onkeydown=function(V){if(V.key==="Enter"){V.preventDefault();let N=this.selectionStart,K=this.selectionEnd,re=this.value,me=re.lastIndexOf(`
`,N-1)+1,Ce=re.substring(me,N),ge=Ce.trim()==="\u2022"||Ce.trim()===""?`
`:`
\u2022 `;this.value=re.substring(0,N)+ge+re.substring(K),this.selectionStart=this.selectionEnd=N+ge.length}else if(V.key==="Backspace"){let N=this.selectionStart;if(N===this.selectionEnd&&N>0){let K=this.value.substring(0,N);K.endsWith(`
\u2022 `)?(V.preventDefault(),this.value=K.substring(0,N-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=N-3):K==="\u2022 "&&(V.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function kt(){let x=typeof Ee<"u"?Ee:document.getElementById("snippet-container");if(!x)return;let V=x.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),N={},K=new Set;V.forEach(ie=>{let te=ie.id,W=ke[te];if(W)for(let B in W)B==="linkedTask"?K.add(W.linkedTask):B!=="type"&&(N[B]||(N[B]=[]),N[B].includes(W[B])||N[B].push(W[B]))});let re=new Set;Object.values(ke).forEach(ie=>{Object.keys(ie).forEach(te=>{te!=="linkedTask"&&te!=="type"&&re.add(te)})}),re.forEach(ie=>{let te=document.getElementById(ie);if(te){let W=N[ie]||[],B="";lt.includes(ie.replace("field-",""))?(B=W.map(ee=>ee.startsWith("\u2022 ")?ee:"\u2022 "+ee).join(`
`),B===""?B="\u2022 ":B.endsWith(`
\u2022 `)||(B+=`
\u2022 `)):B=W.join(`

`),B.trim()!=="\u2022"&&B.trim()!==""?te.value=B:lt.includes(ie.replace("field-",""))?te.value="\u2022 ":te.value="",te.tagName==="TEXTAREA"&&typeof Tt=="function"&&Tt(te)}});let me=new Set,Ce=new Set;x.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(ie=>{let te=ke[ie.id];te&&te.linkedTask&&(ie.checked?me.add(te.linkedTask):Ce.add(te.linkedTask))}),Ce.forEach(ie=>{me.has(ie)||d.toggleTask(ie,!1)}),me.forEach(ie=>{d.toggleTask(ie,!0)})}j.onchange=()=>{let x=j.value;if(Ot(1.5),c.innerHTML=`<option value="">${Z("select_substatus")}</option>`,!x){c.disabled=!0;return}for(let V in rt){let N=rt[V];if(N.status===x){let K=document.createElement("option");K.value=V,K.textContent=N.name,c.appendChild(K)}}c.disabled=!1},c.onchange=()=>{let x=c.value;if(Ot(1.5),!x)return;d.updateSubStatus(x);let V=rt[x];Ee.innerHTML="";let N=(W,B,ee)=>{let ue=document.createElement("label");Object.assign(ue.style,a.checkboxLabel),ue.onmouseover=()=>ue.style.backgroundColor="#e8eaed",ue.onmouseout=()=>ue.style.backgroundColor="#f8f9fa";let le=document.createElement("input");return le.type=B,le.id=W.id,Object.assign(le.style,a.checkboxInput),ue.appendChild(le),ue.appendChild(document.createTextNode(` ${W.text}`)),ee.appendChild(ue),le},K=[],re="radio";if(x==="NI_Awaiting_Inputs")K=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(x.startsWith("SO_"))re="checkbox",K=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"},{id:"quickfill-ga4-event-close",text:"Fechamento GA4 (P\xF3s 2 dias)"}];else if(x.startsWith("AS_")){re="checkbox";let W=document.createElement("label");W.textContent=Z("cenarios_comuns"),Object.assign(W.style,a.label),Ee.appendChild(W),K=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else x.startsWith("IN_")?K=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:x.startsWith("DC_")?(re="radio",K=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]):x==="NI_Attempted_Contact"?(re="radio",K=[{id:"quickfill-ni-attempted-2day",text:"2 Day Rule (2 Liga\xE7\xF5es + Chat AM)"}]):x==="NI_Awaiting_Validation"&&(re="checkbox",K=[{id:"quickfill-ni-awaiting-ecw4",text:"ECW4 (Acompanhar)"},{id:"quickfill-ni-awaiting-ga4",text:"GA4 Event Tracking (Acompanhar)"}]);let me=K.filter(W=>{let B=ke[W.id];return!B.type||B.type==="all"||B.type===e});me.forEach((W,B)=>{let ee=N(W,re,Ee);re==="radio"&&(ee.name="scenario-radio-group",B===0&&(ee.checked=!0))}),me.length>0&&(Be.style.display="block"),V.requiresTasks?(he.style.display="none",Pe.style.display="block",d.selectionElement.style.display="block"):(he.style.display="block",Pe.style.display="none",d.selectionElement.style.display="none"),De.innerHTML="";let Ce=V.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(Ce)].forEach(W=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(W))return;let B=W.slice(1,-1),ee=document.createElement("label"),ue=Z(B.toLowerCase());if(ee.textContent=ue!==B.toLowerCase()?ue:B.replace(/_/g," ").replace(/\b\w/g,Q=>Q.toUpperCase())+":",Object.assign(ee.style,a.label),B==="SPEAKEASY_ID"){let Q=document.createElement("button");Q.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',Q.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,Q.title="Localizar Speakeasy ID no hist\xF3rico",Q.onmouseover=()=>{Q.style.backgroundColor="#c2e7ff",Q.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},Q.onmouseout=()=>{Q.style.backgroundColor="#d3e3fd",Q.style.boxShadow="none"},Q.onmousedown=()=>{Q.style.backgroundColor="#a8c7fa",Q.style.transform="scale(0.96)"},Q.onmouseup=()=>Q.style.transform="scale(1)",Q.onclick=xe=>{xe.preventDefault(),ro(`field-${B}`)},ee.appendChild(Q)}let le;lt.includes(B)?(le=document.createElement("textarea"),Object.assign(le.style,a.textarea),le.classList.add("bullet-textarea"),Tt(le)):Rt.includes(B)?(le=document.createElement("textarea"),Object.assign(le.style,a.textarea)):(le=document.createElement("input"),le.type="text",Object.assign(le.style,a.input),B==="REASON_COMMENTS"&&(x.startsWith("NI_")||x.startsWith("IN_"))&&(Object.assign(ee.style,{display:"none"}),Object.assign(le.style,{display:"none"}))),B==="ON_CALL"&&e==="lm"&&(Object.assign(ee.style,{display:"none"}),Object.assign(le.style,{display:"none"}),le.value="N/A"),le.id=`field-${B}`,De.appendChild(ee),De.appendChild(le)});let ie=Ee.querySelectorAll('input[type="checkbox"], input[type="radio"]');ie.length>0&&(ie.forEach(W=>{W.removeEventListener("change",kt),W.addEventListener("change",kt)}),kt()),Ae.style.display="block",We[x]?je.style.display="block":je.style.display="none",Ke.style.display="flex";let te=d.getCheckedElements().map(W=>W.value);r.updateVisibility(x,te)},he.onclick=()=>{he.style.display="none",Pe.style.display="block",d.selectionElement.style.display="block"};function Ht(){let x=c.value;if(!x)return null;let N=rt[x].template.replace(/\n/g,"<br>"),K='style="margin-bottom: 12px; padding-left: 30px;"',re=[],me="",Ce=d.getCheckedElements();Ce.length>0&&Ce.forEach(te=>{let W=te.value,B=Ge[W],ee=te.closest().querySelector(".stepper-count"),ue=ee?parseInt(ee.textContent):1;ue>1?re.push(`${B.name} (x${ue})`):re.push(B.name)});let ge=d.screenshotsElement;if(ge){let te=Array.from(ge.querySelectorAll('input[id^="name-"]'));te.length>0&&te.forEach(W=>{let B=W.value,ee=W.closest(".cw-screen-card");if(ee){let ue=ee.querySelectorAll('input[id^="screen-"]'),le=!1,Q="";ue.forEach(xe=>{let Vt=xe.closest(".cw-input-group"),$t=Vt?Vt.querySelector(".cw-input-label"):null,Io=$t?$t.textContent:"Evid\xEAncia",Ut=xe.value.trim(),qo=Ut?` ${Ut}`:"";Q+=`<li>${Io} -${qo}</li>`,le=!0}),le&&(me+=`<b>${B}</b>`,me+=`<ul ${K}>${Q}</ul>`)}})}if(N.includes("{TAGS_IMPLEMENTED}")?N=N.replace(/{TAGS_IMPLEMENTED}/g,re.join(", ")||"N/A"):re.length>0&&(N+=`<br><b>Tags:</b> ${re.join(", ")}<br>`),N.includes("{SCREENSHOTS_LIST}")?N=N.replace(/{SCREENSHOTS_LIST}/g,me?`${me}`:"N/A"):me!==""&&(N+=`<br>${me}`),n==="pt"&&o){let te=Se.checked?Z("sim"):Z("nao");N=N.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${Z("consentiu_gravacao")}</b> ${te}<br><br>`),N=N.replace(/{CASO_PORTUGAL}/g,`<br><b>${Z("caso_portugal")}</b> ${Z("sim")}<br>`)}else n==="pt"&&!o?(N=N.replace(/{CASO_PORTUGAL}/g,`<br><b>${Z("caso_portugal")}</b> ${Z("nao")}<br>`),N=N.replace(/{CONSENTIU_GRAVACAO}/g,"")):(N=N.replace(/{CASO_PORTUGAL}/g,""),N=N.replace(/{CONSENTIU_GRAVACAO}/g,""));return De.querySelectorAll("input, textarea").forEach(te=>{let W=te.id.replace("field-",""),B=new RegExp(`{${W}}`,"g"),ee=te.value;if(W==="REASON_COMMENTS"&&(x.startsWith("NI_")||x.startsWith("IN_"))){let Q=Ee.querySelector('input[type="radio"]:checked');Q&&ke[Q.id]&&(ee=ke[Q.id]["field-REASON_COMMENTS"])}if(lt.includes(W)&&ee.trim()!==""){let Q=ee.split(`
...
`).filter(Q=>Q.trim()!=="").map(Q=>`<p style="margin: 0 0 8px 0;">${Q}</p>`).join(""):te.tagName==="TEXTAREA"&&(ee=ee.replace(/\n/g,"<br>"));let ue=ee.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ue===""||ue==="\u2022"||ue.toLowerCase()==="n/a"){let Q=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${W}\\}(?:<br>\\s*)?`,"gi");Q.test(N)?N=N.replace(Q,""):N=N.replace(B,"")}else N=N.replace(B,ee.replace(/\$/g,"$$$$"))}),N=N.replace(/{([A-Z0-9_]+)}/g,""),N=N.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(N+=r.getOutput()),N}tt.onclick=()=>{let x=Ht();x?(ct(x),Y(Z("copiado_sucesso"))):Y(Z("selecione_substatus"),{error:!0})},ot.onclick=async()=>{let x=c.value,V=Ht();if(!V){Y(Z("selecione_substatus"),{error:!0});return}ct(V),It();let N=xt(),K=await wt();if(K)try{if(K.focus(),K.innerHTML.trim()==="<p><br></p>"||K.innerHTML.trim()==="<br>"||K.innerText.trim()===""){let ge=document.createRange();ge.selectNodeContents(K);let ie=window.getSelection();ie.removeAllRanges(),ie.addRange(ge),document.execCommand("delete",!1,null)}else if(!K.innerHTML.endsWith("<br><br>")){let ge=document.createRange();ge.selectNodeContents(K),ge.collapse(!1);let ie=window.getSelection();ie.removeAllRanges(),ie.addRange(ge),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,V),vt(K),setTimeout(()=>{Y(Z("inserido_copiado"))},600);let me=typeof Ve<"u"&&Ve?Ve.checked:!0;if(x&&We[x]&&me){let ge=We[x];await ft(ge),await new Promise(ie=>setTimeout(ie,500))}N(),Ot(1.5),j.value="",c.innerHTML=`<option value="">${Z("select_substatus")}</option>`,c.disabled=!0}catch(re){console.error(re),Y("Erro ao inserir.",{error:!0}),N()}};function Ot(x=1.5){x<=1.5&&(Be.style.display="none",Ee.innerHTML=""),x<=2&&(d.reset(),he.style.display="none"),x<=3&&(Ae.style.display="none",De.innerHTML="",r.reset(),Ke.style.display="none",je.style.display="none")}function It(){if(s=!s,s){let x=p.querySelector(".cw-expand-btn");x&&typeof x.resetState=="function"&&x.resetState()}qe(s,p,"cw-btn-notes")}return St("bau"),Et("pt"),It}var Xe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
                ...
                `},{id:"nrp_dfa",name:"NRP - DFA",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Encerramento",body:`
                    ...
                    <br>
                    <p><strong>[Seu Nome]</strong><br>Time de Solu\xE7\xF5es T\xE9cnicas Cognizant, em nome do Google</p>
                `}]}};function Ao(){let t="v4.2.0 CR-Hybrid",e="CANNED_RESPONSES",n=Object.keys(Xe)[0],o="",s="list",i=!1,a={bgApp:"#F8F9FA",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.08)",borderFocus:"rgba(26, 115, 232, 0.4)",textPrimary:"#202124",textSecondary:"#5F6368",primary:"#1A73E8",primaryBg:"#E8F0FE",shadowCard:"0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)",shadowHover:"0 4px 12px rgba(0,0,0,0.08), 0 2px 4px rgba(0,0,0,0.04)",transition:"all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1)"},r={display:"flex",flexDirection:"column",height:"100%",position:"relative",overflow:"hidden",background:a.bgApp},d={display:"flex",width:"200%",height:"100%",transition:"transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",transform:"translateX(0)",willChange:"transform"},p={width:"50%",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"},u={padding:"20px 24px 12px 24px",flexShrink:"0",background:a.bgApp,zIndex:"10",display:"flex",flexDirection:"column",gap:"16px",borderBottom:`1px solid ${a.borderSubtle}`},l={width:"100%",height:"44px",padding:"0 16px 0 48px",borderRadius:"12px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",fontWeight:"400",color:a.textPrimary,boxSizing:"border-box",outline:"none",transition:a.transition,boxShadow:"0 2px 5px rgba(0,0,0,0.03)",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="%239AA0A6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"16px center"},f={display:"flex",flexWrap:"wrap",justifyContent:"center",gap:"8px",paddingBottom:"4px"},b={padding:"6px 14px",borderRadius:"100px",border:"1px solid #DADCE0",background:"#FFFFFF",color:a.textSecondary,fontSize:"13px",fontWeight:"500",letterSpacing:"0.3px",cursor:"pointer",transition:a.transition,flexShrink:"0",display:"flex",alignItems:"center",justifyContent:"center"},g={background:a.primaryBg,color:a.primary,borderColor:"transparent",fontWeight:"600",boxShadow:"0 1px 2px rgba(26, 115, 232, 0.15)"},E={padding:"16px 24px 80px 24px",overflowY:"auto",flexGrow:"1",display:"flex",flexDirection:"column",gap:"12px"},F={display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 16px",height:"72px",minHeight:"72px",borderRadius:"16px",background:a.bgSurface,border:"1px solid transparent",boxShadow:a.shadowCard,cursor:"pointer",transition:"all 0.25s cubic-bezier(0.2, 0.8, 0.2, 1)",position:"relative",overflow:"hidden"},_=document.createElement("div");_.id="quick-email-popup",_.classList.add("cw-module-window"),Object.assign(_.style,Te,{right:"100px",width:"440px",height:"640px",borderRadius:"20px",boxShadow:"0 24px 64px rgba(0,0,0,0.2)",border:"1px solid rgba(255,255,255,0.4)"});let z={popup:_,googleLine:null,focusElement:null};function $(){i=!i,qe(i,_,"cw-btn-email"),i||setTimeout(()=>A(),300)}let se=Ie(_,"Quick Email",t,"Templates & Automa\xE7\xF5es",z,()=>$()),C=document.createElement("div");Object.assign(C.style,r);let v=document.createElement("div");Object.assign(v.style,d);let y=document.createElement("div");Object.assign(y.style,p);let M=document.createElement("div");Object.assign(M.style,u);let w=document.createElement("input");w.placeholder="Pesquisar templates...",Object.assign(w.style,l),w.onfocus=()=>{w.style.borderColor=a.primary,w.style.boxShadow="0 0 0 4px rgba(26, 115, 232, 0.15)",w.style.background="#fff"},w.onblur=()=>{w.style.borderColor="transparent",w.style.boxShadow="0 2px 5px rgba(0,0,0,0.03)",w.style.background="#fff"},z.focusElement=w;let I=document.createElement("div");Object.assign(I.style,f);let L=document.createElement("div");Object.assign(L.style,E),M.appendChild(w),M.appendChild(I),y.appendChild(M),y.appendChild(L);let R=document.createElement("div");Object.assign(R.style,p);let T=document.createElement("div");Object.assign(T.style,{padding:"0",overflowY:"auto",flexGrow:"1",background:"#fff"}),R.appendChild(T),v.appendChild(y),v.appendChild(R),C.appendChild(v),_.appendChild(se),_.appendChild(C),document.body.appendChild(_);async function j(k,H){try{i&&$();let D=xt();await new Promise(q=>setTimeout(q,800)),H==="email"?await co(k):H==="cr"&&await ft(k),D()}catch(D){console.error("\u274C Erro:",D);let q=document.querySelector(".cw-focus-backdrop");q&&q.classList.remove("active")}}function m(k){s="detail",v.style.transform="translateX(-50%)";let H='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg>',D='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>';T.innerHTML=`
            <style>
            ...
            <div style="position:sticky; top:0; background:rgba(255,255,255,0.9); backdrop-filter:blur(12px); border-bottom:1px solid #eee; padding:16px 24px; z-index:10; display:flex; align-items:center; gap:12px;">
                <button id="csa-back-btn" style="background:none; border:none; cursor:pointer; display:flex; color:#5f6368; padding:8px; margin-left:-12px; border-radius:50%; transition:background 0.2s;">${H}</button>
        ...
        `;let q=T.querySelector("#csa-back-btn");q.onmouseenter=()=>q.style.background="#f1f3f4",q.onmouseleave=()=>q.style.background="none",q.onclick=A;let G=T.querySelector("#csa-insert-btn");G.onmouseenter=()=>{G.style.transform="translateY(-1px)",G.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},G.onmouseleave=()=>{G.style.transform="translateY(0)",G.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},G.onclick=()=>{G.style.transform="scale(0.96)",j(k,"email"),setTimeout(()=>{G.style.transform="scale(1)",A()},300)}}function A(){s="list",v.style.transform="translateX(0)"}function h(k,H,D=null){let q=document.createElement("button"),G=D?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${D}</span>`:"";return q.innerHTML=`${G}${k}`,Object.assign(q.style,b),n===H&&o===""?Object.assign(q.style,g):(q.onmouseenter=()=>{q.style.background="#F1F3F4",q.style.borderColor="#DADCE0"},q.onmouseleave=()=>{q.style.background="#FFFFFF",q.style.borderColor="#DADCE0"}),q.onclick=()=>{n=H,o="",w.value="",c(),S()},q}function c(){I.innerHTML="",I.appendChild(h("Smart CRs",e,"\u26A1")),Object.keys(Xe).forEach(k=>{I.appendChild(h(Xe[k].title,k))})}function S(){L.innerHTML="";let k=[];if(o.trim()!==""){let U=o.toLowerCase();Object.values(Xe).forEach(O=>{O.emails.forEach(P=>{(P.name.toLowerCase().includes(U)||P.subject.toLowerCase().includes(U))&&k.push({type:"email",data:P})})}),Object.entries(We).forEach(([O,P])=>{if(!P)return;(O.replace(/_/g," ").toLowerCase().includes(U)||P.toLowerCase().includes(U))&&k.push({type:"cr",key:O,code:P})})}else n===e?Object.entries(We).forEach(([U,O])=>{O&&k.push({type:"cr",key:U,code:O})}):Xe[n]&&Xe[n].emails.forEach(U=>{k.push({type:"email",data:U})});if(k.length===0){L.innerHTML=`
                ...
                </div>`;return}let D='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1967D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',q='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA8600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',G='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BDC1C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';k.forEach(U=>{let O=document.createElement("div");if(Object.assign(O.style,F),U.type==="email"){let P=U.data,de=P.subject.length>45?P.subject.substring(0,45)+"...":P.subject;O.innerHTML=`
                ...
                `,O.onclick=()=>m(P)}else{let P=U.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");O.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function So(){let t="v2.1 (Apple Motion)",e={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Te,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function d(){i=!i,qe(i,a,"cw-btn-script")}let p=Ie(a,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{d()});a.appendChild(p);let u=document.createElement("div");Object.assign(u.style,e.progressBarContainer);let l=document.createElement("div");Object.assign(l.style,e.progressBarFill),u.appendChild(l),a.appendChild(u);let f=document.createElement("div");f.id="csa-content",Object.assign(f.style,e.contentArea),a.appendChild(f);let b=document.createElement("div");Object.assign(b.style,e.footer);let g=document.createElement("span");g.textContent="by lucaste@",Object.assign(g.style,{fontSize:"10px",color:"#bdc1c6"});let E=document.createElement("button");E.innerHTML=`
  ...
  `,Object.assign(E.style,e.resetBtn),E.onmouseenter=()=>E.style.background="#fce8e6",E.onmouseleave=()=>E.style.background="transparent",E.onclick=()=>{E.style.transform="scale(0.9)",setTimeout(()=>E.style.transform="scale(1)",150);for(let R in n)delete n[R];M()},b.appendChild(g),b.appendChild(E),a.appendChild(b);let F=document.createElement("div");Object.assign(F.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let _=document.createElement("div");Object.assign(_.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let z=document.createElement("div");z.textContent="BAU";let $=document.createElement("div");$.textContent="LT",Object.assign(z.style,ye),Object.assign($.style,ye),_.appendChild(z),_.appendChild($);let se=document.createElement("select");Object.assign(se.style,oo,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),se.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',se.value=o,F.appendChild(_),F.appendChild(se),f.appendChild(F);let C=document.createElement("div");C.id="csa-checklist-area",f.appendChild(C);let v=document.createElement("div");Object.assign(v.style,Qe),v.className="no-drag",v.title="Redimensionar",a.appendChild(v),Ze(a,v),document.body.appendChild(a);function y(R){return R}function M(){C.innerHTML="";let R=`${o} ${s}`,T=Co[R];if(!T){C.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,Object.assign(w.style,a),e===y&&n===""?Object.assign(w.style,r):(w.onmouseenter=()=>{w.style.background="#F1F3F4",w.style.borderColor="#DADCE0"},w.onmouseleave=()=>{w.style.background="#FFFFFF",w.style.borderColor="#DADCE0"}),w.onclick=()=>{e=y,n="",_.value="",se(),w.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}),C()},z.appendChild(w)})}function C(){$.innerHTML="";let y=[],M=n.trim()!=="";if(M?Object.entries(At).forEach(([w,I])=>{let L=I.links.filter(R=>R.name.toLowerCase().includes(n.toLowerCase())||R.desc.toLowerCase().includes(n.toLowerCase()));L.forEach(R=>{R._catIcon=l[w]}),y=[...y,...L]}):(y=At[e].links,y.forEach(w=>w._catIcon=l[e])),y.length===0){$.innerHTML=`
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:60px 20px; color:#9AA0A6;">
            <div style="font-size:32px; margin-bottom:12px; opacity:0.5;">\u{1F50D}</div>
            <div style="font-size:14px; font-weight:500;">Nenhum link encontrado</div>
        </div>`;return}y.forEach((w,I)=>{let L=document.createElement("div");Object.assign(L.style,d);let R=document.createElement("div");Object.assign(R.style,p),R.innerHTML=w._catIcon||'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>',L.appendChild(R);let T=document.createElement("div");T.style.flexGrow="1",T.style.minWidth="0",T.style.display="flex",T.style.flexDirection="column",T.style.gap="2px";let j=k=>{if(!M)return k;let H=new RegExp(`(${n})`,"gi");return k.replace(H,'<span style="color:#1a73e8; font-weight:700;">$1</span>')},m=`<div style="font-size:14px; font-weight:600; color:${o.textPrimary}; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${j(w.name)}</div>`,A=`<div style="font-size:12px; color:${o.textSecondary}; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${j(w.desc)}</div>`;T.innerHTML=m+A,L.appendChild(T);let h=document.createElement("div");h.style.display="flex",h.style.alignItems="center",h.style.gap="8px",h.style.flexShrink="0",h.style.opacity="0.4",h.style.transition="opacity 0.2s";let c=document.createElement("div");c.title="Copiar Link",c.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',Object.assign(c.style,{width:"32px",height:"32px",borderRadius:"8px",display:"flex",alignItems:"center",justifyContent:"center",color:o.textSecondary,cursor:"pointer",transition:"all 0.2s ease"}),c.onclick=k=>{oe.playClick(),k.stopPropagation(),navigator.clipboard.writeText(w.url),c.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',c.style.color="#188038",c.style.background="#E6F4EA",setTimeout(()=>{c.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',c.style.color=o.textSecondary,c.style.background="transparent"},1500)},c.onmouseenter=()=>{c.style.background="#F1F3F4"},c.onmouseleave=()=>{c.style.background="transparent"},h.appendChild(c);let S=document.createElement("div");S.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>',Object.assign(S.style,{display:"flex",alignItems:"center",justifyContent:"center",color:"#DADCE0",width:"24px",height:"24px"}),h.appendChild(S),L.appendChild(h),L.onclick=()=>window.open(w.url,"_blank"),L.onmouseenter=()=>{L.style.transform="translateY(-2px)",L.style.boxShadow=o.shadowHover,h.style.opacity="1",R.style.background="#E8F0FE",R.style.color="#1967D2",S.style.color="#1A73E8"},L.onmouseleave=()=>{L.style.transform="translateY(0)",L.style.boxShadow=o.shadowCard,h.style.opacity="0.4",R.style.background="#F1F3F4",R.style.color=o.textSecondary,S.style.color="#DADCE0"},$.appendChild(L),requestAnimationFrame(()=>{setTimeout(()=>{L.style.opacity="1",L.style.transform="translateY(0)"},I*30)})})}_.addEventListener("input",y=>{n=y.target.value,n!==""?Array.from(z.children).forEach(M=>{Object.assign(M.style,a),M.style.opacity="0.6"}):se(),C()});function v(){g=!g,qe(g,u,"cw-btn-links")}return se(),C(),v}var ze=[];function Pt(t){ze=t}var Ho=["lucaste"],Vo=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function To(){let t="v4.9 (High Contrast UI)",e=!1,n=null,o=null;function s(m){if(!m)return"";try{let A=new Date(m);return isNaN(A.getTime())?String(m):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(m)}}if(!document.getElementById("cw-broadcast-hd-css")){let m=document.createElement("style");m.id="cw-broadcast-hd-css",m.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(c=>{c.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(S=>S.classList.remove("checked")),c.parentElement.classList.add("checked")})}),setTimeout(()=>{let c=g.querySelector(".cw-radio-option.info");c&&c.classList.add("checked")},100);let m=g.querySelector("#cw-bc-cancel"),A=g.querySelector("#cw-bc-close-x"),h=g.querySelector("#cw-bc-send");m.onclick=$,A.onclick=$,h.onclick=se,p.appendChild(g)}function z(m=null){if(!g)return;let A=g.querySelector("#cw-editor-title-label"),h=g.querySelector("#cw-bc-title"),c=g.querySelector("#cw-bc-text"),S=g.querySelector("#cw-bc-send");if(m){o=m.id,A.textContent="Editar Aviso",h.value=m.title||"",c.value=m.text||"",S.textContent="Salvar Altera\xE7\xF5es";let k=m.type||"info",H=g.querySelector(`input[name="cw-bc-type"][value="${k}"]`);H&&H.click()}else{o=null,A.textContent="Novo Aviso",h.value="",c.value="",S.textContent="Publicar";let k=g.querySelector('input[name="cw-bc-type"][value="info"]');k&&k.click()}g.classList.add("active"),setTimeout(()=>h.focus(),300)}function $(){g&&g.classList.remove("active"),o=null}async function se(){let m=g.querySelector("#cw-bc-send"),A=g.querySelector("#cw-bc-title"),h=g.querySelector("#cw-bc-text"),c=g.querySelector('input[name="cw-bc-type"]:checked'),S=c?c.value:"info";if(!A.value.trim()||!h.value.trim()){Y("Preencha todos os campos!",{error:!0});return}m.textContent="Salvando...",m.style.opacity="0.7";let k=!1;o?k=await we.updateBroadcast(o,{title:A.value,text:h.value,type:S}):k=await we.sendBroadcast({title:A.value,text:h.value,type:S,author:window._cwCurrentUser||"admin"}),k?(Y(o?"Atualizado!":"Publicado!"),oe.playSuccess(),$(),setTimeout(()=>y(),1500)):(Y("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),m.textContent=o?"Salvar Altera\xE7\xF5es":"Publicar",m.style.opacity="1")}async function C(m){if(confirm("Confirma a exclus\xE3o deste aviso?"))if(await we.deleteBroadcast(m)){Y("Aviso removido."),oe.playClick();let h=ze.findIndex(c=>c.id===m);h>-1&&ze.splice(h,1),w(),setTimeout(()=>y(),1500)}else Y("Erro ao excluir.",{error:!0})}let v=document.createElement("div");v.className="cw-nice-scroll",Object.assign(v.style,i.feedContainer),p.appendChild(v);async function y(){e&&(F.style.display="block",F.innerHTML="\u{1F504} Sincronizando...");try{let m=await we.fetchData();m&&m.broadcast&&(Pt(m.broadcast),M(),e&&(w(),F.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{F.style.display="none"},1500)))}catch{e&&(F.innerHTML="\u26A0\uFE0F Offline")}}function M(){let m=document.getElementById("cw-btn-broadcast");if(!m)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(ze.some(c=>!A.includes(c.id))){if(m.classList.add("has-new"),!m.querySelector(".cw-badge")){let c=document.createElement("div");c.className="cw-badge",Object.assign(c.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),m.appendChild(c)}}else{m.classList.remove("has-new");let c=m.querySelector(".cw-badge");c&&c.remove()}}function w(){v.innerHTML="";let m=p.querySelector("#cw-bau-widget");m&&m.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),h=[...ze].sort((D,q)=>{let G=new Date(D.date).getTime()||0;return(new Date(q.date).getTime()||0)-G}),c=h.findIndex(D=>D.title&&D.title.toLowerCase().includes("disponibilidade bau"));if(c!==-1){let D=h[c];h.splice(c,1);let q=document.createElement("div");q.id="cw-bau-widget",Object.assign(q.style,i.bauContainer);let G=[],U=(D.text||"").split(`
`),O=/\d{1,2}\/\d{1,2}/;if(U.forEach(ce=>{let fe=ce.match(O);if(fe){let Se=fe[0],_e="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(ce)?_e="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(ce)&&(_e="\u{1F1EA}\u{1F1F8}"),G.some(Fe=>Fe.flag===_e&&Fe.date===Se)||G.push({flag:_e,date:Se})}}),G.length===0){let ce=(D.text||"").match(/\d{1,2}\/\d{1,2}/g);ce&&[...new Set(ce)].forEach(fe=>G.push({flag:"\u{1F4C5}",date:fe}))}let P="",de='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(de=`
              ...
              ${P}
          `,F.after(q);let ne=q.querySelector("#cw-bau-toggle-btn"),ae=q.querySelector("#cw-bau-full");if(ne&&ae&&(ne.onclick=()=>{let ce=ae.style.display==="none";ae.style.display=ce?"block":"none",ne.textContent=ce?"Ocultar":"Detalhes"}),window._cwIsAdmin){let ce=q.querySelector(".cw-bau-edit");ce&&(ce.onclick=()=>z(D))}}let S=h.sort((D,q)=>{let G=A.includes(D.id),U=A.includes(q.id);return G===U?0:G?1:-1});if(S.length===0&&!c){let D=document.createElement("div");Object.assign(D.style,i.emptyState),D.innerHTML=`
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><path d="M9 12l2 2 4-4"></path></svg>
            <div style="font-weight:500;">Tudo lido!</div>
           `,v.appendChild(D)}let k=S.filter(D=>!A.includes(D.id)),H=S.filter(D=>A.includes(D.id));if(k.forEach(D=>v.appendChild(I(D,!1))),H.length>0){let D=document.createElement("div");Object.assign(D.style,i.historyDivider),D.innerHTML=`<span>Hist\xF3rico (${H.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let q=document.createElement("div");Object.assign(q.style,i.historyContainer),H.forEach(U=>q.appendChild(I(U,!0)));let G=!1;D.onclick=()=>{oe.playClick(),G=!G,q.style.display=G?"flex":"none",D.querySelector("svg").style.transform=G?"rotate(180deg)":"rotate(0deg)"},v.appendChild(D),v.appendChild(q)}}function I(m,A){let h=document.createElement("div");Object.assign(h.style,A?i.cardHistory:i.card);let c=a[m.type]||a.info,S=document.createElement("div");Object.assign(S.style,i.cardHeader);let k=document.createElement("div");Object.assign(k.style,i.typeTag,{color:c.color,background:c.bg}),k.innerHTML=`${c.icon} <span>${m.type}</span>`;let H=document.createElement("span");if(Object.assign(H.style,i.dateTag),H.textContent=s(m.date),S.appendChild(k),A)S.appendChild(H);else{let O=document.createElement("button");O.className="cw-btn-interactive",Object.assign(O.style,i.dismissBtn),O.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',O.onmouseenter=()=>{O.style.color="#1e8e3e",O.style.background="#e6f4ea",O.style.borderColor="#1e8e3e"},O.onmouseleave=()=>{O.style.color="#5f6368",O.style.background="#fff",O.style.borderColor="rgba(0,0,0,0.1)"},O.onclick=P=>{P.stopPropagation(),oe.playClick(),h.style.transform="translateX(20px)",h.style.opacity="0",setTimeout(()=>{let de=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");de.push(m.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(de)),w(),M()},200)},S.appendChild(O)}let D=document.createElement("div");Object.assign(D.style,i.cardContent);let q=document.createElement("div");Object.assign(q.style,i.msgTitle),q.textContent=m.title;let G=document.createElement("div");Object.assign(G.style,i.msgBody),G.innerHTML=d(m.text);let U=document.createElement("div");if(Object.assign(U.style,i.msgMeta),U.innerHTML=`Publicado por <b>${m.author||"Sistema"}</b>`,A||(U.innerHTML+=` \u2022 ${s(m.date)}`),D.appendChild(q),D.appendChild(G),D.appendChild(U),h.appendChild(S),h.appendChild(D),window._cwIsAdmin){let O=document.createElement("div");O.className="cw-card-actions";let P=document.createElement("button");P.className="cw-action-btn edit",P.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',P.onclick=()=>z(m);let de=document.createElement("button");de.className="cw-action-btn delete",de.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',de.onclick=()=>C(m.id),O.appendChild(P),O.appendChild(de),h.appendChild(O)}return h}let L=we.getCachedBroadcasts();L.length>0&&(Pt(L),w()),setTimeout(E,500),y(),n||(n=setInterval(y,Vo));let R=document.createElement("div");Object.assign(R.style,Qe),R.className="no-drag",p.appendChild(R),Ze(p,R),document.body.appendChild(p);let T=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),j=ze.some(m=>!T.includes(m.id));return{toggle:l,hasUnread:j}}function ko(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,n={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},o=document.createElement("div");Object.assign(o.style,n.overlay);let s=document.createElement("div");Object.assign(s.style,n.card);let i=document.createElement("div");Object.assign(i.style,n.icon);let a=document.createElement("div");Object.assign(a.style,n.title);let r=document.createElement("div");Object.assign(r.style,n.text);let d=document.createElement("div");Object.assign(d.style,n.dotsContainer);let p=document.createElement("div");Object.assign(p.style,n.btnContainer);let u=document.createElement("button");u.textContent="Pular",Object.assign(u.style,n.btn,n.btnSkip),u.onmouseover=()=>u.style.color="#202124",u.onmouseout=()=>u.style.color="#5f6368";let l=document.createElement("button");l.textContent="Pr\xF3ximo",Object.assign(l.style,n.btn,n.btnNext),l.onmouseover=()=>l.style.transform="scale(1.05)",l.onmouseout=()=>l.style.transform="scale(1)",p.appendChild(u),p.appendChild(l),s.appendChild(i),s.appendChild(a),s.appendChild(r),s.appendChild(d),s.appendChild(p),o.appendChild(s),document.body.appendChild(o);function f(g){let E=t[g];i.textContent=E.icon,a.textContent=E.title,r.textContent=E.text,d.innerHTML="",t.forEach((F,_)=>{let z=document.createElement("div");Object.assign(z.style,n.dot),_===g&&Object.assign(z.style,n.dotActive),d.appendChild(z)}),E.isLast?(u.style.display="none",l.textContent="Come\xE7ar \u{1F680}",l.style.width="100%"):(u.style.display="block",l.textContent="Pr\xF3ximo",l.style.width="auto")}function b(){localStorage.setItem("cw_onboarding_seen_v1","true"),o.style.opacity="0",s.style.transform="translateY(20px)",setTimeout(()=>o.remove(),400),oe.playSuccess(),Y("Tudo pronto! Use o menu flutuante.")}l.onclick=()=>{oe.playClick(),e<t.length-1?(e++,f(e)):b()},u.onclick=()=>{confirm("Pular o tutorial?")&&b()},f(0),requestAnimationFrame(()=>{o.style.opacity="1",s.style.transform="translateY(0)"})}function $o(){if(window.techSolInitialized){Lt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{eo();try{oe.initGlobalListeners(),oe.playStartup()}catch(i){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",i)}we.fetchTips(),Lt();let t=wo(),e=Ao(),n=So(),o=Eo(),s=To();go({toggleNotes:t,toggleEmail:e,toggleScript:n,toggleLinks:o,broadcastControl:s}),setTimeout(()=>{ko()},1500)}catch(t){console.error("Erro fatal na inicializa\xE7\xE3o:",t),Y("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}$o();})();

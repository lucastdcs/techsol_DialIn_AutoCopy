...
\u2022 Tentativa 2 -`}};var ve=e=>new Promise(t=>setTimeout(t,e));function Oe(e,t="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,n[t]||n.info)}function ze(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function St(e,t){if(!e)return;let n=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let i=e.getBoundingClientRect(),s=document.createElement("div");s.id=n,s.style.cssText=`
    ...
    `,document.head.appendChild(e)}function Le(e,t,n){let o=document.getElementById(n);if(!t)return;let i=t.getAttribute("data-moved")==="true",s={x:0,y:0};if(o){let p=o.getBoundingClientRect();s.x=p.left+p.width/2,s.y=p.top+p.height/2}let a,r;if(!i)a=window.innerWidth/2,r=window.innerHeight/2;else{let p=t.getBoundingClientRect();a=p.left+p.width/2,r=p.top+p.height/2,a===0&&r===0&&(a=window.innerWidth/2,r=window.innerHeight/2)}let c=s.x-a,l=s.y-r;e?(K.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",i?t.style.transform=`translate(${c}px, ${l}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${l}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",i?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof So=="function"&&So(t,n)):(K.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",i?t.style.transform=`translate(${c}px, ${l}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${l}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Ut=="function"&&Ut(t))}function So(e,t){Ut(e);let n=o=>{if(!e.classList.contains("open"))return;let i=e.contains(o.target),s=document.querySelector(".cw-pill"),a=s&&s.contains(o.target);i?(e.classList.remove("idle"),e.style.zIndex="2147483648"):a||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function Ut(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var nn="https://script.google.com/a/macros/google.com/s/AKfycbxFxh1cVk6r0t_JTA2TBfHBLJe_mOBQFsidwL1jwsUDcBtQYk3afu25SN-FR3vafJChHw/exec",Wt="cw_data_broadcast",Eo="cw_data_tips",an=["Processando...","Mantenha o foco!","Aguarde..."];function kt(e,t={}){return new Promise((n,o)=>{let i="cw_cb_"+Math.round(1e5*Math.random()),s=document.createElement("script");window[i]=c=>{document.body.contains(s)&&document.body.removeChild(s),delete window[i],n(c)};let a=Object.keys(t).map(c=>encodeURIComponent(c)+"="+encodeURIComponent(t[c])).join("&"),r=`${nn}?op=${e}&callback=${i}&t=${Date.now()}&${a}`;s.src=r,s.onerror=()=>{document.body.contains(s)&&document.body.removeChild(s),delete window[i],o(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(s)})}var ke={fetchTips:async()=>{try{let e=await kt("tips");e?.tips&&localStorage.setItem(Eo,JSON.stringify(e.tips))}catch(e){console.warn("Tips offline",e)}},fetchData:async()=>{try{let e=await kt("broadcast");if(e?.broadcast)return localStorage.setItem(Wt,JSON.stringify(e.broadcast)),e}catch(e){console.warn("Broadcast offline",e)}return{broadcast:JSON.parse(localStorage.getItem(Wt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Wt)||"[]"),getRandomTip:()=>{let e=an,t=localStorage.getItem(Eo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},sendBroadcast:async e=>{let t={...e,date:new Date().toISOString(),id:Date.now().toString()};return await ke._performOp("new_broadcast",t)},updateBroadcast:async(e,t)=>{let n={id:e,...t};return await ke._performOp("update_broadcast",n)},deleteBroadcast:async e=>await ke._performOp("delete_broadcast",{id:e}),_performOp:async(e,t)=>{try{console.log(`\u{1F4E4} Executando ${e}...`,t);let n=await kt(e,t);return n&&n.status==="success"?(console.log("\u2705 Sucesso:",e),!0):(console.warn("\u26A0\uFE0F Falha:",n),!1)}catch(n){return console.error("\u274C Erro JSONP:",n),!1}},logEvent:(e,t,n="",o=null)=>{try{let i="anon";try{let a=Ct();a&&(i=a.split("@")[0].toLowerCase())}catch{}let s={timestamp:new Date().toISOString(),user:i,version:"v5.1",category:e,action:t,label:n,value:o||""};kt("log",s).catch(a=>{})}catch(i){console.warn("Analytics error",i)}},logUsage:()=>{}};var ge={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00",teal:"#00BFA5"},Ot=e=>new Promise(t=>setTimeout(t,e));function To(e){let t="cw-command-center-style";if(!document.getElementById(t)){let f=document.createElement("style");f.id=t,f.innerHTML=`
            ...
            .cw-pill {
                ...
                background: ${ge.glassBg};
                backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);
                border: 1px solid ${ge.glassBorder}; border-radius: 50px;
            ...
            .cw-btn {
                ...
                display: flex; align-items: center; justify-content: center; 
                cursor: pointer; position: relative; color: ${ge.iconIdle};
                flex-shrink: 0;
            }
            .cw-btn:hover { background: ${ge.glassHighlight}; color: ${ge.iconActive}; transform: scale(1.1) !important; }

            .cw-btn.notes.active { color: ${ge.blue} !important; background: rgba(138, 180, 248, 0.15); }
            .cw-btn.email.active { color: ${ge.red} !important; background: rgba(242, 139, 130, 0.15); }
            .cw-btn.script.active { color: ${ge.purple} !important; background: rgba(197, 138, 249, 0.15); }
            .cw-btn.links.active { color: ${ge.green} !important; background: rgba(129, 201, 149, 0.15); }
            .cw-btn.broadcast.active { color: ${ge.orange} !important; background: rgba(249, 171, 0, 0.15); }
            .cw-btn.timezone.active { color: ${ge.teal} !important; background: rgba(0, 191, 165, 0.15); }

            .cw-btn.notes:hover { color: ${ge.blue}; filter: drop-shadow(0 0 5px rgba(138, 180, 248, 0.5)); }
            .cw-btn.email:hover { color: ${ge.red}; filter: drop-shadow(0 0 5px rgba(242, 139, 130, 0.5)); }
            .cw-btn.script:hover { color: ${ge.purple}; filter: drop-shadow(0 0 5px rgba(197, 138, 249, 0.5)); }
            .cw-btn.links:hover { color: ${ge.green}; filter: drop-shadow(0 0 5px rgba(129, 201, 149, 0.5)); }
            .cw-btn.broadcast:hover { color: ${ge.orange}; filter: drop-shadow(0 0 5px rgba(249, 171, 0, 0.5)); }
            .cw-btn.timezone:hover { color: ${ge.teal}; filter: drop-shadow(0 0 5px rgba(0, 191, 165, 0.5)); }
            ...
            .cw-grip-bar { width: 24px; height: 4px; background-color: ${ge.iconIdle}; border-radius: 4px; opacity: 0.4; transition: all 0.3s; }
            .cw-grip:hover .cw-grip-bar { opacity: 1; background-color: #FFFFFF; transform: scaleY(1.2); }
            .cw-pill.dragging .cw-grip-bar { background-color: ${ge.blue}; width: 16px; opacity: 1; }
            ...
            .cw-center-dots span:nth-child(1) { background-color: ${ge.blue}; animation-delay: -0.32s; }
            .cw-center-dots span:nth-child(2) { background-color: ${ge.red}; animation-delay: -0.16s; }
            .cw-center-dots span:nth-child(3) { background-color: ${ge.green}; }
            ...
            .cw-center-success { display: none; color: ${ge.green}; margin-bottom: 10px; }
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
            ...
            .cw-input-label {
                display: block; font-size: 10px; font-weight: 700; color: ${ee.textSub};
    ...
    `;let p=r.querySelector(".cw-hero-grid"),m=r.querySelector(".cw-acc-container"),b=r.querySelector(".cw-results-container"),h=r.querySelector(".cw-search-input"),x=r.querySelector(".cw-status-bar"),f=r.querySelector(".cw-status-text"),A=r.querySelector(".cw-footer-icons");i.forEach(([w,C])=>{let E=o(C.name),T=document.createElement("div");T.className="cw-hero-card",T.id=`hero-${w}`,T.style.setProperty("--hero-color",E.color),T.innerHTML=`
        ...
        `,T.onclick=O=>{if(O.target.closest(".cw-step-btn"))return;let M=t[w]?t[w].count:0;j(w,M>0?-M:1,C)},T.querySelector(".minus").onclick=()=>j(w,-1,C),T.querySelector(".plus").onclick=()=>j(w,1,C),T.dataset.color=E.color,p.appendChild(T)});function S(w,C){let E=o(C.name),T=document.createElement("div");return T.className="cw-task-item",T.dataset.id=w,T.innerHTML=`
        ...
        `,T.onclick=O=>{if(O.target.closest(".cw-step-btn"))return;let M=t[w]?t[w].count:0;j(w,M>0?-M:1,C)},T.querySelector(".minus").onclick=()=>j(w,-1,C),T.querySelector(".plus").onclick=()=>j(w,1,C),T}Object.entries(s).forEach(([w,C])=>{let E=document.createElement("div");E.className="cw-acc-group";let T=document.createElement("div");T.className="cw-acc-header",T.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${C.brand.color}"></div>
                ${w}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,T.onclick=()=>{m.querySelectorAll(".cw-acc-group.open").forEach(M=>{M!==E&&M.classList.remove("open")}),E.classList.toggle("open")};let O=document.createElement("div");O.className="cw-acc-body",C.tasks.forEach(M=>{let N=S(M.key,M);O.appendChild(N)}),E.appendChild(T),E.appendChild(O),m.appendChild(E)});function j(w,C,E){t[w]||(t[w]={count:0,data:E,brand:o(E.name)}),t[w].count+=C,t[w].count<=0&&delete t[w],H(),z(),e&&e()}function H(){i.forEach(([O])=>{let M=p.querySelector(`#hero-${O}`);if(!M)return;let N=t[O];N?(M.classList.add("active"),M.querySelector(".cw-step-val").textContent=N.count,M.querySelector(".cw-step-val").style.color=M.dataset.color):M.classList.remove("active")}),r.querySelectorAll(".cw-task-item").forEach(O=>{let M=O.dataset.id,N=t[M];N?(O.classList.add("selected"),O.querySelector(".cw-step-val").textContent=N.count):O.classList.remove("selected")});let C=Object.keys(t),E=0,T=[];if(C.forEach(O=>{let M=t[O];E+=M.count;for(let N=0;N<M.count;N++)T.length<6&&T.push(M.brand)}),E>0){x.classList.add("visible");let O=E>1?"A\xE7\xF5es":"A\xE7\xE3o",M=E>1?"definidas":"definida";f.textContent=`${E} ${O} ${M}`,A.innerHTML="",T.forEach(N=>{let _=document.createElement("div");_.className="cw-mini-icon",_.innerHTML=et[N.icon]||et.default;let R=_.querySelector("svg");R&&(R.style.width="14px",R.style.height="14px"),A.appendChild(_)})}else x.classList.remove("visible")}h.addEventListener("input",w=>{let C=w.target.value.toLowerCase();if(C.length>0){m.style.display="none",b.style.display="block",b.innerHTML="";let E=!1;Object.entries(_e).forEach(([T,O])=>{if(O.name.toLowerCase().includes(C)){E=!0;let M=S(T,O);t[T]&&(M.classList.add("selected"),M.querySelector(".cw-step-val").textContent=t[T].count),b.appendChild(M)}}),E||(b.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else m.style.display="block",b.style.display="none"});function z(){l.innerHTML="";let w=Object.keys(t),C=!1,E=document.getElementById("sub-status"),T="implementation";if(E&&E.value.toLowerCase().includes("education")&&(T="education"),w.length===0){l.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(w.length===0){l.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let O=document.createElement("div");O.className="cw-info-banner",O.innerHTML=`
...
`.replace(/\n/g,"<br>");gt(E);let T=await Lt();T?(T.innerText.trim()===""&&(T.innerHTML=""),document.execCommand("insertHTML",!1,E),Ft(T),W("Nota gerada e inserida!")):W("Copiado! Abra uma nota para colar.")},t}var Xt="cw_notes_parking_lot",Mt="cw_notes_emergency_save";var $e={getAll:()=>{try{return JSON.parse(localStorage.getItem(Xt)||"[]")}catch{return[]}},save:e=>{let t=$e.getAll(),n={id:Date.now().toString(),timestamp:new Date().toISOString(),...e};return t.unshift(n),t.length>5&&t.pop(),localStorage.setItem(Xt,JSON.stringify(t)),n},delete:e=>{let t=$e.getAll();return t=t.filter(n=>n.id!==e),localStorage.setItem(Xt,JSON.stringify(t)),t},getCount:()=>$e.getAll().length,saveEmergency:e=>{let t={timestamp:Date.now(),data:e};localStorage.setItem(Mt,JSON.stringify(t))},getEmergency:()=>{try{let e=localStorage.getItem(Mt);if(!e)return null;let t=JSON.parse(e);return Date.now()-t.timestamp>432e5?(localStorage.removeItem(Mt),null):t.data}catch{return null}},clearEmergency:()=>{localStorage.removeItem(Mt)}};function Mo(e){let{onSaveCurrent:t,onLoadDraft:n}=e,o=document.createElement("button");o.innerHTML=`
  ...
  `;let U=document.createElement("div");U.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let u=document.createElement("label");u.className="cw-input-label",u.textContent="Sub-status",u.style.marginBottom="0";let v=document.createElement("a");v.href="https://seu-link-do-guia-aqui.com",v.target="_blank",v.className="cw-info-link",v.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(v.style,a.helpLink),U.appendChild(u),U.appendChild(v);let d=document.createElement("select");d.id="sub-status",d.className="cw-select",d.disabled=!0,d.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',N.appendChild(_),N.appendChild(R),N.appendChild(U),N.appendChild(d),b.appendChild(N);let y=document.createElement("div");y.id="step-1-1-portugal",Object.assign(y.style,a.stepBlock,{display:"none"});let B=document.createElement("label");Object.assign(B.style,a.label),y.appendChild(B);let q=document.createElement("div");Object.assign(q.style,a.radioContainer);let G=document.createElement("div");Object.assign(G.style,{display:"flex",alignItems:"center"});let k=document.createElement("input");k.type="radio",k.name="portugal-group",k.value="sim",Object.assign(k.style,a.checkboxInput);let L=document.createElement("label");L.htmlFor="portugal-sim",Object.assign(L.style,{cursor:"pointer"}),G.appendChild(k),G.appendChild(L);let D=document.createElement("div");Object.assign(D.style,{display:"flex",alignItems:"center"});let V=document.createElement("input");V.type="radio",V.name="portugal-group",V.value="nao",V.checked=!0,Object.assign(V.style,a.checkboxInput);let I=document.createElement("label");I.htmlFor="portugal-nao",Object.assign(I.style,{cursor:"pointer"}),D.appendChild(V),D.appendChild(I),q.appendChild(G),q.appendChild(D),y.appendChild(q),b.appendChild(y);function $(g){o=g,g?J.style.display="block":J.style.display="none"}k.onchange=()=>$(!0),V.onchange=()=>$(!1);let J=document.createElement("div");J.id="step-1-2-consent",Object.assign(J.style,a.stepBlock,{display:"none"});let fe=document.createElement("label");Object.assign(fe.style,a.label),J.appendChild(fe);let be=document.createElement("div");Object.assign(be.style,a.radioContainer);let Ee=document.createElement("div");Object.assign(Ee.style,{display:"flex",alignItems:"center"});let ie=document.createElement("input");ie.type="radio",ie.name="consent-group",ie.value="Sim",ie.checked=!0,Object.assign(ie.style,a.checkboxInput);let ye=document.createElement("label");ye.htmlFor="consent-sim",Object.assign(ye.style,{cursor:"pointer"}),Ee.appendChild(ie),Ee.appendChild(ye);let ue=document.createElement("div");Object.assign(ue.style,{display:"flex",alignItems:"center"});let Z=document.createElement("input");Z.type="radio",Z.name="consent-group",Z.value="N\xE3o",Object.assign(Z.style,a.checkboxInput);let de=document.createElement("label");de.htmlFor="consent-nao",Object.assign(de.style,{cursor:"pointer"}),ue.appendChild(Z),ue.appendChild(de),be.appendChild(Ee),be.appendChild(ue),J.appendChild(be),b.appendChild(J);let ce=document.createElement("div");ce.id="step-1-5-snippets",Object.assign(ce.style,a.stepBlock,{display:"none"});let Ne=document.createElement("h3");Object.assign(Ne.style,a.h3),Ne.textContent="Cen\xE1rios Comuns";let Ie=ko(g=>{let P=document.querySelector("textarea");P&&(P.value=g,P.dispatchEvent(new Event("input")),P.style.transition="background-color 0.2s",P.style.backgroundColor="#e8f0fe",setTimeout(()=>P.style.backgroundColor="#fff",300))});Ie.id="snippet-container",ce.appendChild(Ne),ce.appendChild(Ie),b.appendChild(ce);let we=document.createElement("div");we.id="step-3-form",Object.assign(we.style,a.stepBlock,{display:"none"});let Re=document.createElement("h3");Object.assign(Re.style,a.h3),we.appendChild(Re);let Me=document.createElement("div");Me.id="dynamic-form-fields-container",we.appendChild(Me);let Ce=document.createElement("button");Ce.textContent="+ Gostaria de selecionar uma task?",Object.assign(Ce.style,a.optionalBtn),Ce.onmouseover=()=>Ce.style.background="#e8f0fe",Ce.onmouseout=()=>Ce.style.background="white",Ce.onclick=()=>{Ce.style.display="none",We.style.display="block",c.selectionElement.style.display="block"};let We=document.createElement("h3");Object.assign(We.style,a.h3,{marginTop:"20px"});let Zt=c.selectionElement;Object.assign(Zt.style,{marginBottom:"20px"}),we.appendChild(Ce),we.appendChild(We),we.appendChild(Zt),we.appendChild(r.element),we.appendChild(c.screenshotsElement),b.appendChild(we);let Ye=document.createElement("div");Ye.id="step-4-email",Object.assign(Ye.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Xe=document.createElement("label");Xe.style.display="flex",Xe.style.alignItems="center",Xe.style.cursor="pointer",Xe.style.fontSize="14px";let Ke=document.createElement("input");Ke.type="checkbox",Ke.checked=!0,Object.assign(Ke.style,a.checkboxInput),Xe.appendChild(Ke),Xe.appendChild(document.createTextNode("Preencher email automaticamente?")),Ye.appendChild(Xe),b.appendChild(Ye);let Ve=document.createElement("div");Object.assign(Ve.style,{display:"none",gap:"8px",padding:"0"}),b.appendChild(Ve);let rt=document.createElement("button");Object.assign(rt.style,a.buttonBase,{backgroundColor:"#5f6368"}),rt.textContent="Copiar";let lt=document.createElement("button");Object.assign(lt.style,a.buttonBase,{backgroundColor:"#1a73e8"}),lt.textContent="Preencher",Ve.appendChild(rt),Ve.appendChild(lt);async function eo(){let g=await Ge(),P={};Me.querySelectorAll("input, textarea").forEach(pe=>P[pe.id]=pe.value);let Y=c.getCheckedElements().map(pe=>({key:pe.value,count:parseInt(pe.closest(".cw-task-item").querySelector(".cw-step-val")?.textContent||1)})),se=document.getElementById("tag-support-container"),he=null;if(se){let pe=se.querySelector('input[type="radio"]:checked'),te=se.querySelector('input[type="text"]');he={choice:pe?pe.value:"N\xE3o",reason:te?te.value:""}}let Ae=[];return c.getCheckedElements().forEach(pe=>{let te=pe.value;_e[te]?Ae.push(_e[te].name):Ae.push(te)}),{clientName:g.advertiserName,cid:g.cid,status:R.value,subStatus:d.value,caseType:t,lang:n,formData:P,activeTasks:Y,tagSupportState:he,summaryTags:Ae}}function to(g){g.lang&&ht(g.lang),g.caseType&&ft(g.caseType),g.status&&(R.value=g.status,R.dispatchEvent(new Event("change"))),setTimeout(()=>{g.subStatus&&(d.value=g.subStatus,d.dispatchEvent(new Event("change"))),setTimeout(()=>{if(g.formData&&Object.entries(g.formData).forEach(([P,F])=>{let Y=document.getElementById(P);Y&&(Y.value=F)}),c.reset(),g.activeTasks&&Array.isArray(g.activeTasks)&&g.activeTasks.forEach(P=>{for(let F=0;F<P.count;F++)c.toggleTask(P.key,!0)}),g.tagSupportState){let P=document.getElementById("tag-support-container");if(P){let F=P.querySelector(`input[value="${g.tagSupportState.choice}"]`);if(F&&(F.checked=!0,F.dispatchEvent(new Event("change"))),g.tagSupportState.choice==="N\xE3o"&&g.tagSupportState.reason){let Y=P.querySelector('input[type="text"]');Y&&(Y.value=g.tagSupportState.reason)}}}},100)},50)}let Rt=Mo({onSaveCurrent:async()=>{let g=await eo();return xt(1.5),R.value="",g},onLoadDraft:g=>{to(g)}}),nt=m.lastElementChild;if(nt&&nt.insertBefore(Rt.historyBtnWrapper,nt.firstChild),nt){let g=document.createElement("div");g.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',Object.assign(g.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease",marginLeft:"4px"}),g.title="Alternar para Split & Transfer",g.onmouseenter=()=>{g.style.background="rgba(255,255,255,0.1)",g.style.color="#FFF"},g.onmouseleave=()=>{s||(g.style.background="transparent",g.style.color="#9AA0A6")},g.onclick=P=>{P.stopPropagation(),f(g)},nt.insertBefore(g,nt.firstChild)}Ve.insertBefore(Rt.parkButton,Ve.firstChild),l.appendChild(Rt.drawer);let ct=document.createElement("div");Object.assign(ct.style,at),ct.className="no-drag",ct.title="Redimensionar",l.appendChild(ct),it(l,ct),document.body.appendChild(l);function ft(g){t=g;let P=dt();Object.assign(O.style,Te),Object.assign(M.style,Te),g==="bau"?(Object.assign(O.style,P),v.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(M.style,P),v.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),d.value&&d.dispatchEvent(new Event("change"))}function ne(g){try{if(He&&He[n]&&He[n][g])return He[n][g];if(He&&He.pt&&He.pt[g])return He.pt[g]}catch{}return g}function Uo(){j.textContent=ne("idioma"),E.textContent=ne("fluxo"),_.textContent=ne("status_principal"),u.textContent=ne("substatus"),Ne.textContent=ne("cenarios_comuns"),We.textContent=ne("selecione_tasks"),Re.textContent=ne("preencha_detalhes"),rt.textContent=ne("copiar"),lt.textContent=ne("preencher"),R.querySelector('option[value=""]')&&(R.querySelector('option[value=""]').textContent=ne("select_status")),d.querySelector('option[value=""]')&&(d.querySelector('option[value=""]').textContent=ne("select_substatus")),B.textContent=ne("caso_portugal"),L.textContent=ne("sim"),I.textContent=ne("nao"),fe.textContent=ne("consentiu_gravacao"),ye.textContent=ne("sim"),de.textContent=ne("nao"),Me.querySelectorAll("label").forEach(g=>{let P=g.nextElementSibling.id.replace("field-",""),F=ne(P.toLowerCase());F!==P.toLowerCase()?g.textContent=F:g.textContent=P.replace(/_/g," ").replace(/\b\w/g,Y=>Y.toUpperCase())+":"}),Ce.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function ht(g){n=g;let P=dt();Object.assign(z.style,Te),Object.assign(w.style,Te),g==="pt"?(Object.assign(z.style,P),y.style.display="block",$(o)):(Object.assign(w.style,P),y.style.display="none",J.style.display="none"),Uo(),d.value&&d.dispatchEvent(new Event("change"))}function _t(g){(g.value.trim()===""||g.value.trim()==="\u2022")&&(g.value="\u2022 "),g.onkeydown=function(P){if(P.key==="Enter"){P.preventDefault();let F=this.selectionStart,Y=this.selectionEnd,se=this.value,he=se.lastIndexOf(`
`,F-1)+1,Ae=se.substring(he,F),pe=Ae.trim()==="\u2022"||Ae.trim()===""?`
`:`
\u2022 `;this.value=se.substring(0,F)+pe+se.substring(Y),this.selectionStart=this.selectionEnd=F+pe.length}else if(P.key==="Backspace"){let F=this.selectionStart;if(F===this.selectionEnd&&F>0){let Y=this.value.substring(0,F);Y.endsWith(`
\u2022 `)?(P.preventDefault(),this.value=Y.substring(0,F-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=F-3):Y==="\u2022 "&&(P.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function Dt(){let g=typeof Ie<"u"?Ie:document.getElementById("snippet-container");if(!g)return;let P=g.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),F={},Y=new Set;P.forEach(te=>{let le=te.id,Q=De[le];if(Q)for(let X in Q)X==="linkedTask"?Y.add(Q.linkedTask):X!=="type"&&(F[X]||(F[X]=[]),F[X].includes(Q[X])||F[X].push(Q[X]))});let se=new Set;Object.values(De).forEach(te=>{Object.keys(te).forEach(le=>{le!=="linkedTask"&&le!=="type"&&se.add(le)})}),se.forEach(te=>{let le=document.getElementById(te);if(le){let Q=F[te]||[],X="";mt.includes(te.replace("field-",""))?(X=Q.map(re=>re.startsWith("\u2022 ")?re:"\u2022 "+re).join(`
`),X===""?X="\u2022 ":X.endsWith(`
\u2022 `)||(X+=`
\u2022 `)):X=Q.join(`

`),X.trim()!=="\u2022"&&X.trim()!==""?le.value=X:mt.includes(te.replace("field-",""))?le.value="\u2022 ":le.value="",le.tagName==="TEXTAREA"&&typeof _t=="function"&&_t(le)}});let he=new Set,Ae=new Set;g.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(te=>{let le=De[te.id];le&&le.linkedTask&&(te.checked?he.add(le.linkedTask):Ae.add(le.linkedTask))}),Ae.forEach(te=>{he.has(te)||c.toggleTask(te,!1)}),he.forEach(te=>{c.toggleTask(te,!0)})}R.onchange=()=>{let g=R.value;if(xt(1.5),d.innerHTML=`<option value="">${ne("select_substatus")}</option>`,!g){d.disabled=!0;return}for(let P in ut){let F=ut[P];if(F.status===g){let Y=document.createElement("option");Y.value=P,Y.textContent=F.name,d.appendChild(Y)}}d.disabled=!1},d.onchange=()=>{let g=d.value;if(xt(1.5),!g)return;c.updateSubStatus(g);let P=ut[g];Ie.innerHTML="";let F=(Q,X,re)=>{let xe=document.createElement("label");Object.assign(xe.style,a.checkboxLabel),xe.onmouseover=()=>xe.style.backgroundColor="#e8eaed",xe.onmouseout=()=>xe.style.backgroundColor="#f8f9fa";let me=document.createElement("input");return me.type=X,me.id=Q.id,Object.assign(me.style,a.checkboxInput),xe.appendChild(me),xe.appendChild(document.createTextNode(` ${Q.text}`)),re.appendChild(xe),me},Y=[],se="radio";if(g==="NI_Awaiting_Inputs")Y=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(g.startsWith("SO_"))se="checkbox",Y=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"},{id:"quickfill-ga4-event-close",text:"Fechamento GA4 (P\xF3s 2 dias)"}];else if(g.startsWith("AS_")){se="checkbox";let Q=document.createElement("label");Q.textContent=ne("cenarios_comuns"),Object.assign(Q.style,a.label),Ie.appendChild(Q),Y=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else g.startsWith("IN_")?Y=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:g.startsWith("DC_")?(se="radio",Y=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]):g==="NI_Attempted_Contact"?(se="radio",Y=[{id:"quickfill-ni-attempted-2day",text:"2 Day Rule (2 Liga\xE7\xF5es + Chat AM)"}]):g==="NI_Awaiting_Validation"&&(se="checkbox",Y=[{id:"quickfill-ni-awaiting-ecw4",text:"ECW4 (Acompanhar)"},{id:"quickfill-ni-awaiting-ga4",text:"GA4 Event Tracking (Acompanhar)"}]);let he=Y.filter(Q=>{let X=De[Q.id];return!X.type||X.type==="all"||X.type===t});he.forEach((Q,X)=>{let re=F(Q,se,Ie);se==="radio"&&(re.name="scenario-radio-group",X===0&&(re.checked=!0))}),he.length>0&&(ce.style.display="block"),P.requiresTasks?(Ce.style.display="none",We.style.display="block",c.selectionElement.style.display="block"):(Ce.style.display="block",We.style.display="none",c.selectionElement.style.display="none"),Me.innerHTML="";let Ae=P.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(Ae)].forEach(Q=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(Q))return;let X=Q.slice(1,-1),re=document.createElement("label"),xe=ne(X.toLowerCase());if(re.textContent=xe!==X.toLowerCase()?xe:X.replace(/_/g," ").replace(/\b\w/g,oe=>oe.toUpperCase())+":",Object.assign(re.style,a.label),X==="SPEAKEASY_ID"){let oe=document.createElement("button");oe.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',oe.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,oe.title="Localizar Speakeasy ID no hist\xF3rico",oe.onmouseover=()=>{oe.style.backgroundColor="#c2e7ff",oe.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},oe.onmouseout=()=>{oe.style.backgroundColor="#d3e3fd",oe.style.boxShadow="none"},oe.onmousedown=()=>{oe.style.backgroundColor="#a8c7fa",oe.style.transform="scale(0.96)"},oe.onmouseup=()=>oe.style.transform="scale(1)",oe.onclick=Se=>{Se.preventDefault(),vo(`field-${X}`)},re.appendChild(oe)}let me;mt.includes(X)?(me=document.createElement("textarea"),Object.assign(me.style,a.textarea),me.classList.add("bullet-textarea"),_t(me)):$t.includes(X)?(me=document.createElement("textarea"),Object.assign(me.style,a.textarea)):(me=document.createElement("input"),me.type="text",Object.assign(me.style,a.input),X==="REASON_COMMENTS"&&(g.startsWith("NI_")||g.startsWith("IN_"))&&(Object.assign(re.style,{display:"none"}),Object.assign(me.style,{display:"none"}))),X==="ON_CALL"&&t==="lm"&&(Object.assign(re.style,{display:"none"}),Object.assign(me.style,{display:"none"}),me.value="N/A"),me.id=`field-${X}`,Me.appendChild(re),Me.appendChild(me)});let te=Ie.querySelectorAll('input[type="checkbox"], input[type="radio"]');te.length>0&&(te.forEach(Q=>{Q.removeEventListener("change",Dt),Q.addEventListener("change",Dt)}),Dt()),we.style.display="block",Ze[g]?Ye.style.display="block":Ye.style.display="none",Ve.style.display="flex";let le=c.getCheckedElements().map(Q=>Q.value);r.updateVisibility(g,le)},Ce.onclick=()=>{Ce.style.display="none",We.style.display="block",c.selectionElement.style.display="block"};function oo(){let g=d.value;if(!g)return null;let F=ut[g].template.replace(/\n/g,"<br>"),Y='style="margin-bottom: 12px; padding-left: 30px;"',se=[],he="",Ae=c.getCheckedElements();Ae.length>0&&Ae.forEach(le=>{let Q=le.value,X=_e[Q],re=le.closest().querySelector(".stepper-count"),xe=re?parseInt(re.textContent):1;xe>1?se.push(`${X.name} (x${xe})`):se.push(X.name)});let pe=c.screenshotsElement;if(pe){let le=Array.from(pe.querySelectorAll('input[id^="name-"]'));le.length>0&&le.forEach(Q=>{let X=Q.value,re=Q.closest(".cw-screen-card");if(re){let xe=re.querySelectorAll('input[id^="screen-"]'),me=!1,oe="";xe.forEach(Se=>{let ao=Se.closest(".cw-input-group"),io=ao?ao.querySelector(".cw-input-label"):null,Xo=io?io.textContent:"Evid\xEAncia",so=Se.value.trim(),Ko=so?` ${so}`:"";oe+=`<li>${Xo} -${Ko}</li>`,me=!0}),me&&(he+=`<b>${X}</b>`,he+=`<ul ${Y}>${oe}</ul>`)}})}if(F.includes("{TAGS_IMPLEMENTED}")?F=F.replace(/{TAGS_IMPLEMENTED}/g,se.join(", ")||"N/A"):se.length>0&&(F+=`<br><b>Tags:</b> ${se.join(", ")}<br>`),F.includes("{SCREENSHOTS_LIST}")?F=F.replace(/{SCREENSHOTS_LIST}/g,he?`${he}`:"N/A"):he!==""&&(F+=`<br>${he}`),n==="pt"&&o){let le=ie.checked?ne("sim"):ne("nao");F=F.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${ne("consentiu_gravacao")}</b> ${le}<br><br>`),F=F.replace(/{CASO_PORTUGAL}/g,`<br><b>${ne("caso_portugal")}</b> ${ne("sim")}<br>`)}else n==="pt"&&!o?(F=F.replace(/{CASO_PORTUGAL}/g,`<br><b>${ne("caso_portugal")}</b> ${ne("nao")}<br>`),F=F.replace(/{CONSENTIU_GRAVACAO}/g,"")):(F=F.replace(/{CASO_PORTUGAL}/g,""),F=F.replace(/{CONSENTIU_GRAVACAO}/g,""));return Me.querySelectorAll("input, textarea").forEach(le=>{let Q=le.id.replace("field-",""),X=new RegExp(`{${Q}}`,"g"),re=le.value;if(Q==="REASON_COMMENTS"&&(g.startsWith("NI_")||g.startsWith("IN_"))){let oe=Ie.querySelector('input[type="radio"]:checked');oe&&De[oe.id]&&(re=De[oe.id]["field-REASON_COMMENTS"])}if(mt.includes(Q)&&re.trim()!==""){let oe=re.split(`
`).map(Se=>Se.trim()).filter(Se=>Se!==""&&Se!=="\u2022").map(Se=>Se.startsWith("\u2022 ")?Se.substring(2):Se).map(Se=>`<li>${Se}</li>`).join("");re=oe?`<ul ${Y}>${oe}</ul>`:""}else $t.includes(Q)?re=re.split(`
`).filter(oe=>oe.trim()!=="").map(oe=>`<p style="margin: 0 0 8px 0;">${oe}</p>`).join(""):le.tagName==="TEXTAREA"&&(re=re.replace(/\n/g,"<br>"));let xe=re.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(xe===""||xe==="\u2022"||xe.toLowerCase()==="n/a"){let oe=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${Q}\\}(?:<br>\\s*)?`,"gi");oe.test(F)?F=F.replace(oe,""):F=F.replace(X,"")}else F=F.replace(X,re.replace(/\$/g,"$$$$"))}),F=F.replace(/{([A-Z0-9_]+)}/g,""),F=F.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(F+=r.getOutput()),F}rt.onclick=()=>{let g=oo();g?(gt(g),W(ne("copiado_sucesso"))):W(ne("selecione_substatus"),{error:!0})},lt.onclick=async()=>{let g=d.value,P=oo();if(!P){W(ne("selecione_substatus"),{error:!0});return}gt(P),zt();let F=It(),Y=await Lt();if(Y)try{if(Y.focus(),Y.innerHTML.trim()==="<p><br></p>"||Y.innerHTML.trim()==="<br>"||Y.innerText.trim()===""){let pe=document.createRange();pe.selectNodeContents(Y);let te=window.getSelection();te.removeAllRanges(),te.addRange(pe),document.execCommand("delete",!1,null)}else if(!Y.innerHTML.endsWith("<br><br>")){let pe=document.createRange();pe.selectNodeContents(Y),pe.collapse(!1);let te=window.getSelection();te.removeAllRanges(),te.addRange(pe),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,P),Ft(Y),setTimeout(()=>{W(ne("inserido_copiado"))},600);let he=typeof Ke<"u"&&Ke?Ke.checked:!0;if(g&&Ze[g]&&he){let pe=Ze[g];await Tt(pe),await new Promise(te=>setTimeout(te,500))}F(),xt(1.5),R.value="",d.innerHTML=`<option value="">${ne("select_substatus")}</option>`,d.disabled=!0}catch(se){console.error(se),W("Erro ao inserir.",{error:!0}),F()}};function xt(g=1.5){g<=1.5&&(ce.style.display="none",Ie.innerHTML=""),g<=2&&(c.reset(),Ce.style.display="none"),g<=3&&(we.style.display="none",Me.innerHTML="",r.reset(),Ve.style.display="none",Ye.style.display="none")}let Wo=null,yt="";function no(g){let P=document.getElementById("cw-btn-notes");if(!P)return;let F=P.querySelector(".cw-dot-dirty");if(g){if(!F){let Y=document.createElement("div");Y.className="cw-dot-dirty",P.appendChild(Y)}}else F&&F.remove()}async function Yo(){let g=await eo(),P=g.activeTasks.length>0;if(!P){let F=Object.keys(g.formData);for(let Y of F){let se=g.formData[Y];if(se&&se.trim().length>3&&se!=="\u2022 "){P=!0;break}}}if(no(P),P){let F=JSON.stringify(g);F!==yt&&(DraftService.saveEmergency(g),yt=F)}else yt!==""&&(DraftService.clearEmergency(),yt="")}Wo=setInterval(Yo,5e3),setTimeout(()=>{let g=DraftService.getEmergency();if(g){let P=document.createElement("button");P.innerHTML="\u26A0\uFE0F Recuperar trabalho n\xE3o salvo",P.style.cssText="width:100%; background:#FFF3E0; color:#B06000; border:none; padding:8px; font-size:12px; cursor:pointer; font-weight:600; border-bottom:1px solid #FFE0B2;",P.onclick=()=>{to(g),P.remove(),W("Trabalho recuperado!"),SoundManager.playSuccess()},b.insertBefore(P,b.firstChild),no(!0)}},1e3);function zt(){if(i=!i,i){let g=l.querySelector(".cw-expand-btn");g&&typeof g.resetState=="function"&&g.resetState()}Le(i,l,"cw-btn-notes")}return ft("bau"),ht("pt"),zt}var tt={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
        ...
        `;let L=R.querySelector("#csa-back-btn");L.onmouseenter=()=>L.style.background="#f1f3f4",L.onmouseleave=()=>L.style.background="none",L.onclick=v;let D=R.querySelector("#csa-insert-btn");D.onmouseenter=()=>{D.style.transform="translateY(-1px)",D.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},D.onmouseleave=()=>{D.style.transform="translateY(0)",D.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},D.onclick=()=>{D.style.transform="scale(0.96)",U(q,"email"),setTimeout(()=>{D.style.transform="scale(1)",v()},300)}}function v(){i="list",C.style.transform="translateX(0)"}function d(q,G,k=null){let L=document.createElement("button"),D=k?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${k}</span>`:"";return L.innerHTML=`${D}${q}`,Object.assign(L.style,h),n===G&&o===""?Object.assign(L.style,x):(L.onmouseenter=()=>{L.style.background="#F1F3F4",L.style.borderColor="#DADCE0"},L.onmouseleave=()=>{L.style.background="#FFFFFF",L.style.borderColor="#DADCE0"}),L.onclick=()=>{n=G,o="",O.value="",y(),B()},L}function y(){M.innerHTML="",M.appendChild(d("Smart CRs",t,"\u26A1")),Object.keys(tt).forEach(q=>{M.appendChild(d(tt[q].title,q))})}function B(){N.innerHTML="";let q=[];if(o.trim()!==""){let V=o.toLowerCase();Object.values(tt).forEach(I=>{I.emails.forEach($=>{($.name.toLowerCase().includes(V)||$.subject.toLowerCase().includes(V))&&q.push({type:"email",data:$})})}),Object.entries(Ze).forEach(([I,$])=>{if(!$)return;(I.replace(/_/g," ").toLowerCase().includes(V)||$.toLowerCase().includes(V))&&q.push({type:"cr",key:I,code:$})})}else n===t?Object.entries(Ze).forEach(([V,I])=>{I&&q.push({type:"cr",key:V,code:I})}):tt[n]&&tt[n].emails.forEach(V=>{q.push({type:"email",data:V})});if(q.length===0){N.innerHTML=`
                ...
                `,I.onclick=()=>u($)}else{let $=V.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");I.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function Do(){let e="v2.6 (Context HD)",t="csa-local-styles";if(!document.getElementById(t)){let d=document.createElement("style");d.id=t,d.innerHTML=`
  ...
  `,f.onfocus=()=>{h.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",h.style.border="1px solid #1a73e8"},f.onblur=()=>{h.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",h.style.border="1px solid transparent"},h.appendChild(x),h.appendChild(f),b.appendChild(h),m.appendChild(b);let A=document.createElement("div");A.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",m.appendChild(A);let S=null;function j(){if(S)return;S=document.createElement("div"),S.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let _=document.createElement("div");_.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",_.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let R=document.createElement("button");R.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',R.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",R.onclick=()=>{z(),i=!1,T()},_.appendChild(R),S.appendChild(_);let U=document.createElement("div");U.id="cw-history-list",U.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",S.appendChild(U),m.appendChild(S)}function H(){S||j();let _=S.querySelector("#cw-history-list");_.innerHTML="";let R=pn();R.length===0?_.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':R.forEach(U=>{let u=M(U,ot[U._originalCat],!0,U._originalCat);_.appendChild(u)}),requestAnimationFrame(()=>S.style.transform="translateY(0)")}function z(){S&&(S.style.transform="translateY(100%)")}function w(){p.innerHTML="";let _=C("history","Recentes",ot.history);_.id="cw-sidebar-btn-history",_.onclick=()=>{K.playClick(),i=!i,i?H():z(),T()},p.appendChild(_);let R=document.createElement("div");R.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",p.appendChild(R),Object.keys(bt).forEach(U=>{let u=bt[U],v=C(U,u.label,ot[U]);v.id=`cw-sidebar-btn-${U}`,v.onclick=()=>{K.playClick(),i&&(i=!1,z()),E(U)},p.appendChild(v)})}function C(_,R,U){let u=document.createElement("div");u.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${s.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,u.title=R,u.dataset.key=_;let v=document.createElement("div");v.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",v.innerHTML=U||ot.tasks;let d=document.createElement("div");return d.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",d.textContent=R,u.appendChild(v),u.appendChild(d),u.onmouseenter=()=>{o!==_&&!(_==="history"&&i)&&(u.style.background="#F1F3F4",v.style.transform="scale(1.1)")},u.onmouseleave=()=>{o!==_&&!(_==="history"&&i)&&(u.style.background="transparent",v.style.transform="scale(1)")},u}function E(_){let R=document.getElementById(`cat-anchor-${_}`);R&&(R.scrollIntoView({behavior:"smooth",block:"start"}),o=_,T())}function T(){Object.keys(bt).forEach(R=>{let U=p.querySelector(`#cw-sidebar-btn-${R}`);if(U)if(o===R&&!i){let u=Nt[R];U.style.background=u.bg,U.style.color=u.color,U.querySelector("div:first-child").style.transform="scale(1.1)"}else U.style.background="transparent",U.style.color=s.textSecondary,U.querySelector("div:first-child").style.transform="scale(1)"});let _=p.querySelector("#cw-sidebar-btn-history");_&&(i?(_.style.background="#3C4043",_.style.color="#FFFFFF"):(_.style.background="transparent",_.style.color=s.textSecondary))}function O(){if(A.innerHTML="",t.trim()!==""){let R=[];if(Object.entries(bt).forEach(([u,v])=>{let d=v.links.filter(y=>y.name.toLowerCase().includes(t.toLowerCase())||y.desc.toLowerCase().includes(t.toLowerCase()));R.push(...d.map(y=>({...y,_cat:u})))}),R.length===0){A.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let U=document.createElement("div");U.innerHTML="Resultados da busca",U.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",A.appendChild(U),R.forEach(u=>{let v=M(u,ot[u._cat],!1,u._cat);A.appendChild(v)});return}Object.entries(bt).forEach(([R,U])=>{let u=Nt[R],v=document.createElement("div"),d=document.createElement("div");d.id=`cat-anchor-${R}`,d.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,d.innerHTML=`
            ...
            ${U.label}
          `,v.appendChild(d);let y=document.createElement("div");y.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",U.links.forEach(B=>{let q=M(B,ot[R],!1,R);y.appendChild(q)}),v.appendChild(y),A.appendChild(v)});let _=document.createElement("div");_.style.height="80px",A.appendChild(_)}function M(_,R,U,u){let v=document.createElement("div"),d=Nt[u]||Nt.history;v.style.cssText=`
      ...
      `;let y=document.createElement("div");y.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,y.innerHTML=R||ot.tasks;let B=y.querySelector("svg");B&&(B.style.width="22px",B.style.height="22px");let q=document.createElement("div");q.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let G=document.createElement("div");G.style.cssText=`font-size: 14px; font-weight: 600; color: ${s.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,G.textContent=_.name;let k=document.createElement("div");k.style.cssText=`font-size: 12px; color: ${s.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,k.textContent=_.desc,q.appendChild(G),q.appendChild(k);let L=document.createElement("div");return L.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',L.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,L.title="Copiar URL",v.onmouseenter=()=>{v.style.transform="translateY(-2px)",v.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",v.style.borderColor="rgba(0,0,0,0.05)",v.style.borderLeft=`4px solid ${d.color}`,L.style.opacity="1",L.style.background="#F1F3F4"},v.onmouseleave=()=>{v.style.transform="translateY(0)",v.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",v.style.border="1px solid transparent",L.style.opacity="0",L.style.background="transparent"},v.onclick=()=>{!U&&u&&zo(_,u),window.open(_.url,"_blank")},L.onclick=D=>{D.stopPropagation(),K.playClick(),navigator.clipboard.writeText(_.url),!U&&u&&zo(_,u),W("Link copiado!")},v.appendChild(y),v.appendChild(q),v.appendChild(L),v}f.addEventListener("input",_=>{t=_.target.value,O()});function N(){n=!n,Le(n,a,"cw-btn-links")}return document.body.appendChild(a),w(),O(),N}var Ue=[];function Jt(e){Ue=e}var un=["lucaste","ricardogi"],mn=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Go(){let e="v4.9",t=!1,n=null,o=null;function i(u){if(!u)return"";try{let v=new Date(u);return isNaN(v.getTime())?String(u):v.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(u)}}if(!document.getElementById("cw-broadcast-hd-css")){let u=document.createElement("style");u.id="cw-broadcast-hd-css",u.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,x.querySelectorAll('input[name="cw-bc-type"]').forEach(y=>{y.addEventListener("change",()=>{x.querySelectorAll(".cw-radio-option").forEach(B=>B.classList.remove("checked")),y.parentElement.classList.add("checked")})}),setTimeout(()=>{let y=x.querySelector(".cw-radio-option.info");y&&y.classList.add("checked")},100);let u=x.querySelector("#cw-bc-cancel"),v=x.querySelector("#cw-bc-close-x"),d=x.querySelector("#cw-bc-send");u.onclick=H,v.onclick=H,d.onclick=z,l.appendChild(x)}function j(u=null){if(!x)return;let v=x.querySelector("#cw-editor-title-label"),d=x.querySelector("#cw-bc-title"),y=x.querySelector("#cw-bc-text"),B=x.querySelector("#cw-bc-send");if(u){o=u.id,v.textContent="Editar Aviso",d.value=u.title||"",y.value=u.text||"",B.textContent="Salvar Altera\xE7\xF5es";let q=u.type||"info",G=x.querySelector(`input[name="cw-bc-type"][value="${q}"]`);G&&G.click()}else{o=null,v.textContent="Novo Aviso",d.value="",y.value="",B.textContent="Publicar";let q=x.querySelector('input[name="cw-bc-type"][value="info"]');q&&q.click()}x.classList.add("active"),setTimeout(()=>d.focus(),300)}function H(){x&&x.classList.remove("active"),o=null}async function z(){let u=x.querySelector("#cw-bc-send"),v=x.querySelector("#cw-bc-title"),d=x.querySelector("#cw-bc-text"),y=x.querySelector('input[name="cw-bc-type"]:checked'),B=y?y.value:"info";if(!v.value.trim()||!d.value.trim()){W("Preencha todos os campos!",{error:!0});return}u.textContent="Salvando...",u.style.opacity="0.7";let q=!1;o?q=await ke.updateBroadcast(o,{title:v.value,text:d.value,type:B}):q=await ke.sendBroadcast({title:v.value,text:d.value,type:B,author:window._cwCurrentUser||"admin"}),q?(W(o?"Atualizado!":"Publicado!"),K.playSuccess(),H(),setTimeout(()=>E(),1500)):(W("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),u.textContent=o?"Salvar Altera\xE7\xF5es":"Publicar",u.style.opacity="1")}async function w(u){if(confirm("Confirma a exclus\xE3o deste aviso?"))if(await ke.deleteBroadcast(u)){W("Aviso removido."),K.playClick();let d=Ue.findIndex(y=>y.id===u);d>-1&&Ue.splice(d,1),O(),setTimeout(()=>E(),1500)}else W("Erro ao excluir.",{error:!0})}let C=document.createElement("div");C.className="cw-nice-scroll",Object.assign(C.style,s.feedContainer),l.appendChild(C);async function E(){t&&(A.style.display="block",A.innerHTML="\u{1F504} Sincronizando...");try{let u=await ke.fetchData();u&&u.broadcast&&(Jt(u.broadcast),T(),t&&(O(),A.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{A.style.display="none"},1500)))}catch{t&&(A.innerHTML="\u26A0\uFE0F Offline")}}function T(){let u=document.getElementById("cw-btn-broadcast");if(!u)return;let v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Ue.some(y=>!v.includes(y.id))){if(u.classList.add("has-new"),!u.querySelector(".cw-badge")){let y=document.createElement("div");y.className="cw-badge",Object.assign(y.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),u.appendChild(y)}}else{u.classList.remove("has-new");let y=u.querySelector(".cw-badge");y&&y.remove()}}function O(){C.innerHTML="";let u=l.querySelector("#cw-bau-widget");u&&u.remove();let v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),d=[...Ue].sort((k,L)=>{let D=new Date(k.date).getTime()||0;return(new Date(L.date).getTime()||0)-D}),y=d.findIndex(k=>k.title&&k.title.toLowerCase().includes("disponibilidade bau"));if(y!==-1){let k=d[y];d.splice(y,1);let L=document.createElement("div");L.id="cw-bau-widget",Object.assign(L.style,s.bauContainer);let D=[],V=(k.text||"").split(`
`),I=/\d{1,2}\/\d{1,2}/,$="\u{1F4C5}";if(V.forEach(ie=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(ie)?$="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(ie)&&($="\u{1F1EA}\u{1F1F8}");let ye=ie.match(I);if(ye){let ue=ye[0],Z=$;/🇧🇷|🇵🇹|PT|BR/i.test(ie)?Z="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(ie)&&(Z="\u{1F1EA}\u{1F1F8}"),D.some(ce=>ce.flag===Z&&ce.date===ue)||D.push({flag:Z,date:ue})}}),D.length===0){let ie=(k.text||"").match(/\d{1,2}\/\d{1,2}/g);ie&&[...new Set(ie)].forEach(ye=>D.push({flag:"\u{1F4C5}",date:ye}))}let J="",fe='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(fe=`
        ...
        `,G.appendChild(k),G.appendChild(L),T.appendChild(G);let D=document.createElement("div");D.id="cw-planner-status",Object.assign(D.style,l.statusBadge),T.appendChild(D);let V=document.createElement("div");Object.assign(V.style,{padding:"0 4px",marginTop:"12px"});let I=document.createElement("div");I.textContent="Arraste para simular o hor\xE1rio:",I.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let $=document.createElement("div");Object.assign($.style,l.timelineContainer);let J=document.createElement("div");Object.assign(J.style,l.timelineTrack);let fe=document.createElement("div");Object.assign(fe.style,l.dayZone),J.appendChild(fe);let be=document.createElement("input");be.type="range",be.min="0",be.max="1439",be.step="15",be.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let Ee=document.createElement("div");Ee.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",Ee.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",$.appendChild(J),$.appendChild(be),$.appendChild(Ee),V.appendChild(I),V.appendChild($),T.appendChild(V);let ie=k.querySelector("#cw-time-input-br"),ye=L.querySelector("#cw-time-display-client"),ue=L.querySelector("#cw-client-label");function Z(){let de=Qt.find(Me=>Me.id===o);ue.textContent=`${de.flag} ${de.label} (${de.zone})`;let ce=r.getHours(),Ne=r.getMinutes(),Ie=`${String(ce).padStart(2,"0")}:${String(Ne).padStart(2,"0")}`;ie.value=Ie,be.value=ce*60+Ne;let we=r.toLocaleTimeString("pt-BR",{timeZone:de.zone,hour:"2-digit",minute:"2-digit"});ye.textContent=we;let Re=parseInt(we.split(":")[0]);Re>=9&&Re<17?(D.style.background=c.successBg,D.style.color=c.success,D.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):Re>=8&&Re<9||Re>=17&&Re<19?(D.style.background=c.warningBg,D.style.color=c.warning,D.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(D.style.background=c.errorBg,D.style.color=c.error,D.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}be.oninput=de=>{let ce=parseInt(de.target.value);r.setHours(Math.floor(ce/60)),r.setMinutes(ce%60),Z()},ie.oninput=de=>{let[ce,Ne]=de.target.value.split(":");ce&&Ne&&(r.setHours(parseInt(ce)),r.setMinutes(parseInt(Ne)),Z())},Z()}function U(){_(),n||(n=setInterval(_,6e4))}function u(){n&&(clearInterval(n),n=null)}function v(){t=!t,Le(t,p,"cw-btn-timezone"),t?O("live"):u()}return document.body.appendChild(p),v}function fn(){if(window.techSolInitialized){Ht();return}window.techSolInitialized=!0;let e="v5.1";console.log(`\u{1F680} TechSol Suite Initializing (${e})...`);try{go();try{K.initGlobalListeners(),K.playStartup()}catch(r){console.warn("\xC1udio bloqueado:",r)}ke.fetchTips(),Ht();let t=No(),n=Ro(),o=Do(),i=Bo(),s=Vo(),a=Go();To({toggleNotes:t,toggleEmail:n,toggleScript:o,toggleLinks:i,toggleTimezone:s,broadcastControl:a}),setTimeout(()=>{ke.logEvent("App","Start","Session Start"),Po(),setTimeout(()=>{Ho(e)},500)},2500)}catch(t){console.error("Erro fatal na inicializa\xE7\xE3o:",t),W("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}fn();})();

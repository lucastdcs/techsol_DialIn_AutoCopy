    ...
    `,document.head.appendChild(e)}function Ie(e,t,n){let o=document.getElementById(n);if(!t)return;let s=t.getAttribute("data-moved")==="true",i={x:0,y:0};if(o){let m=o.getBoundingClientRect();i.x=m.left+m.width/2,i.y=m.top+m.height/2}let a,r;if(!s)a=window.innerWidth/2,r=window.innerHeight/2;else{let m=t.getBoundingClientRect();a=m.left+m.width/2,r=m.top+m.height/2,a===0&&r===0&&(a=window.innerWidth/2,r=window.innerHeight/2)}let p=i.x-a,d=i.y-r;e?(Y.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",s?t.style.transform=`translate(${p}px, ${d}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${d}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",s?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(t,n)):(Y.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",s?t.style.transform=`translate(${p}px, ${d}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${d}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Bt=="function"&&Bt(t))}function go(e,t){Bt(e);let n=o=>{if(!e.classList.contains("open"))return;let s=e.contains(o.target),i=document.querySelector(".cw-pill"),a=i&&i.contains(o.target);s?(e.classList.remove("idle"),e.style.zIndex="2147483648"):a||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function Bt(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var Po="https://script.google.com/a/macros/google.com/s/AKfycbxFxh1cVk6r0t_JTA2TBfHBLJe_mOBQFsidwL1jwsUDcBtQYk3afu25SN-FR3vafJChHw/exec",Pt="cw_data_broadcast",bo="cw_data_tips",jo=["Processando...","Mantenha o foco!","Aguarde..."];function yt(e,t={}){return new Promise((n,o)=>{let s="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script");window[s]=p=>{document.body.contains(i)&&document.body.removeChild(i),delete window[s],n(p)};let a=Object.keys(t).map(p=>encodeURIComponent(p)+"="+encodeURIComponent(t[p])).join("&"),r=`${Po}?op=${e}&callback=${s}&t=${Date.now()}&${a}`;i.src=r,i.onerror=()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[s],o(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(i)})}var we={fetchTips:async()=>{try{let e=await yt("tips");e?.tips&&localStorage.setItem(bo,JSON.stringify(e.tips))}catch(e){console.warn("Tips offline",e)}},fetchData:async()=>{try{let e=await yt("broadcast");if(e?.broadcast)return localStorage.setItem(Pt,JSON.stringify(e.broadcast)),e}catch(e){console.warn("Broadcast offline",e)}return{broadcast:JSON.parse(localStorage.getItem(Pt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Pt)||"[]"),getRandomTip:()=>{let e=jo,t=localStorage.getItem(bo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},sendBroadcast:async e=>{let t={...e,date:new Date().toISOString(),id:Date.now().toString()};return await we._performOp("new_broadcast",t)},updateBroadcast:async(e,t)=>{let n={id:e,...t};return await we._performOp("update_broadcast",n)},deleteBroadcast:async e=>await we._performOp("delete_broadcast",{id:e}),_performOp:async(e,t)=>{try{console.log(`\u{1F4E4} Executando ${e}...`,t);let n=await yt(e,t);return n&&n.status==="success"?(console.log("\u2705 Sucesso:",e),!0):(console.warn("\u26A0\uFE0F Falha:",n),!1)}catch(n){return console.error("\u274C Erro JSONP:",n),!1}},logEvent:(e,t,n="",o=null)=>{try{let s="anon";try{let a=bt();a&&(s=a.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:s,version:"v4.5.1",category:e,action:t,label:n,value:o||""};yt("log",i).catch(a=>{})}catch(s){console.warn("Analytics error",s)}},logUsage:()=>{}};var pe={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},vt=e=>new Promise(t=>setTimeout(t,e));function fo(e){let t="cw-command-center-style";if(!document.getElementById(t)){let b=document.createElement("style");b.id=t,b.innerHTML=`
            ...
            .cw-pill {
                ...
                transition: opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1),
                            ...
                            padding 0.4s ease;
                min-width: 50px; /* Garante tamanho m\xEDnimo */
            }
            ...
            /* \xCDcone Principal (S\xF3 aparece quando colapsado) */
            .cw-main-logo {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let m=r.querySelector(".cw-hero-grid"),c=r.querySelector(".cw-acc-container"),g=r.querySelector(".cw-results-container"),b=r.querySelector(".cw-search-input"),u=r.querySelector(".cw-status-bar"),A=r.querySelector(".cw-status-text"),_=r.querySelector(".cw-footer-icons");s.forEach(([E,S])=>{let O=o(S.name),D=document.createElement("div");D.className="cw-hero-card",D.id=`hero-${E}`,D.style.setProperty("--hero-color",O.color),D.innerHTML=`
        ...
        `,D.onclick=M=>{if(M.target.closest(".cw-step-btn"))return;let L=t[E]?t[E].count:0;B(E,L>0?-L:1,S)},D.querySelector(".minus").onclick=()=>B(E,-1,S),D.querySelector(".plus").onclick=()=>B(E,1,S),D.dataset.color=O.color,m.appendChild(D)});function G(E,S){let O=o(S.name),D=document.createElement("div");return D.className="cw-task-item",D.dataset.id=E,D.innerHTML=`
        ...
        `};function s(h,F,l="text",v=""){let w=document.createElement("div");w.style.cssText=o.inputWrapper;let f=document.createElement("label");f.style.cssText=o.label,f.textContent=F;let C;l==="textarea"?(C=document.createElement("textarea"),C.style.cssText=o.input+o.textarea):(C=document.createElement("input"),C.type=l,C.style.cssText=o.input);let q=C.style.cssText;return C.onfocus=()=>C.style.cssText=q+o.inputFocus,C.onblur=()=>C.style.cssText=q,C.id=`st-${h}`,C.placeholder=v,w.appendChild(f),w.appendChild(C),{wrapper:w,input:C}}function i(h,F){let l=document.createElement("div"),v=document.createElement("label");v.style.cssText=o.label,v.textContent=F,l.appendChild(v);let w=document.createElement("div");return w.style.cssText=o.radioGroup,["Yes","No"].forEach(f=>{let C=document.createElement("label");C.style.cssText=o.radioLabel;let q=document.createElement("input");q.type="radio",q.name=`st-${h}`,q.value=f==="Yes"?"Y":"N",q.style.display="none",f==="No"&&(q.checked=!0),C.onmousedown=()=>C.style.transform="scale(0.96)",C.onmouseup=()=>C.style.transform="scale(1)",C.onmouseleave=()=>C.style.transform="scale(1)",C.appendChild(q),C.appendChild(document.createTextNode(f)),q.addEventListener("change",()=>{w.querySelectorAll("label").forEach(j=>j.style.cssText=o.radioLabel),q.checked&&(C.style.cssText=o.radioLabel+o.radioActive)}),f==="No"&&(C.style.cssText=o.radioLabel+o.radioActive),w.appendChild(C)}),l.appendChild(w),{wrapper:l}}let a=document.createElement("div");a.style.cssText=o.banner,a.innerHTML=`
    ...
    `,n.appendChild(a);let r=document.createElement("button");r.style.cssText=o.magicBtn,r.innerHTML='<span style="font-size:16px">\u2728</span> Preencher Automaticamente',r.onmouseover=()=>r.style.backgroundColor="#F8F9FA",r.onmouseout=()=>r.style.backgroundColor="#FFFFFF",r.onmousedown=()=>r.style.transform="scale(0.98)",r.onmouseup=()=>r.style.transform="scale(1)",n.appendChild(r);let p=document.createElement("div");p.style.cssText=o.sectionTitle,p.style.marginTop="24px",p.innerHTML="<span>\u{1F6E0}\uFE0F</span> Dados T\xE9cnicos",n.appendChild(p);let d=s("cid","Ads CID","text","000-000-0000"),m=s("ga4","GA4 ID"),c=s("gtm","GTM ID"),g=i("access","Advertiser has access to GA4/GTM?"),b=s("access-email","If Yes, User Email"),u=i("ghost","Ghosting Access Available?");n.append(d.wrapper,m.wrapper,c.wrapper,g.wrapper,b.wrapper,u.wrapper);let A=document.createElement("div");A.style.cssText=o.sectionTitle,A.innerHTML="<span>\u{1F4DE}</span> Contato & Problema",n.appendChild(A);let _=s("name","Name of Advertiser"),G=s("url","Website Address"),B=s("phone","Phone Number"),Z=s("email","Email Address"),se=s("callback","Preferred Call Back Time (w/ Timezone)"),E=s("desc","Detailed Issue Description","textarea","Descreva o problema t\xE9cnico em detalhes..."),S=s("checks","Checks Performed by Tech Team","textarea","Liste o troubleshooting j\xE1 realizado..."),O=s("screens","Uncropped Screenshots (Links)","textarea","https://...");n.append(_.wrapper,G.wrapper,B.wrapper,Z.wrapper,se.wrapper,E.wrapper,S.wrapper,O.wrapper);let D=document.createElement("div");D.style.cssText=o.sectionTitle,D.innerHTML="<span>\u{1F4E7}</span> Contatos para C\xF3pia (CC)",n.appendChild(D);let M=s("c-adv","Advertiser Contact"),L=s("c-am","Account Manager");n.append(M.wrapper,L.wrapper);let k=document.createElement("div");k.style.cssText="padding: 16px 24px; background: rgba(255,255,255,0.9); backdrop-filter: blur(8px); border-top: 1px solid #E0E0E0; display: flex; justify-content: flex-end; position: absolute; bottom: 0; left: 0; width: 100%; box-sizing: border-box; z-index: 100;";let x=document.createElement("button");return x.textContent="Gerar Nota S&T",x.style.cssText="padding: 10px 24px; background: #1a73e8; color: #fff; border: none; border-radius: 24px; font-size: 14px; font-weight: 600; cursor: pointer; box-shadow: 0 2px 6px rgba(26, 115, 232, 0.3); transition: transform 0.1s, box-shadow 0.2s;",x.onmousedown=()=>{x.style.transform="scale(0.96)",x.style.boxShadow="0 1px 3px rgba(26, 115, 232, 0.2)"},x.onmouseup=()=>{x.style.transform="scale(1)",x.style.boxShadow="0 2px 6px rgba(26, 115, 232, 0.3)"},k.appendChild(x),t.appendChild(n),t.appendChild(k),r.onclick=async()=>{r.innerHTML='<span style="font-size:16px">\u23F3</span> Buscando...';let h=await it();h.advertiserName&&(_.input.value=h.advertiserName),h.websiteUrl&&(G.input.value=h.websiteUrl),h.clientEmail&&(Z.input.value=h.clientEmail,M.input.value=h.clientEmail);let l=document.body.innerText.match(/\d{3}-\d{3}-\d{4}/);l&&(d.input.value=l[0]),r.innerHTML='<span style="font-size:16px; color:#188038">\u2705</span> Dados Preenchidos!',r.style.background="#E6F4EA",r.style.borderColor="#188038",setTimeout(()=>{r.innerHTML='<span style="font-size:16px">\u2728</span> Preencher Automaticamente',r.style.background="#FFFFFF",r.style.borderColor="#DADCE0"},2e3),V("Dados capturados com sucesso!")},x.onclick=async()=>{let h=f=>{let C=t.querySelector(`#st-${f}`);return C?C.value:""},F=f=>{let C=t.querySelector(`input[name="st-${f}"]:checked`);return C?C.value:"N"},v=`Split & Transfer : Phone Note Format [Mandatory]

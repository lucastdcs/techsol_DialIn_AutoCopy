...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
  ...
  `;let u=document.createElement("div");u.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let f=document.createElement("label");f.className="cw-input-label",f.textContent="Sub-status",f.style.marginBottom="0";let T=document.createElement("a");T.href="https://seu-link-do-guia-aqui.com",T.target="_blank",T.className="cw-info-link",T.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(T.style,i.helpLink),u.appendChild(f),u.appendChild(T);let C=document.createElement("select");C.id="sub-status",C.className="cw-select",C.disabled=!0,C.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',y.appendChild(r),y.appendChild(d),y.appendChild(u),y.appendChild(C),p.appendChild(y);let z=document.createElement("div");z.id="step-1-1-portugal",Object.assign(z.style,i.stepBlock,{display:"none"});let N=document.createElement("label");Object.assign(N.style,i.label),z.appendChild(N);let k=document.createElement("div");Object.assign(k.style,i.radioContainer);let I=document.createElement("div");Object.assign(I.style,{display:"flex",alignItems:"center"});let j=document.createElement("input");j.type="radio",j.name="portugal-group",j.value="sim",Object.assign(j.style,i.checkboxInput);let X=document.createElement("label");X.htmlFor="portugal-sim",Object.assign(X.style,{cursor:"pointer"}),I.appendChild(j),I.appendChild(X);let R=document.createElement("div");Object.assign(R.style,{display:"flex",alignItems:"center"});let Z=document.createElement("input");Z.type="radio",Z.name="portugal-group",Z.value="nao",Z.checked=!0,Object.assign(Z.style,i.checkboxInput);let re=document.createElement("label");re.htmlFor="portugal-nao",Object.assign(re.style,{cursor:"pointer"}),R.appendChild(Z),R.appendChild(re),k.appendChild(I),k.appendChild(R),z.appendChild(k),p.appendChild(z);function F(E){o=E,E?W.style.display="block":W.style.display="none"}j.onchange=()=>F(!0),Z.onchange=()=>F(!1);let W=document.createElement("div");W.id="step-1-2-consent",Object.assign(W.style,i.stepBlock,{display:"none"});let oe=document.createElement("label");Object.assign(oe.style,i.label),W.appendChild(oe);let _=document.createElement("div");Object.assign(_.style,i.radioContainer);let Q=document.createElement("div");Object.assign(Q.style,{display:"flex",alignItems:"center"});let xe=document.createElement("input");xe.type="radio",xe.name="consent-group",xe.value="Sim",xe.checked=!0,Object.assign(xe.style,i.checkboxInput);let ce=document.createElement("label");ce.htmlFor="consent-sim",Object.assign(ce.style,{cursor:"pointer"}),Q.appendChild(xe),Q.appendChild(ce);let ne=document.createElement("div");Object.assign(ne.style,{display:"flex",alignItems:"center"});let Oe=document.createElement("input");Oe.type="radio",Oe.name="consent-group",Oe.value="N\xE3o",Object.assign(Oe.style,i.checkboxInput);let Re=document.createElement("label");Re.htmlFor="consent-nao",Object.assign(Re.style,{cursor:"pointer"}),ne.appendChild(Oe),ne.appendChild(Re),_.appendChild(Q),_.appendChild(ne),W.appendChild(_),p.appendChild(W);let Le=document.createElement("div");Le.id="step-1-5-snippets",Object.assign(Le.style,i.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,i.h3),nt.textContent="Cen\xE1rios Comuns";let we=so(E=>{let D=document.querySelector("textarea");D&&(D.value=E,D.dispatchEvent(new Event("input")),D.style.transition="background-color 0.2s",D.style.backgroundColor="#e8f0fe",setTimeout(()=>D.style.backgroundColor="#fff",300))});we.id="snippet-container",Le.appendChild(nt),Le.appendChild(we),p.appendChild(Le);let ye=document.createElement("div");ye.id="step-3-form",Object.assign(ye.style,i.stepBlock,{display:"none"});let mt=document.createElement("h3");Object.assign(mt.style,i.h3),ye.appendChild(mt);let Me=document.createElement("div");Me.id="dynamic-form-fields-container",ye.appendChild(Me);let ge=document.createElement("button");ge.textContent="+ Gostaria de selecionar uma task?",Object.assign(ge.style,i.optionalBtn),ge.onmouseover=()=>ge.style.background="#e8f0fe",ge.onmouseout=()=>ge.style.background="white",ge.onclick=()=>{ge.style.display="none",Fe.style.display="block",l.selectionElement.style.display="block"};let Fe=document.createElement("h3");Object.assign(Fe.style,i.h3,{marginTop:"20px"});let _t=l.selectionElement;Object.assign(_t.style,{marginBottom:"20px"}),ye.appendChild(ge),ye.appendChild(Fe),ye.appendChild(_t),ye.appendChild(a.element),ye.appendChild(l.screenshotsElement),p.appendChild(ye);let De=document.createElement("div");De.id="step-4-email",Object.assign(De.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let ze=document.createElement("input");ze.type="checkbox",ze.checked=!0,Object.assign(ze.style,i.checkboxInput),Ge.appendChild(ze),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),De.appendChild(Ge),p.appendChild(De);let We=document.createElement("div");Object.assign(We.style,{display:"none",gap:"8px",padding:"0"}),p.appendChild(We);let Ke=document.createElement("button");Object.assign(Ke.style,i.buttonBase,{backgroundColor:"#5f6368"}),Ke.textContent="Copiar";let Qe=document.createElement("button");Object.assign(Qe.style,i.buttonBase,{backgroundColor:"#1a73e8"}),Qe.textContent="Preencher",We.appendChild(Ke),We.appendChild(Qe);let Ze=document.createElement("div");Object.assign(Ze.style,Ye),Ze.className="no-drag",Ze.title="Redimensionar",m.appendChild(Ze),Xe(m,Ze),document.body.appendChild(m);function gt(E){t=E;let D=Je();Object.assign(x.style,fe),Object.assign(b.style,fe),E==="bau"?(Object.assign(x.style,D),T.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(b.style,D),T.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),C.value&&C.dispatchEvent(new Event("change"))}function H(E){try{if(Ne&&Ne[n]&&Ne[n][E])return Ne[n][E];if(Ne&&Ne.pt&&Ne.pt[E])return Ne.pt[E]}catch{}return E}function vo(){w.textContent=H("idioma"),U.textContent=H("fluxo"),r.textContent=H("status_principal"),f.textContent=H("substatus"),nt.textContent=H("cenarios_comuns"),Fe.textContent=H("selecione_tasks"),mt.textContent=H("preencha_detalhes"),Ke.textContent=H("copiar"),Qe.textContent=H("preencher"),d.querySelector('option[value=""]')&&(d.querySelector('option[value=""]').textContent=H("select_status")),C.querySelector('option[value=""]')&&(C.querySelector('option[value=""]').textContent=H("select_substatus")),N.textContent=H("caso_portugal"),X.textContent=H("sim"),re.textContent=H("nao"),oe.textContent=H("consentiu_gravacao"),ce.textContent=H("sim"),Re.textContent=H("nao"),Me.querySelectorAll("label").forEach(E=>{let D=E.nextElementSibling.id.replace("field-",""),O=H(D.toLowerCase());O!==D.toLowerCase()?E.textContent=O:E.textContent=D.replace(/_/g," ").replace(/\b\w/g,V=>V.toUpperCase())+":"}),ge.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function bt(E){n=E;let D=Je();Object.assign(S.style,fe),Object.assign(q.style,fe),E==="pt"?(Object.assign(S.style,D),z.style.display="block",F(o)):(Object.assign(q.style,D),z.style.display="none",W.style.display="none"),vo(),C.value&&C.dispatchEvent(new Event("change"))}function ft(E){(E.value.trim()===""||E.value.trim()==="\u2022")&&(E.value="\u2022 "),E.onkeydown=function(D){if(D.key==="Enter"){D.preventDefault();let O=this.selectionStart,V=this.selectionEnd,se=this.value,pe=se.lastIndexOf(`
`,O-1)+1,ve=se.substring(pe,O),ue=ve.trim()==="\u2022"||ve.trim()===""?`
`:`
\u2022 `;this.value=se.substring(0,O)+ue+se.substring(V),this.selectionStart=this.selectionEnd=O+ue.length}else if(D.key==="Backspace"){let O=this.selectionStart;if(O===this.selectionEnd&&O>0){let V=this.value.substring(0,O);V.endsWith(`
\u2022 `)?(D.preventDefault(),this.value=V.substring(0,O-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=O-3):V==="\u2022 "&&(D.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function ht(){let E=typeof we<"u"?we:document.getElementById("snippet-container");if(!E)return;let D=E.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),O={},V=new Set;D.forEach(J=>{let K=J.id,G=Se[K];if(G)for(let M in G)M==="linkedTask"?V.add(G.linkedTask):M!=="type"&&(O[M]||(O[M]=[]),O[M].includes(G[M])||O[M].push(G[M]))});let se=new Set;Object.values(Se).forEach(J=>{Object.keys(J).forEach(K=>{K!=="linkedTask"&&K!=="type"&&se.add(K)})}),se.forEach(J=>{let K=document.getElementById(J);if(K){let G=O[J]||[],M="";ot.includes(J.replace("field-",""))?(M=G.map(Y=>Y.startsWith("\u2022 ")?Y:"\u2022 "+Y).join(`
`),M===""?M="\u2022 ":M.endsWith(`
\u2022 `)||(M+=`
\u2022 `)):M=G.join(`

`),M.trim()!=="\u2022"&&M.trim()!==""?K.value=M:ot.includes(J.replace("field-",""))?K.value="\u2022 ":K.value="",K.tagName==="TEXTAREA"&&typeof ft=="function"&&ft(K)}});let pe=new Set,ve=new Set;E.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(J=>{let K=Se[J.id];K&&K.linkedTask&&(J.checked?pe.add(K.linkedTask):ve.add(K.linkedTask))}),ve.forEach(J=>{pe.has(J)||l.toggleTask(J,!1)}),pe.forEach(J=>{l.toggleTask(J,!0)})}d.onchange=()=>{let E=d.value;if(xt(1.5),C.innerHTML=`<option value="">${H("select_substatus")}</option>`,!E){C.disabled=!0;return}for(let D in tt){let O=tt[D];if(O.status===E){let V=document.createElement("option");V.value=D,V.textContent=O.name,C.appendChild(V)}}C.disabled=!1},C.onchange=()=>{let E=C.value;if(xt(1.5),!E)return;l.updateSubStatus(E);let D=tt[E];we.innerHTML="";let O=(G,M,Y)=>{let de=document.createElement("label");Object.assign(de.style,i.checkboxLabel),de.onmouseover=()=>de.style.backgroundColor="#e8eaed",de.onmouseout=()=>de.style.backgroundColor="#f8f9fa";let ae=document.createElement("input");return ae.type=M,ae.id=G.id,Object.assign(ae.style,i.checkboxInput),de.appendChild(ae),de.appendChild(document.createTextNode(` ${G.text}`)),Y.appendChild(de),ae},V=[],se="radio";if(E==="NI_Awaiting_Inputs")V=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(E.startsWith("SO_"))se="checkbox",V=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(E.startsWith("AS_")){se="checkbox";let G=document.createElement("label");G.textContent=H("cenarios_comuns"),Object.assign(G.style,i.label),we.appendChild(G),V=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else E.startsWith("IN_")?V=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:E.startsWith("DC_")&&(se="radio",V=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let pe=V.filter(G=>{let M=Se[G.id];return!M.type||M.type==="all"||M.type===t});pe.forEach((G,M)=>{let Y=O(G,se,we);se==="radio"&&(Y.name="scenario-radio-group",M===0&&(Y.checked=!0))}),pe.length>0&&(Le.style.display="block"),D.requiresTasks?(ge.style.display="none",Fe.style.display="block",l.selectionElement.style.display="block"):(ge.style.display="block",Fe.style.display="none",l.selectionElement.style.display="none"),Me.innerHTML="";let ve=D.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(ve)].forEach(G=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(G))return;let M=G.slice(1,-1),Y=document.createElement("label"),de=H(M.toLowerCase());if(Y.textContent=de!==M.toLowerCase()?de:M.replace(/_/g," ").replace(/\b\w/g,P=>P.toUpperCase())+":",Object.assign(Y.style,i.label),M==="SPEAKEASY_ID"){let P=document.createElement("button");P.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',P.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,P.title="Localizar Speakeasy ID no hist\xF3rico",P.onmouseover=()=>{P.style.backgroundColor="#c2e7ff",P.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},P.onmouseout=()=>{P.style.backgroundColor="#d3e3fd",P.style.boxShadow="none"},P.onmousedown=()=>{P.style.backgroundColor="#a8c7fa",P.style.transform="scale(0.96)"},P.onmouseup=()=>P.style.transform="scale(1)",P.onclick=be=>{be.preventDefault(),Qt(`field-${M}`)},Y.appendChild(P)}let ae;ot.includes(M)?(ae=document.createElement("textarea"),Object.assign(ae.style,i.textarea),ae.classList.add("bullet-textarea"),ft(ae)):Tt.includes(M)?(ae=document.createElement("textarea"),Object.assign(ae.style,i.textarea)):(ae=document.createElement("input"),ae.type="text",Object.assign(ae.style,i.input),M==="REASON_COMMENTS"&&(E.startsWith("NI_")||E.startsWith("IN_"))&&(Object.assign(Y.style,{display:"none"}),Object.assign(ae.style,{display:"none"}))),M==="ON_CALL"&&t==="lm"&&(Object.assign(Y.style,{display:"none"}),Object.assign(ae.style,{display:"none"}),ae.value="N/A"),ae.id=`field-${M}`,Me.appendChild(Y),Me.appendChild(ae)});let J=we.querySelectorAll('input[type="checkbox"], input[type="radio"]');J.length>0&&(J.forEach(G=>{G.removeEventListener("change",ht),G.addEventListener("change",ht)}),ht()),ye.style.display="block",je[E]?De.style.display="block":De.style.display="none",We.style.display="flex";let K=l.getCheckedElements().map(G=>G.value);a.updateVisibility(E,K)},ge.onclick=()=>{ge.style.display="none",Fe.style.display="block",l.selectionElement.style.display="block"};function Rt(){let E=C.value;if(!E)return null;let O=tt[E].template.replace(/\n/g,"<br>"),V='style="margin-bottom: 12px; padding-left: 30px;"',se=[],pe="",ve=l.getCheckedElements();ve.length>0&&ve.forEach(K=>{let G=K.value,M=_e[G],Y=K.closest().querySelector(".stepper-count"),de=Y?parseInt(Y.textContent):1;de>1?se.push(`${M.name} (x${de})`):se.push(M.name)});let ue=l.screenshotsElement;if(ue){let K=Array.from(ue.querySelectorAll('input[id^="name-"]'));K.length>0&&K.forEach(G=>{let M=G.value,Y=G.closest(".cw-screen-card");if(Y){let de=Y.querySelectorAll('input[id^="screen-"]'),ae=!1,P="";de.forEach(be=>{let Lt=be.closest(".cw-input-group"),Ft=Lt?Lt.querySelector(".cw-input-label"):null,wo=Ft?Ft.textContent:"Evid\xEAncia",Dt=be.value.trim(),Ao=Dt?` ${Dt}`:"";P+=`<li>${wo} -${Ao}</li>`,ae=!0}),ae&&(pe+=`<b>${M}</b>`,pe+=`<ul ${V}>${P}</ul>`)}})}if(O.includes("{TAGS_IMPLEMENTED}")?O=O.replace(/{TAGS_IMPLEMENTED}/g,se.join(", ")||"N/A"):se.length>0&&(O+=`<br><b>Tags:</b> ${se.join(", ")}<br>`),O.includes("{SCREENSHOTS_LIST}")?O=O.replace(/{SCREENSHOTS_LIST}/g,pe?`${pe}`:"N/A"):pe!==""&&(O+=`<br>${pe}`),n==="pt"&&o){let K=xe.checked?H("sim"):H("nao");O=O.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${H("consentiu_gravacao")}</b> ${K}<br><br>`),O=O.replace(/{CASO_PORTUGAL}/g,`<br><b>${H("caso_portugal")}</b> ${H("sim")}<br>`)}else n==="pt"&&!o?(O=O.replace(/{CASO_PORTUGAL}/g,`<br><b>${H("caso_portugal")}</b> ${H("nao")}<br>`),O=O.replace(/{CONSENTIU_GRAVACAO}/g,"")):(O=O.replace(/{CASO_PORTUGAL}/g,""),O=O.replace(/{CONSENTIU_GRAVACAO}/g,""));return Me.querySelectorAll("input, textarea").forEach(K=>{let G=K.id.replace("field-",""),M=new RegExp(`{${G}}`,"g"),Y=K.value;if(G==="REASON_COMMENTS"&&(E.startsWith("NI_")||E.startsWith("IN_"))){let P=we.querySelector('input[type="radio"]:checked');P&&Se[P.id]&&(Y=Se[P.id]["field-REASON_COMMENTS"])}if(ot.includes(G)&&Y.trim()!==""){let P=Y.split(`
`).map(be=>be.trim()).filter(be=>be!==""&&be!=="\u2022").map(be=>be.startsWith("\u2022 ")?be.substring(2):be).map(be=>`<li>${be}</li>`).join("");Y=P?`<ul ${V}>${P}</ul>`:""}else Tt.includes(G)?Y=Y.split(`
`).filter(P=>P.trim()!=="").map(P=>`<p style="margin: 0 0 8px 0;">${P}</p>`).join(""):K.tagName==="TEXTAREA"&&(Y=Y.replace(/\n/g,"<br>"));let de=Y.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(de===""||de==="\u2022"||de.toLowerCase()==="n/a"){let P=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${G}\\}(?:<br>\\s*)?`,"gi");P.test(O)?O=O.replace(P,""):O=O.replace(M,"")}else O=O.replace(M,Y.replace(/\$/g,"$$$$"))}),O=O.replace(/{([A-Z0-9_]+)}/g,""),O=O.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(O+=a.getOutput()),O}Ke.onclick=()=>{let E=Rt();E?(It(E),ie(H("copiado_sucesso"))):ie(H("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let E=C.value,D=Rt();if(!D){ie(H("selecione_substatus"),{error:!0});return}It(D),yt();let O=dt(),V=await po();if(V)try{if(V.focus(),V.innerHTML.trim()==="<p><br></p>"||V.innerHTML.trim()==="<br>"||V.innerText.trim()===""){let ue=document.createRange();ue.selectNodeContents(V);let J=window.getSelection();J.removeAllRanges(),J.addRange(ue),document.execCommand("delete",!1,null)}else if(!V.innerHTML.endsWith("<br><br>")){let ue=document.createRange();ue.selectNodeContents(V),ue.collapse(!1);let J=window.getSelection();J.removeAllRanges(),J.addRange(ue),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,D),co(V),setTimeout(()=>{ie(H("inserido_copiado"))},600);let pe=typeof ze<"u"&&ze?ze.checked:!0;if(E&&je[E]&&pe){let ue=je[E];await lt(ue),await new Promise(J=>setTimeout(J,500))}O(),xt(1.5),d.value="",C.innerHTML=`<option value="">${H("select_substatus")}</option>`,C.disabled=!0}catch(se){console.error(se),ie("Erro ao inserir.",{error:!0}),O()}};function xt(E=1.5){E<=1.5&&(Le.style.display="none",we.innerHTML=""),E<=2&&(l.reset(),ge.style.display="none"),E<=3&&(ye.style.display="none",Me.innerHTML="",a.reset(),We.style.display="none",De.style.display="none")}function yt(){if(s=!s,s){let E=m.querySelector(".cw-expand-btn");E&&typeof E.resetState=="function"&&E.resetState()}Te(s,m,"cw-btn-notes")}return gt("bau"),bt("pt"),yt}var $e={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
        ...
        `;let F=C.querySelector("#csa-back-btn");F.onmouseenter=()=>F.style.background="#f1f3f4",F.onmouseleave=()=>F.style.background="none",F.onclick=k;let W=C.querySelector("#csa-insert-btn");W.onmouseenter=()=>{W.style.transform="translateY(-1px)",W.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},W.onmouseleave=()=>{W.style.transform="translateY(0)",W.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},W.onclick=()=>{W.style.transform="scale(0.96)",z(R,"email"),setTimeout(()=>{W.style.transform="scale(1)",k()},300)}}function k(){s="list",b.style.transform="translateX(0)"}function I(R,Z,re=null){let F=document.createElement("button"),W=re?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${re}</span>`:"";return F.innerHTML=`${W}${R}`,Object.assign(F.style,v),n===Z&&o===""?Object.assign(F.style,w):(F.onmouseenter=()=>{F.style.background="#F1F3F4",F.style.borderColor="#DADCE0"},F.onmouseleave=()=>{F.style.background="#FFFFFF",F.style.borderColor="#DADCE0"}),F.onclick=()=>{n=Z,o="",d.value="",j(),X()},F}function j(){u.innerHTML="",u.appendChild(I("Smart CRs",t,"\u26A1")),Object.keys($e).forEach(R=>{u.appendChild(I($e[R].title,R))})}function X(){f.innerHTML="";let R=[];if(o.trim()!==""){let oe=o.toLowerCase();Object.values($e).forEach(_=>{_.emails.forEach(Q=>{(Q.name.toLowerCase().includes(oe)||Q.subject.toLowerCase().includes(oe))&&R.push({type:"email",data:Q})})}),Object.entries(je).forEach(([_,Q])=>{if(!Q)return;(_.replace(/_/g," ").toLowerCase().includes(oe)||Q.toLowerCase().includes(oe))&&R.push({type:"cr",key:_,code:Q})})}else n===t?Object.entries(je).forEach(([oe,_])=>{_&&R.push({type:"cr",key:oe,code:_})}):$e[n]&&$e[n].emails.forEach(oe=>{R.push({type:"email",data:oe})});if(R.length===0){f.innerHTML=`
                ...
                </div>`;return}let re='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1967D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',F='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA8600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',W='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BDC1C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';R.forEach(oe=>{let _=document.createElement("div");if(Object.assign(_.style,S),oe.type==="email"){let Q=oe.data,xe=Q.subject.length>45?Q.subject.substring(0,45)+"...":Q.subject;_.innerHTML=`
                ...
                `,_.onclick=()=>N(Q)}else{let Q=oe.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");_.innerHTML=`
                    ...
                    <div style="flex-grow:1; min-width:0; display:flex; flex-direction:column; gap:2px;">
                        ...
                        <div style="font-size:11px; font-weight:500; color:#EA8600; font-family:'Roboto Mono', monospace; letter-spacing:-0.2px;">${oe.code}</div>
                    </div>
  ...
  `,Object.assign(A.style,t.resetBtn),A.onmouseenter=()=>A.style.background="#fce8e6",A.onmouseleave=()=>A.style.background="transparent",A.onclick=()=>{A.style.transform="scale(0.9)",setTimeout(()=>A.style.transform="scale(1)",150);for(let T in n)delete n[T];r()},v.appendChild(w),v.appendChild(A),a.appendChild(v);let S=document.createElement("div");Object.assign(S.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let q=document.createElement("div");Object.assign(q.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let L=document.createElement("div");L.textContent="BAU";let U=document.createElement("div");U.textContent="LT",Object.assign(L.style,fe),Object.assign(U.style,fe),q.appendChild(L),q.appendChild(U);let te=document.createElement("select");Object.assign(te.style,Ut,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),te.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',te.value=o,S.appendChild(q),S.appendChild(te),g.appendChild(S);let x=document.createElement("div");x.id="csa-checklist-area",g.appendChild(x);let b=document.createElement("div");Object.assign(b.style,Ye),b.className="no-drag",b.title="Redimensionar",a.appendChild(b),Xe(a,b),document.body.appendChild(a);function y(T){return T}function r(){x.innerHTML="";let T=`${o} ${s}`,C=fo[T];if(!C){x.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,document.head.appendChild(r)}let i={critical:{bg:"#FEF2F2",border:"#FECACA",text:"#991B1B",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>'},info:{bg:"#EFF6FF",border:"#BFDBFE",text:"#1E40AF",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>'},success:{bg:"#F0FDF4",border:"#BBF7D0",text:"#166534",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>'}},a={feedContainer:{padding:"24px",overflowY:"auto",flexGrow:"1",background:"#FAFAFA",display:"flex",flexDirection:"column",gap:"20px"},card:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.06)",boxShadow:"0 4px 12px rgba(0,0,0,0.05), 0 1px 2px rgba(0,0,0,0.02)",overflow:"hidden",transition:"all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1)",position:"relative",width:"100%",boxSizing:"border-box",flexShrink:"0"},cardHistory:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.04)",boxShadow:"none",opacity:"0.8",filter:"grayscale(0.3)",marginBottom:"16px",flexShrink:"0"},cardHeader:{padding:"12px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid rgba(0,0,0,0.04)",fontSize:"12px",fontWeight:"600",letterSpacing:"0.5px",textTransform:"uppercase"},msgTitle:{padding:"20px 20px 8px 20px",fontSize:"16px",fontWeight:"700",color:"#202124",letterSpacing:"-0.01em",lineHeight:"1.4"},metaContainer:{padding:"0 20px 12px 20px",display:"flex",alignItems:"center",gap:"8px",fontSize:"12px",color:"#5f6368"},cardBody:{padding:"0 20px 24px 20px",fontSize:"14px",color:"#3c4043",lineHeight:"1.6",whiteSpace:"pre-wrap",fontFamily:"'Google Sans', Roboto, sans-serif",wordBreak:"break-word",overflowWrap:"break-word"},dismissBtn:{width:"28px",height:"28px",borderRadius:"50%",border:"1px solid rgba(0,0,0,0.1)",background:"#fff",color:"#5f6368",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s ease",marginLeft:"12px"},markAllBtn:{fontSize:"12px",color:"#1a73e8",cursor:"pointer",fontWeight:"600",background:"transparent",border:"none",padding:"8px",transition:"opacity 0.2s"},emptyState:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 0",color:"#bdc1c6",gap:"16px",textAlign:"center"},historyDivider:{display:"flex",alignItems:"center",justifyContent:"center",margin:"10px 0 20px 0",cursor:"pointer",color:"#1a73e8",fontSize:"13px",fontWeight:"500",gap:"8px",padding:"10px",borderRadius:"8px",transition:"background 0.2s"},historyContainer:{display:"none",flexDirection:"column",gap:"16px",paddingTop:"10px",borderTop:"1px dashed rgba(0,0,0,0.1)"},bauContainer:{margin:"16px 24px 0 24px",padding:"16px",background:"#F3E8FD",border:"1px solid #D8B4FE",borderRadius:"16px",display:"flex",flexDirection:"column",gap:"10px",position:"relative",flexShrink:"0",boxShadow:"0 2px 8px rgba(147, 51, 234, 0.08)"},bauHeader:{display:"flex",alignItems:"center",justifyContent:"space-between"},bauLabel:{fontSize:"11px",fontWeight:"800",color:"#7E22CE",textTransform:"uppercase",letterSpacing:"0.8px"},bauBody:{fontSize:"13px",color:"#581C87",lineHeight:"1.5",whiteSpace:"pre-wrap",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500"},liveIndicator:{display:"flex",alignItems:"center",gap:"8px"},pulseDot:{width:"8px",height:"8px",borderRadius:"50%",background:"#9333EA",boxShadow:"0 0 0 0 rgba(147, 51, 234, 0.7)",animation:"cw-pulse 2s infinite"}},l="cw-scrollbar-style";if(!document.getElementById(l)){let r=document.createElement("style");r.id=l,r.innerHTML=".cw-nice-scroll::-webkit-scrollbar { width: 5px; } .cw-nice-scroll::-webkit-scrollbar-track { background: transparent; } .cw-nice-scroll::-webkit-scrollbar-thumb { background-color: rgba(0,0,0,0.1); border-radius: 10px; }",document.head.appendChild(r)}function m(r){if(!r||typeof r!="string")return"";let d=r,u=/(https?:\/\/[^\s]+)|(www\.[^\s]+)/g;return d=d.replace(u,f=>{let T=f;return T.startsWith("http")||(T="http://"+T),`<a href="${T}" target="_blank" style="color:#1967d2; text-decoration:underline;">${f}</a>`}),d=d.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),d=d.replace(/_(.*?)_/g,"<i>$1</i>"),d=d.replace(/\n/g,"<br>"),d=Yt(d),d=d.replace(/@todos|@all/gi,'<span style="background:#e8f0fe; color:#1967d2; padding:1px 5px; border-radius:4px; font-weight:600; font-size:12px;">@todos</span>'),d}function h(r){return Object.entries(r).map(([d,u])=>`${d.replace(/[A-Z]/g,f=>"-"+f.toLowerCase())}:${u}`).join(";")}let c=document.createElement("div");c.id="broadcast-popup",c.classList.add("cw-module-window"),Object.assign(c.style,Ae,{right:"auto",left:"50%",width:"450px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let p={popup:c,googleLine:null};function g(){if(t=!t,Te(t,c,"cw-btn-broadcast"),t){let r=document.getElementById("cw-btn-broadcast");r&&r.classList.remove("has-new"),S()}}let v=Ee(c,"Operations Feed",e,"Atualiza\xE7\xF5es oficiais da opera\xE7\xE3o.",p,()=>g()),w=v.querySelector(".cw-header-actions")||v.lastElementChild;if(w){let r=document.createElement("button");r.textContent="Limpar tudo",Object.assign(r.style,a.markAllBtn),r.onclick=d=>{d.stopPropagation(),ee.playSuccess();let u=Ue.map(f=>f.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(u)),L(),q()},w.insertBefore(r,w.firstChild)}c.appendChild(v);let A=document.createElement("div");A.className="cw-nice-scroll",Object.assign(A.style,a.feedContainer),c.appendChild(A);async function S(){let r=document.getElementById("cw-update-status");t&&(r||(r=document.createElement("div"),r.id="cw-update-status",r.style.cssText="padding: 6px; text-align: center; font-size: 11px; color: #5f6368; background: #f8f9fa; border-bottom: 1px solid #e0e0e0;",A.parentNode.insertBefore(r,A)),r.innerHTML="\u23F3 Verificando atualiza\xE7\xF5es...",r.style.display="block");let d=Ue.map(f=>f.id),u=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");try{let f=await He.fetchData();f&&f.broadcast&&(t&&r&&(f.broadcast.some(C=>!d.includes(C.id))?(r.innerHTML="\u2705 Sincronizado.",r.style.backgroundColor="#e6f4ea",r.style.color="#137333"):r.innerHTML="\u{1F539} Tudo atualizado.",setTimeout(()=>{r&&(r.style.display="none")},1e3)),d.length>0&&f.broadcast.filter(z=>!d.includes(z.id)).filter(z=>!u.includes(z.id)).length>0&&(console.log("\u{1F514} Novo aviso detectado!"),ee.playNotification()),Mt(f.broadcast),q(),t&&L())}catch(f){console.error("Erro no update:",f),t&&r&&(r.innerHTML="\u26A0\uFE0F Falha na conex\xE3o.",r.style.backgroundColor="#fce8e6")}}function q(){let r=document.getElementById("cw-btn-broadcast");if(!r)return;let d=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Ue.some(f=>!d.includes(f.id))){if(r.classList.add("has-new"),!r.querySelector(".cw-badge")){let f=document.createElement("div");f.className="cw-badge",Object.assign(f.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),r.appendChild(f)}}else{r.classList.remove("has-new");let f=r.querySelector(".cw-badge");f&&f.remove()}}function L(){A.innerHTML="";let r=c.querySelector("#cw-bau-widget");r&&r.remove();let d=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),u=[...Ue].sort((k,I)=>{let j=new Date(k.date).getTime()||0;return(new Date(I.date).getTime()||0)-j}),f=u.findIndex(k=>k.title&&k.title.toLowerCase().includes("disponibilidade bau")),T=null;if(f!==-1&&(T=u[f],u.splice(f,1)),T){let k=document.createElement("div");k.id="cw-bau-widget",Object.assign(k.style,a.bauContainer),k.innerHTML=`
          ...
          `,v.after(k)}let C=u.sort((k,I)=>{let j=d.includes(k.id),X=d.includes(I.id);return j===X?0:j?1:-1});if(C.length===0&&!T){let k=document.createElement("div");Object.assign(k.style,a.emptyState),k.innerHTML=`
           ...
           `,A.appendChild(k)}let z=C.filter(k=>!d.includes(k.id)),N=C.filter(k=>d.includes(k.id));if(z.forEach(k=>A.appendChild(U(k,!1))),N.length>0){let k=document.createElement("div");Object.assign(k.style,a.historyDivider),k.innerHTML=`<span>Visualizar ${N.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let I=document.createElement("div");Object.assign(I.style,a.historyContainer),N.forEach(X=>I.appendChild(U(X,!0)));let j=!1;k.onclick=()=>{ee.playClick(),j=!j,I.style.display=j?"flex":"none",k.querySelector("svg").style.transform=j?"rotate(180deg)":"rotate(0deg)",k.querySelector("span").textContent=j?"Ocultar hist\xF3rico":`Visualizar ${N.length} avisos anteriores`},A.appendChild(k),A.appendChild(I)}}function U(r,d){let u=document.createElement("div");Object.assign(u.style,d?a.cardHistory:a.card);let f=i[r.type]||i.info,T=document.createElement("div");Object.assign(T.style,a.cardHeader,{background:f.bg,color:f.text,borderBottom:`1px solid ${f.border}`});let C=document.createElement("div");if(Object.assign(C.style,{display:"flex",alignItems:"center",gap:"6px"}),C.innerHTML=`${f.icon} <span>${r.type.toUpperCase()}</span>`,T.appendChild(C),d){let N=document.createElement("span");N.textContent=s(r.date),N.style.opacity="0.7",T.appendChild(N)}else{let N=document.createElement("button");N.title="Marcar como lido",Object.assign(N.style,a.dismissBtn),N.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',N.onmouseenter=()=>{N.style.color="#1e8e3e",N.style.background="#e6f4ea",N.style.borderColor="#1e8e3e"},N.onmouseleave=()=>{N.style.color="#5f6368",N.style.background="#fff",N.style.borderColor="rgba(0,0,0,0.1)"},N.onclick=k=>{k.stopPropagation(),ee.playClick(),u.style.transform="translateX(20px)",u.style.opacity="0",setTimeout(()=>{let I=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");I.push(r.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(I)),L(),q()},250)},T.appendChild(N)}if(u.appendChild(T),r.title){let N=document.createElement("div");Object.assign(N.style,a.msgTitle),N.textContent=r.title,u.appendChild(N)}if(!d){let N=document.createElement("div");Object.assign(N.style,a.metaContainer),N.innerHTML=`<span style="font-weight:600">${r.author}</span> \u2022 <span>${s(r.date)}</span>`,u.appendChild(N)}let z=document.createElement("div");return Object.assign(z.style,a.cardBody),z.innerHTML=m(r.text),u.appendChild(z),u}let te=He.getCachedBroadcasts();te.length>0&&(Mt(te),L()),S(),n||(n=setInterval(S,o));let x=document.createElement("div");Object.assign(x.style,Ye),x.className="no-drag",c.appendChild(x),Xe(c,x),document.body.appendChild(c);let b=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),y=Ue.some(r=>!b.includes(r.id));return{toggle:g,hasUnread:y}}function Ro(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Vt();try{ee.initGlobalListeners(),ee.playStartup()}catch(i){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",i)}He.fetchTips(),Et();let e=go(),t=bo(),n=ho(),o=xo(),s=yo();io({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:s})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),ie("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Ro();})();

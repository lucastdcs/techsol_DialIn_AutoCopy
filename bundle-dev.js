...
@keyframes googleBounce {
    ...
    `;let i=document.createElement("div");if(i.className="cw-focus-backdrop",document.body.appendChild(i),document.body.appendChild(o),o.querySelector(".notes").onclick=g=>{g.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=g=>{g.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=g=>{g.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=g=>{g.stopPropagation(),e.toggleLinks()},o.querySelector(".broadcast").onclick=g=>{g.stopPropagation();let b=g.currentTarget.querySelector(".cw-badge");b&&(b.style.transform="scale(0)",setTimeout(()=>b.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let g=document.createElement("div");g.className="cw-badge",o.querySelector(".broadcast").appendChild(g)}(async function(){await st(2800),o.classList.add("docked"),await st(300);let b=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(T=>T.classList.add("visible"));for(let T=0;T<b.length;T++)b[T].classList.add("popped"),await st(90);await st(200),o.classList.add("system-check")})();let r=!1,a,l,m,h,u=3;o.onmousedown=g=>{if(g.target.closest("button"))return;g.preventDefault(),a=g.clientX,l=g.clientY;let b=o.getBoundingClientRect();m=b.left,h=b.top,document.addEventListener("mousemove",c),document.addEventListener("mouseup",w)};function c(g){let b=g.clientX-a,y=g.clientY-l;!r&&Math.sqrt(b*b+y*y)>u&&(r=!0,o.style.transition="none"),r&&(o.style.left=`${m+b}px`,o.style.top=`${h+y}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function w(g){if(document.removeEventListener("mousemove",c),document.removeEventListener("mouseup",w),r){r=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let b=window.innerWidth,y=window.innerHeight,T=o.getBoundingClientRect(),q=T.left+T.width/2,_;q<b/2?(_=24,o.classList.remove("side-right"),o.classList.add("side-left")):(_=b-T.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let B=T.top;B<24&&(B=24),B>y-T.height-24&&(B=y-T.height-24),o.style.left=`${_}px`,o.style.top=`${B}px`}else{let b=g.target.closest("button");b&&(b.style.transform="scale(0.9)",setTimeout(()=>b.style.transform="",150))}}}function Xe(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let n=document.createElement("div");n.className="cw-center-stage",n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(f)}let l=document.createElement("div");l.className="cw-zen-container";let m=document.createElement("div");Object.assign(m.style,{display:"none"});let h=document.createElement("div");h.className="cw-screens-container",m.appendChild(h),l.innerHTML=`
    ...
    `;let u=l.querySelector(".cw-hero-grid"),c=l.querySelector(".cw-acc-container"),w=l.querySelector(".cw-results-container"),g=l.querySelector(".cw-search-input"),b=l.querySelector(".cw-status-bar"),y=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");i.forEach(([f,x])=>{let s=o(x.name),d=document.createElement("div");d.className="cw-hero-card",d.id=`hero-${f}`,d.style.setProperty("--hero-color",s.color),d.innerHTML=`
        ...
        `,d.onclick=S=>{if(S.target.closest(".cw-step-btn"))return;let p=t[f]?t[f].count:0;_(f,p>0?-p:1,x)},d.querySelector(".minus").onclick=()=>_(f,-1,x),d.querySelector(".plus").onclick=()=>_(f,1,x),d.dataset.color=s.color,u.appendChild(d)});function q(f,x){let s=o(x.name),d=document.createElement("div");return d.className="cw-task-item",d.dataset.id=f,d.innerHTML=`
        ...
        `,d.onclick=S=>{if(S.target.closest(".cw-step-btn"))return;let p=t[f]?t[f].count:0;_(f,p>0?-p:1,x)},d.querySelector(".minus").onclick=()=>_(f,-1,x),d.querySelector(".plus").onclick=()=>_(f,1,x),d}Object.entries(r).forEach(([f,x])=>{let s=document.createElement("div");s.className="cw-acc-group";let d=document.createElement("div");d.className="cw-acc-header",d.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${x.brand.color}"></div>
                ${f}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,d.onclick=()=>{c.querySelectorAll(".cw-acc-group.open").forEach(p=>{p!==s&&p.classList.remove("open")}),s.classList.toggle("open")};let S=document.createElement("div");S.className="cw-acc-body",x.tasks.forEach(p=>{let A=q(p.key,p);S.appendChild(A)}),s.appendChild(d),s.appendChild(S),c.appendChild(s)});function _(f,x,s){t[f]||(t[f]={count:0,data:s,brand:o(s.name)}),t[f].count+=x,t[f].count<=0&&delete t[f],B(),H(),e&&e()}function B(){i.forEach(([S])=>{let p=u.querySelector(`#hero-${S}`);if(!p)return;let A=t[S];A?(p.classList.add("active"),p.querySelector(".cw-step-val").textContent=A.count,p.querySelector(".cw-step-val").style.color=p.dataset.color):p.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(S=>{let p=S.dataset.id,A=t[p];A?(S.classList.add("selected"),S.querySelector(".cw-step-val").textContent=A.count):S.classList.remove("selected")});let x=Object.keys(t),s=0,d=[];if(x.forEach(S=>{let p=t[S];s+=p.count;for(let A=0;A<p.count;A++)d.length<6&&d.push(p.brand)}),s>0){b.classList.add("visible");let S=s>1?"A\xE7\xF5es":"A\xE7\xE3o",p=s>1?"definidas":"definida";y.textContent=`${s} ${S} ${p}`,T.innerHTML="",d.forEach(A=>{let O=document.createElement("div");O.className="cw-mini-icon",O.innerHTML=Pe[A.icon]||Pe.default;let v=O.querySelector("svg");v&&(v.style.width="14px",v.style.height="14px"),T.appendChild(O)})}else b.classList.remove("visible")}g.addEventListener("input",f=>{let x=f.target.value.toLowerCase();if(x.length>0){c.style.display="none",w.style.display="block",w.innerHTML="";let s=!1;Object.entries(Re).forEach(([d,S])=>{if(S.name.toLowerCase().includes(x)){s=!0;let p=q(d,S);t[d]&&(p.classList.add("selected"),p.querySelector(".cw-step-val").textContent=t[d].count),w.appendChild(p)}}),s||(w.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else c.style.display="block",w.style.display="none"});function H(){h.innerHTML="";let f=Object.keys(t),x=!1,s=document.getElementById("sub-status"),d="implementation";if(s&&s.value.toLowerCase().includes("education")&&(d="education"),f.length===0){h.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(f.length===0){h.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let S=document.createElement("div");S.className="cw-info-banner",S.innerHTML=`
...
`).filter(re=>re.trim()!=="").map(re=>`<p style="margin: 0 0 8px 0;">${re}</p>`).join(""):$.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let se=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let re=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${D}\\}(?:<br>\\s*)?`,"gi");re.test(E)?E=E.replace(re,""):E=E.replace(R,"")}else E=E.replace(R,U.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(E+=a.getOutput()),E}Ke.onclick=()=>{let C=It();C?(Tt(C),ee(j("copiado_sucesso"))):ee(j("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=v.value,M=It();if(!M){ee(j("selecione_substatus"),{error:!0});return}Tt(M),bt();let E=Xe(),V=await oo();if(V)try{if(V.focus(),V.innerHTML.trim()==="<p><br></p>"||V.innerHTML.trim()==="<br>"||V.innerText.trim()===""){let de=document.createRange();de.selectNodeContents(V);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("delete",!1,null)}else if(!V.innerHTML.endsWith("<br><br>")){let de=document.createRange();de.selectNodeContents(V),de.collapse(!1);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,M),to(V),setTimeout(()=>{ee(j("inserido_copiado"))},600);let le=typeof Ge<"u"&&Ge?Ge.checked:!0;if(C&&it[C]&&le){let de=it[C];await $t(de),await new Promise(X=>setTimeout(X,500))}E(),gt(1.5),S.value="",v.innerHTML=`<option value="">${j("select_substatus")}</option>`,v.disabled=!0}catch(oe){console.error(oe),ee("Erro ao inserir.",{error:!0}),E()}};function gt(C=1.5){C<=1.5&&(Me.style.display="none",ye.innerHTML=""),C<=2&&(Ae.style.display="none",l.reset(),be.style.display="none"),C<=3&&(Oe.style.display="none",_e.innerHTML="",a.reset(),Ue.style.display="none",De.style.display="none")}function bt(){if(i=!i,i){let C=m.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Ee(i,m,"cw-btn-notes")}return dt("bau"),pt("pt"),bt}var Ve={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
                ...
                `},{id:"nrp_dfa",name:"NRP - DFA",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Encerramento",body:`
                    ...
                    <br>
                    <p><strong>[Seu Nome]</strong><br>Time de Solu\xE7\xF5es T\xE9cnicas Cognizant, em nome do Google</p>
                `}]}};function so(){let e="v4.0.0",t=Object.keys(Ve)[0],n="",o="list",i={display:"flex",flexDirection:"column",height:"100%",position:"relative",overflow:"hidden",background:"#FAFAFA"},r={display:"flex",width:"200%",height:"100%",transition:"transform 0.4s cubic-bezier(0.25, 1, 0.5, 1)",transform:"translateX(0)"},a={width:"50%",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"},l={width:"100%",padding:"10px 12px 10px 36px",borderRadius:"8px",border:"none",background:"#F0F2F5",fontSize:"14px",color:"#202124",boxSizing:"border-box",outline:"none",transition:"all 0.2s ease",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"10px center"},m={display:"flex",gap:"6px",padding:"4px 4px 8px 4px",overflowX:"auto",scrollbarWidth:"none"},h={padding:"6px 12px",borderRadius:"16px",border:"1px solid transparent",background:"transparent",color:"#5f6368",fontSize:"12px",fontWeight:"500",cursor:"pointer",transition:"all 0.2s ease",flexShrink:"0"},u={background:"#E8F0FE",color:"#1967D2",fontWeight:"600"},c={display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px",marginBottom:"6px",borderRadius:"8px",background:"#fff",border:"1px solid #dadce0",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.4, 0.0, 0.2, 1)",position:"relative",overflow:"hidden"},w=!1,g=document.createElement("div");g.id="quick-email-popup",Object.assign(g.style,ve,{right:"100px",width:"480px",height:"600px",opacity:"0",pointerEvents:"none"});let b={popup:g,googleLine:null,focusElement:null};function y(){w=!w,Ee(w,g,"cw-btn-email"),w||setTimeout(()=>O(),300)}let T=Ce(g,"Emails R\xE1pidos",e,"Selecione, visualize e insira com um clique.",b,()=>y()),q=document.createElement("div");Object.assign(q.style,i);let _=document.createElement("div");Object.assign(_.style,r);let B=document.createElement("div");Object.assign(B.style,a);let H=document.createElement("div");Object.assign(H.style,{padding:"16px 16px 4px 16px",flexShrink:"0",background:"#fff",zIndex:"10",display:"flex",flexDirection:"column",gap:"8px",borderBottom:"1px solid #f1f3f4"});let f=document.createElement("input");f.placeholder="Buscar template...",Object.assign(f.style,l),f.onfocus=()=>{f.style.background="#fff",f.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},f.onblur=()=>{f.style.background="#F0F2F5",f.style.boxShadow="none"},b.focusElement=f;let x=document.createElement("div");Object.assign(x.style,m);let s=document.createElement("div");Object.assign(s.style,{padding:"12px 16px",overflowY:"auto",flexGrow:"1"}),H.appendChild(f),H.appendChild(x),B.appendChild(H),B.appendChild(s);let d=document.createElement("div");Object.assign(d.style,a);let S=document.createElement("div");Object.assign(S.style,{padding:"0",overflowY:"auto",flexGrow:"1",background:"#fff"}),d.appendChild(S),_.appendChild(B),_.appendChild(d),q.appendChild(_),g.appendChild(T),g.appendChild(q);let p=document.createElement("div");Object.assign(p.style,{padding:"8px 16px",borderTop:"1px solid #eee",textAlign:"center",fontSize:"10px",color:"#9aa0a6",background:"#fff",flexShrink:"0"}),p.textContent="created by lucaste@",g.appendChild(p),document.body.appendChild(g);function A(F){o="detail",_.style.transform="translateX(-50%)";let L='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg>',I='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>';S.innerHTML=`
        <style>
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function lo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",i="BAU",r=!1,a=document.createElement("div");a.id="call-script-popup",Object.assign(a.style,ve,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",opacity:"0",pointerEvents:"none"});let l={popup:a,googleLine:null};function m(){r=!r,Ee(r,a,"cw-btn-script")}let h=Ce(a,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{m()});a.appendChild(h);let u=document.createElement("div");Object.assign(u.style,t.progressBarContainer);let c=document.createElement("div");Object.assign(c.style,t.progressBarFill),u.appendChild(c),a.appendChild(u);let w=document.createElement("div");w.id="csa-content",Object.assign(w.style,t.contentArea),a.appendChild(w);let g=document.createElement("div");Object.assign(g.style,t.footer);let b=document.createElement("span");b.textContent="by lucaste@",Object.assign(b.style,{fontSize:"10px",color:"#bdc1c6"});let y=document.createElement("button");y.innerHTML=`
  ...
  `,Object.assign(y.style,t.resetBtn),y.onmouseenter=()=>y.style.background="#fce8e6",y.onmouseleave=()=>y.style.background="transparent",y.onclick=()=>{y.style.transform="scale(0.9)",setTimeout(()=>y.style.transform="scale(1)",150);for(let O in n)delete n[O];d()},g.appendChild(b),g.appendChild(y),a.appendChild(g);let T=document.createElement("div");Object.assign(T.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let q=document.createElement("div");Object.assign(q.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let _=document.createElement("div");_.textContent="BAU";let B=document.createElement("div");B.textContent="LT",Object.assign(_.style,me),Object.assign(B.style,me),q.appendChild(_),q.appendChild(B);let H=document.createElement("select");Object.assign(H.style,jt,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),H.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',H.value=o,T.appendChild(q),T.appendChild(H),w.appendChild(T);let f=document.createElement("div");f.id="csa-checklist-area",w.appendChild(f);let x=document.createElement("div");Object.assign(x.style,We),x.className="no-drag",x.title="Redimensionar",a.appendChild(x),Ye(a,x),document.body.appendChild(a);function s(O){return O}function d(){f.innerHTML="";let O=`${o} ${i}`,v=ro[O];if(!v){f.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
           ...
           `,b.appendChild(A)}let S=d.filter(A=>!s.includes(A.id)),p=d.filter(A=>s.includes(A.id));if(S.forEach(A=>b.appendChild(B(A,!1))),p.length>0){let A=document.createElement("div");Object.assign(A.style,a.historyDivider),A.innerHTML=`<span>Visualizar ${p.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let O=document.createElement("div");Object.assign(O.style,a.historyContainer),p.forEach(k=>O.appendChild(B(k,!0)));let v=!1;A.onclick=()=>{J.playClick(),v=!v,O.style.display=v?"flex":"none",A.querySelector("svg").style.transform=v?"rotate(180deg)":"rotate(0deg)",A.querySelector("span").textContent=v?"Ocultar hist\xF3rico":`Visualizar ${p.length} avisos anteriores`},b.appendChild(A),b.appendChild(O)}}function B(s,d){let S=document.createElement("div");Object.assign(S.style,d?a.cardHistory:a.card);let p=r[s.type]||r.info,A=document.createElement("div");Object.assign(A.style,a.cardHeader,{background:p.bg,color:p.text,borderBottom:`1px solid ${p.border}`});let O=document.createElement("div");if(Object.assign(O.style,{display:"flex",alignItems:"center",gap:"6px"}),O.innerHTML=`${p.icon} <span>${s.type.toUpperCase()}</span>`,A.appendChild(O),d){let k=document.createElement("span");k.textContent=i(s.date),k.style.opacity="0.7",A.appendChild(k)}else{let k=document.createElement("button");k.title="Marcar como lido",Object.assign(k.style,a.dismissBtn),k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',k.onmouseenter=()=>{k.style.color="#1e8e3e",k.style.background="#e6f4ea",k.style.borderColor="#1e8e3e"},k.onmouseleave=()=>{k.style.color="#5f6368",k.style.background="#fff",k.style.borderColor="rgba(0,0,0,0.1)"},k.onclick=F=>{F.stopPropagation(),J.playClick(),S.style.transform="translateX(20px)",S.style.opacity="0",setTimeout(()=>{let L=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");L.push(s.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(L)),_(),T()},250)},A.appendChild(k)}if(S.appendChild(A),s.title){let k=document.createElement("div");Object.assign(k.style,a.msgTitle),k.textContent=s.title,S.appendChild(k)}if(!d){let k=document.createElement("div");Object.assign(k.style,a.metaContainer),k.innerHTML=`<span style="font-weight:600">${s.author}</span> \u2022 <span>${i(s.date)}</span>`,S.appendChild(k)}let v=document.createElement("div");return Object.assign(v.style,a.cardBody),v.innerHTML=m(s.text),S.appendChild(v),S}_();let H=document.createElement("div");Object.assign(H.style,We),H.className="no-drag",h.appendChild(H),Ye(h,H),document.body.appendChild(h);let f=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),x=He.some(s=>!f.includes(s.id));return{toggle:c,hasUnread:x}}function Eo(){if(window.techSolInitialized){vt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{zt();try{J.initGlobalListeners(),J.playStartup()}catch(r){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",r)}je.fetchTips(),vt();let e=io(),t=so(),n=lo(),o=co(),i=po();Qt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:i})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),ee("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Eo();})();

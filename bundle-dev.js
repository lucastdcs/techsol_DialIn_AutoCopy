...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var de=e=>new Promise(t=>setTimeout(t,e));function be(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function st(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let r=e.getBoundingClientRect(),a=document.createElement("div");a.id=o,a.style.cssText=`
    ...
    `,a.innerHTML=`
        ...
        ">\xD7</div>
    `;let i=a.querySelector(".cw-close-btn");i.onclick=()=>{a.style.opacity="0",a.style.transform="translateY(-5px)",setTimeout(()=>a.remove(),300)},document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(a)&&i.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await de(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await de(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let n=o.offsetParent!==null,r=o.closest("case-message-view")!==null,a=o.closest(".editor")!==null||o.closest("write-card")!==null;return n&&!r&&a});return t&&be("Editor visualmente detectado.","success"),t}async function Zt(){be("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(d=>d.innerText.trim()==="email");if(o&&o.offsetParent!==null){be("Bot\xE3o de email direto encontrado.");let d=o.closest("material-button")||o.closest("material-fab")||o;Ce(d),e=!0}else{be("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let d=document.querySelector("material-fab-speed-dial");if(d){let b=d.querySelector(".trigger");if(b){Ce(b),await de(800);let y=Array.from(document.querySelectorAll("i.material-icons-extended")).find(w=>w.innerText.trim()==="email");y&&(Ce(y),e=!0)}}}if(!e)return oe("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;be("\u{1F680} FASE 2: Verificando rascunhos...");let n=null,r=0,a=20;for(;r<a;){await de(250);let d=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(n=Array.from(d).find(b=>b.offsetParent!==null),n){be("\u26A0\uFE0F Rascunho detectado!","warn");break}r++}if(n){be("\u{1F5D1}\uFE0F Descartando..."),Ce(n),n.click();let d=null,b=0;for(;b<15;){await de(300);let _=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(d=Array.from(_).find(y=>y.offsetParent!==null),d)break;b++}d&&(Ce(d),oe("Limpando rascunho antigo...",{duration:2e3}),await de(2500))}be("\u{1F680} FASE 3: Buscando editor final...");let i=0,l=null;for(;i<20&&(l=kt(),!l);)await de(250),i++;if(!l)return oe("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let g=l.closest('[id="email-body-content-top"]'),f=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(g){if(f){let b=f.closest('[aria-hidden="true"]');b&&b.removeAttribute("aria-hidden"),f.focus(),Ce(f)}await de(300),g.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let d=g.querySelector("#cases-body-field");if(d){let b=document.createRange();b.selectNodeContents(d),b.collapse(!0);let _=window.getSelection();_.removeAllRanges(),_.addRange(b)}return!0}return!1}async function lt(e){if(!e||!await Zt())return;let o=await At();be("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await de(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let a=document.querySelector('input[aria-label="Enter To email address"]');a&&(await rt(a,o.clientEmail),st(a,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let a=document.querySelector('input[aria-label="Enter Bcc email address"]');a&&(await rt(a,o.internalEmail),st(a,`
    ...
    `,document.head.appendChild(e)}function Te(e,t,o){let n=document.getElementById(o);if(!t)return;let r=t.getAttribute("data-moved")==="true",a={x:0,y:0};if(n){let f=n.getBoundingClientRect();a.x=f.left+f.width/2,a.y=f.top+f.height/2}let i,l;if(!r)i=window.innerWidth/2,l=window.innerHeight/2;else{let f=t.getBoundingClientRect();i=f.left+f.width/2,l=f.top+f.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let g=a.x-i,u=a.y-l;e?(Z.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",r?t.style.transform=`translate(${g}px, ${u}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${g}px), calc(-50% + ${u}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),n&&n.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",r?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof to=="function"&&to(t,o)):(Z.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",r?t.style.transform=`translate(${g}px, ${u}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${g}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),n&&n.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Ot=="function"&&Ot(t))}function to(e,t){Ot(e);let o=n=>{if(!e.classList.contains("open"))return;let r=e.contains(n.target),a=document.querySelector(".cw-pill"),i=a&&a.contains(n.target);r?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=o,document.addEventListener("mousedown",o)}function Ot(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var ao="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",qt="cw_data_broadcast",oo="cw_data_tips",Oo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function no(e){return new Promise((t,o)=>{let n="cw_cb_"+Math.round(1e4*Math.random()),r=document.createElement("script");window[n]=a=>{document.body.removeChild(r),delete window[n],t(a)},r.src=`${ao}?op=${e}&callback=${n}&t=${Date.now()}`,r.onerror=()=>{document.body.removeChild(r),delete window[n],o(new Error("JSONP Load Error"))},document.body.appendChild(r)})}var He={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await no("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(oo,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await no("broadcast");if(e&&e.broadcast)return localStorage.setItem(qt,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(qt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(qt)||"[]"),getRandomTip:()=>{let e=Oo,t=localStorage.getItem(oo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let n={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(ao,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(n)}).catch(r=>console.log("Log fail",r))}};var fe={glassBg:"rgba(40, 40, 40, 0.95)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.1)",iconIdle:"#bdc1c6",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},ct=e=>new Promise(t=>setTimeout(t,e));function io(e){let t="cw-command-center-style";if(!document.getElementById(t)){let C=document.createElement("style");C.id=t,C.innerHTML=`
        ...
        .cw-pill {
            ...
            overflow: hidden; /* Corta conte\xFAdo ao fechar */
            z-index: 2147483647;
            ...
            transition: 
                ...
                /* Drag precisa ser r\xE1pido e linear */
                top 0.1s linear, left 0.1s linear,
                opacity 0.4s ease, transform 0.5s var(--cw-spring);
            
            /* Estado Expandido (Altura m\xE1xima suficiente) */
            max-height: 500px; 
        ...
        .cw-pill.collapsed {
            ...
            justify-content: center; /* Centraliza verticalmente o \xEDcone absoluto */
        }
        ...
        .cw-pill.collapsed .cw-status-container {
            ...
            transition: opacity 0.1s ease; /* Sai r\xE1pido */
        }
        ...
        .cw-btn:hover { background: rgba(255,255,255,0.1); color: ${fe.iconActive}; transform: scale(1.1); }

        /* Cores Ativas */
        .cw-btn.notes.active { color: ${fe.blue} !important; background: rgba(138, 180, 248, 0.15); }
        .cw-btn.email.active { color: ${fe.red} !important; background: rgba(242, 139, 130, 0.15); }
        .cw-btn.script.active { color: ${fe.purple} !important; background: rgba(197, 138, 249, 0.15); }
        .cw-btn.links.active { color: ${fe.green} !important; background: rgba(129, 201, 149, 0.15); }
        .cw-btn.broadcast.active { color: ${fe.orange} !important; background: rgba(249, 171, 0, 0.15); }
    ...
    `,document.head.appendChild(C)}let o={check:'<svg viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" fill="currentColor"/></svg>',notes:'<svg viewBox="0 0 24 24"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z" fill="currentColor"/></svg>',email:'<svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" fill="currentColor"/></svg>',script:'<svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" fill="currentColor"/></svg>',links:'<svg viewBox="0 0 24 24"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z" fill="currentColor"/></svg>',broadcast:'<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" fill="currentColor"/></svg>',nexus:'<svg viewBox="0 0 24 24"><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="currentColor"/></svg>'},n=document.createElement("div");n.className="cw-pill side-right",n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(m)}let l=document.createElement("div");l.className="cw-zen-container";let g=document.createElement("div");Object.assign(g.style,{display:"none"});let u=document.createElement("div");u.className="cw-screens-container",g.appendChild(u),l.innerHTML=`
    ...
    `;let f=l.querySelector(".cw-hero-grid"),d=l.querySelector(".cw-acc-container"),b=l.querySelector(".cw-results-container"),_=l.querySelector(".cw-search-input"),y=l.querySelector(".cw-status-bar"),w=l.querySelector(".cw-status-text"),O=l.querySelector(".cw-footer-icons");r.forEach(([m,h])=>{let s=n(h.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${m}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let p=t[m]?t[m].count:0;M(m,p>0?-p:1,h)},c.querySelector(".minus").onclick=()=>M(m,-1,h),c.querySelector(".plus").onclick=()=>M(m,1,h),c.dataset.color=s.color,f.appendChild(c)});function I(m,h){let s=n(h.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=m,c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let p=t[m]?t[m].count:0;M(m,p>0?-p:1,h)},c.querySelector(".minus").onclick=()=>M(m,-1,h),c.querySelector(".plus").onclick=()=>M(m,1,h),c}Object.entries(a).forEach(([m,h])=>{let s=document.createElement("div");s.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${h.brand.color}"></div>
                ${m}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{d.querySelectorAll(".cw-acc-group.open").forEach(p=>{p!==s&&p.classList.remove("open")}),s.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",h.tasks.forEach(p=>{let x=I(p.key,p);v.appendChild(x)}),s.appendChild(c),s.appendChild(v),d.appendChild(s)});function M(m,h,s){t[m]||(t[m]={count:0,data:s,brand:n(s.name)}),t[m].count+=h,t[m].count<=0&&delete t[m],C(),q(),e&&e()}function C(){r.forEach(([v])=>{let p=f.querySelector(`#hero-${v}`);if(!p)return;let x=t[v];x?(p.classList.add("active"),p.querySelector(".cw-step-val").textContent=x.count,p.querySelector(".cw-step-val").style.color=p.dataset.color):p.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(v=>{let p=v.dataset.id,x=t[p];x?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=x.count):v.classList.remove("selected")});let h=Object.keys(t),s=0,c=[];if(h.forEach(v=>{let p=t[v];s+=p.count;for(let x=0;x<p.count;x++)c.length<6&&c.push(p.brand)}),s>0){y.classList.add("visible");let v=s>1?"A\xE7\xF5es":"A\xE7\xE3o",p=s>1?"definidas":"definida";w.textContent=`${s} ${v} ${p}`,O.innerHTML="",c.forEach(x=>{let k=document.createElement("div");k.className="cw-mini-icon",k.innerHTML=Ve[x.icon]||Ve.default;let A=k.querySelector("svg");A&&(A.style.width="14px",A.style.height="14px"),O.appendChild(k)})}else y.classList.remove("visible")}_.addEventListener("input",m=>{let h=m.target.value.toLowerCase();if(h.length>0){d.style.display="none",b.style.display="block",b.innerHTML="";let s=!1;Object.entries(Re).forEach(([c,v])=>{if(v.name.toLowerCase().includes(h)){s=!0;let p=I(c,v);t[c]&&(p.classList.add("selected"),p.querySelector(".cw-step-val").textContent=t[c].count),b.appendChild(p)}}),s||(b.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else d.style.display="block",b.style.display="none"});function q(){u.innerHTML="";let m=Object.keys(t),h=!1,s=document.getElementById("sub-status"),c="implementation";if(s&&s.value.toLowerCase().includes("education")&&(c="education"),m.length===0){u.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(m.length===0){u.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let v=document.createElement("div");v.className="cw-info-banner",v.innerHTML=`
        ...
        `,u.appendChild(v),m.forEach(p=>{let x=t[p].data,k=t[p].count,A=t[p].brand,T=x.screenshots?x.screenshots[c]||[]:["Link da Evid\xEAncia"];if(T.length>0){h=!0;for(let ne=1;ne<=k;ne++){let B=document.createElement("div");B.className="cw-screen-card",B.style.setProperty("--brand-color",A.color),B.style.setProperty("--brand-bg",A.bg),B.style.setProperty("--brand-shadow",A.color+"40");let D=document.createElement("div");D.className="cw-card-header";let L=document.createElement("div");L.className="cw-card-icon",L.innerHTML=Ve[A.icon]||Ve.default;let P=document.createElement("div");P.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let X=document.createElement("input");X.className="cw-card-title-input",X.id=`name-${p}-${ne}`,X.value=`${x.name}${k>1?" #"+ne:""}`,X.title="Clique para renomear esta task";let H=document.createElement("span");H.className="cw-edit-hint",H.innerHTML="\u270E Renomear",P.appendChild(X),P.appendChild(H),D.appendChild(L),D.appendChild(P),B.appendChild(D),T.forEach((he,W)=>{let R=document.createElement("div");R.className="cw-input-group";let J=document.createElement("label");J.className="cw-input-label",J.textContent=he.replace(/📷|:|•/g,"").trim();let re=document.createElement("input");re.className="cw-input-field",re.id=`screen-${p}-${ne}-${W}`,re.placeholder="Cole o link aqui...",re.setAttribute("autocomplete","off"),re.addEventListener("input",()=>{re.value.trim().length>5?re.classList.add("filled"):re.classList.remove("filled")});let me=document.createElement("div");me.className="cw-input-check",me.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',R.appendChild(J),R.appendChild(re),R.appendChild(me),B.appendChild(R)}),u.appendChild(B)}}}),g.style.display=h?"block":"none"}return{selectionElement:l,screenshotsElement:g,updateSubStatus:()=>q(),getCheckedElements:()=>Object.keys(t).map(m=>({value:m,closest:()=>({querySelector:()=>({textContent:t[m].count})})})),toggleTask:(m,h=!0)=>{let s=t[m];h&&!s?M(m,1,Re[m]):!h&&s&&M(m,-s.count,Re[m])},setMode:m=>{o=m,q()},reset:()=>{for(let m in t)delete t[m];_.value="",d.style.display="block",b.style.display="none",C(),q()}}}function go(){let e="v3.6.0",t="bau",o="pt",n=!1,r=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},i=uo(),l=mo(()=>{let F=l.getCheckedElements().map(E=>E.value);A&&A.value&&i.updateVisibility(A.value,F)}),g=document.createElement("div");g.id="autofill-popup",g.classList.add("cw-module-window"),Object.assign(g.style,we,{right:"100px",width:"400px",transition:"width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)"});let f=Ee(g,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:g,googleLine:null},()=>yt());g.appendChild(f);let d=document.createElement("div");Object.assign(d.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),g.appendChild(d);let b=document.createElement("div");b.textContent="created by lucaste@",Object.assign(b.style,Wt),g.appendChild(b);let _=document.createElement("div");_.id="step-lang-type";let y=document.createElement("label");Object.assign(y.style,a.label),_.appendChild(y);let w=document.createElement("div");Object.assign(w.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let O=document.createElement("div");O.textContent="Portugu\xEAs",O.classList.add("no-drag"),Object.assign(O.style,ge);let I=document.createElement("div");I.textContent="Espa\xF1ol",I.classList.add("no-drag"),Object.assign(I.style,ge),O.onclick=()=>bt("pt"),I.onclick=()=>bt("es"),w.appendChild(O),w.appendChild(I),_.appendChild(w),d.appendChild(_);let M=document.createElement("div");M.id="step-0-case-type";let C=document.createElement("label");Object.assign(C.style,a.label),M.appendChild(C);let q=document.createElement("div");Object.assign(q.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let m=document.createElement("div");m.textContent="BAU",m.classList.add("no-drag"),Object.assign(m.style,ge);let h=document.createElement("div");h.textContent="LM",h.classList.add("no-drag"),Object.assign(h.style,ge),m.onclick=()=>gt("bau"),h.onclick=()=>gt("lm"),q.appendChild(m),q.appendChild(h),M.appendChild(q),d.appendChild(M);let s=document.createElement("div");s.id="step-1-selection";let c=document.createElement("label");c.className="cw-input-label",c.textContent="Status Principal";let v=document.createElement("select");v.id="main-status",v.className="cw-select",v.innerHTML=`
  ...
  `;let p=document.createElement("div");p.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let x=document.createElement("label");x.className="cw-input-label",x.textContent="Sub-status",x.style.marginBottom="0";let k=document.createElement("a");k.href="https://seu-link-do-guia-aqui.com",k.target="_blank",k.className="cw-info-link",k.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(k.style,a.helpLink),p.appendChild(x),p.appendChild(k);let A=document.createElement("select");A.id="sub-status",A.className="cw-select",A.disabled=!0,A.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',s.appendChild(c),s.appendChild(v),s.appendChild(p),s.appendChild(A),d.appendChild(s);let T=document.createElement("div");T.id="step-1-1-portugal",Object.assign(T.style,a.stepBlock,{display:"none"});let ne=document.createElement("label");Object.assign(ne.style,a.label),T.appendChild(ne);let B=document.createElement("div");Object.assign(B.style,a.radioContainer);let D=document.createElement("div");Object.assign(D.style,{display:"flex",alignItems:"center"});let L=document.createElement("input");L.type="radio",L.name="portugal-group",L.value="sim",Object.assign(L.style,a.checkboxInput);let P=document.createElement("label");P.htmlFor="portugal-sim",Object.assign(P.style,{cursor:"pointer"}),D.appendChild(L),D.appendChild(P);let X=document.createElement("div");Object.assign(X.style,{display:"flex",alignItems:"center"});let H=document.createElement("input");H.type="radio",H.name="portugal-group",H.value="nao",H.checked=!0,Object.assign(H.style,a.checkboxInput);let he=document.createElement("label");he.htmlFor="portugal-nao",Object.assign(he.style,{cursor:"pointer"}),X.appendChild(H),X.appendChild(he),B.appendChild(D),B.appendChild(X),T.appendChild(B),d.appendChild(T);function W(S){n=S,S?R.style.display="block":R.style.display="none"}L.onchange=()=>W(!0),H.onchange=()=>W(!1);let R=document.createElement("div");R.id="step-1-2-consent",Object.assign(R.style,a.stepBlock,{display:"none"});let J=document.createElement("label");Object.assign(J.style,a.label),R.appendChild(J);let re=document.createElement("div");Object.assign(re.style,a.radioContainer);let me=document.createElement("div");Object.assign(me.style,{display:"flex",alignItems:"center"});let ve=document.createElement("input");ve.type="radio",ve.name="consent-group",ve.value="Sim",ve.checked=!0,Object.assign(ve.style,a.checkboxInput);let ie=document.createElement("label");ie.htmlFor="consent-sim",Object.assign(ie.style,{cursor:"pointer"}),me.appendChild(ve),me.appendChild(ie);let ee=document.createElement("div");Object.assign(ee.style,{display:"flex",alignItems:"center"});let Oe=document.createElement("input");Oe.type="radio",Oe.name="consent-group",Oe.value="N\xE3o",Object.assign(Oe.style,a.checkboxInput);let Le=document.createElement("label");Le.htmlFor="consent-nao",Object.assign(Le.style,{cursor:"pointer"}),ee.appendChild(Oe),ee.appendChild(Le),re.appendChild(me),re.appendChild(ee),R.appendChild(re),d.appendChild(R);let Me=document.createElement("div");Me.id="step-1-5-snippets",Object.assign(Me.style,a.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,a.h3),nt.textContent="Cen\xE1rios Comuns";let Ae=so(S=>{let F=document.querySelector("textarea");F&&(F.value=S,F.dispatchEvent(new Event("input")),F.style.transition="background-color 0.2s",F.style.backgroundColor="#e8f0fe",setTimeout(()=>F.style.backgroundColor="#fff",300))});Ae.id="snippet-container",Me.appendChild(nt),Me.appendChild(Ae),d.appendChild(Me);let xe=document.createElement("div");xe.id="step-3-form",Object.assign(xe.style,a.stepBlock,{display:"none"});let mt=document.createElement("h3");Object.assign(mt.style,a.h3),xe.appendChild(mt);let _e=document.createElement("div");_e.id="dynamic-form-fields-container",xe.appendChild(_e);let pe=document.createElement("button");pe.textContent="+ Gostaria de selecionar uma task?",Object.assign(pe.style,a.optionalBtn),pe.onmouseover=()=>pe.style.background="#e8f0fe",pe.onmouseout=()=>pe.style.background="white",pe.onclick=()=>{pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};let De=document.createElement("h3");Object.assign(De.style,a.h3,{marginTop:"20px"});let Rt=l.selectionElement;Object.assign(Rt.style,{marginBottom:"20px"}),xe.appendChild(pe),xe.appendChild(De),xe.appendChild(Rt),xe.appendChild(i.element),xe.appendChild(l.screenshotsElement),d.appendChild(xe);let Fe=document.createElement("div");Fe.id="step-4-email",Object.assign(Fe.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let ze=document.createElement("input");ze.type="checkbox",ze.checked=!0,Object.assign(ze.style,a.checkboxInput),Ge.appendChild(ze),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),Fe.appendChild(Ge),d.appendChild(Fe);let We=document.createElement("div");Object.assign(We.style,{display:"none",gap:"8px",padding:"0"}),d.appendChild(We);let Ke=document.createElement("button");Object.assign(Ke.style,a.buttonBase,{backgroundColor:"#5f6368"}),Ke.textContent="Copiar";let Qe=document.createElement("button");Object.assign(Qe.style,a.buttonBase,{backgroundColor:"#1a73e8"}),Qe.textContent="Preencher",We.appendChild(Ke),We.appendChild(Qe);let Ze=document.createElement("div");Object.assign(Ze.style,Ye),Ze.className="no-drag",Ze.title="Redimensionar",g.appendChild(Ze),Xe(g,Ze),document.body.appendChild(g);function gt(S){t=S;let F=Je();Object.assign(m.style,ge),Object.assign(h.style,ge),S==="bau"?(Object.assign(m.style,F),k.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(h.style,F),k.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),A.value&&A.dispatchEvent(new Event("change"))}function V(S){try{if(Ne&&Ne[o]&&Ne[o][S])return Ne[o][S];if(Ne&&Ne.pt&&Ne.pt[S])return Ne.pt[S]}catch{}return S}function vo(){y.textContent=V("idioma"),C.textContent=V("fluxo"),c.textContent=V("status_principal"),x.textContent=V("substatus"),nt.textContent=V("cenarios_comuns"),De.textContent=V("selecione_tasks"),mt.textContent=V("preencha_detalhes"),Ke.textContent=V("copiar"),Qe.textContent=V("preencher"),v.querySelector('option[value=""]')&&(v.querySelector('option[value=""]').textContent=V("select_status")),A.querySelector('option[value=""]')&&(A.querySelector('option[value=""]').textContent=V("select_substatus")),ne.textContent=V("caso_portugal"),P.textContent=V("sim"),he.textContent=V("nao"),J.textContent=V("consentiu_gravacao"),ie.textContent=V("sim"),Le.textContent=V("nao"),_e.querySelectorAll("label").forEach(S=>{let F=S.nextElementSibling.id.replace("field-",""),E=V(F.toLowerCase());E!==F.toLowerCase()?S.textContent=E:S.textContent=F.replace(/_/g," ").replace(/\b\w/g,$=>$.toUpperCase())+":"}),pe.textContent="+ "+(o==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function bt(S){o=S;let F=Je();Object.assign(O.style,ge),Object.assign(I.style,ge),S==="pt"?(Object.assign(O.style,F),T.style.display="block",W(n)):(Object.assign(I.style,F),T.style.display="none",R.style.display="none"),vo(),A.value&&A.dispatchEvent(new Event("change"))}function ft(S){(S.value.trim()===""||S.value.trim()==="\u2022")&&(S.value="\u2022 "),S.onkeydown=function(F){if(F.key==="Enter"){F.preventDefault();let E=this.selectionStart,$=this.selectionEnd,ae=this.value,le=ae.lastIndexOf(`
...
\u2022 `)?(F.preventDefault(),this.value=$.substring(0,E-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=E-3):$==="\u2022 "&&(F.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function ht(){let S=typeof Ae<"u"?Ae:document.getElementById("snippet-container");if(!S)return;let F=S.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),E={},$=new Set;F.forEach(Q=>{let K=Q.id,G=Se[K];if(G)for(let N in G)N==="linkedTask"?$.add(G.linkedTask):N!=="type"&&(E[N]||(E[N]=[]),E[N].includes(G[N])||E[N].push(G[N]))});let ae=new Set;Object.values(Se).forEach(Q=>{Object.keys(Q).forEach(K=>{K!=="linkedTask"&&K!=="type"&&ae.add(K)})}),ae.forEach(Q=>{let K=document.getElementById(Q);if(K){let G=E[Q]||[],N="";ot.includes(Q.replace("field-",""))?(N=G.map(Y=>Y.startsWith("\u2022 ")?Y:"\u2022 "+Y).join(`
`),N===""?N="\u2022 ":N.endsWith(`
\u2022 `)||(N+=`
\u2022 `)):N=G.join(`

`),N.trim()!=="\u2022"&&N.trim()!==""?K.value=N:ot.includes(Q.replace("field-",""))?K.value="\u2022 ":K.value="",K.tagName==="TEXTAREA"&&typeof ft=="function"&&ft(K)}});let le=new Set,ye=new Set;S.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(Q=>{let K=Se[Q.id];K&&K.linkedTask&&(Q.checked?le.add(K.linkedTask):ye.add(K.linkedTask))}),ye.forEach(Q=>{le.has(Q)||l.toggleTask(Q,!1)}),le.forEach(Q=>{l.toggleTask(Q,!0)})}v.onchange=()=>{let S=v.value;if(xt(1.5),A.innerHTML=`<option value="">${V("select_substatus")}</option>`,!S){A.disabled=!0;return}for(let F in tt){let E=tt[F];if(E.status===S){let $=document.createElement("option");$.value=F,$.textContent=E.name,A.appendChild($)}}A.disabled=!1},A.onchange=()=>{let S=A.value;if(xt(1.5),!S)return;l.updateSubStatus(S);let F=tt[S];Ae.innerHTML="";let E=(G,N,Y)=>{let se=document.createElement("label");Object.assign(se.style,a.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let te=document.createElement("input");return te.type=N,te.id=G.id,Object.assign(te.style,a.checkboxInput),se.appendChild(te),se.appendChild(document.createTextNode(` ${G.text}`)),Y.appendChild(se),te},$=[],ae="radio";if(S==="NI_Awaiting_Inputs")$=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(S.startsWith("SO_"))ae="checkbox",$=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(S.startsWith("AS_")){ae="checkbox";let G=document.createElement("label");G.textContent=V("cenarios_comuns"),Object.assign(G.style,a.label),Ae.appendChild(G),$=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else S.startsWith("IN_")?$=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:S.startsWith("DC_")&&(ae="radio",$=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let le=$.filter(G=>{let N=Se[G.id];return!N.type||N.type==="all"||N.type===t});le.forEach((G,N)=>{let Y=E(G,ae,Ae);ae==="radio"&&(Y.name="scenario-radio-group",N===0&&(Y.checked=!0))}),le.length>0&&(Me.style.display="block"),F.requiresTasks?(pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"):(pe.style.display="block",De.style.display="none",l.selectionElement.style.display="none"),_e.innerHTML="";let ye=F.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(ye)].forEach(G=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(G))return;let N=G.slice(1,-1),Y=document.createElement("label"),se=V(N.toLowerCase());if(Y.textContent=se!==N.toLowerCase()?se:N.replace(/_/g," ").replace(/\b\w/g,j=>j.toUpperCase())+":",Object.assign(Y.style,a.label),N==="SPEAKEASY_ID"){let j=document.createElement("button");j.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',j.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
...
`).filter(j=>j.trim()!=="").map(j=>`<p style="margin: 0 0 8px 0;">${j}</p>`).join(""):K.tagName==="TEXTAREA"&&(Y=Y.replace(/\n/g,"<br>"));let se=Y.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let j=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${G}\\}(?:<br>\\s*)?`,"gi");j.test(E)?E=E.replace(j,""):E=E.replace(N,"")}else E=E.replace(N,Y.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(E+=i.getOutput()),E}Ke.onclick=()=>{let S=Lt();S?(It(S),oe(V("copiado_sucesso"))):oe(V("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let S=A.value,F=Lt();if(!F){oe(V("selecione_substatus"),{error:!0});return}It(F),yt();let E=dt(),$=await po();if($)try{if($.focus(),$.innerHTML.trim()==="<p><br></p>"||$.innerHTML.trim()==="<br>"||$.innerText.trim()===""){let ce=document.createRange();ce.selectNodeContents($);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ce),document.execCommand("delete",!1,null)}else if(!$.innerHTML.endsWith("<br><br>")){let ce=document.createRange();ce.selectNodeContents($),ce.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ce),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,F),co($),setTimeout(()=>{oe(V("inserido_copiado"))},600);let le=typeof ze<"u"&&ze?ze.checked:!0;if(S&&Pe[S]&&le){let ce=Pe[S];await lt(ce),await new Promise(Q=>setTimeout(Q,500))}E(),xt(1.5),v.value="",A.innerHTML=`<option value="">${V("select_substatus")}</option>`,A.disabled=!0}catch(ae){console.error(ae),oe("Erro ao inserir.",{error:!0}),E()}};function xt(S=1.5){S<=1.5&&(Me.style.display="none",Ae.innerHTML=""),S<=2&&(l.reset(),pe.style.display="none"),S<=3&&(xe.style.display="none",_e.innerHTML="",i.reset(),We.style.display="none",Fe.style.display="none")}function yt(){if(r=!r,r){let S=g.querySelector(".cw-expand-btn");S&&typeof S.resetState=="function"&&S.resetState()}Te(r,g,"cw-btn-notes")}return gt("bau"),bt("pt"),yt}var $e={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
            ...
            <div style="position:sticky; top:0; background:rgba(255,255,255,0.95); backdrop-filter:blur(10px); border-bottom:1px solid #f1f3f4; padding:12px 20px; z-index:10; display:flex; align-items:center; gap:8px;">
                ...
                <div style="font-weight:600; color:#202124; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${L.name}</div>
            </div>
            <div style="padding:20px;">
                <div style="font-size:11px; font-weight:700; color:#1a73e8; text-transform:uppercase; margin-bottom:6px;">Assunto</div>
                <div style="font-size:13px; color:#202124; padding:12px; background:#F8F9FA; border-radius:8px; border:1px solid #eee; margin-bottom:20px;">${L.subject}</div>
                <div style="font-size:11px; font-weight:700; color:#1a73e8; text-transform:uppercase; margin-bottom:6px;">Mensagem</div>
                <div style="font-size:13px; color:#3c4043; line-height:1.5;">${L.body.replace(/\n/g,"<br>")}</div>
            </div>
        ...
        `,x.querySelector("#csa-back-btn").onclick=T;let H=x.querySelector("#csa-insert-btn");H.onclick=()=>{H.style.transform="scale(0.96)",k(L,"email"),setTimeout(()=>{H.style.transform="scale(1)",T()},300)}}function T(){r="list",C.style.transform="translateX(0)"}function ne(L,P,X=null){let H=document.createElement("button");return H.innerHTML=X?`<span style="margin-right:4px">${X}</span>${L}`:L,Object.assign(H.style,d),o===P&&n===""&&Object.assign(H.style,b),H.onclick=()=>{o=P,n="",s.value="",B(),D()},H}function B(){c.innerHTML="",c.appendChild(ne("Smart CRs",t,"\u26A1")),Object.keys($e).forEach(L=>{c.appendChild(ne($e[L].title,L))})}function D(){v.innerHTML="";let L=[];if(n.trim()!==""){let W=n.toLowerCase();Object.values($e).forEach(R=>{R.emails.forEach(J=>{(J.name.toLowerCase().includes(W)||J.subject.toLowerCase().includes(W))&&L.push({type:"email",data:J})})}),Object.entries(Pe).forEach(([R,J])=>{if(!J)return;(R.replace(/_/g," ").toLowerCase().includes(W)||J.toLowerCase().includes(W))&&L.push({type:"cr",key:R,code:J})})}else o===t?Object.entries(Pe).forEach(([W,R])=>{R&&L.push({type:"cr",key:W,code:R})}):$e[o]&&$e[o].emails.forEach(W=>{L.push({type:"email",data:W})});if(L.length===0){v.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px;">\u{1F50D}</div><div style="font-size:14px; margin-top:8px;">Nada encontrado.</div></div>';return}let X='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a73e8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',H='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fbbc04" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',he='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dadce0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';L.forEach(W=>{let R=document.createElement("div");if(Object.assign(R.style,_),W.type==="email"){let J=W.data,re=J.subject.length>40?J.subject.substring(0,40)+"...":J.subject;R.innerHTML=`
                ...
                `,R.onclick=()=>A(J)}else{let J=W.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");R.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function ho(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},o={},n="PT",r="BAU",a=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,we,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let l={popup:i,googleLine:null};function g(){a=!a,Te(a,i,"cw-btn-script")}let u=Ee(i,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{g()});i.appendChild(u);let f=document.createElement("div");Object.assign(f.style,t.progressBarContainer);let d=document.createElement("div");Object.assign(d.style,t.progressBarFill),f.appendChild(d),i.appendChild(f);let b=document.createElement("div");b.id="csa-content",Object.assign(b.style,t.contentArea),i.appendChild(b);let _=document.createElement("div");Object.assign(_.style,t.footer);let y=document.createElement("span");y.textContent="by lucaste@",Object.assign(y.style,{fontSize:"10px",color:"#bdc1c6"});let w=document.createElement("button");w.innerHTML=`
  ...
  `,Object.assign(w.style,t.resetBtn),w.onmouseenter=()=>w.style.background="#fce8e6",w.onmouseleave=()=>w.style.background="transparent",w.onclick=()=>{w.style.transform="scale(0.9)",setTimeout(()=>w.style.transform="scale(1)",150);for(let k in o)delete o[k];c()},_.appendChild(y),_.appendChild(w),i.appendChild(_);let O=document.createElement("div");Object.assign(O.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let I=document.createElement("div");Object.assign(I.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let M=document.createElement("div");M.textContent="BAU";let C=document.createElement("div");C.textContent="LT",Object.assign(M.style,ge),Object.assign(C.style,ge),I.appendChild(M),I.appendChild(C);let q=document.createElement("select");Object.assign(q.style,Ut,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),q.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',q.value=n,O.appendChild(I),O.appendChild(q),b.appendChild(O);let m=document.createElement("div");m.id="csa-checklist-area",b.appendChild(m);let h=document.createElement("div");Object.assign(h.style,Ye),h.className="no-drag",h.title="Redimensionar",i.appendChild(h),Xe(i,h),document.body.appendChild(i);function s(k){return k}function c(){m.innerHTML="";let k=`${n} ${r}`,A=fo[k];if(!A){m.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,Object.assign(c.style,a),c.style.display="inline-flex",c.style.alignItems="center",t===h&&o===""&&Object.assign(c.style,i),c.onmousedown=()=>c.style.transform="scale(0.95)",c.onmouseup=()=>c.style.transform="scale(1)",c.onmouseleave=()=>c.style.transform="scale(1)",c.onclick=()=>{t=h,o="",w.value="",C(),q()},O.appendChild(c)})}function q(){I.innerHTML="";let h=[],s=o.trim()!=="";if(s?Object.entries(ut).forEach(([c,v])=>{let p=v.links.filter(x=>x.name.toLowerCase().includes(o.toLowerCase())||x.desc.toLowerCase().includes(o.toLowerCase()));p.forEach(x=>{x._catIcon=f[c],x._categoryName=v.label}),h=[...h,...p]}):(h=ut[t].links,h.forEach(c=>c._catIcon=f[t])),h.length===0){I.innerHTML=`
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
        ...
        </div>`;return}h.forEach((c,v)=>{let p=document.createElement("div");Object.assign(p.style,l);let x=document.createElement("div");Object.assign(x.style,g),x.innerHTML=c._catIcon||'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>',x.style.display="flex",x.style.alignItems="center",x.style.justifyContent="center",x.style.color="#5f6368",p.appendChild(x);let k=document.createElement("div");k.style.flexGrow="1";let A=P=>{if(!s)return P;let X=new RegExp(`(${o})`,"gi");return P.replace(X,'<span style="color:#1a73e8; font-weight:700;">$1</span>')},T=`<div style="font-size:14px; font-weight:500; color:#202124;">${A(c.name)}</div>`,ne=`<div style="font-size:11px; color:#5f6368; margin-top:2px;">${A(c.desc)}</div>`;k.innerHTML=T+ne,p.appendChild(k);let B=document.createElement("div");B.style.display="flex",B.style.gap="4px",B.style.opacity="0",B.style.transition="opacity 0.2s";let D=document.createElement("div");D.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',Object.assign(D.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#5f6368",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"}),D.onclick=P=>{Z.playClick(),P.stopPropagation(),navigator.clipboard.writeText(c.url),D.style.transform="scale(1.2)",D.style.color="#1e8e3e",D.style.backgroundColor="#e6f4ea",setTimeout(()=>{D.style.transform="scale(1)",D.style.color="#5f6368",D.style.backgroundColor="transparent"},800)},D.onmouseenter=()=>D.style.backgroundColor="#f1f3f4",D.onmouseleave=()=>D.style.backgroundColor="transparent",B.appendChild(D);let L=document.createElement("div");L.innerHTML="\u2197",Object.assign(L.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",color:"#dadce0",fontSize:"16px"}),B.appendChild(L),p.appendChild(B),p.onclick=()=>window.open(c.url,"_blank"),p.onmouseenter=()=>{p.style.backgroundColor="#f8f9fa",p.style.transform="scale(1.01)",B.style.opacity="1",L.style.color="#1a73e8"},p.onmouseleave=()=>{p.style.backgroundColor="#ffffff",p.style.transform="scale(1)",B.style.opacity="0",L.style.color="#dadce0"},I.appendChild(p),requestAnimationFrame(()=>{p.style.transition="opacity 0.3s ease, transform 0.3s cubic-bezier(0.2, 0.9, 0.3, 1.2)",setTimeout(()=>{p.style.opacity="1",p.style.transform="translateY(0)"},v*40)})})}w.addEventListener("input",h=>{o=h.target.value,o!==""?Array.from(O.children).forEach(s=>{s.style.backgroundColor="transparent",s.style.color="#5f6368",s.style.borderColor="#dadce0"}):C(),q()});function m(){b=!b,Te(b,u,"cw-btn-links")}return C(),q(),m}var Ue=[];function _t(e){Ue=e}function yo(){let e="v2.5 (Emoji Fix)",t=!1,o=null,n=60*1e3;function r(s){if(!s)return"";try{let c=new Date(s);return isNaN(c.getTime())?String(s):c.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(s)}}let a={critical:{bg:"#FEF2F2",border:"#FECACA",text:"#991B1B",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>'},info:{bg:"#EFF6FF",border:"#BFDBFE",text:"#1E40AF",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>'},success:{bg:"#F0FDF4",border:"#BBF7D0",text:"#166534",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>'}},i={feedContainer:{padding:"24px",overflowY:"auto",flexGrow:"1",background:"#FAFAFA",display:"flex",flexDirection:"column",gap:"20px"},card:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.06)",boxShadow:"0 4px 12px rgba(0,0,0,0.05), 0 1px 2px rgba(0,0,0,0.02)",overflow:"hidden",transition:"all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1)",position:"relative",width:"100%",boxSizing:"border-box",flexShrink:"0"},cardHistory:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.04)",boxShadow:"none",opacity:"0.8",filter:"grayscale(0.3)",marginBottom:"16px",flexShrink:"0"},cardHeader:{padding:"12px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid rgba(0,0,0,0.04)",fontSize:"12px",fontWeight:"600",letterSpacing:"0.5px",textTransform:"uppercase"},msgTitle:{padding:"20px 20px 8px 20px",fontSize:"16px",fontWeight:"700",color:"#202124",letterSpacing:"-0.01em",lineHeight:"1.4"},metaContainer:{padding:"0 20px 12px 20px",display:"flex",alignItems:"center",gap:"8px",fontSize:"12px",color:"#5f6368"},cardBody:{padding:"0 20px 24px 20px",fontSize:"14px",color:"#3c4043",lineHeight:"1.6",whiteSpace:"pre-wrap",fontFamily:"'Google Sans', Roboto, sans-serif",wordBreak:"break-word",overflowWrap:"break-word"},emojiImg:"height: 20px; vertical-align: text-bottom; margin: 0 2px;",dismissBtn:{width:"28px",height:"28px",borderRadius:"50%",border:"1px solid rgba(0,0,0,0.1)",background:"#fff",color:"#5f6368",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s ease",marginLeft:"12px"},markAllBtn:{fontSize:"12px",color:"#1a73e8",cursor:"pointer",fontWeight:"600",background:"transparent",border:"none",padding:"8px",transition:"opacity 0.2s"},emptyState:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 0",color:"#bdc1c6",gap:"16px",textAlign:"center"},historyDivider:{display:"flex",alignItems:"center",justifyContent:"center",margin:"10px 0 20px 0",cursor:"pointer",color:"#1a73e8",fontSize:"13px",fontWeight:"500",gap:"8px",padding:"10px",borderRadius:"8px",transition:"background 0.2s"},historyContainer:{display:"none",flexDirection:"column",gap:"16px",paddingTop:"10px",borderTop:"1px dashed rgba(0,0,0,0.1)"}},l="cw-scrollbar-style";if(!document.getElementById(l)){let s=document.createElement("style");s.id=l,s.innerHTML=".cw-nice-scroll::-webkit-scrollbar { width: 5px; } .cw-nice-scroll::-webkit-scrollbar-track { background: transparent; } .cw-nice-scroll::-webkit-scrollbar-thumb { background-color: rgba(0,0,0,0.1); border-radius: 10px; }",document.head.appendChild(s)}function g(s){if(!s||typeof s!="string")return"";let c=s,v=/(https?:\/\/[^\s]+)|(www\.[^\s]+)/g;return c=c.replace(v,p=>{let x=p;return x.startsWith("http")||(x="http://"+x),`<a href="${x}" target="_blank" style="color:#1967d2; text-decoration:underline;">${p}</a>`}),c=c.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),c=c.replace(/_(.*?)_/g,"<i>$1</i>"),c=c.replace(/\n/g,"<br>"),c=Yt(c),c=c.replace(/@todos|@all/gi,'<span style="background:#e8f0fe; color:#1967d2; padding:1px 5px; border-radius:4px; font-weight:600; font-size:12px;">@todos</span>'),c}let u=document.createElement("div");u.id="broadcast-popup",u.classList.add("cw-module-window"),Object.assign(u.style,we,{right:"auto",left:"50%",width:"450px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let f={popup:u,googleLine:null};function d(){if(t=!t,Te(t,u,"cw-btn-broadcast"),t){let s=document.getElementById("cw-btn-broadcast");s&&s.classList.remove("has-new"),w()}}let b=Ee(u,"Operations Feed",e,"Atualiza\xE7\xF5es oficiais da opera\xE7\xE3o.",f,()=>d()),_=b.querySelector(".cw-header-actions")||b.lastElementChild;if(_){let s=document.createElement("button");s.textContent="Limpar tudo",Object.assign(s.style,i.markAllBtn),s.onclick=c=>{c.stopPropagation(),Z.playSuccess();let v=Ue.map(p=>p.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(v)),M(),O()},_.insertBefore(s,_.firstChild)}u.appendChild(b);let y=document.createElement("div");y.className="cw-nice-scroll",Object.assign(y.style,i.feedContainer),u.appendChild(y);async function w(){let s=document.getElementById("cw-update-status");t&&(s||(s=document.createElement("div"),s.id="cw-update-status",s.style.cssText="padding: 6px; text-align: center; font-size: 11px; color: #5f6368; background: #f8f9fa; border-bottom: 1px solid #e0e0e0;",y.parentNode.insertBefore(s,y)),s.innerHTML="\u23F3 Verificando atualiza\xE7\xF5es...",s.style.display="block");let c=Ue.map(p=>p.id),v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");try{let p=await He.fetchData();p&&p.broadcast&&(t&&s&&(p.broadcast.some(k=>!c.includes(k.id))?(s.innerHTML="\u2705 Novos avisos sincronizados!",s.style.backgroundColor="#e6f4ea",s.style.color="#137333"):s.innerHTML="\u{1F539} Tudo atualizado.",setTimeout(()=>{s&&(s.style.display="none")},1500)),c.length>0&&p.broadcast.filter(A=>!c.includes(A.id)).filter(A=>!v.includes(A.id)).length>0&&(console.log("\u{1F514} Novo aviso detectado! Tocando som."),Z.playNotification()),_t(p.broadcast),O(),t&&M())}catch(p){console.error("Erro no update:",p),t&&s&&(s.innerHTML="\u26A0\uFE0F Falha na conex\xE3o.",s.style.backgroundColor="#fce8e6")}}function O(){let s=document.getElementById("cw-btn-broadcast");if(!s)return;let c=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Ue.some(p=>!c.includes(p.id))){if(s.classList.add("has-new"),!s.querySelector(".cw-badge")){let p=document.createElement("div");p.className="cw-badge",Object.assign(p.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),s.appendChild(p)}}else{s.classList.remove("has-new");let p=s.querySelector(".cw-badge");p&&p.remove()}}let I=He.getCachedBroadcasts();I.length>0&&(_t(I),M()),w(),o||(o=setInterval(w,n));function M(){y.innerHTML="";let s=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),c=[...Ue].sort((x,k)=>{let A=s.includes(x.id),T=s.includes(k.id);return A===T?0:A?1:-1});if(c.every(x=>s.includes(x.id))){let x=document.createElement("div");Object.assign(x.style,i.emptyState),x.innerHTML=`
           ...
           `,y.appendChild(x)}let v=c.filter(x=>!s.includes(x.id)),p=c.filter(x=>s.includes(x.id));if(v.forEach(x=>y.appendChild(C(x,!1))),p.length>0){let x=document.createElement("div");Object.assign(x.style,i.historyDivider),x.innerHTML=`<span>Visualizar ${p.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let k=document.createElement("div");Object.assign(k.style,i.historyContainer),p.forEach(T=>k.appendChild(C(T,!0)));let A=!1;x.onclick=()=>{Z.playClick(),A=!A,k.style.display=A?"flex":"none",x.querySelector("svg").style.transform=A?"rotate(180deg)":"rotate(0deg)",x.querySelector("span").textContent=A?"Ocultar hist\xF3rico":`Visualizar ${p.length} avisos anteriores`},y.appendChild(x),y.appendChild(k)}}function C(s,c){let v=document.createElement("div");Object.assign(v.style,c?i.cardHistory:i.card);let p=a[s.type]||a.info,x=document.createElement("div");Object.assign(x.style,i.cardHeader,{background:p.bg,color:p.text,borderBottom:`1px solid ${p.border}`});let k=document.createElement("div");if(Object.assign(k.style,{display:"flex",alignItems:"center",gap:"6px"}),k.innerHTML=`${p.icon} <span>${s.type.toUpperCase()}</span>`,x.appendChild(k),c){let T=document.createElement("span");T.textContent=r(s.date),T.style.opacity="0.7",x.appendChild(T)}else{let T=document.createElement("button");T.title="Marcar como lido",Object.assign(T.style,i.dismissBtn),T.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',T.onmouseenter=()=>{T.style.color="#1e8e3e",T.style.background="#e6f4ea",T.style.borderColor="#1e8e3e"},T.onmouseleave=()=>{T.style.color="#5f6368",T.style.background="#fff",T.style.borderColor="rgba(0,0,0,0.1)"},T.onclick=ne=>{ne.stopPropagation(),Z.playClick(),v.style.transform="translateX(20px)",v.style.opacity="0",setTimeout(()=>{let B=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");B.push(s.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(B)),M(),O()},250)},x.appendChild(T)}if(v.appendChild(x),s.title){let T=document.createElement("div");Object.assign(T.style,i.msgTitle),T.textContent=s.title,v.appendChild(T)}if(!c){let T=document.createElement("div");Object.assign(T.style,i.metaContainer),T.innerHTML=`<span style="font-weight:600">${s.author}</span> \u2022 <span>${r(s.date)}</span>`,v.appendChild(T)}let A=document.createElement("div");return Object.assign(A.style,i.cardBody),A.innerHTML=g(s.text),v.appendChild(A),v}M();let q=document.createElement("div");Object.assign(q.style,Ye),q.className="no-drag",u.appendChild(q),Xe(u,q),document.body.appendChild(u);let m=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),h=Ue.some(s=>!m.includes(s.id));return{toggle:d,hasUnread:h}}function Lo(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Vt();try{Z.initGlobalListeners(),Z.playStartup()}catch(a){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",a)}He.fetchTips(),Et();let e=go(),t=bo(),o=ho(),n=xo(),r=yo();io({toggleNotes:e,toggleEmail:t,toggleScript:o,toggleLinks:n,broadcastControl:r})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),oe("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Lo();})();

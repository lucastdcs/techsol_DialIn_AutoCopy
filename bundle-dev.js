...
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var pe=t=>new Promise(e=>setTimeout(e,t));function Se(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>t.dispatchEvent(new MouseEvent(n,e)))}function nt(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(e=>{let n=e.offsetParent!==null,o=e.closest("case-message-view")!==null,i=e.closest(".editor")!==null||e.closest("write-card")!==null;return n&&!o&&i})}async function Xt(){console.log("\u{1F680} FASE 1: Abrindo janela de email...");let t=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");if(n&&n.offsetParent!==null){let u=n.closest("material-button")||n.closest("material-fab")||n;u.style&&(u.style.display="block",u.style.visibility="visible"),Se(u),t=!0}else{let u=document.querySelector("material-fab-speed-dial");if(u){let l=u.querySelector(".trigger");if(l){l.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Se(l),await pe(1e3);let b=Array.from(document.querySelectorAll("i.material-icons-extended")).find(f=>f.innerText.trim()==="email");b&&(Se(b),t=!0)}else u.click()}}if(!t)return J("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;console.log("\u{1F680} FASE 2: Verificando rascunhos (Polling de 3s)...");let o=null,i=0;for(;i<15;){await pe(200);let u=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(u).find(y=>y.offsetParent!==null),o)break;if(nt()){console.log("\u2139\uFE0F Editor apareceu limpo. Sem rascunhos.");break}i++}if(o){console.log("\u26A0\uFE0F RASCUNHO LOCALIZADO! Executando descarte..."),Se(o);let u=o.querySelector(".buttonText");u&&Se(u),o.click(),console.log("\u23F3 Aguardando Confirm...");let l=null,y=0;for(;y<20;){await pe(200);let b=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(l=Array.from(b).find(f=>f.offsetParent!==null),l)break;y++}if(l){console.log("\u2705 Confirmando..."),Se(l);let b=l.querySelector(".content");b&&Se(b),J("Limpando rascunho...",{duration:2e3}),console.log("\u23F3 Aguardando reload do editor p\xF3s-descarte..."),await pe(3e3)}else console.warn("\u274C Confirm n\xE3o apareceu.")}console.log("\u{1F680} FASE 3: Buscando editor final para limpeza...");let s=0,a=nt();for(;!a&&s<20;)await pe(500),a=nt(),s++;if(!a)return J("Erro: Editor n\xE3o carregou ap\xF3s a abertura.",{error:!0}),!1;let c=a.closest('[id="email-body-content-top"]'),m=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(c){if(m){let l=m.closest('[aria-hidden="true"]');l&&l.removeAttribute("aria-hidden"),m.focus()}await pe(300),c.innerHTML=`
    ...
    `,setTimeout(()=>{let s=i.querySelector("#close-help-internal");s&&(s.onmouseover=()=>s.style.backgroundColor="#f8f9fa",s.onmouseout=()=>s.style.backgroundColor="white",s.onclick=()=>{i.style.opacity="0",i.style.pointerEvents="none"})},0),t.appendChild(i),i}var Zt="cw-module-styles",Jt=document.getElementById(Zt);Jt&&Jt.remove();var Tt=document.createElement("style");Tt.id=Zt;Tt.innerHTML=`
    /* M\xD3DULO BASE (Estado Ativo/Normal) */
    .cw-module-window {
        /* Transi\xE7\xE3o Suave para Background e Filtros (Idle) */
        transition: 
            opacity 0.3s ease,
        ...
        /* Visual Ceramic Light (S\xF3lido quando ativo) */
    ...
    .cw-module-window.idle {
        ...
        cursor: pointer;
        z-index: 9900 !important; /* Vai para tr\xE1s de outros m\xF3dulos */
    }
...
`;document.head.appendChild(Tt);function Ee(t,e,n){let o=document.getElementById(n);if(!e)return;e.classList.contains("cw-module-window")||e.classList.add("cw-module-window");let i=e.getAttribute("data-moved")==="true",s={x:0,y:0};if(o){let u=o.getBoundingClientRect();s.x=u.left+u.width/2,s.y=u.top+u.height/2}let a,c;if(!i)a=window.innerWidth/2,c=window.innerHeight/2;else{let u=e.getBoundingClientRect();a=u.left+u.width/2,c=u.top+u.height/2,a===0&&(a=window.innerWidth/2,c=window.innerHeight/2)}let g=s.x-a,m=s.y-c;t?(Q.playGenieOpen(),e.classList.remove("idle"),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",i?e.style.transform=`translate(${g}px, ${m}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${g}px), calc(-50% + ${m}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),o&&o.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",i?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)",setTimeout(()=>{e.style.transition=""},500)}),To(e,n)):(Q.playSwoosh(),e.classList.remove("idle"),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",e.classList.remove("open"),i?e.style.transform=`translate(${g}px, ${m}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${g}px), calc(-50% + ${m}px)) scale(0.1)`}),setTimeout(()=>{o&&o.classList.remove("active"),e.style.transition="",e.style.transform=""},300),eo(e))}function To(t,e){eo(t);let n=o=>{if(!t.classList.contains("open"))return;let i=t.contains(o.target),s=document.querySelector(".cw-pill"),a=s&&s.contains(o.target);i?(t.classList.remove("idle"),t.style.zIndex="10000"):a||t.classList.add("idle")};t._idleHandler=n,document.addEventListener("mousedown",n)}function eo(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}var no="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",kt="cw_data_broadcast",to="cw_data_tips",ko=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function oo(t){return new Promise((e,n)=>{let o="cw_cb_"+Math.round(1e4*Math.random()),i=document.createElement("script");window[o]=s=>{document.body.removeChild(i),delete window[o],e(s)},i.src=`${no}?op=${t}&callback=${o}&t=${Date.now()}`,i.onerror=()=>{document.body.removeChild(i),delete window[o],n(new Error("JSONP Load Error"))},document.body.appendChild(i)})}var je={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let t=await oo("tips");t&&t.tips&&Array.isArray(t.tips)&&(localStorage.setItem(to,JSON.stringify(t.tips)),console.log("\u2705 Dicas atualizadas:",t.tips.length))}catch(t){console.warn("TechSol: Erro ao baixar dicas (Offline).",t)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let t=await oo("broadcast");if(t&&t.broadcast)return localStorage.setItem(kt,JSON.stringify(t.broadcast)),console.log("\u2705 Broadcasts atualizados:",t.broadcast.length),t}catch(t){console.warn("TechSol: Erro ao buscar Broadcasts.",t)}return{broadcast:JSON.parse(localStorage.getItem(kt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(kt)||"[]"),getRandomTip:()=>{let t=ko,e=localStorage.getItem(to);if(e)try{t=JSON.parse(e)}catch{}return t[Math.floor(Math.random()*t.length)]},logUsage:(t,e="")=>{let o={op:"log",user:window._USER_ID||"agente_anonimo",action:t,meta:e};fetch(no,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(o)}).catch(i=>console.log("Log fail",i))}};var ae={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},lt=t=>new Promise(e=>setTimeout(e,t));function ao(t){let e="cw-command-center-style";if(!document.getElementById(e)){let b=document.createElement("style");b.id=e,b.innerHTML=`

...
\u2022 Tentativa 2 -`}};var fe=e=>new Promise(t=>setTimeout(t,e));function ve(e,t="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,n[t]||n.info)}function qe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function xt(e,t){if(!e)return;let n=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=e.getBoundingClientRect(),i=document.createElement("div");i.id=n,i.style.cssText=`
    ...
    .cw-pill {
        ...
        /* ABRIR: A p\xEDlula expande IMEDIATAMENTE (Delay 0s) */
        transition: 
    ...
    .cw-pill.collapsed {
        ...
        padding: 0 !important;
        gap: 0 !important; /* Importante para n\xE3o somar altura */
        ...
        /* Isso for\xE7a a p\xEDlula a ficar "congelada" enquanto os \xEDcones somem */
        transition: 
    ...
    .cw-pill.collapsed .cw-main-logo { 
        ...
        /* Delay alto (0.8s) para entrar s\xF3 no finalzinho */
        transition: all 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) 0.8s;
    }
    
    /* --- EFEITO GRADIENTE (S\xD3 NO HOVER) --- */
    .cw-pill.collapsed:hover .cw-main-logo svg {
        /* Esconde o SVG branco e mostra o fundo do container pai que ter\xE1 o gradiente? */
    ...
    .cw-pill.collapsed > *:not(.cw-main-logo) {
        ...
        /* Termina em 0.3s. A p\xEDlula come\xE7a a fechar em 0.4s. Margem segura. */
        transition: 
            opacity 0.3s ease 0s, 
    ...
    .cw-center-success { display: none; color: ${ge.green}; }
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let d=r.querySelector(".cw-hero-grid"),c=r.querySelector(".cw-acc-container"),f=r.querySelector(".cw-results-container"),y=r.querySelector(".cw-search-input"),x=r.querySelector(".cw-status-bar"),g=r.querySelector(".cw-status-text"),C=r.querySelector(".cw-footer-icons");s.forEach(([v,A])=>{let k=o(A.name),F=document.createElement("div");F.className="cw-hero-card",F.id=`hero-${v}`,F.style.setProperty("--hero-color",k.color),F.innerHTML=`
        ...
        `,F.onclick=()=>{c.querySelectorAll(".cw-acc-group.open").forEach(w=>{w!==k&&w.classList.remove("open")}),k.classList.toggle("open")};let M=document.createElement("div");M.className="cw-acc-body",A.tasks.forEach(w=>{let I=T(w.key,w);M.appendChild(I)}),k.appendChild(F),k.appendChild(M),c.appendChild(k)});function P(v,A,k){t[v]||(t[v]={count:0,data:k,brand:o(k.name)}),t[v].count+=A,t[v].count<=0&&delete t[v],z(),j(),e&&e()}function z(){s.forEach(([M])=>{let w=d.querySelector(`#hero-${M}`);if(!w)return;let I=t[M];I?(w.classList.add("active"),w.querySelector(".cw-step-val").textContent=I.count,w.querySelector(".cw-step-val").style.color=w.dataset.color):w.classList.remove("active")}),r.querySelectorAll(".cw-task-item").forEach(M=>{let w=M.dataset.id,I=t[w];I?(M.classList.add("selected"),M.querySelector(".cw-step-val").textContent=I.count):M.classList.remove("selected")});let A=Object.keys(t),k=0,F=[];if(A.forEach(M=>{let w=t[M];k+=w.count;for(let I=0;I<w.count;I++)F.length<6&&F.push(w.brand)}),k>0){x.classList.add("visible");let M=k>1?"A\xE7\xF5es":"A\xE7\xE3o",w=k>1?"definidas":"definida";g.textContent=`${k} ${M} ${w}`,C.innerHTML="",F.forEach(I=>{let h=document.createElement("div");h.className="cw-mini-icon",h.innerHTML=Ye[I.icon]||Ye.default;let S=h.querySelector("svg");S&&(S.style.width="14px",S.style.height="14px"),C.appendChild(h)})}else x.classList.remove("visible")}y.addEventListener("input",v=>{let A=v.target.value.toLowerCase();if(A.length>0){c.style.display="none",f.style.display="block",f.innerHTML="";let k=!1;Object.entries(ze).forEach(([F,M])=>{if(M.name.toLowerCase().includes(A)){k=!0;let w=T(F,M);t[F]&&(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=t[F].count),f.appendChild(w)}}),k||(f.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else c.style.display="block",f.style.display="none"});function j(){m.innerHTML="";let v=Object.keys(t),A=!1,k=document.getElementById("sub-status"),F="implementation";if(k&&k.value.toLowerCase().includes("education")&&(F="education"),v.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(v.length===0){m.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let M=document.createElement("div");M.className="cw-info-banner",M.innerHTML=`
...
\u2022 `)?(Y.preventDefault(),this.value=J.substring(0,D-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=D-3):J==="\u2022 "&&(Y.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function Mt(){let E=typeof Oe<"u"?Oe:document.getElementById("snippet-container");if(!E)return;let Y=E.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),D={},J=new Set;Y.forEach(re=>{let ie=re.id,K=Ie[ie];if(K)for(let V in K)V==="linkedTask"?J.add(K.linkedTask):V!=="type"&&(D[V]||(D[V]=[]),D[V].includes(K[V])||D[V].push(K[V]))});let ce=new Set;Object.values(Ie).forEach(re=>{Object.keys(re).forEach(ie=>{ie!=="linkedTask"&&ie!=="type"&&ce.add(ie)})}),ce.forEach(re=>{let ie=document.getElementById(re);if(ie){let K=D[re]||[],V="";ct.includes(re.replace("field-",""))?(V=K.map(ae=>ae.startsWith("\u2022 ")?ae:"\u2022 "+ae).join(`
`),V===""?V="\u2022 ":V.endsWith(`
\u2022 `)||(V+=`
\u2022 `)):V=K.join(`

`),V.trim()!=="\u2022"&&V.trim()!==""?ie.value=V:ct.includes(re.replace("field-",""))?ie.value="\u2022 ":ie.value="",ie.tagName==="TEXTAREA"&&typeof Ft=="function"&&Ft(ie)}});let me=new Set,ke=new Set;E.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(re=>{let ie=Ie[re.id];ie&&ie.linkedTask&&(re.checked?me.add(ie.linkedTask):ke.add(ie.linkedTask))}),ke.forEach(re=>{me.has(re)||p.toggleTask(re,!1)}),me.forEach(re=>{p.toggleTask(re,!0)})}L.onchange=()=>{let E=L.value;if(Lt(1.5),b.innerHTML=`<option value="">${oe("select_substatus")}</option>`,!E){b.disabled=!0;return}for(let Y in lt){let D=lt[Y];if(D.status===E){let J=document.createElement("option");J.value=Y,J.textContent=D.name,b.appendChild(J)}}b.disabled=!1},b.onchange=()=>{let E=b.value;if(Lt(1.5),!E)return;p.updateSubStatus(E);let Y=lt[E];Oe.innerHTML="";let D=(K,V,ae)=>{let ue=document.createElement("label");Object.assign(ue.style,a.checkboxLabel),ue.onmouseover=()=>ue.style.backgroundColor="#e8eaed",ue.onmouseout=()=>ue.style.backgroundColor="#f8f9fa";let de=document.createElement("input");return de.type=V,de.id=K.id,Object.assign(de.style,a.checkboxInput),ue.appendChild(de),ue.appendChild(document.createTextNode(` ${K.text}`)),ae.appendChild(ue),de},J=[],ce="radio";if(E==="NI_Awaiting_Inputs")J=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(E.startsWith("SO_"))ce="checkbox",J=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"},{id:"quickfill-ga4-event-close",text:"Fechamento GA4 (P\xF3s 2 dias)"}];else if(E.startsWith("AS_")){ce="checkbox";let K=document.createElement("label");K.textContent=oe("cenarios_comuns"),Object.assign(K.style,a.label),Oe.appendChild(K),J=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else E.startsWith("IN_")?J=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:E.startsWith("DC_")?(ce="radio",J=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]):E==="NI_Attempted_Contact"?(ce="radio",J=[{id:"quickfill-ni-attempted-2day",text:"2 Day Rule (2 Liga\xE7\xF5es + Chat AM)"}]):E==="NI_Awaiting_Validation"&&(ce="checkbox",J=[{id:"quickfill-ni-awaiting-ecw4",text:"ECW4 (Acompanhar)"},{id:"quickfill-ni-awaiting-ga4",text:"GA4 Event Tracking (Acompanhar)"}]);let me=J.filter(K=>{let V=Ie[K.id];return!V.type||V.type==="all"||V.type===t});me.forEach((K,V)=>{let ae=D(K,ce,Oe);ce==="radio"&&(ae.name="scenario-radio-group",V===0&&(ae.checked=!0))}),me.length>0&&(Be.style.display="block"),Y.requiresTasks?(he.style.display="none",Pe.style.display="block",p.selectionElement.style.display="block"):(he.style.display="block",Pe.style.display="none",p.selectionElement.style.display="none"),De.innerHTML="";let ke=Y.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(ke)].forEach(K=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(K))return;let V=K.slice(1,-1),ae=document.createElement("label"),ue=oe(V.toLowerCase());if(ae.textContent=ue!==V.toLowerCase()?ue:V.replace(/_/g," ").replace(/\b\w/g,ee=>ee.toUpperCase())+":",Object.assign(ae.style,a.label),V==="SPEAKEASY_ID"){let ee=document.createElement("button");ee.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',ee.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
...
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):ie.tagName==="TEXTAREA"&&(ae=ae.replace(/\n/g,"<br>"));let ue=ae.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ue===""||ue==="\u2022"||ue.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${K}\\}(?:<br>\\s*)?`,"gi");ee.test(D)?D=D.replace(ee,""):D=D.replace(V,"")}else D=D.replace(V,ae.replace(/\$/g,"$$$$"))}),D=D.replace(/{([A-Z0-9_]+)}/g,""),D=D.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(D+=r.getOutput()),D}ot.onclick=()=>{let E=Xt();E?(dt(E),U(oe("copiado_sucesso"))):U(oe("selecione_substatus"),{error:!0})},nt.onclick=async()=>{let E=b.value,Y=Xt();if(!Y){U(oe("selecione_substatus"),{error:!0});return}dt(Y),_t();let D=Ct(),J=await Tt();if(J)try{if(J.focus(),J.innerHTML.trim()==="<p><br></p>"||J.innerHTML.trim()==="<br>"||J.innerText.trim()===""){let be=document.createRange();be.selectNodeContents(J);let re=window.getSelection();re.removeAllRanges(),re.addRange(be),document.execCommand("delete",!1,null)}else if(!J.innerHTML.endsWith("<br><br>")){let be=document.createRange();be.selectNodeContents(J),be.collapse(!1);let re=window.getSelection();re.removeAllRanges(),re.addRange(be),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,Y),Et(J),setTimeout(()=>{U(oe("inserido_copiado"))},600);let me=typeof $e<"u"&&$e?$e.checked:!0;if(E&&We[E]&&me){let be=We[E];await vt(be),await new Promise(re=>setTimeout(re,500))}D(),Lt(1.5),L.value="",b.innerHTML=`<option value="">${oe("select_substatus")}</option>`,b.disabled=!0}catch(ce){console.error(ce),U("Erro ao inserir.",{error:!0}),D()}};function Lt(E=1.5){E<=1.5&&(Be.style.display="none",Oe.innerHTML=""),E<=2&&(p.reset(),he.style.display="none"),E<=3&&(Ce.style.display="none",De.innerHTML="",r.reset(),Qe.style.display="none",je.style.display="none")}function _t(){if(s=!s,s){let E=m.querySelector(".cw-expand-btn");E&&typeof E.resetState=="function"&&E.resetState()}Te(s,m,"cw-btn-notes")}return It("bau"),qt("pt"),_t}var Xe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function Oo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Se,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function p(){i=!i,Te(i,a,"cw-btn-script")}let m=Ee(a,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{p()});a.appendChild(m);let d=document.createElement("div");Object.assign(d.style,t.progressBarContainer);let c=document.createElement("div");Object.assign(c.style,t.progressBarFill),d.appendChild(c),a.appendChild(d);let f=document.createElement("div");f.id="csa-content",Object.assign(f.style,t.contentArea),a.appendChild(f);let y=document.createElement("div");Object.assign(y.style,t.footer);let x=document.createElement("span");x.textContent="by lucaste@",Object.assign(x.style,{fontSize:"10px",color:"#bdc1c6"});let g=document.createElement("button");g.innerHTML=`
  ...
  `,g.onfocus=()=>{y.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",y.style.border="1px solid #1a73e8"},g.onblur=()=>{y.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",y.style.border="1px solid transparent"},y.appendChild(x),y.appendChild(g),f.appendChild(y),c.appendChild(f);let C=document.createElement("div");C.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",c.appendChild(C);let T=null;function P(){if(T)return;T=document.createElement("div"),T.style.cssText=`
      ...
      `;let h=document.createElement("div");h.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",h.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let S=document.createElement("button");S.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',S.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",S.onclick=()=>{j(),s=!1,F()},h.appendChild(S),T.appendChild(h);let L=document.createElement("div");L.id="cw-history-list",L.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",T.appendChild(L),c.appendChild(T)}function z(){T||P();let h=T.querySelector("#cw-history-list");h.innerHTML="";let S=Zo();S.length===0?h.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':S.forEach(L=>{let l=w(L,Ke[L._originalCat],!0,L._originalCat);h.appendChild(l)}),requestAnimationFrame(()=>T.style.transform="translateY(0)")}function j(){T&&(T.style.transform="translateY(100%)")}function v(){d.innerHTML="";let h=A("history","Recentes",Ke.history);h.id="cw-sidebar-btn-history",h.onclick=()=>{X.playClick(),s=!s,s?z():j(),F()},d.appendChild(h);let S=document.createElement("div");S.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(S),Object.keys(pt).forEach(L=>{let l=pt[L],u=A(L,l.label,Ke[L]);u.id=`cw-sidebar-btn-${L}`,u.onclick=()=>{X.playClick(),s&&(s=!1,j()),k(L)},d.appendChild(u)})}function A(h,S,L){let l=document.createElement("div");l.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,l.title=S,l.dataset.key=h;let u=document.createElement("div");u.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",u.innerHTML=L||Ke.tasks;let O=document.createElement("div");return O.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",O.textContent=S,l.appendChild(u),l.appendChild(O),l.onmouseenter=()=>{o!==h&&!(h==="history"&&s)&&(l.style.background="#F1F3F4",u.style.transform="scale(1.1)")},l.onmouseleave=()=>{o!==h&&!(h==="history"&&s)&&(l.style.background="transparent",u.style.transform="scale(1)")},l}function k(h){let S=document.getElementById(`cat-anchor-${h}`);S&&(S.scrollIntoView({behavior:"smooth",block:"start"}),o=h,F())}function F(){Object.keys(pt).forEach(S=>{let L=d.querySelector(`#cw-sidebar-btn-${S}`);if(L)if(o===S&&!s){let l=kt[S];L.style.background=l.bg,L.style.color=l.color,L.querySelector("div:first-child").style.transform="scale(1.1)"}else L.style.background="transparent",L.style.color=i.textSecondary,L.querySelector("div:first-child").style.transform="scale(1)"});let h=d.querySelector("#cw-sidebar-btn-history");h&&(s?(h.style.background="#3C4043",h.style.color="#FFFFFF"):(h.style.background="transparent",h.style.color=i.textSecondary))}function M(){if(C.innerHTML="",t.trim()!==""){let S=[];if(Object.entries(pt).forEach(([l,u])=>{let O=u.links.filter(b=>b.name.toLowerCase().includes(t.toLowerCase())||b.desc.toLowerCase().includes(t.toLowerCase()));S.push(...O.map(b=>({...b,_cat:l})))}),S.length===0){C.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let L=document.createElement("div");L.innerHTML="Resultados da busca",L.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",C.appendChild(L),S.forEach(l=>{let u=w(l,Ke[l._cat],!1,l._cat);C.appendChild(u)});return}Object.entries(pt).forEach(([S,L])=>{let l=kt[S],u=document.createElement("div"),O=document.createElement("div");O.id=`cat-anchor-${S}`,O.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,O.innerHTML=`
            ...
            ${L.label}
          `,u.appendChild(O);let b=document.createElement("div");b.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",L.links.forEach(G=>{let R=w(G,Ke[S],!1,S);b.appendChild(R)}),u.appendChild(b),C.appendChild(u)});let h=document.createElement("div");h.style.height="80px",C.appendChild(h)}function w(h,S,L,l){let u=document.createElement("div"),O=kt[l]||kt.history;u.style.cssText=`

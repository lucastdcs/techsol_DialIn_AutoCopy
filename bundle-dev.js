...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var oe=e=>new Promise(t=>setTimeout(t,e));function xe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Ye(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,r=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&r})}async function It(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(i=>i.innerText.trim()==="email");if(n&&n.offsetParent!==null){let i=n.closest("material-button")||n.closest("material-fab")||n;i.style&&(i.style.display="block",i.style.visibility="visible"),xe(i),e=!0}else{let i=document.querySelector("material-fab-speed-dial");if(i){let p=i.querySelector(".trigger");if(p){p.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),xe(p),await oe(1e3);let y=Array.from(document.querySelectorAll("i.material-icons-extended")).find(m=>m.innerText.trim()==="email");y&&(xe(y),e=!0)}else i.click()}}let o=0,r=Ye();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!r&&o<30;)await oe(500),r=Ye(),o++;if(!r)return X("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let s=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(i=>i.offsetParent!==null);if(s){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),xe(s);let i=null,p=0;for(;!i&&p<10;)await oe(200),i=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(y=>y.offsetParent!==null),p++;i?(console.log("\u2705 Confirmando descarte..."),xe(i),await oe(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(r){let i=r.closest('[id="email-body-content-top"]'),S=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(i){if(S){let m=S.closest('[aria-hidden="true"]');m&&m.removeAttribute("aria-hidden"),S.focus()}await oe(300),i.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let y=i.querySelector("#cases-body-field");if(y){let m=document.createRange();m.selectNodeContents(y),m.collapse(!0);let C=window.getSelection();C.removeAllRanges(),C.addRange(m)}return!0}}return X("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function _t(e){if(!e)return;X("Preparando email...",{duration:3e3});let t=dt();if(!await It())return;await oe(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await oe(200),xe(o),await oe(1500);let r=document.querySelector("material-auto-suggest-input input");if(r){xe(r),await oe(200),document.execCommand("insertText",!1,e),r.dispatchEvent(new Event("input",{bubbles:!0}));let a=null,s=0;for(;s<20;){await oe(500),s++;let i=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(i.length>0&&(a=i.find(p=>p.innerText.toLowerCase().includes(e.toLowerCase())),!a&&i.length===1&&(a=i[0]),a))break}if(a){let i=function(m,C){if(m.nodeType===3&&m.nodeValue.includes(C))return m;if(!m.childNodes)return null;for(let b of m.childNodes){let x=i(b,C);if(x)return x}return null};xe(a),await oe(2e3);let p=Ye(),S=p?p.closest('[id="email-body-content-top"]'):document.body,y=i(S,"{%ADVERTISER_NAME%}");if(y){let m=document.createRange(),C=y.nodeValue.indexOf("{%ADVERTISER_NAME%}");m.setStart(y,C),m.setEnd(y,C+19);let b=window.getSelection();b.removeAllRanges(),b.addRange(m),document.execCommand("insertText",!1,t.advertiserName),X("Email preenchido!")}else X("Email inserido (Nome n\xE3o substitu\xEDdo).")}else X(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else X("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function bt(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),X("Preparando email...",{duration:3e3});let t=dt(),n=ct();if(!await It())return;await oe(600);let r=document.querySelector('input[aria-label="Subject"]');r&&e.subject&&(r.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(r,e.subject),r.dispatchEvent(new Event("input",{bubbles:!0})),await oe(300));let a=Ye();if(a){let i=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');i&&(i.focus(),i.click(),i.dispatchEvent(new Event("input",{bubbles:!0}))),await oe(400);let p=new Date;p.setDate(p.getDate()+3);let S=p.getDay();S===6?p.setDate(p.getDate()+2):S===0&&p.setDate(p.getDate()+1);let y=p.toLocaleDateString("pt-BR"),m=e.body;m=m.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),m=m.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),m=m.replace(/\[URL\]/g,t.websiteUrl||"seu site"),m=m.replace(/\[Seu Nome\]/g,n),m=m.replace(/\[MM\/DD\/YYYY\]/g,y),document.execCommand("insertHTML",!1,m),i&&(i.dispatchEvent(new Event("input",{bubbles:!0})),i.dispatchEvent(new Event("change",{bubbles:!0}))),X("Email preenchido com sucesso!",{duration:2e3}),await oe(800)}else X("Erro ao focar no editor.",{error:!0})}var Xt={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Nt={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function ye(e,t,n,o,r,a){let s=document.createElement("div");Object.assign(s.style,Xt),kt(e,s);let i=document.createElement("div");Object.assign(i.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),s.appendChild(i),r&&(r.googleLine=i);let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center",gap:"12px"});let S=document.createElement("img");S.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(S.style,{width:"20px",height:"20px",pointerEvents:"none"});let y=document.createElement("span");y.textContent=t,p.appendChild(S),p.appendChild(y);let m=document.createElement("div");Object.assign(m.style,{display:"flex",alignItems:"center",gap:"4px"});let C='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',b='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',x=document.createElement("div");x.innerHTML=C,Object.assign(x.style,Nt),x.title="Sobre",x.classList.add("no-drag"),x.onmouseenter=()=>{x.style.background="rgba(255,255,255,0.1)",x.style.color="#FFF"},x.onmouseleave=()=>{x.style.color!=="rgb(138, 180, 248)"&&(x.style.background="transparent",x.style.color="#9AA0A6")};let E=document.createElement("div");E.innerHTML=b,Object.assign(E.style,Nt),E.title="Fechar",E.classList.add("no-drag"),E.onmouseenter=()=>{E.style.background="rgba(242, 139, 130, 0.2)",E.style.color="#F28B82"},E.onmouseleave=()=>{E.style.background="transparent",E.style.color="#9AA0A6"},E.onmousedown=k=>k.stopPropagation(),x.onmousedown=k=>k.stopPropagation(),E.onclick=a;let A=Kt(e,t,n,o);return x.onclick=k=>{k.stopPropagation(),A.style.opacity==="1"?(A.style.opacity="0",A.style.pointerEvents="none",x.style.color="#9AA0A6",x.style.background="transparent"):(A.style.opacity="1",A.style.pointerEvents="auto",x.style.color="#8AB4F8",x.style.background="rgba(138, 180, 248, 0.1)")},m.appendChild(x),m.appendChild(E),s.appendChild(p),s.appendChild(m),s}function Kt(e,t,n,o){let r=document.createElement("div");return Object.assign(r.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),r.innerHTML=`
...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=b=>{b.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=b=>{b.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=b=>{b.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=b=>{b.stopPropagation(),e.toggleLinks()},(async function(){await Xe(2800),o.classList.add("docked"),await Xe(300);let x=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(A=>A.classList.add("visible"));for(let A=0;A<x.length;A++)x[A].classList.add("popped"),await Xe(90);await Xe(200),o.classList.add("system-check")})();let a=!1,s,i,p,S,y=3;o.onmousedown=b=>{if(b.target.closest("button"))return;b.preventDefault(),s=b.clientX,i=b.clientY;let x=o.getBoundingClientRect();p=x.left,S=x.top,document.addEventListener("mousemove",m),document.addEventListener("mouseup",C)};function m(b){let x=b.clientX-s,E=b.clientY-i;!a&&Math.sqrt(x*x+E*E)>y&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${p+x}px`,o.style.top=`${S+E}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function C(b){if(document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",C),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let x=window.innerWidth,E=window.innerHeight,A=o.getBoundingClientRect(),k=A.left+A.width/2,G;k<x/2?(G=24,o.classList.remove("side-right"),o.classList.add("side-left")):(G=x-A.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let B=A.top;B<24&&(B=24),B>E-A.height-24&&(B=E-A.height-24),o.style.left=`${G}px`,o.style.top=`${B}px`,setTimeout(()=>{},600)}else{let x=b.target.closest("button");x&&(x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="",150))}}}function Ke(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let s=Date.now()-r,i=Math.max(0,1500-s);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},i)}}var Lt=e=>new Promise(t=>setTimeout(t,e));function Qe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function gt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{X("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Gt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Dt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Ft(){console.log("Iniciando processo de Nova Nota...");let e=Dt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(s=>s.innerText.trim()==="description");if(o){let s=o.closest("material-fab")||o.closest("material-button");s?(s.style&&(s.style.display="block",s.style.visibility="visible"),Qe(s)):Qe(o)}else{let s=document.querySelector("material-fab-speed-dial");if(s){let i=s.querySelector(".trigger");i?(i.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Qe(i)):s.click(),await Lt(800);let S=Array.from(document.querySelectorAll("i.material-icons-extended")).find(y=>y.innerText.trim()==="description");S&&Qe(S)}}let r=null,a=0;for(;!r&&a<20;){await Lt(300);let s=Dt();if(s.length>t)r=s.find(i=>!e.includes(i)),r||(r=s[s.length-1]);else if(a>10){let i=s.filter(p=>p.offsetParent!==null);i.length>0&&(r=i[i.length-1])}a++}return r}var Zt={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto'",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},yo={...Zt,height:"100px",resize:"vertical"};var ft={width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"};var Jt={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},eo={fontSize:"12px",color:"#e37400",marginTop:"4px"},to={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},oo={display:"flex",gap:"15px",marginBottom:"10px"};function Pt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Jt);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,Le,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,oo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,ft);let r=document.createElement("label");r.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(r);let s=document.createElement("input");s.type="radio",s.name="ts_usage_mod",s.value="N\xE3o",s.checked=!0,Object.assign(s.style,ft);let i=document.createElement("label");i.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(s),p.appendChild(i),n.appendChild(a),n.appendChild(p);let S=document.createElement("div");S.style.display="block";let y=document.createElement("label");y.textContent="Qual foi o Motivo?",Object.assign(y.style,Le,{fontSize:"12px"});let m=document.createElement("input");m.type="text",Object.assign(m.style,to);let C=document.createElement("div");C.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(C.style,eo),S.appendChild(y),S.appendChild(m),S.appendChild(C),e.appendChild(t),e.appendChild(n),e.appendChild(S),o.onchange=()=>{S.style.display="none"},s.onchange=()=>{S.style.display="block"};function b(A,k){if(e.style.display="none",!A||A.includes("Education")||!k||k.length===0)return;let G=k.some(c=>c.includes("enhanced")||c==="ec_google_ads"),B=k.some(c=>(c.includes("conversion")||c.includes("ads"))&&!c.includes("enhanced")),g=k.some(c=>c.includes("ga4")||c.includes("analytics")||c.includes("ua")),d=k.some(c=>c.includes("merchant")||c.includes("gmc")||c.includes("shopping"));(G||B&&!g&&!d)&&(e.style.display="block")}function x(){if(e.style.display==="none")return"";let A=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return s.checked&&m.value.trim()!==""&&(A+=`<br><b>Motivo:</b> ${m.value}`),A+="<br>",A}function E(){e.style.display="none",s.checked=!0,o.checked=!1,S.style.display="block",m.value=""}return{element:e,updateVisibility:b,getOutput:x,reset:E}}var D={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},je={ads:'<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>',ga4:'<svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2v-3h2v3zm4 0h-2v-5h2v5z"/></svg>',gtm:'<svg viewBox="0 0 24 24"><path d="M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58.55 0 1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41 0-.55-.23-1.06-.59-1.42zM5.5 7C4.67 7 4 6.33 4 5.5S4.67 4 5.5 4 7 4.67 7 5.5 6.33 7 5.5 7z"/></svg>',gmc:'<svg viewBox="0 0 24 24"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>',default:'<svg viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>'};function jt(e){let t={};function n(g){let d=g.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?D.brands.ads:d.includes("ga4")||d.includes("analytics")?D.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?D.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?D.brands.gmc:D.brands.default}let o=Object.entries(Ie).filter(([g,d])=>d.popular),r={};Object.entries(Ie).forEach(([g,d])=>{if(d.popular)return;let l=n(d.name);r[l.label]||(r[l.label]={brand:l,tasks:[]}),r[l.label].tasks.push({key:g,...d})});let a="cw-zen-tasks";if(!document.getElementById(a)){let g=document.createElement("style");g.id=a,g.innerHTML=`
            ...
            /* HERO CARD (Compacto & T\xE1til) */
            .cw-hero-card {
                background: ${D.white}; border-radius: 12px; padding: 10px 12px;
                box-shadow: ${D.shadowCard}; border: 1px solid transparent;
            ...
            .cw-hero-icon { 
                width: 32px; height: 32px; border-radius: 8px; background: #F3F4F6; color: ${D.textSub};
                display: flex; align-items: center; justify-content: center; flex-shrink: 0; transition: all 0.2s;
            }
            .cw-hero-icon svg { width: 18px; height: 18px; fill: currentColor; }
            .cw-hero-label { font-size: 12px; font-weight: 500; color: ${D.textMain}; line-height: 1.2; }

            /* Hero Active */
            .cw-hero-card.active { background: ${D.white}; border-color: ${D.blue}; }
            .cw-hero-card.active .cw-hero-icon { background: ${D.blue}; color: white; }
            .cw-hero-card.active .cw-hero-label { color: ${D.blue}; font-weight: 600; }

            /* Hero Stepper (Overlay) */
            .cw-hero-stepper {
                position: absolute; right: 4px; top: 4px; bottom: 4px;
                background: ${D.white}; border-radius: 8px; padding: 0 4px;
            ...
            /* Se ele esticar, centralizamos o conte\xFAdo para ficar bonito */
            .cw-hero-card:last-child:nth-child(odd) {
                justify-content: center; /* Opcional: ou manter alinhado \xE0 esquerda */
            }
            ...
            /* \xCDcone na Lista (Miniatura do Hero) */
            .cw-list-icon {
        ...
        `,document.head.appendChild(g)}let s=document.createElement("div");s.className="cw-zen-container";let i=document.createElement("div");Object.assign(i.style,{display:"none"});let p=document.createElement("div");i.appendChild(p),s.innerHTML=`
    ...
    `;let S=s.querySelector(".cw-hero-grid"),y=s.querySelector(".cw-acc-container"),m=s.querySelector(".cw-results-container"),C=s.querySelector(".cw-search-input"),b=s.querySelector(".cw-status-bar"),x=s.querySelector(".cw-status-text"),E=s.querySelector(".cw-status-icons");o.forEach(([g,d])=>{let l=n(d.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${g}`,c.innerHTML=`
            <div class="cw-hero-icon">${je[l.icon]}</div>
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;k(g,h>0?-h:1,d)},c.querySelector(".minus").onclick=()=>k(g,-1,d),c.querySelector(".plus").onclick=()=>k(g,1,d),c.dataset.color=l.color,S.appendChild(c)}),Object.entries(r).forEach(([g,d])=>{let l=document.createElement("div");l.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${d.brand.color}"></div>
                ${g}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{y.querySelectorAll(".cw-acc-group.open").forEach(h=>{h!==l&&h.classList.remove("open")}),l.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",d.tasks.forEach(h=>{let w=A(h.key,h);v.appendChild(w)}),l.appendChild(c),l.appendChild(v),y.appendChild(l)});function A(g,d){let l=n(d.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=g,c.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${l.bg}; color:${l.color}">
                    ${je[l.icon]||je.default}
                </div>
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;k(g,h>0?-h:1,d)},c.querySelector(".minus").onclick=()=>k(g,-1,d),c.querySelector(".plus").onclick=()=>k(g,1,d),c}function k(g,d,l){t[g]||(t[g]={count:0,data:l,brand:n(l.name)}),t[g].count+=d,t[g].count<=0&&delete t[g],G(),B(),e&&e()}function G(){o.forEach(([v])=>{let h=S.querySelector(`#hero-${v}`);if(!h)return;let w=t[v];if(w){h.classList.add("active"),h.style.borderColor=h.dataset.color;let O=h.querySelector(".cw-hero-icon");O.style.backgroundColor=h.dataset.color,O.style.color="white",h.querySelector(".cw-step-val").textContent=w.count}else{h.classList.remove("active"),h.style.borderColor="transparent";let O=h.querySelector(".cw-hero-icon");O.style.backgroundColor="#F3F4F6",O.style.color=D.textSub}}),s.querySelectorAll(".cw-task-item").forEach(v=>{let h=v.dataset.id,w=t[h];w?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=w.count):v.classList.remove("selected")});let d=Object.keys(t),l=0,c=[];if(d.forEach(v=>{let h=t[v];l+=h.count;for(let w=0;w<h.count;w++)c.length<6&&c.push(h.brand)}),l>0){footer.classList.add("visible");let v=l>1?"A\xE7\xF5es":"A\xE7\xE3o",h=l>1?"definidas":"definida";footerCount.textContent=`${l} ${v} ${h}`,footerIcons.innerHTML="",c.forEach(w=>{let O=document.createElement("div");O.className="cw-mini-icon",O.style.backgroundColor=w.color,O.innerHTML=je[w.icon]||je.default;let T=O.querySelector("svg");T&&(T.style.width="12px",T.style.height="12px"),footerIcons.appendChild(O)})}else footer.classList.remove("visible")}C.addEventListener("input",g=>{let d=g.target.value.toLowerCase();if(d.length>0){y.style.display="none",m.style.display="block",m.innerHTML="";let l=!1;Object.entries(Ie).forEach(([c,v])=>{if(v.name.toLowerCase().includes(d)){l=!0;let h=A(c,v);t[c]&&(h.classList.add("selected"),h.querySelector(".cw-step-val").textContent=t[c].count),m.appendChild(h)}}),l||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else y.style.display="block",m.style.display="none"});function B(){p.innerHTML="";let g=Object.keys(t),d=!1,l="implementation";g.forEach(c=>{let v=t[c].data,h=t[c].count,w=v.screenshots?v.screenshots[l]||[]:[];if(w.length>0){d=!0;let O=document.createElement("div");for(let T=1;T<=h;T++){let U=document.createElement("div"),I=document.createElement("input");I.id=`name-${c}-${T}`,I.value=`${v.name}${h>1?" #"+T:""}`,U.appendChild(I),w.forEach((N,te)=>{let j=document.createElement("label");j.textContent=N;let q=document.createElement("input");q.id=`screen-${c}-${T}-${te}`,U.appendChild(j),U.appendChild(q)}),O.appendChild(U)}p.appendChild(O)}}),i.style.display=d?"block":"none"}return{selectionElement:s,screenshotsElement:i,updateSubStatus:()=>B(),getCheckedElements:()=>Object.keys(t).map(g=>({value:g,closest:()=>({querySelector:()=>({textContent:t[g].count})})})),reset:()=>{for(let g in t)delete t[g];G(),B(),C.value="",y.style.display="block",m.style.display="none"}}}function zt(){let e="v3.6.0",t="bau",n="pt",o=!1,r=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},s=Pt(),i=jt(()=>{let _=i.getCheckedElements().map(f=>f.value);I&&I.value&&s.updateVisibility(I.value,_)}),p=document.createElement("div");p.id="autofill-popup",Object.assign(p.style,he,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),p.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let y=ye(p,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:p,googleLine:null},()=>lt()),m=y.lastElementChild;if(m){let u=document.createElement("div");u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',u.classList.add("no-drag"),Object.assign(u.style,{fontSize:"20px",color:"#9AA0A6",cursor:"pointer",padding:"8px",display:"flex",alignItems:"center",justifyContent:"center",marginRight:"4px",marginLeft:"auto",borderRadius:"50%",transition:"background 0.2s, transform 0.3s ease"}),u.title="Expandir/Contrair Janela",u.onmouseover=()=>u.style.backgroundColor="#e8eaed",u.onmouseout=()=>u.style.backgroundColor="transparent";let _=!1;u.onclick=()=>{_=!_,u.style.transform=_?"rotate(180deg)":"rotate(0deg)",p.style.width=_?"700px":"380px",_?u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>':u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>'};let f=m.lastElementChild;f?m.insertBefore(u,f):m.appendChild(u)}p.appendChild(y);let C=document.createElement("div");Object.assign(C.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),p.appendChild(C);let b=document.createElement("div");b.textContent="created by lucaste@",Object.assign(b.style,$e),p.appendChild(b);let x=document.createElement("div");x.id="step-lang-type";let E=document.createElement("label");Object.assign(E.style,a.label),x.appendChild(E);let A=document.createElement("div");Object.assign(A.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let k=document.createElement("div");k.textContent="Portugu\xEAs",k.classList.add("no-drag"),Object.assign(k.style,ie);let G=document.createElement("div");G.textContent="Espa\xF1ol",G.classList.add("no-drag"),Object.assign(G.style,ie),k.onclick=()=>at("pt"),G.onclick=()=>at("es"),A.appendChild(k),A.appendChild(G),x.appendChild(A),C.appendChild(x);let B=document.createElement("div");B.id="step-0-case-type";let g=document.createElement("label");Object.assign(g.style,a.label),B.appendChild(g);let d=document.createElement("div");Object.assign(d.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let l=document.createElement("div");l.textContent="BAU",l.classList.add("no-drag"),Object.assign(l.style,ie);let c=document.createElement("div");c.textContent="LM",c.classList.add("no-drag"),Object.assign(c.style,ie),l.onclick=()=>nt("bau"),c.onclick=()=>nt("lm"),d.appendChild(l),d.appendChild(c),B.appendChild(d),C.appendChild(B);let v=document.createElement("div");v.id="step-1-selection";let h=document.createElement("label");Object.assign(h.style,a.label);let w=document.createElement("select");w.id="main-status",Object.assign(w.style,De),w.innerHTML='<option value="">-- Selecione --</option><option value="NI">NI - Need Info</option><option value="SO">SO - Solution Offered</option><option value="IN">IN - Inactive</option><option value="AS">AS - Assigned</option>';let O=document.createElement("div");Object.assign(O.style,{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginTop:"16px",marginBottom:"8px"});let T=document.createElement("label");Object.assign(T.style,a.label,{marginTop:"0",marginBottom:"0"});let U=document.createElement("a");U.target="_blank",U.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg> Guia de Substatus',Object.assign(U.style,a.helpLink),O.appendChild(T),O.appendChild(U);let I=document.createElement("select");I.id="sub-status",Object.assign(I.style,De),I.disabled=!0,v.appendChild(h),v.appendChild(w),v.appendChild(O),v.appendChild(I),C.appendChild(v);let N=document.createElement("div");N.id="step-1-1-portugal",Object.assign(N.style,a.stepBlock,{display:"none"});let te=document.createElement("label");Object.assign(te.style,a.label),N.appendChild(te);let j=document.createElement("div");Object.assign(j.style,a.radioContainer);let q=document.createElement("div");Object.assign(q.style,{display:"flex",alignItems:"center"});let F=document.createElement("input");F.type="radio",F.name="portugal-group",F.value="sim",Object.assign(F.style,a.checkboxInput);let ne=document.createElement("label");ne.htmlFor="portugal-sim",Object.assign(ne.style,{cursor:"pointer"}),q.appendChild(F),q.appendChild(ne);let ae=document.createElement("div");Object.assign(ae.style,{display:"flex",alignItems:"center"});let Q=document.createElement("input");Q.type="radio",Q.name="portugal-group",Q.value="nao",Q.checked=!0,Object.assign(Q.style,a.checkboxInput);let be=document.createElement("label");be.htmlFor="portugal-nao",Object.assign(be.style,{cursor:"pointer"}),ae.appendChild(Q),ae.appendChild(be),j.appendChild(q),j.appendChild(ae),N.appendChild(j),C.appendChild(N);function Je(u){o=u,u?ge.style.display="block":ge.style.display="none"}F.onchange=()=>Je(!0),Q.onchange=()=>Je(!1);let ge=document.createElement("div");ge.id="step-1-2-consent",Object.assign(ge.style,a.stepBlock,{display:"none"});let et=document.createElement("label");Object.assign(et.style,a.label),ge.appendChild(et);let ze=document.createElement("div");Object.assign(ze.style,a.radioContainer);let Be=document.createElement("div");Object.assign(Be.style,{display:"flex",alignItems:"center"});let Se=document.createElement("input");Se.type="radio",Se.name="consent-group",Se.value="Sim",Se.checked=!0,Object.assign(Se.style,a.checkboxInput);let qe=document.createElement("label");qe.htmlFor="consent-sim",Object.assign(qe.style,{cursor:"pointer"}),Be.appendChild(Se),Be.appendChild(qe);let Ve=document.createElement("div");Object.assign(Ve.style,{display:"flex",alignItems:"center"});let Ne=document.createElement("input");Ne.type="radio",Ne.name="consent-group",Ne.value="N\xE3o",Object.assign(Ne.style,a.checkboxInput);let He=document.createElement("label");He.htmlFor="consent-nao",Object.assign(He.style,{cursor:"pointer"}),Ve.appendChild(Ne),Ve.appendChild(He),ze.appendChild(Be),ze.appendChild(Ve),ge.appendChild(ze),C.appendChild(ge);let Ce=document.createElement("div");Ce.id="step-1-5-snippets",Object.assign(Ce.style,a.stepBlock,{display:"none"});let tt=document.createElement("h3");Object.assign(tt.style,a.h3);let ce=document.createElement("div");ce.id="snippet-container",Ce.appendChild(tt),Ce.appendChild(ce),C.appendChild(Ce);let de=document.createElement("div");de.id="step-2-tasks",Object.assign(de.style,a.stepBlock,{display:"none"});let re=document.createElement("button");re.textContent="+ Gostaria de selecionar uma task?",Object.assign(re.style,a.optionalBtn),re.onmouseover=()=>{re.style.background="#e8f0fe"},re.onmouseout=()=>{re.style.background="white"};let Oe=document.createElement("h3");Object.assign(Oe.style,a.h3);let xt=document.createElement("div");xt.id="task-checkboxes-container",de.appendChild(re),de.appendChild(xt),de.appendChild(Oe),de.appendChild(i.selectionElement),C.appendChild(de);let pe=document.createElement("div");pe.id="step-3-form",Object.assign(pe.style,a.stepBlock,{display:"none"});let ot=document.createElement("h3");Object.assign(ot.style,a.h3),pe.appendChild(ot);let fe=document.createElement("div");fe.id="dynamic-form-fields-container",pe.appendChild(fe),pe.appendChild(s.element),pe.appendChild(i.screenshotsElement),C.appendChild(pe);let Ae=document.createElement("div");Ae.id="step-4-email",Object.assign(Ae.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ee=document.createElement("label");Ee.style.display="flex",Ee.style.alignItems="center",Ee.style.cursor="pointer",Ee.style.fontSize="14px";let we=document.createElement("input");we.type="checkbox",we.checked=!0,Object.assign(we.style,a.checkboxInput),Ee.appendChild(we),Ee.appendChild(document.createTextNode("Preencher email automaticamente?")),Ae.appendChild(Ee),C.appendChild(Ae);let ke=document.createElement("div");Object.assign(ke.style,{display:"none",gap:"8px",padding:"0"}),C.appendChild(ke);let Re=document.createElement("button");Object.assign(Re.style,a.buttonBase,{backgroundColor:"#5f6368"}),Re.textContent="Copiar";let Me=document.createElement("button");Object.assign(Me.style,a.buttonBase,{backgroundColor:"#1a73e8"}),Me.textContent="Preencher",ke.appendChild(Re),ke.appendChild(Me),document.body.appendChild(p);function nt(u){t=u;let _=Ge();Object.assign(l.style,ie),Object.assign(c.style,ie),u==="bau"?(Object.assign(l.style,_),U.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(c.style,_),U.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),I.value&&I.dispatchEvent(new Event("change"))}function R(u){try{if(me&&me[n]&&me[n][u])return me[n][u];if(me&&me.pt&&me.pt[u])return me.pt[u]}catch{}return u}function Ht(){E.textContent=R("idioma"),g.textContent=R("fluxo"),h.textContent=R("status_principal"),T.textContent=R("substatus"),tt.textContent=R("cenarios_comuns"),Oe.textContent=R("selecione_tasks"),ot.textContent=R("preencha_detalhes"),Re.textContent=R("copiar"),Me.textContent=R("preencher"),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=R("select_status")),I.querySelector('option[value=""]')&&(I.querySelector('option[value=""]').textContent=R("select_substatus")),te.textContent=R("caso_portugal"),ne.textContent=R("sim"),be.textContent=R("nao"),et.textContent=R("consentiu_gravacao"),qe.textContent=R("sim"),He.textContent=R("nao"),fe.querySelectorAll("label").forEach(u=>{let _=u.nextElementSibling.id.replace("field-",""),f=R(_.toLowerCase());f!==_.toLowerCase()?u.textContent=f:u.textContent=_.replace(/_/g," ").replace(/\b\w/g,M=>M.toUpperCase())+":"}),re.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function at(u){n=u;let _=Ge();Object.assign(k.style,ie),Object.assign(G.style,ie),u==="pt"?(Object.assign(k.style,_),N.style.display="block",Je(o)):(Object.assign(G.style,_),N.style.display="none",ge.style.display="none"),Ht(),I.value&&I.dispatchEvent(new Event("change"))}function st(u){(u.value.trim()===""||u.value.trim()==="\u2022")&&(u.value="\u2022 "),u.onkeydown=function(_){if(_.key==="Enter"){_.preventDefault();let f=this.selectionStart,M=this.selectionEnd,Y=this.value,se=Y.lastIndexOf(`
`,f-1)+1,W=Y.substring(se,f),z=W.trim()==="\u2022"||W.trim()===""?`
`:`
\u2022 `;this.value=Y.substring(0,f)+z+Y.substring(M),this.selectionStart=this.selectionEnd=f+z.length}else if(_.key==="Backspace"){let f=this.selectionStart;if(f===this.selectionEnd&&f>0){let M=this.value.substring(0,f);M.endsWith(`
\u2022 `)?(_.preventDefault(),this.value=M.substring(0,f-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=f-3):M==="\u2022 "&&(_.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function it(){let u=typeof ce<"u"?ce:document.getElementById("snippet-container");if(!u)return;let _=u.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),f={},M=new Set;_.forEach(W=>{let z=W.id,K=_e[z];if(K)for(let P in K)P==="linkedTask"?M.add(K.linkedTask):P!=="type"&&(f[P]||(f[P]=[]),f[P].includes(K[P])||f[P].push(K[P]))});let Y=new Set;Object.values(_e).forEach(W=>{Object.keys(W).forEach(z=>{z!=="linkedTask"&&z!=="type"&&Y.add(z)})}),Y.forEach(W=>{let z=document.getElementById(W);if(z){let K=f[W]||[],P="";Pe.includes(W.replace("field-",""))?(P=K.map(L=>L.startsWith("\u2022 ")?L:"\u2022 "+L).join(`
`),P===""?P="\u2022 ":P.endsWith(`
\u2022 `)||(P+=`
\u2022 `)):P=K.join(`

`),P.trim()!=="\u2022"&&P.trim()!==""?z.value=P:Pe.includes(W.replace("field-",""))?z.value="\u2022 ":z.value="",z.tagName==="TEXTAREA"&&typeof st=="function"&&st(z)}}),document.querySelectorAll(".task-checkbox").forEach(W=>{M.has(W.value)&&(W.checked||(W.checked=!0,W.dispatchEvent(new Event("change",{bubbles:!0}))))})}w.onchange=()=>{let u=w.value;if(rt(1.5),I.innerHTML=`<option value="">${R("select_substatus")}</option>`,!u){I.disabled=!0;return}for(let _ in Fe){let f=Fe[_];if(f.status===u){let M=document.createElement("option");M.value=_,M.textContent=f.name,I.appendChild(M)}}I.disabled=!1},I.onchange=()=>{let u=I.value;if(rt(1.5),!u)return;i.updateSubStatus(u);let _=Fe[u];ce.innerHTML="";let f=(L,V,H)=>{let Z=document.createElement("label");Object.assign(Z.style,a.checkboxLabel),Z.onmouseover=()=>Z.style.backgroundColor="#e8eaed",Z.onmouseout=()=>Z.style.backgroundColor="#f8f9fa";let $=document.createElement("input");return $.type=V,$.id=L.id,Object.assign($.style,a.checkboxInput),Z.appendChild($),Z.appendChild(document.createTextNode(` ${L.text}`)),H.appendChild(Z),$},M=[],Y="radio";if(u==="NI_Awaiting_Inputs")M=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(u.startsWith("SO_"))Y="checkbox",M=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(u.startsWith("AS_")){Y="checkbox";let L=document.createElement("label");L.textContent=R("cenarios_comuns"),Object.assign(L.style,a.label),ce.appendChild(L),M=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else u.startsWith("IN_")&&(M=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let se=M.filter(L=>{let V=_e[L.id];return!V.type||V.type==="all"||V.type===t});se.forEach((L,V)=>{let H=f(L,Y,ce);Y==="radio"&&(H.name="scenario-radio-group",V===0&&(H.checked=!0))}),se.length>0&&(Ce.style.display="block"),_.requiresTasks?(re.style.display="none",Oe.style.display="block",i.selectionElement.style.display="block",de.style.display="block"):(re.style.display="block",Oe.style.display="none",i.selectionElement.style.display="none",de.style.display="block"),fe.innerHTML="";let W=_.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(W)].forEach(L=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(L))return;let V=L.slice(1,-1),H=document.createElement("label"),Z=R(V.toLowerCase());H.textContent=Z!==V.toLowerCase()?Z:V.replace(/_/g," ").replace(/\b\w/g,J=>J.toUpperCase())+":",Object.assign(H.style,a.label);let $;Pe.includes(V)?($=document.createElement("textarea"),Object.assign($.style,a.textarea),$.classList.add("bullet-textarea"),st($)):mt.includes(V)?($=document.createElement("textarea"),Object.assign($.style,a.textarea)):($=document.createElement("input"),$.type="text",Object.assign($.style,a.input),V==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))&&(Object.assign(H.style,{display:"none"}),Object.assign($.style,{display:"none"}))),V==="ON_CALL"&&t==="lm"&&(Object.assign(H.style,{display:"none"}),Object.assign($.style,{display:"none"}),$.value="N/A"),$.id=`field-${V}`,fe.appendChild(H),fe.appendChild($)});let K=ce.querySelectorAll('input[type="checkbox"], input[type="radio"]');K.length>0&&(K.forEach(L=>{L.removeEventListener("change",it),L.addEventListener("change",it)}),it()),pe.style.display="block",We[u]?Ae.style.display="block":Ae.style.display="none",ke.style.display="flex";let P=i.getCheckedElements().map(L=>L.value);s.updateVisibility(u,P)},re.onclick=()=>{re.style.display="none",Oe.style.display="block",i.selectionElement.style.display="block"};function yt(){let u=I.value;if(!u)return null;let f=Fe[u].template.replace(/\n/g,"<br>"),M='style="margin-bottom: 12px; padding-left: 30px;"',Y=[],se="",W=taskManager.getCheckedElements();W.length>0&&W.forEach(P=>{let L=P.value,V=Ie[L],H=P.closest().querySelector(".stepper-count"),Z=H?parseInt(H.textContent):1;Z>1?Y.push(`${V.name} (x${Z})`):Y.push(V.name)});let z=taskManager.screenshotsElement;if(z){let L=Array.from(z.querySelectorAll('input[id^="name-"]')).filter(V=>V.offsetParent!==null);L.length>0&&L.forEach(V=>{let H=V.value,$=V.closest("div").parentNode.querySelectorAll('input[id^="screen-"]'),J=!1,le="";$.forEach(vt=>{let St=vt.previousElementSibling,Ut=St?St.textContent.replace("\u{1F4F7} ","").replace(":",""):"Print",Ct=vt.value.trim(),$t=Ct?` ${Ct}`:"";le+=`<li>${Ut} -${$t}</li>`,J=!0}),J&&(se+=`<b>${H}</b>`,se+=`<ul ${M}>${le}</ul>`)})}if(f.includes("{TAGS_IMPLEMENTED}")?f=f.replace(/{TAGS_IMPLEMENTED}/g,Y.join(", ")||"N/A"):Y.length>0&&(f+=`<br><b>Tags:</b> ${Y.join(", ")}<br>`),f.includes("{SCREENSHOTS_LIST}")?f=f.replace(/{SCREENSHOTS_LIST}/g,se?`${se}`:"N/A"):se!==""&&(f+=`<br>${se}`),n==="pt"&&o){let P=Se.checked?R("sim"):R("nao");f=f.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${R("consentiu_gravacao")}</b> ${P}<br><br>`),f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${R("caso_portugal")}</b> ${R("sim")}<br>`)}else n==="pt"&&!o?(f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${R("caso_portugal")}</b> ${R("nao")}<br>`),f=f.replace(/{CONSENTIU_GRAVACAO}/g,"")):(f=f.replace(/{CASO_PORTUGAL}/g,""),f=f.replace(/{CONSENTIU_GRAVACAO}/g,""));return fe.querySelectorAll("input, textarea").forEach(P=>{let L=P.id.replace("field-",""),V=new RegExp(`{${L}}`,"g"),H=P.value;if(L==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))){let J=ce.querySelector('input[type="radio"]:checked');J&&_e[J.id]&&(H=_e[J.id]["field-REASON_COMMENTS"])}if(Pe.includes(L)&&H.trim()!==""){let J=H.split(`
`).map(le=>le.trim()).filter(le=>le!==""&&le!=="\u2022").map(le=>le.startsWith("\u2022 ")?le.substring(2):le).map(le=>`<li>${le}</li>`).join("");H=J?`<ul ${M}>${J}</ul>`:""}else mt.includes(L)?H=H.split(`
`).filter(J=>J.trim()!=="").map(J=>`<p style="margin: 0 0 8px 0;">${J}</p>`).join(""):P.tagName==="TEXTAREA"&&(H=H.replace(/\n/g,"<br>"));let Z=H.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(Z===""||Z==="\u2022"||Z.toLowerCase()==="n/a"){let J=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${L}\\}(?:<br>\\s*)?`,"gi");J.test(f)?f=f.replace(J,""):f=f.replace(V,"")}else f=f.replace(V,H.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof s<"u"&&s.getOutput&&(f+=s.getOutput()),f}Re.onclick=()=>{let u=yt();u?(gt(u),X(R("copiado_sucesso"))):X(R("selecione_substatus"),{error:!0})},Me.onclick=async()=>{let u=I.value,_=yt();if(!_){X(R("selecione_substatus"),{error:!0});return}gt(_),lt();let f=Ke(),M=await Ft();if(M)try{if(M.focus(),M.innerHTML.trim()==="<p><br></p>"||M.innerHTML.trim()==="<br>"||M.innerText.trim()===""){let z=document.createRange();z.selectNodeContents(M);let K=window.getSelection();K.removeAllRanges(),K.addRange(z),document.execCommand("delete",!1,null)}else if(!M.innerHTML.endsWith("<br><br>")){let z=document.createRange();z.selectNodeContents(M),z.collapse(!1);let K=window.getSelection();K.removeAllRanges(),K.addRange(z),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,_),Gt(M),setTimeout(()=>{X(R("inserido_copiado"))},600);let se=typeof we<"u"&&we?we.checked:!0;if(u&&We[u]&&se){let z=We[u];await _t(z),await new Promise(K=>setTimeout(K,500))}f(),rt(1.5),w.value="",I.innerHTML=`<option value="">${R("select_substatus")}</option>`,I.disabled=!0}catch(Y){console.error(Y),X("Erro ao inserir.",{error:!0}),f()}};function rt(u=1.5){u<=1.5&&(Ce.style.display="none",ce.innerHTML=""),u<=2&&(de.style.display="none",i.reset(),re.style.display="none"),u<=3&&(pe.style.display="none",fe.innerHTML="",s.reset(),ke.style.display="none",Ae.style.display="none")}function lt(){r=!r,ve(r,p,"cw-btn-notes")}return nt("bau"),at("pt"),lt}var Te={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let q=h.querySelector("#csa-back-btn");q.onmouseover=()=>q.style.backgroundColor="#f1f3f4",q.onmouseout=()=>q.style.backgroundColor="transparent",q.onclick=T;let F=h.querySelector("#csa-insert-btn");F.onmouseover=()=>F.style.backgroundColor="#174ea6",F.onmouseout=()=>F.style.backgroundColor="#1a73e8",F.onclick=async()=>{F.style.transform="scale(0.96)",E();let ne=Ke();try{await bt(N),ne()}catch(ae){console.error(ae),ne()}setTimeout(()=>{F.style.transform="scale(1)",T()},300)}}function T(){o="list",G.style.transform="translateX(0)"}function U(){l.innerHTML="",Object.keys(Te).forEach(N=>{let te=Te[N],j=document.createElement("button");j.textContent=te.title,Object.assign(j.style,S),t===N&&n===""&&Object.assign(j.style,y),j.onclick=()=>{t=N,n="",d.value="",U(),I()},l.appendChild(j)})}function I(){c.innerHTML="";let N=[];if(n.trim()!==""?Object.values(Te).forEach(q=>{let F=q.emails.filter(ne=>ne.name.toLowerCase().includes(n.toLowerCase()));N=[...N,...F]}):Te[t]&&(N=Te[t].emails),N.length===0){c.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let te='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',j='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';N.forEach(q=>{let F=document.createElement("div");Object.assign(F.style,m);let ne=q.subject.length>50?q.subject.substring(0,50)+"...":q.subject;F.innerHTML=`
        <div style="flex-grow: 1; margin-right: 12px; min-width: 0;">
            <div style="font-size:13px; font-weight:600; color:#202124; margin-bottom:2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${q.name}</div>
        ...
        <div style="display:flex; gap:6px;">
            ...
            <button class="action-btn send" title="Inserir Agora" style="width:32px; height:32px; border-radius:50%; border:none; background:#e8f0fe; color:#1a73e8; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all 0.2s;">${te}</button>
        </div>
      `,F.onmouseenter=()=>{F.style.background="#F8F9FA",F.style.borderColor="#1a73e8"},F.onmouseleave=()=>{F.style.background="#fff",F.style.borderColor="#dadce0"};let ae=F.querySelector(".view");ae.onclick=be=>{be.stopPropagation(),O(q)},ae.onmouseenter=()=>{ae.style.background="#d2e3fc",ae.style.color="#174ea6"},ae.onmouseleave=()=>{ae.style.background="#f1f3f4",ae.style.color="#5f6368"};let Q=F.querySelector(".send");Q.onclick=be=>{be.stopPropagation(),Q.style.transform="scale(0.9)",setTimeout(()=>Q.style.transform="scale(1)",150),bt(q),E()},Q.onmouseenter=()=>{Q.style.background="#1a73e8",Q.style.color="#fff",Q.style.boxShadow="0 2px 6px rgba(26,115,232,0.3)"},Q.onmouseleave=()=>{Q.style.background="#e8f0fe",Q.style.color="#1a73e8",Q.style.boxShadow="none"},F.onclick=()=>O(q),c.appendChild(F)})}return d.addEventListener("input",N=>{n=N.target.value,n!==""?Array.from(l.children).forEach(te=>Object.assign(te.style,S)):U(),I()}),U(),I(),E}var ht={"PT BAU":{color:"#6c1199",inicio:["Apresenta\xE7\xE3o (Nome e Time)","Aviso de Grava\xE7\xE3o e Pol\xEDtica de Privacidade","Confirma\xE7\xE3o de CID e Email","(Opcional) Validar autentica\xE7\xE3o da conta via link","Confirma\xE7\xE3o da Task e do AM","Informar tempo da liga\xE7\xE3o (30-45 min)","Pedir para fechar conte\xFAdo sens\xEDvel (antes de compartilhar)","Validar Backup e Acessos Admin"],fim:["Resumo da chamada (o que foi feito e como funciona)","Oferecer ajuda adicional / Abrir para d\xFAvidas","Pedir para fechar compartilhamento de tela","Pr\xF3ximos passos (Acompanhamento por XX dias)","Pedir consentimento para teste de QA","Alinhar escopo (T\xE9cnico vs. Gerente de Contas)","Pesquisa de Satisfa\xE7\xE3o (e confirmar email para envio)","Despedida"]},"PT LT":{color:"#004f67",inicio:["Ol\xE1 [...], eu sou o [...], e fa\xE7o parte da Equipe de Solu\xE7\xF5es T\xE9cnicas do Google. Tudo bem?","Nossa liga\xE7\xE3o poder\xE1 ser gravada para fins de treinamento, qualidade e melhorias dos servi\xE7os do Google, de acordo com a nossa Pol\xEDtica de Privacidade.","Por quest\xE3o de seguran\xE7a preciso que voc\xEA me informe o seu email e CID (ou n\xFAmero) da conta do Ads, por favor","Confirma\xE7\xE3o da Task e do AM","A consultoria tem uma dura\xE7\xE3o m\xE9dia de 30 a 45 minutos.","Pe\xE7o para que compartilhe a tela usando a op\xE7\xE3o \u201CTela Inteira\u201D","Por favor, feche todo e qualquer conte\xFAdo confidencial e sens\xEDvel (conversas, dados pessoais importantes, etc).","Possui o backup do seu site e todos os acessos \xE0s ferramentas do Google?"],fim:["Resumo da chamada (o que foi feito e como funciona)","Oferecer ajuda adicional / Abrir para d\xFAvidas","Pedir para fechar compartilhamento de tela","Pr\xF3ximos passos (Acompanhamento por XX dias)","Durante esse tempo, nossa equipe de qualidade poder\xE1 realizar um teste de convers\xE3o para validar a implementa\xE7\xE3o. Voc\xEA concorda com esse teste para garantirmos a efetividade da implementa\xE7\xE3o?","Alinhar escopo (T\xE9cnico vs. Gerente de Contas)","Pesquisa de Satisfa\xE7\xE3o (e confirmar email para envio)","Despedida"]},"ES BAU":{color:"#00bbff",inicio:["Introducci\xF3n (Nombre y  Equipo).","La llamada pode ser grabada con fines de entrenamiento y calidad de acuerdo com nuestra pol\xEDtica de privacidad.","Informar sitio web registrado en el caso.","Confirmaci\xF3n: Solicitar al Anunciante que confirme los 10 d\xEDgitos del CID el email del anunciante.","Confirmaciones: Tarea, AM","Informar el tiempo que va a durar la reuni\xE3o.","Confirmaci\xF3n: Copia de seguridad y acceso de ADM","Cerrar conte\xFAdo sens\xEDvel antes de compartir la pantalla."],fim:["Resumen de la llamada.","Ayuda adicional.","Cerrar la pantalla compartida.","Pr\xF3ximos passos (\xBFCu\xE1nto tempo seguir\xE1 el caso?)","Encuesta de Satisfa\xE7\xE3o.","Estar\xE9 monitoreando su caso durante XX dias para asegurarme de que todo est\xE9 funcionando corretamente. Durante este tiempo, nuestro equipo de qualidade podr\xEDa realizar una prueba de conversi\xF3n para validar la implementaci\xF3n. \xBFEst\xE1s de acuerdo con esta prueba para garantizar la efectividad de la implementaci\xF3n? Perfecto, \xA1gracias!"]},"ES LT":{color:"#f269ff",inicio:["Presentaci\xF3n (Nombre y equipo).","Informar al cliente sobre la llamada grabada.","Tiempo de duraci\xF3n de la llamada.",`Solicitar al anunciante que confirme lo siguiente: 
 A) 10 d\xEDgitos de la conta 
 B) Correo electr\xF3nico 
 C) N\xFAmero de tel\xE9fono y 
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function qt(){let e="v1.2.7",t={},n="PT",o="BAU",r=!1,a=document.createElement("div");a.id="call-script-popup",Object.assign(a.style,he,{right:"100px",width:"340px",display:"flex",flexDirection:"column",boxShadow:"none",opacity:"0",pointerEvents:"none"});let s={popup:a,googleLine:null};function i(){r=!r,ve(r,a,"cw-btn-script")}let p=ye(a,"Call Script Assistant",e,"Checklists guiados para in\xEDcio e fim de chamada.",s,()=>{i()});a.appendChild(p);let S=document.createElement("div");S.id="csa-content",Object.assign(S.style,{padding:"16px",overflowY:"auto",flexGrow:"1"}),a.appendChild(S);let y=document.createElement("div");y.textContent="created by lucaste@",Object.assign(y.style,$e),a.appendChild(y);let m=document.createElement("div");Object.assign(m.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px",gap:"8px"});let C=document.createElement("div");Object.assign(C.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden"});let b=document.createElement("div");b.textContent="BAU";let x=document.createElement("div");x.textContent="LT",Object.assign(b.style,ie),Object.assign(x.style,ie),C.appendChild(b),C.appendChild(x);let E=document.createElement("select");Object.assign(E.style,De,{marginBottom:"0",width:"auto",minWidth:"85px",paddingTop:"6px",paddingBottom:"6px"}),E.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',E.value=n,m.appendChild(C),m.appendChild(E),S.appendChild(m);let A=document.createElement("div");A.id="csa-checklist-area",Object.assign(A.style,{maxHeight:"60vh",overflowY:"auto",paddingRight:"5px"}),S.appendChild(A),document.body.appendChild(a);function k(l,c){let v=l.replace("#",""),h=parseInt(v.substring(0,2),16),w=parseInt(v.substring(2,4),16),O=parseInt(v.substring(4,6),16);return`rgba(${h}, ${w}, ${O}, ${c})`}function G(l,c,v){l.classList.toggle("csa-completed",c),c?(l.style.borderColor=v,l.style.backgroundColor=k(v,.15),l.style.textDecorationLine="line-through"):(l.style.borderColor="transparent",l.style.backgroundColor="#f8f9fa",l.style.textDecorationLine="none")}function B(l,c,v){let h=ht[l];if(!h)return;let w=h[c];if(!w||w.length===0)return;let O=!0;for(let T=0;T<w.length;T++){let U=`${l}-${c}-${T}`;if(!t[U]){O=!1;break}}v.classList.toggle("csa-group-completed",O)}function g(){A.innerHTML="";let l=`${n} ${o}`,c=ht[l];if(!c){A.innerHTML='<div style="padding: 10px; color: #5f6368;">Script n\xE3o dispon\xEDvel.</div>';return}let v=c.color;["inicio","fim"].forEach(h=>{let w=c[h];if(!w||w.length===0)return;let O=document.createElement("div");O.className="csa-group-container",Object.assign(O.style,{marginBottom:"16px"});let T=document.createElement("div");T.className="csa-group-title";let U=h==="inicio"?"In\xEDcio":"Fim";n.includes("ES")&&(U=h==="inicio"?"Inicio":"Fin"),n.includes("EN")&&(U=h==="inicio"?"Start":"End"),T.textContent=U,Object.assign(T.style,Le,{fontWeight:"600",fontSize:"14px",textDecoration:"underline",marginBottom:"8px"}),O.appendChild(T);let I=document.createElement("ul");Object.assign(I.style,{listStyle:"none",paddingLeft:"0",margin:"0"}),w.forEach((N,te)=>{let j=document.createElement("li");j.className="csa-li",j.textContent=N;let q=`${l}-${h}-${te}`,F=!!t[q];G(j,F,v),j.addEventListener("click",()=>{let ne=!t[q];t[q]=ne,G(j,ne,v),B(l,h,O)}),I.appendChild(j)}),O.appendChild(I),A.appendChild(O),B(l,h,O)})}function d(l){o=l;let c=Ge();Object.assign(b.style,ie),Object.assign(x.style,ie),Object.assign(l==="BAU"?b.style:x.style,c),g()}return b.onclick=()=>d("BAU"),x.onclick=()=>d("LT"),E.addEventListener("change",l=>{n=l.target.value,g()}),d(o),i}var Ze={lm:{label:"LM Forms",links:[{name:"Relat\xF3rio de Ocorr\xEAncias",url:"https://docs.google.com/forms/d/e/1FAIpQLSc6CamPehrREeVr7yCWMyqFETrFYYezNcLb_13W4yZDQkfY6Q/viewform",desc:"Reportar problemas operacionais | Aviso de pausas"},{name:"Chamadas Excedidas (>50min)",url:"https://docs.google.com/forms/d/e/1FAIpQLSfE8EMHNJMTKYeA6XM2RZjZ9AQ4LhGk1Dwm_WLu3kcMdKMikA/viewform",desc:"Registro de chamadas longas"},{name:"Relat\xF3rio de Bugs",url:"https://docs.google.com/forms/d/e/1FAIpQLSfkqRqT2Kbf08IStz31fQPE84MDOtGxk7cetJmc3xzShXIXRA/viewform",desc:"Erros de sistema/ferramenta"},{name:"Suporte LM",url:"https://script.google.com/a/macros/google.com/s/AKfycbxYMlFCMZvqgHMIImeS_u-lNZPiertXmem-5m9Fox3jvZaq0ZOQDoc5ma96ltSvWHY/exec",desc:"Enviar casos para BAU/Solicitar Descarte/Abrir Monitoria para AMs"}]},qa:{label:"QA",links:[{name:"Elogios",url:"https://docs.google.com/forms/d/e/1FAIpQLSezY5K-trQDv0LkL5IoTlV0Tl0oOqGTEszylmgcbMRXcC9Weg/viewform",desc:"Feedback positivo dos Anunciantes"},{name:"Casos Complexos",url:"https://docs.google.com/forms/d/e/1FAIpQLSe26q1LEloFNRfOAVZtA7DCOQTqdu1BAEeWuxtK6oPwZhLp-A/viewform?resourcekey=0-c1N4h8gntza2gQowqYAqMw",desc:"Casos complicados de atender"}]},suporte:{label:"Central de Ajuda",links:[{name:"Suporte Google Ads",url:"https://support.google.com/google-ads/",desc:"Oficial"},{name:"Suporte GA4",url:"https://support.google.com/analytics/",desc:"Oficial"},{name:"Suporte Merchant Center",url:"https://support.google.com/merchants/gethelp",desc:"Oficial"},{name:"Doc. CSP",url:"https://developers.google.com/tag-platform/tag-manager/web/csp?hl=pt-br.",desc:"Doc. oficial sobre CSP"},{name:"Doc. Enhanced Conversion",url:"https://support.google.com/google-ads/answer/9888656?hl=en",desc:"Como funcionam as convers\xF5es otimizadas?"},{name:"Doc. CoMo",url:"https://developers.google.com/tag-platform/security/concepts/consent-mode?hl=pt-br",desc:"Doc. oficial sobre Consent Mode"}]},outros:{label:"Diversos",links:[{name:"Solicitar Grava\xE7\xE3o",url:"https://support.google.com/policies/contact/sar",desc:"Form para solicitar grava\xE7\xE3o da chamada."}]}};function Vt(){let e="v2.4.5",t="lm",n="",o={width:"100%",padding:"10px 12px 10px 36px",borderRadius:"8px",border:"1px solid #dadce0",background:"#f8f9fa",fontSize:"14px",boxSizing:"border-box",outline:"none",color:"#3c4043",transition:"background 0.2s, border-color 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"10px center"},r={display:"flex",flexWrap:"wrap",gap:"8px",paddingBottom:"8px"},a={padding:"6px 16px",borderRadius:"16px",border:"1px solid #dadce0",background:"transparent",color:"#5f6368",fontSize:"13px",fontWeight:"500",cursor:"pointer",whiteSpace:"nowrap",transition:"all 0.2s ease",marginBottom:"4px"},s={background:"#e8f0fe",color:"#1967d2",borderColor:"#e8f0fe",fontWeight:"600"},i={display:"flex",flexDirection:"column",padding:"12px",borderRadius:"8px",cursor:"pointer",border:"1px solid transparent",marginBottom:"4px",transition:"background 0.1s"},p=document.createElement("div");p.id="feedback-popup",Object.assign(p.style,he,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none"});let S={popup:p,googleLine:null,focusElement:null},y=!1,m=ye(p,"Links \xDAteis",e,"Acesso r\xE1pido a formul\xE1rios internos (Ocorr\xEAncias, Bugs) e documenta\xE7\xF5es oficiais de suporte.",S,()=>B());p.appendChild(m);let C=document.createElement("div");Object.assign(C.style,{padding:"0 16px 16px 16px",display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid #f1f3f4",flexShrink:"0",backgroundColor:"#fff"});let b=document.createElement("input");b.type="text",b.placeholder="Buscar link, form ou ajuda...",Object.assign(b.style,o),S.focusElement=b,b.onfocus=()=>{b.style.borderColor="#1a73e8",b.style.backgroundColor="#fff"},b.onblur=()=>{b.style.borderColor="#dadce0",b.style.backgroundColor="#f8f9fa"};let x=document.createElement("div");Object.assign(x.style,r),C.appendChild(b),C.appendChild(x),p.appendChild(C);let E=document.createElement("div");Object.assign(E.style,{padding:"0 8px 8px 8px",overflowY:"auto",flexGrow:"1"}),p.appendChild(E);let A=document.createElement("div");Object.assign(A.style,{padding:"8px 16px",borderTop:"1px solid #eee",display:"flex",justifyContent:"space-between",alignItems:"center",fontSize:"10px",color:"#9aa0a6"}),A.innerHTML="<span>by lucaste@</span>",p.appendChild(A),document.body.appendChild(p);function k(){x.innerHTML="",Object.keys(Ze).forEach(g=>{let d=Ze[g],l=document.createElement("button");l.textContent=d.label,Object.assign(l.style,a),t===g&&n===""&&Object.assign(l.style,s),l.onclick=()=>{t=g,n="",b.value="",k(),G()},x.appendChild(l)})}function G(){E.innerHTML="";let g=[];if(n.trim()!==""?Object.values(Ze).forEach(d=>{let l=d.links.filter(c=>c.name.toLowerCase().includes(n.toLowerCase())||c.desc.toLowerCase().includes(n.toLowerCase()));l.forEach(c=>c._categoryName=d.label),g=[...g,...l]}):g=Ze[t].links,g.length===0){E.innerHTML='<div style="text-align:center; padding:20px; color:#9aa0a6; fontSize:13px;">Nenhum link encontrado.</div>';return}g.forEach(d=>{let l=document.createElement("div");Object.assign(l.style,i);let c=document.createElement("div");Object.assign(c.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"2px"});let v=document.createElement("div");Object.assign(v.style,{display:"flex",flexDirection:"column",flexGrow:"1"});let h=document.createElement("span");h.textContent=d.name,Object.assign(h.style,{fontSize:"14px",color:"#202124",fontWeight:"500"});let w=document.createElement("span");w.textContent=d.desc+(d._categoryName?` \u2022 ${d._categoryName}`:""),Object.assign(w.style,{fontSize:"11px",color:"#5f6368",marginTop:"2px"}),v.appendChild(h),v.appendChild(w);let O=document.createElement("div");Object.assign(O.style,{display:"flex",alignItems:"center",gap:"8px"});let T=document.createElement("div"),U='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',I='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1e8e3e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>';T.innerHTML=U,Object.assign(T.style,{width:"28px",height:"28px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#5f6368",cursor:"pointer",transition:"all 0.2s",opacity:"0"}),T.onclick=te=>{te.stopPropagation();let j=document.createElement("input");j.value=d.url,document.body.appendChild(j),j.select(),document.execCommand("copy"),document.body.removeChild(j),T.innerHTML=I,T.style.backgroundColor="#e6f4ea",setTimeout(()=>{T.innerHTML=U,T.style.backgroundColor="transparent"},1500)},T.onmouseenter=()=>{T.style.backgroundColor="#e8eaed",T.style.color="#202124"},T.onmouseleave=()=>{T.style.backgroundColor="transparent",T.style.color="#5f6368"};let N=document.createElement("span");N.innerHTML="&#8599;",Object.assign(N.style,{fontSize:"18px",color:"#dadce0",marginLeft:"4px"}),O.appendChild(T),O.appendChild(N),c.appendChild(v),c.appendChild(O),l.appendChild(c),l.onmouseenter=()=>{l.style.backgroundColor="#f1f3f4",N.style.color="#1a73e8",T.style.opacity="1"},l.onmouseleave=()=>{l.style.backgroundColor="transparent",N.style.color="#dadce0",T.style.opacity="0"},l.onclick=()=>window.open(d.url,"_blank"),E.appendChild(l)})}b.addEventListener("input",g=>{n=g.target.value,n!==""?Array.from(x.children).forEach(d=>{d.style.backgroundColor="transparent",d.style.color="#5f6368",d.style.borderColor="#dadce0"}):k(),G()});function B(){y=!y,ve(y,p,"cw-btn-links")}return k(),G(),B}function no(){if(window.techSolInitialized){ut();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Ot(),ut();let e=zt(),t=Bt(),n=qt(),o=Vt();Mt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}no();})();

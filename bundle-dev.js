...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Dt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},ft={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var so={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var xe={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var Rt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],no=-1;function it(){let t=Math.floor(Math.random()*Rt.length);return t===no&&(t=(t+1)%Rt.length),no=t,Rt[t]}var Le=t=>new Promise(e=>setTimeout(e,t));async function jo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let n=t.querySelector(".cursor");await Le(200);for(let o=0;o<e.length;o++){let s=e.charAt(o),i=document.createElement("span");i.textContent=s,n&&n.parentNode===t?n.before(i):t.appendChild(i);let a=Math.floor(Math.random()*60)+30;o===0&&(a=150),o>e.length-3&&(a=30),await Le(a)}await Le(600),n&&(n.style.display="none")}async function zt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await Jt(),n=eo(e),o=t.querySelector("#w-icon"),s=t.querySelector("#p1"),i=t.querySelector("#p2"),a=t.querySelector("#p3"),r=t.querySelector("#p-sextou");o&&(o.innerHTML=n.icon),s&&(s.textContent=n.prefix),a&&(a.textContent=n.suffix),await Le(300);let u=o?o.querySelector("svg"):null;if(u&&(u.style.opacity="1",u.style.transform="scale(1)"),await Le(400),s&&(s.style.opacity="1"),W.playStartup(),i&&await jo(i,n.name),a&&(a.style.opacity="1",a.style.transform="translateY(0)"),n.isFriday&&r){await Le(400),r.style.display="block",r.offsetWidth;let m=r.querySelector(".sextou-badge");m&&(m.style.opacity="1",m.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}var Qe={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Ze(t,e){e.onmousedown=n;function n(o){o.stopPropagation(),o.preventDefault();let s=t.style.transition;t.style.transition="none";let i=o.clientX,a=o.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),u=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),m=i,g=a,d=!1;function x(b){m=b.clientX,g=b.clientY,d||(window.requestAnimationFrame(()=>{A(),d=!1}),d=!0)}function A(){let b=r+(m-i),S=u+(g-a);b>360&&(t.style.width=b+"px"),S>300&&(t.style.height=S+"px")}function v(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",v),setTimeout(()=>{t.style.transition=s},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",v)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function ro(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,n=>e[n]?e[n]:"")}var Je=t=>new Promise(e=>setTimeout(e,t));function st(t){t&&["mousedown","mouseup","click"].forEach(e=>t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window})))}var lo="cw-automation-styles";if(!document.getElementById(lo)){let t=document.createElement("style");t.id=lo,t.innerHTML=`
...
\u2022 Tentativa 2 -`}};var be=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,n[e]||n.info)}function qe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>t.dispatchEvent(new MouseEvent(n,e)))}function ht(t,e){if(!t)return;let n=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=t.getBoundingClientRect(),i=document.createElement("div");i.id=n,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let a=i.querySelector(".cw-close-btn");a.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&a.click()},25e3)}async function xt(t,e){if(!t||!e)return;t.focus(),t.value="",t.dispatchEvent(new Event("input",{bubbles:!0})),await be(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(t,e),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})),await be(100),t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function Bt(){let e=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(n=>{let o=n.offsetParent!==null,s=n.closest("case-message-view")!==null,i=n.closest(".editor")!==null||n.closest("write-card")!==null;return o&&!s&&i});return e&&ye("Editor visualmente detectado.","success"),e}async function uo(){ye("\u{1F680} FASE 1: Tentando abrir a janela de email...");let t=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(d=>d.innerText.trim()==="email");if(n&&n.offsetParent!==null){ye("Bot\xE3o de email direto encontrado.");let d=n.closest("material-button")||n.closest("material-fab")||n;qe(d),t=!0}else{ye("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let d=document.querySelector("material-fab-speed-dial");if(d){let x=d.querySelector(".trigger");if(x){qe(x),await be(800);let v=Array.from(document.querySelectorAll("i.material-icons-extended")).find(b=>b.innerText.trim()==="email");v&&(qe(v),t=!0)}}}if(!t)return $("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;ye("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,s=0,i=20;for(;s<i;){await be(250);let d=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(d).find(x=>x.offsetParent!==null),o){ye("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(o){ye("\u{1F5D1}\uFE0F Descartando..."),qe(o),o.click();let d=null,x=0;for(;x<15;){await be(300);let A=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(d=Array.from(A).find(v=>v.offsetParent!==null),d)break;x++}d&&(qe(d),$("Limpando rascunho antigo...",{duration:2e3}),await be(2500))}ye("\u{1F680} FASE 3: Buscando editor final...");let a=0,r=null;for(;a<20&&(r=Bt(),!r);)await be(250),a++;if(!r)return $("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let u=r.closest('[id="email-body-content-top"]'),g=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(u){if(g){let x=g.closest('[aria-hidden="true"]');x&&x.removeAttribute("aria-hidden"),g.focus(),qe(g)}await be(300),u.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let d=u.querySelector("#cases-body-field");if(d){let x=document.createRange();x.selectNodeContents(d),x.collapse(!0);let A=window.getSelection();A.removeAllRanges(),A.addRange(x)}return!0}return!1}async function yt(t){if(!t||!await uo())return;let n=await at();ye("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await be(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await xt(i,n.clientEmail),ht(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await xt(i,n.internalEmail),ht(i,`
            ...
            `))}await be(500);let s=document.querySelector('material-button[debug-id="canned_response_button"]');if(s){qe(s),await be(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){qe(i),document.execCommand("insertText",!1,t),i.dispatchEvent(new Event("input",{bubbles:!0})),ye("\u23F3 Buscando resultado da Canned Response...","info");let a=null,r=0,u=15e3,m=500;for(;r<u&&(a=document.querySelector("material-select-dropdown-item"),!a);)await be(m),r+=m;if(a){qe(a),await be(1500);let g=Bt();if(g&&n.advertiserName){let d=g.innerHTML;d.includes("{%ADVERTISER_NAME%}")&&(g.innerHTML=d.replace(/{%ADVERTISER_NAME%}/g,n.advertiserName))}$("Canned Response aplicada!")}else ye(`\u274C Timeout: Resultado '${t}' n\xE3o apareceu ap\xF3s 15s.`,"error"),$(`Timeout: Template '${t}' n\xE3o carregou.`,{error:!0})}}else $("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function mo(t){if(ye(`\u{1F680} Iniciando Quick Email: ${t.name}`),!await uo())return;let n=await at(),o=_t();await be(600),ye("\u{1F4E7} Processando destinat\xE1rios...");let s=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(s&&(s.click(),await be(600)),n.clientEmail&&n.clientEmail!=="N/A"&&n.clientEmail!=="N/A (Bloqueado)"){let r=document.querySelector('input[aria-label="Enter To email address"]');r&&(await xt(r,n.clientEmail),ht(r,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(n.internalEmail){let r=document.querySelector('input[aria-label="Enter Bcc email address"]');r&&(await xt(r,n.internalEmail),ht(r,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let g=r.querySelector(".cw-hero-grid"),d=r.querySelector(".cw-acc-container"),x=r.querySelector(".cw-results-container"),A=r.querySelector(".cw-search-input"),v=r.querySelector(".cw-status-bar"),b=r.querySelector(".cw-status-text"),S=r.querySelector(".cw-footer-icons");s.forEach(([O,k])=>{let M=o(k.name),D=document.createElement("div");D.className="cw-hero-card",D.id=`hero-${O}`,D.style.setProperty("--hero-color",M.color),D.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${We[M.icon]}</div>
...
<b>Additional Comments:</b> (Optional)`.replace(/\n/g,"<br>");ct(c);let y=await Et();y?(y.innerText.trim()===""&&(y.innerHTML=""),document.execCommand("insertHTML",!1,c),St(y),$("Nota S&T inserida!")):$("Copiado! Abra uma nota para colar.")},e}function Eo(){let t="v3.7.0 (S&T Mode)",e="bau",n="pt",o=!1,s=!1,i=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},r=Ao(),u=Co(()=>{let U=u.getCheckedElements().map(R=>R.value);p&&p.value&&r.updateVisibility(p.value,U)}),m=document.createElement("div");m.id="autofill-popup",m.classList.add("cw-module-window"),Object.assign(m.style,Ce,{right:"100px",width:"450px",transition:"width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)"});let g={popup:m,googleLine:null},d=Se(m,"Case Notes",t,"Gera notas padronizadas.",g,()=>Lt());m.appendChild(d);let x=d.lastElementChild;if(x){let C=document.createElement("div");C.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',Object.assign(C.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease",marginLeft:"4px"}),C.title="Alternar para Split & Transfer",C.onmouseenter=()=>{C.style.background="rgba(255,255,255,0.1)",C.style.color="#FFF"},C.onmouseleave=()=>{i||(C.style.background="transparent",C.style.color="#9AA0A6")},C.onclick=U=>{U.stopPropagation(),S(C)},x.insertBefore(C,x.firstChild)}let A=document.createElement("div");Object.assign(A.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),m.appendChild(A);let v=document.createElement("div");Object.assign(v.style,{flexGrow:"1",display:"none",overflow:"hidden"});let b=So(()=>S());v.appendChild(b),m.appendChild(v);function S(C){i=!i,i?(A.style.display="none",v.style.display="flex",g.googleLine&&(g.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)"),C&&(C.style.color="#C58AF9",C.style.background="rgba(197, 138, 249, 0.15)")):(A.style.display="block",v.style.display="none",g.googleLine&&(g.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"),C&&(C.style.color="#9AA0A6",C.style.background="transparent"))}let E=document.createElement("div");E.textContent="created by lucaste@",Object.assign(E.style,so),m.appendChild(E);let G=document.createElement("div");G.id="step-lang-type";let Q=document.createElement("label");Object.assign(Q.style,a.label),G.appendChild(Q);let X=document.createElement("div");Object.assign(X.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let O=document.createElement("div");O.textContent="Portugu\xEAs",O.classList.add("no-drag"),Object.assign(O.style,xe);let k=document.createElement("div");k.textContent="Espa\xF1ol",k.classList.add("no-drag"),Object.assign(k.style,xe),O.onclick=()=>qt("pt"),k.onclick=()=>qt("es"),X.appendChild(O),X.appendChild(k),G.appendChild(X),A.appendChild(G);let M=document.createElement("div");M.id="step-0-case-type";let D=document.createElement("label");Object.assign(D.style,a.label),M.appendChild(D);let N=document.createElement("div");Object.assign(N.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let T=document.createElement("div");T.textContent="BAU",T.classList.add("no-drag"),Object.assign(T.style,xe);let B=document.createElement("div");B.textContent="LM",B.classList.add("no-drag"),Object.assign(B.style,xe),T.onclick=()=>Ot("bau"),B.onclick=()=>Ot("lm"),N.appendChild(T),N.appendChild(B),M.appendChild(N),A.appendChild(M);let f=document.createElement("div");f.id="step-1-selection";let h=document.createElement("label");h.className="cw-input-label",h.textContent="Status Principal";let q=document.createElement("select");q.id="main-status",q.className="cw-select",q.innerHTML=`
  ...
  `;let l=document.createElement("div");l.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let c=document.createElement("label");c.className="cw-input-label",c.textContent="Sub-status",c.style.marginBottom="0";let y=document.createElement("a");y.href="https://seu-link-do-guia-aqui.com",y.target="_blank",y.className="cw-info-link",y.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(y.style,a.helpLink),l.appendChild(c),l.appendChild(y);let p=document.createElement("select");p.id="sub-status",p.className="cw-select",p.disabled=!0,p.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',f.appendChild(h),f.appendChild(q),f.appendChild(l),f.appendChild(p),A.appendChild(f);let w=document.createElement("div");w.id="step-1-1-portugal",Object.assign(w.style,a.stepBlock,{display:"none"});let I=document.createElement("label");Object.assign(I.style,a.label),w.appendChild(I);let P=document.createElement("div");Object.assign(P.style,a.radioContainer);let _=document.createElement("div");Object.assign(_.style,{display:"flex",alignItems:"center"});let F=document.createElement("input");F.type="radio",F.name="portugal-group",F.value="sim",Object.assign(F.style,a.checkboxInput);let j=document.createElement("label");j.htmlFor="portugal-sim",Object.assign(j.style,{cursor:"pointer"}),_.appendChild(F),_.appendChild(j);let V=document.createElement("div");Object.assign(V.style,{display:"flex",alignItems:"center"});let L=document.createElement("input");L.type="radio",L.name="portugal-group",L.value="nao",L.checked=!0,Object.assign(L.style,a.checkboxInput);let z=document.createElement("label");z.htmlFor="portugal-nao",Object.assign(z.style,{cursor:"pointer"}),V.appendChild(L),V.appendChild(z),P.appendChild(_),P.appendChild(V),w.appendChild(P),A.appendChild(w);function Z(C){o=C,C?te.style.display="block":te.style.display="none"}F.onchange=()=>Z(!0),L.onchange=()=>Z(!1);let te=document.createElement("div");te.id="step-1-2-consent",Object.assign(te.style,a.stepBlock,{display:"none"});let se=document.createElement("label");Object.assign(se.style,a.label),te.appendChild(se);let le=document.createElement("div");Object.assign(le.style,a.radioContainer);let pe=document.createElement("div");Object.assign(pe.style,{display:"flex",alignItems:"center"});let we=document.createElement("input");we.type="radio",we.name="consent-group",we.value="Sim",we.checked=!0,Object.assign(we.style,a.checkboxInput);let Fe=document.createElement("label");Fe.htmlFor="consent-sim",Object.assign(Fe.style,{cursor:"pointer"}),pe.appendChild(we),pe.appendChild(Fe);let et=document.createElement("div");Object.assign(et.style,{display:"flex",alignItems:"center"});let Ne=document.createElement("input");Ne.type="radio",Ne.name="consent-group",Ne.value="N\xE3o",Object.assign(Ne.style,a.checkboxInput);let pt=document.createElement("label");pt.htmlFor="consent-nao",Object.assign(pt.style,{cursor:"pointer"}),et.appendChild(Ne),et.appendChild(pt),le.appendChild(pe),le.appendChild(et),te.appendChild(le),A.appendChild(te);let Ge=document.createElement("div");Ge.id="step-1-5-snippets",Object.assign(Ge.style,a.stepBlock,{display:"none"});let ut=document.createElement("h3");Object.assign(ut.style,a.h3),ut.textContent="Cen\xE1rios Comuns";let ke=yo(C=>{let U=document.querySelector("textarea");U&&(U.value=C,U.dispatchEvent(new Event("input")),U.style.transition="background-color 0.2s",U.style.backgroundColor="#e8f0fe",setTimeout(()=>U.style.backgroundColor="#fff",300))});ke.id="snippet-container",Ge.appendChild(ut),Ge.appendChild(ke),A.appendChild(Ge);let Ae=document.createElement("div");Ae.id="step-3-form",Object.assign(Ae.style,a.stepBlock,{display:"none"});let kt=document.createElement("h3");Object.assign(kt.style,a.h3),Ae.appendChild(kt);let Re=document.createElement("div");Re.id="dynamic-form-fields-container",Ae.appendChild(Re);let fe=document.createElement("button");fe.textContent="+ Gostaria de selecionar uma task?",Object.assign(fe.style,a.optionalBtn),fe.onmouseover=()=>fe.style.background="#e8f0fe",fe.onmouseout=()=>fe.style.background="white",fe.onclick=()=>{fe.style.display="none",Be.style.display="block",u.selectionElement.style.display="block"};let Be=document.createElement("h3");Object.assign(Be.style,a.h3,{marginTop:"20px"});let Wt=u.selectionElement;Object.assign(Wt.style,{marginBottom:"20px"}),Ae.appendChild(fe),Ae.appendChild(Be),Ae.appendChild(Wt),Ae.appendChild(r.element),Ae.appendChild(u.screenshotsElement),A.appendChild(Ae);let Pe=document.createElement("div");Pe.id="step-4-email",Object.assign(Pe.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let je=document.createElement("label");je.style.display="flex",je.style.alignItems="center",je.style.cursor="pointer",je.style.fontSize="14px";let He=document.createElement("input");He.type="checkbox",He.checked=!0,Object.assign(He.style,a.checkboxInput),je.appendChild(He),je.appendChild(document.createTextNode("Preencher email automaticamente?")),Pe.appendChild(je),A.appendChild(Pe);let Ke=document.createElement("div");Object.assign(Ke.style,{display:"none",gap:"8px",padding:"0"}),A.appendChild(Ke);let tt=document.createElement("button");Object.assign(tt.style,a.buttonBase,{backgroundColor:"#5f6368"}),tt.textContent="Copiar";let ot=document.createElement("button");Object.assign(ot.style,a.buttonBase,{backgroundColor:"#1a73e8"}),ot.textContent="Preencher",Ke.appendChild(tt),Ke.appendChild(ot);let nt=document.createElement("div");Object.assign(nt.style,Qe),nt.className="no-drag",nt.title="Redimensionar",m.appendChild(nt),Ze(m,nt),document.body.appendChild(m);function Ot(C){e=C;let U=it();Object.assign(T.style,xe),Object.assign(B.style,xe),C==="bau"?(Object.assign(T.style,U),y.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(B.style,U),y.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),p.value&&p.dispatchEvent(new Event("change"))}function oe(C){try{if(_e&&_e[n]&&_e[n][C])return _e[n][C];if(_e&&_e.pt&&_e.pt[C])return _e.pt[C]}catch{}return C}function Do(){Q.textContent=oe("idioma"),D.textContent=oe("fluxo"),h.textContent=oe("status_principal"),c.textContent=oe("substatus"),ut.textContent=oe("cenarios_comuns"),Be.textContent=oe("selecione_tasks"),kt.textContent=oe("preencha_detalhes"),tt.textContent=oe("copiar"),ot.textContent=oe("preencher"),q.querySelector('option[value=""]')&&(q.querySelector('option[value=""]').textContent=oe("select_status")),p.querySelector('option[value=""]')&&(p.querySelector('option[value=""]').textContent=oe("select_substatus")),I.textContent=oe("caso_portugal"),j.textContent=oe("sim"),z.textContent=oe("nao"),se.textContent=oe("consentiu_gravacao"),Fe.textContent=oe("sim"),pt.textContent=oe("nao"),Re.querySelectorAll("label").forEach(C=>{let U=C.nextElementSibling.id.replace("field-",""),R=oe(U.toLowerCase());R!==U.toLowerCase()?C.textContent=R:C.textContent=U.replace(/_/g," ").replace(/\b\w/g,J=>J.toUpperCase())+":"}),fe.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function qt(C){n=C;let U=it();Object.assign(O.style,xe),Object.assign(k.style,xe),C==="pt"?(Object.assign(O.style,U),w.style.display="block",Z(o)):(Object.assign(k.style,U),w.style.display="none",te.style.display="none"),Do(),p.value&&p.dispatchEvent(new Event("change"))}function It(C){(C.value.trim()===""||C.value.trim()==="\u2022")&&(C.value="\u2022 "),C.onkeydown=function(U){if(U.key==="Enter"){U.preventDefault();let R=this.selectionStart,J=this.selectionEnd,ce=this.value,me=ce.lastIndexOf(`
`,R-1)+1,Te=ce.substring(me,R),ge=Te.trim()==="\u2022"||Te.trim()===""?`
`:`
\u2022 `;this.value=ce.substring(0,R)+ge+ce.substring(J),this.selectionStart=this.selectionEnd=R+ge.length}else if(U.key==="Backspace"){let R=this.selectionStart;if(R===this.selectionEnd&&R>0){let J=this.value.substring(0,R);J.endsWith(`
\u2022 `)?(U.preventDefault(),this.value=J.substring(0,R-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=R-3):J==="\u2022 "&&(U.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function Ft(){let C=typeof ke<"u"?ke:document.getElementById("snippet-container");if(!C)return;let U=C.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),R={},J=new Set;U.forEach(re=>{let ie=re.id,Y=Oe[ie];if(Y)for(let H in Y)H==="linkedTask"?J.add(Y.linkedTask):H!=="type"&&(R[H]||(R[H]=[]),R[H].includes(Y[H])||R[H].push(Y[H]))});let ce=new Set;Object.values(Oe).forEach(re=>{Object.keys(re).forEach(ie=>{ie!=="linkedTask"&&ie!=="type"&&ce.add(ie)})}),ce.forEach(re=>{let ie=document.getElementById(re);if(ie){let Y=R[re]||[],H="";lt.includes(re.replace("field-",""))?(H=Y.map(ae=>ae.startsWith("\u2022 ")?ae:"\u2022 "+ae).join(`
`),H===""?H="\u2022 ":H.endsWith(`
\u2022 `)||(H+=`
\u2022 `)):H=Y.join(`

`),H.trim()!=="\u2022"&&H.trim()!==""?ie.value=H:lt.includes(re.replace("field-",""))?ie.value="\u2022 ":ie.value="",ie.tagName==="TEXTAREA"&&typeof It=="function"&&It(ie)}});let me=new Set,Te=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(re=>{let ie=Oe[re.id];ie&&ie.linkedTask&&(re.checked?me.add(ie.linkedTask):Te.add(ie.linkedTask))}),Te.forEach(re=>{me.has(re)||u.toggleTask(re,!1)}),me.forEach(re=>{u.toggleTask(re,!0)})}q.onchange=()=>{let C=q.value;if(Mt(1.5),p.innerHTML=`<option value="">${oe("select_substatus")}</option>`,!C){p.disabled=!0;return}for(let U in rt){let R=rt[U];if(R.status===C){let J=document.createElement("option");J.value=U,J.textContent=R.name,p.appendChild(J)}}p.disabled=!1},p.onchange=()=>{let C=p.value;if(Mt(1.5),!C)return;u.updateSubStatus(C);let U=rt[C];ke.innerHTML="";let R=(Y,H,ae)=>{let ue=document.createElement("label");Object.assign(ue.style,a.checkboxLabel),ue.onmouseover=()=>ue.style.backgroundColor="#e8eaed",ue.onmouseout=()=>ue.style.backgroundColor="#f8f9fa";let de=document.createElement("input");return de.type=H,de.id=Y.id,Object.assign(de.style,a.checkboxInput),ue.appendChild(de),ue.appendChild(document.createTextNode(` ${Y.text}`)),ae.appendChild(ue),de},J=[],ce="radio";if(C==="NI_Awaiting_Inputs")J=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))ce="checkbox",J=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"},{id:"quickfill-ga4-event-close",text:"Fechamento GA4 (P\xF3s 2 dias)"}];else if(C.startsWith("AS_")){ce="checkbox";let Y=document.createElement("label");Y.textContent=oe("cenarios_comuns"),Object.assign(Y.style,a.label),ke.appendChild(Y),J=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")?J=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:C.startsWith("DC_")?(ce="radio",J=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]):C==="NI_Attempted_Contact"?(ce="radio",J=[{id:"quickfill-ni-attempted-2day",text:"2 Day Rule (2 Liga\xE7\xF5es + Chat AM)"}]):C==="NI_Awaiting_Validation"&&(ce="checkbox",J=[{id:"quickfill-ni-awaiting-ecw4",text:"ECW4 (Acompanhar)"},{id:"quickfill-ni-awaiting-ga4",text:"GA4 Event Tracking (Acompanhar)"}]);let me=J.filter(Y=>{let H=Oe[Y.id];return!H.type||H.type==="all"||H.type===e});me.forEach((Y,H)=>{let ae=R(Y,ce,ke);ce==="radio"&&(ae.name="scenario-radio-group",H===0&&(ae.checked=!0))}),me.length>0&&(Ge.style.display="block"),U.requiresTasks?(fe.style.display="none",Be.style.display="block",u.selectionElement.style.display="block"):(fe.style.display="block",Be.style.display="none",u.selectionElement.style.display="none"),Re.innerHTML="";let Te=U.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(Te)].forEach(Y=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(Y))return;let H=Y.slice(1,-1),ae=document.createElement("label"),ue=oe(H.toLowerCase());if(ae.textContent=ue!==H.toLowerCase()?ue:H.replace(/_/g," ").replace(/\b\w/g,ee=>ee.toUpperCase())+":",Object.assign(ae.style,a.label),H==="SPEAKEASY_ID"){let ee=document.createElement("button");ee.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',ee.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,ee.title="Localizar Speakeasy ID no hist\xF3rico",ee.onmouseover=()=>{ee.style.backgroundColor="#c2e7ff",ee.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},ee.onmouseout=()=>{ee.style.backgroundColor="#d3e3fd",ee.style.boxShadow="none"},ee.onmousedown=()=>{ee.style.backgroundColor="#a8c7fa",ee.style.transform="scale(0.96)"},ee.onmouseup=()=>ee.style.transform="scale(1)",ee.onclick=he=>{he.preventDefault(),po(`field-${H}`)},ae.appendChild(ee)}let de;lt.includes(H)?(de=document.createElement("textarea"),Object.assign(de.style,a.textarea),de.classList.add("bullet-textarea"),It(de)):Gt.includes(H)?(de=document.createElement("textarea"),Object.assign(de.style,a.textarea)):(de=document.createElement("input"),de.type="text",Object.assign(de.style,a.input),H==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign(ae.style,{display:"none"}),Object.assign(de.style,{display:"none"}))),H==="ON_CALL"&&e==="lm"&&(Object.assign(ae.style,{display:"none"}),Object.assign(de.style,{display:"none"}),de.value="N/A"),de.id=`field-${H}`,Re.appendChild(ae),Re.appendChild(de)});let re=ke.querySelectorAll('input[type="checkbox"], input[type="radio"]');re.length>0&&(re.forEach(Y=>{Y.removeEventListener("change",Ft),Y.addEventListener("change",Ft)}),Ft()),Ae.style.display="block",Ue[C]?Pe.style.display="block":Pe.style.display="none",Ke.style.display="flex";let ie=u.getCheckedElements().map(Y=>Y.value);r.updateVisibility(C,ie)},fe.onclick=()=>{fe.style.display="none",Be.style.display="block",u.selectionElement.style.display="block"};function Yt(){let C=p.value;if(!C)return null;let R=rt[C].template.replace(/\n/g,"<br>"),J='style="margin-bottom: 12px; padding-left: 30px;"',ce=[],me="",Te=u.getCheckedElements();Te.length>0&&Te.forEach(ie=>{let Y=ie.value,H=De[Y],ae=ie.closest().querySelector(".stepper-count"),ue=ae?parseInt(ae.textContent):1;ue>1?ce.push(`${H.name} (x${ue})`):ce.push(H.name)});let ge=u.screenshotsElement;if(ge){let ie=Array.from(ge.querySelectorAll('input[id^="name-"]'));ie.length>0&&ie.forEach(Y=>{let H=Y.value,ae=Y.closest(".cw-screen-card");if(ae){let ue=ae.querySelectorAll('input[id^="screen-"]'),de=!1,ee="";ue.forEach(he=>{let Xt=he.closest(".cw-input-group"),Kt=Xt?Xt.querySelector(".cw-input-label"):null,zo=Kt?Kt.textContent:"Evid\xEAncia",Qt=he.value.trim(),Go=Qt?` ${Qt}`:"";ee+=`<li>${zo} -${Go}</li>`,de=!0}),de&&(me+=`<b>${H}</b>`,me+=`<ul ${J}>${ee}</ul>`)}})}if(R.includes("{TAGS_IMPLEMENTED}")?R=R.replace(/{TAGS_IMPLEMENTED}/g,ce.join(", ")||"N/A"):ce.length>0&&(R+=`<br><b>Tags:</b> ${ce.join(", ")}<br>`),R.includes("{SCREENSHOTS_LIST}")?R=R.replace(/{SCREENSHOTS_LIST}/g,me?`${me}`:"N/A"):me!==""&&(R+=`<br>${me}`),n==="pt"&&o){let ie=we.checked?oe("sim"):oe("nao");R=R.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${oe("consentiu_gravacao")}</b> ${ie}<br><br>`),R=R.replace(/{CASO_PORTUGAL}/g,`<br><b>${oe("caso_portugal")}</b> ${oe("sim")}<br>`)}else n==="pt"&&!o?(R=R.replace(/{CASO_PORTUGAL}/g,`<br><b>${oe("caso_portugal")}</b> ${oe("nao")}<br>`),R=R.replace(/{CONSENTIU_GRAVACAO}/g,"")):(R=R.replace(/{CASO_PORTUGAL}/g,""),R=R.replace(/{CONSENTIU_GRAVACAO}/g,""));return Re.querySelectorAll("input, textarea").forEach(ie=>{let Y=ie.id.replace("field-",""),H=new RegExp(`{${Y}}`,"g"),ae=ie.value;if(Y==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let ee=ke.querySelector('input[type="radio"]:checked');ee&&Oe[ee.id]&&(ae=Oe[ee.id]["field-REASON_COMMENTS"])}if(lt.includes(Y)&&ae.trim()!==""){let ee=ae.split(`
`).map(he=>he.trim()).filter(he=>he!==""&&he!=="\u2022").map(he=>he.startsWith("\u2022 ")?he.substring(2):he).map(he=>`<li>${he}</li>`).join("");ae=ee?`<ul ${J}>${ee}</ul>`:""}else Gt.includes(Y)?ae=ae.split(`
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):ie.tagName==="TEXTAREA"&&(ae=ae.replace(/\n/g,"<br>"));let ue=ae.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ue===""||ue==="\u2022"||ue.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${Y}\\}(?:<br>\\s*)?`,"gi");ee.test(R)?R=R.replace(ee,""):R=R.replace(H,"")}else R=R.replace(H,ae.replace(/\$/g,"$$$$"))}),R=R.replace(/{([A-Z0-9_]+)}/g,""),R=R.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(R+=r.getOutput()),R}tt.onclick=()=>{let C=Yt();C?(ct(C),$(oe("copiado_sucesso"))):$(oe("selecione_substatus"),{error:!0})},ot.onclick=async()=>{let C=p.value,U=Yt();if(!U){$(oe("selecione_substatus"),{error:!0});return}ct(U),Lt();let R=At(),J=await Et();if(J)try{if(J.focus(),J.innerHTML.trim()==="<p><br></p>"||J.innerHTML.trim()==="<br>"||J.innerText.trim()===""){let ge=document.createRange();ge.selectNodeContents(J);let re=window.getSelection();re.removeAllRanges(),re.addRange(ge),document.execCommand("delete",!1,null)}else if(!J.innerHTML.endsWith("<br><br>")){let ge=document.createRange();ge.selectNodeContents(J),ge.collapse(!1);let re=window.getSelection();re.removeAllRanges(),re.addRange(ge),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,U),St(J),setTimeout(()=>{$(oe("inserido_copiado"))},600);let me=typeof He<"u"&&He?He.checked:!0;if(C&&Ue[C]&&me){let ge=Ue[C];await yt(ge),await new Promise(re=>setTimeout(re,500))}R(),Mt(1.5),q.value="",p.innerHTML=`<option value="">${oe("select_substatus")}</option>`,p.disabled=!0}catch(ce){console.error(ce),$("Erro ao inserir.",{error:!0}),R()}};function Mt(C=1.5){C<=1.5&&(Ge.style.display="none",ke.innerHTML=""),C<=2&&(u.reset(),fe.style.display="none"),C<=3&&(Ae.style.display="none",Re.innerHTML="",r.reset(),Ke.style.display="none",Pe.style.display="none")}function Lt(){if(s=!s,s){let C=m.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Ee(s,m,"cw-btn-notes")}return Ot("bau"),qt("pt"),Lt}var Ye={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function Oo(){let t="v2.1 (Apple Motion)",e={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Ce,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function u(){i=!i,Ee(i,a,"cw-btn-script")}let m=Se(a,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{u()});a.appendChild(m);let g=document.createElement("div");Object.assign(g.style,e.progressBarContainer);let d=document.createElement("div");Object.assign(d.style,e.progressBarFill),g.appendChild(d),a.appendChild(g);let x=document.createElement("div");x.id="csa-content",Object.assign(x.style,e.contentArea),a.appendChild(x);let A=document.createElement("div");Object.assign(A.style,e.footer);let v=document.createElement("span");v.textContent="by lucaste@",Object.assign(v.style,{fontSize:"10px",color:"#bdc1c6"});let b=document.createElement("button");b.innerHTML=`
  ...
  `,b.onfocus=()=>{A.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",A.style.border="1px solid #1a73e8"},b.onblur=()=>{A.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",A.style.border="1px solid transparent"},A.appendChild(v),A.appendChild(b),x.appendChild(A),d.appendChild(x);let S=document.createElement("div");S.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",d.appendChild(S);let E=null;function G(){if(E)return;E=document.createElement("div"),E.style.cssText=`
      ...
      `;let f=document.createElement("div");f.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",f.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let h=document.createElement("button");h.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',h.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",h.onclick=()=>{X(),s=!1,D()},f.appendChild(h),E.appendChild(f);let q=document.createElement("div");q.id="cw-history-list",q.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",E.appendChild(q),d.appendChild(E)}function Q(){E||G();let f=E.querySelector("#cw-history-list");f.innerHTML="";let h=Zo();h.length===0?f.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':h.forEach(q=>{let l=T(q,Xe[q._originalCat],!0,q._originalCat);f.appendChild(l)}),requestAnimationFrame(()=>E.style.transform="translateY(0)")}function X(){E&&(E.style.transform="translateY(100%)")}function O(){g.innerHTML="";let f=k("history","Recentes",Xe.history);f.id="cw-sidebar-btn-history",f.onclick=()=>{W.playClick(),s=!s,s?Q():X(),D()},g.appendChild(f);let h=document.createElement("div");h.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",g.appendChild(h),Object.keys(dt).forEach(q=>{let l=dt[q],c=k(q,l.label,Xe[q]);c.id=`cw-sidebar-btn-${q}`,c.onclick=()=>{W.playClick(),s&&(s=!1,X()),M(q)},g.appendChild(c)})}function k(f,h,q){let l=document.createElement("div");l.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,l.title=h,l.dataset.key=f;let c=document.createElement("div");c.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",c.innerHTML=q||Xe.tasks;let y=document.createElement("div");return y.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",y.textContent=h,l.appendChild(c),l.appendChild(y),l.onmouseenter=()=>{o!==f&&!(f==="history"&&s)&&(l.style.background="#F1F3F4",c.style.transform="scale(1.1)")},l.onmouseleave=()=>{o!==f&&!(f==="history"&&s)&&(l.style.background="transparent",c.style.transform="scale(1)")},l}function M(f){let h=document.getElementById(`cat-anchor-${f}`);h&&(h.scrollIntoView({behavior:"smooth",block:"start"}),o=f,D())}function D(){Object.keys(dt).forEach(h=>{let q=g.querySelector(`#cw-sidebar-btn-${h}`);if(q)if(o===h&&!s){let l=Tt[h];q.style.background=l.bg,q.style.color=l.color,q.querySelector("div:first-child").style.transform="scale(1.1)"}else q.style.background="transparent",q.style.color=i.textSecondary,q.querySelector("div:first-child").style.transform="scale(1)"});let f=g.querySelector("#cw-sidebar-btn-history");f&&(s?(f.style.background="#3C4043",f.style.color="#FFFFFF"):(f.style.background="transparent",f.style.color=i.textSecondary))}function N(){if(S.innerHTML="",e.trim()!==""){let h=[];if(Object.entries(dt).forEach(([l,c])=>{let y=c.links.filter(p=>p.name.toLowerCase().includes(e.toLowerCase())||p.desc.toLowerCase().includes(e.toLowerCase()));h.push(...y.map(p=>({...p,_cat:l})))}),h.length===0){S.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let q=document.createElement("div");q.innerHTML="Resultados da busca",q.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",S.appendChild(q),h.forEach(l=>{let c=T(l,Xe[l._cat],!1,l._cat);S.appendChild(c)});return}Object.entries(dt).forEach(([h,q])=>{let l=Tt[h],c=document.createElement("div"),y=document.createElement("div");y.id=`cat-anchor-${h}`,y.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,y.innerHTML=`
            ...
            ${q.label}
          `,c.appendChild(y);let p=document.createElement("div");p.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",q.links.forEach(w=>{let I=T(w,Xe[h],!1,h);p.appendChild(I)}),c.appendChild(p),S.appendChild(c)});let f=document.createElement("div");f.style.height="80px",S.appendChild(f)}function T(f,h,q,l){let c=document.createElement("div"),y=Tt[l]||Tt.history;c.style.cssText=`
      ...
      `,v.querySelectorAll('input[name="cw-bc-type"]').forEach(p=>{p.addEventListener("change",()=>{v.querySelectorAll(".cw-radio-option").forEach(w=>w.classList.remove("checked")),p.parentElement.classList.add("checked")})}),setTimeout(()=>{let p=v.querySelector(".cw-radio-option.info");p&&p.classList.add("checked")},100);let l=v.querySelector("#cw-bc-cancel"),c=v.querySelector("#cw-bc-close-x"),y=v.querySelector("#cw-bc-send");l.onclick=Q,c.onclick=Q,y.onclick=X,m.appendChild(v)}function G(l=null){if(!v)return;let c=v.querySelector("#cw-editor-title-label"),y=v.querySelector("#cw-bc-title"),p=v.querySelector("#cw-bc-text"),w=v.querySelector("#cw-bc-send");if(l){o=l.id,c.textContent="Editar Aviso",y.value=l.title||"",p.value=l.text||"",w.textContent="Salvar Altera\xE7\xF5es";let I=l.type||"info",P=v.querySelector(`input[name="cw-bc-type"][value="${I}"]`);P&&P.click()}else{o=null,c.textContent="Novo Aviso",y.value="",p.value="",w.textContent="Publicar";let I=v.querySelector('input[name="cw-bc-type"][value="info"]');I&&I.click()}v.classList.add("active"),setTimeout(()=>y.focus(),300)}function Q(){v&&v.classList.remove("active"),o=null}async function X(){let l=v.querySelector("#cw-bc-send"),c=v.querySelector("#cw-bc-title"),y=v.querySelector("#cw-bc-text"),p=v.querySelector('input[name="cw-bc-type"]:checked'),w=p?p.value:"info";if(!c.value.trim()||!y.value.trim()){$("Preencha todos os campos!",{error:!0});return}l.textContent="Salvando...",l.style.opacity="0.7";let I=!1;o?I=await ve.updateBroadcast(o,{title:c.value,text:y.value,type:w}):I=await ve.sendBroadcast({title:c.value,text:y.value,type:w,author:window._cwCurrentUser||"admin"}),I?($(o?"Atualizado!":"Publicado!"),W.playSuccess(),Q(),setTimeout(()=>M(),1500)):($("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),l.textContent=o?"Salvar Altera\xE7\xF5es":"Publicar",l.style.opacity="1")}async function O(l){if(confirm("Confirma a exclus\xE3o deste aviso?"))if(await ve.deleteBroadcast(l)){$("Aviso removido."),W.playClick();let y=ze.findIndex(p=>p.id===l);y>-1&&ze.splice(y,1),N(),setTimeout(()=>M(),1500)}else $("Erro ao excluir.",{error:!0})}let k=document.createElement("div");k.className="cw-nice-scroll",Object.assign(k.style,i.feedContainer),m.appendChild(k);async function M(){e&&(S.style.display="block",S.innerHTML="\u{1F504} Sincronizando...");try{let l=await ve.fetchData();l&&l.broadcast&&(Vt(l.broadcast),D(),e&&(N(),S.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{S.style.display="none"},1500)))}catch{e&&(S.innerHTML="\u26A0\uFE0F Offline")}}function D(){let l=document.getElementById("cw-btn-broadcast");if(!l)return;let c=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(ze.some(p=>!c.includes(p.id))){if(l.classList.add("has-new"),!l.querySelector(".cw-badge")){let p=document.createElement("div");p.className="cw-badge",Object.assign(p.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),l.appendChild(p)}}else{l.classList.remove("has-new");let p=l.querySelector(".cw-badge");p&&p.remove()}}function N(){k.innerHTML="";let l=m.querySelector("#cw-bau-widget");l&&l.remove();let c=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),y=[...ze].sort((_,F)=>{let j=new Date(_.date).getTime()||0;return(new Date(F.date).getTime()||0)-j}),p=y.findIndex(_=>_.title&&_.title.toLowerCase().includes("disponibilidade bau"));if(p!==-1){let _=y[p];y.splice(p,1);let F=document.createElement("div");F.id="cw-bau-widget",Object.assign(F.style,i.bauContainer);let j=[],V=(_.text||"").split(`
`),L=/\d{1,2}\/\d{1,2}/;if(V.forEach(le=>{let pe=le.match(L);if(pe){let we=pe[0],Fe="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(le)?Fe="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(le)&&(Fe="\u{1F1EA}\u{1F1F8}"),j.some(Ne=>Ne.flag===Fe&&Ne.date===we)||j.push({flag:Fe,date:we})}}),j.length===0){let le=(_.text||"").match(/\d{1,2}\/\d{1,2}/g);le&&[...new Set(le)].forEach(pe=>j.push({flag:"\u{1F4C5}",date:pe}))}let z="",Z='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(Z=`
              ...
              `),j.length>0?z=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${j.map(pe=>`

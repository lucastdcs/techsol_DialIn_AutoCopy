...
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var ie=e=>new Promise(t=>setTimeout(t,e));function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Qe(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,l=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&l})}async function _t(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(s=>s.innerText.trim()==="email");if(n&&n.offsetParent!==null){let s=n.closest("material-button")||n.closest("material-fab")||n;s.style&&(s.style.display="block",s.style.visibility="visible"),Ce(s),e=!0}else{let s=document.querySelector("material-fab-speed-dial");if(s){let p=s.querySelector(".trigger");if(p){p.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Ce(p),await ie(1e3);let x=Array.from(document.querySelectorAll("i.material-icons-extended")).find(b=>b.innerText.trim()==="email");x&&(Ce(x),e=!0)}else s.click()}}let o=0,l=Qe();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!l&&o<30;)await ie(500),l=Qe(),o++;if(!l)return K("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let i=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(s=>s.offsetParent!==null);if(i){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),Ce(i);let s=null,p=0;for(;!s&&p<10;)await ie(200),s=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(x=>x.offsetParent!==null),p++;s?(console.log("\u2705 Confirmando descarte..."),Ce(s),await ie(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(l){let s=l.closest('[id="email-body-content-top"]'),S=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(s){if(S){let b=S.closest('[aria-hidden="true"]');b&&b.removeAttribute("aria-hidden"),S.focus()}await ie(300),s.innerHTML=`
    ...
    `,document.head.appendChild(e)}function we(e,t,n){let o=document.getElementById(n);t.classList.contains("cw-module-window")||t.classList.add("cw-module-window");let l=()=>{if(!o)return;let a=o.getBoundingClientRect(),i=a.left+a.width/2,s=a.top+a.height/2,p=t.offsetLeft,S=t.offsetTop,x=i-p,b=s-S;t.style.transformOrigin=`${x}px ${b}px`};e?(l(),t.style.opacity="",t.style.pointerEvents="",t.style.transform="",t.offsetWidth,t.classList.add("open"),t.classList.remove("idle"),o&&o.classList.add("active"),Jt(t,n)):(l(),t.classList.remove("open"),t.classList.remove("idle"),o&&o.classList.remove("active"),Mt(t))}function Jt(e,t){Mt(e);let n=o=>{if(!e.classList.contains("open"))return;let l=e.contains(o.target),a=document.querySelector(".cw-pill"),i=a&&a.contains(o.target);l?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function Mt(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var J={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",gripColor:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",gripActive:"linear-gradient(to left, #4285F4, #EA4335, #FBBC05, #34A853)",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995"},Ze=e=>new Promise(t=>setTimeout(t,e));function Dt(e){let t="cw-command-center-style";if(!document.getElementById(t)){let g=document.createElement("style");g.id=t,g.innerHTML=`
            ...
            .cw-pill {
                ...
                border: 1px solid ${J.glassBorder};
                border-radius: 50px;
...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
            ...
            /* Cores de Marca */
            .cw-btn.notes:hover { color: ${J.blue}; filter: drop-shadow(0 0 5px rgba(138, 180, 248, 0.5)); }
            .cw-btn.email:hover { color: ${J.red}; filter: drop-shadow(0 0 5px rgba(242, 139, 130, 0.5)); }
            .cw-btn.script:hover { color: ${J.purple}; filter: drop-shadow(0 0 5px rgba(197, 138, 249, 0.5)); }
            .cw-btn.links:hover { color: ${J.green}; filter: drop-shadow(0 0 5px rgba(129, 201, 149, 0.5)); }
            ...
            .cw-pill.dragging .cw-grip-bar { 
                background-color: ${J.blue}; /* Azul Google de A\xE7\xE3o */
                width: 16px; /* Encolhe horizontalmente (tens\xE3o f\xEDsica) */
                opacity: 1;
            }

            /* ESTADO COLAPSADO (S\xF3 o Grip vis\xEDvel) */
          .cw-pill.collapsed {
              /* Encolhe altura e largura para ficar s\xF3 um "tic-tac" */
              width: 40px; 
              height: 12px; /* Altura do grip + padding m\xEDnimo */
              padding: 8px 0;
              gap: 0;
              overflow: hidden; /* Esconde os bot\xF5es */
              border-radius: 20px; /* Mais arredondado */
              background: rgba(61, 61, 61, 0.95); /* Menos transparente */
          }

          /* Esconde conte\xFAdo interno quando colapsado */
          ...
          .cw-pill.collapsed > .cw-status-container {
              ...
              pointer-events: none;
              transform: scale(0.8);
              transition: opacity 0.2s, transform 0.2s; /* R\xE1pido */
          }
          ...
          .cw-pill.collapsed .cw-grip-bar {
              background-color: ${J.blue}; /* Azul para indicar "estou aqui" */
              opacity: 0.8;
          }
           ...
           @keyframes successPop {
            ...
            .cw-dots span:nth-child(1) { background: ${J.blue}; animation-delay: -0.32s; }
            .cw-dots span:nth-child(2) { background: ${J.red}; animation-delay: -0.16s; }
            .cw-dots span:nth-child(3) { background: ${J.green}; }
    ...
    `;let l=document.createElement("div");l.className="cw-focus-backdrop",document.body.appendChild(l),document.body.appendChild(o),o.querySelector(".notes").onclick=g=>{g.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=g=>{g.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=g=>{g.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=g=>{g.stopPropagation(),e.toggleLinks()},(async function(){await Ze(2850),o.classList.add("docked"),await Ze(300),o.style.transform="none";let h=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(w=>w.classList.add("visible"));for(let w=0;w<h.length;w++)h[w].classList.add("popped"),await Ze(90);await Ze(200),o.classList.add("system-check")})();let a=!1,i,s,p,S,x=3;o.onmousedown=g=>{if(g.target.closest("button"))return;g.preventDefault(),i=g.clientX,s=g.clientY;let h=o.getBoundingClientRect();p=h.left,S=h.top,document.addEventListener("mousemove",b),document.addEventListener("mouseup",C)};function b(g){let h=g.clientX-i,A=g.clientY-s;!a&&Math.sqrt(h*h+A*A)>x&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${p+h}px`,o.style.top=`${S+A}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function C(g){if(document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",C),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let h=window.innerWidth,A=window.innerHeight,w=o.getBoundingClientRect(),k=w.left+w.width/2,z;k<h/2?(z=24,o.classList.remove("side-right"),o.classList.add("side-left")):(z=h-w.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let $=w.top;$<24&&($=24),$>A-w.height-24&&($=A-w.height-24),o.style.left=`${z}px`,o.style.top=`${$}px`,setTimeout(()=>{},600)}else{if(g.target.closest(".cw-grip")){o.classList.toggle("collapsed");return}let h=g.target.closest("button");h&&(h.style.transform="scale(0.9)",setTimeout(()=>h.style.transform="",150))}}}function Je(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let l=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let i=Date.now()-l,s=Math.max(0,1500-i);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},s)}}var Gt=e=>new Promise(t=>setTimeout(t,e));function et(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function ht(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{K("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Pt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Ft(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function zt(){console.log("Iniciando processo de Nova Nota...");let e=Ft(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(i=>i.innerText.trim()==="description");if(o){let i=o.closest("material-fab")||o.closest("material-button");i?(i.style&&(i.style.display="block",i.style.visibility="visible"),et(i)):et(o)}else{let i=document.querySelector("material-fab-speed-dial");if(i){let s=i.querySelector(".trigger");s?(s.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),et(s)):i.click(),await Gt(800);let S=Array.from(document.querySelectorAll("i.material-icons-extended")).find(x=>x.innerText.trim()==="description");S&&et(S)}}let l=null,a=0;for(;!l&&a<20;){await Gt(300);let i=Ft();if(i.length>t)l=i.find(s=>!e.includes(s)),l||(l=i[i.length-1]);else if(a>10){let s=i.filter(p=>p.offsetParent!==null);s.length>0&&(l=s[s.length-1])}a++}return l}var F={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},ge="cubic-bezier(0.25, 0.8, 0.25, 1)",eo={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${F.border}`,backgroundColor:F.bgInput,fontSize:"14px",color:F.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${ge}, box-shadow 0.2s ${ge}, background-color 0.2s`,outline:"none"},So={...eo,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},Co={fontSize:"13px",fontWeight:"700",color:F.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},Ao={display:"block",fontSize:"13px",fontWeight:"600",color:F.text,marginBottom:"8px",marginTop:"16px"},wo={fontSize:"12px",color:F.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},Eo={fontSize:"12px",color:F.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},To={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:F.text,cursor:"pointer",padding:"12px 14px",backgroundColor:F.surface,border:`1px solid ${F.border}`,borderRadius:"12px",transition:`all 0.2s ${ge}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},xt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:F.primary},ko={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:F.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${ge}, box-shadow 0.2s ${ge}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},Oo={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${F.primary}`,color:F.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${ge}`},Io={background:"transparent",border:`1px solid ${F.border}`,borderRadius:"20px",color:F.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${ge}`,fontFamily:"'Google Sans', 'Roboto'"};var No={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:F.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},_o={fontSize:"13px",fontWeight:"700",color:F.primary,minWidth:"20px",textAlign:"center"},Lo={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${F.border}`,backgroundColor:F.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${ge}, box-shadow 0.2s ${ge}`},Ro={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${F.bgInput}`},Mo={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${F.border}`,backgroundColor:F.surface,color:F.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${ge}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},Do={backgroundColor:F.primaryBg,color:F.primary,borderColor:F.primary,fontWeight:"600"},Go={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:F.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Fo={borderTop:`1px solid ${F.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Po={maxHeight:"240px",overflowY:"auto",border:`1px solid ${F.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:F.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},zo={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${F.bgInput}`,cursor:"pointer",fontSize:"13px",color:F.text,transition:"background 0.1s",userSelect:"none"};var to={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},oo={fontSize:"12px",color:"#e37400",marginTop:"4px"},no={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},ao={display:"flex",gap:"15px",marginBottom:"10px"};function jt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,to);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,Pe,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,ao);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,xt);let l=document.createElement("label");l.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(l);let i=document.createElement("input");i.type="radio",i.name="ts_usage_mod",i.value="N\xE3o",i.checked=!0,Object.assign(i.style,xt);let s=document.createElement("label");s.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(i),p.appendChild(s),n.appendChild(a),n.appendChild(p);let S=document.createElement("div");S.style.display="block";let x=document.createElement("label");x.textContent="Qual foi o Motivo?",Object.assign(x.style,Pe,{fontSize:"12px"});let b=document.createElement("input");b.type="text",Object.assign(b.style,no);let C=document.createElement("div");C.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(C.style,oo),S.appendChild(x),S.appendChild(b),S.appendChild(C),e.appendChild(t),e.appendChild(n),e.appendChild(S),o.onchange=()=>{S.style.display="none"},i.onchange=()=>{S.style.display="block"};function g(w,k){if(e.style.display="none",!w||w.includes("Education")||!k||k.length===0)return;let z=k.some(c=>c.includes("enhanced")||c==="ec_google_ads"),$=k.some(c=>(c.includes("conversion")||c.includes("ads"))&&!c.includes("enhanced")),m=k.some(c=>c.includes("ga4")||c.includes("analytics")||c.includes("ua")),d=k.some(c=>c.includes("merchant")||c.includes("gmc")||c.includes("shopping"));(z||$&&!m&&!d)&&(e.style.display="block")}function h(){if(e.style.display==="none")return"";let w=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return i.checked&&b.value.trim()!==""&&(w+=`<br><b>Motivo:</b> ${b.value}`),w+="<br>",w}function A(){e.style.display="none",i.checked=!0,o.checked=!1,S.style.display="block",b.value=""}return{element:e,updateVisibility:g,getOutput:h,reset:A}}var R={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},_e={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function Bt(e){let t={};function n(m){let d=m.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?R.brands.ads:d.includes("ga4")||d.includes("analytics")?R.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?R.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?R.brands.gmc:R.brands.default}let o=Object.entries(Se).filter(([m,d])=>d.popular),l={};Object.entries(Se).forEach(([m,d])=>{if(d.popular)return;let r=n(d.name);l[r.label]||(l[r.label]={brand:r,tasks:[]}),l[r.label].tasks.push({key:m,...d})});let a="cw-zen-tasks";if(!document.getElementById(a)){let m=document.createElement("style");m.id=a,m.innerHTML=`
          ...
          /* --- HERO SECTION (Refined) --- */
            ...
            .cw-helper-text { font-size: 12px; color: ${R.textSub}; margin-top: 12px; line-height: 1.4; }
            ...
            /* TEXTO */
            .cw-hero-label { 
                font-size: 12px; font-weight: 500; color: ${R.textMain}; line-height: 1.2; 
                text-align: left;
            }
            ...
            .cw-step-btn {
                ...
                color: ${R.textMain}; display: flex; align-items: center; justify-content: center;
            ...
            .cw-search-input {
                ...
                border: 1px solid ${R.border}; border-radius: 10px; background: ${R.white};
                font-size: 13px; outline: none;
                background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%239CA3AF" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>');
                background-repeat: no-repeat; background-position: 10px center;
                transition: border-color 0.2s, box-shadow 0.2s; margin-bottom: 16px;
            }
            .cw-search-input:focus { border-color: ${R.blue}; box-shadow: 0 0 0 3px ${R.blueLight}; }

            /* ACCORDION */
            .cw-acc-group { margin-bottom: 8px; border: 1px solid ${R.border}; border-radius: 10px; background: ${R.white}; overflow: hidden; }
            .cw-acc-header {
                padding: 12px 16px; display: flex; align-items: center; justify-content: space-between;
                cursor: pointer; background: ${R.white}; transition: background 0.1s;
            }
            .cw-acc-header:hover { background: #F9FAFB; }
            .cw-acc-title { font-size: 13px; font-weight: 600; color: ${R.textMain}; display: flex; align-items: center; gap: 8px; }
            .cw-acc-dot { width: 8px; height: 8px; border-radius: 50%; }
            .cw-acc-icon { width: 12px; height: 12px; transition: transform 0.3s; color: ${R.textSub}; font-size: 10px; }
            .cw-acc-group.open .cw-acc-icon { transform: rotate(180deg); }
            .cw-acc-body { display: none; border-top: 1px solid ${R.border}; background: #FAFAFA; }
            ...
            .cw-task-item.selected { background: ${R.blueLight}; }
            ...
            .cw-task-label { font-size: 13px; color: ${R.textSub}; transition: color 0.1s; font-weight: 400; line-height: 1.3; }
            .cw-task-item.selected .cw-task-label { color: ${R.blue}; font-weight: 500; }
            ...
            .cw-step-val { font-size: 13px; font-weight: 600; min-width: 14px; text-align: center; color: ${R.blue}; }
            ...
            .cw-status-bar {
                ...
                box-shadow: ${R.shadowFloat}; z-index: 10;
            }
            .cw-status-bar.visible { transform: translateY(0); }
            .cw-status-text { font-size: 13px; font-weight: 500; color: ${R.textMain}; }
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
            ...
            .cw-card-title-input {
                font-family: ${R.font}; font-size: 15px; font-weight: 600; color: ${R.textMain};
                border: 1px solid transparent; 
                border-radius: 6px;
                background: transparent; 
            ...
            .cw-card-title-input:focus {
                background: #FFFFFF;
                border-color: ${R.brands.ads.color};
                box-shadow: 0 0 0 2px rgba(26, 115, 232, 0.1);
            }

            /* Dica Visual "\u270E Renomear" */
            .cw-edit-hint {
                font-size: 12px; color: ${R.textSub}; opacity: 0; 
            ...
            .cw-info-banner {
                ...
                border-radius: 8px;
                font-size: 11px; color: ${R.textSub};
                display: flex; align-items: center; gap: 8px;
            }
            .cw-info-link { color: ${R.brands.ads.color}; text-decoration: none; font-weight: 600; }
            ...
            .cw-input-label {
                display: block; font-size: 10px; font-weight: 700; color: ${R.textSub};
    ...
    `;let S=i.querySelector(".cw-hero-grid"),x=i.querySelector(".cw-acc-container"),b=i.querySelector(".cw-results-container"),C=i.querySelector(".cw-search-input"),g=i.querySelector(".cw-status-bar"),h=i.querySelector(".cw-status-text"),A=i.querySelector(".cw-footer-icons");o.forEach(([m,d])=>{let r=n(d.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${m}`,c.style.setProperty("--hero-color",r.color),c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let y=t[m]?t[m].count:0;k(m,y>0?-y:1,d)},c.querySelector(".minus").onclick=()=>k(m,-1,d),c.querySelector(".plus").onclick=()=>k(m,1,d),c.dataset.color=r.color,S.appendChild(c)});function w(m,d){let r=n(d.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=m,c.innerHTML=`
...
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):B.tagName==="TEXTAREA"&&(q=q.replace(/\n/g,"<br>"));let Q=q.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(Q===""||Q==="\u2022"||Q.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${N}\\}(?:<br>\\s*)?`,"gi");ee.test(f)?f=f.replace(ee,""):f=f.replace(T,"")}else f=f.replace(T,q.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(f+=i.getOutput()),f}Ge.onclick=()=>{let u=St();u?(ht(u),K(G("copiado_sucesso"))):K(G("selecione_substatus"),{error:!0})},Fe.onclick=async()=>{let u=O.value,L=St();if(!L){K(G("selecione_substatus"),{error:!0});return}ht(L),dt();let f=Je(),P=await zt();if(P)try{if(P.focus(),P.innerHTML.trim()==="<p><br></p>"||P.innerHTML.trim()==="<br>"||P.innerText.trim()===""){let ae=document.createRange();ae.selectNodeContents(P);let H=window.getSelection();H.removeAllRanges(),H.addRange(ae),document.execCommand("delete",!1,null)}else if(!P.innerHTML.endsWith("<br><br>")){let ae=document.createRange();ae.selectNodeContents(P),ae.collapse(!1);let H=window.getSelection();H.removeAllRanges(),H.addRange(ae),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,L),Pt(P),setTimeout(()=>{K(G("inserido_copiado"))},600);let te=typeof Ie<"u"&&Ie?Ie.checked:!0;if(u&&Ke[u]&&te){let ae=Ke[u];await Lt(ae),await new Promise(H=>setTimeout(H,500))}f(),ct(1.5),E.value="",O.innerHTML=`<option value="">${G("select_substatus")}</option>`,O.disabled=!0}catch(X){console.error(X),K("Erro ao inserir.",{error:!0}),f()}};function ct(u=1.5){u<=1.5&&(Te.style.display="none",me.innerHTML=""),u<=2&&(be.style.display="none",s.reset(),le.style.display="none"),u<=3&&(fe.style.display="none",ye.innerHTML="",i.reset(),Me.style.display="none",ke.style.display="none")}function dt(){l=!l,we(l,p,"cw-btn-notes")}return it("bau"),st("pt"),dt}var Le={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
      ...
      `;let V=y.querySelector("#csa-back-btn");V.onmouseover=()=>V.style.backgroundColor="#f1f3f4",V.onmouseout=()=>V.style.backgroundColor="transparent",V.onclick=I;let D=y.querySelector("#csa-insert-btn");D.onmouseover=()=>D.style.backgroundColor="#174ea6",D.onmouseout=()=>D.style.backgroundColor="#1a73e8",D.onclick=async()=>{D.style.transform="scale(0.96)",A();let oe=Je();try{await ft(_),oe()}catch(ne){console.error(ne),oe()}setTimeout(()=>{D.style.transform="scale(1)",I()},300)}}function I(){o="list",z.style.transform="translateX(0)"}function U(){r.innerHTML="",Object.keys(Le).forEach(_=>{let Z=Le[_],j=document.createElement("button");j.textContent=Z.title,Object.assign(j.style,S),t===_&&n===""&&Object.assign(j.style,x),j.onclick=()=>{t=_,n="",d.value="",U(),O()},r.appendChild(j)})}function O(){c.innerHTML="";let _=[];if(n.trim()!==""?Object.values(Le).forEach(V=>{let D=V.emails.filter(oe=>oe.name.toLowerCase().includes(n.toLowerCase()));_=[..._,...D]}):Le[t]&&(_=Le[t].emails),_.length===0){c.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let Z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',j='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';_.forEach(V=>{let D=document.createElement("div");Object.assign(D.style,b);let oe=V.subject.length>50?V.subject.substring(0,50)+"...":V.subject;D.innerHTML=`

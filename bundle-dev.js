...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ct={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ut={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Wt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var fe={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var St=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Ht=-1;function Je(){let e=Math.floor(Math.random()*St.length);return e===Ht&&(e=(e+1)%St.length),Ht=e,St[e]}var Ie=e=>new Promise(t=>setTimeout(t,e));async function Eo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let o=e.querySelector(".cursor");await Ie(200);for(let n=0;n<t.length;n++){let s=t.charAt(n),i=document.createElement("span");i.textContent=s,o&&o.parentNode===e?o.before(i):e.appendChild(i);let a=Math.floor(Math.random()*60)+30;n===0&&(a=150),n>t.length-3&&(a=30),await Ie(a)}await Ie(600),o&&(o.style.display="none")}async function Et(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await Ie(200);let t=await zt(),o=Bt(t),n=e.querySelector("#w-icon"),s=e.querySelector("#p1"),i=e.querySelector("#p2"),a=e.querySelector("#p3"),l=e.querySelector("#p-sextou");n&&(n.innerHTML=o.icon),s&&(s.textContent=o.prefix),a&&(a.textContent=o.suffix),await Ie(300);let m=n?n.querySelector("svg"):null;if(m&&(m.style.opacity="1",m.style.transform="scale(1)"),await Ie(400),s&&(s.style.opacity="1"),Z.playStartup(),i&&await Eo(i,o.name),a&&(a.style.opacity="1",a.style.transform="translateY(0)"),o.isFriday&&l){await Ie(400),l.style.display="block",l.offsetWidth;let p=l.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await Ie(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await Ie(900),e.parentNode&&e.parentNode.removeChild(e)}}var Ye={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Xe(e,t){t.onmousedown=o;function o(n){n.stopPropagation(),n.preventDefault();let s=e.style.transition;e.style.transition="none";let i=n.clientX,a=n.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),m=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),p=i,x=a,u=!1;function g(w){p=w.clientX,x=w.clientY,u||(window.requestAnimationFrame(()=>{S(),u=!1}),u=!0)}function S(){let w=l+(p-i),T=m+(x-a);w>360&&(e.style.width=w+"px"),T>300&&(e.style.height=T+"px")}function f(){document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",f),setTimeout(()=>{e.style.transition=s},50)}document.addEventListener("mousemove",g),document.addEventListener("mouseup",f)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function Yt(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,o=>t[o]?t[o]:"")}var et=e=>new Promise(t=>setTimeout(t,e));function it(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}var Xt="cw-automation-styles";if(!document.getElementById(Xt)){let e=document.createElement("style");e.id=Xt,e.innerHTML=`
...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var me=e=>new Promise(t=>setTimeout(t,e));function he(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function st(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let s=e.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let a=i.querySelector(".cw-close-btn");a.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&a.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await me(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await me(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let n=o.offsetParent!==null,s=o.closest("case-message-view")!==null,i=o.closest(".editor")!==null||o.closest("write-card")!==null;return n&&!s&&i});return t&&he("Editor visualmente detectado.","success"),t}async function Zt(){he("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");if(o&&o.offsetParent!==null){he("Bot\xE3o de email direto encontrado.");let u=o.closest("material-button")||o.closest("material-fab")||o;Ce(u),e=!0}else{he("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let u=document.querySelector("material-fab-speed-dial");if(u){let g=u.querySelector(".trigger");if(g){Ce(g),await me(800);let f=Array.from(document.querySelectorAll("i.material-icons-extended")).find(w=>w.innerText.trim()==="email");f&&(Ce(f),e=!0)}}}if(!e)return ae("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;he("\u{1F680} FASE 2: Verificando rascunhos...");let n=null,s=0,i=20;for(;s<i;){await me(250);let u=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(n=Array.from(u).find(g=>g.offsetParent!==null),n){he("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(n){he("\u{1F5D1}\uFE0F Descartando..."),Ce(n),n.click();let u=null,g=0;for(;g<15;){await me(300);let S=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(u=Array.from(S).find(f=>f.offsetParent!==null),u)break;g++}u&&(Ce(u),ae("Limpando rascunho antigo...",{duration:2e3}),await me(2500))}he("\u{1F680} FASE 3: Buscando editor final...");let a=0,l=null;for(;a<20&&(l=kt(),!l);)await me(250),a++;if(!l)return ae("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let m=l.closest('[id="email-body-content-top"]'),x=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(m){if(x){let g=x.closest('[aria-hidden="true"]');g&&g.removeAttribute("aria-hidden"),x.focus(),Ce(x)}await me(300),m.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let u=m.querySelector("#cases-body-field");if(u){let g=document.createRange();g.selectNodeContents(u),g.collapse(!0);let S=window.getSelection();S.removeAllRanges(),S.addRange(g)}return!0}return!1}async function lt(e){if(!e||!await Zt())return;let o=await At();he("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await me(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await rt(i,o.clientEmail),st(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await rt(i,o.internalEmail),st(i,`
            ...
            `))}await me(500);let s=document.querySelector('material-button[debug-id="canned_response_button"]');if(s){Ce(s),await me(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){Ce(i),document.execCommand("insertText",!1,e),i.dispatchEvent(new Event("input",{bubbles:!0})),he("\u23F3 Buscando resultado da Canned Response...","info");let a=null,l=0,m=15e3,p=500;for(;l<m&&(a=document.querySelector("material-select-dropdown-item"),!a);)await me(p),l+=p;if(a){Ce(a),await me(1500);let x=kt();if(x&&o.advertiserName){let u=x.innerHTML;u.includes("{%ADVERTISER_NAME%}")&&(x.innerHTML=u.replace(/{%ADVERTISER_NAME%}/g,o.advertiserName))}ae("Canned Response aplicada!")}else he(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),ae(`Timeout: Template '${e}' n\xE3o carregou.`,{error:!0})}}else ae("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function Jt(e){if(he(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Zt())return;let o=await At(),n=vt();await me(600),he("\u{1F4E7} Processando destinat\xE1rios...");let s=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(s&&(s.click(),await me(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await rt(l,o.clientEmail),st(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await rt(l,o.internalEmail),st(l,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
...
@keyframes googleBounce {
    ...
    `;let s=document.createElement("div");if(s.className="cw-focus-backdrop",document.body.appendChild(s),document.body.appendChild(n),n.querySelector(".notes").onclick=S=>{S.stopPropagation(),e.toggleNotes()},n.querySelector(".email").onclick=S=>{S.stopPropagation(),e.toggleEmail()},n.querySelector(".script").onclick=S=>{S.stopPropagation(),e.toggleScript()},n.querySelector(".links").onclick=S=>{S.stopPropagation(),e.toggleLinks()},n.querySelector(".broadcast").onclick=S=>{S.stopPropagation();let f=S.currentTarget.querySelector(".cw-badge");f&&(f.style.transform="scale(0)",setTimeout(()=>f.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let S=document.createElement("div");S.className="cw-badge",n.querySelector(".broadcast").appendChild(S)}(async function(){await ct(2800),n.classList.add("docked"),await ct(300);let f=n.querySelectorAll(".cw-btn");n.querySelectorAll(".cw-sep").forEach(T=>T.classList.add("visible"));for(let T=0;T<f.length;T++)f[T].classList.add("popped"),await ct(90);await ct(200),n.classList.add("system-check")})();let i=!1,a,l,m,p,x=3;n.onmousedown=S=>{if(S.target.closest("button"))return;S.preventDefault(),a=S.clientX,l=S.clientY;let f=n.getBoundingClientRect();m=f.left,p=f.top,document.addEventListener("mousemove",u),document.addEventListener("mouseup",g)};function u(S){let f=S.clientX-a,w=S.clientY-l;!i&&Math.sqrt(f*f+w*w)>x&&(i=!0,n.style.transition="none"),i&&(n.style.left=`${m+f}px`,n.style.top=`${p+w}px`,n.style.right="auto",n.style.bottom="auto",n.style.transform="none")}function g(S){if(document.removeEventListener("mousemove",u),document.removeEventListener("mouseup",g),i){i=!1,n.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let f=window.innerWidth,w=window.innerHeight,T=n.getBoundingClientRect(),q=T.left+T.width/2,M;q<f/2?(M=24,n.classList.remove("side-right"),n.classList.add("side-left")):(M=f-T.width-24,n.classList.remove("side-left"),n.classList.add("side-right"));let V=T.top;V<24&&(V=24),V>w-T.height-24&&(V=w-T.height-24),n.style.left=`${M}px`,n.style.top=`${V}px`}else{let f=S.target.closest("button");f&&(f.style.transform="scale(0.9)",setTimeout(()=>f.style.transform="",150))}}}function dt(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(v)}let l=document.createElement("div");l.className="cw-zen-container";let m=document.createElement("div");Object.assign(m.style,{display:"none"});let p=document.createElement("div");p.className="cw-screens-container",m.appendChild(p),l.innerHTML=`
    ...
    `;let x=l.querySelector(".cw-hero-grid"),u=l.querySelector(".cw-acc-container"),g=l.querySelector(".cw-results-container"),S=l.querySelector(".cw-search-input"),f=l.querySelector(".cw-status-bar"),w=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");s.forEach(([v,b])=>{let r=n(b.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${v}`,c.style.setProperty("--hero-color",r.color),c.innerHTML=`
        ...
        `,c.onclick=y=>{if(y.target.closest(".cw-step-btn"))return;let d=t[v]?t[v].count:0;M(v,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>M(v,-1,b),c.querySelector(".plus").onclick=()=>M(v,1,b),c.dataset.color=r.color,x.appendChild(c)});function q(v,b){let r=n(b.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=v,c.innerHTML=`
        ...
        `,c.onclick=y=>{if(y.target.closest(".cw-step-btn"))return;let d=t[v]?t[v].count:0;M(v,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>M(v,-1,b),c.querySelector(".plus").onclick=()=>M(v,1,b),c}Object.entries(i).forEach(([v,b])=>{let r=document.createElement("div");r.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${b.brand.color}"></div>
                ${v}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{u.querySelectorAll(".cw-acc-group.open").forEach(d=>{d!==r&&d.classList.remove("open")}),r.classList.toggle("open")};let y=document.createElement("div");y.className="cw-acc-body",b.tasks.forEach(d=>{let h=q(d.key,d);y.appendChild(h)}),r.appendChild(c),r.appendChild(y),u.appendChild(r)});function M(v,b,r){t[v]||(t[v]={count:0,data:r,brand:n(r.name)}),t[v].count+=b,t[v].count<=0&&delete t[v],V(),X(),e&&e()}function V(){s.forEach(([y])=>{let d=x.querySelector(`#hero-${y}`);if(!d)return;let h=t[y];h?(d.classList.add("active"),d.querySelector(".cw-step-val").textContent=h.count,d.querySelector(".cw-step-val").style.color=d.dataset.color):d.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(y=>{let d=y.dataset.id,h=t[d];h?(y.classList.add("selected"),y.querySelector(".cw-step-val").textContent=h.count):y.classList.remove("selected")});let b=Object.keys(t),r=0,c=[];if(b.forEach(y=>{let d=t[y];r+=d.count;for(let h=0;h<d.count;h++)c.length<6&&c.push(d.brand)}),r>0){f.classList.add("visible");let y=r>1?"A\xE7\xF5es":"A\xE7\xE3o",d=r>1?"definidas":"definida";w.textContent=`${r} ${y} ${d}`,T.innerHTML="",c.forEach(h=>{let O=document.createElement("div");O.className="cw-mini-icon",O.innerHTML=Ve[h.icon]||Ve.default;let A=O.querySelector("svg");A&&(A.style.width="14px",A.style.height="14px"),T.appendChild(O)})}else f.classList.remove("visible")}S.addEventListener("input",v=>{let b=v.target.value.toLowerCase();if(b.length>0){u.style.display="none",g.style.display="block",g.innerHTML="";let r=!1;Object.entries(Re).forEach(([c,y])=>{if(y.name.toLowerCase().includes(b)){r=!0;let d=q(c,y);t[c]&&(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=t[c].count),g.appendChild(d)}}),r||(g.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else u.style.display="block",g.style.display="none"});function X(){p.innerHTML="";let v=Object.keys(t),b=!1,r=document.getElementById("sub-status"),c="implementation";if(r&&r.value.toLowerCase().includes("education")&&(c="education"),v.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(v.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let y=document.createElement("div");y.className="cw-info-banner",y.innerHTML=`
        ...
        `,p.appendChild(y),v.forEach(d=>{let h=t[d].data,O=t[d].count,A=t[d].brand,k=h.screenshots?h.screenshots[c]||[]:["Link da Evid\xEAncia"];if(k.length>0){b=!0;for(let se=1;se<=O;se++){let z=document.createElement("div");z.className="cw-screen-card",z.style.setProperty("--brand-color",A.color),z.style.setProperty("--brand-bg",A.bg),z.style.setProperty("--brand-shadow",A.color+"40");let L=document.createElement("div");L.className="cw-card-header";let ne=document.createElement("div");ne.className="cw-card-icon",ne.innerHTML=Ve[A.icon]||Ve.default;let J=document.createElement("div");J.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let _=document.createElement("input");_.className="cw-card-title-input",_.id=`name-${d}-${se}`,_.value=`${h.name}${O>1?" #"+se:""}`,_.title="Clique para renomear esta task";let K=document.createElement("span");K.className="cw-edit-hint",K.innerHTML="\u270E Renomear",J.appendChild(_),J.appendChild(K),L.appendChild(ne),L.appendChild(J),z.appendChild(L),k.forEach((re,R)=>{let $=document.createElement("div");$.className="cw-input-group";let ee=document.createElement("label");ee.className="cw-input-label",ee.textContent=re.replace(/📷|:|•/g,"").trim();let N=document.createElement("input");N.className="cw-input-field",N.id=`screen-${d}-${se}-${R}`,N.placeholder="Cole o link aqui...",N.setAttribute("autocomplete","off"),N.addEventListener("input",()=>{N.value.trim().length>5?N.classList.add("filled"):N.classList.remove("filled")});let Y=document.createElement("div");Y.className="cw-input-check",Y.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',$.appendChild(ee),$.appendChild(N),$.appendChild(Y),z.appendChild($)}),p.appendChild(z)}}}),m.style.display=b?"block":"none"}return{selectionElement:l,screenshotsElement:m,updateSubStatus:()=>X(),getCheckedElements:()=>Object.keys(t).map(v=>({value:v,closest:()=>({querySelector:()=>({textContent:t[v].count})})})),toggleTask:(v,b=!0)=>{let r=t[v];b&&!r?M(v,1,Re[v]):!b&&r&&M(v,-r.count,Re[v])},setMode:v=>{o=v,X()},reset:()=>{for(let v in t)delete t[v];S.value="",u.style.display="block",g.style.display="none",V(),X()}}}function go(){let e="v3.6.0",t="bau",o="pt",n=!1,s=!1,i={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},a=uo(),l=mo(()=>{let D=l.getCheckedElements().map(E=>E.value);A&&A.value&&a.updateVisibility(A.value,D)}),m=document.createElement("div");m.id="autofill-popup",m.classList.add("cw-module-window"),Object.assign(m.style,we,{right:"100px",width:"400px",transition:"width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)"});let x=Ee(m,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:m,googleLine:null},()=>yt());m.appendChild(x);let u=document.createElement("div");Object.assign(u.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),m.appendChild(u);let g=document.createElement("div");g.textContent="created by lucaste@",Object.assign(g.style,Wt),m.appendChild(g);let S=document.createElement("div");S.id="step-lang-type";let f=document.createElement("label");Object.assign(f.style,i.label),S.appendChild(f);let w=document.createElement("div");Object.assign(w.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let T=document.createElement("div");T.textContent="Portugu\xEAs",T.classList.add("no-drag"),Object.assign(T.style,fe);let q=document.createElement("div");q.textContent="Espa\xF1ol",q.classList.add("no-drag"),Object.assign(q.style,fe),T.onclick=()=>bt("pt"),q.onclick=()=>bt("es"),w.appendChild(T),w.appendChild(q),S.appendChild(w),u.appendChild(S);let M=document.createElement("div");M.id="step-0-case-type";let V=document.createElement("label");Object.assign(V.style,i.label),M.appendChild(V);let X=document.createElement("div");Object.assign(X.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let v=document.createElement("div");v.textContent="BAU",v.classList.add("no-drag"),Object.assign(v.style,fe);let b=document.createElement("div");b.textContent="LM",b.classList.add("no-drag"),Object.assign(b.style,fe),v.onclick=()=>gt("bau"),b.onclick=()=>gt("lm"),X.appendChild(v),X.appendChild(b),M.appendChild(X),u.appendChild(M);let r=document.createElement("div");r.id="step-1-selection";let c=document.createElement("label");c.className="cw-input-label",c.textContent="Status Principal";let y=document.createElement("select");y.id="main-status",y.className="cw-select",y.innerHTML=`
  ...
  `;let d=document.createElement("div");d.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let h=document.createElement("label");h.className="cw-input-label",h.textContent="Sub-status",h.style.marginBottom="0";let O=document.createElement("a");O.href="https://seu-link-do-guia-aqui.com",O.target="_blank",O.className="cw-info-link",O.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(O.style,i.helpLink),d.appendChild(h),d.appendChild(O);let A=document.createElement("select");A.id="sub-status",A.className="cw-select",A.disabled=!0,A.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',r.appendChild(c),r.appendChild(y),r.appendChild(d),r.appendChild(A),u.appendChild(r);let k=document.createElement("div");k.id="step-1-1-portugal",Object.assign(k.style,i.stepBlock,{display:"none"});let se=document.createElement("label");Object.assign(se.style,i.label),k.appendChild(se);let z=document.createElement("div");Object.assign(z.style,i.radioContainer);let L=document.createElement("div");Object.assign(L.style,{display:"flex",alignItems:"center"});let ne=document.createElement("input");ne.type="radio",ne.name="portugal-group",ne.value="sim",Object.assign(ne.style,i.checkboxInput);let J=document.createElement("label");J.htmlFor="portugal-sim",Object.assign(J.style,{cursor:"pointer"}),L.appendChild(ne),L.appendChild(J);let _=document.createElement("div");Object.assign(_.style,{display:"flex",alignItems:"center"});let K=document.createElement("input");K.type="radio",K.name="portugal-group",K.value="nao",K.checked=!0,Object.assign(K.style,i.checkboxInput);let re=document.createElement("label");re.htmlFor="portugal-nao",Object.assign(re.style,{cursor:"pointer"}),_.appendChild(K),_.appendChild(re),z.appendChild(L),z.appendChild(_),k.appendChild(z),u.appendChild(k);function R(C){n=C,C?$.style.display="block":$.style.display="none"}ne.onchange=()=>R(!0),K.onchange=()=>R(!1);let $=document.createElement("div");$.id="step-1-2-consent",Object.assign($.style,i.stepBlock,{display:"none"});let ee=document.createElement("label");Object.assign(ee.style,i.label),$.appendChild(ee);let N=document.createElement("div");Object.assign(N.style,i.radioContainer);let Y=document.createElement("div");Object.assign(Y.style,{display:"flex",alignItems:"center"});let xe=document.createElement("input");xe.type="radio",xe.name="consent-group",xe.value="Sim",xe.checked=!0,Object.assign(xe.style,i.checkboxInput);let ce=document.createElement("label");ce.htmlFor="consent-sim",Object.assign(ce.style,{cursor:"pointer"}),Y.appendChild(xe),Y.appendChild(ce);let te=document.createElement("div");Object.assign(te.style,{display:"flex",alignItems:"center"});let Oe=document.createElement("input");Oe.type="radio",Oe.name="consent-group",Oe.value="N\xE3o",Object.assign(Oe.style,i.checkboxInput);let Me=document.createElement("label");Me.htmlFor="consent-nao",Object.assign(Me.style,{cursor:"pointer"}),te.appendChild(Oe),te.appendChild(Me),N.appendChild(Y),N.appendChild(te),$.appendChild(N),u.appendChild($);let Le=document.createElement("div");Le.id="step-1-5-snippets",Object.assign(Le.style,i.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,i.h3),nt.textContent="Cen\xE1rios Comuns";let Ae=so(C=>{let D=document.querySelector("textarea");D&&(D.value=C,D.dispatchEvent(new Event("input")),D.style.transition="background-color 0.2s",D.style.backgroundColor="#e8f0fe",setTimeout(()=>D.style.backgroundColor="#fff",300))});Ae.id="snippet-container",Le.appendChild(nt),Le.appendChild(Ae),u.appendChild(Le);let ye=document.createElement("div");ye.id="step-3-form",Object.assign(ye.style,i.stepBlock,{display:"none"});let mt=document.createElement("h3");Object.assign(mt.style,i.h3),ye.appendChild(mt);let _e=document.createElement("div");_e.id="dynamic-form-fields-container",ye.appendChild(_e);let ge=document.createElement("button");ge.textContent="+ Gostaria de selecionar uma task?",Object.assign(ge.style,i.optionalBtn),ge.onmouseover=()=>ge.style.background="#e8f0fe",ge.onmouseout=()=>ge.style.background="white",ge.onclick=()=>{ge.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};let De=document.createElement("h3");Object.assign(De.style,i.h3,{marginTop:"20px"});let Rt=l.selectionElement;Object.assign(Rt.style,{marginBottom:"20px"}),ye.appendChild(ge),ye.appendChild(De),ye.appendChild(Rt),ye.appendChild(a.element),ye.appendChild(l.screenshotsElement),u.appendChild(ye);let Fe=document.createElement("div");Fe.id="step-4-email",Object.assign(Fe.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let ze=document.createElement("input");ze.type="checkbox",ze.checked=!0,Object.assign(ze.style,i.checkboxInput),Ge.appendChild(ze),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),Fe.appendChild(Ge),u.appendChild(Fe);let We=document.createElement("div");Object.assign(We.style,{display:"none",gap:"8px",padding:"0"}),u.appendChild(We);let Ke=document.createElement("button");Object.assign(Ke.style,i.buttonBase,{backgroundColor:"#5f6368"}),Ke.textContent="Copiar";let Qe=document.createElement("button");Object.assign(Qe.style,i.buttonBase,{backgroundColor:"#1a73e8"}),Qe.textContent="Preencher",We.appendChild(Ke),We.appendChild(Qe);let Ze=document.createElement("div");Object.assign(Ze.style,Ye),Ze.className="no-drag",Ze.title="Redimensionar",m.appendChild(Ze),Xe(m,Ze),document.body.appendChild(m);function gt(C){t=C;let D=Je();Object.assign(v.style,fe),Object.assign(b.style,fe),C==="bau"?(Object.assign(v.style,D),O.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(b.style,D),O.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),A.value&&A.dispatchEvent(new Event("change"))}function j(C){try{if(Ne&&Ne[o]&&Ne[o][C])return Ne[o][C];if(Ne&&Ne.pt&&Ne.pt[C])return Ne.pt[C]}catch{}return C}function vo(){f.textContent=j("idioma"),V.textContent=j("fluxo"),c.textContent=j("status_principal"),h.textContent=j("substatus"),nt.textContent=j("cenarios_comuns"),De.textContent=j("selecione_tasks"),mt.textContent=j("preencha_detalhes"),Ke.textContent=j("copiar"),Qe.textContent=j("preencher"),y.querySelector('option[value=""]')&&(y.querySelector('option[value=""]').textContent=j("select_status")),A.querySelector('option[value=""]')&&(A.querySelector('option[value=""]').textContent=j("select_substatus")),se.textContent=j("caso_portugal"),J.textContent=j("sim"),re.textContent=j("nao"),ee.textContent=j("consentiu_gravacao"),ce.textContent=j("sim"),Me.textContent=j("nao"),_e.querySelectorAll("label").forEach(C=>{let D=C.nextElementSibling.id.replace("field-",""),E=j(D.toLowerCase());E!==D.toLowerCase()?C.textContent=E:C.textContent=D.replace(/_/g," ").replace(/\b\w/g,P=>P.toUpperCase())+":"}),ge.textContent="+ "+(o==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function bt(C){o=C;let D=Je();Object.assign(T.style,fe),Object.assign(q.style,fe),C==="pt"?(Object.assign(T.style,D),k.style.display="block",R(n)):(Object.assign(q.style,D),k.style.display="none",$.style.display="none"),vo(),A.value&&A.dispatchEvent(new Event("change"))}function ft(C){(C.value.trim()===""||C.value.trim()==="\u2022")&&(C.value="\u2022 "),C.onkeydown=function(D){if(D.key==="Enter"){D.preventDefault();let E=this.selectionStart,P=this.selectionEnd,ie=this.value,pe=ie.lastIndexOf(`
`,E-1)+1,ve=ie.substring(pe,E),ue=ve.trim()==="\u2022"||ve.trim()===""?`
`:`
\u2022 `;this.value=ie.substring(0,E)+ue+ie.substring(P),this.selectionStart=this.selectionEnd=E+ue.length}else if(D.key==="Backspace"){let E=this.selectionStart;if(E===this.selectionEnd&&E>0){let P=this.value.substring(0,E);P.endsWith(`
\u2022 `)?(D.preventDefault(),this.value=P.substring(0,E-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=E-3):P==="\u2022 "&&(D.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function ht(){let C=typeof Ae<"u"?Ae:document.getElementById("snippet-container");if(!C)return;let D=C.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),E={},P=new Set;D.forEach(Q=>{let W=Q.id,F=Se[W];if(F)for(let I in F)I==="linkedTask"?P.add(F.linkedTask):I!=="type"&&(E[I]||(E[I]=[]),E[I].includes(F[I])||E[I].push(F[I]))});let ie=new Set;Object.values(Se).forEach(Q=>{Object.keys(Q).forEach(W=>{W!=="linkedTask"&&W!=="type"&&ie.add(W)})}),ie.forEach(Q=>{let W=document.getElementById(Q);if(W){let F=E[Q]||[],I="";ot.includes(Q.replace("field-",""))?(I=F.map(U=>U.startsWith("\u2022 ")?U:"\u2022 "+U).join(`
`),I===""?I="\u2022 ":I.endsWith(`
\u2022 `)||(I+=`
\u2022 `)):I=F.join(`

`),I.trim()!=="\u2022"&&I.trim()!==""?W.value=I:ot.includes(Q.replace("field-",""))?W.value="\u2022 ":W.value="",W.tagName==="TEXTAREA"&&typeof ft=="function"&&ft(W)}});let pe=new Set,ve=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(Q=>{let W=Se[Q.id];W&&W.linkedTask&&(Q.checked?pe.add(W.linkedTask):ve.add(W.linkedTask))}),ve.forEach(Q=>{pe.has(Q)||l.toggleTask(Q,!1)}),pe.forEach(Q=>{l.toggleTask(Q,!0)})}y.onchange=()=>{let C=y.value;if(xt(1.5),A.innerHTML=`<option value="">${j("select_substatus")}</option>`,!C){A.disabled=!0;return}for(let D in tt){let E=tt[D];if(E.status===C){let P=document.createElement("option");P.value=D,P.textContent=E.name,A.appendChild(P)}}A.disabled=!1},A.onchange=()=>{let C=A.value;if(xt(1.5),!C)return;l.updateSubStatus(C);let D=tt[C];Ae.innerHTML="";let E=(F,I,U)=>{let de=document.createElement("label");Object.assign(de.style,i.checkboxLabel),de.onmouseover=()=>de.style.backgroundColor="#e8eaed",de.onmouseout=()=>de.style.backgroundColor="#f8f9fa";let oe=document.createElement("input");return oe.type=I,oe.id=F.id,Object.assign(oe.style,i.checkboxInput),de.appendChild(oe),de.appendChild(document.createTextNode(` ${F.text}`)),U.appendChild(de),oe},P=[],ie="radio";if(C==="NI_Awaiting_Inputs")P=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))ie="checkbox",P=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(C.startsWith("AS_")){ie="checkbox";let F=document.createElement("label");F.textContent=j("cenarios_comuns"),Object.assign(F.style,i.label),Ae.appendChild(F),P=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")?P=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:C.startsWith("DC_")&&(ie="radio",P=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let pe=P.filter(F=>{let I=Se[F.id];return!I.type||I.type==="all"||I.type===t});pe.forEach((F,I)=>{let U=E(F,ie,Ae);ie==="radio"&&(U.name="scenario-radio-group",I===0&&(U.checked=!0))}),pe.length>0&&(Le.style.display="block"),D.requiresTasks?(ge.style.display="none",De.style.display="block",l.selectionElement.style.display="block"):(ge.style.display="block",De.style.display="none",l.selectionElement.style.display="none"),_e.innerHTML="";let ve=D.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(ve)].forEach(F=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(F))return;let I=F.slice(1,-1),U=document.createElement("label"),de=j(I.toLowerCase());if(U.textContent=de!==I.toLowerCase()?de:I.replace(/_/g," ").replace(/\b\w/g,B=>B.toUpperCase())+":",Object.assign(U.style,i.label),I==="SPEAKEASY_ID"){let B=document.createElement("button");B.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',B.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,B.title="Localizar Speakeasy ID no hist\xF3rico",B.onmouseover=()=>{B.style.backgroundColor="#c2e7ff",B.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},B.onmouseout=()=>{B.style.backgroundColor="#d3e3fd",B.style.boxShadow="none"},B.onmousedown=()=>{B.style.backgroundColor="#a8c7fa",B.style.transform="scale(0.96)"},B.onmouseup=()=>B.style.transform="scale(1)",B.onclick=be=>{be.preventDefault(),Qt(`field-${I}`)},U.appendChild(B)}let oe;ot.includes(I)?(oe=document.createElement("textarea"),Object.assign(oe.style,i.textarea),oe.classList.add("bullet-textarea"),ft(oe)):Tt.includes(I)?(oe=document.createElement("textarea"),Object.assign(oe.style,i.textarea)):(oe=document.createElement("input"),oe.type="text",Object.assign(oe.style,i.input),I==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign(U.style,{display:"none"}),Object.assign(oe.style,{display:"none"}))),I==="ON_CALL"&&t==="lm"&&(Object.assign(U.style,{display:"none"}),Object.assign(oe.style,{display:"none"}),oe.value="N/A"),oe.id=`field-${I}`,_e.appendChild(U),_e.appendChild(oe)});let Q=Ae.querySelectorAll('input[type="checkbox"], input[type="radio"]');Q.length>0&&(Q.forEach(F=>{F.removeEventListener("change",ht),F.addEventListener("change",ht)}),ht()),ye.style.display="block",Pe[C]?Fe.style.display="block":Fe.style.display="none",We.style.display="flex";let W=l.getCheckedElements().map(F=>F.value);a.updateVisibility(C,W)},ge.onclick=()=>{ge.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};function Mt(){let C=A.value;if(!C)return null;let E=tt[C].template.replace(/\n/g,"<br>"),P='style="margin-bottom: 12px; padding-left: 30px;"',ie=[],pe="",ve=l.getCheckedElements();ve.length>0&&ve.forEach(W=>{let F=W.value,I=Re[F],U=W.closest().querySelector(".stepper-count"),de=U?parseInt(U.textContent):1;de>1?ie.push(`${I.name} (x${de})`):ie.push(I.name)});let ue=l.screenshotsElement;if(ue){let W=Array.from(ue.querySelectorAll('input[id^="name-"]'));W.length>0&&W.forEach(F=>{let I=F.value,U=F.closest(".cw-screen-card");if(U){let de=U.querySelectorAll('input[id^="screen-"]'),oe=!1,B="";de.forEach(be=>{let Lt=be.closest(".cw-input-group"),Dt=Lt?Lt.querySelector(".cw-input-label"):null,Ao=Dt?Dt.textContent:"Evid\xEAncia",Ft=be.value.trim(),wo=Ft?` ${Ft}`:"";B+=`<li>${Ao} -${wo}</li>`,oe=!0}),oe&&(pe+=`<b>${I}</b>`,pe+=`<ul ${P}>${B}</ul>`)}})}if(E.includes("{TAGS_IMPLEMENTED}")?E=E.replace(/{TAGS_IMPLEMENTED}/g,ie.join(", ")||"N/A"):ie.length>0&&(E+=`<br><b>Tags:</b> ${ie.join(", ")}<br>`),E.includes("{SCREENSHOTS_LIST}")?E=E.replace(/{SCREENSHOTS_LIST}/g,pe?`${pe}`:"N/A"):pe!==""&&(E+=`<br>${pe}`),o==="pt"&&n){let W=xe.checked?j("sim"):j("nao");E=E.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${j("consentiu_gravacao")}</b> ${W}<br><br>`),E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("sim")}<br>`)}else o==="pt"&&!n?(E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${j("caso_portugal")}</b> ${j("nao")}<br>`),E=E.replace(/{CONSENTIU_GRAVACAO}/g,"")):(E=E.replace(/{CASO_PORTUGAL}/g,""),E=E.replace(/{CONSENTIU_GRAVACAO}/g,""));return _e.querySelectorAll("input, textarea").forEach(W=>{let F=W.id.replace("field-",""),I=new RegExp(`{${F}}`,"g"),U=W.value;if(F==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let B=Ae.querySelector('input[type="radio"]:checked');B&&Se[B.id]&&(U=Se[B.id]["field-REASON_COMMENTS"])}if(ot.includes(F)&&U.trim()!==""){let B=U.split(`
`).map(be=>be.trim()).filter(be=>be!==""&&be!=="\u2022").map(be=>be.startsWith("\u2022 ")?be.substring(2):be).map(be=>`<li>${be}</li>`).join("");U=B?`<ul ${P}>${B}</ul>`:""}else Tt.includes(F)?U=U.split(`
`).filter(B=>B.trim()!=="").map(B=>`<p style="margin: 0 0 8px 0;">${B}</p>`).join(""):W.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let de=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(de===""||de==="\u2022"||de.toLowerCase()==="n/a"){let B=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${F}\\}(?:<br>\\s*)?`,"gi");B.test(E)?E=E.replace(B,""):E=E.replace(I,"")}else E=E.replace(I,U.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(E+=a.getOutput()),E}Ke.onclick=()=>{let C=Mt();C?(It(C),ae(j("copiado_sucesso"))):ae(j("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=A.value,D=Mt();if(!D){ae(j("selecione_substatus"),{error:!0});return}It(D),yt();let E=dt(),P=await po();if(P)try{if(P.focus(),P.innerHTML.trim()==="<p><br></p>"||P.innerHTML.trim()==="<br>"||P.innerText.trim()===""){let ue=document.createRange();ue.selectNodeContents(P);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ue),document.execCommand("delete",!1,null)}else if(!P.innerHTML.endsWith("<br><br>")){let ue=document.createRange();ue.selectNodeContents(P),ue.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ue),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,D),co(P),setTimeout(()=>{ae(j("inserido_copiado"))},600);let pe=typeof ze<"u"&&ze?ze.checked:!0;if(C&&Pe[C]&&pe){let ue=Pe[C];await lt(ue),await new Promise(Q=>setTimeout(Q,500))}E(),xt(1.5),y.value="",A.innerHTML=`<option value="">${j("select_substatus")}</option>`,A.disabled=!0}catch(ie){console.error(ie),ae("Erro ao inserir.",{error:!0}),E()}};function xt(C=1.5){C<=1.5&&(Le.style.display="none",Ae.innerHTML=""),C<=2&&(l.reset(),ge.style.display="none"),C<=3&&(ye.style.display="none",_e.innerHTML="",a.reset(),We.style.display="none",Fe.style.display="none")}function yt(){if(s=!s,s){let C=m.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Te(s,m,"cw-btn-notes")}return gt("bau"),bt("pt"),yt}var $e={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
            ...
            <div style="padding:24px;">
                ...
                <div>
                    ...
                    <div style="font-size:14px; color:#3c4043; line-height:1.6; padding:0 4px;">${_.body.replace(/\n/g,"<br>")}</div>
                </div>
            </div>
        ...
        `;let R=A.querySelector("#csa-back-btn");R.onmouseenter=()=>R.style.background="#f1f3f4",R.onmouseleave=()=>R.style.background="none",R.onclick=z;let $=A.querySelector("#csa-insert-btn");$.onmouseenter=()=>{$.style.transform="translateY(-1px)",$.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},$.onmouseleave=()=>{$.style.transform="translateY(0)",$.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},$.onclick=()=>{$.style.transform="scale(0.96)",k(_,"email"),setTimeout(()=>{$.style.transform="scale(1)",z()},300)}}function z(){s="list",b.style.transform="translateX(0)"}function L(_,K,re=null){let R=document.createElement("button"),$=re?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${re}</span>`:"";return R.innerHTML=`${$}${_}`,Object.assign(R.style,S),o===K&&n===""?Object.assign(R.style,f):(R.onmouseenter=()=>{R.style.background="#F1F3F4",R.style.borderColor="#DADCE0"},R.onmouseleave=()=>{R.style.background="#FFFFFF",R.style.borderColor="#DADCE0"}),R.onclick=()=>{o=K,n="",y.value="",ne(),J()},R}function ne(){d.innerHTML="",d.appendChild(L("Smart CRs",t,"\u26A1")),Object.keys($e).forEach(_=>{d.appendChild(L($e[_].title,_))})}function J(){h.innerHTML="";let _=[];if(n.trim()!==""){let ee=n.toLowerCase();Object.values($e).forEach(N=>{N.emails.forEach(Y=>{(Y.name.toLowerCase().includes(ee)||Y.subject.toLowerCase().includes(ee))&&_.push({type:"email",data:Y})})}),Object.entries(Pe).forEach(([N,Y])=>{if(!Y)return;(N.replace(/_/g," ").toLowerCase().includes(ee)||Y.toLowerCase().includes(ee))&&_.push({type:"cr",key:N,code:Y})})}else o===t?Object.entries(Pe).forEach(([ee,N])=>{N&&_.push({type:"cr",key:ee,code:N})}):$e[o]&&$e[o].emails.forEach(ee=>{_.push({type:"email",data:ee})});if(_.length===0){h.innerHTML=`
                ...
                </div>`;return}let re='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1967D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',R='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA8600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',$='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BDC1C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';_.forEach(ee=>{let N=document.createElement("div");if(Object.assign(N.style,T),ee.type==="email"){let Y=ee.data,xe=Y.subject.length>45?Y.subject.substring(0,45)+"...":Y.subject;N.innerHTML=`
  ...
  `,Object.assign(w.style,t.resetBtn),w.onmouseenter=()=>w.style.background="#fce8e6",w.onmouseleave=()=>w.style.background="transparent",w.onclick=()=>{w.style.transform="scale(0.9)",setTimeout(()=>w.style.transform="scale(1)",150);for(let O in o)delete o[O];c()},S.appendChild(f),S.appendChild(w),a.appendChild(S);let T=document.createElement("div");Object.assign(T.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let q=document.createElement("div");Object.assign(q.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let M=document.createElement("div");M.textContent="BAU";let V=document.createElement("div");V.textContent="LT",Object.assign(M.style,fe),Object.assign(V.style,fe),q.appendChild(M),q.appendChild(V);let X=document.createElement("select");Object.assign(X.style,Ut,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),X.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',X.value=n,T.appendChild(q),T.appendChild(X),g.appendChild(T);let v=document.createElement("div");v.id="csa-checklist-area",g.appendChild(v);let b=document.createElement("div");Object.assign(b.style,Ye),b.className="no-drag",b.title="Redimensionar",a.appendChild(b),Xe(a,b),document.body.appendChild(a);function r(O){return O}function c(){v.innerHTML="";let O=`${n} ${s}`,A=fo[O];if(!A){v.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,Object.assign(c.style,i),c.style.display="inline-flex",c.style.alignItems="center",t===b&&o===""&&Object.assign(c.style,a),c.onmousedown=()=>c.style.transform="scale(0.95)",c.onmouseup=()=>c.style.transform="scale(1)",c.onmouseleave=()=>c.style.transform="scale(1)",c.onclick=()=>{t=b,o="",w.value="",V(),X()},T.appendChild(c)})}function X(){q.innerHTML="";let b=[],r=o.trim()!=="";if(r?Object.entries(ut).forEach(([c,y])=>{let d=y.links.filter(h=>h.name.toLowerCase().includes(o.toLowerCase())||h.desc.toLowerCase().includes(o.toLowerCase()));d.forEach(h=>{h._catIcon=x[c],h._categoryName=y.label}),b=[...b,...d]}):(b=ut[t].links,b.forEach(c=>c._catIcon=x[t])),b.length===0){q.innerHTML=`
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
           ...
           `,f.appendChild(h)}let y=c.filter(h=>!r.includes(h.id)),d=c.filter(h=>r.includes(h.id));if(y.forEach(h=>f.appendChild(V(h,!1))),d.length>0){let h=document.createElement("div");Object.assign(h.style,a.historyDivider),h.innerHTML=`<span>Visualizar ${d.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let O=document.createElement("div");Object.assign(O.style,a.historyContainer),d.forEach(k=>O.appendChild(V(k,!0)));let A=!1;h.onclick=()=>{Z.playClick(),A=!A,O.style.display=A?"flex":"none",h.querySelector("svg").style.transform=A?"rotate(180deg)":"rotate(0deg)",h.querySelector("span").textContent=A?"Ocultar hist\xF3rico":`Visualizar ${d.length} avisos anteriores`},f.appendChild(h),f.appendChild(O)}}function V(r,c){let y=document.createElement("div");Object.assign(y.style,c?a.cardHistory:a.card);let d=i[r.type]||i.info,h=document.createElement("div");Object.assign(h.style,a.cardHeader,{background:d.bg,color:d.text,borderBottom:`1px solid ${d.border}`});let O=document.createElement("div");if(Object.assign(O.style,{display:"flex",alignItems:"center",gap:"6px"}),O.innerHTML=`${d.icon} <span>${r.type.toUpperCase()}</span>`,h.appendChild(O),c){let k=document.createElement("span");k.textContent=s(r.date),k.style.opacity="0.7",h.appendChild(k)}else{let k=document.createElement("button");k.title="Marcar como lido",Object.assign(k.style,a.dismissBtn),k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',k.onmouseenter=()=>{k.style.color="#1e8e3e",k.style.background="#e6f4ea",k.style.borderColor="#1e8e3e"},k.onmouseleave=()=>{k.style.color="#5f6368",k.style.background="#fff",k.style.borderColor="rgba(0,0,0,0.1)"},k.onclick=se=>{se.stopPropagation(),Z.playClick(),y.style.transform="translateX(20px)",y.style.opacity="0",setTimeout(()=>{let z=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");z.push(r.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(z)),M(),T()},250)},h.appendChild(k)}if(y.appendChild(h),r.title){let k=document.createElement("div");Object.assign(k.style,a.msgTitle),k.textContent=r.title,y.appendChild(k)}if(!c){let k=document.createElement("div");Object.assign(k.style,a.metaContainer),k.innerHTML=`<span style="font-weight:600">${r.author}</span> \u2022 <span>${s(r.date)}</span>`,y.appendChild(k)}let A=document.createElement("div");return Object.assign(A.style,a.cardBody),A.innerHTML=m(r.text),y.appendChild(A),y}M();let X=document.createElement("div");Object.assign(X.style,Ye),X.className="no-drag",p.appendChild(X),Xe(p,X),document.body.appendChild(p);let v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),b=Ue.some(r=>!v.includes(r.id));return{toggle:u,hasUnread:b}}function Mo(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Vt();try{Z.initGlobalListeners(),Z.playStartup()}catch(i){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",i)}He.fetchTips(),Et();let e=go(),t=bo(),o=ho(),n=xo(),s=yo();io({toggleNotes:e,toggleEmail:t,toggleScript:o,toggleLinks:n,broadcastControl:s})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),ae("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Mo();})();

...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=b=>{b.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=b=>{b.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=b=>{b.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=b=>{b.stopPropagation(),e.toggleLinks()},(async function(){await Xe(2800),o.classList.add("docked"),await Xe(300);let x=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(E=>E.classList.add("visible"));for(let E=0;E<x.length;E++)x[E].classList.add("popped"),await Xe(90);await Xe(200),o.classList.add("system-check")})();let a=!1,s,i,p,S,y=3;o.onmousedown=b=>{if(b.target.closest("button"))return;b.preventDefault(),s=b.clientX,i=b.clientY;let x=o.getBoundingClientRect();p=x.left,S=x.top,document.addEventListener("mousemove",m),document.addEventListener("mouseup",C)};function m(b){let x=b.clientX-s,A=b.clientY-i;!a&&Math.sqrt(x*x+A*A)>y&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${p+x}px`,o.style.top=`${S+A}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function C(b){if(document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",C),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let x=window.innerWidth,A=window.innerHeight,E=o.getBoundingClientRect(),I=E.left+E.width/2,F;I<x/2?(F=24,o.classList.remove("side-right"),o.classList.add("side-left")):(F=x-E.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let B=E.top;B<24&&(B=24),B>A-E.height-24&&(B=A-E.height-24),o.style.left=`${F}px`,o.style.top=`${B}px`,setTimeout(()=>{},600)}else{let x=b.target.closest("button");x&&(x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="",150))}}}function Ke(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let s=Date.now()-r,i=Math.max(0,1500-s);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},i)}}var Mt=e=>new Promise(t=>setTimeout(t,e));function Qe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function gt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{Q("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Gt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Dt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Ft(){console.log("Iniciando processo de Nova Nota...");let e=Dt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(s=>s.innerText.trim()==="description");if(o){let s=o.closest("material-fab")||o.closest("material-button");s?(s.style&&(s.style.display="block",s.style.visibility="visible"),Qe(s)):Qe(o)}else{let s=document.querySelector("material-fab-speed-dial");if(s){let i=s.querySelector(".trigger");i?(i.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Qe(i)):s.click(),await Mt(800);let S=Array.from(document.querySelectorAll("i.material-icons-extended")).find(y=>y.innerText.trim()==="description");S&&Qe(S)}}let r=null,a=0;for(;!r&&a<20;){await Mt(300);let s=Dt();if(s.length>t)r=s.find(i=>!e.includes(i)),r||(r=s[s.length-1]);else if(a>10){let i=s.filter(p=>p.offsetParent!==null);i.length>0&&(r=i[i.length-1])}a++}return r}var Zt={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto'",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},yo={...Zt,height:"100px",resize:"vertical"};var ft={width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"};var Jt={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},eo={fontSize:"12px",color:"#e37400",marginTop:"4px"},to={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},oo={display:"flex",gap:"15px",marginBottom:"10px"};function Pt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Jt);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,Me,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,oo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,ft);let r=document.createElement("label");r.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(r);let s=document.createElement("input");s.type="radio",s.name="ts_usage_mod",s.value="N\xE3o",s.checked=!0,Object.assign(s.style,ft);let i=document.createElement("label");i.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(s),p.appendChild(i),n.appendChild(a),n.appendChild(p);let S=document.createElement("div");S.style.display="block";let y=document.createElement("label");y.textContent="Qual foi o Motivo?",Object.assign(y.style,Me,{fontSize:"12px"});let m=document.createElement("input");m.type="text",Object.assign(m.style,to);let C=document.createElement("div");C.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(C.style,eo),S.appendChild(y),S.appendChild(m),S.appendChild(C),e.appendChild(t),e.appendChild(n),e.appendChild(S),o.onchange=()=>{S.style.display="none"},s.onchange=()=>{S.style.display="block"};function b(E,I){if(e.style.display="none",!E||E.includes("Education")||!I||I.length===0)return;let F=I.some(c=>c.includes("enhanced")||c==="ec_google_ads"),B=I.some(c=>(c.includes("conversion")||c.includes("ads"))&&!c.includes("enhanced")),g=I.some(c=>c.includes("ga4")||c.includes("analytics")||c.includes("ua")),d=I.some(c=>c.includes("merchant")||c.includes("gmc")||c.includes("shopping"));(F||B&&!g&&!d)&&(e.style.display="block")}function x(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return s.checked&&m.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${m.value}`),E+="<br>",E}function A(){e.style.display="none",s.checked=!0,o.checked=!1,S.style.display="block",m.value=""}return{element:e,updateVisibility:b,getOutput:x,reset:A}}var k={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},je={ads:'<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>',ga4:'<svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2v-3h2v3zm4 0h-2v-5h2v5z"/></svg>',gtm:'<svg viewBox="0 0 24 24"><path d="M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58.55 0 1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41 0-.55-.23-1.06-.59-1.42zM5.5 7C4.67 7 4 6.33 4 5.5S4.67 4 5.5 4 7 4.67 7 5.5 6.33 7 5.5 7z"/></svg>',gmc:'<svg viewBox="0 0 24 24"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>',default:'<svg viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>'};function jt(e){let t={};function n(g){let d=g.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?k.brands.ads:d.includes("ga4")||d.includes("analytics")?k.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?k.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?k.brands.gmc:k.brands.default}let o=Object.entries(Ie).filter(([g,d])=>d.popular),r={};Object.entries(Ie).forEach(([g,d])=>{if(d.popular)return;let l=n(d.name);r[l.label]||(r[l.label]={brand:l,tasks:[]}),r[l.label].tasks.push({key:g,...d})});let a="cw-zen-tasks";if(!document.getElementById(a)){let g=document.createElement("style");g.id=a,g.innerHTML=`
            ...
            /* HERO CARD */
            .cw-hero-card {
                background: ${k.white}; border-radius: 12px; padding: 10px 12px;
                box-shadow: ${k.shadowCard}; border: 1px solid transparent;
            ...
            .cw-hero-icon { 
                width: 32px; height: 32px; border-radius: 8px; background: #F3F4F6; color: ${k.textSub};
                display: flex; align-items: center; justify-content: center; flex-shrink: 0; transition: all 0.2s;
            }
            .cw-hero-icon svg { width: 18px; height: 18px; fill: currentColor; }
            .cw-hero-label { font-size: 12px; font-weight: 500; color: ${k.textMain}; line-height: 1.2; }

            /* Hero Active */
            .cw-hero-card.active { background: ${k.white}; border-color: ${k.blue}; }
            .cw-hero-card.active .cw-hero-icon { background: ${k.blue}; color: white; }
            .cw-hero-card.active .cw-hero-label { color: ${k.blue}; font-weight: 600; }

            /* Hero Stepper */
            .cw-hero-stepper {
                position: absolute; right: 4px; top: 4px; bottom: 4px;
                background: ${k.white}; border-radius: 8px; padding: 0 4px;
            ...
            .cw-screens-container {
                padding: 10px 4px 40px 4px; /* Espa\xE7o para scroll */
            ...
            /* Efeito de Foco no Cart\xE3o */
            .cw-screen-card:focus-within {
                border-color: ${k.brands.ads.color}; /* Azul Google */
            ...
            /* Input de T\xEDtulo (Edit\xE1vel) */
            .cw-card-title-input {
                font-family: ${k.font}; font-size: 14px; font-weight: 600;
                color: ${k.textMain}; border: none; background: transparent;
                width: 100%; outline: none; transition: color 0.2s;
            }
            .cw-card-title-input:focus { color: ${k.brands.ads.color}; }
            ...
            .cw-input-label {
                display: block; font-size: 11px; font-weight: 600; color: ${k.textSub};
            ...
            .cw-input-field.filled {
                ...
                color: #137333;
                padding-right: 30px; /* Espa\xE7o pro check */
            }

            /* \xCDcone de Check Animado (Aparece quando cola) */
            .cw-input-check {
    ...
    `;let S=s.querySelector(".cw-hero-grid"),y=s.querySelector(".cw-acc-container"),m=s.querySelector(".cw-results-container"),C=s.querySelector(".cw-search-input"),b=s.querySelector(".cw-status-bar"),x=s.querySelector(".cw-status-text"),A=s.querySelector(".cw-footer-icons");o.forEach(([g,d])=>{let l=n(d.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${g}`,c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;I(g,h>0?-h:1,d)},c.querySelector(".minus").onclick=()=>I(g,-1,d),c.querySelector(".plus").onclick=()=>I(g,1,d),c.dataset.color=l.color,S.appendChild(c)});function E(g,d){let l=n(d.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=g,c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;I(g,h>0?-h:1,d)},c.querySelector(".minus").onclick=()=>I(g,-1,d),c.querySelector(".plus").onclick=()=>I(g,1,d),c}Object.entries(r).forEach(([g,d])=>{let l=document.createElement("div");l.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${d.brand.color}"></div>
                ${g}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{y.querySelectorAll(".cw-acc-group.open").forEach(h=>{h!==l&&h.classList.remove("open")}),l.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",d.tasks.forEach(h=>{let w=E(h.key,h);v.appendChild(w)}),l.appendChild(c),l.appendChild(v),y.appendChild(l)});function I(g,d,l){t[g]||(t[g]={count:0,data:l,brand:n(l.name)}),t[g].count+=d,t[g].count<=0&&delete t[g],F(),B(),e&&e()}function F(){o.forEach(([v])=>{let h=S.querySelector(`#hero-${v}`);if(!h)return;let w=t[v];if(w){h.classList.add("active"),h.style.borderColor=h.dataset.color;let T=h.querySelector(".cw-hero-icon");T.style.backgroundColor=h.dataset.color,T.style.color="white",h.querySelector(".cw-step-val").textContent=w.count}else{h.classList.remove("active"),h.style.borderColor="transparent";let T=h.querySelector(".cw-hero-icon");T.style.backgroundColor="#F3F4F6",T.style.color=k.textSub}}),s.querySelectorAll(".cw-task-item").forEach(v=>{let h=v.dataset.id,w=t[h];w?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=w.count):v.classList.remove("selected")});let d=Object.keys(t),l=0,c=[];if(d.forEach(v=>{let h=t[v];l+=h.count;for(let w=0;w<h.count;w++)c.length<6&&c.push(h.brand)}),l>0){b.classList.add("visible");let v=l>1?"A\xE7\xF5es":"A\xE7\xE3o",h=l>1?"definidas":"definida";x.textContent=`${l} ${v} ${h}`,A.innerHTML="",c.forEach(w=>{let T=document.createElement("div");T.className="cw-mini-icon",T.style.backgroundColor=w.color,T.innerHTML=je[w.icon]||je.default;let O=T.querySelector("svg");O&&(O.style.width="12px",O.style.height="12px"),A.appendChild(T)})}else b.classList.remove("visible")}C.addEventListener("input",g=>{let d=g.target.value.toLowerCase();if(d.length>0){y.style.display="none",m.style.display="block",m.innerHTML="";let l=!1;Object.entries(Ie).forEach(([c,v])=>{if(v.name.toLowerCase().includes(d)){l=!0;let h=E(c,v);t[c]&&(h.classList.add("selected"),h.querySelector(".cw-step-val").textContent=t[c].count),m.appendChild(h)}}),l||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else y.style.display="block",m.style.display="none"});function B(){p.innerHTML="";let g=Object.keys(t),d=!1,l="implementation";if(g.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para gerar os campos de evid\xEAncia.</div>';return}g.forEach(c=>{let v=t[c].data,h=t[c].count,w=v.screenshots?v.screenshots[l]||[]:["Evid\xEAncia da Implementa\xE7\xE3o"];if(w.length>0){d=!0;for(let T=1;T<=h;T++){let O=document.createElement("div");O.className="cw-screen-card";let $=document.createElement("div");$.className="cw-card-header";let N=document.createElement("input");N.className="cw-card-title-input",N.id=`name-${c}-${T}`,N.value=`${v.name}${h>1?" #"+T:""}`;let _=document.createElement("span");_.innerHTML="\u270E",_.style.cssText="font-size:12px; color:#DADCE0; cursor:pointer; margin-left:8px",_.onclick=()=>N.focus();let Z=document.createElement("div");Z.style.cssText="display:flex; align-items:center; width:100%",Z.appendChild(N),Z.appendChild(_),$.appendChild(Z),O.appendChild($),w.forEach((j,V)=>{let L=document.createElement("div");L.className="cw-input-group";let te=document.createElement("label");te.className="cw-input-label",te.textContent=j.replace(/📷|:|•/g,"").trim();let U=document.createElement("input");U.className="cw-input-field",U.id=`screen-${c}-${T}-${V}`,U.placeholder="Cole o link aqui...",U.setAttribute("autocomplete","off");let W=document.createElement("div");W.className="cw-input-check",W.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="width:100%;height:100%"><polyline points="20 6 9 17 4 12"></polyline></svg>',U.addEventListener("input",()=>{U.value.trim().length>5?U.classList.add("filled"):U.classList.remove("filled")}),L.appendChild(te),L.appendChild(U),L.appendChild(W),O.appendChild(L)}),p.appendChild(O)}}}),d||(p.innerHTML='<div class="cw-empty-state">Esta tarefa n\xE3o requer screenshots.</div>'),i.style.display=d?"block":"none"}return{selectionElement:s,screenshotsElement:i,updateSubStatus:()=>B(),getCheckedElements:()=>Object.keys(t).map(g=>({value:g,closest:()=>({querySelector:()=>({textContent:t[g].count})})})),reset:()=>{for(let g in t)delete t[g];F(),B(),C.value="",y.style.display="block",m.style.display="none"}}}function zt(){let e="v3.6.0",t="bau",n="pt",o=!1,r=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},s=Pt(),i=jt(()=>{let R=i.getCheckedElements().map(f=>f.value);N&&N.value&&s.updateVisibility(N.value,R)}),p=document.createElement("div");p.id="autofill-popup",Object.assign(p.style,he,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),p.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let y=ye(p,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:p,googleLine:null},()=>lt()),m=y.lastElementChild;if(m){let u=document.createElement("div");u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',u.classList.add("no-drag"),Object.assign(u.style,{fontSize:"20px",color:"#9AA0A6",cursor:"pointer",padding:"8px",display:"flex",alignItems:"center",justifyContent:"center",marginRight:"4px",marginLeft:"auto",borderRadius:"50%",transition:"background 0.2s, transform 0.3s ease"}),u.title="Expandir/Contrair Janela",u.onmouseover=()=>u.style.backgroundColor="#e8eaed",u.onmouseout=()=>u.style.backgroundColor="transparent";let R=!1;u.onclick=()=>{R=!R,u.style.transform=R?"rotate(180deg)":"rotate(0deg)",p.style.width=R?"700px":"380px",R?u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>':u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>'};let f=m.lastElementChild;f?m.insertBefore(u,f):m.appendChild(u)}p.appendChild(y);let C=document.createElement("div");Object.assign(C.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),p.appendChild(C);let b=document.createElement("div");b.textContent="created by lucaste@",Object.assign(b.style,$e),p.appendChild(b);let x=document.createElement("div");x.id="step-lang-type";let A=document.createElement("label");Object.assign(A.style,a.label),x.appendChild(A);let E=document.createElement("div");Object.assign(E.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let I=document.createElement("div");I.textContent="Portugu\xEAs",I.classList.add("no-drag"),Object.assign(I.style,ie);let F=document.createElement("div");F.textContent="Espa\xF1ol",F.classList.add("no-drag"),Object.assign(F.style,ie),I.onclick=()=>at("pt"),F.onclick=()=>at("es"),E.appendChild(I),E.appendChild(F),x.appendChild(E),C.appendChild(x);let B=document.createElement("div");B.id="step-0-case-type";let g=document.createElement("label");Object.assign(g.style,a.label),B.appendChild(g);let d=document.createElement("div");Object.assign(d.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let l=document.createElement("div");l.textContent="BAU",l.classList.add("no-drag"),Object.assign(l.style,ie);let c=document.createElement("div");c.textContent="LM",c.classList.add("no-drag"),Object.assign(c.style,ie),l.onclick=()=>nt("bau"),c.onclick=()=>nt("lm"),d.appendChild(l),d.appendChild(c),B.appendChild(d),C.appendChild(B);let v=document.createElement("div");v.id="step-1-selection";let h=document.createElement("label");Object.assign(h.style,a.label);let w=document.createElement("select");w.id="main-status",Object.assign(w.style,De),w.innerHTML='<option value="">-- Selecione --</option><option value="NI">NI - Need Info</option><option value="SO">SO - Solution Offered</option><option value="IN">IN - Inactive</option><option value="AS">AS - Assigned</option>';let T=document.createElement("div");Object.assign(T.style,{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginTop:"16px",marginBottom:"8px"});let O=document.createElement("label");Object.assign(O.style,a.label,{marginTop:"0",marginBottom:"0"});let $=document.createElement("a");$.target="_blank",$.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg> Guia de Substatus',Object.assign($.style,a.helpLink),T.appendChild(O),T.appendChild($);let N=document.createElement("select");N.id="sub-status",Object.assign(N.style,De),N.disabled=!0,v.appendChild(h),v.appendChild(w),v.appendChild(T),v.appendChild(N),C.appendChild(v);let _=document.createElement("div");_.id="step-1-1-portugal",Object.assign(_.style,a.stepBlock,{display:"none"});let Z=document.createElement("label");Object.assign(Z.style,a.label),_.appendChild(Z);let j=document.createElement("div");Object.assign(j.style,a.radioContainer);let V=document.createElement("div");Object.assign(V.style,{display:"flex",alignItems:"center"});let L=document.createElement("input");L.type="radio",L.name="portugal-group",L.value="sim",Object.assign(L.style,a.checkboxInput);let te=document.createElement("label");te.htmlFor="portugal-sim",Object.assign(te.style,{cursor:"pointer"}),V.appendChild(L),V.appendChild(te);let U=document.createElement("div");Object.assign(U.style,{display:"flex",alignItems:"center"});let W=document.createElement("input");W.type="radio",W.name="portugal-group",W.value="nao",W.checked=!0,Object.assign(W.style,a.checkboxInput);let be=document.createElement("label");be.htmlFor="portugal-nao",Object.assign(be.style,{cursor:"pointer"}),U.appendChild(W),U.appendChild(be),j.appendChild(V),j.appendChild(U),_.appendChild(j),C.appendChild(_);function Je(u){o=u,u?ge.style.display="block":ge.style.display="none"}L.onchange=()=>Je(!0),W.onchange=()=>Je(!1);let ge=document.createElement("div");ge.id="step-1-2-consent",Object.assign(ge.style,a.stepBlock,{display:"none"});let et=document.createElement("label");Object.assign(et.style,a.label),ge.appendChild(et);let ze=document.createElement("div");Object.assign(ze.style,a.radioContainer);let Be=document.createElement("div");Object.assign(Be.style,{display:"flex",alignItems:"center"});let Se=document.createElement("input");Se.type="radio",Se.name="consent-group",Se.value="Sim",Se.checked=!0,Object.assign(Se.style,a.checkboxInput);let qe=document.createElement("label");qe.htmlFor="consent-sim",Object.assign(qe.style,{cursor:"pointer"}),Be.appendChild(Se),Be.appendChild(qe);let Ve=document.createElement("div");Object.assign(Ve.style,{display:"flex",alignItems:"center"});let _e=document.createElement("input");_e.type="radio",_e.name="consent-group",_e.value="N\xE3o",Object.assign(_e.style,a.checkboxInput);let He=document.createElement("label");He.htmlFor="consent-nao",Object.assign(He.style,{cursor:"pointer"}),Ve.appendChild(_e),Ve.appendChild(He),ze.appendChild(Be),ze.appendChild(Ve),ge.appendChild(ze),C.appendChild(ge);let Ce=document.createElement("div");Ce.id="step-1-5-snippets",Object.assign(Ce.style,a.stepBlock,{display:"none"});let tt=document.createElement("h3");Object.assign(tt.style,a.h3);let ce=document.createElement("div");ce.id="snippet-container",Ce.appendChild(tt),Ce.appendChild(ce),C.appendChild(Ce);let de=document.createElement("div");de.id="step-2-tasks",Object.assign(de.style,a.stepBlock,{display:"none"});let re=document.createElement("button");re.textContent="+ Gostaria de selecionar uma task?",Object.assign(re.style,a.optionalBtn),re.onmouseover=()=>{re.style.background="#e8f0fe"},re.onmouseout=()=>{re.style.background="white"};let Oe=document.createElement("h3");Object.assign(Oe.style,a.h3);let xt=document.createElement("div");xt.id="task-checkboxes-container",de.appendChild(re),de.appendChild(xt),de.appendChild(Oe),de.appendChild(i.selectionElement),C.appendChild(de);let pe=document.createElement("div");pe.id="step-3-form",Object.assign(pe.style,a.stepBlock,{display:"none"});let ot=document.createElement("h3");Object.assign(ot.style,a.h3),pe.appendChild(ot);let fe=document.createElement("div");fe.id="dynamic-form-fields-container",pe.appendChild(fe),pe.appendChild(s.element),pe.appendChild(i.screenshotsElement),C.appendChild(pe);let Ae=document.createElement("div");Ae.id="step-4-email",Object.assign(Ae.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ee=document.createElement("label");Ee.style.display="flex",Ee.style.alignItems="center",Ee.style.cursor="pointer",Ee.style.fontSize="14px";let we=document.createElement("input");we.type="checkbox",we.checked=!0,Object.assign(we.style,a.checkboxInput),Ee.appendChild(we),Ee.appendChild(document.createTextNode("Preencher email automaticamente?")),Ae.appendChild(Ee),C.appendChild(Ae);let ke=document.createElement("div");Object.assign(ke.style,{display:"none",gap:"8px",padding:"0"}),C.appendChild(ke);let Le=document.createElement("button");Object.assign(Le.style,a.buttonBase,{backgroundColor:"#5f6368"}),Le.textContent="Copiar";let Re=document.createElement("button");Object.assign(Re.style,a.buttonBase,{backgroundColor:"#1a73e8"}),Re.textContent="Preencher",ke.appendChild(Le),ke.appendChild(Re),document.body.appendChild(p);function nt(u){t=u;let R=Ge();Object.assign(l.style,ie),Object.assign(c.style,ie),u==="bau"?(Object.assign(l.style,R),$.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(c.style,R),$.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),N.value&&N.dispatchEvent(new Event("change"))}function M(u){try{if(me&&me[n]&&me[n][u])return me[n][u];if(me&&me.pt&&me.pt[u])return me.pt[u]}catch{}return u}function Ht(){A.textContent=M("idioma"),g.textContent=M("fluxo"),h.textContent=M("status_principal"),O.textContent=M("substatus"),tt.textContent=M("cenarios_comuns"),Oe.textContent=M("selecione_tasks"),ot.textContent=M("preencha_detalhes"),Le.textContent=M("copiar"),Re.textContent=M("preencher"),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=M("select_status")),N.querySelector('option[value=""]')&&(N.querySelector('option[value=""]').textContent=M("select_substatus")),Z.textContent=M("caso_portugal"),te.textContent=M("sim"),be.textContent=M("nao"),et.textContent=M("consentiu_gravacao"),qe.textContent=M("sim"),He.textContent=M("nao"),fe.querySelectorAll("label").forEach(u=>{let R=u.nextElementSibling.id.replace("field-",""),f=M(R.toLowerCase());f!==R.toLowerCase()?u.textContent=f:u.textContent=R.replace(/_/g," ").replace(/\b\w/g,D=>D.toUpperCase())+":"}),re.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function at(u){n=u;let R=Ge();Object.assign(I.style,ie),Object.assign(F.style,ie),u==="pt"?(Object.assign(I.style,R),_.style.display="block",Je(o)):(Object.assign(F.style,R),_.style.display="none",ge.style.display="none"),Ht(),N.value&&N.dispatchEvent(new Event("change"))}function st(u){(u.value.trim()===""||u.value.trim()==="\u2022")&&(u.value="\u2022 "),u.onkeydown=function(R){if(R.key==="Enter"){R.preventDefault();let f=this.selectionStart,D=this.selectionEnd,K=this.value,se=K.lastIndexOf(`
`,f-1)+1,X=K.substring(se,f),z=X.trim()==="\u2022"||X.trim()===""?`
`:`
\u2022 `;this.value=K.substring(0,f)+z+K.substring(D),this.selectionStart=this.selectionEnd=f+z.length}else if(R.key==="Backspace"){let f=this.selectionStart;if(f===this.selectionEnd&&f>0){let D=this.value.substring(0,f);D.endsWith(`
\u2022 `)?(R.preventDefault(),this.value=D.substring(0,f-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=f-3):D==="\u2022 "&&(R.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function it(){let u=typeof ce<"u"?ce:document.getElementById("snippet-container");if(!u)return;let R=u.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),f={},D=new Set;R.forEach(X=>{let z=X.id,J=Ne[z];if(J)for(let P in J)P==="linkedTask"?D.add(J.linkedTask):P!=="type"&&(f[P]||(f[P]=[]),f[P].includes(J[P])||f[P].push(J[P]))});let K=new Set;Object.values(Ne).forEach(X=>{Object.keys(X).forEach(z=>{z!=="linkedTask"&&z!=="type"&&K.add(z)})}),K.forEach(X=>{let z=document.getElementById(X);if(z){let J=f[X]||[],P="";Pe.includes(X.replace("field-",""))?(P=J.map(G=>G.startsWith("\u2022 ")?G:"\u2022 "+G).join(`
`),P===""?P="\u2022 ":P.endsWith(`
\u2022 `)||(P+=`
\u2022 `)):P=J.join(`

`),P.trim()!=="\u2022"&&P.trim()!==""?z.value=P:Pe.includes(X.replace("field-",""))?z.value="\u2022 ":z.value="",z.tagName==="TEXTAREA"&&typeof st=="function"&&st(z)}}),document.querySelectorAll(".task-checkbox").forEach(X=>{D.has(X.value)&&(X.checked||(X.checked=!0,X.dispatchEvent(new Event("change",{bubbles:!0}))))})}w.onchange=()=>{let u=w.value;if(rt(1.5),N.innerHTML=`<option value="">${M("select_substatus")}</option>`,!u){N.disabled=!0;return}for(let R in Fe){let f=Fe[R];if(f.status===u){let D=document.createElement("option");D.value=R,D.textContent=f.name,N.appendChild(D)}}N.disabled=!1},N.onchange=()=>{let u=N.value;if(rt(1.5),!u)return;i.updateSubStatus(u);let R=Fe[u];ce.innerHTML="";let f=(G,q,H)=>{let ee=document.createElement("label");Object.assign(ee.style,a.checkboxLabel),ee.onmouseover=()=>ee.style.backgroundColor="#e8eaed",ee.onmouseout=()=>ee.style.backgroundColor="#f8f9fa";let Y=document.createElement("input");return Y.type=q,Y.id=G.id,Object.assign(Y.style,a.checkboxInput),ee.appendChild(Y),ee.appendChild(document.createTextNode(` ${G.text}`)),H.appendChild(ee),Y},D=[],K="radio";if(u==="NI_Awaiting_Inputs")D=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(u.startsWith("SO_"))K="checkbox",D=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(u.startsWith("AS_")){K="checkbox";let G=document.createElement("label");G.textContent=M("cenarios_comuns"),Object.assign(G.style,a.label),ce.appendChild(G),D=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else u.startsWith("IN_")&&(D=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let se=D.filter(G=>{let q=Ne[G.id];return!q.type||q.type==="all"||q.type===t});se.forEach((G,q)=>{let H=f(G,K,ce);K==="radio"&&(H.name="scenario-radio-group",q===0&&(H.checked=!0))}),se.length>0&&(Ce.style.display="block"),R.requiresTasks?(re.style.display="none",Oe.style.display="block",i.selectionElement.style.display="block",de.style.display="block"):(re.style.display="block",Oe.style.display="none",i.selectionElement.style.display="none",de.style.display="block"),fe.innerHTML="";let X=R.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(X)].forEach(G=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(G))return;let q=G.slice(1,-1),H=document.createElement("label"),ee=M(q.toLowerCase());H.textContent=ee!==q.toLowerCase()?ee:q.replace(/_/g," ").replace(/\b\w/g,oe=>oe.toUpperCase())+":",Object.assign(H.style,a.label);let Y;Pe.includes(q)?(Y=document.createElement("textarea"),Object.assign(Y.style,a.textarea),Y.classList.add("bullet-textarea"),st(Y)):mt.includes(q)?(Y=document.createElement("textarea"),Object.assign(Y.style,a.textarea)):(Y=document.createElement("input"),Y.type="text",Object.assign(Y.style,a.input),q==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))&&(Object.assign(H.style,{display:"none"}),Object.assign(Y.style,{display:"none"}))),q==="ON_CALL"&&t==="lm"&&(Object.assign(H.style,{display:"none"}),Object.assign(Y.style,{display:"none"}),Y.value="N/A"),Y.id=`field-${q}`,fe.appendChild(H),fe.appendChild(Y)});let J=ce.querySelectorAll('input[type="checkbox"], input[type="radio"]');J.length>0&&(J.forEach(G=>{G.removeEventListener("change",it),G.addEventListener("change",it)}),it()),pe.style.display="block",We[u]?Ae.style.display="block":Ae.style.display="none",ke.style.display="flex";let P=i.getCheckedElements().map(G=>G.value);s.updateVisibility(u,P)},re.onclick=()=>{re.style.display="none",Oe.style.display="block",i.selectionElement.style.display="block"};function yt(){let u=N.value;if(!u)return null;let f=Fe[u].template.replace(/\n/g,"<br>"),D='style="margin-bottom: 12px; padding-left: 30px;"',K=[],se="",X=taskManager.getCheckedElements();X.length>0&&X.forEach(P=>{let G=P.value,q=Ie[G],H=P.closest().querySelector(".stepper-count"),ee=H?parseInt(H.textContent):1;ee>1?K.push(`${q.name} (x${ee})`):K.push(q.name)});let z=taskManager.screenshotsElement;if(z){let G=Array.from(z.querySelectorAll('input[id^="name-"]')).filter(q=>q.offsetParent!==null);G.length>0&&G.forEach(q=>{let H=q.value,Y=q.closest("div").parentNode.querySelectorAll('input[id^="screen-"]'),oe=!1,le="";Y.forEach(vt=>{let St=vt.previousElementSibling,Ut=St?St.textContent.replace("\u{1F4F7} ","").replace(":",""):"Print",Ct=vt.value.trim(),$t=Ct?` ${Ct}`:"";le+=`<li>${Ut} -${$t}</li>`,oe=!0}),oe&&(se+=`<b>${H}</b>`,se+=`<ul ${D}>${le}</ul>`)})}if(f.includes("{TAGS_IMPLEMENTED}")?f=f.replace(/{TAGS_IMPLEMENTED}/g,K.join(", ")||"N/A"):K.length>0&&(f+=`<br><b>Tags:</b> ${K.join(", ")}<br>`),f.includes("{SCREENSHOTS_LIST}")?f=f.replace(/{SCREENSHOTS_LIST}/g,se?`${se}`:"N/A"):se!==""&&(f+=`<br>${se}`),n==="pt"&&o){let P=Se.checked?M("sim"):M("nao");f=f.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${M("consentiu_gravacao")}</b> ${P}<br><br>`),f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${M("caso_portugal")}</b> ${M("sim")}<br>`)}else n==="pt"&&!o?(f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${M("caso_portugal")}</b> ${M("nao")}<br>`),f=f.replace(/{CONSENTIU_GRAVACAO}/g,"")):(f=f.replace(/{CASO_PORTUGAL}/g,""),f=f.replace(/{CONSENTIU_GRAVACAO}/g,""));return fe.querySelectorAll("input, textarea").forEach(P=>{let G=P.id.replace("field-",""),q=new RegExp(`{${G}}`,"g"),H=P.value;if(G==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))){let oe=ce.querySelector('input[type="radio"]:checked');oe&&Ne[oe.id]&&(H=Ne[oe.id]["field-REASON_COMMENTS"])}if(Pe.includes(G)&&H.trim()!==""){let oe=H.split(`
`).map(le=>le.trim()).filter(le=>le!==""&&le!=="\u2022").map(le=>le.startsWith("\u2022 ")?le.substring(2):le).map(le=>`<li>${le}</li>`).join("");H=oe?`<ul ${D}>${oe}</ul>`:""}else mt.includes(G)?H=H.split(`
`).filter(oe=>oe.trim()!=="").map(oe=>`<p style="margin: 0 0 8px 0;">${oe}</p>`).join(""):P.tagName==="TEXTAREA"&&(H=H.replace(/\n/g,"<br>"));let ee=H.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ee===""||ee==="\u2022"||ee.toLowerCase()==="n/a"){let oe=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${G}\\}(?:<br>\\s*)?`,"gi");oe.test(f)?f=f.replace(oe,""):f=f.replace(q,"")}else f=f.replace(q,H.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof s<"u"&&s.getOutput&&(f+=s.getOutput()),f}Le.onclick=()=>{let u=yt();u?(gt(u),Q(M("copiado_sucesso"))):Q(M("selecione_substatus"),{error:!0})},Re.onclick=async()=>{let u=N.value,R=yt();if(!R){Q(M("selecione_substatus"),{error:!0});return}gt(R),lt();let f=Ke(),D=await Ft();if(D)try{if(D.focus(),D.innerHTML.trim()==="<p><br></p>"||D.innerHTML.trim()==="<br>"||D.innerText.trim()===""){let z=document.createRange();z.selectNodeContents(D);let J=window.getSelection();J.removeAllRanges(),J.addRange(z),document.execCommand("delete",!1,null)}else if(!D.innerHTML.endsWith("<br><br>")){let z=document.createRange();z.selectNodeContents(D),z.collapse(!1);let J=window.getSelection();J.removeAllRanges(),J.addRange(z),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,R),Gt(D),setTimeout(()=>{Q(M("inserido_copiado"))},600);let se=typeof we<"u"&&we?we.checked:!0;if(u&&We[u]&&se){let z=We[u];await Nt(z),await new Promise(J=>setTimeout(J,500))}f(),rt(1.5),w.value="",N.innerHTML=`<option value="">${M("select_substatus")}</option>`,N.disabled=!0}catch(K){console.error(K),Q("Erro ao inserir.",{error:!0}),f()}};function rt(u=1.5){u<=1.5&&(Ce.style.display="none",ce.innerHTML=""),u<=2&&(de.style.display="none",i.reset(),re.style.display="none"),u<=3&&(pe.style.display="none",fe.innerHTML="",s.reset(),ke.style.display="none",Ae.style.display="none")}function lt(){r=!r,ve(r,p,"cw-btn-notes")}return nt("bau"),at("pt"),lt}var Te={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let V=h.querySelector("#csa-back-btn");V.onmouseover=()=>V.style.backgroundColor="#f1f3f4",V.onmouseout=()=>V.style.backgroundColor="transparent",V.onclick=O;let L=h.querySelector("#csa-insert-btn");L.onmouseover=()=>L.style.backgroundColor="#174ea6",L.onmouseout=()=>L.style.backgroundColor="#1a73e8",L.onclick=async()=>{L.style.transform="scale(0.96)",A();let te=Ke();try{await bt(_),te()}catch(U){console.error(U),te()}setTimeout(()=>{L.style.transform="scale(1)",O()},300)}}function O(){o="list",F.style.transform="translateX(0)"}function $(){l.innerHTML="",Object.keys(Te).forEach(_=>{let Z=Te[_],j=document.createElement("button");j.textContent=Z.title,Object.assign(j.style,S),t===_&&n===""&&Object.assign(j.style,y),j.onclick=()=>{t=_,n="",d.value="",$(),N()},l.appendChild(j)})}function N(){c.innerHTML="";let _=[];if(n.trim()!==""?Object.values(Te).forEach(V=>{let L=V.emails.filter(te=>te.name.toLowerCase().includes(n.toLowerCase()));_=[..._,...L]}):Te[t]&&(_=Te[t].emails),_.length===0){c.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let Z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',j='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';_.forEach(V=>{let L=document.createElement("div");Object.assign(L.style,m);let te=V.subject.length>50?V.subject.substring(0,50)+"...":V.subject;L.innerHTML=`

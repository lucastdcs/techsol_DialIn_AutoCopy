...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var pe=e=>new Promise(t=>setTimeout(t,e));function Re(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function it(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,a=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&a})}async function Vt(){let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(l=>l.innerText.trim()==="email");if(n&&n.offsetParent!==null){let l=n.closest("material-button")||n.closest("material-fab")||n;l.style&&(l.style.display="block",l.style.visibility="visible"),Re(l),e=!0}else{let l=document.querySelector("material-fab-speed-dial");if(l){let p=l.querySelector(".trigger");if(p){p.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Re(p),await pe(1e3);let A=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");A&&(Re(A),e=!0)}else l.click()}}let o=0,a=it();for(console.log("\u23F3 Aguardando editor EDIT\xC1VEL...");!a&&o<30;)await pe(500),a=it(),o++;if(!a)return oe("Erro: Editor de email n\xE3o apareceu.",{error:!0}),!1;let i=Array.from(document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]')).find(l=>l.offsetParent!==null);if(i){console.log("\u26A0\uFE0F Rascunho detectado. Clicando em Discard..."),Re(i);let l=null,p=0;for(;!l&&p<10;)await pe(200),l=Array.from(document.querySelectorAll('material-button[debug-id="confirm-button"]')).find(A=>A.offsetParent!==null),p++;l?(console.log("\u2705 Confirmando descarte..."),Re(l),await pe(2500)):console.warn("\u26A0\uFE0F Cliquei em Discard, mas o bot\xE3o Confirm n\xE3o apareceu.")}if(a){let l=a.closest('[id="email-body-content-top"]'),g=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(l){if(g){let u=g.closest('[aria-hidden="true"]');u&&u.removeAttribute("aria-hidden"),g.focus()}await pe(300),l.innerHTML=`
                <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                    <span id="cases-body-field"><br></span>
                </div>
            `;let A=l.querySelector("#cases-body-field");if(A){let u=document.createRange();u.selectNodeContents(A),u.collapse(!0);let O=window.getSelection();O.removeAllRanges(),O.addRange(u)}return!0}}return oe("Erro cr\xEDtico ao acessar editor.",{error:!0}),!1}async function $t(e){if(!e)return;oe("Preparando email...",{duration:3e3});let t=ht();if(!await Vt())return;await pe(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await pe(200),Re(o),await pe(1500);let a=document.querySelector("material-auto-suggest-input input");if(a){Re(a),await pe(200),document.execCommand("insertText",!1,e),a.dispatchEvent(new Event("input",{bubbles:!0}));let r=null,i=0;for(;i<20;){await pe(500),i++;let l=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(l.length>0&&(r=l.find(p=>p.innerText.toLowerCase().includes(e.toLowerCase())),!r&&l.length===1&&(r=l[0]),r))break}if(r){let l=function(u,O){if(u.nodeType===3&&u.nodeValue.includes(O))return u;if(!u.childNodes)return null;for(let h of u.childNodes){let f=l(h,O);if(f)return f}return null};Re(r),await pe(2e3);let p=it(),g=p?p.closest('[id="email-body-content-top"]'):document.body,A=l(g,"{%ADVERTISER_NAME%}");if(A){let u=document.createRange(),O=A.nodeValue.indexOf("{%ADVERTISER_NAME%}");u.setStart(A,O),u.setEnd(A,O+19);let h=window.getSelection();h.removeAllRanges(),h.addRange(u),document.execCommand("insertText",!1,t.advertiserName),oe("Email preenchido!")}else oe("Email inserido (Nome n\xE3o substitu\xEDdo).")}else oe(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else oe("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function St(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),oe("Preparando email...",{duration:3e3});let t=ht(),n=ft();if(!await Vt())return;await pe(600);let a=document.querySelector('input[aria-label="Subject"]');a&&e.subject&&(a.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(a,e.subject),a.dispatchEvent(new Event("input",{bubbles:!0})),await pe(300));let r=it();if(r){let l=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');l&&(l.focus(),l.click(),l.dispatchEvent(new Event("input",{bubbles:!0}))),await pe(400);let p=new Date;p.setDate(p.getDate()+3);let g=p.getDay();g===6?p.setDate(p.getDate()+2):g===0&&p.setDate(p.getDate()+1);let A=p.toLocaleDateString("pt-BR"),u=e.body;u=u.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),u=u.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),u=u.replace(/\[URL\]/g,t.websiteUrl||"seu site"),u=u.replace(/\[Seu Nome\]/g,n),u=u.replace(/\[MM\/DD\/YYYY\]/g,A),document.execCommand("insertHTML",!1,u),l&&(l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))),oe("Email preenchido com sucesso!",{duration:2e3}),await pe(800)}else oe("Erro ao focar no editor.",{error:!0})}var xo={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Ut={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Se(e,t,n,o,a,r){let i=document.createElement("div");Object.assign(i.style,xo),Bt(e,i);let l=document.createElement("div");Object.assign(l.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),i.appendChild(l),a&&(a.googleLine=l);let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center",gap:"12px"});let g=document.createElement("img");g.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(g.style,{width:"20px",height:"20px",pointerEvents:"none"});let A=document.createElement("span");A.textContent=t,p.appendChild(g),p.appendChild(A);let u=document.createElement("div");Object.assign(u.style,{display:"flex",alignItems:"center",gap:"4px"});let O='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',h='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',f=document.createElement("div");f.innerHTML=O,Object.assign(f.style,Ut),f.title="Sobre",f.classList.add("no-drag"),f.onmouseenter=()=>{f.style.background="rgba(255,255,255,0.1)",f.style.color="#FFF"},f.onmouseleave=()=>{f.style.color!=="rgb(138, 180, 248)"&&(f.style.background="transparent",f.style.color="#9AA0A6")};let x=document.createElement("div");x.innerHTML=h,Object.assign(x.style,Ut),x.title="Fechar",x.classList.add("no-drag"),x.onmouseenter=()=>{x.style.background="rgba(242, 139, 130, 0.2)",x.style.color="#F28B82"},x.onmouseleave=()=>{x.style.background="transparent",x.style.color="#9AA0A6"},x.onmousedown=q=>q.stopPropagation(),f.onmousedown=q=>q.stopPropagation(),x.onclick=r;let E=yo(e,t,n,o);return f.onclick=q=>{q.stopPropagation(),E.style.opacity==="1"?(E.style.opacity="0",E.style.pointerEvents="none",f.style.color="#9AA0A6",f.style.background="transparent"):(E.style.opacity="1",E.style.pointerEvents="auto",f.style.color="#8AB4F8",f.style.background="rgba(138, 180, 248, 0.1)")},u.appendChild(f),u.appendChild(x),i.appendChild(p),i.appendChild(u),i}function yo(e,t,n,o){let a=document.createElement("div");return Object.assign(a.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),a.innerHTML=`
    ...
    `,document.head.appendChild(e)}function Ce(e,t,n){let o=document.getElementById(n);if(!t)return;let a=t.getAttribute("data-moved")==="true",r={x:0,y:0};if(o){let A=o.getBoundingClientRect();r.x=A.left+A.width/2,r.y=A.top+A.height/2}let i,l;if(!a)i=window.innerWidth/2,l=window.innerHeight/2;else{let A=t.getBoundingClientRect();i=A.left+A.width/2,l=A.top+A.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let p=r.x-i,g=r.y-l;e?(K.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",a?t.style.transform=`translate(${p}px, ${g}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${g}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",a?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof Wt=="function"&&Wt(t,n)):(K.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",a?t.style.transform=`translate(${p}px, ${g}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${g}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Ct=="function"&&Ct(t))}function Wt(e,t){Ct(e);let n=o=>{if(!e.classList.contains("open"))return;let a=e.contains(o.target),r=document.querySelector(".cw-pill"),i=r&&r.contains(o.target);a?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function Ct(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var Kt="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",Et="cw_data_broadcast",Yt="cw_data_tips",vo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function Xt(e){return new Promise((t,n)=>{let o="cw_cb_"+Math.round(1e4*Math.random()),a=document.createElement("script");window[o]=r=>{document.body.removeChild(a),delete window[o],t(r)},a.src=`${Kt}?op=${e}&callback=${o}&t=${Date.now()}`,a.onerror=()=>{document.body.removeChild(a),delete window[o],n(new Error("JSONP Load Error"))},document.body.appendChild(a)})}var je={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await Xt("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(Yt,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await Xt("broadcast");if(e&&e.broadcast)return localStorage.setItem(Et,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(Et)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Et)||"[]"),getRandomTip:()=>{let e=vo,t=localStorage.getItem(Yt);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let o={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(Kt,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(o)}).catch(a=>console.log("Log fail",a))}};var ne={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},st=e=>new Promise(t=>setTimeout(t,e));function Qt(e){let t="cw-command-center-style";if(!document.getElementById(t)){let h=document.createElement("style");h.id=t,h.innerHTML=`
...
@keyframes googleBounce {
    ...
    `,e.appendChild(n);let o=Date.now();return e.classList.add("processing-center"),t&&t.classList.add("active"),function(){let r=Date.now()-o,i=Math.max(0,2e3-r);setTimeout(()=>{let l=n.querySelector(".cw-center-dots"),p=n.querySelector(".cw-center-text"),g=n.querySelector(".cw-center-success");l&&(l.style.display="none"),p&&(p.style.display="none"),g&&g.classList.add("show"),e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing-center"),setTimeout(()=>{n.remove(),e.classList.remove("success"),t&&t.classList.remove("active")},400)},1e3)},i)}}function Jt(e){let t=document.createElement("div");t.className="cw-step-scenarios";let n=document.createElement("div");Object.assign(n.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let o=document.createElement("div");Object.assign(o.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"40px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s ease"}),o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>";let a=null;Object.entries(we).forEach(([i,l])=>{let p=document.createElement("div");p.textContent=i,Object.assign(p.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",display:"flex",alignItems:"center",gap:"6px"}),p.onmouseenter=()=>{a!==l&&(o.style.background="#fff",o.style.borderColor="#1a73e8",o.style.color="#202124",o.textContent=`"${l.substring(0,120)}${l.length>120?"...":""}"`),a!==l&&(p.style.background="#f1f3f4")},p.onmouseleave=()=>{a!==l&&(a||(o.style.background="#f8f9fa",o.style.borderColor="#dadce0",o.style.color="#5f6368",o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>"),p.style.background="#ffffff")},p.onclick=()=>{K.playClick(),a===l?(a=null,r(),e("")):(a=l,r(),p.style.transform="scale(0.95)",setTimeout(()=>p.style.transform="scale(1)",150),e(l))},n.appendChild(p)});function r(){Array.from(n.children).forEach(i=>{we[i.textContent]===a?(i.style.background="#e8f0fe",i.style.borderColor="#1a73e8",i.style.color="#1967d2",i.style.fontWeight="500"):(i.style.background="#ffffff",i.style.borderColor="#dadce0",i.style.color="#3c4043",i.style.fontWeight="400")})}return t.appendChild(n),t.appendChild(o),t}var Zt=e=>new Promise(t=>setTimeout(t,e));function rt(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function Tt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{oe("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function to(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function eo(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function oo(){console.log("Iniciando processo de Nova Nota...");let e=eo(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(i=>i.innerText.trim()==="description");if(o){let i=o.closest("material-fab")||o.closest("material-button");i?(i.style&&(i.style.display="block",i.style.visibility="visible"),rt(i)):rt(o)}else{let i=document.querySelector("material-fab-speed-dial");if(i){let l=i.querySelector(".trigger");l?(l.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),rt(l)):i.click(),await Zt(800);let g=Array.from(document.querySelectorAll("i.material-icons-extended")).find(A=>A.innerText.trim()==="description");g&&rt(g)}}let a=null,r=0;for(;!a&&r<20;){await Zt(300);let i=eo();if(i.length>t)a=i.find(l=>!e.includes(l)),a||(a=i[i.length-1]);else if(r>10){let l=i.filter(p=>p.offsetParent!==null);l.length>0&&(a=l[l.length-1])}r++}return a}var P={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},Ee="cubic-bezier(0.25, 0.8, 0.25, 1)",Ao={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.bgInput,fontSize:"14px",color:P.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${Ee}, box-shadow 0.2s ${Ee}, background-color 0.2s`,outline:"none"},Xo={...Ao,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},Ko={fontSize:"13px",fontWeight:"700",color:P.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},Qo={display:"block",fontSize:"13px",fontWeight:"600",color:P.text,marginBottom:"8px",marginTop:"16px"},Jo={fontSize:"12px",color:P.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},Zo={fontSize:"12px",color:P.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},en={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:P.text,cursor:"pointer",padding:"12px 14px",backgroundColor:P.surface,border:`1px solid ${P.border}`,borderRadius:"12px",transition:`all 0.2s ${Ee}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},kt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:P.primary},tn={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:P.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${Ee}, box-shadow 0.2s ${Ee}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},on={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${P.primary}`,color:P.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${Ee}`},nn={background:"transparent",border:`1px solid ${P.border}`,borderRadius:"20px",color:P.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${Ee}`,fontFamily:"'Google Sans', 'Roboto'"};var an={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:P.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},sn={fontSize:"13px",fontWeight:"700",color:P.primary,minWidth:"20px",textAlign:"center"},rn={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${P.border}`,backgroundColor:P.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${Ee}, box-shadow 0.2s ${Ee}`},ln={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${P.bgInput}`},cn={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${P.border}`,backgroundColor:P.surface,color:P.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${Ee}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},dn={backgroundColor:P.primaryBg,color:P.primary,borderColor:P.primary,fontWeight:"600"},pn={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:P.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},un={borderTop:`1px solid ${P.bgInput}`,paddingTop:"20px",marginTop:"16px"};var mn={maxHeight:"240px",overflowY:"auto",border:`1px solid ${P.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:P.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},gn={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${P.bgInput}`,cursor:"pointer",fontSize:"13px",color:P.text,transition:"background 0.1s",userSelect:"none"};var wo={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},So={fontSize:"12px",color:"#e37400",marginTop:"4px"},Co={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},Eo={display:"flex",gap:"15px",marginBottom:"10px"};function no(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,wo);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,vt,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,Eo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,kt);let a=document.createElement("label");a.textContent="Sim";let r=document.createElement("div");Object.assign(r.style,{display:"flex",alignItems:"center"}),r.appendChild(o),r.appendChild(a);let i=document.createElement("input");i.type="radio",i.name="ts_usage_mod",i.value="N\xE3o",i.checked=!0,Object.assign(i.style,kt);let l=document.createElement("label");l.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(i),p.appendChild(l),n.appendChild(r),n.appendChild(p);let g=document.createElement("div");g.style.display="block";let A=document.createElement("label");A.textContent="Qual foi o Motivo?",Object.assign(A.style,vt,{fontSize:"12px"});let u=document.createElement("input");u.type="text",Object.assign(u.style,Co);let O=document.createElement("div");O.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(O.style,So),g.appendChild(A),g.appendChild(u),g.appendChild(O),e.appendChild(t),e.appendChild(n),e.appendChild(g),o.onchange=()=>{g.style.display="none"},i.onchange=()=>{g.style.display="block"};function h(E,q){if(e.style.display="none",!E||E.includes("Education")||!q||q.length===0)return;let _=q.some(s=>s.includes("enhanced")||s==="ec_google_ads"),B=q.some(s=>(s.includes("conversion")||s.includes("ads"))&&!s.includes("enhanced")),V=q.some(s=>s.includes("ga4")||s.includes("analytics")||s.includes("ua")),m=q.some(s=>s.includes("merchant")||s.includes("gmc")||s.includes("shopping"));(_||B&&!V&&!m)&&(e.style.display="block")}function f(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return i.checked&&u.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${u.value}`),E+="<br>",E}function x(){e.style.display="none",i.checked=!0,o.checked=!1,g.style.display="block",u.value=""}return{element:e,updateVisibility:h,getOutput:f,reset:x}}var G={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Pe={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function ao(e){let t={},n="implementation";function o(m){let b=m.toLowerCase();return b.includes("ads")||b.includes("conversion")||b.includes("remarketing")?G.brands.ads:b.includes("ga4")||b.includes("analytics")?G.brands.ga4:b.includes("gtm")||b.includes("tag manager")||b.includes("container")?G.brands.gtm:b.includes("merchant")||b.includes("shopping")||b.includes("feed")?G.brands.gmc:G.brands.default}let a=Object.entries(_e).filter(([m,b])=>b.popular),r={};Object.entries(_e).forEach(([m,b])=>{if(b.popular)return;let s=o(b.name);r[s.label]||(r[s.label]={brand:s,tasks:[]}),r[s.label].tasks.push({key:m,...b})});let i="cw-zen-tasks";if(!document.getElementById(i)){let m=document.createElement("style");m.id=i,m.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let A=l.querySelector(".cw-hero-grid"),u=l.querySelector(".cw-acc-container"),O=l.querySelector(".cw-results-container"),h=l.querySelector(".cw-search-input"),f=l.querySelector(".cw-status-bar"),x=l.querySelector(".cw-status-text"),E=l.querySelector(".cw-footer-icons");a.forEach(([m,b])=>{let s=o(b.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${m}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let d=t[m]?t[m].count:0;_(m,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>_(m,-1,b),c.querySelector(".plus").onclick=()=>_(m,1,b),c.dataset.color=s.color,A.appendChild(c)});function q(m,b){let s=o(b.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=m,c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let d=t[m]?t[m].count:0;_(m,d>0?-d:1,b)},c.querySelector(".minus").onclick=()=>_(m,-1,b),c.querySelector(".plus").onclick=()=>_(m,1,b),c}Object.entries(r).forEach(([m,b])=>{let s=document.createElement("div");s.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${b.brand.color}"></div>
                ${m}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{u.querySelectorAll(".cw-acc-group.open").forEach(d=>{d!==s&&d.classList.remove("open")}),s.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",b.tasks.forEach(d=>{let y=q(d.key,d);w.appendChild(y)}),s.appendChild(c),s.appendChild(w),u.appendChild(s)});function _(m,b,s){t[m]||(t[m]={count:0,data:s,brand:o(s.name)}),t[m].count+=b,t[m].count<=0&&delete t[m],B(),V(),e&&e()}function B(){a.forEach(([w])=>{let d=A.querySelector(`#hero-${w}`);if(!d)return;let y=t[w];y?(d.classList.add("active"),d.querySelector(".cw-step-val").textContent=y.count,d.querySelector(".cw-step-val").style.color=d.dataset.color):d.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(w=>{let d=w.dataset.id,y=t[d];y?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=y.count):w.classList.remove("selected")});let b=Object.keys(t),s=0,c=[];if(b.forEach(w=>{let d=t[w];s+=d.count;for(let y=0;y<d.count;y++)c.length<6&&c.push(d.brand)}),s>0){f.classList.add("visible");let w=s>1?"A\xE7\xF5es":"A\xE7\xE3o",d=s>1?"definidas":"definida";x.textContent=`${s} ${w} ${d}`,E.innerHTML="",c.forEach(y=>{let k=document.createElement("div");k.className="cw-mini-icon",k.innerHTML=Pe[y.icon]||Pe.default;let v=k.querySelector("svg");v&&(v.style.width="14px",v.style.height="14px"),E.appendChild(k)})}else f.classList.remove("visible")}h.addEventListener("input",m=>{let b=m.target.value.toLowerCase();if(b.length>0){u.style.display="none",O.style.display="block",O.innerHTML="";let s=!1;Object.entries(_e).forEach(([c,w])=>{if(w.name.toLowerCase().includes(b)){s=!0;let d=q(c,w);t[c]&&(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=t[c].count),O.appendChild(d)}}),s||(O.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else u.style.display="block",O.style.display="none"});function V(){g.innerHTML="";let m=Object.keys(t),b=!1,s=document.getElementById("sub-status"),c="implementation";if(s&&s.value.toLowerCase().includes("education")&&(c="education"),m.length===0){g.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(m.length===0){g.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`

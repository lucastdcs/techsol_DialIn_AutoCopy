...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var be=e=>new Promise(t=>setTimeout(t,e));function we(e,t="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,n[t]||n.info)}function Oe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function rt(e,t){if(!e)return;let n=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=e.getBoundingClientRect(),a=document.createElement("div");a.id=n,a.style.cssText=`
    ...
    `,a.innerHTML=`
        ...
        ">\xD7</div>
    `;let i=a.querySelector(".cw-close-btn");i.onclick=()=>{a.style.opacity="0",a.style.transform="translateY(-5px)",setTimeout(()=>a.remove(),300)},document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(a)&&i.click()},25e3)}async function lt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await be(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await be(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function Ot(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(n=>{let o=n.offsetParent!==null,s=n.closest("case-message-view")!==null,a=n.closest(".editor")!==null||n.closest("write-card")!==null;return o&&!s&&a});return t&&we("Editor visualmente detectado.","success"),t}async function to(){we("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(l=>l.innerText.trim()==="email");if(n&&n.offsetParent!==null){we("Bot\xE3o de email direto encontrado.");let l=n.closest("material-button")||n.closest("material-fab")||n;Oe(l),e=!0}else{we("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let l=document.querySelector("material-fab-speed-dial");if(l){let u=l.querySelector(".trigger");if(u){Oe(u),await be(800);let d=Array.from(document.querySelectorAll("i.material-icons-extended")).find(E=>E.innerText.trim()==="email");d&&(Oe(d),e=!0)}}}if(!e)return oe("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;we("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,s=0,a=20;for(;s<a;){await be(250);let l=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(l).find(u=>u.offsetParent!==null),o){we("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(o){we("\u{1F5D1}\uFE0F Descartando..."),Oe(o),o.click();let l=null,u=0;for(;u<15;){await be(300);let b=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(l=Array.from(b).find(d=>d.offsetParent!==null),l)break;u++}l&&(Oe(l),oe("Limpando rascunho antigo...",{duration:2e3}),await be(2500))}we("\u{1F680} FASE 3: Buscando editor final...");let i=0,r=null;for(;i<20&&(r=Ot(),!r);)await be(250),i++;if(!r)return oe("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let c=r.closest('[id="email-body-content-top"]'),g=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(c){if(g){let u=g.closest('[aria-hidden="true"]');u&&u.removeAttribute("aria-hidden"),g.focus(),Oe(g)}await be(300),c.innerHTML=`
    ...
    `,document.head.appendChild(e)}function Ie(e,t,n){let o=document.getElementById(n);if(!t)return;let s=t.getAttribute("data-moved")==="true",a={x:0,y:0};if(o){let g=o.getBoundingClientRect();a.x=g.left+g.width/2,a.y=g.top+g.height/2}let i,r;if(!s)i=window.innerWidth/2,r=window.innerHeight/2;else{let g=t.getBoundingClientRect();i=g.left+g.width/2,r=g.top+g.height/2,i===0&&r===0&&(i=window.innerWidth/2,r=window.innerHeight/2)}let c=a.x-i,f=a.y-r;e?(ae.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",s?t.style.transform=`translate(${c}px, ${f}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${f}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",s?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof ao=="function"&&ao(t,n)):(ae.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",s?t.style.transform=`translate(${c}px, ${f}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${f}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof qt=="function"&&qt(t))}function ao(e,t){qt(e);let n=o=>{if(!e.classList.contains("open"))return;let s=e.contains(o.target),a=document.querySelector(".cw-pill"),i=a&&a.contains(o.target);s?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function qt(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var qo="https://script.google.com/a/macros/google.com/s/AKfycbysAGOgn40LEQ1uJIppENtTGNSRscLRQkGA96UPYTDDbA0c_KhVUwDQ-Do8ZQ7lQizo/exec",It="cw_data_broadcast",io="cw_data_tips",Io=["Processando...","Mantenha o foco!","Aguarde..."];function Nt(e,t={}){return new Promise((n,o)=>{let s="cw_cb_"+Math.round(1e5*Math.random()),a=document.createElement("script");window[s]=c=>{document.body.contains(a)&&document.body.removeChild(a),delete window[s],n(c)};let i=Object.keys(t).map(c=>encodeURIComponent(c)+"="+encodeURIComponent(t[c])).join("&"),r=`${qo}?op=${e}&callback=${s}&t=${Date.now()}&${i}`;a.src=r,a.onerror=()=>{document.body.contains(a)&&document.body.removeChild(a),delete window[s],o(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(a)})}var Ae={fetchTips:async()=>{try{let e=await Nt("tips");e?.tips&&localStorage.setItem(io,JSON.stringify(e.tips))}catch(e){console.warn("Tips offline",e)}},fetchData:async()=>{try{let e=await Nt("broadcast");if(e?.broadcast)return localStorage.setItem(It,JSON.stringify(e.broadcast)),e}catch(e){console.warn("Broadcast offline",e)}return{broadcast:JSON.parse(localStorage.getItem(It)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(It)||"[]"),getRandomTip:()=>{let e=Io,t=localStorage.getItem(io);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},sendBroadcast:async e=>{let t={...e,date:new Date().toISOString(),id:Date.now().toString()};return await Ae._performOp("new_broadcast",t)},updateBroadcast:async(e,t)=>{let n={id:e,...t};return await Ae._performOp("update_broadcast",n)},deleteBroadcast:async e=>await Ae._performOp("delete_broadcast",{id:e}),_performOp:async(e,t)=>{try{console.log(`\u{1F4E4} Executando ${e}...`,t);let n=await Nt(e,t);return n&&n.status==="success"?(console.log("\u2705 Sucesso:",e),!0):(console.warn("\u26A0\uFE0F Falha:",n),!1)}catch(n){return console.error("\u274C Erro JSONP:",n),!1}},logUsage:()=>{}};var pe={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},dt=e=>new Promise(t=>setTimeout(t,e));function so(e){let t="cw-command-center-style";if(!document.getElementById(t)){let b=document.createElement("style");b.id=t,b.innerHTML=`
            ...
            .cw-btn.broadcast.active { color: ${pe.orange} !important; background: rgba(249, 171, 0, 0.15); } /* NOVO */
            ...
            .cw-btn.broadcast:hover { color: ${pe.orange}; filter: drop-shadow(0 0 5px rgba(249, 171, 0, 0.5)); } /* NOVO */
...
@keyframes googleBounce {
    ...
    `;let s=document.createElement("div");if(s.className="cw-focus-backdrop",document.body.appendChild(s),document.body.appendChild(o),o.querySelector(".notes").onclick=b=>{b.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=b=>{b.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=b=>{b.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=b=>{b.stopPropagation(),e.toggleLinks()},o.querySelector(".broadcast").onclick=b=>{b.stopPropagation();let d=b.currentTarget.querySelector(".cw-badge");d&&(d.style.transform="scale(0)",setTimeout(()=>d.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let b=document.createElement("div");b.className="cw-badge",o.querySelector(".broadcast").appendChild(b)}(async function(){await dt(2800),o.classList.add("docked"),await dt(300);let d=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(y=>y.classList.add("visible"));for(let y=0;y<d.length;y++)d[y].classList.add("popped"),await dt(90);await dt(200),o.classList.add("system-check")})();let a=!1,i,r,c,f,g=3;o.onmousedown=b=>{if(b.target.closest("button"))return;b.preventDefault(),i=b.clientX,r=b.clientY;let d=o.getBoundingClientRect();c=d.left,f=d.top,document.addEventListener("mousemove",l),document.addEventListener("mouseup",u)};function l(b){let d=b.clientX-i,E=b.clientY-r;!a&&Math.sqrt(d*d+E*E)>g&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${c+d}px`,o.style.top=`${f+E}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function u(b){if(document.removeEventListener("mousemove",l),document.removeEventListener("mouseup",u),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let d=window.innerWidth,E=window.innerHeight,y=o.getBoundingClientRect(),R=y.left+y.width/2,P;R<d/2?(P=24,o.classList.remove("side-right"),o.classList.add("side-left")):(P=d-y.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let Y=y.top;Y<24&&(Y=24),Y>E-y.height-24&&(Y=E-y.height-24),o.style.left=`${P}px`,o.style.top=`${Y}px`}else{let d=b.target.closest("button");d&&(d.style.transform="scale(0.9)",setTimeout(()=>d.style.transform="",150))}}}function pt(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let n=document.createElement("div");n.className="cw-center-stage",n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(v)}let r=document.createElement("div");r.className="cw-zen-container";let c=document.createElement("div");Object.assign(c.style,{display:"none"});let f=document.createElement("div");f.className="cw-screens-container",c.appendChild(f),r.innerHTML=`
    ...
    `;let g=r.querySelector(".cw-hero-grid"),l=r.querySelector(".cw-acc-container"),u=r.querySelector(".cw-results-container"),b=r.querySelector(".cw-search-input"),d=r.querySelector(".cw-status-bar"),E=r.querySelector(".cw-status-text"),y=r.querySelector(".cw-footer-icons");s.forEach(([v,m])=>{let h=o(m.name),w=document.createElement("div");w.className="cw-hero-card",w.id=`hero-${v}`,w.style.setProperty("--hero-color",h.color),w.innerHTML=`
        ...
        `,w.onclick=T=>{if(T.target.closest(".cw-step-btn"))return;let C=t[v]?t[v].count:0;P(v,C>0?-C:1,m)},w.querySelector(".minus").onclick=()=>P(v,-1,m),w.querySelector(".plus").onclick=()=>P(v,1,m),w.dataset.color=h.color,g.appendChild(w)});function R(v,m){let h=o(m.name),w=document.createElement("div");return w.className="cw-task-item",w.dataset.id=v,w.innerHTML=`
        ...
        `,w.onclick=T=>{if(T.target.closest(".cw-step-btn"))return;let C=t[v]?t[v].count:0;P(v,C>0?-C:1,m)},w.querySelector(".minus").onclick=()=>P(v,-1,m),w.querySelector(".plus").onclick=()=>P(v,1,m),w}Object.entries(a).forEach(([v,m])=>{let h=document.createElement("div");h.className="cw-acc-group";let w=document.createElement("div");w.className="cw-acc-header",w.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${m.brand.color}"></div>
                ${v}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,w.onclick=()=>{l.querySelectorAll(".cw-acc-group.open").forEach(C=>{C!==h&&C.classList.remove("open")}),h.classList.toggle("open")};let T=document.createElement("div");T.className="cw-acc-body",m.tasks.forEach(C=>{let D=R(C.key,C);T.appendChild(D)}),h.appendChild(w),h.appendChild(T),l.appendChild(h)});function P(v,m,h){t[v]||(t[v]={count:0,data:h,brand:o(h.name)}),t[v].count+=m,t[v].count<=0&&delete t[v],Y(),ie(),e&&e()}function Y(){s.forEach(([T])=>{let C=g.querySelector(`#hero-${T}`);if(!C)return;let D=t[T];D?(C.classList.add("active"),C.querySelector(".cw-step-val").textContent=D.count,C.querySelector(".cw-step-val").style.color=C.dataset.color):C.classList.remove("active")}),r.querySelectorAll(".cw-task-item").forEach(T=>{let C=T.dataset.id,D=t[C];D?(T.classList.add("selected"),T.querySelector(".cw-step-val").textContent=D.count):T.classList.remove("selected")});let m=Object.keys(t),h=0,w=[];if(m.forEach(T=>{let C=t[T];h+=C.count;for(let D=0;D<C.count;D++)w.length<6&&w.push(C.brand)}),h>0){d.classList.add("visible");let T=h>1?"A\xE7\xF5es":"A\xE7\xE3o",C=h>1?"definidas":"definida";E.textContent=`${h} ${T} ${C}`,y.innerHTML="",w.forEach(D=>{let F=document.createElement("div");F.className="cw-mini-icon",F.innerHTML=Ue[D.icon]||Ue.default;let N=F.querySelector("svg");N&&(N.style.width="14px",N.style.height="14px"),y.appendChild(F)})}else d.classList.remove("visible")}b.addEventListener("input",v=>{let m=v.target.value.toLowerCase();if(m.length>0){l.style.display="none",u.style.display="block",u.innerHTML="";let h=!1;Object.entries(De).forEach(([w,T])=>{if(T.name.toLowerCase().includes(m)){h=!0;let C=R(w,T);t[w]&&(C.classList.add("selected"),C.querySelector(".cw-step-val").textContent=t[w].count),u.appendChild(C)}}),h||(u.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else l.style.display="block",u.style.display="none"});function ie(){f.innerHTML="";let v=Object.keys(t),m=!1,h=document.getElementById("sub-status"),w="implementation";if(h&&h.value.toLowerCase().includes("education")&&(w="education"),v.length===0){f.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(v.length===0){f.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let T=document.createElement("div");T.className="cw-info-banner",T.innerHTML=`
...
`).filter(W=>W.trim()!=="").map(W=>`<p style="margin: 0 0 8px 0;">${W}</p>`).join(""):J.tagName==="TEXTAREA"&&(Z=Z.replace(/\n/g,"<br>"));let ue=Z.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ue===""||ue==="\u2022"||ue.toLowerCase()==="n/a"){let W=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${V}\\}(?:<br>\\s*)?`,"gi");W.test(q)?q=q.replace(W,""):q=q.replace(z,"")}else q=q.replace(z,Z.replace(/\$/g,"$$$$"))}),q=q.replace(/{([A-Z0-9_]+)}/g,""),q=q.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(q+=i.getOutput()),q}Ze.onclick=()=>{let k=Ft();k?(Mt(k),oe(X("copiado_sucesso"))):oe(X("selecione_substatus"),{error:!0})},Je.onclick=async()=>{let k=N.value,H=Ft();if(!H){oe(X("selecione_substatus"),{error:!0});return}Mt(H),vt();let q=pt(),K=await uo();if(K)try{if(K.focus(),K.innerHTML.trim()==="<p><br></p>"||K.innerHTML.trim()==="<br>"||K.innerText.trim()===""){let ge=document.createRange();ge.selectNodeContents(K);let ne=window.getSelection();ne.removeAllRanges(),ne.addRange(ge),document.execCommand("delete",!1,null)}else if(!K.innerHTML.endsWith("<br><br>")){let ge=document.createRange();ge.selectNodeContents(K),ge.collapse(!1);let ne=window.getSelection();ne.removeAllRanges(),ne.addRange(ge),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,H),po(K),setTimeout(()=>{oe(X("inserido_copiado"))},600);let me=typeof je<"u"&&je?je.checked:!0;if(k&&$e[k]&&me){let ge=$e[k];await ct(ge),await new Promise(ne=>setTimeout(ne,500))}q(),yt(1.5),T.value="",N.innerHTML=`<option value="">${X("select_substatus")}</option>`,N.disabled=!0}catch(de){console.error(de),oe("Erro ao inserir.",{error:!0}),q()}};function yt(k=1.5){k<=1.5&&(Ee.style.display="none",Ce.innerHTML=""),k<=2&&(r.reset(),xe.style.display="none"),k<=3&&(he.style.display="none",Fe.innerHTML="",i.reset(),Ye.style.display="none",Be.style.display="none")}function vt(){if(s=!s,s){let k=c.querySelector(".cw-expand-btn");k&&typeof k.resetState=="function"&&k.resetState()}Ie(s,c,"cw-btn-notes")}return bt("bau"),ft("pt"),vt}var We={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
        ...
        `;let I=N.querySelector("#csa-back-btn");I.onmouseenter=()=>I.style.background="#f1f3f4",I.onmouseleave=()=>I.style.background="none",I.onclick=x;let L=N.querySelector("#csa-insert-btn");L.onmouseenter=()=>{L.style.transform="translateY(-1px)",L.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},L.onmouseleave=()=>{L.style.transform="translateY(0)",L.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},L.onclick=()=>{L.style.transform="scale(0.96)",ee(M,"email"),setTimeout(()=>{L.style.transform="scale(1)",x()},300)}}function x(){s="list",m.style.transform="translateX(0)"}function A(M,j,_=null){let I=document.createElement("button"),L=_?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${_}</span>`:"";return I.innerHTML=`${L}${M}`,Object.assign(I.style,b),n===j&&o===""?Object.assign(I.style,d):(I.onmouseenter=()=>{I.style.background="#F1F3F4",I.style.borderColor="#DADCE0"},I.onmouseleave=()=>{I.style.background="#FFFFFF",I.style.borderColor="#DADCE0"}),I.onclick=()=>{n=j,o="",T.value="",S(),G()},I}function S(){C.innerHTML="",C.appendChild(A("Smart CRs",t,"\u26A1")),Object.keys(We).forEach(M=>{C.appendChild(A(We[M].title,M))})}function G(){D.innerHTML="";let M=[];if(o.trim()!==""){let $=o.toLowerCase();Object.values(We).forEach(O=>{O.emails.forEach(B=>{(B.name.toLowerCase().includes($)||B.subject.toLowerCase().includes($))&&M.push({type:"email",data:B})})}),Object.entries($e).forEach(([O,B])=>{if(!B)return;(O.replace(/_/g," ").toLowerCase().includes($)||B.toLowerCase().includes($))&&M.push({type:"cr",key:O,code:B})})}else n===t?Object.entries($e).forEach(([$,O])=>{O&&M.push({type:"cr",key:$,code:O})}):We[n]&&We[n].emails.forEach($=>{M.push({type:"email",data:$})});if(M.length===0){D.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function xo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",a=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Te,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:i,googleLine:null};function c(){a=!a,Ie(a,i,"cw-btn-script")}let f=qe(i,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{c()});i.appendChild(f);let g=document.createElement("div");Object.assign(g.style,t.progressBarContainer);let l=document.createElement("div");Object.assign(l.style,t.progressBarFill),g.appendChild(l),i.appendChild(g);let u=document.createElement("div");u.id="csa-content",Object.assign(u.style,t.contentArea),i.appendChild(u);let b=document.createElement("div");Object.assign(b.style,t.footer);let d=document.createElement("span");d.textContent="by lucaste@",Object.assign(d.style,{fontSize:"10px",color:"#bdc1c6"});let E=document.createElement("button");E.innerHTML=`
  ...
  `,Object.assign(E.style,t.resetBtn),E.onmouseenter=()=>E.style.background="#fce8e6",E.onmouseleave=()=>E.style.background="transparent",E.onclick=()=>{E.style.transform="scale(0.9)",setTimeout(()=>E.style.transform="scale(1)",150);for(let F in n)delete n[F];w()},b.appendChild(d),b.appendChild(E),i.appendChild(b);let y=document.createElement("div");Object.assign(y.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let R=document.createElement("div");Object.assign(R.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let P=document.createElement("div");P.textContent="BAU";let Y=document.createElement("div");Y.textContent="LT",Object.assign(P.style,ve),Object.assign(Y.style,ve),R.appendChild(P),R.appendChild(Y);let ie=document.createElement("select");Object.assign(ie.style,Xt,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),ie.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',ie.value=o,y.appendChild(R),y.appendChild(ie),u.appendChild(y);let v=document.createElement("div");v.id="csa-checklist-area",u.appendChild(v);let m=document.createElement("div");Object.assign(m.style,Xe),m.className="no-drag",m.title="Redimensionar",i.appendChild(m),Ke(i,m),document.body.appendChild(i);function h(F){return F}function w(){v.innerHTML="";let F=`${o} ${s}`,N=ho[F];if(!N){v.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
      ...
      `,document.head.appendChild(p)}let a={feedContainer:{padding:"20px 24px 80px 24px",overflowY:"auto",flexGrow:"1",background:"#F8F9FA",display:"flex",flexDirection:"column",gap:"20px"},card:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.12)",boxShadow:"0 4px 12px rgba(60,64,67,0.08)",overflow:"hidden",transition:"all 0.3s ease",position:"relative",width:"100%",boxSizing:"border-box",flexShrink:"0"},cardHeader:{padding:"16px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid #F1F3F4"},typeTag:{display:"flex",alignItems:"center",gap:"6px",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",letterSpacing:"0.6px",padding:"4px 8px",borderRadius:"6px"},dateTag:{fontSize:"11px",color:"#5f6368",fontWeight:"500"},cardContent:{padding:"16px 20px 20px 20px"},msgTitle:{fontSize:"16px",fontWeight:"700",color:"#202124",marginBottom:"8px",lineHeight:"1.4"},msgBody:{fontSize:"14px",color:"#3c4043",lineHeight:"1.6",whiteSpace:"pre-wrap",wordBreak:"break-word"},msgMeta:{fontSize:"11px",color:"#9aa0a6",marginTop:"12px",display:"flex",alignItems:"center",gap:"6px"},dismissBtn:{width:"28px",height:"28px",borderRadius:"50%",border:"1px solid rgba(0,0,0,0.1)",background:"#fff",color:"#5f6368",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s ease",marginLeft:"12px"},bauContainer:{margin:"16px 24px 0 24px",padding:"16px",background:"#F3E8FD",border:"1px solid #D8B4FE",borderRadius:"16px",display:"flex",flexDirection:"column",gap:"12px",boxShadow:"0 4px 12px rgba(147, 51, 234, 0.1)"},bauHeader:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"2px"},bauLabel:{fontSize:"11px",fontWeight:"800",color:"#7E22CE",textTransform:"uppercase",letterSpacing:"0.8px"},liveIndicator:{display:"flex",alignItems:"center",gap:"8px"},pulseDot:{width:"8px",height:"8px",borderRadius:"50%",background:"#9333EA",boxShadow:"0 0 0 0 rgba(147, 51, 234, 0.7)",animation:"cw-pulse 2s infinite"},bauSlotRow:{display:"flex",alignItems:"center",gap:"10px",padding:"8px 12px",background:"rgba(255,255,255,0.5)",borderRadius:"8px",marginBottom:"4px"},bauFlag:{fontSize:"18px",lineHeight:"1"},bauDate:{fontSize:"16px",fontWeight:"700",color:"#581C87",letterSpacing:"-0.5px"},emptyState:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"60px 0",color:"#BDC1C6",gap:"16px",textAlign:"center"},historyDivider:{display:"flex",alignItems:"center",justifyContent:"center",margin:"20px 0",cursor:"pointer",color:"#1a73e8",fontSize:"13px",fontWeight:"500",gap:"8px",padding:"8px 16px",borderRadius:"20px",background:"#E8F0FE"},historyContainer:{display:"none",flexDirection:"column",gap:"16px",opacity:"0.8"}},i={critical:{color:"#991B1B",bg:"#FEF2F2",icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>'},info:{color:"#1E40AF",bg:"#EFF6FF",icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>'},success:{color:"#166534",bg:"#F0FDF4",icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>'}};function r(p){return p?Object.entries(p).map(([x,A])=>`${x.replace(/[A-Z]/g,S=>"-"+S.toLowerCase())}:${A}`).join(";"):""}function c(p){if(!p||typeof p!="string")return"";let x=p;return x=x.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" style="color:#1967d2; text-decoration:none; font-weight:500;">$1</a>'),x=x.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),x=x.replace(/_(.*?)_/g,"<i>$1</i>"),x=x.replace(/\n/g,"<br>"),x=Qt(x),x}let f=document.createElement("div");f.id="broadcast-popup",f.classList.add("cw-module-window"),Object.assign(f.style,Te,{right:"auto",left:"50%",width:"420px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",backgroundColor:"#FAFAFA",overflow:"hidden"});let g={popup:f,googleLine:null};function l(){if(t=!t,Ie(t,f,"cw-btn-broadcast"),t){let p=document.getElementById("cw-btn-broadcast");p&&p.classList.remove("has-new"),h()}}let u=qe(f,"Central de Avisos",e,"Comunica\xE7\xE3o oficial da opera\xE7\xE3o.",g,()=>l()),b=u.querySelector(".cw-header-actions")||u.lastElementChild,d=null;function E(){let p=null;try{p=jt()}catch{console.warn("TechSol: Auth Pending")}if(p){let x=p.split("@")[0].toLowerCase(),A=Fo.includes(x);if(window._cwIsAdmin=A,window._cwCurrentUser=x,A&&b&&!b.querySelector("#cw-admin-btn")){let S=document.createElement("div");S.id="cw-admin-btn",S.className="cw-btn-interactive",S.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',Object.assign(S.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#1a73e8",background:"rgba(26, 115, 232, 0.1)",marginRight:"8px"}),S.title="Novo Aviso",S.onclick=G=>{G.stopPropagation(),P()},b.insertBefore(S,b.firstChild),d||R(),T()}}else window._cwAdminRetries||(window._cwAdminRetries=0),window._cwAdminRetries<5&&(window._cwAdminRetries++,setTimeout(E,2e3))}if(b){let p=document.createElement("button");p.textContent="Limpar",p.className="cw-btn-interactive",Object.assign(p.style,{fontSize:"12px",color:"#1a73e8",background:"transparent",border:"none",padding:"8px",fontWeight:"600"}),p.onclick=x=>{x.stopPropagation(),ae.playSuccess();let A=Ge.map(S=>S.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(A)),T(),w()},b.insertBefore(p,b.firstChild)}f.appendChild(u);let y=document.createElement("div");y.id="cw-update-status",y.style.cssText="padding: 8px; text-align: center; font-size: 11px; color: #5f6368; background: #FAFAFA; border-bottom: 1px solid transparent; font-weight:500; display:none;",f.appendChild(y);function R(){d=document.createElement("div"),d.className="cw-editor-overlay",d.innerHTML=`
      ...
      `,d.querySelectorAll('input[name="cw-bc-type"]').forEach(S=>{S.addEventListener("change",()=>{d.querySelectorAll(".cw-radio-option").forEach(G=>G.classList.remove("checked")),S.parentElement.classList.add("checked")})}),setTimeout(()=>{let S=d.querySelector(".cw-radio-option.info");S&&S.classList.add("checked")},100);let p=d.querySelector("#cw-bc-cancel"),x=d.querySelector("#cw-bc-close-x"),A=d.querySelector("#cw-bc-send");p.onclick=Y,x.onclick=Y,A.onclick=ie,f.appendChild(d)}function P(p=null){if(!d)return;let x=d.querySelector("#cw-editor-title-label"),A=d.querySelector("#cw-bc-title"),S=d.querySelector("#cw-bc-text"),G=d.querySelector("#cw-bc-send");if(p){o=p.id,x.textContent="Editar Aviso",A.value=p.title||"",S.value=p.text||"",G.textContent="Salvar Altera\xE7\xF5es";let M=p.type||"info",j=d.querySelector(`input[name="cw-bc-type"][value="${M}"]`);j&&j.click()}else{o=null,x.textContent="Novo Aviso",A.value="",S.value="",G.textContent="Publicar";let M=d.querySelector('input[name="cw-bc-type"][value="info"]');M&&M.click()}d.classList.add("active"),setTimeout(()=>A.focus(),300)}function Y(){d&&d.classList.remove("active"),o=null}async function ie(){let p=d.querySelector("#cw-bc-send"),x=d.querySelector("#cw-bc-title"),A=d.querySelector("#cw-bc-text"),S=d.querySelector('input[name="cw-bc-type"]:checked'),G=S?S.value:"info";if(!x.value.trim()||!A.value.trim()){oe("Preencha todos os campos!",{error:!0});return}p.textContent="Salvando...",p.style.opacity="0.7";let M=!1;o?M=await Ae.updateBroadcast(o,{title:x.value,text:A.value,type:G}):M=await Ae.sendBroadcast({title:x.value,text:A.value,type:G,author:window._cwCurrentUser||"admin"}),M?(oe(o?"Atualizado!":"Publicado!"),ae.playSuccess(),Y(),setTimeout(()=>h(),1500)):(oe("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),p.textContent=o?"Salvar Altera\xE7\xF5es":"Publicar",p.style.opacity="1")}async function v(p){if(confirm("Confirma a exclus\xE3o deste aviso?"))if(await Ae.deleteBroadcast(p)){oe("Aviso removido."),ae.playClick();let A=Ge.findIndex(S=>S.id===p);A>-1&&Ge.splice(A,1),T(),setTimeout(()=>h(),1500)}else oe("Erro ao excluir.",{error:!0})}let m=document.createElement("div");m.className="cw-nice-scroll",Object.assign(m.style,a.feedContainer),f.appendChild(m);async function h(){t&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let p=await Ae.fetchData();p&&p.broadcast&&(Lt(p.broadcast),w(),t&&(T(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{t&&(y.innerHTML="\u26A0\uFE0F Offline")}}function w(){let p=document.getElementById("cw-btn-broadcast");if(!p)return;let x=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Ge.some(S=>!x.includes(S.id))){if(p.classList.add("has-new"),!p.querySelector(".cw-badge")){let S=document.createElement("div");S.className="cw-badge",Object.assign(S.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),p.appendChild(S)}}else{p.classList.remove("has-new");let S=p.querySelector(".cw-badge");S&&S.remove()}}function T(){m.innerHTML="";let p=f.querySelector("#cw-bau-widget");p&&p.remove();let x=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),A=[...Ge].sort((_,I)=>{let L=new Date(_.date).getTime()||0;return(new Date(I.date).getTime()||0)-L}),S=A.findIndex(_=>_.title&&_.title.toLowerCase().includes("disponibilidade bau"));if(S!==-1){let _=A[S];A.splice(S,1);let I=document.createElement("div");I.id="cw-bau-widget",Object.assign(I.style,a.bauContainer);let L=[],$=(_.text||"").split(`
`),O=/\d{1,2}\/\d{1,2}/;if($.forEach(ce=>{let fe=ce.match(O);if(fe){let Ee=fe[0],Me="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(ce)?Me="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(ce)&&(Me="\u{1F1EA}\u{1F1F8}"),L.some(he=>he.flag===Me&&he.date===Ee)||L.push({flag:Me,date:Ee})}}),L.length===0){let ce=(_.text||"").match(/\d{1,2}\/\d{1,2}/g);ce&&[...new Set(ce)].forEach(fe=>L.push({flag:"\u{1F4C5}",date:fe}))}let B="",se='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(se=`
              ...
              `).join("")}</div>
                  ...
                  <div id="cw-bau-full" style="display:none; margin-top:12px; padding-top:12px; border-top:1px dashed rgba(139, 92, 246, 0.3); font-size:13px; line-height:1.5; color:#581C87;">${c(_.text)}</div>
              `:B=`
                <div style="display:flex; justify-content:space-between; align-items:start;">
                    <div style="font-size:13px; color:#581C87; line-height:1.5; flex:1;">${c(_.text)}</div>
              ...
              ${B}
          `,y.after(I);let re=I.querySelector("#cw-bau-toggle-btn"),te=I.querySelector("#cw-bau-full");if(re&&te&&(re.onclick=()=>{let ce=te.style.display==="none";te.style.display=ce?"block":"none",re.textContent=ce?"Ocultar":"Detalhes"}),window._cwIsAdmin){let ce=I.querySelector(".cw-bau-edit");ce&&(ce.onclick=()=>P(_))}}let G=A.sort((_,I)=>{let L=x.includes(_.id),$=x.includes(I.id);return L===$?0:L?1:-1});if(G.length===0&&!S){let _=document.createElement("div");Object.assign(_.style,a.emptyState),_.innerHTML=`
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><path d="M9 12l2 2 4-4"></path></svg>
            <div style="font-weight:500;">Tudo lido!</div>
           `,m.appendChild(_)}let M=G.filter(_=>!x.includes(_.id)),j=G.filter(_=>x.includes(_.id));if(M.forEach(_=>m.appendChild(C(_,!1))),j.length>0){let _=document.createElement("div");Object.assign(_.style,a.historyDivider),_.innerHTML=`<span>Hist\xF3rico (${j.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let I=document.createElement("div");Object.assign(I.style,a.historyContainer),j.forEach($=>I.appendChild(C($,!0)));let L=!1;_.onclick=()=>{ae.playClick(),L=!L,I.style.display=L?"flex":"none",_.querySelector("svg").style.transform=L?"rotate(180deg)":"rotate(0deg)"},m.appendChild(_),m.appendChild(I)}}function C(p,x){let A=document.createElement("div");Object.assign(A.style,x?a.cardHistory:a.card);let S=i[p.type]||i.info,G=document.createElement("div");Object.assign(G.style,a.cardHeader);let M=document.createElement("div");Object.assign(M.style,a.typeTag,{color:S.color,background:S.bg}),M.innerHTML=`${S.icon} <span>${p.type}</span>`;let j=document.createElement("span");if(Object.assign(j.style,a.dateTag),j.textContent=s(p.date),G.appendChild(M),x)G.appendChild(j);else{let O=document.createElement("button");O.className="cw-btn-interactive",Object.assign(O.style,a.dismissBtn),O.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',O.onmouseenter=()=>{O.style.color="#1e8e3e",O.style.background="#e6f4ea",O.style.borderColor="#1e8e3e"},O.onmouseleave=()=>{O.style.color="#5f6368",O.style.background="#fff",O.style.borderColor="rgba(0,0,0,0.1)"},O.onclick=B=>{B.stopPropagation(),ae.playClick(),A.style.transform="translateX(20px)",A.style.opacity="0",setTimeout(()=>{let se=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");se.push(p.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(se)),T(),w()},200)},G.appendChild(O)}let _=document.createElement("div");Object.assign(_.style,a.cardContent);let I=document.createElement("div");Object.assign(I.style,a.msgTitle),I.textContent=p.title;let L=document.createElement("div");Object.assign(L.style,a.msgBody),L.innerHTML=c(p.text);let $=document.createElement("div");if(Object.assign($.style,a.msgMeta),$.innerHTML=`Publicado por <b>${p.author||"Sistema"}</b>`,x||($.innerHTML+=` \u2022 ${s(p.date)}`),_.appendChild(I),_.appendChild(L),_.appendChild($),A.appendChild(G),A.appendChild(_),window._cwIsAdmin){let O=document.createElement("div");O.className="cw-card-actions";let B=document.createElement("button");B.className="cw-action-btn edit",B.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',B.onclick=()=>P(p);let se=document.createElement("button");se.className="cw-action-btn delete",se.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',se.onclick=()=>v(p.id),O.appendChild(B),O.appendChild(se),A.appendChild(O)}return A}let D=Ae.getCachedBroadcasts();D.length>0&&(Lt(D),T()),setTimeout(E,500),h(),n||(n=setInterval(h,Do));let F=document.createElement("div");Object.assign(F.style,Xe),F.className="no-drag",f.appendChild(F),Ke(f,F),document.body.appendChild(f);let N=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),ee=Ge.some(p=>!N.includes(p.id));return{toggle:l,hasUnread:ee}}function Go(){if(window.techSolInitialized){Tt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{Wt();try{ae.initGlobalListeners(),ae.playStartup()}catch(a){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",a)}Ae.fetchTips(),Tt();let e=bo(),t=fo(),n=xo(),o=yo(),s=vo();so({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:s})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),oe("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Go();})();

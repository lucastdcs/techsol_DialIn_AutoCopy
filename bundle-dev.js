(()=>{var nt="",bo=e=>new Promise(t=>setTimeout(t,e));async function Dt(){if(nt)return nt;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await bo(100);let t="Consultor",n=document.querySelector("profile-details .name");if(n)t=n.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let s=o.src.match(/\/photos\/([^\?]+)/)[1];t=s.charAt(0).toUpperCase()+s.slice(1)}}return e.click(),document.body.click(),nt=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function ft(){return nt||"Consultor"}function Ft(e){let t=new Date,n=t.getHours(),o=t.getDay(),s="Ol\xE1",r="";n>=5&&n<12?(s="Bom dia",r='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):n>=12&&n<18?(s="Boa tarde",r='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(s="Boa noite",r='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let a=[];n>=0&&n<5?a=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:n<12?o===1?a=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?a=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:a=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:n<18?a=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:a=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(a=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let l=a[Math.floor(Math.random()*a.length)];return{prefix:`${s},`,name:e,suffix:l,icon:r,isFriday:o===5}}function ht(){let e="Cliente",t="[INSERIR URL]";try{let o=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let s=o.nextElementSibling.innerText.trim();s&&(e=s)}}catch(n){console.warn("Falha ao capturar Nome:",n)}try{let o=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let s=o.nextElementSibling.innerText.trim();s&&(t=s)}}catch(n){console.warn("Falha ao capturar Website:",n)}return{advertiserName:e,websiteUrl:t,agentName:ft()}}var ze=null,xt=null,$e=.3;function Ue(){if(!ze){let e=window.AudioContext||window.webkitAudioContext;e&&(ze=new e)}return ze&&ze.state==="suspended"&&ze.resume(),ze}function Gt(e){if(xt)return xt;let t=e.sampleRate*2,n=e.createBuffer(1,t,e.sampleRate),o=n.getChannelData(0);for(let s=0;s<t;s++)o[s]=Math.random()*2-1;return xt=n,n}var J={playClick:()=>{let e=Ue();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Gt(e);let o=e.createBiquadFilter();o.type="highpass",o.frequency.value=4e3;let s=e.createGain();s.gain.setValueAtTime($e*.8,t),s.gain.exponentialRampToValueAtTime(.001,t+.015),n.connect(o),o.connect(s),s.connect(e.destination),n.start(t),n.stop(t+.02)},playHover:()=>{let e=Ue();if(!e)return;let t=e.currentTime,n=e.createOscillator();n.type="sine",n.frequency.setValueAtTime(400,t);let o=e.createGain();o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime($e*.1,t+.005),o.gain.linearRampToValueAtTime(0,t+.02),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.03)},playSuccess:()=>{let e=Ue();if(!e)return;let t=e.currentTime;[1046.5,1567.9].forEach((o,s)=>{let r=e.createOscillator(),a=e.createGain();r.type="sine",r.frequency.value=o,a.gain.setValueAtTime(0,t),a.gain.linearRampToValueAtTime($e*.6,t+.05),a.gain.exponentialRampToValueAtTime(.001,t+.6),r.connect(a),a.connect(e.destination),r.start(t),r.stop(t+.7)})},playGenieOpen:()=>{let e=Ue();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Gt(e);let o=e.createBiquadFilter();o.type="lowpass",o.frequency.setValueAtTime(100,t),o.frequency.exponentialRampToValueAtTime(800,t+.2);let s=e.createGain();s.gain.setValueAtTime(0,t),s.gain.linearRampToValueAtTime($e*.5,t+.05),s.gain.linearRampToValueAtTime(0,t+.25),n.connect(o),o.connect(s),s.connect(e.destination),n.start(t),n.stop(t+.3)},playError:()=>{let e=Ue();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="triangle",n.frequency.setValueAtTime(120,t),n.frequency.exponentialRampToValueAtTime(80,t+.1),o.gain.setValueAtTime($e,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.2)},playStartup:()=>{let e=Ue();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="sine",n.frequency.value=440;let s=e.createBiquadFilter();s.type="lowpass",s.frequency.value=200,o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime($e*.4,t+.8),o.gain.linearRampToValueAtTime(0,t+1.6),n.connect(s),s.connect(o),o.connect(e.destination),n.start(t),n.stop(t+2)},playSwoosh:()=>{J.playGenieOpen()},playReset:()=>{J.playError()},initGlobalListeners:()=>{if(window._cwSoundListenersActive)return;window._cwSoundListenersActive=!0;let e=0,t=50;document.addEventListener("mouseover",n=>{if(!ze)return;let o=n.target.closest('button, a, input[type="checkbox"], .cw-btn, .cw-hero-card, .cw-task-item, [data-sound="hover"]');if(!o||o.contains(n.relatedTarget))return;let s=Date.now();s-e<t||(J.playHover(),e=s)},{passive:!0})}};var zt=1e4;function jt(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
    ...
    `,document.head.appendChild(t)}function oe(e,t={}){let n=document.createElement("div"),o=t.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(n.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:o,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",pointerEvents:"none"}),n.textContent=e,document.body.appendChild(n),t.error?J.playError():J.playSuccess(),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>n.remove(),400)},t.duration||4e3)}function Pt(e,t=null){let n=0,o=0,s=0,r=0,a=t||e;a.style.cursor="grab",a.onmousedown=l;function l(S){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(S.target.tagName)||S.target.closest(".no-drag"))return;S=S||window.event,a.style.cursor="grabbing",e.style.transition="none";let u=e.getBoundingClientRect();e.style.transform="none",e.style.left=u.left+"px",e.style.top=u.top+"px",e.style.margin="0",e.style.bottom="auto",e.style.right="auto",zt++,e.style.zIndex=zt,s=S.clientX,r=S.clientY,e.setAttribute("data-dragging","true"),document.onmouseup=g,document.onmousemove=p}function p(S){S=S||window.event,S.preventDefault(),n=s-S.clientX,o=r-S.clientY,s=S.clientX,r=S.clientY;let u=e.offsetTop-o,O=e.offsetLeft-n,h=16,f=window.innerWidth,y=window.innerHeight,T=e.offsetWidth,I=e.offsetHeight;O<h?O=h:O+T>f-h&&(O=f-T-h),u<h?u=h:u+I>y-h&&(u=y-I-h),e.style.top=u+"px",e.style.left=O+"px"}function g(){document.onmouseup=null,document.onmousemove=null,a.style.cursor="grab",setTimeout(()=>{e.style.transition="all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease",e.setAttribute("data-dragging","false"),e.setAttribute("data-moved","true")},50)}}var Se={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:"99999",overflow:"hidden",backgroundColor:"rgba(255, 255, 255, 0.98)",backdropFilter:"blur(20px)",webkitBackdropFilter:"blur(20px)",borderRadius:"16px",boxShadow:`
    0 0 1px rgba(0,0,0,0.08), 
    0 8px 24px rgba(0,0,0,0.12),
    0 20px 60px rgba(0,0,0,0.08)
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var vt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},qt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Ht={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var me={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var yt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Bt=-1;function Ze(){let e=Math.floor(Math.random()*yt.length);return e===Bt&&(e=(e+1)%yt.length),Bt=e,yt[e]}var Oe=e=>new Promise(t=>setTimeout(t,e));async function fo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let n=e.querySelector(".cursor");await Oe(200);for(let o=0;o<t.length;o++){let s=t.charAt(o),r=document.createElement("span");r.textContent=s,n&&n.parentNode===e?n.before(r):e.appendChild(r);let a=Math.floor(Math.random()*60)+30;o===0&&(a=150),o>t.length-3&&(a=30),await Oe(a)}await Oe(600),n&&(n.style.display="none")}async function St(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let S=l.querySelector(".cw-hero-grid"),u=l.querySelector(".cw-acc-container"),O=l.querySelector(".cw-results-container"),h=l.querySelector(".cw-search-input"),f=l.querySelector(".cw-status-bar"),y=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");s.forEach(([m,b])=>{let i=o(b.name),d=document.createElement("div");d.className="cw-hero-card",d.id=`hero-${m}`,d.style.setProperty("--hero-color",i.color),d.innerHTML=`
        ...
        `,d.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let c=t[m]?t[m].count:0;R(m,c>0?-c:1,b)},d.querySelector(".minus").onclick=()=>R(m,-1,b),d.querySelector(".plus").onclick=()=>R(m,1,b),d.dataset.color=i.color,S.appendChild(d)});function I(m,b){let i=o(b.name),d=document.createElement("div");return d.className="cw-task-item",d.dataset.id=m,d.innerHTML=`
        ...
        `,d.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let c=t[m]?t[m].count:0;R(m,c>0?-c:1,b)},d.querySelector(".minus").onclick=()=>R(m,-1,b),d.querySelector(".plus").onclick=()=>R(m,1,b),d}Object.entries(r).forEach(([m,b])=>{let i=document.createElement("div");i.className="cw-acc-group";let d=document.createElement("div");d.className="cw-acc-header",d.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${b.brand.color}"></div>
                ${m}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,d.onclick=()=>{u.querySelectorAll(".cw-acc-group.open").forEach(c=>{c!==i&&c.classList.remove("open")}),i.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",b.tasks.forEach(c=>{let x=I(c.key,c);w.appendChild(x)}),i.appendChild(d),i.appendChild(w),u.appendChild(i)});function R(m,b,i){t[m]||(t[m]={count:0,data:i,brand:o(i.name)}),t[m].count+=b,t[m].count<=0&&delete t[m],j(),V(),e&&e()}function j(){s.forEach(([w])=>{let c=S.querySelector(`#hero-${w}`);if(!c)return;let x=t[w];x?(c.classList.add("active"),c.querySelector(".cw-step-val").textContent=x.count,c.querySelector(".cw-step-val").style.color=c.dataset.color):c.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(w=>{let c=w.dataset.id,x=t[c];x?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=x.count):w.classList.remove("selected")});let b=Object.keys(t),i=0,d=[];if(b.forEach(w=>{let c=t[w];i+=c.count;for(let x=0;x<c.count;x++)d.length<6&&d.push(c.brand)}),i>0){f.classList.add("visible");let w=i>1?"A\xE7\xF5es":"A\xE7\xE3o",c=i>1?"definidas":"definida";y.textContent=`${i} ${w} ${c}`,T.innerHTML="",d.forEach(x=>{let E=document.createElement("div");E.className="cw-mini-icon",E.innerHTML=je[x.icon]||je.default;let v=E.querySelector("svg");v&&(v.style.width="14px",v.style.height="14px"),T.appendChild(E)})}else f.classList.remove("visible")}h.addEventListener("input",m=>{let b=m.target.value.toLowerCase();if(b.length>0){u.style.display="none",O.style.display="block",O.innerHTML="";let i=!1;Object.entries(_e).forEach(([d,w])=>{if(w.name.toLowerCase().includes(b)){i=!0;let c=I(d,w);t[d]&&(c.classList.add("selected"),c.querySelector(".cw-step-val").textContent=t[d].count),O.appendChild(c)}}),i||(O.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else u.style.display="block",O.style.display="none"});function V(){g.innerHTML="";let m=Object.keys(t),b=!1,i=document.getElementById("sub-status"),d="implementation";if(i&&i.value.toLowerCase().includes("education")&&(d="education"),m.length===0){g.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(m.length===0){g.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`
...
\u2022 `)?(D.preventDefault(),this.value=H.substring(0,A-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=A-3):H==="\u2022 "&&(D.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function mt(){let C=typeof ye<"u"?ye:document.getElementById("snippet-container");if(!C)return;let D=C.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),A={},H=new Set;D.forEach(X=>{let $=X.id,F=we[$];if(F)for(let M in F)M==="linkedTask"?H.add(F.linkedTask):M!=="type"&&(A[M]||(A[M]=[]),A[M].includes(F[M])||A[M].push(F[M]))});let te=new Set;Object.values(we).forEach(X=>{Object.keys(X).forEach($=>{$!=="linkedTask"&&$!=="type"&&te.add($)})}),te.forEach(X=>{let $=document.getElementById(X);if($){let F=A[X]||[],M="";tt.includes(X.replace("field-",""))?(M=F.map(U=>U.startsWith("\u2022 ")?U:"\u2022 "+U).join(`
`),M===""?M="\u2022 ":M.endsWith(`
\u2022 `)||(M+=`
\u2022 `)):M=F.join(`

`),M.trim()!=="\u2022"&&M.trim()!==""?$.value=M:tt.includes(X.replace("field-",""))?$.value="\u2022 ":$.value="",$.tagName==="TEXTAREA"&&typeof ut=="function"&&ut($)}});let le=new Set,he=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(X=>{let $=we[X.id];$&&$.linkedTask&&(X.checked?le.add($.linkedTask):he.add($.linkedTask))}),he.forEach(X=>{le.has(X)||l.toggleTask(X,!1)}),le.forEach(X=>{l.toggleTask(X,!0)})}w.onchange=()=>{let C=w.value;if(gt(1.5),v.innerHTML=`<option value="">${P("select_substatus")}</option>`,!C){v.disabled=!0;return}for(let D in et){let A=et[D];if(A.status===C){let H=document.createElement("option");H.value=D,H.textContent=A.name,v.appendChild(H)}}v.disabled=!1},v.onchange=()=>{let C=v.value;if(gt(1.5),!C)return;l.updateSubStatus(C);let D=et[C];ye.innerHTML="";let A=(F,M,U)=>{let se=document.createElement("label");Object.assign(se.style,r.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let Q=document.createElement("input");return Q.type=M,Q.id=F.id,Object.assign(Q.style,r.checkboxInput),se.appendChild(Q),se.appendChild(document.createTextNode(` ${F.text}`)),U.appendChild(se),Q},H=[],te="radio";if(C==="NI_Awaiting_Inputs")H=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))te="checkbox",H=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(C.startsWith("AS_")){te="checkbox";let F=document.createElement("label");F.textContent=P("cenarios_comuns"),Object.assign(F.style,r.label),ye.appendChild(F),H=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")&&(H=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let le=H.filter(F=>{let M=we[F.id];return!M.type||M.type==="all"||M.type===t});le.forEach((F,M)=>{let U=A(F,te,ye);te==="radio"&&(U.name="scenario-radio-group",M===0&&(U.checked=!0))}),le.length>0&&(Le.style.display="block"),D.requiresTasks?(be.style.display="none",He.style.display="block",l.selectionElement.style.display="block",ve.style.display="block"):(be.style.display="block",He.style.display="none",l.selectionElement.style.display="none",ve.style.display="block"),Ne.innerHTML="";let he=D.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(he)].forEach(F=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(F))return;let M=F.slice(1,-1),U=document.createElement("label"),se=P(M.toLowerCase());U.textContent=se!==M.toLowerCase()?se:M.replace(/_/g," ").replace(/\b\w/g,re=>re.toUpperCase())+":",Object.assign(U.style,r.label);let Q;tt.includes(M)?(Q=document.createElement("textarea"),Object.assign(Q.style,r.textarea),Q.classList.add("bullet-textarea"),ut(Q)):wt.includes(M)?(Q=document.createElement("textarea"),Object.assign(Q.style,r.textarea)):(Q=document.createElement("input"),Q.type="text",Object.assign(Q.style,r.input),M==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign(U.style,{display:"none"}),Object.assign(Q.style,{display:"none"}))),M==="ON_CALL"&&t==="lm"&&(Object.assign(U.style,{display:"none"}),Object.assign(Q.style,{display:"none"}),Q.value="N/A"),Q.id=`field-${M}`,Ne.appendChild(U),Ne.appendChild(Q)});let X=ye.querySelectorAll('input[type="checkbox"], input[type="radio"]');X.length>0&&(X.forEach(F=>{F.removeEventListener("change",mt),F.addEventListener("change",mt)}),mt()),ke.style.display="block",at[C]?De.style.display="block":De.style.display="none",Ve.style.display="flex";let $=l.getCheckedElements().map(F=>F.value);a.updateVisibility(C,$)},be.onclick=()=>{be.style.display="none",He.style.display="block",l.selectionElement.style.display="block"};function _t(){let C=v.value;if(!C)return null;let A=et[C].template.replace(/\n/g,"<br>"),H='style="margin-bottom: 12px; padding-left: 30px;"',te=[],le="",he=l.getCheckedElements();he.length>0&&he.forEach($=>{let F=$.value,M=_e[F],U=$.closest().querySelector(".stepper-count"),se=U?parseInt(U.textContent):1;se>1?te.push(`${M.name} (x${se})`):te.push(M.name)});let de=l.screenshotsElement;if(de){let $=Array.from(de.querySelectorAll('input[id^="name-"]'));$.length>0&&$.forEach(F=>{let M=F.value,U=F.closest(".cw-screen-card");if(U){let se=U.querySelectorAll('input[id^="screen-"]'),Q=!1,re="";se.forEach(fe=>{let Rt=fe.closest(".cw-input-group"),Mt=Rt?Rt.querySelector(".cw-input-label"):null,mo=Mt?Mt.textContent:"Evid\xEAncia",Lt=fe.value.trim(),go=Lt?` ${Lt}`:"";re+=`<li>${mo} -${go}</li>`,Q=!0}),Q&&(le+=`<b>${M}</b>`,le+=`<ul ${H}>${re}</ul>`)}})}if(A.includes("{TAGS_IMPLEMENTED}")?A=A.replace(/{TAGS_IMPLEMENTED}/g,te.join(", ")||"N/A"):te.length>0&&(A+=`<br><b>Tags:</b> ${te.join(", ")}<br>`),A.includes("{SCREENSHOTS_LIST}")?A=A.replace(/{SCREENSHOTS_LIST}/g,le?`${le}`:"N/A"):le!==""&&(A+=`<br>${le}`),n==="pt"&&o){let $=xe.checked?P("sim"):P("nao");A=A.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${P("consentiu_gravacao")}</b> ${$}<br><br>`),A=A.replace(/{CASO_PORTUGAL}/g,`<br><b>${P("caso_portugal")}</b> ${P("sim")}<br>`)}else n==="pt"&&!o?(A=A.replace(/{CASO_PORTUGAL}/g,`<br><b>${P("caso_portugal")}</b> ${P("nao")}<br>`),A=A.replace(/{CONSENTIU_GRAVACAO}/g,"")):(A=A.replace(/{CASO_PORTUGAL}/g,""),A=A.replace(/{CONSENTIU_GRAVACAO}/g,""));return Ne.querySelectorAll("input, textarea").forEach($=>{let F=$.id.replace("field-",""),M=new RegExp(`{${F}}`,"g"),U=$.value;if(F==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let re=ye.querySelector('input[type="radio"]:checked');re&&we[re.id]&&(U=we[re.id]["field-REASON_COMMENTS"])}if(tt.includes(F)&&U.trim()!==""){let re=U.split(`
`).map(fe=>fe.trim()).filter(fe=>fe!==""&&fe!=="\u2022").map(fe=>fe.startsWith("\u2022 ")?fe.substring(2):fe).map(fe=>`<li>${fe}</li>`).join("");U=re?`<ul ${H}>${re}</ul>`:""}else wt.includes(F)?U=U.split(`
`).filter(re=>re.trim()!=="").map(re=>`<p style="margin: 0 0 8px 0;">${re}</p>`).join(""):$.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let se=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let re=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${F}\\}(?:<br>\\s*)?`,"gi");re.test(A)?A=A.replace(re,""):A=A.replace(M,"")}else A=A.replace(M,U.replace(/\$/g,"$$$$"))}),A=A.replace(/{([A-Z0-9_]+)}/g,""),A=A.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(A+=a.getOutput()),A}Ke.onclick=()=>{let C=_t();C?(Tt(C),oe(P("copiado_sucesso"))):oe(P("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=v.value,D=_t();if(!D){oe(P("selecione_substatus"),{error:!0});return}Tt(D),bt();let A=Xe(),H=await oo();if(H)try{if(H.focus(),H.innerHTML.trim()==="<p><br></p>"||H.innerHTML.trim()==="<br>"||H.innerText.trim()===""){let de=document.createRange();de.selectNodeContents(H);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("delete",!1,null)}else if(!H.innerHTML.endsWith("<br><br>")){let de=document.createRange();de.selectNodeContents(H),de.collapse(!1);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,D),to(H),setTimeout(()=>{oe(P("inserido_copiado"))},600);let le=typeof Ge<"u"&&Ge?Ge.checked:!0;if(C&&at[C]&&le){let de=at[C];await $t(de),await new Promise(X=>setTimeout(X,500))}A(),gt(1.5),w.value="",v.innerHTML=`<option value="">${P("select_substatus")}</option>`,v.disabled=!0}catch(te){console.error(te),oe("Erro ao inserir.",{error:!0}),A()}};function gt(C=1.5){C<=1.5&&(Le.style.display="none",ye.innerHTML=""),C<=2&&(ve.style.display="none",l.reset(),be.style.display="none"),C<=3&&(ke.style.display="none",Ne.innerHTML="",a.reset(),Ve.style.display="none",De.style.display="none")}function bt(){if(s=!s,s){let C=p.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Ae(s,p,"cw-btn-notes")}return dt("bau"),pt("pt"),bt}var Pe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function lo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",r=!1,a=document.createElement("div");a.id="call-script-popup",Object.assign(a.style,Se,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",opacity:"0",pointerEvents:"none"});let l={popup:a,googleLine:null};function p(){r=!r,Ae(r,a,"cw-btn-script")}let g=Ce(a,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{p()});a.appendChild(g);let S=document.createElement("div");Object.assign(S.style,t.progressBarContainer);let u=document.createElement("div");Object.assign(u.style,t.progressBarFill),S.appendChild(u),a.appendChild(S);let O=document.createElement("div");O.id="csa-content",Object.assign(O.style,t.contentArea),a.appendChild(O);let h=document.createElement("div");Object.assign(h.style,t.footer);let f=document.createElement("span");f.textContent="by lucaste@",Object.assign(f.style,{fontSize:"10px",color:"#bdc1c6"});let y=document.createElement("button");y.innerHTML=`
  ...
  `,Object.assign(y.style,t.resetBtn),y.onmouseenter=()=>y.style.background="#fce8e6",y.onmouseleave=()=>y.style.background="transparent",y.onclick=()=>{y.style.transform="scale(0.9)",setTimeout(()=>y.style.transform="scale(1)",150);for(let E in n)delete n[E];d()},h.appendChild(f),h.appendChild(y),a.appendChild(h);let T=document.createElement("div");Object.assign(T.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let I=document.createElement("div");Object.assign(I.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let R=document.createElement("div");R.textContent="BAU";let j=document.createElement("div");j.textContent="LT",Object.assign(R.style,me),Object.assign(j.style,me),I.appendChild(R),I.appendChild(j);let V=document.createElement("select");Object.assign(V.style,qt,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),V.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',V.value=o,T.appendChild(I),T.appendChild(V),O.appendChild(T);let m=document.createElement("div");m.id="csa-checklist-area",O.appendChild(m);let b=document.createElement("div");Object.assign(b.style,We),b.className="no-drag",b.title="Redimensionar",a.appendChild(b),Ye(a,b),document.body.appendChild(a);function i(E){return E}function d(){m.innerHTML="";let E=`${o} ${s}`,v=ro[E];if(!v){m.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
           ...
           `,f.appendChild(x)}let w=d.filter(x=>!i.includes(x.id)),c=d.filter(x=>i.includes(x.id));if(w.forEach(x=>f.appendChild(j(x,!1))),c.length>0){let x=document.createElement("div");Object.assign(x.style,a.historyDivider),x.innerHTML=`<span>Visualizar ${c.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let E=document.createElement("div");Object.assign(E.style,a.historyContainer),c.forEach(k=>E.appendChild(j(k,!0)));let v=!1;x.onclick=()=>{J.playClick(),v=!v,E.style.display=v?"flex":"none",x.querySelector("svg").style.transform=v?"rotate(180deg)":"rotate(0deg)",x.querySelector("span").textContent=v?"Ocultar hist\xF3rico":`Visualizar ${c.length} avisos anteriores`},f.appendChild(x),f.appendChild(E)}}function j(i,d){let w=document.createElement("div");Object.assign(w.style,d?a.cardHistory:a.card);let c=r[i.type]||r.info,x=document.createElement("div");Object.assign(x.style,a.cardHeader,{background:c.bg,color:c.text,borderBottom:`1px solid ${c.border}`});let E=document.createElement("div");if(Object.assign(E.style,{display:"flex",alignItems:"center",gap:"6px"}),E.innerHTML=`${c.icon} <span>${i.type.toUpperCase()}</span>`,x.appendChild(E),d){let k=document.createElement("span");k.textContent=s(i.date),k.style.opacity="0.7",x.appendChild(k)}else{let k=document.createElement("button");k.title="Marcar como lido",Object.assign(k.style,a.dismissBtn),k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',k.onmouseenter=()=>{k.style.color="#1e8e3e",k.style.background="#e6f4ea",k.style.borderColor="#1e8e3e"},k.onmouseleave=()=>{k.style.color="#5f6368",k.style.background="#fff",k.style.borderColor="rgba(0,0,0,0.1)"},k.onclick=G=>{G.stopPropagation(),J.playClick(),w.style.transform="translateX(20px)",w.style.opacity="0",setTimeout(()=>{let L=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");L.push(i.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(L)),R(),T()},250)},x.appendChild(k)}if(w.appendChild(x),i.title){let k=document.createElement("div");Object.assign(k.style,a.msgTitle),k.textContent=i.title,w.appendChild(k)}if(!d){let k=document.createElement("div");Object.assign(k.style,a.metaContainer),k.innerHTML=`<span style="font-weight:600">${i.author}</span> \u2022 <span>${s(i.date)}</span>`,w.appendChild(k)}let v=document.createElement("div");return Object.assign(v.style,a.cardBody),v.innerHTML=p(i.text),w.appendChild(v),w}R();let V=document.createElement("div");Object.assign(V.style,We),V.className="no-drag",g.appendChild(V),Ye(g,V),document.body.appendChild(g);let m=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),b=qe.some(i=>!m.includes(i.id));return{toggle:u,hasUnread:b}}function Eo(){if(window.techSolInitialized){St();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{jt();try{J.initGlobalListeners(),J.playStartup()}catch(r){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",r)}Be.fetchTips(),St();let e=io(),t=so(),n=lo(),o=co(),s=po();Qt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:s})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),oe("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Eo();})();

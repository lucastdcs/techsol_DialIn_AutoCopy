...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var de=e=>new Promise(t=>setTimeout(t,e));function be(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function st(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let s=e.getBoundingClientRect(),a=document.createElement("div");a.id=o,a.style.cssText=`
    ...
    `,document.head.appendChild(e)}function Ee(e,t,o){let n=document.getElementById(o);if(!t)return;let s=t.getAttribute("data-moved")==="true",a={x:0,y:0};if(n){let b=n.getBoundingClientRect();a.x=b.left+b.width/2,a.y=b.top+b.height/2}let i,l;if(!s)i=window.innerWidth/2,l=window.innerHeight/2;else{let b=t.getBoundingClientRect();i=b.left+b.width/2,l=b.top+b.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let m=a.x-i,u=a.y-l;e?(Z.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",s?t.style.transform=`translate(${m}px, ${u}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${m}px), calc(-50% + ${u}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),n&&n.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",s?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof eo=="function"&&eo(t,o)):(Z.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",s?t.style.transform=`translate(${m}px, ${u}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${m}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),n&&n.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof kt=="function"&&kt(t))}function eo(e,t){kt(e);let o=n=>{if(!e.classList.contains("open"))return;let s=e.contains(n.target),a=document.querySelector(".cw-pill"),i=a&&a.contains(n.target);s?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=o,document.addEventListener("mousedown",o)}function kt(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var no="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",Ot="cw_data_broadcast",to="cw_data_tips",ko=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function oo(e){return new Promise((t,o)=>{let n="cw_cb_"+Math.round(1e4*Math.random()),s=document.createElement("script");window[n]=a=>{document.body.removeChild(s),delete window[n],t(a)},s.src=`${no}?op=${e}&callback=${n}&t=${Date.now()}`,s.onerror=()=>{document.body.removeChild(s),delete window[n],o(new Error("JSONP Load Error"))},document.body.appendChild(s)})}var ot={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await oo("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(to,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await oo("broadcast");if(e&&e.broadcast)return localStorage.setItem(Ot,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(Ot)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Ot)||"[]"),getRandomTip:()=>{let e=ko,t=localStorage.getItem(to);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let n={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(no,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(n)}).catch(s=>console.log("Log fail",s))}};var Ne={glassBg:"rgba(40, 40, 40, 0.95)",glassBorder:"rgba(255, 255, 255, 0.15)",iconIdle:"#bdc1c6",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},Oo=e=>new Promise(t=>setTimeout(t,e));function ao(e){let t="cw-command-center-style";if(!document.getElementById(t)){let y=document.createElement("style");y.id=t,y.innerHTML=`
        ...
        .cw-pill {
            ...
            width: 56px; /* Largura Fixa */
            padding: 8px 0 16px 0; /* Espa\xE7o para o Grip e para baixo */
            gap: 8px;
            ...
            /* Anima\xE7\xE3o Suave "Persiana" */
            transition: 
                max-height 0.4s cubic-bezier(0.2, 0, 0, 1), 
                padding 0.3s ease, /* Importante para a bola perfeita */
                background 0.3s ease,
                transform 0.1s linear, top 0.1s linear, left 0.1s linear;
            
            max-height: 500px; /* Altura suficiente para aberto */
            opacity: 0; transform: translateX(40px);
        }
        
        .cw-pill.docked { opacity: 1; transform: translateX(0); }

        /* --- ESTADO COLAPSADO (BOLA PERFEITA) --- */
        .cw-pill.collapsed {
            /* For\xE7a altura igual a largura */
            max-height: 56px !important; 
            
            /* CRUCIAL: Remove padding para n\xE3o deformar o c\xEDrculo */
            padding: 0 !important; 
            gap: 0 !important;
            
            border-radius: 50% !important; /* C\xEDrculo perfeito */
            background: rgba(30, 30, 30, 1);
            justify-content: center; /* Centraliza o \xEDcone verticalmente */
        }
        ...
        /* Quando fechado, o Grip some completamente (altura 0) */
        .cw-pill.collapsed .cw-grip {
            height: 0; margin: 0; opacity: 0; pointer-events: none;
        }
        ...
        .cw-brand-btn svg {
            ...
            fill: currentColor; /* Usa a cor definida no bot\xE3o (Branco) */
            filter: drop-shadow(0 0 4px rgba(255,255,255,0.3)); /* Brilho sutil */
        }

        /* Ajuste de rota\xE7\xE3o suave */
        .cw-pill.collapsed .cw-brand-btn { transform: rotate(0deg); }
        ...
        .cw-pill.collapsed .cw-module-list { opacity: 0; pointer-events: none; transition-delay: 0s; }

        .cw-btn {
            width: 40px; height: 40px; flex-shrink: 0;
            border-radius: 50%; border: none; background: transparent;
            display: flex; align-items: center; justify-content: center; 
            cursor: pointer; color: ${Ne.iconIdle};
            transition: all 0.2s ease;
        }
        .cw-btn svg { width: 20px; height: 20px; fill: currentColor; pointer-events: none; }
        .cw-btn:hover { background: rgba(255,255,255,0.1); color: ${Ne.iconActive}; transform: scale(1.1); }

        /* Cores Ativas */
        .cw-btn.notes.active { color: ${Ne.blue}; background: rgba(138, 180, 248, 0.2); }
        .cw-btn.email.active { color: ${Ne.red}; background: rgba(242, 139, 130, 0.2); }
        .cw-btn.script.active { color: ${Ne.purple}; background: rgba(197, 138, 249, 0.2); }
        .cw-btn.links.active { color: ${Ne.green}; background: rgba(129, 201, 149, 0.2); }
        .cw-btn.broadcast.active { color: ${Ne.orange}; background: rgba(249, 171, 0, 0.2); }
...
\u2022 `)?(D.preventDefault(),this.value=$.substring(0,E-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=E-3):$==="\u2022 "&&(D.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function ft(){let S=typeof ve<"u"?ve:document.getElementById("snippet-container");if(!S)return;let D=S.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),E={},$=new Set;D.forEach(Q=>{let K=Q.id,F=we[K];if(F)for(let I in F)I==="linkedTask"?$.add(F.linkedTask):I!=="type"&&(E[I]||(E[I]=[]),E[I].includes(F[I])||E[I].push(F[I]))});let ae=new Set;Object.values(we).forEach(Q=>{Object.keys(Q).forEach(K=>{K!=="linkedTask"&&K!=="type"&&ae.add(K)})}),ae.forEach(Q=>{let K=document.getElementById(Q);if(K){let F=E[Q]||[],I="";tt.includes(Q.replace("field-",""))?(I=F.map(Y=>Y.startsWith("\u2022 ")?Y:"\u2022 "+Y).join(`
`),I===""?I="\u2022 ":I.endsWith(`
\u2022 `)||(I+=`
\u2022 `)):I=F.join(`

`),I.trim()!=="\u2022"&&I.trim()!==""?K.value=I:tt.includes(Q.replace("field-",""))?K.value="\u2022 ":K.value="",K.tagName==="TEXTAREA"&&typeof bt=="function"&&bt(K)}});let le=new Set,xe=new Set;S.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(Q=>{let K=we[Q.id];K&&K.linkedTask&&(Q.checked?le.add(K.linkedTask):xe.add(K.linkedTask))}),xe.forEach(Q=>{le.has(Q)||l.toggleTask(Q,!1)}),le.forEach(Q=>{l.toggleTask(Q,!0)})}w.onchange=()=>{let S=w.value;if(ht(1.5),C.innerHTML=`<option value="">${H("select_substatus")}</option>`,!S){C.disabled=!0;return}for(let D in et){let E=et[D];if(E.status===S){let $=document.createElement("option");$.value=D,$.textContent=E.name,C.appendChild($)}}C.disabled=!1},C.onchange=()=>{let S=C.value;if(ht(1.5),!S)return;l.updateSubStatus(S);let D=et[S];ve.innerHTML="";let E=(F,I,Y)=>{let se=document.createElement("label");Object.assign(se.style,a.checkboxLabel),se.onmouseover=()=>se.style.backgroundColor="#e8eaed",se.onmouseout=()=>se.style.backgroundColor="#f8f9fa";let te=document.createElement("input");return te.type=I,te.id=F.id,Object.assign(te.style,a.checkboxInput),se.appendChild(te),se.appendChild(document.createTextNode(` ${F.text}`)),Y.appendChild(se),te},$=[],ae="radio";if(S==="NI_Awaiting_Inputs")$=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(S.startsWith("SO_"))ae="checkbox",$=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(S.startsWith("AS_")){ae="checkbox";let F=document.createElement("label");F.textContent=H("cenarios_comuns"),Object.assign(F.style,a.label),ve.appendChild(F),$=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else S.startsWith("IN_")?$=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:S.startsWith("DC_")&&(ae="radio",$=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let le=$.filter(F=>{let I=we[F.id];return!I.type||I.type==="all"||I.type===t});le.forEach((F,I)=>{let Y=E(F,ae,ve);ae==="radio"&&(Y.name="scenario-radio-group",I===0&&(Y.checked=!0))}),le.length>0&&(Le.style.display="block"),D.requiresTasks?(pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"):(pe.style.display="block",De.style.display="none",l.selectionElement.style.display="none"),_e.innerHTML="";let xe=D.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(xe)].forEach(F=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(F))return;let I=F.slice(1,-1),Y=document.createElement("label"),se=H(I.toLowerCase());if(Y.textContent=se!==I.toLowerCase()?se:I.replace(/_/g," ").replace(/\b\w/g,j=>j.toUpperCase())+":",Object.assign(Y.style,a.label),I==="SPEAKEASY_ID"){let j=document.createElement("button");j.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',j.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
...
`).filter(j=>j.trim()!=="").map(j=>`<p style="margin: 0 0 8px 0;">${j}</p>`).join(""):K.tagName==="TEXTAREA"&&(Y=Y.replace(/\n/g,"<br>"));let se=Y.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let j=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${F}\\}(?:<br>\\s*)?`,"gi");j.test(E)?E=E.replace(j,""):E=E.replace(I,"")}else E=E.replace(I,Y.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(E+=i.getOutput()),E}Xe.onclick=()=>{let S=Rt();S?(qt(S),oe(H("copiado_sucesso"))):oe(H("selecione_substatus"),{error:!0})},Ke.onclick=async()=>{let S=C.value,D=Rt();if(!D){oe(H("selecione_substatus"),{error:!0});return}qt(D),xt();let E=ct(),$=await co();if($)try{if($.focus(),$.innerHTML.trim()==="<p><br></p>"||$.innerHTML.trim()==="<br>"||$.innerText.trim()===""){let ce=document.createRange();ce.selectNodeContents($);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ce),document.execCommand("delete",!1,null)}else if(!$.innerHTML.endsWith("<br><br>")){let ce=document.createRange();ce.selectNodeContents($),ce.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(ce),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,D),lo($),setTimeout(()=>{oe(H("inserido_copiado"))},600);let le=typeof ze<"u"&&ze?ze.checked:!0;if(S&&Pe[S]&&le){let ce=Pe[S];await lt(ce),await new Promise(Q=>setTimeout(Q,500))}E(),ht(1.5),w.value="",C.innerHTML=`<option value="">${H("select_substatus")}</option>`,C.disabled=!0}catch(ae){console.error(ae),oe("Erro ao inserir.",{error:!0}),E()}};function ht(S=1.5){S<=1.5&&(Le.style.display="none",ve.innerHTML=""),S<=2&&(l.reset(),pe.style.display="none"),S<=3&&(he.style.display="none",_e.innerHTML="",i.reset(),Ue.style.display="none",Fe.style.display="none")}function xt(){if(s=!s,s){let S=m.querySelector(".cw-expand-btn");S&&typeof S.resetState=="function"&&S.resetState()}Ee(s,m,"cw-btn-notes")}return mt("bau"),gt("pt"),xt}var He={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
        ...
        `,h.querySelector("#csa-back-btn").onclick=T;let V=h.querySelector("#csa-insert-btn");V.onclick=()=>{V.style.transform="scale(0.96)",k(R,"email"),setTimeout(()=>{V.style.transform="scale(1)",T()},300)}}function T(){s="list",L.style.transform="translateX(0)"}function ne(R,P,X=null){let V=document.createElement("button");return V.innerHTML=X?`<span style="margin-right:4px">${X}</span>${R}`:R,Object.assign(V.style,p),o===P&&n===""&&Object.assign(V.style,g),V.onclick=()=>{o=P,n="",r.value="",B(),M()},V}function B(){c.innerHTML="",c.appendChild(ne("Smart CRs",t,"\u26A1")),Object.keys(He).forEach(R=>{c.appendChild(ne(He[R].title,R))})}function M(){w.innerHTML="";let R=[];if(n.trim()!==""){let W=n.toLowerCase();Object.values(He).forEach(_=>{_.emails.forEach(J=>{(J.name.toLowerCase().includes(W)||J.subject.toLowerCase().includes(W))&&R.push({type:"email",data:J})})}),Object.entries(Pe).forEach(([_,J])=>{if(!J)return;(_.replace(/_/g," ").toLowerCase().includes(W)||J.toLowerCase().includes(W))&&R.push({type:"cr",key:_,code:J})})}else o===t?Object.entries(Pe).forEach(([W,_])=>{_&&R.push({type:"cr",key:W,code:_})}):He[o]&&He[o].emails.forEach(W=>{R.push({type:"email",data:W})});if(R.length===0){w.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px;">\u{1F50D}</div><div style="font-size:14px; margin-top:8px;">Nada encontrado.</div></div>';return}let X='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a73e8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',V='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fbbc04" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',fe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dadce0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';R.forEach(W=>{let _=document.createElement("div");if(Object.assign(_.style,N),W.type==="email"){let J=W.data,re=J.subject.length>40?J.subject.substring(0,40)+"...":J.subject;_.innerHTML=`
                ...
                `,_.onclick=()=>C(J)}else{let J=W.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");_.innerHTML=`

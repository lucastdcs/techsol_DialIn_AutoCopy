...
.cw-dropdown-option.selected { 
    ...
    `,document.head.appendChild(t)}function ee(e,t={}){let o=document.createElement("div"),n=t.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(o.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:n,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",pointerEvents:"none"}),o.textContent=e,document.body.appendChild(o),t.error?Q.playError():Q.playSuccess(),requestAnimationFrame(()=>{o.style.opacity="1",o.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>o.remove(),400)},t.duration||4e3)}function Ht(e,t=null){let o=0,n=0,s=0,i=0,a=t||e;a.style.cursor="grab",a.onmousedown=l;function l(v){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(v.target.tagName)||v.target.closest(".no-drag"))return;v=v||window.event,a.style.cursor="grabbing",e.style.transition="none";let u=e.getBoundingClientRect();e.style.transform="none",e.style.left=u.left+"px",e.style.top=u.top+"px",e.style.margin="0",e.style.bottom="auto",e.style.right="auto",Bt++,e.style.zIndex=Bt,s=v.clientX,i=v.clientY,e.setAttribute("data-dragging","true"),document.onmouseup=p,document.onmousemove=g}function g(v){v=v||window.event,v.preventDefault(),o=s-v.clientX,n=i-v.clientY,s=v.clientX,i=v.clientY;let u=e.offsetTop-n,m=e.offsetLeft-o,x=16,f=window.innerWidth,A=window.innerHeight,T=e.offsetWidth,q=e.offsetHeight;m<x?m=x:m+T>f-x&&(m=f-T-x),u<x?u=x:u+q>A-x&&(u=A-q-x),e.style.top=u+"px",e.style.left=m+"px"}function p(){document.onmouseup=null,document.onmousemove=null,a.style.cursor="grab",setTimeout(()=>{e.style.transition="all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease",e.setAttribute("data-dragging","false"),e.setAttribute("data-moved","true")},50)}}var we={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:"99999",overflow:"hidden",backgroundColor:"rgba(255, 255, 255, 0.98)",backdropFilter:"blur(20px)",webkitBackdropFilter:"blur(20px)",borderRadius:"16px",boxShadow:`
    0 0 1px rgba(0,0,0,0.08), 
    0 8px 24px rgba(0,0,0,0.12),
    0 20px 60px rgba(0,0,0,0.08)
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var At={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Vt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var $t={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var be={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var vt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],jt=-1;function Je(){let e=Math.floor(Math.random()*vt.length);return e===jt&&(e=(e+1)%vt.length),jt=e,vt[e]}var Ie=e=>new Promise(t=>setTimeout(t,e));async function Eo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let o=e.querySelector(".cursor");await Ie(200);for(let n=0;n<t.length;n++){let s=t.charAt(n),i=document.createElement("span");i.textContent=s,o&&o.parentNode===e?o.before(i):e.appendChild(i);let a=Math.floor(Math.random()*60)+30;n===0&&(a=150),n>t.length-3&&(a=30),await Ie(a)}await Ie(600),o&&(o.style.display="none")}async function wt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await Ie(200);let t=await Ft(),o=Gt(t),n=e.querySelector("#w-icon"),s=e.querySelector("#p1"),i=e.querySelector("#p2"),a=e.querySelector("#p3"),l=e.querySelector("#p-sextou");n&&(n.innerHTML=o.icon),s&&(s.textContent=o.prefix),a&&(a.textContent=o.suffix),await Ie(300);let g=n?n.querySelector("svg"):null;if(g&&(g.style.opacity="1",g.style.transform="scale(1)"),await Ie(400),s&&(s.style.opacity="1"),Q.playStartup(),i&&await Eo(i,o.name),a&&(a.style.opacity="1",a.style.transform="translateY(0)"),o.isFriday&&l){await Ie(400),l.style.display="block",l.offsetWidth;let p=l.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await Ie(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await Ie(900),e.parentNode&&e.parentNode.removeChild(e)}}var We={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Ye(e,t){t.onmousedown=o;function o(n){n.stopPropagation(),n.preventDefault();let s=e.style.transition;e.style.transition="none";let i=n.clientX,a=n.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),g=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),p=i,v=a,u=!1;function m(A){p=A.clientX,v=A.clientY,u||(window.requestAnimationFrame(()=>{x(),u=!1}),u=!0)}function x(){let A=l+(p-i),T=g+(v-a);A>360&&(e.style.width=A+"px"),T>300&&(e.style.height=T+"px")}function f(){document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",f),setTimeout(()=>{e.style.transition=s},50)}document.addEventListener("mousemove",m),document.addEventListener("mouseup",f)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function Ut(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,o=>t[o]?t[o]:"")}var et=e=>new Promise(t=>setTimeout(t,e));function it(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}var Wt="cw-automation-styles";if(!document.getElementById(Wt)){let e=document.createElement("style");e.id=Wt,e.innerHTML=`
...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var me=e=>new Promise(t=>setTimeout(t,e));function ye(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function Kt(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let s=e.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let a=i.querySelector(".cw-close-btn");a.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&a.click()},25e3)}async function Qt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await me(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await me(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function Ct(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let n=o.offsetParent!==null,s=o.closest("case-message-view")!==null,i=o.closest(".editor")!==null||o.closest("write-card")!==null;return n&&!s&&i});return t&&ye("Editor visualmente detectado.","success"),t}async function Zt(){ye("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");if(o&&o.offsetParent!==null){ye("Bot\xE3o de email direto encontrado.");let u=o.closest("material-button")||o.closest("material-fab")||o;Ce(u),e=!0}else{ye("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let u=document.querySelector("material-fab-speed-dial");if(u){let m=u.querySelector(".trigger");if(m){Ce(m),await me(800);let f=Array.from(document.querySelectorAll("i.material-icons-extended")).find(A=>A.innerText.trim()==="email");f&&(Ce(f),e=!0)}}}if(!e)return ee("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;ye("\u{1F680} FASE 2: Verificando rascunhos...");let n=null,s=0,i=20;for(;s<i;){await me(250);let u=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(n=Array.from(u).find(m=>m.offsetParent!==null),n){ye("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(n){ye("\u{1F5D1}\uFE0F Descartando..."),Ce(n),n.click();let u=null,m=0;for(;m<15;){await me(300);let x=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(u=Array.from(x).find(f=>f.offsetParent!==null),u)break;m++}u&&(Ce(u),ee("Limpando rascunho antigo...",{duration:2e3}),await me(2500))}ye("\u{1F680} FASE 3: Buscando editor final...");let a=0,l=null;for(;a<20&&(l=Ct(),!l);)await me(250),a++;if(!l)return ee("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let g=l.closest('[id="email-body-content-top"]'),v=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(g){if(v){let m=v.closest('[aria-hidden="true"]');m&&m.removeAttribute("aria-hidden"),v.focus(),Ce(v)}await me(300),g.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let u=g.querySelector("#cases-body-field");if(u){let m=document.createRange();m.selectNodeContents(u),m.collapse(!0);let x=window.getSelection();x.removeAllRanges(),x.addRange(m)}return!0}return!1}async function Jt(e){if(!e||!await Zt())return;let o=await xt();await me(500);let n=document.querySelector('material-button[debug-id="canned_response_button"]');if(n){Ce(n),await me(1e3);let s=document.querySelector("material-auto-suggest-input input");if(s){Ce(s),document.execCommand("insertText",!1,e),s.dispatchEvent(new Event("input",{bubbles:!0})),await me(800);let i=document.querySelector("material-select-dropdown-item");if(i){Ce(i),await me(1500);let a=Ct();if(a&&o.advertiserName){let l=a.innerHTML;l.includes("{%ADVERTISER_NAME%}")&&(a.innerHTML=l.replace(/{%ADVERTISER_NAME%}/g,o.advertiserName))}ee("Canned Response aplicada!")}else ee(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else ee("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function Et(e){if(ye(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Zt())return;let o=await xt(),n=ht();await me(600),ye("\u{1F4E7} Processando destinat\xE1rios...");let s=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(s&&(s.click(),await me(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await Qt(l,o.clientEmail),Kt(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await Qt(l,o.internalEmail),Kt(l,`
...
@keyframes googleBounce {
    ...
    `;let s=document.createElement("div");if(s.className="cw-focus-backdrop",document.body.appendChild(s),document.body.appendChild(n),n.querySelector(".notes").onclick=x=>{x.stopPropagation(),e.toggleNotes()},n.querySelector(".email").onclick=x=>{x.stopPropagation(),e.toggleEmail()},n.querySelector(".script").onclick=x=>{x.stopPropagation(),e.toggleScript()},n.querySelector(".links").onclick=x=>{x.stopPropagation(),e.toggleLinks()},n.querySelector(".broadcast").onclick=x=>{x.stopPropagation();let f=x.currentTarget.querySelector(".cw-badge");f&&(f.style.transform="scale(0)",setTimeout(()=>f.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let x=document.createElement("div");x.className="cw-badge",n.querySelector(".broadcast").appendChild(x)}(async function(){await rt(2800),n.classList.add("docked"),await rt(300);let f=n.querySelectorAll(".cw-btn");n.querySelectorAll(".cw-sep").forEach(T=>T.classList.add("visible"));for(let T=0;T<f.length;T++)f[T].classList.add("popped"),await rt(90);await rt(200),n.classList.add("system-check")})();let i=!1,a,l,g,p,v=3;n.onmousedown=x=>{if(x.target.closest("button"))return;x.preventDefault(),a=x.clientX,l=x.clientY;let f=n.getBoundingClientRect();g=f.left,p=f.top,document.addEventListener("mousemove",u),document.addEventListener("mouseup",m)};function u(x){let f=x.clientX-a,A=x.clientY-l;!i&&Math.sqrt(f*f+A*A)>v&&(i=!0,n.style.transition="none"),i&&(n.style.left=`${g+f}px`,n.style.top=`${p+A}px`,n.style.right="auto",n.style.bottom="auto",n.style.transform="none")}function m(x){if(document.removeEventListener("mousemove",u),document.removeEventListener("mouseup",m),i){i=!1,n.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let f=window.innerWidth,A=window.innerHeight,T=n.getBoundingClientRect(),q=T.left+T.width/2,R;q<f/2?(R=24,n.classList.remove("side-right"),n.classList.add("side-left")):(R=f-T.width-24,n.classList.remove("side-left"),n.classList.add("side-right"));let j=T.top;j<24&&(j=24),j>A-T.height-24&&(j=A-T.height-24),n.style.left=`${R}px`,n.style.top=`${j}px`}else{let f=x.target.closest("button");f&&(f.style.transform="scale(0.9)",setTimeout(()=>f.style.transform="",150))}}}function Xe(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(b)}let l=document.createElement("div");l.className="cw-zen-container";let g=document.createElement("div");Object.assign(g.style,{display:"none"});let p=document.createElement("div");p.className="cw-screens-container",g.appendChild(p),l.innerHTML=`
    ...
    `;let v=l.querySelector(".cw-hero-grid"),u=l.querySelector(".cw-acc-container"),m=l.querySelector(".cw-results-container"),x=l.querySelector(".cw-search-input"),f=l.querySelector(".cw-status-bar"),A=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");s.forEach(([b,h])=>{let r=n(h.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${b}`,c.style.setProperty("--hero-color",r.color),c.innerHTML=`
        ...
        `,c.onclick=S=>{if(S.target.closest(".cw-step-btn"))return;let d=t[b]?t[b].count:0;R(b,d>0?-d:1,h)},c.querySelector(".minus").onclick=()=>R(b,-1,h),c.querySelector(".plus").onclick=()=>R(b,1,h),c.dataset.color=r.color,v.appendChild(c)});function q(b,h){let r=n(h.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=b,c.innerHTML=`
        ...
        `,c.onclick=()=>{u.querySelectorAll(".cw-acc-group.open").forEach(d=>{d!==r&&d.classList.remove("open")}),r.classList.toggle("open")};let S=document.createElement("div");S.className="cw-acc-body",h.tasks.forEach(d=>{let y=q(d.key,d);S.appendChild(y)}),r.appendChild(c),r.appendChild(S),u.appendChild(r)});function R(b,h,r){t[b]||(t[b]={count:0,data:r,brand:n(r.name)}),t[b].count+=h,t[b].count<=0&&delete t[b],j(),U(),e&&e()}function j(){s.forEach(([S])=>{let d=v.querySelector(`#hero-${S}`);if(!d)return;let y=t[S];y?(d.classList.add("active"),d.querySelector(".cw-step-val").textContent=y.count,d.querySelector(".cw-step-val").style.color=d.dataset.color):d.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(S=>{let d=S.dataset.id,y=t[d];y?(S.classList.add("selected"),S.querySelector(".cw-step-val").textContent=y.count):S.classList.remove("selected")});let h=Object.keys(t),r=0,c=[];if(h.forEach(S=>{let d=t[S];r+=d.count;for(let y=0;y<d.count;y++)c.length<6&&c.push(d.brand)}),r>0){f.classList.add("visible");let S=r>1?"A\xE7\xF5es":"A\xE7\xE3o",d=r>1?"definidas":"definida";A.textContent=`${r} ${S} ${d}`,T.innerHTML="",c.forEach(y=>{let O=document.createElement("div");O.className="cw-mini-icon",O.innerHTML=He[y.icon]||He.default;let w=O.querySelector("svg");w&&(w.style.width="14px",w.style.height="14px"),T.appendChild(O)})}else f.classList.remove("visible")}x.addEventListener("input",b=>{let h=b.target.value.toLowerCase();if(h.length>0){u.style.display="none",m.style.display="block",m.innerHTML="";let r=!1;Object.entries(Re).forEach(([c,S])=>{if(S.name.toLowerCase().includes(h)){r=!0;let d=q(c,S);t[c]&&(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=t[c].count),m.appendChild(d)}}),r||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else u.style.display="block",m.style.display="none"});function U(){p.innerHTML="";let b=Object.keys(t),h=!1,r=document.getElementById("sub-status"),c="implementation";if(r&&r.value.toLowerCase().includes("education")&&(c="education"),b.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(b.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let S=document.createElement("div");S.className="cw-info-banner",S.innerHTML=`
  ...
  `;let d=document.createElement("div");d.style.cssText="display: flex; justify-content: space-between; align-items: baseline; margin-top: 16px; margin-bottom: 6px;";let y=document.createElement("label");y.className="cw-input-label",y.textContent="Sub-status",y.style.marginBottom="0";let O=document.createElement("a");O.href="https://seu-link-do-guia-aqui.com",O.target="_blank",O.className="cw-info-link",O.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:4px; transform:translateY(1px)"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>Guia de Substatus',Object.assign(O.style,i.helpLink),d.appendChild(y),d.appendChild(O);let w=document.createElement("select");w.id="sub-status",w.className="cw-select",w.disabled=!0,w.innerHTML='<option value="" disabled selected hidden>Aguardando status principal...</option>',r.appendChild(c),r.appendChild(S),r.appendChild(d),r.appendChild(w),u.appendChild(r);let k=document.createElement("div");k.id="step-1-1-portugal",Object.assign(k.style,i.stepBlock,{display:"none"});let F=document.createElement("label");Object.assign(F.style,i.label),k.appendChild(F);let M=document.createElement("div");Object.assign(M.style,i.radioContainer);let I=document.createElement("div");Object.assign(I.style,{display:"flex",alignItems:"center"});let z=document.createElement("input");z.type="radio",z.name="portugal-group",z.value="sim",Object.assign(z.style,i.checkboxInput);let N=document.createElement("label");N.htmlFor="portugal-sim",Object.assign(N.style,{cursor:"pointer"}),I.appendChild(z),I.appendChild(N);let Y=document.createElement("div");Object.assign(Y.style,{display:"flex",alignItems:"center"});let X=document.createElement("input");X.type="radio",X.name="portugal-group",X.value="nao",X.checked=!0,Object.assign(X.style,i.checkboxInput);let te=document.createElement("label");te.htmlFor="portugal-nao",Object.assign(te.style,{cursor:"pointer"}),Y.appendChild(X),Y.appendChild(te),M.appendChild(I),M.appendChild(Y),k.appendChild(M),u.appendChild(k);function ie(C){n=C,C?ne.style.display="block":ne.style.display="none"}z.onchange=()=>ie(!0),X.onchange=()=>ie(!1);let ne=document.createElement("div");ne.id="step-1-2-consent",Object.assign(ne.style,i.stepBlock,{display:"none"});let fe=document.createElement("label");Object.assign(fe.style,i.label),ne.appendChild(fe);let ce=document.createElement("div");Object.assign(ce.style,i.radioContainer);let ge=document.createElement("div");Object.assign(ge.style,{display:"flex",alignItems:"center"});let ve=document.createElement("input");ve.type="radio",ve.name="consent-group",ve.value="Sim",ve.checked=!0,Object.assign(ve.style,i.checkboxInput);let se=document.createElement("label");se.htmlFor="consent-sim",Object.assign(se.style,{cursor:"pointer"}),ge.appendChild(ve),ge.appendChild(se);let Z=document.createElement("div");Object.assign(Z.style,{display:"flex",alignItems:"center"});let Oe=document.createElement("input");Oe.type="radio",Oe.name="consent-group",Oe.value="N\xE3o",Object.assign(Oe.style,i.checkboxInput);let Me=document.createElement("label");Me.htmlFor="consent-nao",Object.assign(Me.style,{cursor:"pointer"}),Z.appendChild(Oe),Z.appendChild(Me),ce.appendChild(ge),ce.appendChild(Z),ne.appendChild(ce),u.appendChild(ne);let Le=document.createElement("div");Le.id="step-1-5-snippets",Object.assign(Le.style,i.stepBlock,{display:"none"});let nt=document.createElement("h3");Object.assign(nt.style,i.h3),nt.textContent="Cen\xE1rios Comuns";let Ae=so(C=>{let L=document.querySelector("textarea");L&&(L.value=C,L.dispatchEvent(new Event("input")),L.style.transition="background-color 0.2s",L.style.backgroundColor="#e8f0fe",setTimeout(()=>L.style.backgroundColor="#fff",300))});Ae.id="snippet-container",Le.appendChild(nt),Le.appendChild(Ae),u.appendChild(Le);let he=document.createElement("div");he.id="step-3-form",Object.assign(he.style,i.stepBlock,{display:"none"});let dt=document.createElement("h3");Object.assign(dt.style,i.h3),he.appendChild(dt);let _e=document.createElement("div");_e.id="dynamic-form-fields-container",he.appendChild(_e);let pe=document.createElement("button");pe.textContent="+ Gostaria de selecionar uma task?",Object.assign(pe.style,i.optionalBtn),pe.onmouseover=()=>pe.style.background="#e8f0fe",pe.onmouseout=()=>pe.style.background="white",pe.onclick=()=>{pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};let De=document.createElement("h3");Object.assign(De.style,i.h3,{marginTop:"20px"});let Nt=l.selectionElement;Object.assign(Nt.style,{marginBottom:"20px"}),he.appendChild(pe),he.appendChild(De),he.appendChild(Nt),he.appendChild(a.element),he.appendChild(l.screenshotsElement),u.appendChild(he);let Fe=document.createElement("div");Fe.id="step-4-email",Object.assign(Fe.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let Ge=document.createElement("label");Ge.style.display="flex",Ge.style.alignItems="center",Ge.style.cursor="pointer",Ge.style.fontSize="14px";let ze=document.createElement("input");ze.type="checkbox",ze.checked=!0,Object.assign(ze.style,i.checkboxInput),Ge.appendChild(ze),Ge.appendChild(document.createTextNode("Preencher email automaticamente?")),Fe.appendChild(Ge),u.appendChild(Fe);let Ue=document.createElement("div");Object.assign(Ue.style,{display:"none",gap:"8px",padding:"0"}),u.appendChild(Ue);let Ke=document.createElement("button");Object.assign(Ke.style,i.buttonBase,{backgroundColor:"#5f6368"}),Ke.textContent="Copiar";let Qe=document.createElement("button");Object.assign(Qe.style,i.buttonBase,{backgroundColor:"#1a73e8"}),Qe.textContent="Preencher",Ue.appendChild(Ke),Ue.appendChild(Qe);let Ze=document.createElement("div");Object.assign(Ze.style,We),Ze.className="no-drag",Ze.title="Redimensionar",g.appendChild(Ze),Ye(g,Ze),document.body.appendChild(g);function pt(C){t=C;let L=Je();Object.assign(b.style,be),Object.assign(h.style,be),C==="bau"?(Object.assign(b.style,L),O.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(h.style,L),O.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),w.value&&w.dispatchEvent(new Event("change"))}function P(C){try{if(Ne&&Ne[o]&&Ne[o][C])return Ne[o][C];if(Ne&&Ne.pt&&Ne.pt[C])return Ne.pt[C]}catch{}return C}function vo(){f.textContent=P("idioma"),j.textContent=P("fluxo"),c.textContent=P("status_principal"),y.textContent=P("substatus"),nt.textContent=P("cenarios_comuns"),De.textContent=P("selecione_tasks"),dt.textContent=P("preencha_detalhes"),Ke.textContent=P("copiar"),Qe.textContent=P("preencher"),S.querySelector('option[value=""]')&&(S.querySelector('option[value=""]').textContent=P("select_status")),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=P("select_substatus")),F.textContent=P("caso_portugal"),N.textContent=P("sim"),te.textContent=P("nao"),fe.textContent=P("consentiu_gravacao"),se.textContent=P("sim"),Me.textContent=P("nao"),_e.querySelectorAll("label").forEach(C=>{let L=C.nextElementSibling.id.replace("field-",""),E=P(L.toLowerCase());E!==L.toLowerCase()?C.textContent=E:C.textContent=L.replace(/_/g," ").replace(/\b\w/g,H=>H.toUpperCase())+":"}),pe.textContent="+ "+(o==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function ut(C){o=C;let L=Je();Object.assign(T.style,be),Object.assign(q.style,be),C==="pt"?(Object.assign(T.style,L),k.style.display="block",ie(n)):(Object.assign(q.style,L),k.style.display="none",ne.style.display="none"),vo(),w.value&&w.dispatchEvent(new Event("change"))}function mt(C){(C.value.trim()===""||C.value.trim()==="\u2022")&&(C.value="\u2022 "),C.onkeydown=function(L){if(L.key==="Enter"){L.preventDefault();let E=this.selectionStart,H=this.selectionEnd,oe=this.value,le=oe.lastIndexOf(`
`,E-1)+1,xe=oe.substring(le,E),de=xe.trim()==="\u2022"||xe.trim()===""?`
`:`
\u2022 `;this.value=oe.substring(0,E)+de+oe.substring(H),this.selectionStart=this.selectionEnd=E+de.length}else if(L.key==="Backspace"){let E=this.selectionStart;if(E===this.selectionEnd&&E>0){let H=this.value.substring(0,E);H.endsWith(`
...
`),_.trim()!=="\u2022"&&_.trim()!==""?W.value=_:ot.includes(K.replace("field-",""))?W.value="\u2022 ":W.value="",W.tagName==="TEXTAREA"&&typeof mt=="function"&&mt(W)}});let le=new Set,xe=new Set;C.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(K=>{let W=Se[K.id];W&&W.linkedTask&&(K.checked?le.add(W.linkedTask):xe.add(W.linkedTask))}),xe.forEach(K=>{le.has(K)||l.toggleTask(K,!1)}),le.forEach(K=>{l.toggleTask(K,!0)})}S.onchange=()=>{let C=S.value;if(bt(1.5),w.innerHTML=`<option value="">${P("select_substatus")}</option>`,!C){w.disabled=!0;return}for(let L in tt){let E=tt[L];if(E.status===C){let H=document.createElement("option");H.value=L,H.textContent=E.name,w.appendChild(H)}}w.disabled=!1},w.onchange=()=>{let C=w.value;if(bt(1.5),!C)return;l.updateSubStatus(C);let L=tt[C];Ae.innerHTML="";let E=(D,_,$)=>{let re=document.createElement("label");Object.assign(re.style,i.checkboxLabel),re.onmouseover=()=>re.style.backgroundColor="#e8eaed",re.onmouseout=()=>re.style.backgroundColor="#f8f9fa";let J=document.createElement("input");return J.type=_,J.id=D.id,Object.assign(J.style,i.checkboxInput),re.appendChild(J),re.appendChild(document.createTextNode(` ${D.text}`)),$.appendChild(re),J},H=[],oe="radio";if(C==="NI_Awaiting_Inputs")H=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(C.startsWith("SO_"))oe="checkbox",H=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(C.startsWith("AS_")){oe="checkbox";let D=document.createElement("label");D.textContent=P("cenarios_comuns"),Object.assign(D.style,i.label),Ae.appendChild(D),H=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else C.startsWith("IN_")?H=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]:C.startsWith("DC_")&&(oe="radio",H=[{id:"quickfill-dc-lm-no-access",text:"LM - Sem acessos (Reagendar em BAU)"}]);let le=H.filter(D=>{let _=Se[D.id];return!_.type||_.type==="all"||_.type===t});le.forEach((D,_)=>{let $=E(D,oe,Ae);oe==="radio"&&($.name="scenario-radio-group",_===0&&($.checked=!0))}),le.length>0&&(Le.style.display="block"),L.requiresTasks?(pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"):(pe.style.display="block",De.style.display="none",l.selectionElement.style.display="none"),_e.innerHTML="";let xe=L.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(xe)].forEach(D=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(D))return;let _=D.slice(1,-1),$=document.createElement("label"),re=P(_.toLowerCase());if($.textContent=re!==_.toLowerCase()?re:_.replace(/_/g," ").replace(/\b\w/g,B=>B.toUpperCase())+":",Object.assign($.style,i.label),_==="SPEAKEASY_ID"){let B=document.createElement("button");B.innerHTML='<span style="font-size:12px; margin-right:4px;">\u2728</span>Auto Busca',B.style.cssText=`
              font-family: 'Google Sans', Roboto, sans-serif;
              font-size: 11px;
              font-weight: 500;
          ...
          `,B.title="Localizar Speakeasy ID no hist\xF3rico",B.onmouseover=()=>{B.style.backgroundColor="#c2e7ff",B.style.boxShadow="0 1px 2px rgba(0,0,0,0.1)"},B.onmouseout=()=>{B.style.backgroundColor="#d3e3fd",B.style.boxShadow="none"},B.onmousedown=()=>{B.style.backgroundColor="#a8c7fa",B.style.transform="scale(0.96)"},B.onmouseup=()=>B.style.transform="scale(1)",B.onclick=ue=>{ue.preventDefault(),Xt(`field-${_}`)},$.appendChild(B)}let J;ot.includes(_)?(J=document.createElement("textarea"),Object.assign(J.style,i.textarea),J.classList.add("bullet-textarea"),mt(J)):St.includes(_)?(J=document.createElement("textarea"),Object.assign(J.style,i.textarea)):(J=document.createElement("input"),J.type="text",Object.assign(J.style,i.input),_==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))&&(Object.assign($.style,{display:"none"}),Object.assign(J.style,{display:"none"}))),_==="ON_CALL"&&t==="lm"&&(Object.assign($.style,{display:"none"}),Object.assign(J.style,{display:"none"}),J.value="N/A"),J.id=`field-${_}`,_e.appendChild($),_e.appendChild(J)});let K=Ae.querySelectorAll('input[type="checkbox"], input[type="radio"]');K.length>0&&(K.forEach(D=>{D.removeEventListener("change",gt),D.addEventListener("change",gt)}),gt()),he.style.display="block",st[C]?Fe.style.display="block":Fe.style.display="none",Ue.style.display="flex";let W=l.getCheckedElements().map(D=>D.value);a.updateVisibility(C,W)},pe.onclick=()=>{pe.style.display="none",De.style.display="block",l.selectionElement.style.display="block"};function _t(){let C=w.value;if(!C)return null;let E=tt[C].template.replace(/\n/g,"<br>"),H='style="margin-bottom: 12px; padding-left: 30px;"',oe=[],le="",xe=l.getCheckedElements();xe.length>0&&xe.forEach(W=>{let D=W.value,_=Re[D],$=W.closest().querySelector(".stepper-count"),re=$?parseInt($.textContent):1;re>1?oe.push(`${_.name} (x${re})`):oe.push(_.name)});let de=l.screenshotsElement;if(de){let W=Array.from(de.querySelectorAll('input[id^="name-"]'));W.length>0&&W.forEach(D=>{let _=D.value,$=D.closest(".cw-screen-card");if($){let re=$.querySelectorAll('input[id^="screen-"]'),J=!1,B="";re.forEach(ue=>{let Rt=ue.closest(".cw-input-group"),Mt=Rt?Rt.querySelector(".cw-input-label"):null,Ao=Mt?Mt.textContent:"Evid\xEAncia",Lt=ue.value.trim(),wo=Lt?` ${Lt}`:"";B+=`<li>${Ao} -${wo}</li>`,J=!0}),J&&(le+=`<b>${_}</b>`,le+=`<ul ${H}>${B}</ul>`)}})}if(E.includes("{TAGS_IMPLEMENTED}")?E=E.replace(/{TAGS_IMPLEMENTED}/g,oe.join(", ")||"N/A"):oe.length>0&&(E+=`<br><b>Tags:</b> ${oe.join(", ")}<br>`),E.includes("{SCREENSHOTS_LIST}")?E=E.replace(/{SCREENSHOTS_LIST}/g,le?`${le}`:"N/A"):le!==""&&(E+=`<br>${le}`),o==="pt"&&n){let W=ve.checked?P("sim"):P("nao");E=E.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${P("consentiu_gravacao")}</b> ${W}<br><br>`),E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${P("caso_portugal")}</b> ${P("sim")}<br>`)}else o==="pt"&&!n?(E=E.replace(/{CASO_PORTUGAL}/g,`<br><b>${P("caso_portugal")}</b> ${P("nao")}<br>`),E=E.replace(/{CONSENTIU_GRAVACAO}/g,"")):(E=E.replace(/{CASO_PORTUGAL}/g,""),E=E.replace(/{CONSENTIU_GRAVACAO}/g,""));return _e.querySelectorAll("input, textarea").forEach(W=>{let D=W.id.replace("field-",""),_=new RegExp(`{${D}}`,"g"),$=W.value;if(D==="REASON_COMMENTS"&&(C.startsWith("NI_")||C.startsWith("IN_"))){let B=Ae.querySelector('input[type="radio"]:checked');B&&Se[B.id]&&($=Se[B.id]["field-REASON_COMMENTS"])}if(ot.includes(D)&&$.trim()!==""){let B=$.split(`
`).map(ue=>ue.trim()).filter(ue=>ue!==""&&ue!=="\u2022").map(ue=>ue.startsWith("\u2022 ")?ue.substring(2):ue).map(ue=>`<li>${ue}</li>`).join("");$=B?`<ul ${H}>${B}</ul>`:""}else St.includes(D)?$=$.split(`
`).filter(B=>B.trim()!=="").map(B=>`<p style="margin: 0 0 8px 0;">${B}</p>`).join(""):W.tagName==="TEXTAREA"&&($=$.replace(/\n/g,"<br>"));let re=$.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(re===""||re==="\u2022"||re.toLowerCase()==="n/a"){let B=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${D}\\}(?:<br>\\s*)?`,"gi");B.test(E)?E=E.replace(B,""):E=E.replace(_,"")}else E=E.replace(_,$.replace(/\$/g,"$$$$"))}),E=E.replace(/{([A-Z0-9_]+)}/g,""),E=E.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(E+=a.getOutput()),E}Ke.onclick=()=>{let C=_t();C?(Ot(C),ee(P("copiado_sucesso"))):ee(P("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let C=w.value,L=_t();if(!L){ee(P("selecione_substatus"),{error:!0});return}Ot(L),ft();let E=Xe(),H=await po();if(H)try{if(H.focus(),H.innerHTML.trim()==="<p><br></p>"||H.innerHTML.trim()==="<br>"||H.innerText.trim()===""){let de=document.createRange();de.selectNodeContents(H);let K=window.getSelection();K.removeAllRanges(),K.addRange(de),document.execCommand("delete",!1,null)}else if(!H.innerHTML.endsWith("<br><br>")){let de=document.createRange();de.selectNodeContents(H),de.collapse(!1);let K=window.getSelection();K.removeAllRanges(),K.addRange(de),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,L),co(H),setTimeout(()=>{ee(P("inserido_copiado"))},600);let le=typeof ze<"u"&&ze?ze.checked:!0;if(C&&st[C]&&le){let de=st[C];await Jt(de),await new Promise(K=>setTimeout(K,500))}E(),bt(1.5),S.value="",w.innerHTML=`<option value="">${P("select_substatus")}</option>`,w.disabled=!0}catch(oe){console.error(oe),ee("Erro ao inserir.",{error:!0}),E()}};function bt(C=1.5){C<=1.5&&(Le.style.display="none",Ae.innerHTML=""),C<=2&&(l.reset(),pe.style.display="none"),C<=3&&(he.style.display="none",_e.innerHTML="",a.reset(),Ue.style.display="none",Fe.style.display="none")}function ft(){if(s=!s,s){let C=g.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Te(s,g,"cw-btn-notes")}return pt("bau"),ut("pt"),ft}var Ve={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>

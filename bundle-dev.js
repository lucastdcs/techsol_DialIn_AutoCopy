...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let g=r.querySelector(".cw-hero-grid"),d=r.querySelector(".cw-acc-container"),x=r.querySelector(".cw-results-container"),A=r.querySelector(".cw-search-input"),v=r.querySelector(".cw-status-bar"),b=r.querySelector(".cw-status-text"),S=r.querySelector(".cw-footer-icons");s.forEach(([O,k])=>{let L=o(k.name),D=document.createElement("div");D.className="cw-hero-card",D.id=`hero-${O}`,D.style.setProperty("--hero-color",L.color),D.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${Ye[L.icon]}</div>
        ...
        `,D.onclick=N=>{if(N.target.closest(".cw-step-btn"))return;let T=e[O]?e[O].count:0;G(O,T>0?-T:1,k)},D.querySelector(".minus").onclick=()=>G(O,-1,k),D.querySelector(".plus").onclick=()=>G(O,1,k),D.dataset.color=L.color,g.appendChild(D)});function E(O,k){let L=o(k.name),D=document.createElement("div");return D.className="cw-task-item",D.dataset.id=O,D.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${L.bg}; color:${L.color}">
                    ${Ye[L.icon]||Ye.default}
                </div>
        ...
        `,m.appendChild(N),O.forEach(T=>{let B=e[T].data,f=e[T].count,h=e[T].brand,I=B.screenshots?B.screenshots[D]||[]:["Link da Evid\xEAncia"];if(I.length>0){k=!0;for(let l=1;l<=f;l++){let c=document.createElement("div");c.className="cw-screen-card",c.style.setProperty("--brand-color",h.color),c.style.setProperty("--brand-bg",h.bg),c.style.setProperty("--brand-shadow",h.color+"40");let y=document.createElement("div");y.className="cw-card-header";let p=document.createElement("div");p.className="cw-card-icon",p.innerHTML=Ye[h.icon]||Ye.default;let w=document.createElement("div");w.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let q=document.createElement("input");q.className="cw-card-title-input",q.id=`name-${T}-${l}`,q.value=`${B.name}${f>1?" #"+l:""}`,q.title="Clique para renomear esta task";let P=document.createElement("span");P.className="cw-edit-hint",P.innerHTML="\u270E Renomear",w.appendChild(q),w.appendChild(P),y.appendChild(p),y.appendChild(w),c.appendChild(y),I.forEach((_,F)=>{let j=document.createElement("div");j.className="cw-input-group";let V=document.createElement("label");V.className="cw-input-label",V.textContent=_.replace(/📷|:|•/g,"").trim();let M=document.createElement("input");M.className="cw-input-field",M.id=`screen-${T}-${l}-${F}`,M.placeholder="Cole o link aqui...",M.setAttribute("autocomplete","off"),M.addEventListener("input",()=>{M.value.trim().length>5?M.classList.add("filled"):M.classList.remove("filled")});let z=document.createElement("div");z.className="cw-input-check",z.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',j.appendChild(V),j.appendChild(M),j.appendChild(z),c.appendChild(j)}),m.appendChild(c)}}}),u.style.display=k?"block":"none"}return{selectionElement:r,screenshotsElement:u,updateSubStatus:()=>X(),getCheckedElements:()=>Object.keys(e).map(O=>({value:O,closest:()=>({querySelector:()=>({textContent:e[O].count})})})),toggleTask:(O,k=!0)=>{let L=e[O];k&&!L?G(O,1,ze[O]):!k&&L&&G(O,-L.count,ze[O])},setMode:O=>{n=O,X()},reset:()=>{for(let O in e)delete e[O];A.value="",d.style.display="block",x.style.display="none",Q(),X()}}}function So(t){let e=document.createElement("div");e.style.cssText="display: flex; flex-direction: column; height: 100%; width: 100%; background: #F8F9FA; overflow: hidden; position: relative;";let n=document.createElement("div");n.style.cssText="flex: 1; overflow-y: auto; padding: 20px 24px 80px 24px; min-height: 0;";let o={sectionTitle:`
            font-family: 'Google Sans', Roboto, sans-serif;
            font-size: 11px; 
            font-weight: 700; 
            color: #5F6368; 
        ...
        `};function s(h,I,l="text",c=""){let y=document.createElement("div");y.style.cssText=o.inputWrapper;let p=document.createElement("label");p.style.cssText=o.label,p.textContent=I;let w;l==="textarea"?(w=document.createElement("textarea"),w.style.cssText=o.input+o.textarea):(w=document.createElement("input"),w.type=l,w.style.cssText=o.input);let q=w.style.cssText;return w.onfocus=()=>w.style.cssText=q+o.inputFocus,w.onblur=()=>w.style.cssText=q,w.id=`st-${h}`,w.placeholder=c,y.appendChild(p),y.appendChild(w),{wrapper:y,input:w}}function i(h,I){let l=document.createElement("div"),c=document.createElement("label");c.style.cssText=o.label,c.textContent=I,l.appendChild(c);let y=document.createElement("div");return y.style.cssText=o.radioGroup,["Yes","No"].forEach(p=>{let w=document.createElement("label");w.style.cssText=o.radioLabel;let q=document.createElement("input");q.type="radio",q.name=`st-${h}`,q.value=p==="Yes"?"Y":"N",q.style.display="none",p==="No"&&(q.checked=!0),w.onmousedown=()=>w.style.transform="scale(0.96)",w.onmouseup=()=>w.style.transform="scale(1)",w.onmouseleave=()=>w.style.transform="scale(1)",w.appendChild(q),w.appendChild(document.createTextNode(p)),q.addEventListener("change",()=>{y.querySelectorAll("label").forEach(P=>P.style.cssText=o.radioLabel),q.checked&&(w.style.cssText=o.radioLabel+o.radioActive)}),p==="No"&&(w.style.cssText=o.radioLabel+o.radioActive),y.appendChild(w)}),l.appendChild(y),{wrapper:l}}let a=document.createElement("div");a.style.cssText=o.banner,a.innerHTML=`
...
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):ie.tagName==="TEXTAREA"&&(ae=ae.replace(/\n/g,"<br>"));let me=ae.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(me===""||me==="\u2022"||me.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${Y}\\}(?:<br>\\s*)?`,"gi");ee.test(R)?R=R.replace(ee,""):R=R.replace(H,"")}else R=R.replace(H,ae.replace(/\$/g,"$$$$"))}),R=R.replace(/{([A-Z0-9_]+)}/g,""),R=R.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(R+=r.getOutput()),R}ot.onclick=()=>{let C=Xt();C?(dt(C),$(oe("copiado_sucesso"))):$(oe("selecione_substatus"),{error:!0})},nt.onclick=async()=>{let C=p.value,U=Xt();if(!U){$(oe("selecione_substatus"),{error:!0});return}dt(U),_t();let R=Ct(),J=await Tt();if(J)try{if(J.focus(),J.innerHTML.trim()==="<p><br></p>"||J.innerHTML.trim()==="<br>"||J.innerText.trim()===""){let be=document.createRange();be.selectNodeContents(J);let re=window.getSelection();re.removeAllRanges(),re.addRange(be),document.execCommand("delete",!1,null)}else if(!J.innerHTML.endsWith("<br><br>")){let be=document.createRange();be.selectNodeContents(J),be.collapse(!1);let re=window.getSelection();re.removeAllRanges(),re.addRange(be),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,U),Et(J),setTimeout(()=>{$(oe("inserido_copiado"))},600);let ge=typeof $e<"u"&&$e?$e.checked:!0;if(C&&We[C]&&ge){let be=We[C];await vt(be),await new Promise(re=>setTimeout(re,500))}R(),Mt(1.5),I.value="",p.innerHTML=`<option value="">${oe("select_substatus")}</option>`,p.disabled=!0}catch(ce){console.error(ce),$("Erro ao inserir.",{error:!0}),R()}};function Mt(C=1.5){C<=1.5&&(Be.style.display="none",Oe.innerHTML=""),C<=2&&(u.reset(),he.style.display="none"),C<=3&&(Ce.style.display="none",De.innerHTML="",r.reset(),Qe.style.display="none",je.style.display="none")}function _t(){if(s=!s,s){let C=m.querySelector(".cw-expand-btn");C&&typeof C.resetState=="function"&&C.resetState()}Te(s,m,"cw-btn-notes")}return It("bau"),qt("pt"),_t}var Xe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
        ...
        `;let F=h.querySelector("#csa-back-btn");F.onmouseenter=()=>F.style.background="#f1f3f4",F.onmouseleave=()=>F.style.background="none",F.onclick=c;let j=h.querySelector("#csa-insert-btn");j.onmouseenter=()=>{j.style.transform="translateY(-1px)",j.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},j.onmouseleave=()=>{j.style.transform="translateY(0)",j.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},j.onclick=()=>{j.style.transform="scale(0.96)",I(q,"email"),setTimeout(()=>{j.style.transform="scale(1)",c()},300)}}function c(){s="list",k.style.transform="translateX(0)"}function y(q,P,_=null){let F=document.createElement("button"),j=_?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${_}</span>`:"";return F.innerHTML=`${j}${q}`,Object.assign(F.style,A),n===P&&o===""?Object.assign(F.style,v):(F.onmouseenter=()=>{F.style.background="#F1F3F4",F.style.borderColor="#DADCE0"},F.onmouseleave=()=>{F.style.background="#FFFFFF",F.style.borderColor="#DADCE0"}),F.onclick=()=>{n=P,o="",N.value="",p(),w()},F}function p(){T.innerHTML="",T.appendChild(y("Smart CRs",e,"\u26A1")),Object.keys(Xe).forEach(q=>{T.appendChild(y(Xe[q].title,q))})}function w(){B.innerHTML="";let q=[];if(o.trim()!==""){let V=o.toLowerCase();Object.values(Xe).forEach(M=>{M.emails.forEach(z=>{(z.name.toLowerCase().includes(V)||z.subject.toLowerCase().includes(V))&&q.push({type:"email",data:z})})}),Object.entries(We).forEach(([M,z])=>{if(!z)return;(M.replace(/_/g," ").toLowerCase().includes(V)||z.toLowerCase().includes(V))&&q.push({type:"cr",key:M,code:z})})}else n===e?Object.entries(We).forEach(([V,M])=>{M&&q.push({type:"cr",key:V,code:M})}):Xe[n]&&Xe[n].emails.forEach(V=>{q.push({type:"email",data:V})});if(q.length===0){B.innerHTML=`
                ...
                `,M.onclick=()=>l(z)}else{let z=V.key.replace(/_/g," ").replace("AS ","AS - ").replace("NI ","NI - ");M.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function Oo(){let t="v2.1 (Apple Motion)",e={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Se,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function u(){i=!i,Te(i,a,"cw-btn-script")}let m=Ee(a,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{u()});a.appendChild(m);let g=document.createElement("div");Object.assign(g.style,e.progressBarContainer);let d=document.createElement("div");Object.assign(d.style,e.progressBarFill),g.appendChild(d),a.appendChild(g);let x=document.createElement("div");x.id="csa-content",Object.assign(x.style,e.contentArea),a.appendChild(x);let A=document.createElement("div");Object.assign(A.style,e.footer);let v=document.createElement("span");v.textContent="by lucaste@",Object.assign(v.style,{fontSize:"10px",color:"#bdc1c6"});let b=document.createElement("button");b.innerHTML=`
  ...
  `,b.onfocus=()=>{A.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",A.style.border="1px solid #1a73e8"},b.onblur=()=>{A.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",A.style.border="1px solid transparent"},A.appendChild(v),A.appendChild(b),x.appendChild(A),d.appendChild(x);let S=document.createElement("div");S.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",d.appendChild(S);let E=null;function G(){if(E)return;E=document.createElement("div"),E.style.cssText=`
      ...
      `;let f=document.createElement("div");f.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",f.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let h=document.createElement("button");h.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',h.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",h.onclick=()=>{X(),s=!1,D()},f.appendChild(h),E.appendChild(f);let I=document.createElement("div");I.id="cw-history-list",I.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",E.appendChild(I),d.appendChild(E)}function Q(){E||G();let f=E.querySelector("#cw-history-list");f.innerHTML="";let h=Zo();h.length===0?f.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':h.forEach(I=>{let l=T(I,Ke[I._originalCat],!0,I._originalCat);f.appendChild(l)}),requestAnimationFrame(()=>E.style.transform="translateY(0)")}function X(){E&&(E.style.transform="translateY(100%)")}function O(){g.innerHTML="";let f=k("history","Recentes",Ke.history);f.id="cw-sidebar-btn-history",f.onclick=()=>{W.playClick(),s=!s,s?Q():X(),D()},g.appendChild(f);let h=document.createElement("div");h.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",g.appendChild(h),Object.keys(pt).forEach(I=>{let l=pt[I],c=k(I,l.label,Ke[I]);c.id=`cw-sidebar-btn-${I}`,c.onclick=()=>{W.playClick(),s&&(s=!1,X()),L(I)},g.appendChild(c)})}function k(f,h,I){let l=document.createElement("div");l.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,l.title=h,l.dataset.key=f;let c=document.createElement("div");c.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",c.innerHTML=I||Ke.tasks;let y=document.createElement("div");return y.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",y.textContent=h,l.appendChild(c),l.appendChild(y),l.onmouseenter=()=>{o!==f&&!(f==="history"&&s)&&(l.style.background="#F1F3F4",c.style.transform="scale(1.1)")},l.onmouseleave=()=>{o!==f&&!(f==="history"&&s)&&(l.style.background="transparent",c.style.transform="scale(1)")},l}function L(f){let h=document.getElementById(`cat-anchor-${f}`);h&&(h.scrollIntoView({behavior:"smooth",block:"start"}),o=f,D())}function D(){Object.keys(pt).forEach(h=>{let I=g.querySelector(`#cw-sidebar-btn-${h}`);if(I)if(o===h&&!s){let l=kt[h];I.style.background=l.bg,I.style.color=l.color,I.querySelector("div:first-child").style.transform="scale(1.1)"}else I.style.background="transparent",I.style.color=i.textSecondary,I.querySelector("div:first-child").style.transform="scale(1)"});let f=g.querySelector("#cw-sidebar-btn-history");f&&(s?(f.style.background="#3C4043",f.style.color="#FFFFFF"):(f.style.background="transparent",f.style.color=i.textSecondary))}function N(){if(S.innerHTML="",e.trim()!==""){let h=[];if(Object.entries(pt).forEach(([l,c])=>{let y=c.links.filter(p=>p.name.toLowerCase().includes(e.toLowerCase())||p.desc.toLowerCase().includes(e.toLowerCase()));h.push(...y.map(p=>({...p,_cat:l})))}),h.length===0){S.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let I=document.createElement("div");I.innerHTML="Resultados da busca",I.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",S.appendChild(I),h.forEach(l=>{let c=T(l,Ke[l._cat],!1,l._cat);S.appendChild(c)});return}Object.entries(pt).forEach(([h,I])=>{let l=kt[h],c=document.createElement("div"),y=document.createElement("div");y.id=`cat-anchor-${h}`,y.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,y.innerHTML=`
            ...
            ${I.label}
          `,c.appendChild(y);let p=document.createElement("div");p.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",I.links.forEach(w=>{let q=T(w,Ke[h],!1,h);p.appendChild(q)}),c.appendChild(p),S.appendChild(c)});let f=document.createElement("div");f.style.height="80px",S.appendChild(f)}function T(f,h,I,l){let c=document.createElement("div"),y=kt[l]||kt.history;c.style.cssText=`
...
`),M=/\d{1,2}\/\d{1,2}/;if(V.forEach(le=>{let ue=le.match(M);if(ue){let Ae=ue[0],Le="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(le)?Le="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(le)&&(Le="\u{1F1EA}\u{1F1F8}"),j.some(Re=>Re.flag===Le&&Re.date===Ae)||j.push({flag:Le,date:Ae})}}),j.length===0){let le=(_.text||"").match(/\d{1,2}\/\d{1,2}/g);le&&[...new Set(le)].forEach(ue=>j.push({flag:"\u{1F4C5}",date:ue}))}let z="",Z='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(Z=`
        ...
        `,h.appendChild(I),h.appendChild(l),S.appendChild(h);let c=document.createElement("div");c.id="cw-planner-status",Object.assign(c.style,r.statusBadge),S.appendChild(c);let y=document.createElement("div");Object.assign(y.style,{padding:"0 8px"});let p=document.createElement("div");p.textContent="Arraste para simular o hor\xE1rio:",p.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:8px;";let w=document.createElement("div");Object.assign(w.style,r.timelineContainer);let q=document.createElement("div");Object.assign(q.style,r.timelineTrack);let P=document.createElement("input");P.type="range",P.min="0",P.max="1439",P.step="15",P.style.cssText="position:absolute; top:14px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let _=document.createElement("div");_.style.cssText="position:absolute; top:32px; width:100%; display:flex; justify-content:space-between; font-size:10px; color:#9AA0A6; padding:0 2px;",_.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>23h</span>",w.appendChild(q),w.appendChild(P),w.appendChild(_),y.appendChild(p),y.appendChild(w),S.appendChild(y);let F=I.querySelector("#cw-time-input-br"),j=l.querySelector("#cw-time-display-client"),V=l.querySelector("#cw-client-label");function M(){let z=Wt.find(Ae=>Ae.id===o);V.textContent=`${z.flag} ${z.label} (${z.zone})`;let Z=i.getHours(),te=i.getMinutes(),se=`${String(Z).padStart(2,"0")}:${String(te).padStart(2,"0")}`;F.value=se,P.value=Z*60+te;let le=i.toLocaleTimeString("pt-BR",{timeZone:z.zone,hour:"2-digit",minute:"2-digit"});j.textContent=le;let ue=parseInt(le.split(":")[0]);ue>=9&&ue<17?(c.style.background="#E6F4EA",c.style.color="#137333",c.innerHTML="\u2705 Hor\xE1rio Comercial Ideal"):ue>=8&&ue<9||ue>=17&&ue<19?(c.style.background="#FEF7E0",c.style.color="#B06000",c.innerHTML="\u26A0\uFE0F Hor\xE1rio Limite (Aten\xE7\xE3o)"):(c.style.background="#FCE8E6",c.style.color="#C5221F",c.innerHTML="\u26D4 Fora de Hor\xE1rio (Noite/Fechado)")}P.oninput=z=>{let Z=parseInt(z.target.value);i.setHours(Math.floor(Z/60)),i.setMinutes(Z%60),M()},F.oninput=z=>{let[Z,te]=z.target.value.split(":");Z&&te&&(i.setHours(parseInt(Z)),i.setMinutes(parseInt(te)),M())},M()}function k(){X(),n||(n=setInterval(X,6e4))}function L(){n&&(clearInterval(n),n=null)}function D(T){return Object.entries(T).map(([B,f])=>`${B.replace(/[A-Z]/g,h=>"-"+h.toLowerCase())}:${f}`).join(";")}function N(){e=!e,Te(e,u,"cw-btn-timezone"),e?E("live"):L()}return document.body.appendChild(u),N}function on(){if(window.techSolInitialized){Gt();return}window.techSolInitialized=!0;let t="v4.5.1";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{io();try{W.initGlobalListeners(),W.playStartup()}catch(r){console.warn("\xC1udio bloqueado:",r)}we.fetchTips(),Gt();let e=Eo(),n=To(),o=Oo(),s=qo(),i=Ro(),a=Fo();xo({toggleNotes:e,toggleEmail:n,toggleScript:o,toggleLinks:s,toggleTimezone:i,broadcastControl:a}),setTimeout(()=>{we.logEvent("App","Start","Session Start"),Lo(),setTimeout(()=>{_o(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),$("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}on();})();

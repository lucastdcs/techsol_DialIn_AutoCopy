(()=>{var at="",bo=e=>new Promise(t=>setTimeout(t,e));async function Mt(){if(at)return at;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await bo(100);let t="Consultor",n=document.querySelector("profile-details .name");if(n)t=n.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let r=o.src.match(/\/photos\/([^\?]+)/)[1];t=r.charAt(0).toUpperCase()+r.slice(1)}}return e.click(),document.body.click(),at=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function ft(){return at||"Consultor"}function Dt(e){let t=new Date,n=t.getHours(),o=t.getDay(),r="Ol\xE1",i="";n>=5&&n<12?(r="Bom dia",i='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):n>=12&&n<18?(r="Boa tarde",i='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(r="Boa noite",i='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let a=[];n>=0&&n<5?a=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:n<12?o===1?a=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?a=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:a=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:n<18?a=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:a=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(a=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let l=a[Math.floor(Math.random()*a.length)];return{prefix:`${r},`,name:e,suffix:l,icon:i,isFriday:o===5}}function ht(){let e="Cliente",t="[INSERIR URL]";try{let o=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let r=o.nextElementSibling.innerText.trim();r&&(e=r)}}catch(n){console.warn("Falha ao capturar Nome:",n)}try{let o=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let r=o.nextElementSibling.innerText.trim();r&&(t=r)}}catch(n){console.warn("Falha ao capturar Website:",n)}return{advertiserName:e,websiteUrl:t,agentName:ft()}}var Be=null,xt=null,qe=.3;function ze(){if(!Be){let e=window.AudioContext||window.webkitAudioContext;e&&(Be=new e)}return Be&&Be.state==="suspended"&&Be.resume(),Be}function yt(e){if(xt)return xt;let t=e.sampleRate*2,n=e.createBuffer(1,t,e.sampleRate),o=n.getChannelData(0);for(let r=0;r<t;r++)o[r]=Math.random()*2-1;return xt=n,n}var J={playClick:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=yt(e);let o=e.createBiquadFilter();o.type="highpass",o.frequency.value=4e3;let r=e.createGain();r.gain.setValueAtTime(qe*.8,t),r.gain.exponentialRampToValueAtTime(.001,t+.015),n.connect(o),o.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.02)},playHover:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createOscillator();n.type="sine",n.frequency.setValueAtTime(400,t);let o=e.createGain();o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(qe*.1,t+.005),o.gain.linearRampToValueAtTime(0,t+.02),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.03)},playSuccess:()=>{let e=ze();if(!e)return;let t=e.currentTime;[1046.5,1567.9].forEach((o,r)=>{let i=e.createOscillator(),a=e.createGain();i.type="sine",i.frequency.value=o,a.gain.setValueAtTime(0,t),a.gain.linearRampToValueAtTime(qe*.6,t+.05),a.gain.exponentialRampToValueAtTime(.001,t+.6),i.connect(a),a.connect(e.destination),i.start(t),i.stop(t+.7)})},playGenieOpen:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=yt(e);let o=e.createBiquadFilter();o.type="lowpass",o.frequency.setValueAtTime(100,t),o.frequency.exponentialRampToValueAtTime(800,t+.2);let r=e.createGain();r.gain.setValueAtTime(0,t),r.gain.linearRampToValueAtTime(qe*.5,t+.05),r.gain.linearRampToValueAtTime(0,t+.25),n.connect(o),o.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.3)},playError:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="triangle",n.frequency.setValueAtTime(120,t),n.frequency.exponentialRampToValueAtTime(80,t+.1),o.gain.setValueAtTime(qe,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.2)},playStartup:()=>{let e=ze();if(!e)return;let t=e.currentTime,n=e.createOscillator(),o=e.createGain();n.type="sine",n.frequency.setValueAtTime(50,t),n.frequency.exponentialRampToValueAtTime(150,t+.3),o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(qe*1.5,t+.05),o.gain.exponentialRampToValueAtTime(.001,t+.4),n.connect(o),o.connect(e.destination),n.start(t),n.stop(t+.4),[{freq:880,start:.1},{freq:1318,start:.18}].forEach(i=>{let a=e.createOscillator(),l=e.createGain();a.type="sine",a.frequency.setValueAtTime(i.freq,t),l.gain.setValueAtTime(0,t),l.gain.setValueAtTime(0,t+i.start),l.gain.linearRampToValueAtTime(qe*.8,t+i.start+.02),l.gain.exponentialRampToValueAtTime(.001,t+i.start+.3),a.connect(l),l.connect(e.destination),a.start(t),a.stop(t+i.start+.35)});try{let i=yt(e),a=e.createBufferSource(),l=e.createBiquadFilter(),u=e.createGain();a.buffer=i,a.loop=!0,l.type="highpass",l.frequency.setValueAtTime(2e3,t),l.frequency.linearRampToValueAtTime(5e3,t+.3),u.gain.setValueAtTime(0,t),u.gain.linearRampToValueAtTime(qe*.2,t+.05),u.gain.exponentialRampToValueAtTime(.001,t+.4),a.connect(l),l.connect(u),u.connect(e.destination),a.start(t),a.stop(t+.4)}catch{}},playNotification:()=>{let e=ze();if(!e)return;let t=e.currentTime;[{freq:880,dur:1.2,vol:.6},{freq:1760,dur:.6,vol:.3}].forEach(o=>{let r=e.createOscillator(),i=e.createGain();r.type="sine",r.frequency.setValueAtTime(o.freq,t),i.gain.setValueAtTime(0,t),i.gain.linearRampToValueAtTime(qe*o.vol,t+.004),i.gain.exponentialRampToValueAtTime(.001,t+o.dur),r.connect(i),i.connect(e.destination),r.start(t),r.stop(t+o.dur+.1)})},playSwoosh:()=>{J.playGenieOpen()},playReset:()=>{J.playError()},initGlobalListeners:()=>{if(window._cwSoundListenersActive)return;window._cwSoundListenersActive=!0;let e=0,t=50;document.addEventListener("mouseover",n=>{if(!Be)return;let o=n.target.closest('button, a, input[type="checkbox"], .cw-btn, .cw-hero-card, .cw-task-item, [data-sound="hover"]');if(!o||o.contains(n.relatedTarget))return;let r=Date.now();r-e<t||(J.playHover(),e=r)},{passive:!0})}};var Ft=1e4;function zt(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
        :root {
            --cw-primary: #1a73e8;
...
\u2022 Tentativa 2  - 
\u2022 Tentativa 3 - `,"field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-2-6-final":{type:"all","field-REASON_COMMENTS":"Finaliza\xE7\xE3o (2/6)","field-SPEAKEASY_ID":"-","field-ON_CALL":"-","field-COMENTARIOS":"\u2022 Dia 9 finaliza\xE7\xE3o do 2/6, durante o per\xEDodo do acompanhamento n\xE3o houve retorno do anunciante, ent\xE3o o caso ser\xE1 encerrado.","field-SCREENSHOTS":"\u2022 N/A","field-GTM_GA4_VERIFICADO":"N/A"},"quickfill-in-manual":{type:"all","field-REASON_COMMENTS":"Outro (Manual)","field-GTM_GA4_VERIFICADO":"N/A"}};var pe=e=>new Promise(t=>setTimeout(t,e));function Se(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function ot(){return Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(t=>{let n=t.offsetParent!==null,o=t.closest("case-message-view")!==null,r=t.closest(".editor")!==null||t.closest("write-card")!==null;return n&&!o&&r})}async function Ht(){console.log("\u{1F680} FASE 1: Abrindo janela de email...");let e=!1,n=Array.from(document.querySelectorAll("i.material-icons-extended")).find(h=>h.innerText.trim()==="email");if(n&&n.offsetParent!==null){let h=n.closest("material-button")||n.closest("material-fab")||n;h.style&&(h.style.display="block",h.style.visibility="visible"),Se(h),e=!0}else{let h=document.querySelector("material-fab-speed-dial");if(h){let d=h.querySelector(".trigger");if(d){d.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Se(d),await pe(1e3);let m=Array.from(document.querySelectorAll("i.material-icons-extended")).find(g=>g.innerText.trim()==="email");m&&(Se(m),e=!0)}else h.click()}}if(!e)return ee("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;console.log("\u{1F680} FASE 2: Verificando rascunhos (Polling de 3s)...");let o=null,r=0;for(;r<15;){await pe(200);let h=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(h).find(E=>E.offsetParent!==null),o)break;if(ot()){console.log("\u2139\uFE0F Editor apareceu limpo. Sem rascunhos.");break}r++}if(o){console.log("\u26A0\uFE0F RASCUNHO LOCALIZADO! Executando descarte..."),Se(o);let h=o.querySelector(".buttonText");h&&Se(h),o.click(),console.log("\u23F3 Aguardando Confirm...");let d=null,E=0;for(;E<20;){await pe(200);let m=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(d=Array.from(m).find(g=>g.offsetParent!==null),d)break;E++}if(d){console.log("\u2705 Confirmando..."),Se(d);let m=d.querySelector(".content");m&&Se(m),ee("Limpando rascunho...",{duration:2e3}),console.log("\u23F3 Aguardando reload do editor p\xF3s-descarte..."),await pe(3e3)}else console.warn("\u274C Confirm n\xE3o apareceu.")}console.log("\u{1F680} FASE 3: Buscando editor final para limpeza...");let i=0,a=ot();for(;!a&&i<20;)await pe(500),a=ot(),i++;if(!a)return ee("Erro: Editor n\xE3o carregou ap\xF3s a abertura.",{error:!0}),!1;let l=a.closest('[id="email-body-content-top"]'),x=(a.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(l){if(x){let d=x.closest('[aria-hidden="true"]');d&&d.removeAttribute("aria-hidden"),x.focus()}await pe(300),l.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let h=l.querySelector("#cases-body-field");if(h){let d=document.createRange();d.selectNodeContents(h),d.collapse(!0);let E=window.getSelection();E.removeAllRanges(),E.addRange(d)}return!0}return!1}async function $t(e){if(!e)return;ee("Preparando email...",{duration:3e3});let t=ht();if(!await Ht())return;await pe(500);let o=document.querySelector('material-button[debug-id="canned_response_button"]');if(o){o.scrollIntoView({behavior:"smooth",block:"center"}),await pe(200),Se(o),await pe(1500);let r=document.querySelector("material-auto-suggest-input input");if(r){Se(r),await pe(200),document.execCommand("insertText",!1,e),r.dispatchEvent(new Event("input",{bubbles:!0}));let i=null,a=0;for(;a<20;){await pe(500),a++;let l=Array.from(document.querySelectorAll("material-select-dropdown-item"));if(l.length>0&&(i=l.find(u=>u.innerText.toLowerCase().includes(e.toLowerCase())),!i&&l.length===1&&(i=l[0]),i))break}if(i){let l=function(d,E){if(d.nodeType===3&&d.nodeValue.includes(E))return d;if(!d.childNodes)return null;for(let m of d.childNodes){let g=l(m,E);if(g)return g}return null};Se(i),await pe(2e3);let u=ot(),x=u?u.closest('[id="email-body-content-top"]'):document.body,h=l(x,"{%ADVERTISER_NAME%}");if(h){let d=document.createRange(),E=h.nodeValue.indexOf("{%ADVERTISER_NAME%}");d.setStart(h,E),d.setEnd(h,E+19);let m=window.getSelection();m.removeAllRanges(),m.addRange(d),document.execCommand("insertText",!1,t.advertiserName),ee("Email preenchido!")}else ee("Email inserido (Nome n\xE3o substitu\xEDdo).")}else ee(`Template '${e}' n\xE3o encontrado.`,{error:!0})}}else ee("Bot\xE3o Canned Response n\xE3o achado.",{error:!0})}async function Ct(e){console.log(`\u{1F680} Iniciando automa\xE7\xE3o (Quick): ${e.name}`),ee("Preparando email...",{duration:3e3});let t=ht(),n=ft();if(!await Ht())return;await pe(600);let r=document.querySelector('input[aria-label="Subject"]');r&&e.subject&&(r.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(r,e.subject),r.dispatchEvent(new Event("input",{bubbles:!0})),await pe(300));let i=ot();if(i){let l=(i.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');l&&(l.focus(),l.click(),l.dispatchEvent(new Event("input",{bubbles:!0}))),await pe(400);let u=new Date;u.setDate(u.getDate()+3);let x=u.getDay();x===6?u.setDate(u.getDate()+2):x===0&&u.setDate(u.getDate()+1);let h=u.toLocaleDateString("pt-BR"),d=e.body;d=d.replace(/\[Nome do Cliente\]/g,t.advertiserName||"Cliente"),d=d.replace(/\[INSERIR URL\]/g,t.websiteUrl||"seu site"),d=d.replace(/\[URL\]/g,t.websiteUrl||"seu site"),d=d.replace(/\[Seu Nome\]/g,n),d=d.replace(/\[MM\/DD\/YYYY\]/g,h),document.execCommand("insertHTML",!1,d),l&&(l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))),ee("Email preenchido com sucesso!",{duration:2e3}),await pe(800)}else ee("Erro ao focar no editor.",{error:!0})}var ho={height:"56px",padding:"0 20px",backgroundColor:"rgba(28, 28, 32, 0.85)",backdropFilter:"blur(12px)",webkitBackdropFilter:"blur(12px)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",alignItems:"center",justifyContent:"space-between",color:"#E8EAED",fontFamily:"'Google Sans', Roboto, sans-serif",fontWeight:"500",letterSpacing:"0.5px",cursor:"grab",position:"relative",borderRadius:"16px 16px 0 0",flexShrink:"0",userSelect:"none",boxSizing:"border-box"},Ut={width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%",cursor:"pointer",color:"#9AA0A6",transition:"all 0.2s ease"};function Ce(e,t,n,o,r,i){let a=document.createElement("div");Object.assign(a.style,ho),Bt(e,a);let l=document.createElement("div");Object.assign(l.style,{position:"absolute",bottom:"0",left:"0",width:"100%",height:"2px",background:"linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)",zIndex:"10",opacity:"0.8"}),a.appendChild(l),r&&(r.googleLine=l);let u=document.createElement("div");Object.assign(u.style,{display:"flex",alignItems:"center",gap:"12px"});let x=document.createElement("img");x.src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg",Object.assign(x.style,{width:"20px",height:"20px",pointerEvents:"none"});let h=document.createElement("span");h.textContent=t,u.appendChild(x),u.appendChild(h);let d=document.createElement("div");Object.assign(d.style,{display:"flex",alignItems:"center",gap:"4px"});let E='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',m='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',g=document.createElement("div");g.innerHTML=E,Object.assign(g.style,Ut),g.title="Sobre",g.classList.add("no-drag"),g.onmouseenter=()=>{g.style.background="rgba(255,255,255,0.1)",g.style.color="#FFF"},g.onmouseleave=()=>{g.style.color!=="rgb(138, 180, 248)"&&(g.style.background="transparent",g.style.color="#9AA0A6")};let y=document.createElement("div");y.innerHTML=m,Object.assign(y.style,Ut),y.title="Fechar",y.classList.add("no-drag"),y.onmouseenter=()=>{y.style.background="rgba(242, 139, 130, 0.2)",y.style.color="#F28B82"},y.onmouseleave=()=>{y.style.background="transparent",y.style.color="#9AA0A6"},y.onmousedown=q=>q.stopPropagation(),g.onmousedown=q=>q.stopPropagation(),y.onclick=i;let T=xo(e,t,n,o);return g.onclick=q=>{q.stopPropagation(),T.style.opacity==="1"?(T.style.opacity="0",T.style.pointerEvents="none",g.style.color="#9AA0A6",g.style.background="transparent"):(T.style.opacity="1",T.style.pointerEvents="auto",g.style.color="#8AB4F8",g.style.background="rgba(138, 180, 248, 0.1)")},d.appendChild(g),d.appendChild(y),a.appendChild(u),a.appendChild(d),a}function xo(e,t,n,o){let r=document.createElement("div");return Object.assign(r.style,{position:"absolute",top:"56px",left:"0",width:"100%",height:"calc(100% - 56px)",backgroundColor:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(5px)",zIndex:"50",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"24px",boxSizing:"border-box",opacity:"0",transition:"opacity 0.2s ease",pointerEvents:"none",borderRadius:"0 0 16px 16px"}),r.innerHTML=`
    ...
    `,document.head.appendChild(e)}function Ee(e,t,n){let o=document.getElementById(n);if(!t)return;let r=t.getAttribute("data-moved")==="true",i={x:0,y:0};if(o){let h=o.getBoundingClientRect();i.x=h.left+h.width/2,i.y=h.top+h.height/2}let a,l;if(!r)a=window.innerWidth/2,l=window.innerHeight/2;else{let h=t.getBoundingClientRect();a=h.left+h.width/2,l=h.top+h.height/2,a===0&&l===0&&(a=window.innerWidth/2,l=window.innerHeight/2)}let u=i.x-a,x=i.y-l;e?(J.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",r?t.style.transform=`translate(${u}px, ${x}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${u}px), calc(-50% + ${x}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",r?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof Wt=="function"&&Wt(t,n)):(J.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",r?t.style.transform=`translate(${u}px, ${x}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${u}px), calc(-50% + ${x}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Et=="function"&&Et(t))}function Wt(e,t){Et(e);let n=o=>{if(!e.classList.contains("open"))return;let r=e.contains(o.target),i=document.querySelector(".cw-pill"),a=i&&i.contains(o.target);r?(e.classList.remove("idle"),e.style.zIndex="2147483648"):a||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=n,document.addEventListener("mousedown",n)}function Et(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var Kt="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",Tt="cw_data_broadcast",Yt="cw_data_tips",yo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function Xt(e){return new Promise((t,n)=>{let o="cw_cb_"+Math.round(1e4*Math.random()),r=document.createElement("script");window[o]=i=>{document.body.removeChild(r),delete window[o],t(i)},r.src=`${Kt}?op=${e}&callback=${o}&t=${Date.now()}`,r.onerror=()=>{document.body.removeChild(r),delete window[o],n(new Error("JSONP Load Error"))},document.body.appendChild(r)})}var je={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await Xt("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(Yt,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await Xt("broadcast");if(e&&e.broadcast)return localStorage.setItem(Tt,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(Tt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Tt)||"[]"),getRandomTip:()=>{let e=yo,t=localStorage.getItem(Yt);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let o={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(Kt,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(o)}).catch(r=>console.log("Log fail",r))}};var ne={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},st=e=>new Promise(t=>setTimeout(t,e));function Qt(e){let t="cw-command-center-style";if(!document.getElementById(t)){let m=document.createElement("style");m.id=t,m.innerHTML=`
...
@keyframes googleBounce {
    ...
    `;let r=document.createElement("div");if(r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=m=>{m.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=m=>{m.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=m=>{m.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=m=>{m.stopPropagation(),e.toggleLinks()},o.querySelector(".broadcast").onclick=m=>{m.stopPropagation();let g=m.currentTarget.querySelector(".cw-badge");g&&(g.style.transform="scale(0)",setTimeout(()=>g.remove(),200)),e.broadcastControl&&e.broadcastControl.toggle()},e.broadcastControl&&e.broadcastControl.hasUnread){let m=document.createElement("div");m.className="cw-badge",o.querySelector(".broadcast").appendChild(m)}(async function(){await st(2800),o.classList.add("docked"),await st(300);let g=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(T=>T.classList.add("visible"));for(let T=0;T<g.length;T++)g[T].classList.add("popped"),await st(90);await st(200),o.classList.add("system-check")})();let i=!1,a,l,u,x,h=3;o.onmousedown=m=>{if(m.target.closest("button"))return;m.preventDefault(),a=m.clientX,l=m.clientY;let g=o.getBoundingClientRect();u=g.left,x=g.top,document.addEventListener("mousemove",d),document.addEventListener("mouseup",E)};function d(m){let g=m.clientX-a,y=m.clientY-l;!i&&Math.sqrt(g*g+y*y)>h&&(i=!0,o.style.transition="none"),i&&(o.style.left=`${u+g}px`,o.style.top=`${x+y}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function E(m){if(document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",E),i){i=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let g=window.innerWidth,y=window.innerHeight,T=o.getBoundingClientRect(),q=T.left+T.width/2,_;q<g/2?(_=24,o.classList.remove("side-right"),o.classList.add("side-left")):(_=g-T.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let B=T.top;B<24&&(B=24),B>y-T.height-24&&(B=y-T.height-24),o.style.left=`${_}px`,o.style.top=`${B}px`}else{let g=m.target.closest("button");g&&(g.style.transform="scale(0.9)",setTimeout(()=>g.style.transform="",150))}}}function Xe(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");if(!e)return()=>{};let n=document.createElement("div");n.className="cw-center-stage",n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(b)}let l=document.createElement("div");l.className="cw-zen-container";let u=document.createElement("div");Object.assign(u.style,{display:"none"});let x=document.createElement("div");x.className="cw-screens-container",u.appendChild(x),l.innerHTML=`
    ...
    `;let h=l.querySelector(".cw-hero-grid"),d=l.querySelector(".cw-acc-container"),E=l.querySelector(".cw-results-container"),m=l.querySelector(".cw-search-input"),g=l.querySelector(".cw-status-bar"),y=l.querySelector(".cw-status-text"),T=l.querySelector(".cw-footer-icons");r.forEach(([b,f])=>{let s=o(f.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${b}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let p=t[b]?t[b].count:0;_(b,p>0?-p:1,f)},c.querySelector(".minus").onclick=()=>_(b,-1,f),c.querySelector(".plus").onclick=()=>_(b,1,f),c.dataset.color=s.color,h.appendChild(c)});function q(b,f){let s=o(f.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=b,c.innerHTML=`
        ...
        `,c.onclick=w=>{if(w.target.closest(".cw-step-btn"))return;let p=t[b]?t[b].count:0;_(b,p>0?-p:1,f)},c.querySelector(".minus").onclick=()=>_(b,-1,f),c.querySelector(".plus").onclick=()=>_(b,1,f),c}Object.entries(i).forEach(([b,f])=>{let s=document.createElement("div");s.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${f.brand.color}"></div>
                ${b}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{d.querySelectorAll(".cw-acc-group.open").forEach(p=>{p!==s&&p.classList.remove("open")}),s.classList.toggle("open")};let w=document.createElement("div");w.className="cw-acc-body",f.tasks.forEach(p=>{let A=q(p.key,p);w.appendChild(A)}),s.appendChild(c),s.appendChild(w),d.appendChild(s)});function _(b,f,s){t[b]||(t[b]={count:0,data:s,brand:o(s.name)}),t[b].count+=f,t[b].count<=0&&delete t[b],B(),H(),e&&e()}function B(){r.forEach(([w])=>{let p=h.querySelector(`#hero-${w}`);if(!p)return;let A=t[w];A?(p.classList.add("active"),p.querySelector(".cw-step-val").textContent=A.count,p.querySelector(".cw-step-val").style.color=p.dataset.color):p.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(w=>{let p=w.dataset.id,A=t[p];A?(w.classList.add("selected"),w.querySelector(".cw-step-val").textContent=A.count):w.classList.remove("selected")});let f=Object.keys(t),s=0,c=[];if(f.forEach(w=>{let p=t[w];s+=p.count;for(let A=0;A<p.count;A++)c.length<6&&c.push(p.brand)}),s>0){g.classList.add("visible");let w=s>1?"A\xE7\xF5es":"A\xE7\xE3o",p=s>1?"definidas":"definida";y.textContent=`${s} ${w} ${p}`,T.innerHTML="",c.forEach(A=>{let O=document.createElement("div");O.className="cw-mini-icon",O.innerHTML=Pe[A.icon]||Pe.default;let v=O.querySelector("svg");v&&(v.style.width="14px",v.style.height="14px"),T.appendChild(O)})}else g.classList.remove("visible")}m.addEventListener("input",b=>{let f=b.target.value.toLowerCase();if(f.length>0){d.style.display="none",E.style.display="block",E.innerHTML="";let s=!1;Object.entries(Re).forEach(([c,w])=>{if(w.name.toLowerCase().includes(f)){s=!0;let p=q(c,w);t[c]&&(p.classList.add("selected"),p.querySelector(".cw-step-val").textContent=t[c].count),E.appendChild(p)}}),s||(E.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else d.style.display="block",E.style.display="none"});function H(){x.innerHTML="";let b=Object.keys(t),f=!1,s=document.getElementById("sub-status"),c="implementation";if(s&&s.value.toLowerCase().includes("education")&&(c="education"),b.length===0){x.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(b.length===0){x.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let w=document.createElement("div");w.className="cw-info-banner",w.innerHTML=`
...
`).filter(re=>re.trim()!=="").map(re=>`<p style="margin: 0 0 8px 0;">${re}</p>`).join(""):$.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let se=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(se===""||se==="\u2022"||se.toLowerCase()==="n/a"){let re=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${D}\\}(?:<br>\\s*)?`,"gi");re.test(C)?C=C.replace(re,""):C=C.replace(R,"")}else C=C.replace(R,U.replace(/\$/g,"$$$$"))}),C=C.replace(/{([A-Z0-9_]+)}/g,""),C=C.replace(/(<br>){3,}/g,"<br><br>"),typeof a<"u"&&a.getOutput&&(C+=a.getOutput()),C}Ke.onclick=()=>{let S=Nt();S?(kt(S),ee(j("copiado_sucesso"))):ee(j("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let S=v.value,M=Nt();if(!M){ee(j("selecione_substatus"),{error:!0});return}kt(M),bt();let C=Xe(),V=await oo();if(V)try{if(V.focus(),V.innerHTML.trim()==="<p><br></p>"||V.innerHTML.trim()==="<br>"||V.innerText.trim()===""){let de=document.createRange();de.selectNodeContents(V);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("delete",!1,null)}else if(!V.innerHTML.endsWith("<br><br>")){let de=document.createRange();de.selectNodeContents(V),de.collapse(!1);let X=window.getSelection();X.removeAllRanges(),X.addRange(de),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,M),to(V),setTimeout(()=>{ee(j("inserido_copiado"))},600);let le=typeof Ge<"u"&&Ge?Ge.checked:!0;if(S&&it[S]&&le){let de=it[S];await $t(de),await new Promise(X=>setTimeout(X,500))}C(),gt(1.5),w.value="",v.innerHTML=`<option value="">${j("select_substatus")}</option>`,v.disabled=!0}catch(oe){console.error(oe),ee("Erro ao inserir.",{error:!0}),C()}};function gt(S=1.5){S<=1.5&&(Me.style.display="none",ye.innerHTML=""),S<=2&&(Ae.style.display="none",l.reset(),be.style.display="none"),S<=3&&(Oe.style.display="none",_e.innerHTML="",a.reset(),Ue.style.display="none",De.style.display="none")}function bt(){if(r=!r,r){let S=u.querySelector(".cw-expand-btn");S&&typeof S.resetState=="function"&&S.resetState()}Ee(r,u,"cw-btn-notes")}return dt("bau"),pt("pt"),bt}var Ve={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function lo(){let e="v2.1 (Apple Motion)",t={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},n={},o="PT",r="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",Object.assign(a.style,ve,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",opacity:"0",pointerEvents:"none"});let l={popup:a,googleLine:null};function u(){i=!i,Ee(i,a,"cw-btn-script")}let x=Ce(a,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{u()});a.appendChild(x);let h=document.createElement("div");Object.assign(h.style,t.progressBarContainer);let d=document.createElement("div");Object.assign(d.style,t.progressBarFill),h.appendChild(d),a.appendChild(h);let E=document.createElement("div");E.id="csa-content",Object.assign(E.style,t.contentArea),a.appendChild(E);let m=document.createElement("div");Object.assign(m.style,t.footer);let g=document.createElement("span");g.textContent="by lucaste@",Object.assign(g.style,{fontSize:"10px",color:"#bdc1c6"});let y=document.createElement("button");y.innerHTML=`
  ...
  `,Object.assign(y.style,t.resetBtn),y.onmouseenter=()=>y.style.background="#fce8e6",y.onmouseleave=()=>y.style.background="transparent",y.onclick=()=>{y.style.transform="scale(0.9)",setTimeout(()=>y.style.transform="scale(1)",150);for(let O in n)delete n[O];c()},m.appendChild(g),m.appendChild(y),a.appendChild(m);let T=document.createElement("div");Object.assign(T.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",gap:"8px"});let q=document.createElement("div");Object.assign(q.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",background:"#fff"});let _=document.createElement("div");_.textContent="BAU";let B=document.createElement("div");B.textContent="LT",Object.assign(_.style,me),Object.assign(B.style,me),q.appendChild(_),q.appendChild(B);let H=document.createElement("select");Object.assign(H.style,jt,{marginBottom:"0",width:"auto",minWidth:"90px",paddingTop:"6px",paddingBottom:"6px",paddingRight:"30px",height:"32px",backgroundPosition:"right 8px center"}),H.innerHTML='<option value="PT">PT</option><option value="ES">ES</option><option value="EN">EN</option>',H.value=o,T.appendChild(q),T.appendChild(H),E.appendChild(T);let b=document.createElement("div");b.id="csa-checklist-area",E.appendChild(b);let f=document.createElement("div");Object.assign(f.style,We),f.className="no-drag",f.title="Redimensionar",a.appendChild(f),Ye(a,f),document.body.appendChild(a);function s(O){return O}function c(){b.innerHTML="";let O=`${o} ${r}`,v=ro[O];if(!v){b.innerHTML=`<div style="padding: 30px; text-align: center; color: #bdc1c6; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:40px; opacity:0.6;">
        ...
        </div>`;return}f.forEach((c,w)=>{let p=document.createElement("div");Object.assign(p.style,l);let A=document.createElement("div");Object.assign(A.style,u),A.textContent=c._catIcon||"\u{1F517}",p.appendChild(A);let O=document.createElement("div");O.style.flexGrow="1";let v=N=>{if(!s)return N;let W=new RegExp(`(${n})`,"gi");return N.replace(W,'<span style="color:#1a73e8; font-weight:700;">$1</span>')},k=`<div style="font-size:14px; font-weight:500; color:#202124;">${v(c.name)}</div>`,F=`<div style="font-size:11px; color:#5f6368; margin-top:2px;">${v(c.desc)}</div>`;O.innerHTML=k+F,p.appendChild(O);let L=document.createElement("div");L.style.display="flex",L.style.gap="4px",L.style.opacity="0",L.style.transition="opacity 0.2s";let I=document.createElement("div");I.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',Object.assign(I.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#5f6368",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"}),I.onclick=N=>{J.playClick(),N.stopPropagation(),navigator.clipboard.writeText(c.url),I.style.transform="scale(1.2)",I.style.color="#1e8e3e",I.style.backgroundColor="#e6f4ea",setTimeout(()=>{I.style.transform="scale(1)",I.style.color="#5f6368",I.style.backgroundColor="transparent"},800)},I.onmouseenter=()=>I.style.backgroundColor="#f1f3f4",I.onmouseleave=()=>I.style.backgroundColor="transparent",L.appendChild(I);let z=document.createElement("div");z.innerHTML="\u2197",Object.assign(z.style,{width:"32px",height:"32px",display:"flex",alignItems:"center",justifyContent:"center",color:"#dadce0",fontSize:"16px"}),L.appendChild(z),p.appendChild(L),p.onclick=()=>window.open(c.url,"_blank"),p.onmouseenter=()=>{p.style.backgroundColor="#f8f9fa",p.style.transform="scale(1.01)",L.style.opacity="1",z.style.color="#1a73e8"},p.onmouseleave=()=>{p.style.backgroundColor="#ffffff",p.style.transform="scale(1)",L.style.opacity="0",z.style.color="#dadce0"},q.appendChild(p),requestAnimationFrame(()=>{p.style.transition="opacity 0.3s ease, transform 0.3s cubic-bezier(0.2, 0.9, 0.3, 1.2)",setTimeout(()=>{p.style.opacity="1",p.style.transform="translateY(0)"},w*40)})})}y.addEventListener("input",f=>{n=f.target.value,n!==""?Array.from(T.children).forEach(s=>{s.style.backgroundColor="transparent",s.style.color="#5f6368",s.style.borderColor="#dadce0"}):B(),H()});function b(){E=!E,Ee(E,x,"cw-btn-links")}return B(),H(),b}var He=[];function qt(e){He=e}function po(){let e="v2.5 (Emoji Fix)",t=!1,n=null,o=60*1e3;function r(s){if(!s)return"";try{let c=new Date(s);return isNaN(c.getTime())?String(s):c.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(s)}}let i={critical:{bg:"#FEF2F2",border:"#FECACA",text:"#991B1B",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>'},info:{bg:"#EFF6FF",border:"#BFDBFE",text:"#1E40AF",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>'},success:{bg:"#F0FDF4",border:"#BBF7D0",text:"#166534",icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>'}},a={feedContainer:{padding:"24px",overflowY:"auto",flexGrow:"1",background:"#FAFAFA",display:"flex",flexDirection:"column",gap:"20px"},card:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.06)",boxShadow:"0 4px 12px rgba(0,0,0,0.05), 0 1px 2px rgba(0,0,0,0.02)",overflow:"hidden",transition:"all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1)",position:"relative",width:"100%",boxSizing:"border-box",flexShrink:"0"},cardHistory:{background:"#FFFFFF",borderRadius:"16px",border:"1px solid rgba(0,0,0,0.04)",boxShadow:"none",opacity:"0.8",filter:"grayscale(0.3)",marginBottom:"16px",flexShrink:"0"},cardHeader:{padding:"12px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid rgba(0,0,0,0.04)",fontSize:"12px",fontWeight:"600",letterSpacing:"0.5px",textTransform:"uppercase"},msgTitle:{padding:"20px 20px 8px 20px",fontSize:"16px",fontWeight:"700",color:"#202124",letterSpacing:"-0.01em",lineHeight:"1.4"},metaContainer:{padding:"0 20px 12px 20px",display:"flex",alignItems:"center",gap:"8px",fontSize:"12px",color:"#5f6368"},cardBody:{padding:"0 20px 24px 20px",fontSize:"14px",color:"#3c4043",lineHeight:"1.6",whiteSpace:"pre-wrap",fontFamily:"'Google Sans', Roboto, sans-serif",wordBreak:"break-word",overflowWrap:"break-word"},emojiImg:"height: 20px; vertical-align: text-bottom; margin: 0 2px;",dismissBtn:{width:"28px",height:"28px",borderRadius:"50%",border:"1px solid rgba(0,0,0,0.1)",background:"#fff",color:"#5f6368",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s ease",marginLeft:"12px"},markAllBtn:{fontSize:"12px",color:"#1a73e8",cursor:"pointer",fontWeight:"600",background:"transparent",border:"none",padding:"8px",transition:"opacity 0.2s"},emptyState:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 0",color:"#bdc1c6",gap:"16px",textAlign:"center"},historyDivider:{display:"flex",alignItems:"center",justifyContent:"center",margin:"10px 0 20px 0",cursor:"pointer",color:"#1a73e8",fontSize:"13px",fontWeight:"500",gap:"8px",padding:"10px",borderRadius:"8px",transition:"background 0.2s"},historyContainer:{display:"none",flexDirection:"column",gap:"16px",paddingTop:"10px",borderTop:"1px dashed rgba(0,0,0,0.1)"}},l="cw-scrollbar-style";if(!document.getElementById(l)){let s=document.createElement("style");s.id=l,s.innerHTML=".cw-nice-scroll::-webkit-scrollbar { width: 5px; } .cw-nice-scroll::-webkit-scrollbar-track { background: transparent; } .cw-nice-scroll::-webkit-scrollbar-thumb { background-color: rgba(0,0,0,0.1); border-radius: 10px; }",document.head.appendChild(s)}function u(s){if(!s||typeof s!="string")return"";let c=s,w=/(https?:\/\/[^\s]+)|(www\.[^\s]+)/g;return c=c.replace(w,p=>{let A=p;return A.startsWith("http")||(A="http://"+A),`<a href="${A}" target="_blank" style="color:#1967d2; text-decoration:underline;">${p}</a>`}),c=c.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),c=c.replace(/_(.*?)_/g,"<i>$1</i>"),c=c.replace(/\n/g,"<br>"),c=Vt(c),c=c.replace(/@todos|@all/gi,'<span style="background:#e8f0fe; color:#1967d2; padding:1px 5px; border-radius:4px; font-weight:600; font-size:12px;">@todos</span>'),c}let x=document.createElement("div");x.id="broadcast-popup",Object.assign(x.style,ve,{right:"auto",left:"50%",width:"450px",height:"650px",display:"flex",flexDirection:"column",opacity:"0",pointerEvents:"none"});let h={popup:x,googleLine:null};function d(){if(t=!t,Ee(t,x,"cw-btn-broadcast"),t){let s=document.getElementById("cw-btn-broadcast");s&&s.classList.remove("has-new"),y()}}let E=Ce(x,"Operations Feed",e,"Atualiza\xE7\xF5es oficiais da opera\xE7\xE3o.",h,()=>d()),m=E.querySelector(".cw-header-actions")||E.lastElementChild;if(m){let s=document.createElement("button");s.textContent="Limpar tudo",Object.assign(s.style,a.markAllBtn),s.onclick=c=>{c.stopPropagation(),J.playSuccess();let w=He.map(p=>p.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(w)),_(),T()},m.insertBefore(s,m.firstChild)}x.appendChild(E);let g=document.createElement("div");g.className="cw-nice-scroll",Object.assign(g.style,a.feedContainer),x.appendChild(g);async function y(){let s=document.getElementById("cw-update-status");t&&(s||(s=document.createElement("div"),s.id="cw-update-status",s.style.cssText="padding: 6px; text-align: center; font-size: 11px; color: #5f6368; background: #f8f9fa; border-bottom: 1px solid #e0e0e0;",g.parentNode.insertBefore(s,g)),s.innerHTML="\u23F3 Verificando atualiza\xE7\xF5es...",s.style.display="block");let c=He.map(p=>p.id),w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");try{let p=await je.fetchData();p&&p.broadcast&&(t&&s&&(p.broadcast.some(O=>!c.includes(O.id))?(s.innerHTML="\u2705 Novos avisos sincronizados!",s.style.backgroundColor="#e6f4ea",s.style.color="#137333"):s.innerHTML="\u{1F539} Tudo atualizado.",setTimeout(()=>{s&&(s.style.display="none")},1500)),c.length>0&&p.broadcast.filter(v=>!c.includes(v.id)).filter(v=>!w.includes(v.id)).length>0&&(console.log("\u{1F514} Novo aviso detectado! Tocando som."),J.playNotification()),qt(p.broadcast),T(),t&&_())}catch(p){console.error("Erro no update:",p),t&&s&&(s.innerHTML="\u26A0\uFE0F Falha na conex\xE3o.",s.style.backgroundColor="#fce8e6")}}function T(){let s=document.getElementById("cw-btn-broadcast");if(!s)return;let c=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(He.some(p=>!c.includes(p.id))){if(s.classList.add("has-new"),!s.querySelector(".cw-badge")){let p=document.createElement("div");p.className="cw-badge",Object.assign(p.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),s.appendChild(p)}}else{s.classList.remove("has-new");let p=s.querySelector(".cw-badge");p&&p.remove()}}let q=je.getCachedBroadcasts();q.length>0&&(qt(q),_()),y(),n||(n=setInterval(y,o));function _(){g.innerHTML="";let s=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),c=[...He].sort((A,O)=>{let v=s.includes(A.id),k=s.includes(O.id);return v===k?0:v?1:-1});if(c.every(A=>s.includes(A.id))){let A=document.createElement("div");Object.assign(A.style,a.emptyState),A.innerHTML=`
           ...
           `,g.appendChild(A)}let w=c.filter(A=>!s.includes(A.id)),p=c.filter(A=>s.includes(A.id));if(w.forEach(A=>g.appendChild(B(A,!1))),p.length>0){let A=document.createElement("div");Object.assign(A.style,a.historyDivider),A.innerHTML=`<span>Visualizar ${p.length} avisos anteriores</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:transform 0.3s"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let O=document.createElement("div");Object.assign(O.style,a.historyContainer),p.forEach(k=>O.appendChild(B(k,!0)));let v=!1;A.onclick=()=>{J.playClick(),v=!v,O.style.display=v?"flex":"none",A.querySelector("svg").style.transform=v?"rotate(180deg)":"rotate(0deg)",A.querySelector("span").textContent=v?"Ocultar hist\xF3rico":`Visualizar ${p.length} avisos anteriores`},g.appendChild(A),g.appendChild(O)}}function B(s,c){let w=document.createElement("div");Object.assign(w.style,c?a.cardHistory:a.card);let p=i[s.type]||i.info,A=document.createElement("div");Object.assign(A.style,a.cardHeader,{background:p.bg,color:p.text,borderBottom:`1px solid ${p.border}`});let O=document.createElement("div");if(Object.assign(O.style,{display:"flex",alignItems:"center",gap:"6px"}),O.innerHTML=`${p.icon} <span>${s.type.toUpperCase()}</span>`,A.appendChild(O),c){let k=document.createElement("span");k.textContent=r(s.date),k.style.opacity="0.7",A.appendChild(k)}else{let k=document.createElement("button");k.title="Marcar como lido",Object.assign(k.style,a.dismissBtn),k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',k.onmouseenter=()=>{k.style.color="#1e8e3e",k.style.background="#e6f4ea",k.style.borderColor="#1e8e3e"},k.onmouseleave=()=>{k.style.color="#5f6368",k.style.background="#fff",k.style.borderColor="rgba(0,0,0,0.1)"},k.onclick=F=>{F.stopPropagation(),J.playClick(),w.style.transform="translateX(20px)",w.style.opacity="0",setTimeout(()=>{let L=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");L.push(s.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(L)),_(),T()},250)},A.appendChild(k)}if(w.appendChild(A),s.title){let k=document.createElement("div");Object.assign(k.style,a.msgTitle),k.textContent=s.title,w.appendChild(k)}if(!c){let k=document.createElement("div");Object.assign(k.style,a.metaContainer),k.innerHTML=`<span style="font-weight:600">${s.author}</span> \u2022 <span>${r(s.date)}</span>`,w.appendChild(k)}let v=document.createElement("div");return Object.assign(v.style,a.cardBody),v.innerHTML=u(s.text),w.appendChild(v),w}_();let H=document.createElement("div");Object.assign(H.style,We),H.className="no-drag",x.appendChild(H),Ye(x,H),document.body.appendChild(x);let b=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),f=He.some(s=>!b.includes(s.id));return{toggle:d,hasUnread:f}}function Eo(){if(window.techSolInitialized){wt();return}window.techSolInitialized=!0,console.log("\u{1F680} TechSol Suite Initializing...");try{zt();try{J.initGlobalListeners(),J.playStartup()}catch(i){console.warn("\xC1udio n\xE3o p\xF4de ser iniciado automaticamente:",i)}je.fetchTips(),wt();let e=io(),t=so(),n=lo(),o=co(),r=po();Qt({toggleNotes:e,toggleEmail:t,toggleScript:n,toggleLinks:o,broadcastControl:r})}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),ee("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}Eo();})();

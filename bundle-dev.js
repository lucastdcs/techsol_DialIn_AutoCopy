...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var de=e=>new Promise(t=>setTimeout(t,e));function fe(e,t="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,o[t]||o.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>e.dispatchEvent(new MouseEvent(o,t)))}function st(e,t){if(!e)return;let o=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,n=document.getElementById(o);n&&n.remove();let r=e.getBoundingClientRect(),a=document.createElement("div");a.id=o,a.style.cssText=`
    ...
    `,a.innerHTML=`
        ...
        ">\xD7</div>
    `;let i=a.querySelector(".cw-close-btn");i.onclick=()=>{a.style.opacity="0",a.style.transform="translateY(-5px)",setTimeout(()=>a.remove(),300)},document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(a)&&i.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await de(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await de(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let n=o.offsetParent!==null,r=o.closest("case-message-view")!==null,a=o.closest(".editor")!==null||o.closest("write-card")!==null;return n&&!r&&a});return t&&fe("Editor visualmente detectado.","success"),t}async function Zt(){fe("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(d=>d.innerText.trim()==="email");if(o&&o.offsetParent!==null){fe("Bot\xE3o de email direto encontrado.");let d=o.closest("material-button")||o.closest("material-fab")||o;Ce(d),e=!0}else{fe("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let d=document.querySelector("material-fab-speed-dial");if(d){let b=d.querySelector(".trigger");if(b){Ce(b),await de(800);let y=Array.from(document.querySelectorAll("i.material-icons-extended")).find(w=>w.innerText.trim()==="email");y&&(Ce(y),e=!0)}}}if(!e)return oe("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;fe("\u{1F680} FASE 2: Verificando rascunhos...");let n=null,r=0,a=20;for(;r<a;){await de(250);let d=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(n=Array.from(d).find(b=>b.offsetParent!==null),n){fe("\u26A0\uFE0F Rascunho detectado!","warn");break}r++}if(n){fe("\u{1F5D1}\uFE0F Descartando..."),Ce(n),n.click();let d=null,b=0;for(;b<15;){await de(300);let _=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(d=Array.from(_).find(y=>y.offsetParent!==null),d)break;b++}d&&(Ce(d),oe("Limpando rascunho antigo...",{duration:2e3}),await de(2500))}fe("\u{1F680} FASE 3: Buscando editor final...");let i=0,l=null;for(;i<20&&(l=kt(),!l);)await de(250),i++;if(!l)return oe("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let g=l.closest('[id="email-body-content-top"]'),f=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(g){if(f){let b=f.closest('[aria-hidden="true"]');b&&b.removeAttribute("aria-hidden"),f.focus(),Ce(f)}await de(300),g.innerHTML=`
    ...
    `,document.head.appendChild(e)}function Te(e,t,o){let n=document.getElementById(o);if(!t)return;let r=t.getAttribute("data-moved")==="true",a={x:0,y:0};if(n){let f=n.getBoundingClientRect();a.x=f.left+f.width/2,a.y=f.top+f.height/2}let i,l;if(!r)i=window.innerWidth/2,l=window.innerHeight/2;else{let f=t.getBoundingClientRect();i=f.left+f.width/2,l=f.top+f.height/2,i===0&&l===0&&(i=window.innerWidth/2,l=window.innerHeight/2)}let g=a.x-i,u=a.y-l;e?(Z.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",r?t.style.transform=`translate(${g}px, ${u}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${g}px), calc(-50% + ${u}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),n&&n.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",r?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof to=="function"&&to(t,o)):(Z.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",r?t.style.transform=`translate(${g}px, ${u}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${g}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),n&&n.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Ot=="function"&&Ot(t))}function to(e,t){Ot(e);let o=n=>{if(!e.classList.contains("open"))return;let r=e.contains(n.target),a=document.querySelector(".cw-pill"),i=a&&a.contains(n.target);r?(e.classList.remove("idle"),e.style.zIndex="2147483648"):i||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=o,document.addEventListener("mousedown",o)}function Ot(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var ao="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",qt="cw_data_broadcast",oo="cw_data_tips",Oo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function no(e){return new Promise((t,o)=>{let n="cw_cb_"+Math.round(1e4*Math.random()),r=document.createElement("script");window[n]=a=>{document.body.removeChild(r),delete window[n],t(a)},r.src=`${ao}?op=${e}&callback=${n}&t=${Date.now()}`,r.onerror=()=>{document.body.removeChild(r),delete window[n],o(new Error("JSONP Load Error"))},document.body.appendChild(r)})}var He={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await no("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(oo,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await no("broadcast");if(e&&e.broadcast)return localStorage.setItem(qt,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(qt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(qt)||"[]"),getRandomTip:()=>{let e=Oo,t=localStorage.getItem(oo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let n={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(ao,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(n)}).catch(r=>console.log("Log fail",r))}};var me={glassBg:"rgba(61, 61, 61, 0.95)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},ct=e=>new Promise(t=>setTimeout(t,e));function io(e){let t="cw-command-center-style";if(!document.getElementById(t)){let C=document.createElement("style");C.id=t,C.innerHTML=`
        ...
        .cw-pill {
            ...
            /* Transi\xE7\xF5es: Altura El\xE1stica, Resto Suave */
            transition: 
                max-height 0.6s var(--cw-spring),
                padding 0.4s ease,
                background 0.3s ease,
                opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1);
                /* Note: top/left (drag) n\xE3o est\xE3o aqui para serem instant\xE2neos via JS */
        ...
        .cw-pill.collapsed {
            max-height: 56px !important; /* Altura do bot\xE3o */
        ...
        /* Posi\xE7\xE3o Absoluta quando Fechado (Centraliza\xE7\xE3o Perfeita) */
        ...
        .cw-grip-bar { width: 20px; height: 3px; background-color: ${me.iconIdle}; border-radius: 4px; }

        .cw-btn {
            width: 40px; height: 40px; border-radius: 50%; border: none; background: transparent;
            display: flex; align-items: center; justify-content: center; cursor: pointer; position: relative; 
            color: ${me.iconIdle}; transition: all 0.2s ease; flex-shrink: 0;
        }
        .cw-btn:hover { background: ${me.glassHighlight}; color: ${me.iconActive}; transform: scale(1.1); }
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let f=l.querySelector(".cw-hero-grid"),d=l.querySelector(".cw-acc-container"),b=l.querySelector(".cw-results-container"),_=l.querySelector(".cw-search-input"),y=l.querySelector(".cw-status-bar"),w=l.querySelector(".cw-status-text"),O=l.querySelector(".cw-footer-icons");r.forEach(([m,h])=>{let s=n(h.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${m}`,c.style.setProperty("--hero-color",s.color),c.innerHTML=`
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let p=t[m]?t[m].count:0;L(m,p>0?-p:1,h)},c.querySelector(".minus").onclick=()=>L(m,-1,h),c.querySelector(".plus").onclick=()=>L(m,1,h),c.dataset.color=s.color,f.appendChild(c)});function I(m,h){let s=n(h.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=m,c.innerHTML=`

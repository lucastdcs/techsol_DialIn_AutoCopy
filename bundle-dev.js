...
/* --- BUTTONS (Estados e Intera\xE7\xE3o) --- */
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(o),o.querySelector(".notes").onclick=b=>{b.stopPropagation(),e.toggleNotes()},o.querySelector(".email").onclick=b=>{b.stopPropagation(),e.toggleEmail()},o.querySelector(".script").onclick=b=>{b.stopPropagation(),e.toggleScript()},o.querySelector(".links").onclick=b=>{b.stopPropagation(),e.toggleLinks()},(async function(){await Xe(2800),o.classList.add("docked"),await Xe(300);let x=o.querySelectorAll(".cw-btn");o.querySelectorAll(".cw-sep").forEach(E=>E.classList.add("visible"));for(let E=0;E<x.length;E++)x[E].classList.add("popped"),await Xe(90);await Xe(200),o.classList.add("system-check")})();let a=!1,s,i,p,S,y=3;o.onmousedown=b=>{if(b.target.closest("button"))return;b.preventDefault(),s=b.clientX,i=b.clientY;let x=o.getBoundingClientRect();p=x.left,S=x.top,document.addEventListener("mousemove",m),document.addEventListener("mouseup",C)};function m(b){let x=b.clientX-s,A=b.clientY-i;!a&&Math.sqrt(x*x+A*A)>y&&(a=!0,o.style.transition="none"),a&&(o.style.left=`${p+x}px`,o.style.top=`${S+A}px`,o.style.right="auto",o.style.bottom="auto",o.style.transform="none")}function C(b){if(document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",C),a){a=!1,o.style.transition="left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.4s ease";let x=window.innerWidth,A=window.innerHeight,E=o.getBoundingClientRect(),k=E.left+E.width/2,F;k<x/2?(F=24,o.classList.remove("side-right"),o.classList.add("side-left")):(F=x-E.width-24,o.classList.remove("side-left"),o.classList.add("side-right"));let B=E.top;B<24&&(B=24),B>A-E.height-24&&(B=A-E.height-24),o.style.left=`${F}px`,o.style.top=`${B}px`,setTimeout(()=>{},600)}else{let x=b.target.closest("button");x&&(x.style.transform="scale(0.9)",setTimeout(()=>x.style.transform="",150))}}}function Ke(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop"),n=document.getElementById("cw-loader"),o=document.getElementById("cw-success");if(!e||!n||!o)return()=>{};let r=Date.now();return e.classList.add("processing"),t&&t.classList.add("active"),n.style.display="flex",o.style.display="none",function(){let s=Date.now()-r,i=Math.max(0,1500-s);setTimeout(()=>{n.style.display="none",o.style.display="block",o.offsetWidth,e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing","success"),t&&t.classList.remove("active")},2e3)},i)}}var Lt=e=>new Promise(t=>setTimeout(t,e));function Qe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function gt(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let n=document.createRange();n.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(n);try{document.execCommand("copy")}catch{Q("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function Gt(e){["input","change","keydown","keyup"].forEach(n=>{let o=new Event(n,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function Dt(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function Ft(){console.log("Iniciando processo de Nova Nota...");let e=Dt(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(s=>s.innerText.trim()==="description");if(o){let s=o.closest("material-fab")||o.closest("material-button");s?(s.style&&(s.style.display="block",s.style.visibility="visible"),Qe(s)):Qe(o)}else{let s=document.querySelector("material-fab-speed-dial");if(s){let i=s.querySelector(".trigger");i?(i.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),Qe(i)):s.click(),await Lt(800);let S=Array.from(document.querySelectorAll("i.material-icons-extended")).find(y=>y.innerText.trim()==="description");S&&Qe(S)}}let r=null,a=0;for(;!r&&a<20;){await Lt(300);let s=Dt();if(s.length>t)r=s.find(i=>!e.includes(i)),r||(r=s[s.length-1]);else if(a>10){let i=s.filter(p=>p.offsetParent!==null);i.length>0&&(r=i[i.length-1])}a++}return r}var Zt={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto'",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},yo={...Zt,height:"100px",resize:"vertical"};var ft={width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"};var Jt={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},eo={fontSize:"12px",color:"#e37400",marginTop:"4px"},to={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},oo={display:"flex",gap:"15px",marginBottom:"10px"};function Pt(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Jt);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,De,{marginTop:"0"});let n=document.createElement("div");Object.assign(n.style,oo);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,ft);let r=document.createElement("label");r.textContent="Sim";let a=document.createElement("div");Object.assign(a.style,{display:"flex",alignItems:"center"}),a.appendChild(o),a.appendChild(r);let s=document.createElement("input");s.type="radio",s.name="ts_usage_mod",s.value="N\xE3o",s.checked=!0,Object.assign(s.style,ft);let i=document.createElement("label");i.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(s),p.appendChild(i),n.appendChild(a),n.appendChild(p);let S=document.createElement("div");S.style.display="block";let y=document.createElement("label");y.textContent="Qual foi o Motivo?",Object.assign(y.style,De,{fontSize:"12px"});let m=document.createElement("input");m.type="text",Object.assign(m.style,to);let C=document.createElement("div");C.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(C.style,eo),S.appendChild(y),S.appendChild(m),S.appendChild(C),e.appendChild(t),e.appendChild(n),e.appendChild(S),o.onchange=()=>{S.style.display="none"},s.onchange=()=>{S.style.display="block"};function b(E,k){if(e.style.display="none",!E||E.includes("Education")||!k||k.length===0)return;let F=k.some(l=>l.includes("enhanced")||l==="ec_google_ads"),B=k.some(l=>(l.includes("conversion")||l.includes("ads"))&&!l.includes("enhanced")),g=k.some(l=>l.includes("ga4")||l.includes("analytics")||l.includes("ua")),d=k.some(l=>l.includes("merchant")||l.includes("gmc")||l.includes("shopping"));(F||B&&!g&&!d)&&(e.style.display="block")}function x(){if(e.style.display==="none")return"";let E=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return s.checked&&m.value.trim()!==""&&(E+=`<br><b>Motivo:</b> ${m.value}`),E+="<br>",E}function A(){e.style.display="none",s.checked=!0,o.checked=!1,S.style.display="block",m.value=""}return{element:e,updateVisibility:b,getOutput:x,reset:A}}var I={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Te={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function jt(e){let t={};function n(g){let d=g.toLowerCase();return d.includes("ads")||d.includes("conversion")||d.includes("remarketing")?I.brands.ads:d.includes("ga4")||d.includes("analytics")?I.brands.ga4:d.includes("gtm")||d.includes("tag manager")||d.includes("container")?I.brands.gtm:d.includes("merchant")||d.includes("shopping")||d.includes("feed")?I.brands.gmc:I.brands.default}let o=Object.entries(Ne).filter(([g,d])=>d.popular),r={};Object.entries(Ne).forEach(([g,d])=>{if(d.popular)return;let c=n(d.name);r[c.label]||(r[c.label]={brand:c,tasks:[]}),r[c.label].tasks.push({key:g,...d})});let a="cw-zen-tasks";if(!document.getElementById(a)){let g=document.createElement("style");g.id=a,g.innerHTML=`
            ...
            .cw-helper-text { font-size: 12px; color: ${I.textSub}; margin-top: 12px; line-height: 1.4; }

            /* HERO CARD */
            .cw-hero-card {
                background: ${I.white}; border-radius: 12px; padding: 10px 12px;
                box-shadow: ${I.shadowCard}; border: 1px solid transparent;
            ...
            .cw-hero-icon { 
                width: 32px; height: 32px; border-radius: 8px; background: #F3F4F6; color: ${I.textSub};
                display: flex; align-items: center; justify-content: center; flex-shrink: 0; transition: all 0.2s;
            }
            .cw-hero-icon svg { width: 18px; height: 18px; fill: currentColor; }
            .cw-hero-label { font-size: 12px; font-weight: 500; color: ${I.textMain}; line-height: 1.2; }

            /* Hero Active */
            .cw-hero-card.active { background: ${I.white}; border-color: ${I.blue}; }
            .cw-hero-card.active .cw-hero-icon { background: ${I.blue}; color: white; }
            .cw-hero-card.active .cw-hero-label { color: ${I.blue}; font-weight: 600; }

            /* Hero Stepper */
            .cw-hero-stepper {
                position: absolute; right: 4px; top: 4px; bottom: 4px;
                background: ${I.white}; border-radius: 8px; padding: 0 4px;
            ...
            .cw-search-input {
                ...
                border: 1px solid ${I.border}; border-radius: 10px; background: ${I.white};
                font-size: 13px; outline: none;
                background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%239CA3AF" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>');
                background-repeat: no-repeat; background-position: 10px center;
                transition: border-color 0.2s, box-shadow 0.2s; margin-bottom: 16px;
            }
            .cw-search-input:focus { border-color: ${I.blue}; box-shadow: 0 0 0 3px ${I.blueLight}; }

            /* ACCORDION */
            .cw-acc-group { margin-bottom: 8px; border: 1px solid ${I.border}; border-radius: 10px; background: ${I.white}; overflow: hidden; }
            .cw-acc-header {
                padding: 12px 16px; display: flex; align-items: center; justify-content: space-between;
                cursor: pointer; background: ${I.white}; transition: background 0.1s;
            }
            .cw-acc-header:hover { background: #F9FAFB; }
            .cw-acc-title { font-size: 13px; font-weight: 600; color: ${I.textMain}; display: flex; align-items: center; gap: 8px; }
            .cw-acc-dot { width: 8px; height: 8px; border-radius: 50%; }
            .cw-acc-icon { width: 12px; height: 12px; transition: transform 0.3s; color: ${I.textSub}; font-size: 10px; }
            .cw-acc-group.open .cw-acc-icon { transform: rotate(180deg); }
            .cw-acc-body { display: none; border-top: 1px solid ${I.border}; background: #FAFAFA; }
            ...
            .cw-task-item.selected { background: ${I.blueLight}; }
            ...
            .cw-task-label { font-size: 13px; color: ${I.textSub}; transition: color 0.1s; font-weight: 400; line-height: 1.3; }
            .cw-task-item.selected .cw-task-label { color: ${I.blue}; font-weight: 500; }
            ...
            .cw-step-btn {
                ...
                color: ${I.textMain}; display: flex; align-items: center; justify-content: center;
                font-size: 14px; font-weight: bold; transition: background 0.1s; cursor: pointer;
            }
            .cw-step-btn:hover { background: #E5E7EB; }
            .cw-step-val { font-size: 13px; font-weight: 600; min-width: 14px; text-align: center; color: ${I.blue}; }
            ...
            .cw-status-bar {
                ...
                box-shadow: ${I.shadowFloat}; z-index: 10;
            }
            .cw-status-bar.visible { transform: translateY(0); }
            .cw-status-text { font-size: 13px; font-weight: 500; color: ${I.textMain}; }
...
/* --- SCREENSHOTS: FINE & ELEGANT --- */
            ...
            .cw-screen-card {
                background: #FFFFFF;
                border-radius: 12px; /* Radius menor para ser mais "t\xE9cnico" */
                ...
                /* Sombra quase invis\xEDvel, s\xF3 para separar do fundo */
                box-shadow: 0 1px 2px rgba(0,0,0,0.02);
            }

            /* Foco no Cart\xE3o (Eleva\xE7\xE3o sutil) */
            .cw-screen-card:focus-within {
                border-color: #E5E7EB; /* Mant\xE9m cinza, o destaque \xE9 a esquerda */
            ...
            /* \xCDCONE (Sem fundo, apenas o logo) */
            .cw-card-icon {
            ...
            /* T\xEDtulo Edit\xE1vel (Parece texto normal) */
            .cw-card-title-input {
                font-family: ${I.font}; font-size: 14px; font-weight: 600; color: ${I.textMain};
            ...
            .cw-input-label {
                display: block; font-size: 10px; font-weight: 700; color: ${I.textSub};
    ...
    `;let S=s.querySelector(".cw-hero-grid"),y=s.querySelector(".cw-acc-container"),m=s.querySelector(".cw-results-container"),C=s.querySelector(".cw-search-input"),b=s.querySelector(".cw-status-bar"),x=s.querySelector(".cw-status-text"),A=s.querySelector(".cw-footer-icons");o.forEach(([g,d])=>{let c=n(d.name),l=document.createElement("div");l.className="cw-hero-card",l.id=`hero-${g}`,l.innerHTML=`
        ...
        `,l.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let h=t[g]?t[g].count:0;k(g,h>0?-h:1,d)},l.querySelector(".minus").onclick=()=>k(g,-1,d),l.querySelector(".plus").onclick=()=>k(g,1,d),l.dataset.color=c.color,S.appendChild(l)});function E(g,d){let c=n(d.name),l=document.createElement("div");return l.className="cw-task-item",l.dataset.id=g,l.innerHTML=`
...
`).filter(oe=>oe.trim()!=="").map(oe=>`<p style="margin: 0 0 8px 0;">${oe}</p>`).join(""):P.tagName==="TEXTAREA"&&(U=U.replace(/\n/g,"<br>"));let ee=U.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ee===""||ee==="\u2022"||ee.toLowerCase()==="n/a"){let oe=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${G}\\}(?:<br>\\s*)?`,"gi");oe.test(f)?f=f.replace(oe,""):f=f.replace(q,"")}else f=f.replace(q,U.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof s<"u"&&s.getOutput&&(f+=s.getOutput()),f}Re.onclick=()=>{let u=yt();u?(gt(u),Q(L("copiado_sucesso"))):Q(L("selecione_substatus"),{error:!0})},Le.onclick=async()=>{let u=N.value,M=yt();if(!M){Q(L("selecione_substatus"),{error:!0});return}gt(M),lt();let f=Ke(),D=await Ft();if(D)try{if(D.focus(),D.innerHTML.trim()==="<p><br></p>"||D.innerHTML.trim()==="<br>"||D.innerText.trim()===""){let z=document.createRange();z.selectNodeContents(D);let J=window.getSelection();J.removeAllRanges(),J.addRange(z),document.execCommand("delete",!1,null)}else if(!D.innerHTML.endsWith("<br><br>")){let z=document.createRange();z.selectNodeContents(D),z.collapse(!1);let J=window.getSelection();J.removeAllRanges(),J.addRange(z),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,M),Gt(D),setTimeout(()=>{Q(L("inserido_copiado"))},600);let se=typeof we<"u"&&we?we.checked:!0;if(u&&We[u]&&se){let z=We[u];await Nt(z),await new Promise(J=>setTimeout(J,500))}f(),rt(1.5),w.value="",N.innerHTML=`<option value="">${L("select_substatus")}</option>`,N.disabled=!0}catch(K){console.error(K),Q("Erro ao inserir.",{error:!0}),f()}};function rt(u=1.5){u<=1.5&&(Ce.style.display="none",ce.innerHTML=""),u<=2&&(de.style.display="none",i.reset(),re.style.display="none"),u<=3&&(pe.style.display="none",fe.innerHTML="",s.reset(),Ie.style.display="none",Ae.style.display="none")}function lt(){r=!r,ve(r,p,"cw-btn-notes")}return nt("bau"),at("pt"),lt}var Oe={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
      ...
      `;let H=h.querySelector("#csa-back-btn");H.onmouseover=()=>H.style.backgroundColor="#f1f3f4",H.onmouseout=()=>H.style.backgroundColor="transparent",H.onclick=T;let _=h.querySelector("#csa-insert-btn");_.onmouseover=()=>_.style.backgroundColor="#174ea6",_.onmouseout=()=>_.style.backgroundColor="#1a73e8",_.onclick=async()=>{_.style.transform="scale(0.96)",A();let te=Ke();try{await bt(R),te()}catch($){console.error($),te()}setTimeout(()=>{_.style.transform="scale(1)",T()},300)}}function T(){o="list",F.style.transform="translateX(0)"}function V(){c.innerHTML="",Object.keys(Oe).forEach(R=>{let Z=Oe[R],j=document.createElement("button");j.textContent=Z.title,Object.assign(j.style,S),t===R&&n===""&&Object.assign(j.style,y),j.onclick=()=>{t=R,n="",d.value="",V(),N()},c.appendChild(j)})}function N(){l.innerHTML="";let R=[];if(n.trim()!==""?Object.values(Oe).forEach(H=>{let _=H.emails.filter(te=>te.name.toLowerCase().includes(n.toLowerCase()));R=[...R,..._]}):Oe[t]&&(R=Oe[t].emails),R.length===0){l.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let Z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',j='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';R.forEach(H=>{let _=document.createElement("div");Object.assign(_.style,m);let te=H.subject.length>50?H.subject.substring(0,50)+"...":H.subject;_.innerHTML=`

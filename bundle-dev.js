...
\u2022 Tentativa 2 -`}};var fe=e=>new Promise(t=>setTimeout(t,e));function ve(e,t="info"){let n={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,n[t]||n.info)}function qe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(n=>e.dispatchEvent(new MouseEvent(n,t)))}function xt(e,t){if(!e)return;let n=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(n);o&&o.remove();let s=e.getBoundingClientRect(),i=document.createElement("div");i.id=n,i.style.cssText=`
    ...
    .cw-pill {
        ...
        /* Usamos a curva el\xE1stica para dar o "pop" */
        transition: 
    ...
    .cw-pill.collapsed {
        ...
        /* FECHAR: AQUI EST\xC1 A CORRE\xC7\xC3O CR\xCDTICA */
        /* Delay de 0.25s: A p\xEDlula fica IM\xD3VEL enquanto os \xEDcones somem */
        transition: 
    ...
    .cw-main-logo {
        ...
        transition: all 0.3s ease; /* Some r\xE1pido ao abrir */
    ...
    .cw-pill.collapsed .cw-main-logo { 
        ...
        /* Entra s\xF3 no finalzinho, quando a p\xEDlula j\xE1 virou bola */
    ...
    .cw-pill > *:not(.cw-main-logo) {
        opacity: 1;
        transform: scale(1);
        /* ABRIR: Espera a p\xEDlula crescer (0.2s delay) para aparecer */
        transition: 
    ...
    .cw-pill.collapsed > *:not(.cw-main-logo) {
        ...
        /* Isso limpa a \xE1rea antes da p\xEDlula come\xE7ar a encolher aos 0.25s */
        transform: scale(0); 
        transition: 
    ...
    /* --- BOT\xD5ES E RESTO (Mantido igual) --- */
    .cw-btn {
...
`),_=/\d{1,2}\/\d{1,2}/;if(W.forEach(le=>{let ue=le.match(_);if(ue){let Ae=ue[0],Me="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(le)?Me="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(le)&&(Me="\u{1F1EA}\u{1F1F8}"),H.some(Re=>Re.flag===Me&&Re.date===Ae)||H.push({flag:Me,date:Ae})}}),H.length===0){let le=(N.text||"").match(/\d{1,2}\/\d{1,2}/g);le&&[...new Set(le)].forEach(ue=>H.push({flag:"\u{1F4C5}",date:ue}))}let B="",Z='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(Z=`

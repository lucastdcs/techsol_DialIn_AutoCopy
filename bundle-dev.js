(()=>{var $e="",Wt=e=>new Promise(t=>setTimeout(t,e));async function At(){if($e)return $e;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await Wt(100);let t="Consultor",n=document.querySelector("profile-details .name");if(n)t=n.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let r=o.src.match(/\/photos\/([^\?]+)/)[1];t=r.charAt(0).toUpperCase()+r.slice(1)}}return e.click(),document.body.click(),$e=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function ct(){return $e||"Consultor"}function Et(e){let t=new Date,n=t.getHours(),o=t.getDay(),r="Ol\xE1",a="";n>=5&&n<12?(r="Bom dia",a='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):n>=12&&n<18?(r="Boa tarde",a='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(r="Boa noite",a='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let i=[];n>=0&&n<5?i=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:n<12?o===1?i=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?i=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:i=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:n<18?i=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:i=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(i=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let s=i[Math.floor(Math.random()*i.length)];return{prefix:`${r},`,name:e,suffix:s,icon:a,isFriday:o===5}}function dt(){let e="Cliente",t="[INSERIR URL]";try{let o=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let r=o.nextElementSibling.innerText.trim();r&&(e=r)}}catch(n){console.warn("Falha ao capturar Nome:",n)}try{let o=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(o&&o.nextElementSibling){let r=o.nextElementSibling.innerText.trim();r&&(t=r)}}catch(n){console.warn("Falha ao capturar Website:",n)}return{advertiserName:e,websiteUrl:t,agentName:ct()}}var wt=1e4;function Ot(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
    ...
    `,document.head.appendChild(t)}function K(e,t={}){let n=document.createElement("div");Object.assign(n.style,{position:"fixed",bottom:"24px",left:"50%",transform:"translateX(-50%) translateY(20px)",background:t.error?"#d93025":"#323232",color:"#fff",padding:"14px 24px",borderRadius:"4px",boxShadow:"0 2px 8px rgba(0,0,0,.3)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"opacity .3s ease, transform .3s ease"}),n.textContent=e,document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateX(-50%) translateY(0)"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateX(-50%) translateY(20px)",setTimeout(()=>n.remove(),300)},t.duration||4e3)}function kt(e,t=null){let n=0,o=0,r=0,a=0,i=t||e;i.style.cursor="grab",i.onmousedown=s;function s(x){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(x.target.tagName)||x.target.classList.contains("no-drag"))return;x=x||window.event,i.style.cursor="grabbing";let m=e.getBoundingClientRect();e.style.left=m.left+"px",e.style.top=m.top+"px",e.style.right="auto",e.style.bottom="auto",e.style.width||(e.style.width=m.width+"px"),wt++,e.style.zIndex=wt,r=x.clientX,a=x.clientY,e.setAttribute("data-dragging","false"),document.onmouseup=S,document.onmousemove=p}function p(x){x=x||window.event,x.preventDefault(),n=r-x.clientX,o=a-x.clientY,r=x.clientX,a=x.clientY,e.setAttribute("data-dragging","true"),e.style.top=e.offsetTop-o+"px",e.style.left=e.offsetLeft-n+"px"}function S(){document.onmouseup=null,document.onmousemove=null,i.style.cursor="grab",setTimeout(()=>{e.setAttribute("data-dragging","false")},100)}}var xe={position:"fixed",top:"calc(50% - 250px)",width:"380px",maxHeight:"90vh",zIndex:"9999",overflow:"hidden",display:"flex",flexDirection:"column",opacity:"0",transform:"scale(0.05)",pointerEvents:"none",fontFamily:"'Google Sans', 'Roboto'"};var Ge={display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Fe={width:"100%",padding:"10px 36px 10px 12px",borderRadius:"8px",border:"1px solid #dadce0",backgroundColor:"#fff",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%233c4043%22%20d%3D%22M287%20197.3l-116.5-116.5c-4.7-4.7-12.4-4.7-17.1%200L5.4%20197.3c-4.7%204.7-4.7%2012.4%200%2017.1l17.1%2017.1c4.7%204.7%2012.4%204.7%2017.1%200l94.3-94.3c4.7-4.7%2012.4-4.7%2017.1%200l94.3%2094.3c4.7%204.7%2012.4%204.7%2017.1%200l17.1-17.1c4.7-4.7%204.7-12.4%200-17.1z%22%2F%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"10px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'"};var We={fontSize:"10px",color:"#9aa0a6",textAlign:"center",padding:"8px 16px",borderTop:"1px solid #eee",marginTop:"16px"};var se={padding:"6px 12px",cursor:"pointer",fontSize:"14px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s ease",width:"100%",textAlign:"center"};var pt=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Tt=-1;function Pe(){let e=Math.floor(Math.random()*pt.length);return e===Tt&&(e=(e+1)%pt.length),Tt=e,pt[e]}var ge=e=>new Promise(t=>setTimeout(t,e));async function Yt(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let n=e.querySelector(".cursor");await ge(200);for(let o=0;o<t.length;o++){let r=t.charAt(o),a=document.createElement("span");a.textContent=r,n&&n.parentNode===e?n.before(a):e.appendChild(a);let i=Math.floor(Math.random()*60)+30;o===0&&(i=150),o>t.length-3&&(i=30),await ge(i)}await ge(600),n&&(n.style.display="none")}async function ut(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let S=i.querySelector(".cw-hero-grid"),x=i.querySelector(".cw-acc-container"),m=i.querySelector(".cw-results-container"),C=i.querySelector(".cw-search-input"),b=i.querySelector(".cw-status-bar"),h=i.querySelector(".cw-status-text"),A=i.querySelector(".cw-footer-icons");o.forEach(([g,d])=>{let l=n(d.name),c=document.createElement("div");c.className="cw-hero-card",c.id=`hero-${g}`,c.style.setProperty("--hero-color",l.color),c.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${Oe[l.icon]}</div>
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let y=t[g]?t[g].count:0;k(g,y>0?-y:1,d)},c.querySelector(".minus").onclick=()=>k(g,-1,d),c.querySelector(".plus").onclick=()=>k(g,1,d),c.dataset.color=l.color,S.appendChild(c)});function E(g,d){let l=n(d.name),c=document.createElement("div");return c.className="cw-task-item",c.dataset.id=g,c.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${l.bg}; color:${l.color}">
                    ${Oe[l.icon]||Oe.default}
                </div>
        ...
        `,c.onclick=v=>{if(v.target.closest(".cw-step-btn"))return;let y=t[g]?t[g].count:0;k(g,y>0?-y:1,d)},c.querySelector(".minus").onclick=()=>k(g,-1,d),c.querySelector(".plus").onclick=()=>k(g,1,d),c}Object.entries(r).forEach(([g,d])=>{let l=document.createElement("div");l.className="cw-acc-group";let c=document.createElement("div");c.className="cw-acc-header",c.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${d.brand.color}"></div>
                ${g}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,c.onclick=()=>{x.querySelectorAll(".cw-acc-group.open").forEach(y=>{y!==l&&y.classList.remove("open")}),l.classList.toggle("open")};let v=document.createElement("div");v.className="cw-acc-body",d.tasks.forEach(y=>{let w=E(y.key,y);v.appendChild(w)}),l.appendChild(c),l.appendChild(v),x.appendChild(l)});function k(g,d,l){t[g]||(t[g]={count:0,data:l,brand:n(l.name)}),t[g].count+=d,t[g].count<=0&&delete t[g],F(),q(),e&&e()}function F(){o.forEach(([v])=>{let y=S.querySelector(`#hero-${v}`);if(!y)return;let w=t[v];w?(y.classList.add("active"),y.querySelector(".cw-step-val").textContent=w.count,y.querySelector(".cw-step-val").style.color=y.dataset.color):y.classList.remove("active")}),i.querySelectorAll(".cw-task-item").forEach(v=>{let y=v.dataset.id,w=t[y];w?(v.classList.add("selected"),v.querySelector(".cw-step-val").textContent=w.count):v.classList.remove("selected")});let d=Object.keys(t),l=0,c=[];if(d.forEach(v=>{let y=t[v];l+=y.count;for(let w=0;w<y.count;w++)c.length<6&&c.push(y.brand)}),l>0){b.classList.add("visible");let v=l>1?"A\xE7\xF5es":"A\xE7\xE3o",y=l>1?"definidas":"definida";h.textContent=`${l} ${v} ${y}`,A.innerHTML="",c.forEach(w=>{let L=document.createElement("div");L.className="cw-mini-icon",L.innerHTML=Oe[w.icon]||Oe.default;let O=L.querySelector("svg");O&&(O.style.width="14px",O.style.height="14px"),A.appendChild(L)})}else b.classList.remove("visible")}C.addEventListener("input",g=>{let d=g.target.value.toLowerCase();if(d.length>0){x.style.display="none",m.style.display="block",m.innerHTML="";let l=!1;Object.entries(_e).forEach(([c,v])=>{if(v.name.toLowerCase().includes(d)){l=!0;let y=E(c,v);t[c]&&(y.classList.add("selected"),y.querySelector(".cw-step-val").textContent=t[c].count),m.appendChild(y)}}),l||(m.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else x.style.display="block",m.style.display="none"});function q(){p.innerHTML="";let g=Object.keys(t),d=!1,l="implementation";if(g.length===0){p.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let c=document.createElement("div");c.className="cw-info-banner",c.innerHTML=`
        ...
        `,p.appendChild(c),g.forEach(v=>{let y=t[v].data,w=t[v].count,L=t[v].brand,O=y.screenshots?y.screenshots[l]||[]:["Link da Evid\xEAncia"];if(O.length>0){d=!0;for(let U=1;U<=w;U++){let T=document.createElement("div");T.className="cw-screen-card",T.style.setProperty("--brand-color",L.color),T.style.setProperty("--brand-bg",L.bg),T.style.setProperty("--brand-shadow",L.color+"40");let I=document.createElement("div");I.className="cw-card-header";let Z=document.createElement("div");Z.className="cw-card-icon",Z.innerHTML=Oe[L.icon]||Oe.default;let P=document.createElement("div");P.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let j=document.createElement("input");j.className="cw-card-title-input",j.id=`name-${v}-${U}`,j.value=`${y.name}${w>1?" #"+U:""}`,j.title="Clique para renomear esta task";let R=document.createElement("span");R.className="cw-edit-hint",R.innerHTML="\u270E Renomear",P.appendChild(j),P.appendChild(R),I.appendChild(Z),I.appendChild(P),T.appendChild(I),O.forEach((oe,ne)=>{let $=document.createElement("div");$.className="cw-input-group";let de=document.createElement("label");de.className="cw-input-label",de.textContent=oe.replace(/📷|:|•/g,"").trim();let re=document.createElement("input");re.className="cw-input-field",re.id=`screen-${v}-${U}-${ne}`,re.placeholder="Cole o link aqui...",re.setAttribute("autocomplete","off"),re.addEventListener("input",()=>{re.value.trim().length>5?re.classList.add("filled"):re.classList.remove("filled")});let pe=document.createElement("div");pe.className="cw-input-check",pe.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',$.appendChild(de),$.appendChild(re),$.appendChild(pe),T.appendChild($)}),p.appendChild(T)}}}),s.style.display=d?"block":"none"}return{selectionElement:i,screenshotsElement:s,updateSubStatus:()=>q(),getCheckedElements:()=>Object.keys(t).map(g=>({value:g,closest:()=>({querySelector:()=>({textContent:t[g].count})})})),reset:()=>{for(let g in t)delete t[g];F(),q(),C.value="",x.style.display="block",m.style.display="none"}}}function zt(){let e="v3.6.0",t="bau",n="pt",o=!1,r=!1,a={input:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease"},textarea:{width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box",fontFamily:"'Google Sans', Roboto, sans-serif",transition:"border-color 0.2s ease, box-shadow 0.2s ease",height:"100px",resize:"vertical"},h3:{fontSize:"14px",fontWeight:"600",color:"#202124",margin:"0 0 12px 0"},label:{display:"block",fontSize:"14px",fontWeight:"500",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"14px",fontWeight:"400",cursor:"pointer",padding:"8px",background:"#f8f9fa",borderRadius:"6px",transition:"background-color 0.2s ease, box-shadow 0.2s ease",userSelect:"none"},checkboxInput:{width:"auto",marginRight:"10px",marginBottom:"0",cursor:"pointer",accentColor:"#1a73e8"},buttonBase:{flex:"1 1 0",padding:"10px 0",color:"#fff",border:"none",borderRadius:"8px",fontSize:"14px",fontWeight:"500",cursor:"pointer",marginTop:"16px"},stepBlock:{borderTop:"1px solid #eee",paddingTop:"12px",marginTop:"12px"},radioContainer:{display:"flex",gap:"15px",marginBottom:"10px"},optionalBtn:{width:"100%",padding:"10px",background:"white",border:"1px dashed #1a73e8",color:"#1a73e8",borderRadius:"6px",cursor:"pointer",fontWeight:"500",fontSize:"13px",marginBottom:"10px",transition:"all 0.2s"},helpLink:{fontSize:"12px",color:"#1a73e8",textDecoration:"none",cursor:"pointer",fontWeight:"500",display:"flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"color 0.2s"}},i=Pt(),s=jt(()=>{let N=s.getCheckedElements().map(f=>f.value);T&&T.value&&i.updateVisibility(T.value,N)}),p=document.createElement("div");p.id="autofill-popup",Object.assign(p.style,xe,{right:"100px",width:"400px",boxShadow:"none",opacity:"0",pointerEvents:"none",transition:"width 0.5s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease, transform 0.3s ease"}),p.style.transition+=", width 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";let x=ve(p,"Case Notes Assistant",e,"Gera notas padronizadas automaticamente. Selecione o status, as tasks realizadas e preencha os detalhes para inserir no caso.",{popup:p,googleLine:null},()=>lt()),m=x.lastElementChild;if(m){let u=document.createElement("div");u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',u.classList.add("no-drag"),Object.assign(u.style,{fontSize:"20px",color:"#9AA0A6",cursor:"pointer",padding:"8px",display:"flex",alignItems:"center",justifyContent:"center",marginRight:"4px",marginLeft:"auto",borderRadius:"50%",transition:"background 0.2s, transform 0.3s ease"}),u.title="Expandir/Contrair Janela",u.onmouseover=()=>u.style.backgroundColor="#e8eaed",u.onmouseout=()=>u.style.backgroundColor="transparent";let N=!1;u.onclick=()=>{N=!N,u.style.transform=N?"rotate(180deg)":"rotate(0deg)",p.style.width=N?"700px":"380px",N?u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>':u.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>'};let f=m.lastElementChild;f?m.insertBefore(u,f):m.appendChild(u)}p.appendChild(x);let C=document.createElement("div");Object.assign(C.style,{padding:"0 16px 16px 16px",overflowY:"auto",flexGrow:"1"}),p.appendChild(C);let b=document.createElement("div");b.textContent="created by lucaste@",Object.assign(b.style,We),p.appendChild(b);let h=document.createElement("div");h.id="step-lang-type";let A=document.createElement("label");Object.assign(A.style,a.label),h.appendChild(A);let E=document.createElement("div");Object.assign(E.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let k=document.createElement("div");k.textContent="Portugu\xEAs",k.classList.add("no-drag"),Object.assign(k.style,se);let F=document.createElement("div");F.textContent="Espa\xF1ol",F.classList.add("no-drag"),Object.assign(F.style,se),k.onclick=()=>at("pt"),F.onclick=()=>at("es"),E.appendChild(k),E.appendChild(F),h.appendChild(E),C.appendChild(h);let q=document.createElement("div");q.id="step-0-case-type";let g=document.createElement("label");Object.assign(g.style,a.label),q.appendChild(g);let d=document.createElement("div");Object.assign(d.style,{display:"flex",borderRadius:"8px",border:"1px solid #dadce0",overflow:"hidden",marginBottom:"16px"});let l=document.createElement("div");l.textContent="BAU",l.classList.add("no-drag"),Object.assign(l.style,se);let c=document.createElement("div");c.textContent="LM",c.classList.add("no-drag"),Object.assign(c.style,se),l.onclick=()=>nt("bau"),c.onclick=()=>nt("lm"),d.appendChild(l),d.appendChild(c),q.appendChild(d),C.appendChild(q);let v=document.createElement("div");v.id="step-1-selection";let y=document.createElement("label");Object.assign(y.style,a.label);let w=document.createElement("select");w.id="main-status",Object.assign(w.style,Fe),w.innerHTML='<option value="">-- Selecione --</option><option value="NI">NI - Need Info</option><option value="SO">SO - Solution Offered</option><option value="IN">IN - Inactive</option><option value="AS">AS - Assigned</option>';let L=document.createElement("div");Object.assign(L.style,{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginTop:"16px",marginBottom:"8px"});let O=document.createElement("label");Object.assign(O.style,a.label,{marginTop:"0",marginBottom:"0"});let U=document.createElement("a");U.target="_blank",U.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg> Guia de Substatus',Object.assign(U.style,a.helpLink),L.appendChild(O),L.appendChild(U);let T=document.createElement("select");T.id="sub-status",Object.assign(T.style,Fe),T.disabled=!0,v.appendChild(y),v.appendChild(w),v.appendChild(L),v.appendChild(T),C.appendChild(v);let I=document.createElement("div");I.id="step-1-1-portugal",Object.assign(I.style,a.stepBlock,{display:"none"});let Z=document.createElement("label");Object.assign(Z.style,a.label),I.appendChild(Z);let P=document.createElement("div");Object.assign(P.style,a.radioContainer);let j=document.createElement("div");Object.assign(j.style,{display:"flex",alignItems:"center"});let R=document.createElement("input");R.type="radio",R.name="portugal-group",R.value="sim",Object.assign(R.style,a.checkboxInput);let oe=document.createElement("label");oe.htmlFor="portugal-sim",Object.assign(oe.style,{cursor:"pointer"}),j.appendChild(R),j.appendChild(oe);let ne=document.createElement("div");Object.assign(ne.style,{display:"flex",alignItems:"center"});let $=document.createElement("input");$.type="radio",$.name="portugal-group",$.value="nao",$.checked=!0,Object.assign($.style,a.checkboxInput);let de=document.createElement("label");de.htmlFor="portugal-nao",Object.assign(de.style,{cursor:"pointer"}),ne.appendChild($),ne.appendChild(de),P.appendChild(j),P.appendChild(ne),I.appendChild(P),C.appendChild(I);function re(u){o=u,u?pe.style.display="block":pe.style.display="none"}R.onchange=()=>re(!0),$.onchange=()=>re(!1);let pe=document.createElement("div");pe.id="step-1-2-consent",Object.assign(pe.style,a.stepBlock,{display:"none"});let et=document.createElement("label");Object.assign(et.style,a.label),pe.appendChild(et);let Be=document.createElement("div");Object.assign(Be.style,a.radioContainer);let qe=document.createElement("div");Object.assign(qe.style,{display:"flex",alignItems:"center"});let Ce=document.createElement("input");Ce.type="radio",Ce.name="consent-group",Ce.value="Sim",Ce.checked=!0,Object.assign(Ce.style,a.checkboxInput);let Ve=document.createElement("label");Ve.htmlFor="consent-sim",Object.assign(Ve.style,{cursor:"pointer"}),qe.appendChild(Ce),qe.appendChild(Ve);let He=document.createElement("div");Object.assign(He.style,{display:"flex",alignItems:"center"});let Re=document.createElement("input");Re.type="radio",Re.name="consent-group",Re.value="N\xE3o",Object.assign(Re.style,a.checkboxInput);let Ue=document.createElement("label");Ue.htmlFor="consent-nao",Object.assign(Ue.style,{cursor:"pointer"}),He.appendChild(Re),He.appendChild(Ue),Be.appendChild(qe),Be.appendChild(He),pe.appendChild(Be),C.appendChild(pe);let Ae=document.createElement("div");Ae.id="step-1-5-snippets",Object.assign(Ae.style,a.stepBlock,{display:"none"});let tt=document.createElement("h3");Object.assign(tt.style,a.h3);let ue=document.createElement("div");ue.id="snippet-container",Ae.appendChild(tt),Ae.appendChild(ue),C.appendChild(Ae);let me=document.createElement("div");me.id="step-2-tasks",Object.assign(me.style,a.stepBlock,{display:"none"});let le=document.createElement("button");le.textContent="+ Gostaria de selecionar uma task?",Object.assign(le.style,a.optionalBtn),le.onmouseover=()=>{le.style.background="#e8f0fe"},le.onmouseout=()=>{le.style.background="white"};let Ie=document.createElement("h3");Object.assign(Ie.style,a.h3);let xt=document.createElement("div");xt.id="task-checkboxes-container",me.appendChild(le),me.appendChild(xt),me.appendChild(Ie),me.appendChild(s.selectionElement),C.appendChild(me);let be=document.createElement("div");be.id="step-3-form",Object.assign(be.style,a.stepBlock,{display:"none"});let ot=document.createElement("h3");Object.assign(ot.style,a.h3),be.appendChild(ot);let he=document.createElement("div");he.id="dynamic-form-fields-container",be.appendChild(he),be.appendChild(i.element),be.appendChild(s.screenshotsElement),C.appendChild(be);let Ee=document.createElement("div");Ee.id="step-4-email",Object.assign(Ee.style,{display:"none",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid #eee"});let we=document.createElement("label");we.style.display="flex",we.style.alignItems="center",we.style.cursor="pointer",we.style.fontSize="14px";let Te=document.createElement("input");Te.type="checkbox",Te.checked=!0,Object.assign(Te.style,a.checkboxInput),we.appendChild(Te),we.appendChild(document.createTextNode("Preencher email automaticamente?")),Ee.appendChild(we),C.appendChild(Ee);let Ne=document.createElement("div");Object.assign(Ne.style,{display:"none",gap:"8px",padding:"0"}),C.appendChild(Ne);let Me=document.createElement("button");Object.assign(Me.style,a.buttonBase,{backgroundColor:"#5f6368"}),Me.textContent="Copiar";let De=document.createElement("button");Object.assign(De.style,a.buttonBase,{backgroundColor:"#1a73e8"}),De.textContent="Preencher",Ne.appendChild(Me),Ne.appendChild(De),document.body.appendChild(p);function nt(u){t=u;let N=Pe();Object.assign(l.style,se),Object.assign(c.style,se),u==="bau"?(Object.assign(l.style,N),U.href="https://docs.google.com/presentation/d/1Jra4de31rYaFZ0JMH_CiVzr2S3F8J1qcUcJRaw0Lw5Q/edit?slide=id.g2fd98a4e46f_11_2657#slide=id.g2fd98a4e46f_11_2657"):(Object.assign(c.style,N),U.href="https://docs.google.com/presentation/d/1CzrmfatUVReZWKAbwxHxcB3YXsH834xO6pPhTsZ7yjM/edit?slide=id.g1f1e626a09c_2_2243&resourcekey=0-KmtR4noMvEx3PODZk_ZvQw#slide=id.g1f1e626a09c_2_2243"),T.value&&T.dispatchEvent(new Event("change"))}function M(u){try{if(fe&&fe[n]&&fe[n][u])return fe[n][u];if(fe&&fe.pt&&fe.pt[u])return fe.pt[u]}catch{}return u}function Ht(){A.textContent=M("idioma"),g.textContent=M("fluxo"),y.textContent=M("status_principal"),O.textContent=M("substatus"),tt.textContent=M("cenarios_comuns"),Ie.textContent=M("selecione_tasks"),ot.textContent=M("preencha_detalhes"),Me.textContent=M("copiar"),De.textContent=M("preencher"),w.querySelector('option[value=""]')&&(w.querySelector('option[value=""]').textContent=M("select_status")),T.querySelector('option[value=""]')&&(T.querySelector('option[value=""]').textContent=M("select_substatus")),Z.textContent=M("caso_portugal"),oe.textContent=M("sim"),de.textContent=M("nao"),et.textContent=M("consentiu_gravacao"),Ve.textContent=M("sim"),Ue.textContent=M("nao"),he.querySelectorAll("label").forEach(u=>{let N=u.nextElementSibling.id.replace("field-",""),f=M(N.toLowerCase());f!==N.toLowerCase()?u.textContent=f:u.textContent=N.replace(/_/g," ").replace(/\b\w/g,D=>D.toUpperCase())+":"}),le.textContent="+ "+(n==="pt"?"Gostaria de selecionar uma task?":"Quisiera seleccionar una tarea?")}function at(u){n=u;let N=Pe();Object.assign(k.style,se),Object.assign(F.style,se),u==="pt"?(Object.assign(k.style,N),I.style.display="block",re(o)):(Object.assign(F.style,N),I.style.display="none",pe.style.display="none"),Ht(),T.value&&T.dispatchEvent(new Event("change"))}function it(u){(u.value.trim()===""||u.value.trim()==="\u2022")&&(u.value="\u2022 "),u.onkeydown=function(N){if(N.key==="Enter"){N.preventDefault();let f=this.selectionStart,D=this.selectionEnd,X=this.value,ie=X.lastIndexOf(`
`,f-1)+1,Y=X.substring(ie,f),B=Y.trim()==="\u2022"||Y.trim()===""?`
`:`
\u2022 `;this.value=X.substring(0,f)+B+X.substring(D),this.selectionStart=this.selectionEnd=f+B.length}else if(N.key==="Backspace"){let f=this.selectionStart;if(f===this.selectionEnd&&f>0){let D=this.value.substring(0,f);D.endsWith(`
\u2022 `)?(N.preventDefault(),this.value=D.substring(0,f-3)+this.value.substring(this.selectionEnd),this.selectionStart=this.selectionEnd=f-3):D==="\u2022 "&&(N.preventDefault(),this.value="",this.selectionStart=this.selectionEnd=0)}}}}function st(){let u=typeof ue<"u"?ue:document.getElementById("snippet-container");if(!u)return;let N=u.querySelectorAll('input[type="checkbox"]:checked, input[type="radio"]:checked'),f={},D=new Set;N.forEach(Y=>{let B=Y.id,Q=Le[B];if(Q)for(let z in Q)z==="linkedTask"?D.add(Q.linkedTask):z!=="type"&&(f[z]||(f[z]=[]),f[z].includes(Q[z])||f[z].push(Q[z]))});let X=new Set;Object.values(Le).forEach(Y=>{Object.keys(Y).forEach(B=>{B!=="linkedTask"&&B!=="type"&&X.add(B)})}),X.forEach(Y=>{let B=document.getElementById(Y);if(B){let Q=f[Y]||[],z="";ze.includes(Y.replace("field-",""))?(z=Q.map(G=>G.startsWith("\u2022 ")?G:"\u2022 "+G).join(`
`),z===""?z="\u2022 ":z.endsWith(`
\u2022 `)||(z+=`
\u2022 `)):z=Q.join(`

`),z.trim()!=="\u2022"&&z.trim()!==""?B.value=z:ze.includes(Y.replace("field-",""))?B.value="\u2022 ":B.value="",B.tagName==="TEXTAREA"&&typeof it=="function"&&it(B)}}),document.querySelectorAll(".task-checkbox").forEach(Y=>{D.has(Y.value)&&(Y.checked||(Y.checked=!0,Y.dispatchEvent(new Event("change",{bubbles:!0}))))})}w.onchange=()=>{let u=w.value;if(rt(1.5),T.innerHTML=`<option value="">${M("select_substatus")}</option>`,!u){T.disabled=!0;return}for(let N in je){let f=je[N];if(f.status===u){let D=document.createElement("option");D.value=N,D.textContent=f.name,T.appendChild(D)}}T.disabled=!1},T.onchange=()=>{let u=T.value;if(rt(1.5),!u)return;s.updateSubStatus(u);let N=je[u];ue.innerHTML="";let f=(G,V,H)=>{let J=document.createElement("label");Object.assign(J.style,a.checkboxLabel),J.onmouseover=()=>J.style.backgroundColor="#e8eaed",J.onmouseout=()=>J.style.backgroundColor="#f8f9fa";let W=document.createElement("input");return W.type=V,W.id=G.id,Object.assign(W.style,a.checkboxInput),J.appendChild(W),J.appendChild(document.createTextNode(` ${G.text}`)),H.appendChild(J),W},D=[],X="radio";if(u==="NI_Awaiting_Inputs")D=[{id:"quickfill-ni-inicio-manual",text:"In\xEDcio 2/6 (Manual)"},{id:"quickfill-ni-cms-access",text:"In\xEDcio 2/6 (ADV sem acesso ao CMS)"},{id:"quickfill-ni-followup-bau",text:"Follow-up 2/6 (BAU)"},{id:"quickfill-ni-followup-lm",text:"Follow-up 2/6 (LM)"}];else if(u.startsWith("SO_"))X="checkbox",D=[{id:"quickfill-gtm-install",text:"Instala\xE7\xE3o do GTM"},{id:"quickfill-whatsapp",text:"Convers\xE3o de WhatsApp"},{id:"quickfill-form",text:"Convers\xE3o de Formul\xE1rio (Padr\xE3o)"},{id:"quickfill-ecw4-close",text:"Fechamento ECW4 (P\xF3s 7 dias)"}];else if(u.startsWith("AS_")){X="checkbox";let G=document.createElement("label");G.textContent=M("cenarios_comuns"),Object.assign(G.style,a.label),ue.appendChild(G),D=[{id:"quickfill-as-no-show",text:"Anunciante n\xE3o compareceu (respondeu e-mail)"},{id:"quickfill-as-insufficient-time",text:"Tempo insuficiente"},{id:"quickfill-as-no-access",text:"Anunciante sem acessos necess\xE1rios"}]}else u.startsWith("IN_")&&(D=[{id:"quickfill-in-nrp-bau",text:"NRP (BAU - 3 tentativas)"},{id:"quickfill-in-nrp-lm",text:"NRP (LM - Sem tentativas)"},{id:"quickfill-in-no-show-bau",text:"No-Show (BAU - 3 tentativas)"},{id:"quickfill-in-2-6-final",text:"Finaliza\xE7\xE3o 2/6 (Sem Resposta)"},{id:"quickfill-in-manual",text:"Outro (Manual)"}]);let ie=D.filter(G=>{let V=Le[G.id];return!V.type||V.type==="all"||V.type===t});ie.forEach((G,V)=>{let H=f(G,X,ue);X==="radio"&&(H.name="scenario-radio-group",V===0&&(H.checked=!0))}),ie.length>0&&(Ae.style.display="block"),N.requiresTasks?(le.style.display="none",Ie.style.display="block",s.selectionElement.style.display="block",me.style.display="block"):(le.style.display="block",Ie.style.display="none",s.selectionElement.style.display="none",me.style.display="block"),he.innerHTML="";let Y=N.template.match(/{([A-Z0-9_]+)}/g)||[];[...new Set(Y)].forEach(G=>{if(["{TAGS_IMPLEMENTED}","{SCREENSHOTS_LIST}","{CONSENTIU_GRAVACAO}","{CASO_PORTUGAL}"].includes(G))return;let V=G.slice(1,-1),H=document.createElement("label"),J=M(V.toLowerCase());H.textContent=J!==V.toLowerCase()?J:V.replace(/_/g," ").replace(/\b\w/g,ee=>ee.toUpperCase())+":",Object.assign(H.style,a.label);let W;ze.includes(V)?(W=document.createElement("textarea"),Object.assign(W.style,a.textarea),W.classList.add("bullet-textarea"),it(W)):mt.includes(V)?(W=document.createElement("textarea"),Object.assign(W.style,a.textarea)):(W=document.createElement("input"),W.type="text",Object.assign(W.style,a.input),V==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))&&(Object.assign(H.style,{display:"none"}),Object.assign(W.style,{display:"none"}))),V==="ON_CALL"&&t==="lm"&&(Object.assign(H.style,{display:"none"}),Object.assign(W.style,{display:"none"}),W.value="N/A"),W.id=`field-${V}`,he.appendChild(H),he.appendChild(W)});let Q=ue.querySelectorAll('input[type="checkbox"], input[type="radio"]');Q.length>0&&(Q.forEach(G=>{G.removeEventListener("change",st),G.addEventListener("change",st)}),st()),be.style.display="block",Ye[u]?Ee.style.display="block":Ee.style.display="none",Ne.style.display="flex";let z=s.getCheckedElements().map(G=>G.value);i.updateVisibility(u,z)},le.onclick=()=>{le.style.display="none",Ie.style.display="block",s.selectionElement.style.display="block"};function yt(){let u=T.value;if(!u)return null;let f=je[u].template.replace(/\n/g,"<br>"),D='style="margin-bottom: 12px; padding-left: 30px;"',X=[],ie="",Y=s.getCheckedElements();Y.length>0&&Y.forEach(z=>{let G=z.value,V=_e[G],H=z.closest().querySelector(".stepper-count"),J=H?parseInt(H.textContent):1;J>1?X.push(`${V.name} (x${J})`):X.push(V.name)});let B=s.screenshotsElement;if(B){let G=Array.from(B.querySelectorAll('input[id^="name-"]')).filter(V=>V.offsetParent!==null);G.length>0&&G.forEach(V=>{let H=V.value,W=V.closest("div").parentNode.querySelectorAll('input[id^="screen-"]'),ee=!1,ce="";W.forEach(vt=>{let St=vt.previousElementSibling,Ut=St?St.textContent.replace("\u{1F4F7} ","").replace(":",""):"Print",Ct=vt.value.trim(),$t=Ct?` ${Ct}`:"";ce+=`<li>${Ut} -${$t}</li>`,ee=!0}),ee&&(ie+=`<b>${H}</b>`,ie+=`<ul ${D}>${ce}</ul>`)})}if(f.includes("{TAGS_IMPLEMENTED}")?f=f.replace(/{TAGS_IMPLEMENTED}/g,X.join(", ")||"N/A"):X.length>0&&(f+=`<br><b>Tags:</b> ${X.join(", ")}<br>`),f.includes("{SCREENSHOTS_LIST}")?f=f.replace(/{SCREENSHOTS_LIST}/g,ie?`${ie}`:"N/A"):ie!==""&&(f+=`<br>${ie}`),n==="pt"&&o){let z=Ce.checked?M("sim"):M("nao");f=f.replace(/{CONSENTIU_GRAVACAO}/g,`<br><b>${M("consentiu_gravacao")}</b> ${z}<br><br>`),f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${M("caso_portugal")}</b> ${M("sim")}<br>`)}else n==="pt"&&!o?(f=f.replace(/{CASO_PORTUGAL}/g,`<br><b>${M("caso_portugal")}</b> ${M("nao")}<br>`),f=f.replace(/{CONSENTIU_GRAVACAO}/g,"")):(f=f.replace(/{CASO_PORTUGAL}/g,""),f=f.replace(/{CONSENTIU_GRAVACAO}/g,""));return he.querySelectorAll("input, textarea").forEach(z=>{let G=z.id.replace("field-",""),V=new RegExp(`{${G}}`,"g"),H=z.value;if(G==="REASON_COMMENTS"&&(u.startsWith("NI_")||u.startsWith("IN_"))){let ee=ue.querySelector('input[type="radio"]:checked');ee&&Le[ee.id]&&(H=Le[ee.id]["field-REASON_COMMENTS"])}if(ze.includes(G)&&H.trim()!==""){let ee=H.split(`
`).map(ce=>ce.trim()).filter(ce=>ce!==""&&ce!=="\u2022").map(ce=>ce.startsWith("\u2022 ")?ce.substring(2):ce).map(ce=>`<li>${ce}</li>`).join("");H=ee?`<ul ${D}>${ee}</ul>`:""}else mt.includes(G)?H=H.split(`
`).filter(ee=>ee.trim()!=="").map(ee=>`<p style="margin: 0 0 8px 0;">${ee}</p>`).join(""):z.tagName==="TEXTAREA"&&(H=H.replace(/\n/g,"<br>"));let J=H.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(J===""||J==="\u2022"||J.toLowerCase()==="n/a"){let ee=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${G}\\}(?:<br>\\s*)?`,"gi");ee.test(f)?f=f.replace(ee,""):f=f.replace(V,"")}else f=f.replace(V,H.replace(/\$/g,"$$$$"))}),f=f.replace(/{([A-Z0-9_]+)}/g,""),f=f.replace(/(<br>){3,}/g,"<br><br>"),typeof i<"u"&&i.getOutput&&(f+=i.getOutput()),f}Me.onclick=()=>{let u=yt();u?(gt(u),K(M("copiado_sucesso"))):K(M("selecione_substatus"),{error:!0})},De.onclick=async()=>{let u=T.value,N=yt();if(!N){K(M("selecione_substatus"),{error:!0});return}gt(N),lt();let f=Qe(),D=await Ft();if(D)try{if(D.focus(),D.innerHTML.trim()==="<p><br></p>"||D.innerHTML.trim()==="<br>"||D.innerText.trim()===""){let B=document.createRange();B.selectNodeContents(D);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(B),document.execCommand("delete",!1,null)}else if(!D.innerHTML.endsWith("<br><br>")){let B=document.createRange();B.selectNodeContents(D),B.collapse(!1);let Q=window.getSelection();Q.removeAllRanges(),Q.addRange(B),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,N),Gt(D),setTimeout(()=>{K(M("inserido_copiado"))},600);let ie=typeof Te<"u"&&Te?Te.checked:!0;if(u&&Ye[u]&&ie){let B=Ye[u];await Nt(B),await new Promise(Q=>setTimeout(Q,500))}f(),rt(1.5),w.value="",T.innerHTML=`<option value="">${M("select_substatus")}</option>`,T.disabled=!0}catch(X){console.error(X),K("Erro ao inserir.",{error:!0}),f()}};function rt(u=1.5){u<=1.5&&(Ae.style.display="none",ue.innerHTML=""),u<=2&&(me.style.display="none",s.reset(),le.style.display="none"),u<=3&&(be.style.display="none",he.innerHTML="",i.reset(),Ne.style.display="none",Ee.style.display="none")}function lt(){r=!r,Se(r,p,"cw-btn-notes")}return nt("bau"),at("pt"),lt}var ke={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                    <p>Ol\xE1,</p>
                    <br>
      ...
      `;let j=y.querySelector("#csa-back-btn");j.onmouseover=()=>j.style.backgroundColor="#f1f3f4",j.onmouseout=()=>j.style.backgroundColor="transparent",j.onclick=O;let R=y.querySelector("#csa-insert-btn");R.onmouseover=()=>R.style.backgroundColor="#174ea6",R.onmouseout=()=>R.style.backgroundColor="#1a73e8",R.onclick=async()=>{R.style.transform="scale(0.96)",A();let oe=Qe();try{await bt(I),oe()}catch(ne){console.error(ne),oe()}setTimeout(()=>{R.style.transform="scale(1)",O()},300)}}function O(){o="list",F.style.transform="translateX(0)"}function U(){l.innerHTML="",Object.keys(ke).forEach(I=>{let Z=ke[I],P=document.createElement("button");P.textContent=Z.title,Object.assign(P.style,S),t===I&&n===""&&Object.assign(P.style,x),P.onclick=()=>{t=I,n="",d.value="",U(),T()},l.appendChild(P)})}function T(){c.innerHTML="";let I=[];if(n.trim()!==""?Object.values(ke).forEach(j=>{let R=j.emails.filter(oe=>oe.name.toLowerCase().includes(n.toLowerCase()));I=[...I,...R]}):ke[t]&&(I=ke[t].emails),I.length===0){c.innerHTML='<div style="text-align:center; padding:60px 20px; color:#9aa0a6;"><div style="font-size:24px; margin-bottom:8px;">\u{1F50D}</div><div style="font-size:14px;">Nenhum template encontrado.</div></div>';return}let Z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',P='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>';I.forEach(j=>{let R=document.createElement("div");Object.assign(R.style,m);let oe=j.subject.length>50?j.subject.substring(0,50)+"...":j.subject;R.innerHTML=`
        <div style="flex-grow: 1; margin-right: 12px; min-width: 0;">
            <div style="font-size:13px; font-weight:600; color:#202124; margin-bottom:2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${j.name}</div>
            <div style="font-size:12px; color:#5f6368; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${oe}</div>
        </div>
        <div style="display:flex; gap:6px;">
            <button class="action-btn view" title="Visualizar" style="width:32px; height:32px; border-radius:50%; border:none; background:#f1f3f4; color:#5f6368; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all 0.2s;">${P}</button>

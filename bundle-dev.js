(()=>{var nt="",Gt=e=>new Promise(t=>setTimeout(t,e));async function zt(){if(nt)return nt;try{let e=document.querySelector("profile-icon material-button")||document.querySelector('a[aria-label*="Account"]');if(!e)return"Agente";e.click(),await Gt(100);let t="Consultor",a=document.querySelector("profile-details .name");if(a)t=a.textContent.trim().split(" ")[0],t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();else{let o=document.querySelector("profile-details img");if(o&&o.src.includes("/photos/")){let s=o.src.match(/\/photos\/([^\?]+)/)[1];t=s.charAt(0).toUpperCase()+s.slice(1)}}return e.click(),document.body.click(),nt=t,t}catch(e){return console.warn("Sherlock falhou:",e),"Consultor"}}function vt(){return nt||"Consultor"}function Bt(e){let t=new Date,a=t.getHours(),o=t.getDay(),s="Ol\xE1",i="";a>=5&&a<12?(s="Bom dia",i='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#FBBC05" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):a>=12&&a<18?(s="Boa tarde",i='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#EA4335" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2"></path><path d="M12 20v2"></path><path d="M4.93 4.93l1.41 1.41"></path><path d="M17.66 17.66l1.41 1.41"></path><path d="M2 12h2"></path><path d="M20 12h2"></path><path d="M4.93 19.07l1.41-1.41"></path><path d="M17.66 6.34l1.41-1.41"></path></svg>'):(s="Boa noite",i='<svg class="weather-icon" viewBox="0 0 24 24" fill="none" stroke="#8AB4F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>');let n=[];a>=0&&a<5?n=["Guerreiro da madrugada.","O mundo dorme, voc\xEA avan\xE7a.","Foco total."]:a<12?o===1?n=["Vamos definir o tom da semana.","Nova semana, novas conquistas."]:o===5?n=["O \xFAltimo g\xE1s antes do descanso.","Vamos fechar com chave de ouro."]:n=["Que seu dia seja produtivo.","Foco e caf\xE9 para hoje."]:a<18?n=["Mantenha o ritmo.","Tarde produtiva pela frente.","Seguimos avan\xE7ando."]:n=["Encerrando o dia com produtividade.","Excelente dedica\xE7\xE3o."],(o===0||o===6)&&(n=["Sua dedica\xE7\xE3o no fim de semana \xE9 inspiradora.","Trabalho excepcional."]);let l=n[Math.floor(Math.random()*n.length)];return{prefix:`${s},`,name:e,suffix:l,icon:i,isFriday:o===5}}async function So(){try{let t=document.evaluate("//div[contains(@class, 'form-label') and contains(text(), 'Contact email')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(!t)return null;let a=t.parentElement,o=a.querySelector(".unmask-button")||a.querySelector('[aria-label="Click to view"]');o&&(o.click(),await Gt(500));let i=Array.from(a.querySelectorAll("a, span, div, pii-value")).find(n=>{let l=n.innerText.trim();return l.includes("@")&&!l.includes("Is this:")&&l.toLowerCase()!=="email"});return i?i.innerText.trim():null}catch(e){return console.warn("Erro ao capturar email do cliente:",e),null}}function Co(){try{let e=document.querySelector('material-input[debug-id="account-id-input"]');if(e){let t=e.querySelector("input");if(t){let a=t.value.trim();if(a)return a.includes("@")?a:`${a}@google.com`}}}catch(e){console.warn("Erro ao capturar email interno:",e)}return null}async function wt(){let e="Cliente",t="[INSERIR URL]";try{let i=document.evaluate("//div[contains(text(), 'Given name')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(i&&i.nextElementSibling){let n=i.nextElementSibling.innerText.trim();n&&(e=n)}}catch(s){console.warn("Falha Nome:",s)}try{let i=document.evaluate("//div[contains(text(), 'Website')]",document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;if(i&&i.nextElementSibling){let n=i.nextElementSibling.innerText.trim();n&&(t=n)}}catch(s){console.warn("Falha URL:",s)}let a=await So(),o=Co();return{advertiserName:e,websiteUrl:t,clientEmail:a,internalEmail:o,agentName:vt()}}var Pe=null,At=null,qe=.3;function Be(){if(!Pe){let e=window.AudioContext||window.webkitAudioContext;e&&(Pe=new e)}return Pe&&Pe.state==="suspended"&&Pe.resume(),Pe}function Pt(e){if(At)return At;let t=e.sampleRate*2,a=e.createBuffer(1,t,e.sampleRate),o=a.getChannelData(0);for(let s=0;s<t;s++)o[s]=Math.random()*2-1;return At=a,a}var te={playClick:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createBufferSource();a.buffer=Pt(e);let o=e.createBiquadFilter();o.type="highpass",o.frequency.value=4e3;let s=e.createGain();s.gain.setValueAtTime(qe*.8,t),s.gain.exponentialRampToValueAtTime(.001,t+.015),a.connect(o),o.connect(s),s.connect(e.destination),a.start(t),a.stop(t+.02)},playHover:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createOscillator();a.type="sine",a.frequency.setValueAtTime(400,t);let o=e.createGain();o.gain.setValueAtTime(0,t),o.gain.linearRampToValueAtTime(qe*.1,t+.005),o.gain.linearRampToValueAtTime(0,t+.02),a.connect(o),o.connect(e.destination),a.start(t),a.stop(t+.03)},playSuccess:()=>{let e=Be();if(!e)return;let t=e.currentTime;[1046.5,1567.9].forEach((o,s)=>{let i=e.createOscillator(),n=e.createGain();i.type="sine",i.frequency.value=o,n.gain.setValueAtTime(0,t),n.gain.linearRampToValueAtTime(qe*.6,t+.05),n.gain.exponentialRampToValueAtTime(.001,t+.6),i.connect(n),n.connect(e.destination),i.start(t),i.stop(t+.7)})},playGenieOpen:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createBufferSource();a.buffer=Pt(e);let o=e.createBiquadFilter();o.type="lowpass",o.frequency.setValueAtTime(100,t),o.frequency.exponentialRampToValueAtTime(800,t+.2);let s=e.createGain();s.gain.setValueAtTime(0,t),s.gain.linearRampToValueAtTime(qe*.5,t+.05),s.gain.linearRampToValueAtTime(0,t+.25),a.connect(o),o.connect(s),s.connect(e.destination),a.start(t),a.stop(t+.3)},playError:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=e.createOscillator(),o=e.createGain();a.type="triangle",a.frequency.setValueAtTime(120,t),a.frequency.exponentialRampToValueAtTime(80,t+.1),o.gain.setValueAtTime(qe,t),o.gain.exponentialRampToValueAtTime(.001,t+.15),a.connect(o),o.connect(e.destination),a.start(t),a.stop(t+.2)},playStartup:()=>{let e=Be();if(!e)return;let t=e.currentTime,a=.12,o=e.createOscillator(),s=e.createGain(),i=e.createBiquadFilter();o.type="square",o.frequency.setValueAtTime(400,t),o.frequency.exponentialRampToValueAtTime(50,t+.1),i.type="lowpass",i.frequency.setValueAtTime(800,t),i.frequency.exponentialRampToValueAtTime(100,t+.1),s.gain.setValueAtTime(qe*4,t),s.gain.exponentialRampToValueAtTime(.001,t+.1),o.connect(i),i.connect(s),s.connect(e.destination),o.start(t),o.stop(t+.12);let n=e.createOscillator(),l=e.createGain();n.type="sine",n.frequency.setValueAtTime(150,t),n.frequency.exponentialRampToValueAtTime(50,t+.15),l.gain.setValueAtTime(qe*1.5,t),l.gain.exponentialRampToValueAtTime(.001,t+.15),n.connect(l),l.connect(e.destination),n.start(t),n.stop(t+.15),[55,55.4,110.5].forEach(f=>{let c=e.createOscillator(),p=e.createGain(),g=e.createBiquadFilter();c.type="sawtooth",c.frequency.value=f,g.type="lowpass",g.frequency.setValueAtTime(30,t),g.frequency.linearRampToValueAtTime(900,t+a+.2),g.frequency.exponentialRampToValueAtTime(40,t+3),p.gain.setValueAtTime(0,t),p.gain.linearRampToValueAtTime(qe*.6,t+a+.1),p.gain.exponentialRampToValueAtTime(.001,t+3.5),c.connect(g),g.connect(p),p.connect(e.destination),c.start(t),c.stop(t+3.6)})},playNotification:()=>{let e=Be();if(!e)return;let t=e.currentTime;[{freq:880,dur:1.2,vol:.6},{freq:1760,dur:.6,vol:.3}].forEach(o=>{let s=e.createOscillator(),i=e.createGain();s.type="sine",s.frequency.setValueAtTime(o.freq,t),i.gain.setValueAtTime(0,t),i.gain.linearRampToValueAtTime(qe*o.vol,t+.004),i.gain.exponentialRampToValueAtTime(.001,t+o.dur),s.connect(i),i.connect(e.destination),s.start(t),s.stop(t+o.dur+.1)})},playSwoosh:()=>{te.playGenieOpen()},playReset:()=>{te.playError()},initGlobalListeners:()=>{if(window._cwSoundListenersActive)return;window._cwSoundListenersActive=!0;let e=0,t=50;document.addEventListener("mouseover",a=>{if(!Pe)return;let o=a.target.closest('button, a, input[type="checkbox"], .cw-btn, .cw-hero-card, .cw-task-item, [data-sound="hover"]');if(!o||o.contains(a.relatedTarget))return;let s=Date.now();s-e<t||(te.playHover(),e=s)},{passive:!0})}};var jt=1e4;function Vt(){if(document.getElementById("google-font-roboto")&&document.getElementById("techsol-global-styles"))return;let e=document.createElement("link");e.id="google-font-roboto",e.href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Google+Sans:wght@400;500;700&display=swap",e.rel="stylesheet",document.head.appendChild(e);let t=document.createElement("style");t.id="techsol-global-styles",t.textContent=`
        :root {
            --cw-primary: #1a73e8;
...
.cw-dropdown-option.selected { 
    ...
    `,document.head.appendChild(t)}function se(e,t={}){let a=document.createElement("div"),o=t.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(a.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:o,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",pointerEvents:"none"}),a.textContent=e,document.body.appendChild(a),t.error?te.playError():te.playSuccess(),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{a.style.opacity="0",a.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>a.remove(),400)},t.duration||4e3)}function $t(e,t=null){let a=0,o=0,s=0,i=0,n=t||e;n.style.cursor="grab",n.onmousedown=l;function l(c){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(c.target.tagName)||c.target.closest(".no-drag"))return;c=c||window.event,n.style.cursor="grabbing",e.style.transition="none";let p=e.getBoundingClientRect();e.style.transform="none",e.style.left=p.left+"px",e.style.top=p.top+"px",e.style.margin="0",e.style.bottom="auto",e.style.right="auto",jt++,e.style.zIndex=jt,s=c.clientX,i=c.clientY,e.setAttribute("data-dragging","true"),document.onmouseup=f,document.onmousemove=m}function m(c){c=c||window.event,c.preventDefault(),a=s-c.clientX,o=i-c.clientY,s=c.clientX,i=c.clientY;let p=e.offsetTop-o,g=e.offsetLeft-a,v=16,w=window.innerWidth,A=window.innerHeight,S=e.offsetWidth,I=e.offsetHeight;g<v?g=v:g+S>w-v&&(g=w-S-v),p<v?p=v:p+I>A-v&&(p=A-I-v),e.style.top=p+"px",e.style.left=g+"px"}function f(){document.onmouseup=null,document.onmousemove=null,n.style.cursor="grab",setTimeout(()=>{e.style.transition="all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease",e.setAttribute("data-dragging","false"),e.setAttribute("data-moved","true")},50)}}var Ae={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:"99999",overflow:"hidden",backgroundColor:"rgba(255, 255, 255, 0.98)",backdropFilter:"blur(20px)",webkitBackdropFilter:"blur(20px)",borderRadius:"16px",boxShadow:`
    0 0 1px rgba(0,0,0,0.08), 
    0 8px 24px rgba(0,0,0,0.12),
    0 20px 60px rgba(0,0,0,0.08)
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ct={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ut={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Wt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var he={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var St=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],Ht=-1;function Je(){let e=Math.floor(Math.random()*St.length);return e===Ht&&(e=(e+1)%St.length),Ht=e,St[e]}var Ie=e=>new Promise(t=>setTimeout(t,e));async function Eo(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let a=e.querySelector(".cursor");await Ie(200);for(let o=0;o<t.length;o++){let s=t.charAt(o),i=document.createElement("span");i.textContent=s,a&&a.parentNode===e?a.before(i):e.appendChild(i);let n=Math.floor(Math.random()*60)+30;o===0&&(n=150),o>t.length-3&&(n=30),await Ie(n)}await Ie(600),a&&(a.style.display="none")}async function Et(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await Ie(200);let t=await zt(),a=Bt(t),o=e.querySelector("#w-icon"),s=e.querySelector("#p1"),i=e.querySelector("#p2"),n=e.querySelector("#p3"),l=e.querySelector("#p-sextou");o&&(o.innerHTML=a.icon),s&&(s.textContent=a.prefix),n&&(n.textContent=a.suffix),await Ie(300);let m=o?o.querySelector("svg"):null;if(m&&(m.style.opacity="1",m.style.transform="scale(1)"),await Ie(400),s&&(s.style.opacity="1"),te.playStartup(),i&&await Eo(i,a.name),n&&(n.style.opacity="1",n.style.transform="translateY(0)"),a.isFriday&&l){await Ie(400),l.style.display="block",l.offsetWidth;let f=l.querySelector(".sextou-badge");f&&(f.style.opacity="1",f.style.transform="scale(1)")}await Ie(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await Ie(900),e.parentNode&&e.parentNode.removeChild(e)}}var Ye={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Xe(e,t){t.onmousedown=a;function a(o){o.stopPropagation(),o.preventDefault();let s=e.style.transition;e.style.transition="none";let i=o.clientX,n=o.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),m=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),f=i,c=n,p=!1;function g(A){f=A.clientX,c=A.clientY,p||(window.requestAnimationFrame(()=>{v(),p=!1}),p=!0)}function v(){let A=l+(f-i),S=m+(c-n);A>360&&(e.style.width=A+"px"),S>300&&(e.style.height=S+"px")}function w(){document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",w),setTimeout(()=>{e.style.transition=s},50)}document.addEventListener("mousemove",g),document.addEventListener("mouseup",w)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function Yt(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,a=>t[a]?t[a]:"")}var et=e=>new Promise(t=>setTimeout(t,e));function it(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}var Xt="cw-automation-styles";if(!document.getElementById(Xt)){let e=document.createElement("style");e.id=Xt,e.innerHTML=`
...
Irei abrir caso em BAU para o dia solicitado e pedir descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var ge=e=>new Promise(t=>setTimeout(t,e));function xe(e,t="info"){let a={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,a[t]||a.info)}function Ce(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(a=>e.dispatchEvent(new MouseEvent(a,t)))}function st(e,t){if(!e)return;let a=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(a);o&&o.remove();let s=e.getBoundingClientRect(),i=document.createElement("div");i.id=a,i.style.cssText=`
        position: fixed;
        top: ${s.bottom+8}px;
        left: ${s.left}px;
        min-width: 300px;
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let n=i.querySelector(".cw-close-btn");n.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&n.click()},25e3)}async function rt(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await ge(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await ge(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(a=>{let o=a.offsetParent!==null,s=a.closest("case-message-view")!==null,i=a.closest(".editor")!==null||a.closest("write-card")!==null;return o&&!s&&i});return t&&xe("Editor visualmente detectado.","success"),t}async function Zt(){xe("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=!1,a=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");if(a&&a.offsetParent!==null){xe("Bot\xE3o de email direto encontrado.");let p=a.closest("material-button")||a.closest("material-fab")||a;Ce(p),e=!0}else{xe("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let p=document.querySelector("material-fab-speed-dial");if(p){let g=p.querySelector(".trigger");if(g){Ce(g),await ge(800);let w=Array.from(document.querySelectorAll("i.material-icons-extended")).find(A=>A.innerText.trim()==="email");w&&(Ce(w),e=!0)}}}if(!e)return se("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;xe("\u{1F680} FASE 2: Verificando rascunhos...");let o=null,s=0,i=20;for(;s<i;){await ge(250);let p=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(o=Array.from(p).find(g=>g.offsetParent!==null),o){xe("\u26A0\uFE0F Rascunho detectado!","warn");break}s++}if(o){xe("\u{1F5D1}\uFE0F Descartando..."),Ce(o),o.click();let p=null,g=0;for(;g<15;){await ge(300);let v=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(p=Array.from(v).find(w=>w.offsetParent!==null),p)break;g++}p&&(Ce(p),se("Limpando rascunho antigo...",{duration:2e3}),await ge(2500))}xe("\u{1F680} FASE 3: Buscando editor final...");let n=0,l=null;for(;n<20&&(l=kt(),!l);)await ge(250),n++;if(!l)return se("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let m=l.closest('[id="email-body-content-top"]'),c=(l.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(m){if(c){let g=c.closest('[aria-hidden="true"]');g&&g.removeAttribute("aria-hidden"),c.focus(),Ce(c)}await ge(300),m.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let p=m.querySelector("#cases-body-field");if(p){let g=document.createRange();g.selectNodeContents(p),g.collapse(!0);let v=window.getSelection();v.removeAllRanges(),v.addRange(g)}return!0}return!1}async function lt(e){if(!e||!await Zt())return;let a=await wt();xe("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await ge(600)),a.clientEmail&&a.clientEmail!=="N/A"&&a.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await rt(i,a.clientEmail),st(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(a.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await rt(i,a.internalEmail),st(i,`
            ...
            `))}await ge(500);let s=document.querySelector('material-button[debug-id="canned_response_button"]');if(s){Ce(s),await ge(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){Ce(i),document.execCommand("insertText",!1,e),i.dispatchEvent(new Event("input",{bubbles:!0})),xe("\u23F3 Buscando resultado da Canned Response...","info");let n=null,l=0,m=15e3,f=500;for(;l<m&&(n=document.querySelector("material-select-dropdown-item"),!n);)await ge(f),l+=f;if(n){Ce(n),await ge(1500);let c=kt();if(c&&a.advertiserName){let p=c.innerHTML;p.includes("{%ADVERTISER_NAME%}")&&(c.innerHTML=p.replace(/{%ADVERTISER_NAME%}/g,a.advertiserName))}se("Canned Response aplicada!")}else xe(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),se(`Timeout: Template '${e}' n\xE3o carregou.`,{error:!0})}}else se("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function Jt(e){if(xe(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Zt())return;let a=await wt(),o=vt();await ge(600),xe("\u{1F4E7} Processando destinat\xE1rios...");let s=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(s&&(s.click(),await ge(600)),a.clientEmail&&a.clientEmail!=="N/A"&&a.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await rt(l,a.clientEmail),st(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(a.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await rt(l,a.internalEmail),st(l,`
                <strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia.
                <div style="margin-top:4px;">
                    <a href="https://mail.google.com/mail/u/0?ui=2&ik=ed23fb3167&attid=0.1&permmsgid=msg-f:1843445102914241244&th=19953b8dda2302dc&view=fimg&fur=ip&permmsgid=msg-f:1843445102914241244&sz=s0-l75-ft&attbid=ANGjdJ9m7O33cM36sxBYohVD6Qsapyux4PNr8qmTBlZ8zkp_LR79suGZhnxFJtBoFDeyMFygsH_tvCts5fnX0WV4rdClw9YqqR7guLnaXU9UzmZRRMRXEoC7T_MPbwo&disp=emb&realattid=ii_mfmv7wjm1&zw" target="_blank" style="color:#1a73e8;text-decoration:none;font-weight:500;display:inline-flex;align-items:center;">
                        Consultar Regra <span style="font-size:14px;margin-left:2px;">\u2197</span>
    ...
    `,document.head.appendChild(e)}function Te(e,t,a){let o=document.getElementById(a);if(!t)return;let s=t.getAttribute("data-moved")==="true",i={x:0,y:0};if(o){let c=o.getBoundingClientRect();i.x=c.left+c.width/2,i.y=c.top+c.height/2}let n,l;if(!s)n=window.innerWidth/2,l=window.innerHeight/2;else{let c=t.getBoundingClientRect();n=c.left+c.width/2,l=c.top+c.height/2,n===0&&l===0&&(n=window.innerWidth/2,l=window.innerHeight/2)}let m=i.x-n,f=i.y-l;e?(te.playGenieOpen(),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",s?t.style.transform=`translate(${m}px, ${f}px) scale(0.05)`:t.style.transform=`translate(calc(-50% + ${m}px), calc(-50% + ${f}px)) scale(0.05)`,t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("open"),o&&o.classList.add("active"),t.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",t.style.opacity="1",s?t.style.transform="translate(0, 0) scale(1)":t.style.transform="translate(-50%, -50%) scale(1)"}),typeof to=="function"&&to(t,a)):(te.playSwoosh(),t.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",t.style.pointerEvents="none",requestAnimationFrame(()=>{t.style.opacity="0",s?t.style.transform=`translate(${m}px, ${f}px) scale(0.1)`:t.style.transform=`translate(calc(-50% + ${m}px), calc(-50% + ${f}px)) scale(0.1)`}),setTimeout(()=>{t.classList.remove("open"),o&&o.classList.remove("active"),t.style.transition="",t.style.transform=""},300),typeof Ot=="function"&&Ot(t))}function to(e,t){Ot(e);let a=o=>{if(!e.classList.contains("open"))return;let s=e.contains(o.target),i=document.querySelector(".cw-pill"),n=i&&i.contains(o.target);s?(e.classList.remove("idle"),e.style.zIndex="2147483648"):n||(e.classList.add("idle"),e.style.zIndex="2147483646")};e._idleHandler=a,document.addEventListener("mousedown",a)}function Ot(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var no="https://script.google.com/a/macros/google.com/s/AKfycbwxxY5EhL3U1ZIEvs_y28FFeIFr7rMfSzNIljclqPd9Mk58-gx7pBRfZ8pQmXt2P1IMjw/exec",qt="cw_data_broadcast",oo="cw_data_tips",Oo=["Processando sua solicita\xE7\xE3o...","Dica: Mantenha suas notas organizadas.","Aguarde um momento...","Quase l\xE1..."];function ao(e){return new Promise((t,a)=>{let o="cw_cb_"+Math.round(1e4*Math.random()),s=document.createElement("script");window[o]=i=>{document.body.removeChild(s),delete window[o],t(i)},s.src=`${no}?op=${e}&callback=${o}&t=${Date.now()}`,s.onerror=()=>{document.body.removeChild(s),delete window[o],a(new Error("JSONP Load Error"))},document.body.appendChild(s)})}var He={fetchTips:async()=>{try{console.log("\u{1F4E5} Baixando dicas via JSONP...");let e=await ao("tips");e&&e.tips&&Array.isArray(e.tips)&&(localStorage.setItem(oo,JSON.stringify(e.tips)),console.log("\u2705 Dicas atualizadas:",e.tips.length))}catch(e){console.warn("TechSol: Erro ao baixar dicas (Offline).",e)}},fetchData:async()=>{try{console.log("\u{1F4E5} Baixando Broadcasts via JSONP...");let e=await ao("broadcast");if(e&&e.broadcast)return localStorage.setItem(qt,JSON.stringify(e.broadcast)),console.log("\u2705 Broadcasts atualizados:",e.broadcast.length),e}catch(e){console.warn("TechSol: Erro ao buscar Broadcasts.",e)}return{broadcast:JSON.parse(localStorage.getItem(qt)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(qt)||"[]"),getRandomTip:()=>{let e=Oo,t=localStorage.getItem(oo);if(t)try{e=JSON.parse(t)}catch{}return e[Math.floor(Math.random()*e.length)]},logUsage:(e,t="")=>{let o={op:"log",user:window._USER_ID||"agente_anonimo",action:e,meta:t};fetch(no,{method:"POST",mode:"no-cors",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(o)}).catch(s=>console.log("Log fail",s))}};var le={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00"},ct=e=>new Promise(t=>setTimeout(t,e));function io(e){let t="cw-command-center-style";if(!document.getElementById(t)){let v=document.createElement("style");v.id=t,v.innerHTML=`
...
@keyframes googleBounce {
    ...
    `,e.appendChild(a);let o=Date.now();return e.classList.add("processing-center"),t&&t.classList.add("active"),function(){let i=Date.now()-o,n=Math.max(0,2e3-i);setTimeout(()=>{let l=a.querySelector(".cw-center-dots"),m=a.querySelector(".cw-center-text"),f=a.querySelector(".cw-center-success");l&&(l.style.display="none"),m&&(m.style.display="none"),f&&f.classList.add("show"),e.classList.add("success"),setTimeout(()=>{e.classList.remove("processing-center"),setTimeout(()=>{a.remove(),e.classList.remove("success"),t&&t.classList.remove("active")},400)},1e3)},n)}}function so(e){let t=document.createElement("div");t.className="cw-step-scenarios";let a=document.createElement("div");Object.assign(a.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let o=document.createElement("div");Object.assign(o.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"40px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s ease"}),o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>";let s=null;Object.entries(Se).forEach(([n,l])=>{let m=document.createElement("div");m.textContent=n,Object.assign(m.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",display:"flex",alignItems:"center",gap:"6px"}),m.onmouseenter=()=>{s!==l&&(o.style.background="#fff",o.style.borderColor="#1a73e8",o.style.color="#202124",o.textContent=`"${l.substring(0,120)}${l.length>120?"...":""}"`),s!==l&&(m.style.background="#f1f3f4")},m.onmouseleave=()=>{s!==l&&(s||(o.style.background="#f8f9fa",o.style.borderColor="#dadce0",o.style.color="#5f6368",o.innerHTML="<span>Passe o mouse sobre um cen\xE1rio para visualizar o texto...</span>"),m.style.background="#ffffff")},m.onclick=()=>{te.playClick(),s===l?(s=null,i(),e("")):(s=l,i(),m.style.transform="scale(0.95)",setTimeout(()=>m.style.transform="scale(1)",150),e(l))},a.appendChild(m)});function i(){Array.from(a.children).forEach(n=>{Se[n.textContent]===s?(n.style.background="#e8f0fe",n.style.borderColor="#1a73e8",n.style.color="#1967d2",n.style.fontWeight="500"):(n.style.background="#ffffff",n.style.borderColor="#dadce0",n.style.color="#3c4043",n.style.fontWeight="400")})}return t.appendChild(a),t.appendChild(o),t}var ro=e=>new Promise(t=>setTimeout(t,e));function pt(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(a=>e.dispatchEvent(new MouseEvent(a,t)))}function It(e){let t=document.createElement("div");t.style.position="fixed",t.style.left="-9999px",t.innerHTML=e,document.body.appendChild(t);let a=document.createRange();a.selectNodeContents(t);let o=window.getSelection();o.removeAllRanges(),o.addRange(a);try{document.execCommand("copy")}catch{se("Falha ao copiar",{error:!0})}o.removeAllRanges(),document.body.removeChild(t)}function co(e){["input","change","keydown","keyup"].forEach(a=>{let o=new Event(a,{bubbles:!0,cancelable:!0});e.dispatchEvent(o)})}function lo(){return Array.from(document.querySelectorAll('div[contenteditable="true"]'))}async function po(){console.log("Iniciando processo de Nova Nota...");let e=lo(),t=e.length,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(n=>n.innerText.trim()==="description");if(o){let n=o.closest("material-fab")||o.closest("material-button");n?(n.style&&(n.style.display="block",n.style.visibility="visible"),pt(n)):pt(o)}else{let n=document.querySelector("material-fab-speed-dial");if(n){let l=n.querySelector(".trigger");l?(l.dispatchEvent(new MouseEvent("mouseenter",{bubbles:!0})),pt(l)):n.click(),await ro(800);let f=Array.from(document.querySelectorAll("i.material-icons-extended")).find(c=>c.innerText.trim()==="description");f&&pt(f)}}let s=null,i=0;for(;!s&&i<20;){await ro(300);let n=lo();if(n.length>t)s=n.find(l=>!e.includes(l)),s||(s=n[n.length-1]);else if(i>10){let l=n.filter(m=>m.offsetParent!==null);l.length>0&&(s=l[l.length-1])}i++}return s}var Y={primary:"#1a73e8",primaryBg:"#e8f0fe",text:"#202124",textSub:"#5f6368",border:"#dadce0",bgInput:"#f8f9fa",surface:"#ffffff",success:"#1e8e3e",warning:"#e37400",error:"#d93025"},ke="cubic-bezier(0.25, 0.8, 0.25, 1)",qo={width:"100%",padding:"12px 14px",borderRadius:"8px",border:`1px solid ${Y.border}`,backgroundColor:Y.bgInput,fontSize:"14px",color:Y.text,marginBottom:"16px",boxSizing:"border-box",fontFamily:"'Google Sans', 'Roboto', sans-serif",transition:`border-color 0.2s ${ke}, box-shadow 0.2s ${ke}, background-color 0.2s`,outline:"none"},sa={...qo,minHeight:"100px",resize:"vertical",lineHeight:"1.5"},ra={fontSize:"13px",fontWeight:"700",color:Y.textSub,textTransform:"uppercase",letterSpacing:"0.6px",margin:"0 0 12px 0"},la={display:"block",fontSize:"13px",fontWeight:"600",color:Y.text,marginBottom:"8px",marginTop:"16px"},ca={fontSize:"12px",color:Y.warning,marginTop:"6px",display:"flex",alignItems:"center",gap:"6px",fontWeight:"500"},da={fontSize:"12px",color:Y.primary,textDecoration:"none",cursor:"pointer",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"4px",marginLeft:"auto",transition:"opacity 0.2s"},pa={display:"flex",alignItems:"center",marginBottom:"8px",fontSize:"14px",fontWeight:"500",color:Y.text,cursor:"pointer",padding:"12px 14px",backgroundColor:Y.surface,border:`1px solid ${Y.border}`,borderRadius:"12px",transition:`all 0.2s ${ke}`,userSelect:"none",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},Nt={width:"18px",height:"18px",marginRight:"12px",cursor:"pointer",accentColor:Y.primary},ua={flex:"1 1 0",padding:"12px 0",color:"#fff",backgroundColor:Y.primary,border:"none",borderRadius:"50px",fontSize:"14px",fontWeight:"600",cursor:"pointer",marginTop:"20px",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.3)",transition:`transform 0.1s ${ke}, box-shadow 0.2s ${ke}`,display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},ma={width:"100%",padding:"10px",background:"#FFFFFF",border:`1px dashed ${Y.primary}`,color:Y.primary,borderRadius:"8px",cursor:"pointer",fontWeight:"600",fontSize:"13px",marginBottom:"12px",transition:`background-color 0.2s ${ke}`},ga={background:"transparent",border:`1px solid ${Y.border}`,borderRadius:"20px",color:Y.primary,cursor:"pointer",fontSize:"13px",fontWeight:"600",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",margin:"16px auto 0 auto",transition:`all 0.2s ${ke}`,fontFamily:"'Google Sans', 'Roboto'"};var ba={width:"24px",height:"24px",border:"none",borderRadius:"50%",backgroundColor:"#ffffff",boxShadow:"0 1px 3px rgba(0,0,0,0.15)",color:Y.text,cursor:"pointer",padding:"0",fontSize:"16px",fontWeight:"700",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",transition:"transform 0.1s ease"},fa={fontSize:"13px",fontWeight:"700",color:Y.primary,minWidth:"20px",textAlign:"center"},ha={width:"100%",padding:"12px 12px 12px 40px",borderRadius:"12px",border:`1px solid ${Y.border}`,backgroundColor:Y.surface,fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",outline:"none",transition:`border-color 0.2s ${ke}, box-shadow 0.2s ${ke}`},xa={display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"20px",paddingBottom:"12px",borderBottom:`1px solid ${Y.bgInput}`},ya={padding:"6px 12px",borderRadius:"8px",border:`1px solid ${Y.border}`,backgroundColor:Y.surface,color:Y.textSub,fontSize:"13px",fontWeight:"500",cursor:"pointer",transition:`all 0.2s ${ke}`,userSelect:"none",display:"flex",alignItems:"center",gap:"6px"},va={backgroundColor:Y.primaryBg,color:Y.primary,borderColor:Y.primary,fontWeight:"600"},wa={marginLeft:"4px",width:"16px",height:"16px",borderRadius:"50%",display:"none",alignItems:"center",justifyContent:"center",fontSize:"10px",color:Y.primary,backgroundColor:"rgba(255,255,255,0.6)",transition:"background 0.2s",lineHeight:"1"},Aa={borderTop:`1px solid ${Y.bgInput}`,paddingTop:"20px",marginTop:"16px"};var Sa={maxHeight:"240px",overflowY:"auto",border:`1px solid ${Y.border}`,borderRadius:"12px",marginTop:"8px",backgroundColor:Y.surface,boxShadow:"0 4px 20px rgba(0,0,0,0.05)",display:"none"},Ca={display:"flex",alignItems:"center",padding:"10px 16px",borderBottom:`1px solid ${Y.bgInput}`,cursor:"pointer",fontSize:"13px",color:Y.text,transition:"background 0.1s",userSelect:"none"};var Io={marginTop:"16px",marginBottom:"12px",padding:"10px",background:"#fff8e1",borderRadius:"6px",border:"1px solid #ffecb3",display:"none"},No={fontSize:"12px",color:"#e37400",marginTop:"4px"},Mo={width:"100%",padding:"8px",borderRadius:"8px",border:"1px solid #dadce0",fontSize:"14px",marginBottom:"12px",boxSizing:"border-box"},_o={display:"flex",gap:"15px",marginBottom:"10px"};function uo(){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Io);let t=document.createElement("label");t.textContent="Utilizou o Tag Support para criar/verificar?",Object.assign(t.style,Ct,{marginTop:"0"});let a=document.createElement("div");Object.assign(a.style,_o);let o=document.createElement("input");o.type="radio",o.name="ts_usage_mod",o.value="Sim",Object.assign(o.style,Nt);let s=document.createElement("label");s.textContent="Sim";let i=document.createElement("div");Object.assign(i.style,{display:"flex",alignItems:"center"}),i.appendChild(o),i.appendChild(s);let n=document.createElement("input");n.type="radio",n.name="ts_usage_mod",n.value="N\xE3o",n.checked=!0,Object.assign(n.style,Nt);let l=document.createElement("label");l.textContent="N\xE3o";let m=document.createElement("div");Object.assign(m.style,{display:"flex",alignItems:"center"}),m.appendChild(n),m.appendChild(l),a.appendChild(i),a.appendChild(m);let f=document.createElement("div");f.style.display="block";let c=document.createElement("label");c.textContent="Qual foi o Motivo?",Object.assign(c.style,Ct,{fontSize:"12px"});let p=document.createElement("input");p.type="text",Object.assign(p.style,Mo);let g=document.createElement("div");g.innerHTML='\u26A0\uFE0F <strong>Lembre-se de preencher o Form!</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>',Object.assign(g.style,No),f.appendChild(c),f.appendChild(p),f.appendChild(g),e.appendChild(t),e.appendChild(a),e.appendChild(f),o.onchange=()=>{f.style.display="none"},n.onchange=()=>{f.style.display="block"};function v(S,I){if(e.style.display="none",!S||S.includes("Education")||!I||I.length===0)return;let F=I.some(y=>y.includes("enhanced")||y==="ec_google_ads"),X=I.some(y=>(y.includes("conversion")||y.includes("ads"))&&!y.includes("enhanced")),oe=I.some(y=>y.includes("ga4")||y.includes("analytics")||y.includes("ua")),x=I.some(y=>y.includes("merchant")||y.includes("gmc")||y.includes("shopping"));(F||X&&!oe&&!x)&&(e.style.display="block")}function w(){if(e.style.display==="none")return"";let S=`<br><b>Utilizou Tag Support?</b> ${o.checked?"Sim":"N\xE3o"}`;return n.checked&&p.value.trim()!==""&&(S+=`<br><b>Motivo:</b> ${p.value}`),S+="<br>",S}function A(){e.style.display="none",n.checked=!0,o.checked=!1,f.style.display="block",p.value=""}return{element:e,updateVisibility:v,getOutput:w,reset:A}}var j={bg:"#F9FAFB",white:"#FFFFFF",border:"#E5E7EB",textMain:"#111827",textSub:"#6B7280",blue:"#007AFF",blueLight:"#EBF5FF",brands:{ads:{id:"ads",label:"Google Ads",color:"#1967D2",bg:"#E8F0FE",icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:"#E37400",bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:"#00A1F1",bg:"#E2F4FD",icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:"#0F9D58",bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},Ve={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function mo(e){let t={},a="implementation";function o(x){let b=x.toLowerCase();return b.includes("ads")||b.includes("conversion")||b.includes("remarketing")?j.brands.ads:b.includes("ga4")||b.includes("analytics")?j.brands.ga4:b.includes("gtm")||b.includes("tag manager")||b.includes("container")?j.brands.gtm:b.includes("merchant")||b.includes("shopping")||b.includes("feed")?j.brands.gmc:j.brands.default}let s=Object.entries(_e).filter(([x,b])=>b.popular),i={};Object.entries(_e).forEach(([x,b])=>{if(b.popular)return;let y=o(b.name);i[y.label]||(i[y.label]={brand:y,tasks:[]}),i[y.label].tasks.push({key:x,...b})});let n="cw-zen-tasks";if(!document.getElementById(n)){let x=document.createElement("style");x.id=n,x.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(x)}let l=document.createElement("div");l.className="cw-zen-container";let m=document.createElement("div");Object.assign(m.style,{display:"none"});let f=document.createElement("div");f.className="cw-screens-container",m.appendChild(f),l.innerHTML=`
    ...
    `;let c=l.querySelector(".cw-hero-grid"),p=l.querySelector(".cw-acc-container"),g=l.querySelector(".cw-results-container"),v=l.querySelector(".cw-search-input"),w=l.querySelector(".cw-status-bar"),A=l.querySelector(".cw-status-text"),S=l.querySelector(".cw-footer-icons");s.forEach(([x,b])=>{let y=o(b.name),r=document.createElement("div");r.className="cw-hero-card",r.id=`hero-${x}`,r.style.setProperty("--hero-color",y.color),r.innerHTML=`
        ...
        `,r.onclick=d=>{if(d.target.closest(".cw-step-btn"))return;let u=t[x]?t[x].count:0;F(x,u>0?-u:1,b)},r.querySelector(".minus").onclick=()=>F(x,-1,b),r.querySelector(".plus").onclick=()=>F(x,1,b),r.dataset.color=y.color,c.appendChild(r)});function I(x,b){let y=o(b.name),r=document.createElement("div");return r.className="cw-task-item",r.dataset.id=x,r.innerHTML=`
        ...
        `,r.onclick=d=>{if(d.target.closest(".cw-step-btn"))return;let u=t[x]?t[x].count:0;F(x,u>0?-u:1,b)},r.querySelector(".minus").onclick=()=>F(x,-1,b),r.querySelector(".plus").onclick=()=>F(x,1,b),r}Object.entries(i).forEach(([x,b])=>{let y=document.createElement("div");y.className="cw-acc-group";let r=document.createElement("div");r.className="cw-acc-header",r.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${b.brand.color}"></div>
                ${x}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,r.onclick=()=>{p.querySelectorAll(".cw-acc-group.open").forEach(u=>{u!==y&&u.classList.remove("open")}),y.classList.toggle("open")};let d=document.createElement("div");d.className="cw-acc-body",b.tasks.forEach(u=>{let h=I(u.key,u);d.appendChild(h)}),y.appendChild(r),y.appendChild(d),p.appendChild(y)});function F(x,b,y){t[x]||(t[x]={count:0,data:y,brand:o(y.name)}),t[x].count+=b,t[x].count<=0&&delete t[x],X(),oe(),e&&e()}function X(){s.forEach(([d])=>{let u=c.querySelector(`#hero-${d}`);if(!u)return;let h=t[d];h?(u.classList.add("active"),u.querySelector(".cw-step-val").textContent=h.count,u.querySelector(".cw-step-val").style.color=u.dataset.color):u.classList.remove("active")}),l.querySelectorAll(".cw-task-item").forEach(d=>{let u=d.dataset.id,h=t[u];h?(d.classList.add("selected"),d.querySelector(".cw-step-val").textContent=h.count):d.classList.remove("selected")});let b=Object.keys(t),y=0,r=[];if(b.forEach(d=>{let u=t[d];y+=u.count;for(let h=0;h<u.count;h++)r.length<6&&r.push(u.brand)}),y>0){w.classList.add("visible");let d=y>1?"A\xE7\xF5es":"A\xE7\xE3o",u=y>1?"definidas":"definida";A.textContent=`${y} ${d} ${u}`,S.innerHTML="",r.forEach(h=>{let C=document.createElement("div");C.className="cw-mini-icon",C.innerHTML=Ve[h.icon]||Ve.default;let E=C.querySelector("svg");E&&(E.style.width="14px",E.style.height="14px"),S.appendChild(C)})}else w.classList.remove("visible")}v.addEventListener("input",x=>{let b=x.target.value.toLowerCase();if(b.length>0){p.style.display="none",g.style.display="block",g.innerHTML="";let y=!1;Object.entries(_e).forEach(([r,d])=>{if(d.name.toLowerCase().includes(b)){y=!0;let u=I(r,d);t[r]&&(u.classList.add("selected"),u.querySelector(".cw-step-val").textContent=t[r].count),g.appendChild(u)}}),y||(g.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else p.style.display="block",g.style.display="none"});function oe(){f.innerHTML="";let x=Object.keys(t),b=!1,y=document.getElementById("sub-status"),r="implementation";if(y&&y.value.toLowerCase().includes("education")&&(r="education"),x.length===0){f.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}if(x.length===0){f.innerHTML='<div class="cw-empty-state">Selecione tarefas para ver os campos.</div>';return}let d=document.createElement("div");d.className="cw-info-banner",d.innerHTML=`
...
`).filter(H=>H.trim()!=="").map(H=>`<p style="margin: 0 0 8px 0;">${H}</p>`).join(""):Z.tagName==="TEXTAREA"&&(K=K.replace(/\n/g,"<br>"));let de=K.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(de===""||de==="\u2022"||de.toLowerCase()==="n/a"){let H=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${z}\\}(?:<br>\\s*)?`,"gi");H.test(O)?O=O.replace(H,""):O=O.replace(L,"")}else O=O.replace(L,K.replace(/\$/g,"$$$$"))}),O=O.replace(/{([A-Z0-9_]+)}/g,""),O=O.replace(/(<br>){3,}/g,"<br><br>"),typeof n<"u"&&n.getOutput&&(O+=n.getOutput()),O}Ke.onclick=()=>{let k=Rt();k?(It(k),se(U("copiado_sucesso"))):se(U("selecione_substatus"),{error:!0})},Qe.onclick=async()=>{let k=E.value,G=Rt();if(!G){se(U("selecione_substatus"),{error:!0});return}It(G),yt();let O=dt(),W=await po();if(W)try{if(W.focus(),W.innerHTML.trim()==="<p><br></p>"||W.innerHTML.trim()==="<br>"||W.innerText.trim()===""){let me=document.createRange();me.selectNodeContents(W);let ee=window.getSelection();ee.removeAllRanges(),ee.addRange(me),document.execCommand("delete",!1,null)}else if(!W.innerHTML.endsWith("<br><br>")){let me=document.createRange();me.selectNodeContents(W),me.collapse(!1);let ee=window.getSelection();ee.removeAllRanges(),ee.addRange(me),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,G),co(W),setTimeout(()=>{se(U("inserido_copiado"))},600);let pe=typeof ze<"u"&&ze?ze.checked:!0;if(k&&je[k]&&pe){let me=je[k];await lt(me),await new Promise(ee=>setTimeout(ee,500))}O(),xt(1.5),d.value="",E.innerHTML=`<option value="">${U("select_substatus")}</option>`,E.disabled=!0}catch(re){console.error(re),se("Erro ao inserir.",{error:!0}),O()}};function xt(k=1.5){k<=1.5&&(Le.style.display="none",we.innerHTML=""),k<=2&&(l.reset(),be.style.display="none"),k<=3&&(ye.style.display="none",Me.innerHTML="",n.reset(),We.style.display="none",De.style.display="none")}function yt(){if(s=!s,s){let k=m.querySelector(".cw-expand-btn");k&&typeof k.resetState=="function"&&k.resetState()}Te(s,m,"cw-btn-notes")}return gt("bau"),bt("pt"),yt}var $e={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
                ...
                `},{id:"nrp_dfa",name:"NRP - DFA",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Encerramento",body:`
                    ...
                    <br>
                    <p><strong>[Seu Nome]</strong><br>Time de Solu\xE7\xF5es T\xE9cnicas Cognizant, em nome do Google</p>
                `}]}};function bo(){let e="v4.2.0 CR-Hybrid",t="CANNED_RESPONSES",a=Object.keys($e)[0],o="",s="list",i=!1,n={bgApp:"#F8F9FA",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.08)",borderFocus:"rgba(26, 115, 232, 0.4)",textPrimary:"#202124",textSecondary:"#5F6368",primary:"#1A73E8",primaryBg:"#E8F0FE",shadowCard:"0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)",shadowHover:"0 4px 12px rgba(0,0,0,0.08), 0 2px 4px rgba(0,0,0,0.04)",transition:"all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1)"},l={display:"flex",flexDirection:"column",height:"100%",position:"relative",overflow:"hidden",background:n.bgApp},m={display:"flex",width:"200%",height:"100%",transition:"transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",transform:"translateX(0)",willChange:"transform"},f={width:"50%",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"},c={padding:"20px 24px 12px 24px",flexShrink:"0",background:n.bgApp,zIndex:"10",display:"flex",flexDirection:"column",gap:"16px",borderBottom:`1px solid ${n.borderSubtle}`},p={width:"100%",height:"44px",padding:"0 16px 0 48px",borderRadius:"12px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",fontWeight:"400",color:n.textPrimary,boxSizing:"border-box",outline:"none",transition:n.transition,boxShadow:"0 2px 5px rgba(0,0,0,0.03)",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="%239AA0A6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"16px center"},g={display:"flex",flexWrap:"wrap",justifyContent:"center",gap:"8px",paddingBottom:"4px"},v={padding:"6px 14px",borderRadius:"100px",border:"1px solid #DADCE0",background:"#FFFFFF",color:n.textSecondary,fontSize:"13px",fontWeight:"500",letterSpacing:"0.3px",cursor:"pointer",transition:n.transition,flexShrink:"0",display:"flex",alignItems:"center",justifyContent:"center"},w={background:n.primaryBg,color:n.primary,borderColor:"transparent",fontWeight:"600",boxShadow:"0 1px 2px rgba(26, 115, 232, 0.15)"},A={padding:"16px 24px 80px 24px",overflowY:"auto",flexGrow:"1",display:"flex",flexDirection:"column",gap:"12px"},S={display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 16px",height:"72px",minHeight:"72px",borderRadius:"16px",background:n.bgSurface,border:"1px solid transparent",boxShadow:n.shadowCard,cursor:"pointer",transition:"all 0.25s cubic-bezier(0.2, 0.8, 0.2, 1)",position:"relative",overflow:"hidden"},I=document.createElement("div");I.id="quick-email-popup",I.classList.add("cw-module-window"),Object.assign(I.style,Ae,{right:"100px",width:"440px",height:"640px",borderRadius:"20px",boxShadow:"0 24px 64px rgba(0,0,0,0.2)",border:"1px solid rgba(255,255,255,0.4)"});let F={popup:I,googleLine:null,focusElement:null};function X(){i=!i,Te(i,I,"cw-btn-email"),i||setTimeout(()=>T(),300)}let oe=Ee(I,"Quick Email",e,"Templates & Automa\xE7\xF5es",F,()=>X()),x=document.createElement("div");Object.assign(x.style,l);let b=document.createElement("div");Object.assign(b.style,m);let y=document.createElement("div");Object.assign(y.style,f);let r=document.createElement("div");Object.assign(r.style,c);let d=document.createElement("input");d.placeholder="Pesquisar templates...",Object.assign(d.style,p),d.onfocus=()=>{d.style.borderColor=n.primary,d.style.boxShadow="0 0 0 4px rgba(26, 115, 232, 0.15)",d.style.background="#fff"},d.onblur=()=>{d.style.borderColor="transparent",d.style.boxShadow="0 2px 5px rgba(0,0,0,0.03)",d.style.background="#fff"},F.focusElement=d;let u=document.createElement("div");Object.assign(u.style,g);let h=document.createElement("div");Object.assign(h.style,A),r.appendChild(d),r.appendChild(u),y.appendChild(r),y.appendChild(h);let C=document.createElement("div");Object.assign(C.style,f);let E=document.createElement("div");Object.assign(E.style,{padding:"0",overflowY:"auto",flexGrow:"1",background:"#fff"}),C.appendChild(E),b.appendChild(y),b.appendChild(C),x.appendChild(b),I.appendChild(oe),I.appendChild(x),document.body.appendChild(I);async function B(R,$){try{i&&X();let ae=dt();await new Promise(N=>setTimeout(N,800)),$==="email"?await Jt(R):$==="cr"&&await lt(R),ae()}catch(ae){console.error("\u274C Erro:",ae);let N=document.querySelector(".cw-focus-backdrop");N&&N.classList.remove("active")}}function M(R){s="detail",b.style.transform="translateX(-50%)";let $='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg>',ae='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>';E.innerHTML=`
            <style>
        ...
        `;let N=E.querySelector("#csa-back-btn");N.onmouseenter=()=>N.style.background="#f1f3f4",N.onmouseleave=()=>N.style.background="none",N.onclick=T;let D=E.querySelector("#csa-insert-btn");D.onmouseenter=()=>{D.style.transform="translateY(-1px)",D.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},D.onmouseleave=()=>{D.style.transform="translateY(0)",D.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},D.onclick=()=>{D.style.transform="scale(0.96)",B(R,"email"),setTimeout(()=>{D.style.transform="scale(1)",T()},300)}}function T(){s="list",b.style.transform="translateX(0)"}function q(R,$,ae=null){let N=document.createElement("button"),D=ae?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${ae}</span>`:"";return N.innerHTML=`${D}${R}`,Object.assign(N.style,v),a===$&&o===""?Object.assign(N.style,w):(N.onmouseenter=()=>{N.style.background="#F1F3F4",N.style.borderColor="#DADCE0"},N.onmouseleave=()=>{N.style.background="#FFFFFF",N.style.borderColor="#DADCE0"}),N.onclick=()=>{a=$,o="",d.value="",P(),V()},N}function P(){u.innerHTML="",u.appendChild(q("Smart CRs",t,"\u26A1")),Object.keys($e).forEach(R=>{u.appendChild(q($e[R].title,R))})}function V(){h.innerHTML="";let R=[];if(o.trim()!==""){let J=o.toLowerCase();Object.values($e).forEach(_=>{_.emails.forEach(Q=>{(Q.name.toLowerCase().includes(J)||Q.subject.toLowerCase().includes(J))&&R.push({type:"email",data:Q})})}),Object.entries(je).forEach(([_,Q])=>{if(!Q)return;(_.replace(/_/g," ").toLowerCase().includes(J)||Q.toLowerCase().includes(J))&&R.push({type:"cr",key:_,code:Q})})}else a===t?Object.entries(je).forEach(([J,_])=>{_&&R.push({type:"cr",key:J,code:_})}):$e[a]&&$e[a].emails.forEach(J=>{R.push({type:"email",data:J})});if(R.length===0){h.innerHTML=`
                ...
                </div>`;return}let ae='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1967D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>',N='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA8600" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',D='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BDC1C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>';R.forEach(J=>{let _=document.createElement("div");if(Object.assign(_.style,S),J.type==="email"){let Q=J.data,ue=Q.subject.length>45?Q.subject.substring(0,45)+"...":Q.subject;_.innerHTML=`
                    <div style="width:40px; height:40px; border-radius:10px; background:#E8F0FE; display:flex; align-items:center; justify-content:center; flex-shrink:0; margin-right:16px;">${ae}</div>
...
`),V=/\d{1,2}\/\d{1,2}/;if(P.forEach(N=>{let D=N.match(V);if(D){let J=D[0],_="\u{1F4C5}";/🇧🇷|🇵🇹|PT|BR/i.test(N)?_="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(N)&&(_="\u{1F1EA}\u{1F1F8}"),q.some(ue=>ue.flag===_&&ue.date===J)||q.push({flag:_,date:J})}}),q.length===0){let N=C.text.match(/\d{1,2}\/\d{1,2}/g);N&&[...new Set(N)].forEach(D=>q.push({flag:"\u{1F4C5}",date:D}))}let R="";q.length>0?R=`
              ...
              <div style="${f(n.bauHeader)} margin-bottom:8px;">
                  <div style="${f(n.liveIndicator)}">
                      <div style="${f(n.pulseDot)}"></div>
                      <span style="${f(n.bauLabel)}">Disponibilidade BAU</span>
                  </div>
                  <div style="font-size:10px; opacity:0.6; font-weight:500; color:#7E22CE;">${s(C.date)}</div>
              </div>
              ${R}
          `,v.after(T);let $=T.querySelector("#cw-bau-toggle-btn"),ae=T.querySelector("#cw-bau-full");$&&ae&&($.onclick=()=>{let N=ae.style.display==="none";ae.style.display=N?"block":"none",$.textContent=N?"Ocultar":"Detalhes",$.style.background=N?"#fff":"rgba(255,255,255,0.6)"})}let E=u.sort((T,q)=>{let P=d.includes(T.id),V=d.includes(q.id);return P===V?0:P?1:-1});if(E.length===0&&!C){let T=document.createElement("div");Object.assign(T.style,n.emptyState),T.innerHTML=`

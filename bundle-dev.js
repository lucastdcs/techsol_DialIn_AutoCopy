...
`).filter(Q=>Q.trim()!=="").map(Q=>`<p style="margin: 0 0 8px 0;">${Q}</p>`).join(""):oe.tagName==="TEXTAREA"&&(te=te.replace(/\n/g,"<br>"));let ue=te.replace(/<[^>]*>/g,"").replace(/&nbsp;/g," ").trim();if(ue===""||ue==="\u2022"||ue.toLowerCase()==="n/a"){let Q=new RegExp(`(?:<br>\\s*)?<[b|strong]+>[^<]+:\\s*<\\/[b|strong]+>\\s*\\{${W}\\}(?:<br>\\s*)?`,"gi");Q.test(F)?F=F.replace(Q,""):F=F.replace(P,"")}else F=F.replace(P,te.replace(/\$/g,"$$$$"))}),F=F.replace(/{([A-Z0-9_]+)}/g,""),F=F.replace(/(<br>){3,}/g,"<br><br>"),typeof r<"u"&&r.getOutput&&(F+=r.getOutput()),F}ot.onclick=()=>{let y=$t();y?(dt(y),V(J("copiado_sucesso"))):V(J("selecione_substatus"),{error:!0})},nt.onclick=async()=>{let y=f.value,$=$t();if(!$){V(J("selecione_substatus"),{error:!0});return}dt($),It();let F=yt(),K=await At();if(K)try{if(K.focus(),K.innerHTML.trim()==="<p><br></p>"||K.innerHTML.trim()==="<br>"||K.innerText.trim()===""){let ge=document.createRange();ge.selectNodeContents(K);let ie=window.getSelection();ie.removeAllRanges(),ie.addRange(ge),document.execCommand("delete",!1,null)}else if(!K.innerHTML.endsWith("<br><br>")){let ge=document.createRange();ge.selectNodeContents(K),ge.collapse(!1);let ie=window.getSelection();ie.removeAllRanges(),ie.addRange(ge),document.execCommand("insertHTML",!1,"<br><br>")}document.execCommand("insertHTML",!1,$),wt(K),setTimeout(()=>{V(J("inserido_copiado"))},600);let me=typeof $e<"u"&&$e?$e.checked:!0;if(y&&Ye[y]&&me){let ge=Ye[y];await ht(ge),await new Promise(ie=>setTimeout(ie,500))}F(),qt(1.5),N.value="",f.innerHTML=`<option value="">${J("select_substatus")}</option>`,f.disabled=!0}catch(re){console.error(re),V("Erro ao inserir.",{error:!0}),F()}};function qt(y=1.5){y<=1.5&&(Pe.style.display="none",Ee.innerHTML=""),y<=2&&(p.reset(),he.style.display="none"),y<=3&&(Ae.style.display="none",De.innerHTML="",r.reset(),Qe.style.display="none",He.style.display="none")}function It(){if(s=!s,s){let y=d.querySelector(".cw-expand-btn");y&&typeof y.resetState=="function"&&y.resetState()}Ie(s,d,"cw-btn-notes")}return Et("bau"),Tt("pt"),It}var Ke={CONTACT:{title:"Tentativas & Agendamento",emails:[{id:"attempt_10min",name:"Tentativa de Contato (Antes dos 10min)",subject:"Implementa\xE7\xE3o com o Time de Solu\xE7\xF5es T\xE9cnicas do Google - Tentativa de Contato",body:`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condi\xE7\xF5es.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las ferramentas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes  (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfa\xE7\xE3o.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes dias."]},"EN BAU":{color:"#ff0011",inicio:["Example 1","Example 2"],fim:["Example 3","Example 4"]}};function To(){let t="v2.1 (Apple Motion)",e={progressBarContainer:{height:"4px",background:"#f1f3f4",width:"100%",position:"relative",overflow:"hidden"},progressBarFill:{height:"100%",background:"linear-gradient(90deg, #4285F4, #34A853)",width:"0%",transition:"width 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)",borderRadius:"0 2px 2px 0"},contentArea:{padding:"16px",overflowY:"auto",flexGrow:"1",background:"#f8f9fa",scrollBehavior:"smooth"},card:{background:"#ffffff",border:"1px solid #dadce0",borderRadius:"12px",padding:"16px",marginBottom:"16px",transition:"transform 0.2s ease, box-shadow 0.2s ease",boxShadow:"0 1px 2px rgba(0,0,0,0.02)"},cardTitle:{fontSize:"13px",fontWeight:"700",color:"#5f6368",textTransform:"uppercase",letterSpacing:"0.6px",marginBottom:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none"},itemRow:{display:"flex",alignItems:"flex-start",padding:"10px 8px",cursor:"pointer",borderRadius:"8px",transition:"background-color 0.15s ease, opacity 0.3s ease",color:"#202124",fontSize:"14px",lineHeight:"1.5",marginBottom:"2px"},itemCompleted:{opacity:"0.5",textDecoration:"line-through",color:"#5f6368"},checkbox:{minWidth:"20px",height:"20px",borderRadius:"6px",border:"2px solid #dadce0",marginRight:"14px",marginTop:"1px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",background:"#fff"},footer:{padding:"12px 16px",borderTop:"1px solid #eee",background:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center"},resetBtn:{background:"transparent",border:"none",color:"#d93025",fontSize:"12px",fontWeight:"600",cursor:"pointer",padding:"6px 12px",borderRadius:"20px",transition:"background 0.2s ease",display:"flex",alignItems:"center",gap:"4px"}},o={},n="PT",s="BAU",i=!1,a=document.createElement("div");a.id="call-script-popup",a.classList.add("cw-module-window"),Object.assign(a.style,Te,{right:"auto",left:"50%",width:"400px",height:"650px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:a,googleLine:null};function p(){i=!i,Ie(i,a,"cw-btn-script")}let d=qe(a,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{p()});a.appendChild(d);let m=document.createElement("div");Object.assign(m.style,e.progressBarContainer);let c=document.createElement("div");Object.assign(c.style,e.progressBarFill),m.appendChild(c),a.appendChild(m);let g=document.createElement("div");g.id="csa-content",Object.assign(g.style,e.contentArea),a.appendChild(g);let b=document.createElement("div");Object.assign(b.style,e.footer);let u=document.createElement("span");u.textContent="by lucaste@",Object.assign(u.style,{fontSize:"10px",color:"#bdc1c6"});let A=document.createElement("button");A.innerHTML=`
  ...
  `,u.onfocus=()=>{g.style.background="#FFF",g.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)",g.style.borderColor=s.primary},u.onblur=()=>{g.style.background="#F1F3F4",g.style.boxShadow="none",g.style.borderColor=s.borderSubtle},g.appendChild(b),g.appendChild(u),c.appendChild(g),m.appendChild(c);let A=document.createElement("div");A.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",m.appendChild(A);let _=null;function G(){if(_)return;_=document.createElement("div"),_.style.cssText=`
      ...
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Hist\xF3rico Recente</span>';let x=document.createElement("button");x.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',x.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",x.onclick=Z,k.appendChild(x),_.appendChild(k);let h=document.createElement("div");h.id="cw-history-list",h.style.cssText="flex: 1; overflow-y: auto; padding: 20px;",_.appendChild(h),m.appendChild(_)}function B(){_||G();let k=_.querySelector("#cw-history-list");k.innerHTML="";let x=Yo();x.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 40px;">Nenhum link acessado recentemente.</div>':x.forEach(h=>{let N=M(h,ze[h._originalCat],!0);k.appendChild(N)}),requestAnimationFrame(()=>{_.style.transform="translateY(0)"})}function Z(){_&&(_.style.transform="translateY(100%)")}function se(){d.innerHTML="";let k=E("history","Recentes",ze.history);k.onclick=()=>{Y.playClick(),B()};let x=document.createElement("div");x.style.cssText="width: 40px; height: 1px; background: rgba(0,0,0,0.06); margin: 8px 0;",d.appendChild(k),d.appendChild(x),Object.keys(Ct).forEach(h=>{let N=Ct[h],l=E(h,N.label,ze[h]);l.onclick=()=>{Y.playClick(),S(h)},d.appendChild(l)})}function E(k,x,h){let N=document.createElement("div");N.style.cssText=`
          width: 64px; height: 56px; border-radius: 12px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${s.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          margin-bottom: 4px; position: relative;
      `,N.title=x,N.dataset.key=k;let l=document.createElement("div");l.style.cssText="width: 24px; height: 24px; margin-bottom: 4px; transition: transform 0.2s;",l.innerHTML=h||ze.tasks;let v=document.createElement("div");return v.style.cssText="font-size: 10px; font-weight: 500; opacity: 0.8;",v.textContent=x,N.appendChild(l),N.appendChild(v),N.onmouseenter=()=>{n!==k&&(N.style.background="rgba(0,0,0,0.04)",l.style.transform="scale(1.1)")},N.onmouseleave=()=>{n!==k&&(N.style.background="transparent",l.style.transform="scale(1)")},N}function S(k){let x=document.getElementById(`cat-anchor-${k}`);x&&(x.scrollIntoView({behavior:"smooth",block:"start"}),O(k))}function O(k){n=k,Array.from(d.children).forEach(x=>{if(!x.dataset.key)return;let h=x.querySelector("div:first-child");x.dataset.key===k?(x.style.background="#E8F0FE",x.style.color="#1967D2",x.style.fontWeight="600",h&&(h.style.transform="scale(1.1)")):(x.style.background="transparent",x.style.color=s.textSecondary,x.style.fontWeight="500",h&&(h.style.transform="scale(1)"))})}function D(){if(A.innerHTML="",e.trim()!==""){let x=[];if(Object.entries(Ct).forEach(([N,l])=>{let v=l.links.filter(w=>w.name.toLowerCase().includes(e.toLowerCase())||w.desc.toLowerCase().includes(e.toLowerCase()));x.push(...v.map(w=>({...w,_cat:N})))}),x.length===0){A.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nenhum link encontrado.</div>';return}let h=document.createElement("div");h.innerHTML="Resultados da busca",h.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase;",A.appendChild(h),x.forEach(N=>{let l=M(N,ze[N._cat],!1);A.appendChild(l)});return}Object.entries(Ct).forEach(([x,h])=>{let N=document.createElement("div"),l=document.createElement("div");l.id=`cat-anchor-${x}`,l.innerHTML=`<span style="opacity:0.6; margin-right:8px;">${ze[x]}</span> ${h.label}`,l.style.cssText=`
              display: flex; align-items: center;
              font-size: 12px; font-weight: 700; color: #1a73e8; 
              text-transform: uppercase; margin: 32px 0 12px 0;
              padding-top: 10px;
          `,N.appendChild(l),h.links.forEach(v=>{let w=M(v,ze[x],!1,x);N.appendChild(w)}),A.appendChild(N)});let k=document.createElement("div");k.style.height="60px",A.appendChild(k)}function M(k,x,h,N){let l=document.createElement("div"),v=h?"#FFF8E1":"#FFFFFF",w=h?"1px solid #FFE082":"1px solid rgba(0,0,0,0.08)";l.style.cssText=`
      ...
      `,T.title="Copiar URL",l.onmouseenter=()=>{l.style.transform="translateY(-2px)",l.style.boxShadow="0 4px 12px rgba(0,0,0,0.08)",f.style.background=s.primaryBg,f.style.color=s.primary,T.style.opacity="1",T.style.color=s.primary,T.style.background="#F1F3F4"},l.onmouseleave=()=>{l.style.transform="translateY(0)",l.style.boxShadow="0 1px 2px rgba(0,0,0,0.04)",f.style.background=h?"#FFFFFF":"#F1F3F4",f.style.color=s.textSecondary,T.style.opacity="0.6",T.style.color="#9AA0A6",T.style.background="transparent"},l.onclick=()=>{!h&&N&&ko(k,N),window.open(k.url,"_blank")},T.onclick=z=>{z.stopPropagation(),Y.playClick(),navigator.clipboard.writeText(k.url),!h&&N&&ko(k,N),V("Link copiado!")},l.appendChild(f),l.appendChild(q),l.appendChild(T),l}u.addEventListener("input",k=>{e=k.target.value,D()});function L(){o=!o,Ie(o,i,"cw-btn-links")}return document.body.appendChild(i),se(),D(),L}var Be=[];function Ht(t){Be=t}var Xo=["lucaste"],Ko=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function qo(){let t="v4.9 (High Contrast UI)",e=!1,o=null,n=null;function s(l){if(!l)return"";try{let v=new Date(l);return isNaN(v.getTime())?String(l):v.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(l)}}if(!document.getElementById("cw-broadcast-hd-css")){let l=document.createElement("style");l.id="cw-broadcast-hd-css",l.innerHTML=`
        @keyframes cw-pulse {
